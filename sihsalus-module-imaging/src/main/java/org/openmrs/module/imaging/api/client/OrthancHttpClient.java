...
public class OrthancHttpClient {
  ...
  public HttpURLConnection createConnection(
      String method, String url, String path, String username, String password) throws IOException {
   ...
   */
  public static void throwConnectionException(OrthancConfiguration config, HttpURLConnection con)
      throws IOException {
    String errorMessage;
    try {
    ...
    throw new IOException(
        "Request to Orthanc server "
            + redactUrl(config.getOrthancBaseUrl())
            + " failed with error: "
            + errorMessage);
  }
   ...
   * @throws IOException the IO exception
   */
  public int testOrthancConnection(String url, String username, String password)
      throws IOException {
