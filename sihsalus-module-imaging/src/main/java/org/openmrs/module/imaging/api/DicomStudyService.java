...
public interface DicomStudyService extends OpenmrsService {
  ...
  @Authorized(PRIVILEGE_RECEIVE_ORTHANC_UPDATES)
  void fetchNewChangedStudiesByConfiguration(OrthancConfiguration orthancConfiguration)
      throws IOException;

  @Authorized(PRIVILEGE_RECEIVE_ORTHANC_UPDATES)
  void fetchNewChangedStudiesByConfigurationAndStudyUIDs(
  ...
  @Authorized(PRIVILEGE_VIEW_IMAGE_DATA)
  PreviewResult fetchInstancePreview(String orthancInstanceUID, DicomStudy study)
      throws IOException;
}
