...
public class SihsalusImagingConfiguration {
    ...
    DicomStudyService dicomStudyService(DicomStudyDao dicomStudyDao, OrthancHttpClient orthancHttpClient) {
    ...
    RequestProcedureStepService requestProcedureStepService(RequestProcedureStepDao requestProcedureStepDao) {
