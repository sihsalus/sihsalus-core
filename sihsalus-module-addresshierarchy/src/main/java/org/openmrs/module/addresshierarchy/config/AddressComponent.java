...
/**
 * Represents a component of a hierarchical address This aims to combine the fields required to set
 * up the address template in the system, and to align this with the levels needed by the address
 * hierarchy
 */
    ...
    ret =
        ret
            && OpenmrsUtil.nullSafeEquals(
                this.isRequiredInHierarchy(), that.isRequiredInHierarchy());
    return ret;
  }
}
