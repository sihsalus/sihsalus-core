...
public class AddressToEntryMapsUpdaterTask extends AbstractTask {
  ...
  public void execute() {
    ...
    try {
      ...
      lastStartTimeGlobalProp =
          Context.getAdministrationService()
              .getGlobalPropertyObject(
                  AddressHierarchyConstants
      ...
      // update all the patients that have changed since last execution of this task (lastStartTime
      // will be null on first execution, so it will check all records to date)
