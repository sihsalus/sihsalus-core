...
public class AddressHierarchyModuleException extends APIException {
   ...
   * #AddressHierarchyModuleException(String)} constructor to specify a helpful message to the end
   * user
   */
   ...
   *
   * @param message helpful message string for the end user
   * @param cause the parent exception cause that this AddressHierarchyModuleException is wrapping
   *     around
   */
   ...
   * AddressHierarchyModuleException. Preference should be given to the {@link
   * #AddressHierarchyModuleException(String, Throwable)} constructor if at all possible instead of
   * this one.
   *
   * @param cause the parent exception cause that this AddressHierarchyModuleException is wrapping
   *     around
