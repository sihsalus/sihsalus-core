...
class AdHocQueryDeleteMe {
  ...
  @JsonProperty private String definitionType;

  @JsonProperty private List<Query> queries;

  @JsonProperty private String composition;
  ...
  public static class Query {
    ...
    @JsonProperty private String definitionKey;
