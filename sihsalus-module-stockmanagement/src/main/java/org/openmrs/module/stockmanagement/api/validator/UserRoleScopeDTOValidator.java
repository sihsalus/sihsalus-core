...
@Handler(
    supports = {UserRoleScopeDTO.class},
    order = 50)
public class UserRoleScopeDTOValidator implements Validator {
  ...
  public void validate(Object target, Errors errors) {
    ...
    ValidationUtils.rejectIfEmptyOrWhitespace(
        errors, "role", messageSourceService.getMessage("error.null"));
    ...
    // ValidateUtil.validateFieldLengths(errors, UserRoleScopeDTO.class, "gender",
    // "personVoidReason");
  }
}
