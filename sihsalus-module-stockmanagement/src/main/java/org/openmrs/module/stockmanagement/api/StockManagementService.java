...
public interface StockManagementService extends OpenmrsService {
  ...
  @Transactional
  @Authorized(Privileges.TASK_STOCKMANAGEMENT_USERROLESCOPES_MUTATE)
  UserRoleScopeOperationType saveUserRoleScopeOperationType(
      UserRoleScopeOperationType userRoleScopeOperationType);

  @Transactional
  @Authorized(Privileges.TASK_STOCKMANAGEMENT_USERROLESCOPES_MUTATE)
  void voidUserRoleScopeLocations(
      List<String> userRoleScopeLocationIds, String reason, int voidedBy);

  @Transactional
  @Authorized(Privileges.TASK_STOCKMANAGEMENT_USERROLESCOPES_MUTATE)
  void voidUserRoleScopeOperationTypes(
      List<String> userRoleScopeOperationTypeIds, String reason, int voidedBy);
  ...
  @Transactional(readOnly = true)
  @Authorized(Privileges.APP_STOCKMANAGEMENT_STOCKITEMS)
  List<Integer> searchStockItemCommonName(
  ...
  @Transactional(readOnly = true)
  @Authorized(Privileges.APP_STOCKMANAGEMENT_STOCKITEMS)
  Result<StockRuleDTO> findStockRules(
  ...
  @Transactional(readOnly = true)
  Result<StockOperationDTO> findStockOperations(
  ...
  @Transactional(readOnly = true)
  @Authorized(Privileges.APP_STOCKMANAGEMENT_STOCKITEMS)
  Result<StockItemPackagingUOMDTO> findStockItemPackagingUOMs(
  ...
  @Transactional(readOnly = true)
  boolean userHasStockManagementPrivilege(
      User user,
      Location location,
  ...
  @Transactional(readOnly = true)
  HashSet<PrivilegeScope> getPrivilegeScopes(
      User user,
      Location location,
      StockOperationType stockOperationType,
      String stockManagementPrivilege);
  ...
  @Authorized(
      value = {
        Privileges.APP_STOCKMANAGEMENT_STOCKOPERATIONS,
  ...
  void stockOperationItemsReceived(
      StockOperationDTO stockOperationDTO, List<StockOperationActionLineItem> lineItems);
  ...
  @Transactional(readOnly = true)
  @Authorized(
      value = {Privileges.APP_STOCKMANAGEMENT_STOCKITEMS},
      requireAll = false)
  ...
  @Authorized(
      value = {Privileges.APP_STOCKMANAGEMENT_STOCKITEMS},
      requireAll = false)
  StockInventoryResult getStockInventory(
      StockItemInventorySearchFilter filter, HashSet<RecordPrivilegeFilter> recordPrivilegeFilters);

  @Transactional(readOnly = true)
  @Authorized(
      value = {Privileges.APP_STOCKMANAGEMENT_STOCKITEMS},
      requireAll = false)
  Result<StockItemTransactionDTO> findStockItemTransactions(
  ...
  @Authorized(
      value = {Privileges.APP_STOCKMANAGEMENT_STOCKITEMS},
      requireAll = false)
  List<StockItemDTO> getExistingStockItemIds(
  ...
  @Transactional(readOnly = true)
  List<StockItemPackagingUOM> getStockItemPackagingUOMs(
  ...
  @Transactional(readOnly = true)
  @Authorized(
      value = {Privileges.TASK_STOCKMANAGEMENT_STOCKITEMS_DISPENSE_QTY},
      requireAll = false)
  ...
  @Authorized(
      value = {Privileges.TASK_STOCKMANAGEMENT_STOCKITEMS_DISPENSE_QTY},
      requireAll = false)
  Result<OrderItemDTO> findOrderItems(
  ...
  @Transactional
  void updateStockBatchExpiryNotificationDate(
  ...
  @Transactional(readOnly = true)
  void setStockItemCurrentBalanceWithDescendants(
      List<StockRuleCurrentQuantity> stockRuleCurrentQuantities);

  @Transactional(readOnly = true)
  void setStockItemCurrentBalanceWithoutDescendants(
      List<StockRuleCurrentQuantity> stockRuleCurrentQuantities);
  ...
  List<StockBatchDTO> getExpiringStockBatchesDueForNotification(
  ...
  void sendStockOperationNotification(
  ...
  @Transactional(readOnly = true)
  @Authorized(value = Privileges.APP_STOCKMANAGEMENT_REPORTS)
  Result<BatchJobDTO> findBatchJobs(
      BatchJobSearchFilter batchJobSearchFilter,
  ...
  <T extends StockItemInventory> void getStockInventory(
      StockItemInventorySearchFilter filter,
      HashSet<RecordPrivilegeFilter> recordPrivilegeFilters,
      Function<T, Boolean> consumer,
      Class<T> resultClass);

  StockInventoryResult postProcessInventoryResult(
  ...
  void getStockInventoryForecastData(
      StockItemInventorySearchFilter filter, Function<Object[], Boolean> consumer);

  void getStockInventoryExpiryForecastData(
      StockItemInventorySearchFilter filter, Function<Object[], Boolean> consumer);
  ...
  @Transactional(readOnly = true)
  Map<Integer, Boolean> checkStockBatchHasTransactionsAfterOperation(
      Integer stockOperationId, List<Integer> stockBatchIds);

  @Transactional
  @Authorized(Privileges.TASK_STOCKMANAGEMENT_STOCKOPERATIONS_MUTATE)
  StockOperationBatchNumbersDTO saveStockOperationBatchNumbers(
