...
public class StockOperation extends BaseChangeableOpenmrsData implements Serializable {
  ...
  public StockItemTransaction removeStockItemTransaction(
      StockItemTransaction stockItemTransaction) {
  ...
  public void setReservedTransactions(Set<ReservedTransaction> reservedTransactions) {
    this.reservedTransactions =
        reservedTransactions == null ? null : new HashSet<>(reservedTransactions);
  }
  ...
  public ReservedTransaction addReservedTransaction(ReservedTransaction reservedTransaction) {
    ...
    reservedTransaction.setIsAvailable(
        getStockOperationType().getAvailableWhenReserved() != null
  ...
  public boolean canDisplayReceivedItems() {
    return canReceiveItems()
        || (StockOperationStatus.canDisplayReceivedItems(getStatus(), this.getDispatchedDate()));
  }
