...
public class GlobalProperties {
  ...
  public static final String STOCK_ITEM_SEARCH_MAX_INTERMEDIATE_RESULT =
      ModuleConstants.MODULE_ID + ".stockItemSearchMaxIntermediateResult";

  public static final String STOCK_SOURCE_TYPE_CODED_CONCEPT_ID =
      ModuleConstants.MODULE_ID + ".stockSourceCodeConceptId";

  public static final String STOCK_ADJUSTMENT_REASON_CODED_CONCEPT_ID =
      ModuleConstants.MODULE_ID + ".stockAdjustmentReasonCodeConceptId";

  public static final String NEGATIVE_STOCK_BALANCE_ALLOWED =
      ModuleConstants.MODULE_ID + ".negativeStockBalanceAllowed";

  public static final String EXCESS_RECIEVED_ITEM_THRESHOLD =
      ModuleConstants.MODULE_ID + ".excessReceivedItemThreshold";

  public static final String DISPENSING_UNITS_CONCEPT_ID =
      ModuleConstants.MODULE_ID + ".dispensingUnitsConceptId";

  public static final String PACKAGING_UNITS_CONCEPT_ID =
      ModuleConstants.MODULE_ID + ".packagingUnitsConceptId";

  public static final String STOCK_ITEM_CATEGORY_CONCEPT_ID =
      ModuleConstants.MODULE_ID + ".stockItemCategoryConceptId";

  public static final String UNKNOWN_CONCEPT_ID = ModuleConstants.MODULE_ID + ".unknownConceptId";

  public static final String STOCK_ITEMS_MAX_UPLOAD_FILE_SIZE =
      ModuleConstants.MODULE_ID + ".stockItemsMaxUploadFileSize";

  public static final String STOCK_OPERATION_PRINT_DISABLE_BALANCE_ON_HAND =
      ModuleConstants.MODULE_ID + ".stockOperationPrintDisableBalanceOnHand";

  public static final String STOCK_OPERATION_PRINT_DISABLE_COSTS =
      ModuleConstants.MODULE_ID + ".stockOperationPrintDisableCosts";
  ...
  public static final String ENABLE_STOCK_RULE_JOB =
      ModuleConstants.MODULE_ID + ".enableStockRuleJob";

  public static final String STOCK_RULE_JOB_BATCH_SIZE =
      ModuleConstants.MODULE_ID + ".stockRuleJobBatchSize";

  public static final String ENABLE_STOCK_BATCH_JOB =
      ModuleConstants.MODULE_ID + ".enableStockBatchJob";

  public static final String STOCK_BATCH_DEFAULT_EXPIRY_NOTIFICATION_NOTICE_PERIOD =
      ModuleConstants.MODULE_ID + ".stockBatchDefaultExpiryNotificationNoticePeriod";

  public static final String CLOSE_PRINT_AFTER_PRINT =
      ModuleConstants.MODULE_ID + ".closePrintAfterPrint";

  public static final String STOCK_OPERATION_NOTIFICATION_EMAIL =
      ModuleConstants.MODULE_ID + ".stockOperationNotificationEmail";

  public static final String STOCK_OPERATION_NOTIFICATION_ROLE =
      ModuleConstants.MODULE_ID + ".stockOperationNotificationRole";

  public static final String BATCH_JOB_EXPIRY_IN_MINUTES =
      ModuleConstants.MODULE_ID + ".batchJobExpiryInMinutes";

  public static final String APPLICATION_ROOT_URL =
      ModuleConstants.MODULE_ID + ".applicationRootUrl";
  ...
  public static Integer getStockBatchDefaultExpiryNotificationNoticePeriod() {
    try {
      return Math.max(
          0,
          Integer.parseInt(
              getGlobalProperty(STOCK_BATCH_DEFAULT_EXPIRY_NOTIFICATION_NOTICE_PERIOD)));
    } catch (Exception exception) {
    }
    return 120;
  }
  ...
  public static boolean allowStockIssueWithoutRequisition() {
    try {
      return Boolean.parseBoolean(
          getGlobalProperty("stockmanagement.allowStockIssueWithoutRequisition"));
    } catch (Exception exception) {
    }
    return false;
  }
  ...
  public static BigDecimal GetReportingCalculationsNoDaysInMonth() {
    try {
      BigDecimal result =
          new BigDecimal(getGlobalProperty("stockmanagement.reportingCalculationsNoDaysInMonth"));
  ...
  public static boolean uomPriorityIsBigToSmall() {
    try {
      String property =
          getGlobalProperty("stockmanagement.packagingUnitPackSizePriorityIsBigToSmall");
      if (StringUtils.isBlank(property)) return true;
