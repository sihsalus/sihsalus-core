...
class PartialStockManagementService implements InvocationHandler {
    ...
    switch (name) {
      case "getCompleteLocationTree":
        return args.length == 0
            ? listAll(LocationTree.class)
            : getCompleteLocationTree((Integer) args[0]);
      ...
      case "submitStockOperation":
        processStockOperationAction(
            (StockOperationDTO) args[0], StockOperationAction.Action.SUBMIT, null);
        return null;
      case "completeStockOperation":
        processStockOperationAction(
            (StockOperationDTO) args[0], StockOperationAction.Action.COMPLETE, null);
        return null;
      case "approveStockOperation":
        processStockOperationAction(
            (StockOperationDTO) args[0], StockOperationAction.Action.APPROVE, null);
        return null;
      case "dispatchStockOperation":
        processStockOperationAction(
            (StockOperationDTO) args[0], StockOperationAction.Action.DISPATCH, null);
        return null;
      case "rejectStockOperation":
        processStockOperationAction(
            (StockOperationDTO) args[0], StockOperationAction.Action.REJECT, (String) args[1]);
        return null;
      case "returnStockOperation":
        processStockOperationAction(
            (StockOperationDTO) args[0], StockOperationAction.Action.RETURN, (String) args[1]);
        return null;
      case "cancelStockOperation":
        processStockOperationAction(
            (StockOperationDTO) args[0], StockOperationAction.Action.CANCEL, (String) args[1]);
        return null;
      case "stockOperationItemsReceived":
        stockOperationItemsReceived(
            (StockOperationDTO) args[0], (List<StockOperationActionLineItem>) args[1]);
        return null;
      ...
      case "voidUserRoleScopeOperationTypes":
        voidByUuids(
            UserRoleScopeOperationType.class,
            (List<String>) args[0],
            (String) args[1],
            (Integer) args[2]);
        return null;
      ...
      case "searchStockItemCommonName":
        return searchStockItemCommonName(
            (String) args[0], (Boolean) args[1], (Boolean) args[2], (Integer) args[3]);
      case "findStockItems":
      ...
      case "findStockRules":
        return args.length > 1
            ? findStockRules(
                (StockRuleSearchFilter) args[0], (HashSet<RecordPrivilegeFilter>) args[1])
      ...
      case "findStockOperations":
        return args.length > 1
            ? findStockOperations(
                (StockOperationSearchFilter) args[0], (HashSet<RecordPrivilegeFilter>) args[1])
      ...
      case "getStockInventory":
        if (args.length > 3) {
          getStockInventory(
              (StockItemInventorySearchFilter) args[0],
              (HashSet<RecordPrivilegeFilter>) args[1],
              (Function<StockItemInventory, Boolean>) args[2],
              (Class<StockItemInventory>) args[3]);
          return null;
        }
        return args.length > 1
            ? getStockInventory(
                (StockItemInventorySearchFilter) args[0], (HashSet<RecordPrivilegeFilter>) args[1])
            : getStockInventory((StockItemInventorySearchFilter) args[0], null);
      case "getStockInventoryForecastData":
        getStockInventoryForecastData(
            (StockItemInventorySearchFilter) args[0], (Function<Object[], Boolean>) args[1]);
        return null;
      case "getStockInventoryExpiryForecastData":
        getStockInventoryExpiryForecastData(
            (StockItemInventorySearchFilter) args[0], (Function<Object[], Boolean>) args[1]);
        return null;
      case "postProcessInventoryResult":
        return postProcessInventoryResult(
            (StockItemInventorySearchFilter) args[0], (StockInventoryResult) args[1]);
      ...
      case "voidStockItemPackagingUOM":
        voidByUuid(
            StockItemPackagingUOM.class, (String) args[0], (String) args[1], (Integer) args[2]);
        return null;
      ...
      case "getStockItemPackagingUOMs":
        return getStockItemPackagingUOMs(
            (List<StockItemPackagingUOMSearchFilter.ItemGroupFilter>) args[0]);
      ...
      case "findOrderItems":
        return args.length > 1
            ? findOrderItems(
                (OrderItemSearchFilter) args[0], (HashSet<RecordPrivilegeFilter>) args[1])
      ...
      case "checkStockBatchHasTransactionsAfterOperation":
        return checkStockBatchHasTransactionsAfterOperation(
            (Integer) args[0], (List<Integer>) args[1]);
      ...
      case "sendStockOperationNotification":
        sendStockOperationNotification(
            (String) args[0],
            (StockOperationAction.Action) args[1],
            (String) args[2],
            (Integer) args[3]);
        return null;
  ...
  private UnsupportedOperationException unsupported(Method method) {
    return new UnsupportedOperationException(
        "Stock Management service method "
            + method.getName()
            + " requires the Hibernate 7 DAO migration");
  }
  ...
  private List<LocationTree> getCompleteLocationTree(Integer atLocationId) {
    ...
    return query(
        LocationTree.class,
        (cb, root) -> predicates(cb.equal(root.get("parentLocationId"), atLocationId)));
  }
  ...
  private List<PartyDTO> getCompletePartyList(
      Integer atLocationId, boolean onlyDispensingLocations) {
    List<Integer> locationIds =
        getCompleteLocationTree(atLocationId).stream()
  ...
  private Result<UserRoleScopeDTO> findUserRoleScopes(UserRoleScopeSearchFilter filter) {
    UserRoleScopeSearchFilter safeFilter =
        filter == null ? new UserRoleScopeSearchFilter() : filter;
        ...
        query(
            ...
            (cb, root) -> {
              ...
              if (safeFilter.getLocation() != null) {
                Join<UserRoleScope, UserRoleScopeLocation> locationJoin =
                    root.join("userRoleScopeLocations", JoinType.LEFT);
              ...
              if (safeFilter.getOperationType() != null) {
                Join<UserRoleScope, UserRoleScopeOperationType> operationJoin =
                    root.join("userRoleScopeOperationTypes", JoinType.LEFT);
                predicates.add(
                    cb.equal(
                        operationJoin.get("stockOperationType"), safeFilter.getOperationType()));
    ...
    List<UserRoleScopeDTO> dtos =
        scopes.stream().map(this::userRoleScopeToDto).collect(Collectors.toList());
    ...
    if (locations != null) {
      dto.setLocations(
          locations.stream()
              ...
              .map(this::userRoleScopeLocationToDto)
              .collect(Collectors.toList()));
    }
    ...
    if (operationTypes != null) {
      dto.setOperationTypes(
          operationTypes.stream()
              ...
              .map(this::userRoleScopeOperationTypeToDto)
              .collect(Collectors.toList()));
    }
    return dto;
  }
  ...
  private UserRoleScopeLocationDTO userRoleScopeLocationToDto(UserRoleScopeLocation location) {
    ...
    dto.setUserRoleScopeId(
        location.getUserRoleScope() == null ? null : location.getUserRoleScope().getId());
  ...
  private UserRoleScopeOperationTypeDTO userRoleScopeOperationTypeToDto(
      UserRoleScopeOperationType operationType) {
  ...
  private UserRoleScope saveUserRoleScope(UserRoleScopeDTO dto) {
    ...
    List<UserRoleScopeLocation> locationsToRemove =
                ...
                .filter(
                    location ->
                        dto.getLocations().stream()
                            .noneMatch(
                                incoming ->
                                    sameUuid(incoming.getLocationUuid(), location.getLocation())))
                .collect(Collectors.toList());
    List<UserRoleScopeOperationType> operationTypesToRemove =
        dto.getOperationTypes() == null
            ? new ArrayList<>()
            : activeUserRoleScopeOperationTypes(userRoleScope).stream()
                .filter(
                    operationType ->
                        dto.getOperationTypes().stream()
                            .noneMatch(
                                incoming ->
                                    sameUuid(
                                        incoming.getOperationTypeUuid(),
                                        operationType.getStockOperationType())))
                .collect(Collectors.toList());
  ...
  private void rejectSelfUserRoleScopeUpdate(User user) {
    ...
    if (user != null
        ...
        && user.getUuid().equalsIgnoreCase(authenticatedUser.getUuid())) {
      throw new StockManagementException(
          "Users cannot update their own stock management role scopes");
    }
  }

  private void saveUserRoleScopeLocations(
      UserRoleScope userRoleScope, List<UserRoleScopeLocationDTO> locationDtos) {
    if (locationDtos == null) {
      return;
    }
    for (UserRoleScopeLocationDTO locationDto : locationDtos) {
      Location location =
          Context.getLocationService().getLocationByUuid(locationDto.getLocationUuid());
      if (location == null) {
        throw new StockManagementException("User role scope location not found");
      }
      UserRoleScopeLocation scopeLocation =
          activeUserRoleScopeLocations(userRoleScope).stream()
  ...
  private void saveUserRoleScopeOperationTypes(
    ...
    for (UserRoleScopeOperationTypeDTO operationTypeDto : operationTypeDtos) {
      StockOperationType operationType =
          byUuid(StockOperationType.class, operationTypeDto.getOperationTypeUuid());
      if (operationType == null) {
        throw new StockManagementException("User role scope operation type not found");
      }
      UserRoleScopeOperationType scopeOperationType =
          activeUserRoleScopeOperationTypes(userRoleScope).stream()
              .filter(
                  existing ->
                      sameUuid(
                          operationTypeDto.getOperationTypeUuid(),
                          existing.getStockOperationType()))
              .findFirst()
  ...
  private List<UserRoleScopeOperationType> activeUserRoleScopeOperationTypes(
      UserRoleScope userRoleScope) {
  ...
  private boolean sameUuid(String uuid, BaseOpenmrsObject object) {
    return StringUtils.isNotBlank(uuid)
        && object != null
        && uuid.equalsIgnoreCase(object.getUuid());
  }
  ...
  private StockOperation saveStockOperation(StockOperationDTO dto) {
    ...
    if (isNew) {
      ...
      operationType =
          requireByUuid(
              StockOperationType.class,
              dto.getOperationTypeUuid(),
    ...
    StockOperationLink requisitionLink =
        isNew ? stockOperationRequisitionLink(operationType, dto) : null;
    List<StockOperationItem> operationItems =
        saveStockOperationItems(operation, operationType, dto);
    saveOrUpdate(operation);
    if (isNew && StringUtils.isBlank(operation.getOperationNumber())) {
      operation.setOperationNumber(
          operationType.getAcronym()
              + "-"
  ...
  private void applyStockOperationFields(StockOperation operation, StockOperationDTO dto) {
    ...
    operation.setSource(
        StringUtils.isBlank(dto.getSourceUuid()) ? null : byUuid(Party.class, dto.getSourceUuid()));
    operation.setDestination(
        StringUtils.isBlank(dto.getDestinationUuid())
            ? null
            : byUuid(Party.class, dto.getDestinationUuid()));
    operation.setReason(
        StringUtils.isBlank(dto.getReasonUuid())
            ? null
    ...
    if (StringUtils.isNotBlank(dto.getResponsiblePersonUuid())) {
      ...
      operation.setResponsiblePersonOther(
          StringUtils.isBlank(dto.getResponsiblePersonOther())
              ? null
              : dto.getResponsiblePersonOther());
    }
  }

  private StockOperationLink stockOperationRequisitionLink(
      StockOperationType operationType, StockOperationDTO dto) {
    if (operationType.canBeRelatedToRequisition()
        && StringUtils.isNotBlank(dto.getRequisitionStockOperationUuid())) {
  ...
  private List<StockOperationItem> saveStockOperationItems(
      StockOperation operation, StockOperationType operationType, StockOperationDTO dto) {
    List<StockOperationItemDTO> itemDtos =
        dto.getStockOperationItems() == null ? new ArrayList<>() : dto.getStockOperationItems();
    List<StockOperationItem> existingItems =
        operation.getStockOperationItems() == null
            ? new ArrayList<>()
    ...
    for (StockOperationItemDTO itemDto : itemDtos) {
      ...
      if (itemDto.getQuantity() != null) {
        ...
        item.setStockItemPackagingUOM(
            requireByUuid(
                StockItemPackagingUOM.class,
                itemDto.getStockItemPackagingUOMUuid(),
                "Stock item packaging unit not found"));
      }
  ...
  private StockOperationItem resolveStockOperationItem(
      List<StockOperationItem> existingItems, StockOperationItemDTO itemDto) {
    ...
    return existingItems.stream()
        ...
        .orElseThrow(
            () ->
                new StockManagementException(
                    "Stock operation item not found: " + itemDto.getUuid()));
  }

  private StockItem resolveStockOperationStockItem(StockOperationItemDTO itemDto) {
    StockItem stockItem =
        StringUtils.isNotBlank(itemDto.getStockItemUuid())
  ...
  private StockBatch resolveStockOperationBatch(
      StockOperationType operationType, StockItem stockItem, StockOperationItemDTO itemDto) {
    ...
    StockBatch stockBatch =
        findStockBatch(stockItem, itemDto.getBatchNo(), itemDto.getExpiration());
    if (stockBatch != null) {
      return stockBatch;
    }
    ...
    List<StockBatch> batches =
        query(
            ...
            (cb, root) -> {
              ...
              predicates.add(
                  cb.equal(
                      cb.lower(root.get("batchNo").as(String.class)),
  ...
  private void applyStockOperationItemQuantities(
      StockOperationItem item, StockOperationItemDTO itemDto) {
    if (itemDto.getQuantityReceived() != null) {
      item.setQuantityReceived(itemDto.getQuantityReceived());
      item.setQuantityReceivedPackagingUOM(
          requireByUuid(
              StockItemPackagingUOM.class,
              itemDto.getQuantityReceivedPackagingUOMUuid(),
              "Quantity received packaging unit not found"));
    }
    if (itemDto.getQuantityRequested() != null) {
      item.setQuantityRequested(itemDto.getQuantityRequested());
      item.setQuantityRequestedPackagingUOM(
          requireByUuid(
              StockItemPackagingUOM.class,
              itemDto.getQuantityRequestedPackagingUOMUuid(),
              "Quantity requested packaging unit not found"));
    }
  }

  private void processStockOperationAction(
      StockOperationDTO dto, StockOperationAction.Action action, String reason) {
    if (dto == null || StringUtils.isBlank(dto.getUuid())) {
      throw new StockManagementException("Stock operation uuid is required");
    }
    StockOperation operation =
        requireByUuid(StockOperation.class, dto.getUuid(), "Stock operation not found");
    ...
    boolean lockAndReserve =
        action == StockOperationAction.Action.SUBMIT
            || (operation.isUpdateable()
  ...
  private void notifyStockOperationAction(
      StockOperation operation,
      StockOperationType operationType,
    ...
    try {
      ...
      sendStockOperationNotification(
          operation.getUuid(), action, reason, user == null ? null : user.getUserId());
    } catch (Exception exception) {
      log.error("Unable to send stock operation notification", exception);
    }
  }

  private boolean shouldNotifyStockOperationAction(
      StockOperationType operationType, StockOperationAction.Action action) {
  ...
  private void validateStockOperationAction(
      StockOperation operation,
      StockOperationType operationType,
      StockOperationAction.Action action) {
    boolean allowed;
    switch (action) {
      ...
      case DISPATCH:
        allowed =
            operationType.requiresDispatchAcknowledgement()
                && (operation.isUpdateable()
                    || operation.getStatus() == StockOperationStatus.SUBMITTED);
        break;
      case APPROVE:
        allowed =
            operation.getStatus() == StockOperationStatus.SUBMITTED
  ...
  private void validateStockOperationActionPrivilege(
      StockOperation operation,
      StockOperationType operationType,
      StockOperationAction.Action action) {
    ...
    if (location == null
        || !operationType.userCanProcess(authenticatedUser(), location, privilege)) {
      throw new StockManagementException("User cannot process stock operation");
    }
  }

  private String stockOperationActionPrivilege(
      StockOperation operation, StockOperationAction.Action action) {
    switch (action) {
      case APPROVE:
      case REJECT:
  ...
  private Location stockOperationActionLocation(
      StockOperation operation, StockOperationAction.Action action) {
    if ((action == StockOperationAction.Action.COMPLETE
            || action == StockOperationAction.Action.RETURN)
        && operation.getStatus() == StockOperationStatus.DISPATCHED
  ...
  private void applyStockOperationAction(
      StockOperation operation,
      StockOperationType operationType,
      StockOperationAction.Action action,
      String reason,
    ...
    if (action == StockOperationAction.Action.DISPATCH) {
      ...
      operation.setStatus(StockOperationStatus.DISPATCHED);
        ...
        || action == StockOperationAction.Action.APPROVE) {
      operation.setCompletedBy(user);
      operation.setCompletedDate(now);
      operation.setStatus(StockOperationStatus.COMPLETED);
      operationType.onCompleted(operation);
  ...
  private void stockOperationItemsReceived(
      StockOperationDTO dto, List<StockOperationActionLineItem> lineItems) {
    if (dto == null
        || StringUtils.isBlank(dto.getUuid())
        || lineItems == null
        || lineItems.isEmpty()) {
      return;
    }
    ...
    Location destination =
        operation.getDestination() == null ? null : operation.getDestination().getLocation();
    if (destination == null
        || !operationType.userCanProcess(
            authenticatedUser(),
            destination,
            Privileges.TASK_STOCKMANAGEMENT_STOCKOPERATIONS_RECEIVEITEMS)) {
    ...
    for (StockOperationActionLineItem lineItem : lineItems) {
      ...
      StockOperationItem item =
          operation.getStockOperationItems().stream()
              .filter(
                  candidate ->
                      lineItem.getUuid() != null && lineItem.getUuid().equals(candidate.getUuid()))
              .findFirst()
              .orElseThrow(
                  () -> new StockManagementException("Stock operation line item not found"));
  ...
  private void validateReceivedQuantity(
      StockOperationItem item, BigDecimal amount, StockItemPackagingUOM uom, BigDecimal threshold) {
    if (item.getQuantity() == null
        || item.getStockItemPackagingUOM() == null
        || item.getStockItemPackagingUOM().getFactor() == null
        || uom.getFactor() == null) {
      return;
    }
    ...
    BigDecimal allowedMultiplier =
        BigDecimal.valueOf(100)
            .add(threshold == null ? BigDecimal.ZERO : threshold)
  ...
  private StockOperationBatchNumbersDTO saveStockOperationBatchNumbers(
    ...
    if (batchNumbersDto == null
        || StringUtils.isBlank(batchNumbersDto.getUuid())
        || batchNumbersDto.getBatchNumbers() == null
        || batchNumbersDto.getBatchNumbers().isEmpty()) {
      throw new StockManagementException("Stock operation batch numbers are required");
    }
    StockOperation operation =
        requireByUuid(StockOperation.class, batchNumbersDto.getUuid(), "Stock operation not found");
    ensureStockOperationCollections(operation);
    StockOperationType operationType = operation.getStockOperationType();
    ...
    if (operation.getAtLocation() == null
        || !operationType.userCanProcess(
            authenticatedUser(),
            operation.getAtLocation(),
            Privileges.TASK_STOCKMANAGEMENT_STOCKOPERATIONS_MUTATE)) {
      throw new StockManagementException("User cannot update stock operation batch numbers");
    }
    Map<Integer, Boolean> batchesInUse =
        checkStockBatchHasTransactionsAfterOperation(
            operation.getId(),
            operation.getStockOperationItems().stream()
    ...
    for (StockOperationBatchNumbersDTO.StockOperationItemBatchNumber batchNumber :
        batchNumbersDto.getBatchNumbers()) {
  ...
  private void updateStockOperationItemBatchNumber(
      StockOperation operation,
      StockOperationBatchNumbersDTO.StockOperationItemBatchNumber batchNumber,
      Map<Integer, Boolean> batchesInUse) {
    if (batchNumber == null
        || StringUtils.isBlank(batchNumber.getUuid())
    ...
    StockBatch newBatch =
        findStockBatch(stockItem, batchNumber.getBatchNo(), batchNumber.getExpiration());
    if (newBatch == null) {
  ...
  private void dispenseStockItems(List<DispenseRequest> dispenseRequests) {
    ...
    List<DispenseLine> lines =
        dispenseRequests.stream().map(this::dispenseLine).collect(Collectors.toList());
  ...
  private DispenseLine dispenseLine(DispenseRequest request) {
    ...
    StockItem stockItem =
        requireByUuid(StockItem.class, request.getStockItemUuid(), "Stock item is required");
    StockBatch stockBatch =
        requireByUuid(StockBatch.class, request.getStockBatchUuid(), "Stock batch is required");
    Patient patient =
        request.getPatientId() == null
            ? null
            : Context.getPatientService().getPatient(request.getPatientId());
    if (patient == null) {
    ...
    StockItemPackagingUOM uom =
        requireByUuid(
            StockItemPackagingUOM.class,
            request.getStockItemPackagingUOMUuid(),
            "Stock item packaging unit is required");
    ...
    return new DispenseLine(
        party, patient, order, encounter, stockItem, stockBatch, request.getQuantity(), uom);
  }
  ...
  private void validateDispenseBalances(List<DispenseLine> lines) {
    ...
    for (DispenseLine line : lines) {
      ...
      String key =
          inventoryKey(line.party.getId(), line.stockItem.getId(), line.stockBatch.getId());
    ...
    for (Map.Entry<String, BigDecimal> entry : requestedByKey.entrySet()) {
      ...
      if (balance.subtract(entry.getValue()).compareTo(BigDecimal.ZERO) < 0) {
        throw new StockManagementException(
            "Dispense quantity would make stock negative for "
                + stockItemName(line.stockItem)
                + " batch "
                + line.stockBatch.getBatchNo());
      }
    }
  }
  ...
  private List<StockOperationItem> getStockOperationItemsByStockOperation(
      Integer stockOperationId) {
    if (stockOperationId == null) {
      return new ArrayList<>();
    }
    return query(
        StockOperationItem.class,
        (cb, root) ->
            predicates(
  ...
  private Result<StockOperationItemDTO> findStockOperationItems(
      StockOperationItemSearchFilter filter) {
    StockOperationItemSearchFilter safeFilter =
        filter == null ? new StockOperationItemSearchFilter() : filter;
    List<StockOperationItemDTO> items =
        queryStockOperationItems(safeFilter).stream()
  ...
  private Result<StockOperationItemCost> getStockOperationItemCosts(
      StockOperationItemSearchFilter filter) {
    StockOperationItemSearchFilter safeFilter =
        filter == null ? new StockOperationItemSearchFilter() : filter;
    List<StockOperationItemCost> costs =
        queryStockOperationItems(safeFilter).stream()
            .sorted(Comparator.comparing(this::objectId, Comparator.nullsLast(Integer::compareTo)))
  ...
  private List<StockOperationItem> queryStockOperationItems(StockOperationItemSearchFilter filter) {
    return query(
        ...
        (cb, root) -> {
          ...
          Join<StockOperationItem, StockOperation> stockOperation =
              root.join("stockOperation", JoinType.LEFT);
          ...
          if (filter.getStockOperationUuids() != null
              && !filter.getStockOperationUuids().isEmpty()) {
  ...
  private StockOperationItemDTO stockOperationItemToDto(
    ...
    setOperationItemUom(
        dto, item.getStockItemPackagingUOM(), "quantity", filter.getIncludePackagingUnitName());
    setOperationItemUom(
        dto,
        item.getQuantityReceivedPackagingUOM(),
        "received",
        filter.getIncludePackagingUnitName());
    setOperationItemUom(
        dto,
        item.getQuantityRequestedPackagingUOM(),
        "requested",
        filter.getIncludePackagingUnitName());
  ...
  private StockOperationItemCost stockOperationItemToCost(StockOperationItem item) {
    ...
    if (stockItem == null
        || stockItem.getPurchasePrice() == null
        || stockItem.getPurchasePriceUoM() == null) {
      return cost;
    }
  ...
  private void setPurchaseCost(
      StockOperationItemCost cost,
      BigDecimal purchasePrice,
      StockItemPackagingUOM purchaseUom,
      StockItemPackagingUOM quantityUom) {
    if (quantityUom == null
        || cost.getQuantity() == null
        || purchaseUom.getFactor() == null
    ...
    BigDecimal baseUnitPrice =
        purchasePrice.divide(purchaseUom.getFactor(), 5, RoundingMode.HALF_EVEN);
    BigDecimal convertedUnitPrice =
        baseUnitPrice.multiply(quantityUom.getFactor()).setScale(2, RoundingMode.HALF_EVEN);
  ...
  private void setUnitCost(
      StockOperationItemCost cost, BigDecimal unitCost, StockItemPackagingUOM uom) {
  ...
  private Result<StockItemTransactionDTO> findStockItemTransactions(
      StockItemTransactionSearchFilter filter,
      HashSet<RecordPrivilegeFilter> recordPrivilegeFilters) {
    StockItemTransactionSearchFilter safeFilter =
        filter == null ? new StockItemTransactionSearchFilter() : filter;
    List<StockItemTransactionDTO> transactions =
        queryStockItemTransactions(safeFilter, recordPrivilegeFilters).stream()
            .sorted(
                Comparator.comparing(this::objectId, Comparator.nullsLast(Integer::compareTo))
                    .reversed())
  ...
  private List<StockItemTransaction> queryStockItemTransactions(
    ...
    if (allowedPartyIds != null
        ...
        && !allowedPartyIds.contains(filter.getPartyId())) {
      return new ArrayList<>();
    }
    return query(
        StockItemTransaction.class,
        (cb, root) -> {
          ...
          if (filter.getStockOperationId() != null) {
            predicates.add(
                cb.equal(root.get("stockOperation").get("id"), filter.getStockOperationId()));
          }
          if (filter.getStockItemId() != null) {
          ...
          if (filter.getTransactionDateMin() != null) {
            predicates.add(
                cb.greaterThanOrEqualTo(
                    root.<Date>get("dateCreated"), filter.getTransactionDateMin()));
          }
          if (filter.getTransactionDateMax() != null) {
            predicates.add(
                cb.lessThanOrEqualTo(
                    root.<Date>get("dateCreated"), filter.getTransactionDateMax()));
          }
          if (filter.getIsPatientTransaction() != null) {
            predicates.add(
                Boolean.TRUE.equals(filter.getIsPatientTransaction())
  ...
  private List<StockItemInventory> getStockBatchLocationInventory(List<Integer> stockBatchIds) {
    ...
    List<StockItemTransaction> transactions =
        query(
            StockItemTransaction.class,
            (cb, root) ->
                predicates(
                    ...
                    cb.or(
                        cb.isNull(root.get("stockBatch").get("expiration")),
    ...
    for (StockItemTransaction transaction : transactions) {
      if (transaction.getStockBatch() == null
          || transaction.getStockItemPackagingUOM() == null
      ...
      StockItemInventory inventory =
          inventoryByKey.computeIfAbsent(
              key, ignored -> stockItemInventory(party, stockItem, batch));
      BigDecimal existingQuantity =
          inventory.getQuantity() == null ? BigDecimal.ZERO : inventory.getQuantity();
      inventory.setQuantity(
          existingQuantity.add(transaction.getQuantity().multiply(uom.getFactor())));
    }
  ...
  private StockItemInventory stockItemInventory(
      Party party, StockItem stockItem, StockBatch batch) {
  ...
  private void applyPreferredInventoryUoms(List<StockItemInventory> inventories) {
    ...
    uomFilter.setStockItemIds(
        inventories.stream()
            ...
            .distinct()
            .collect(Collectors.toList()));
    Map<Integer, List<StockItemPackagingUOMDTO>> uomsByStockItem =
        findStockItemPackagingUOMs(uomFilter).getData().stream()
    ...
    for (StockItemInventory inventory : inventories) {
      ...
      StockItemPackagingUOMDTO preferredUom =
          preferredPackagingUom(
              inventory.getQuantity(), uoms, false, uomPriorityIsBigToSmall, null);
      if (preferredUom == null
          || preferredUom.getFactor() == null
          || BigDecimal.ZERO.compareTo(preferredUom.getFactor()) == 0) {
        continue;
      }
      inventory.setQuantity(
          inventory.getQuantity().divide(preferredUom.getFactor(), 5, RoundingMode.HALF_EVEN));
  ...
  private StockInventoryResult getStockInventory(
      StockItemInventorySearchFilter filter,
      HashSet<RecordPrivilegeFilter> recordPrivilegeFilters) {
    StockItemInventorySearchFilter safeFilter =
        filter == null ? new StockItemInventorySearchFilter() : filter;
    List<StockItemInventory> inventories =
        computeStockInventory(safeFilter, recordPrivilegeFilters);
    StockInventoryResult result = new StockInventoryResult();
    result.setTotalRecordCount((long) inventories.size());
    Integer limit =
        safeFilter.getLimit() == null || safeFilter.getLimit() <= 0 ? null : safeFilter.getLimit();
    Result<StockItemInventory> page =
        resultFromList(inventories, safeFilter.getStartIndex(), limit);
  ...
  private <T extends StockItemInventory> void getStockInventory(
      StockItemInventorySearchFilter filter,
      HashSet<RecordPrivilegeFilter> recordPrivilegeFilters,
    ...
    for (StockItemInventory inventory :
  ...
  private StockInventoryResult postProcessInventoryResult(
      StockItemInventorySearchFilter filter, StockInventoryResult result) {
    StockInventoryResult safeResult = result == null ? new StockInventoryResult() : result;
    StockItemInventorySearchFilter safeFilter =
        filter == null ? new StockItemInventorySearchFilter() : filter;
    List<StockItemInventory> data =
        safeResult.getData() == null ? new ArrayList<>() : safeResult.getData();
  ...
  private Result<StockItemInventory> getMovingStockInventory(
      StockItemInventorySearchFilter filter, boolean mostMoving) {
    StockItemInventorySearchFilter safeFilter =
        filter == null ? new StockItemInventorySearchFilter() : filter;
    List<StockItemInventory> inventories = computeStockInventory(safeFilter, null);
    Comparator<StockItemInventory> comparator =
        Comparator.comparing(
            inventory ->
                inventory.getQuantity() == null ? BigDecimal.ZERO : inventory.getQuantity().abs(),
    ...
    inventories.sort(
        comparator.thenComparing(
            StockItemInventory::getStockItemId, Comparator.nullsLast(Integer::compareTo)));
    return resultFromList(inventories, safeFilter.getStartIndex(), safeFilter.getLimit());
  }

  private void getStockInventoryForecastData(
      StockItemInventorySearchFilter filter, Function<Object[], Boolean> consumer) {
    if (consumer == null) {
      return;
    }
    StockItemInventorySearchFilter safeFilter =
    ...
    if (groupBy != null) {
      groupByParty =
          groupBy == StockItemInventorySearchFilter.InventoryGroupBy.LocationStockItem
              || groupBy
    ...
    for (StockItemTransaction transaction : forecastTransactions(safeFilter, false)) {
      ...
      Integer partyId =
          groupByParty && transaction.getParty() != null ? transaction.getParty().getId() : null;
      Integer stockItemId =
          groupByStockItem && transaction.getStockItem() != null
              ? transaction.getStockItem().getId()
              : null;
      Integer stockBatchId =
          groupByBatch && transaction.getStockBatch() != null
              ? transaction.getStockBatch().getId()
              : null;
      ForecastAccumulator accumulator =
          accumulators.computeIfAbsent(
              forecastKey(partyId, stockItemId, stockBatchId, null),
              ignored ->
                  new ForecastAccumulator(partyId, stockItemId, stockBatchId, null, months.size()));
  ...
  private void getStockInventoryExpiryForecastData(
      StockItemInventorySearchFilter filter, Function<Object[], Boolean> consumer) {
    if (consumer == null) {
      return;
    }
    ...
    for (StockItemTransaction transaction : forecastTransactions(safeFilter, true)) {
      ...
      ForecastAccumulator accumulator =
          accumulators.computeIfAbsent(
              ...
              ignored ->
                  new ForecastAccumulator(
                      null, stockItemId, stockBatchId, expiration, months.size()));
  ...
  private List<StockItemTransaction> forecastTransactions(
      StockItemInventorySearchFilter filter, boolean requireExpiringBatch) {
    Date today = DateUtil.today();
    return query(
            StockItemTransaction.class,
            (cb, root) -> {
              List<Predicate> predicates = new ArrayList<>();
              Join<StockItemTransaction, StockBatch> batch =
                  root.join("stockBatch", JoinType.INNER);
              Join<StockItemTransaction, StockItem> stockItem =
                  root.join("stockItem", JoinType.INNER);
              Join<StockItemTransaction, StockItemPackagingUOM> uom =
                  root.join("stockItemPackagingUOM", JoinType.INNER);
              ...
              if (requireExpiringBatch) {
                ...
                predicates.add(
                    cb.or(
                        cb.isNull(batch.get("expiration")),
                        cb.greaterThan(batch.<Date>get("expiration"), filter.getStartDate())));
              }
              if (filter.getStockItemCategoryConceptId() != null) {
                predicates.add(
                    cb.equal(
                        stockItem.get("category").get("conceptId"),
        ...
        .filter(
            transaction ->
                !requireExpiringBatch || transaction.getStockBatch().getExpiration() != null)
        .filter(
            transaction ->
                transaction.getStockBatch().getExpiration() == null
                    || transaction.getStockBatch().getExpiration().after(today)
                    || transaction.getDateCreated() != null)
        .sorted(
            Comparator.comparing(
                    (StockItemTransaction transaction) ->
                        transaction.getStockItem() == null
                            ? null
                            : transaction.getStockItem().getId(),
                    Comparator.nullsLast(Integer::compareTo))
                .thenComparing(
                    transaction ->
                        transaction.getStockBatch() == null
                            ? null
                            : transaction.getStockBatch().getExpiration(),
                    Comparator.nullsLast(Date::compareTo))
                .thenComparing(this::objectId, Comparator.nullsLast(Integer::compareTo)))
        .collect(Collectors.toList());
  }

  private boolean matchesForecastFilters(
      StockItemTransaction transaction, StockItemInventorySearchFilter filter) {
  ...
  private boolean hasForecastItemGroupConstraint(
  ...
  private boolean forecastItemGroupMatches(
      StockItemTransaction transaction, StockItemInventorySearchFilter.ItemGroupFilter group) {
    Party party = transaction.getParty();
    StockItem stockItem = transaction.getStockItem();
    StockBatch batch = transaction.getStockBatch();
    if (group.getPartyIds() != null
        && !group.getPartyIds().isEmpty()
        && (party == null || !group.getPartyIds().contains(party.getId()))) {
      return false;
    }
    if (group.getPartyUuids() != null
        && !group.getPartyUuids().isEmpty()
    ...
    return group.getStockBatchIds() == null
        || group.getStockBatchIds().isEmpty()
        || (batch != null && group.getStockBatchIds().contains(batch.getId()));
  }

  private void addForecastTransaction(
      ForecastAccumulator accumulator,
      StockItemTransaction transaction,
    ...
    if (transaction.getQuantity() == null
        ...
        || transaction.getDateCreated() == null
        || transaction.getDateCreated().before(filter.getStartDate())
        || transaction.getDateCreated().after(filter.getEndDate())) {
      return;
    }
    int monthIndex = forecastMonthIndex(transaction.getDateCreated(), months);
    if (monthIndex >= 0) {
      accumulator.consumedByMonth[monthIndex] =
          accumulator.consumedByMonth[monthIndex].add(quantity.abs());
    }
  }
  ...
  private String forecastKey(
      Integer partyId, Integer stockItemId, Integer stockBatchId, Date expiration) {
    return partyId
        + ":"
        + stockItemId
        + ":"
  ...
  private void setStockItemInformation(List<StockItemInventory> inventories) {
    ...
    Map<Integer, StockBatch> stockBatches =
        listByIds(
                StockBatch.class,
                "id",
                inventories.stream()
  ...
  private List<StockItemInventory> computeStockInventory(
      StockItemInventorySearchFilter filter,
      HashSet<RecordPrivilegeFilter> recordPrivilegeFilters) {
    List<StockItemInventorySearchFilter.ItemGroupFilter> itemGroupFilters =
        filter.getItemGroupFilters();
    if (filter.isRequireItemGroupFilters()
        && (itemGroupFilters == null || itemGroupFilters.isEmpty())) {
      return new ArrayList<>();
    }
    Set<Integer> allowedPartyIds = allowedPartyIds(recordPrivilegeFilters);
    if (allowedPartyIds != null && allowedPartyIds.isEmpty()) {
    ...
    Set<Integer> unrestrictedPartyIds =
        filter.getUnRestrictedPartyIds() == null
            ? new HashSet<>()
            : new HashSet<>(filter.getUnRestrictedPartyIds());
    if (allowedPartyIds != null) {
      requestedPartyIds =
          requestedPartyIds.isEmpty()
              ? new HashSet<>(allowedPartyIds)
              : requestedPartyIds.stream()
                  .filter(
                      partyId ->
                          allowedPartyIds.contains(partyId)
                              || unrestrictedPartyIds.contains(partyId))
                  .collect(Collectors.toSet());
    ...
    Map<String, StockItemInventory> inventoryByKey = new LinkedHashMap<>();
    for (StockItemTransaction transaction :
        query(
            StockItemTransaction.class,
            (cb, root) -> {
              List<Predicate> predicates = new ArrayList<>();
              ...
              if (queryFilter.getDate() != null) {
                predicates.add(
                    cb.lessThanOrEqualTo(root.<Date>get("dateCreated"), queryFilter.getDate()));
              }
              if (queryFilter.getStartDate() != null) {
                predicates.add(
                    cb.greaterThanOrEqualTo(
                        root.<Date>get("dateCreated"), queryFilter.getStartDate()));
              }
              if (queryFilter.getEndDate() != null) {
                predicates.add(
                    cb.lessThanOrEqualTo(root.<Date>get("dateCreated"), queryFilter.getEndDate()));
              }
              if (queryFilter.getStockItemCategoryConceptId() != null) {
                predicates.add(
                    cb.equal(
                        root.get("stockItem").get("category").get("conceptId"),
    ...
    inventories.sort(
        Comparator.comparing(
                StockItemInventory::getPartyId, Comparator.nullsLast(Integer::compareTo))
            .thenComparing(
                StockItemInventory::getStockItemId, Comparator.nullsLast(Integer::compareTo))
            .thenComparing(
                StockItemInventory::getStockBatchId, Comparator.nullsLast(Integer::compareTo)));
  ...
  private void addInventoryTransaction(
      StockItemInventorySearchFilter filter,
      Map<String, StockItemInventory> inventoryByKey,
      StockItemTransaction transaction) {
    ...
    Party party =
        filter.getInventoryGroupBy()
                == StockItemInventorySearchFilter.InventoryGroupBy.StockItemOnly
            ? null
    ...
    StockItemInventory inventory =
        inventoryByKey.computeIfAbsent(
            key, ignored -> inventoryRow(party, transaction.getStockItem(), batch));
    inventory.setQuantity(
        (inventory.getQuantity() == null ? BigDecimal.ZERO : inventory.getQuantity())
            .add(quantity));
  }
  ...
  private Set<Integer> inventoryPartyIds(
      List<StockItemInventorySearchFilter.ItemGroupFilter> filters) {
    if (filters == null) {
      return new HashSet<>();
    }
    Set<Integer> partyIds =
        filters.stream()
            .filter(Objects::nonNull)
            .flatMap(
                filter ->
                    filter.getPartyIds() == null
  ...
  private Set<Integer> inventoryStockItemIds(
      List<StockItemInventorySearchFilter.ItemGroupFilter> filters) {
    if (filters == null) {
      return new HashSet<>();
    }
    Set<Integer> stockItemIds =
        filters.stream()
            .filter(Objects::nonNull)
            .map(StockItemInventorySearchFilter.ItemGroupFilter::getStockItemId)
            .filter(Objects::nonNull)
            .collect(Collectors.toSet());
    List<String> stockItemUuids =
        filters.stream()
            .filter(Objects::nonNull)
  ...
  private Set<Integer> inventoryStockBatchIds(
      List<StockItemInventorySearchFilter.ItemGroupFilter> filters) {
    if (filters == null) {
      return new HashSet<>();
    }
  ...
  private List<StockItemInventory> inventoryTotals(
      StockItemInventorySearchFilter filter, List<StockItemInventory> inventories) {
    ...
    for (StockItemInventory inventory : inventories) {
      String key =
          inventoryKey(
              filter.getTotalBy() == StockItemInventorySearchFilter.InventoryGroupBy.StockItemOnly
                  ? null
                  : inventory.getPartyId(),
              inventory.getStockItemId(),
              filter.getTotalBy()
                      == StockItemInventorySearchFilter.InventoryGroupBy.LocationStockItemBatchNo
                  ? inventory.getStockBatchId()
                  : null);
      StockItemInventory total =
          totalsByKey.computeIfAbsent(
              key,
              ignored -> {
                ...
                row.setStockBatchId(
                    filter.getTotalBy()
                            == StockItemInventorySearchFilter.InventoryGroupBy
      ...
      total.setQuantity(
          total
              .getQuantity()
              .add(inventory.getQuantity() == null ? BigDecimal.ZERO : inventory.getQuantity()));
    }
  ...
  private StockItemPackagingUOMDTO preferredPackagingUom(
      BigDecimal value,
      List<StockItemPackagingUOMDTO> uoms,
      boolean isDispensing,
      boolean uomPriorityIsBigToSmall,
      Integer preferredStockItemPackagingUomId) {
    if (value == null || uoms == null || uoms.isEmpty()) {
      return null;
    }
    Comparator<StockItemPackagingUOMDTO> comparator =
        Comparator.comparing(
                StockItemPackagingUOMDTO::getIsDefaultStockOperationsUoM,
                Comparator.nullsLast(Boolean::compareTo))
            .reversed();
    if (isDispensing || !uomPriorityIsBigToSmall) {
      comparator =
          comparator.thenComparing(
              StockItemPackagingUOMDTO::getFactor, Comparator.nullsLast(BigDecimal::compareTo));
    } else {
      comparator =
          comparator.thenComparing(
              Comparator.comparing(
                      StockItemPackagingUOMDTO::getFactor,
                      Comparator.nullsLast(BigDecimal::compareTo))
                  .reversed());
    }
    ...
    for (StockItemPackagingUOMDTO uom : uoms) {
      ...
      if (value.divide(uom.getFactor(), 5, RoundingMode.HALF_EVEN).abs().compareTo(BigDecimal.ONE)
          >= 0) {
  ...
  private Result<StockOperationLinkDTO> findStockOperationLinks(
    ...
    if (StringUtils.isBlank(parentOrChildStockOperationUuid)
        && StringUtils.isBlank(childStockOperationUuid)) {
      return new Result<>(new ArrayList<>(), 0);
    }
    List<StockOperationLinkDTO> links =
        query(
                StockOperationLink.class,
                (cb, root) -> {
                  List<Predicate> predicates = new ArrayList<>();
                  Join<StockOperationLink, StockOperation> parent =
                      root.join("parent", JoinType.INNER);
                  Join<StockOperationLink, StockOperation> child =
                      root.join("child", JoinType.INNER);
  ...
  private Result<StockOperationDTO> findStockOperations(
    ...
    StockOperationSearchFilter safeFilter =
        filter == null ? new StockOperationSearchFilter() : filter;
    List<StockOperationDTO> operations =
        query(
                StockOperation.class,
                (cb, root) -> {
                  List<Predicate> predicates = new ArrayList<>();
                  Join<StockOperation, StockOperationType> operationType =
                      root.join("stockOperationType", JoinType.INNER);
                  ...
                  Join<Party, Location> destinationLocation =
                      destination.join("location", JoinType.LEFT);
                  Join<Party, StockSource> sourceStockSource =
                      source.join("stockSource", JoinType.LEFT);
                  Join<Party, StockSource> destinationStockSource =
                      destination.join("stockSource", JoinType.LEFT);
                  Join<StockSource, Concept> sourceType =
                      sourceStockSource.join("sourceType", JoinType.LEFT);
                  Join<StockSource, Concept> destinationType =
                      destinationStockSource.join("sourceType", JoinType.LEFT);
                  ...
                  if (safeFilter.getLocationId() != null) {
                    predicates.add(
                        cb.or(
                            ...
                            cb.equal(
                                destinationLocation.get("locationId"),
                                safeFilter.getLocationId())));
                  }
                  ...
                  if (safeFilter.getStockSourceId() != null) {
                    predicates.add(
                        cb.or(
                            ...
                            cb.equal(
                                destinationStockSource.get("id"), safeFilter.getStockSourceId())));
                  }
                  if (safeFilter.getOperationTypeId() != null
                      && !safeFilter.getOperationTypeId().isEmpty()) {
                  ...
                  if (safeFilter.getOperationDateMin() != null) {
                    predicates.add(
                        cb.greaterThanOrEqualTo(
                            root.<Date>get("operationDate"), safeFilter.getOperationDateMin()));
                  }
                  if (safeFilter.getOperationDateMax() != null) {
                    predicates.add(
                        cb.lessThanOrEqualTo(
                            root.<Date>get("operationDate"), safeFilter.getOperationDateMax()));
                  }
                  if (StringUtils.isNotBlank(safeFilter.getOperationNumber())) {
                    ...
                    predicates.add(
                        cb.like(
                            cb.upper(root.get("operationNumber").as(String.class)),
                  ...
                  if (safeFilter.getSourceTypeIds() != null
                      && !safeFilter.getSourceTypeIds().isEmpty()) {
                    predicates.add(
                        cb.or(
                  ...
                  if (StringUtils.isNotBlank(safeFilter.getSearchText())) {
                    String query =
                        safeFilter.getSearchText().replace("%", "").toLowerCase(Locale.ROOT);
                    if (query.isEmpty()) {
                      return predicates(cb.disjunction());
                    }
                    String term = query + "%";
                    predicates.add(
                        cb.or(
                            ...
                            cb.like(
                                cb.lower(destinationLocation.get("name").as(String.class)), term),
                            cb.like(cb.lower(sourceStockSource.get("name").as(String.class)), term),
                            cb.like(
                                cb.lower(destinationStockSource.get("name").as(String.class)),
                                term)));
                  }
                  if (!safeFilter.getIncludeVoided()) {
                    predicates.add(cb.isFalse(root.get("voided")));
                  ...
                  if (safeFilter.getStockItemId() != null) {
                    Join<StockOperation, StockOperationItem> item =
                        root.join("stockOperationItems", JoinType.INNER);
                    predicates.add(
                        cb.equal(item.get("stockItem").get("id"), safeFilter.getStockItemId()));
                    predicates.add(cb.isFalse(item.get("voided")));
                  }
                  addRecordPrivilegePredicates(
                      cb,
                      predicates,
                      operationType,
                      sourceLocation,
  ...
  private void addRecordPrivilegePredicates(
      CriteriaBuilder cb,
      List<Predicate> predicates,
      Join<StockOperation, StockOperationType> operationType,
      Join<Party, Location> sourceLocation,
      Join<Party, Location> destinationLocation,
      HashSet<RecordPrivilegeFilter> recordPrivilegeFilters) {
    if (recordPrivilegeFilters == null) {
      return;
    }
    List<Predicate> allowedScopes =
        recordPrivilegeFilters.stream()
                ...
                scope ->
                    cb.and(
                        ...
                        cb.or(
                            ...
                            cb.equal(
                                destinationLocation.get("locationId"), scope.getLocationId()))))
            .collect(Collectors.toList());
    predicates.add(
  ...
  private StockOperationDTO stockOperationToDto(StockOperation operation) {
    ...
    setUser(
        dto::setCreator,
        dto::setCreatorGivenName,
        dto::setCreatorFamilyName,
  ...
  private Result<StockItemDTO> findStockItems(StockItemSearchFilter filter) {
    StockItemSearchFilter safeFilter = filter == null ? new StockItemSearchFilter() : filter;
    List<StockItemDTO> dtos =
        queryStockItems(safeFilter).stream()
            .sorted(Comparator.comparing(this::objectId, Comparator.nullsLast(Integer::compareTo)))
    ...
    return query(
        ...
        (cb, root) -> {
          ...
          if (filter.getIsDrug() != null) {
            predicates.add(
                filter.getIsDrug()
                    ? cb.isNotNull(drug.get("drugId"))
                    : cb.isNull(drug.get("drugId")));
          }
          ...
          if (!drugConceptPredicates.isEmpty()) {
            predicates.add(
                filter.getSearchEitherDrugsOrConcepts()
  ...
  private List<Integer> searchStockItemCommonName(
      String text, Boolean isDrugSearch, boolean includeAll, int maxItems) {
    if (StringUtils.isBlank(text) || maxItems <= 0) {
      return new ArrayList<>();
    }
    String term = "%" + text.trim().toLowerCase(Locale.ROOT).replace("%", "") + "%";
    List<StockItem> matches =
        query(
            StockItem.class,
            (cb, root) -> {
              List<Predicate> predicates = new ArrayList<>();
  ...
  private Object saveStockItem(Object[] args) {
    ...
    if (args.length == 2
        && args[0] instanceof StockItem
        && args[1] instanceof StockItemPackagingUOM) {
      ...
      restoreStockItemUomReferences(
          stockItem,
          uom,
          isDispensingUom,
          isDefaultOperationUom,
          isPurchasePriceUom,
          isReorderLevelUom);
  ...
  private void clearTransientStockItemUomReferences(
      StockItem stockItem, StockItemPackagingUOM uom) {
  ...
  private void restoreStockItemUomReferences(
      StockItem stockItem,
      StockItemPackagingUOM uom,
      boolean dispensing,
      boolean defaultOperation,
      boolean purchasePrice,
  ...
  private StockItem saveStockItem(StockItemDTO dto) {
    ...
    stockItem.setPreferredVendor(
        StringUtils.isBlank(dto.getPreferredVendorUuid())
            ? null
            : requireByUuid(
                StockSource.class, dto.getPreferredVendorUuid(), "Stock source not found"));
    stockItem.setDispensingUnit(
        StringUtils.isBlank(dto.getDispensingUnitUuid())
            ? null
            : requireByUuid(
                Concept.class, dto.getDispensingUnitUuid(), "Dispensing unit concept not found"));
    stockItem.setCategory(
        StringUtils.isBlank(dto.getCategoryUuid())
            ? null
    ...
    if (!isNew) {
      ...
      stockItem.setPurchasePriceUoM(
          StringUtils.isBlank(dto.getPurchasePriceUoMUuid())
              ? null
              : requireRelatedUom(dto.getPurchasePriceUoMUuid(), stockItem));
      stockItem.setReorderLevel(dto.getReorderLevel());
      stockItem.setReorderLevelUOM(
          StringUtils.isBlank(dto.getReorderLevelUoMUuid())
              ? null
              : requireRelatedUom(dto.getReorderLevelUoMUuid(), stockItem));
      stockItem.setDispensingUnitPackagingUoM(
          StringUtils.isBlank(dto.getDispensingUnitPackagingUoMUuid())
              ? null
              : requireRelatedUom(dto.getDispensingUnitPackagingUoMUuid(), stockItem));
      stockItem.setDefaultStockOperationsUoM(
          StringUtils.isBlank(dto.getDefaultStockOperationsUoMUuid())
              ? null
  ...
  private void ensureNoExistingStockItemForDrug(Drug drug) {
    if (!stockItemsByDrug(drug.getDrugId()).stream()
  ...
  private StockItemPackagingUOM requireRelatedUom(String uuid, StockItem stockItem) {
    StockItemPackagingUOM uom =
        requireByUuid(StockItemPackagingUOM.class, uuid, "Stock item UOM not found");
    if (uom.getStockItem() == null
        || !Objects.equals(uom.getStockItem().getId(), stockItem.getId())) {
  ...
  private StockRuleDTO saveStockRule(StockRuleDTO dto) {
    ...
    StockItem stockItem =
        requireByUuid(StockItem.class, dto.getStockItemUuid(), "Stock item not found");
    ...
    if (!isNew
        && stockRule.getLastEvaluation() != null
        && dto.getEvaluationFrequency() != null
        && !Objects.equals(dto.getEvaluationFrequency(), stockRule.getEvaluationFrequency())) {
      stockRule.setNextEvaluation(
          addMinutes(stockRule.getLastEvaluation(), boundedMinutes(dto.getEvaluationFrequency())));
    }
  ...
  private void validateStockRule(StockRuleDTO dto) {
    ...
    if (dto.getEvaluationFrequency() == null || dto.getEvaluationFrequency() <= 0) {
      throw new StockManagementException(
          "Stock rule evaluation frequency must be greater than zero");
    }
  ...
  private Result<StockRuleDTO> findStockRules(
    ...
    Set<Integer> allowedLocationIds =
        recordPrivilegeFilters == null
            ? null
            : recordPrivilegeFilters.stream()
                .map(RecordPrivilegeFilter::getLocationId)
                .filter(Objects::nonNull)
    ...
    List<StockRuleDTO> dtos =
        query(
                ...
                (cb, root) -> {
                  ...
                  if (safeFilter.getStockItemUuids() != null
                      && !safeFilter.getStockItemUuids().isEmpty()) {
                    predicates.add(stockItem.get("uuid").in(safeFilter.getStockItemUuids()));
                  }
                  if (safeFilter.getLocationUuids() != null
                      && !safeFilter.getLocationUuids().isEmpty()) {
                  ...
                  addNullableDateRangePredicate(
                      cb,
                      predicates,
                      root,
                      "lastEvaluation",
                      safeFilter.getLastEvaluationMin(),
                      safeFilter.getLastEvaluationMax());
                  addNullableDateRangePredicate(
                      cb,
                      predicates,
                      root,
                      "nextEvaluation",
                      safeFilter.getNextEvaluationMin(),
                      safeFilter.getNextEvaluationMax());
                  addNullableDateRangePredicate(
                      cb,
                      predicates,
                      root,
                      "lastActionDate",
                      safeFilter.getLastActionDateMin(),
                      safeFilter.getLastActionDateMax());
                  if (safeFilter.getHasNotificationRoleSet() != null) {
                    Predicate alertSet =
                        cb.and(
                            cb.isNotNull(root.get("alertRole")),
                            cb.notEqual(root.get("alertRole"), ""));
                    Predicate mailSet =
                        cb.and(
                            cb.isNotNull(root.get("mailRole")),
                            cb.notEqual(root.get("mailRole"), ""));
                    predicates.add(
                        safeFilter.getHasNotificationRoleSet()
  ...
  private void addNullableDateRangePredicate(
      CriteriaBuilder cb,
      List<Predicate> predicates,
      Root<StockRule> root,
      String field,
    ...
    if (min != null) {
      predicates.add(
          cb.or(cb.greaterThanOrEqualTo(root.<Date>get(field), min), cb.isNull(root.get(field))));
    }
    if (max != null) {
      predicates.add(
          cb.or(cb.lessThanOrEqualTo(root.<Date>get(field), max), cb.isNull(root.get(field))));
    }
  }
        ...
        query(
            ...
            (cb, root) -> {
              ...
              if (StringUtils.isNotBlank(safeFilter.getTextSearch())) {
                String term =
                    safeFilter.getTextSearch().replace("%", "").toLowerCase(Locale.ROOT) + "%";
                predicates.add(
                    cb.or(
  ...
  private Result<PartyDTO> findParty(PartySearchFilter filter) {
    ...
    List<PartyDTO> dtos =
        parties.stream()
            ...
            .sorted(
                Comparator.comparing(
                    PartyDTO::getName, Comparator.nullsLast(String::compareToIgnoreCase)))
            .collect(Collectors.toList());
    return resultFromList(dtos, safeFilter.getStartIndex(), safeFilter.getLimit());
  }
  ...
  private List<Party> findParty(Boolean hasLocation, Boolean hasStockSource) {
    return query(
        ...
        (cb, root) -> {
          ...
          if (hasLocation != null) {
            predicates.add(
                hasLocation ? cb.isNotNull(root.get("location")) : cb.isNull(root.get("location")));
          }
          if (hasStockSource != null) {
            predicates.add(
                hasStockSource
                    ? cb.isNotNull(root.get("stockSource"))
                    : cb.isNull(root.get("stockSource")));
          }
          return predicates;
        });
  }
  ...
  private List<PartyDTO> getAllParties() {
    return sortedById(listAll(Party.class)).stream()
        .map(this::partyToDto)
        .collect(Collectors.toList());
  }
  ...
  private PartyDTO partyToDto(Party party) {
    ...
    if (party.getLocation() != null) {
      ...
      dto.setTags(
          party.getLocation().getTags().stream()
  ...
  private Result<StockItemPackagingUOMDTO> findStockItemPackagingUOMs(
      StockItemPackagingUOMSearchFilter filter) {
    StockItemPackagingUOMSearchFilter safeFilter =
        filter == null ? new StockItemPackagingUOMSearchFilter() : filter;
    List<StockItemPackagingUOMDTO> dtos =
        query(
                StockItemPackagingUOM.class,
                (cb, root) -> {
                  List<Predicate> predicates = new ArrayList<>();
                  Join<StockItemPackagingUOM, StockItem> stockItem =
                      root.join("stockItem", JoinType.LEFT);
                  if (StringUtils.isNotBlank(safeFilter.getUuid())) {
                    predicates.add(cb.equal(root.get("uuid"), safeFilter.getUuid()));
                  }
                  if (safeFilter.getStockItemIds() != null
                      && !safeFilter.getStockItemIds().isEmpty()) {
  ...
  private Object saveStockItemPackagingUOM(Object arg) {
    ...
    uom.setPackagingUom(
        requireByUuid(Concept.class, dto.getPackagingUomUuid(), "Packaging UOM concept not found"));
    uom.setFactor(dto.getFactor());
    return saveOrUpdate(uom);
  }

  private StockItemPackagingUOMDTO stockItemPackagingUomToDto(
      StockItemPackagingUOM uom, boolean includeDispensingUnit) {
    ...
    if (stockItem != null) {
      dto.setStockItemId(stockItem.getId());
      dto.setStockItemUuid(stockItem.getUuid());
      dto.setIsDispensingUnit(
          stockItem.getDispensingUnitPackagingUoM() != null
              && Objects.equals(stockItem.getDispensingUnitPackagingUoM().getId(), uom.getId()));
      dto.setIsDefaultStockOperationsUoM(
          stockItem.getDefaultStockOperationsUoM() != null
    ...
    List<StockBatchDTO> batches =
        query(
                ...
                (cb, root) -> {
                  ...
                  if (safeFilter.getStockBatchIds() != null
                      && !safeFilter.getStockBatchIds().isEmpty()) {
  ...
  private Map<Integer, BigDecimal> stockBatchBalancesForParty(
    ...
    return query(
            ...
            (cb, root) ->
                predicates(
                    cb.equal(root.get("party"), party),
                    root.get("stockBatch").get("id").in(batchIds)))
        .stream()
        .filter(transaction -> transaction.getStockBatch() != null)
        .collect(
            Collectors.groupingBy(
                ...
                Collectors.reducing(
                    BigDecimal.ZERO, this::stockItemTransactionQuantity, BigDecimal::add)));
  }

  private BigDecimal stockItemTransactionQuantity(StockItemTransaction transaction) {
    BigDecimal quantity =
        transaction.getQuantity() == null ? BigDecimal.ZERO : transaction.getQuantity();
    StockItemPackagingUOM uom = transaction.getStockItemPackagingUOM();
  ...
  private List<StockBatchDTO> getExpiringStockBatchesDueForNotification(
    ...
    return query(
        ...
        .stream()
        .filter(
            batch -> expiresWithinNoticePeriod(batch, today, defaultExpiryNotificationNoticePeriod))
        .sorted(
            Comparator.comparing(StockBatch::getExpiration, Comparator.nullsLast(Date::compareTo))
                .thenComparing(this::objectId, Comparator.nullsLast(Integer::compareTo)))
        .map(this::stockBatchToDto)
        .collect(Collectors.toList());
  }

  private boolean expiresWithinNoticePeriod(
      StockBatch batch, Date today, Integer defaultNoticePeriod) {
  ...
  private Result<StockOperationLineItem> findStockOperationLineItems(
      StockOperationLineItemFilter filter) {
    StockOperationLineItemFilter safeFilter =
        filter == null ? new StockOperationLineItemFilter() : filter;
    Set<Integer> atLocationIds =
        reportLocationIds(safeFilter.getAtLocationId(), safeFilter.getChildLocations());
    Set<Integer> sourcePartyIds =
        reportPartyIds(safeFilter.getSourcePartyId(), safeFilter.getSourcePartyChildLocations());
    Set<Integer> destinationPartyIds =
        reportPartyIds(
            safeFilter.getDestinationPartyId(), safeFilter.getDestinationPartyChildLocations());
    ...
    Set<Integer> operationTypeIds =
        safeFilter.getStockOperationTypes() == null
            ? Set.of()
            : safeFilter.getStockOperationTypes().stream()
                .map(StockOperationType::getId)
                .filter(Objects::nonNull)
                .collect(Collectors.toSet());
    List<StockOperationLineItem> lineItems =
        query(
                StockOperationItem.class,
                (cb, root) -> {
                  List<Predicate> predicates = new ArrayList<>();
                  Join<StockOperationItem, StockOperation> operation =
                      root.join("stockOperation", JoinType.INNER);
                  Join<StockOperationItem, StockItem> stockItem =
                      root.join("stockItem", JoinType.INNER);
                  Join<StockOperation, Location> atLocation =
                      operation.join("atLocation", JoinType.LEFT);
                  Join<StockOperation, Party> source = operation.join("source", JoinType.LEFT);
                  Join<StockOperation, Party> destination =
                      operation.join("destination", JoinType.LEFT);
                  if (safeFilter.getStockOperationIdMin() != null) {
                    predicates.add(
                        cb.greaterThanOrEqualTo(
                            operation.get("id"), safeFilter.getStockOperationIdMin()));
                  }
                  if (safeFilter.getStockOperationItemIdMin() != null) {
                    predicates.add(
                        cb.greaterThan(root.get("id"), safeFilter.getStockOperationItemIdMin()));
                  }
                  ...
                  addInPredicate(
                      predicates, operation.get("stockOperationType").get("id"), operationTypeIds);
                  addInPredicate(
                      predicates, operation.get("status"), safeFilter.getStockOperationStatuses());
                  if (safeFilter.getStartDate() != null) {
                    predicates.add(
                        cb.greaterThanOrEqualTo(
                            operation.<Date>get("dateCreated"), safeFilter.getStartDate()));
                  }
                  if (safeFilter.getEndDate() != null) {
                    predicates.add(
                        cb.lessThanOrEqualTo(
                            operation.<Date>get("dateCreated"), safeFilter.getEndDate()));
                  }
            ...
            .sorted(
                Comparator.comparing(
                        (StockOperationItem item) ->
                            item.getStockOperation() == null
                                ? null
                                : item.getStockOperation().getId(),
                        Comparator.nullsLast(Integer::compareTo))
                    .thenComparing(this::objectId, Comparator.nullsLast(Integer::compareTo)))
            .map(this::stockOperationLineItem)
            .collect(Collectors.toList());
    return reportResultFromList(
        lineItems,
        safeFilter.getStartIndex(),
        safeFilter.getLimit(),
  ...
  private void setStockOperationLineStockItem(
      StockOperationLineItem lineItem, StockItem stockItem) {
    if (stockItem == null) {
      return;
    }
  ...
  private void setStockOperationLineUom(
      StockOperationLineItem lineItem, StockItemPackagingUOM uom) {
    if (uom == null) {
      return;
    }
  ...
  private void setStockOperationLineRequestedUom(
      StockOperationLineItem lineItem, StockItemPackagingUOM uom) {
    if (uom == null) {
      return;
    }
  ...
  private void setStockOperationLineOperation(
      StockOperationLineItem lineItem, StockOperation operation) {
    if (operation == null) {
      return;
    }
    ...
    lineItem.setDestinationName(
        operation.getDestination() == null ? null : partyName(operation.getDestination()));
    ...
    setLineUser(
        operation.getCompletedBy(),
        lineItem::setCompletedBy,
        lineItem::setCompletedByGivenName,
        lineItem::setCompletedByFamilyName);
    setLineUser(
        operation.getResponsiblePerson(),
        lineItem::setResponsiblePerson,
        lineItem::setResponsiblePersonGivenName,
        lineItem::setResponsiblePersonFamilyName);
    setLineUser(
        operation.getCreator(),
        lineItem::setCreator,
        lineItem::setCreatorGivenName,
        lineItem::setCreatorFamilyName);
    if (operation.getParentStockOperationLinks() != null) {
      operation.getParentStockOperationLinks().stream()
          ...
          .ifPresent(
              link ->
                  lineItem.setRequisitionOperationNumber(link.getParent().getOperationNumber()));
    }
  }
  ...
  private Result<DispensingLineItem> findDispensingLineItems(DispensingLineFilter filter) {
    ...
    List<DispensingLineItem> lineItems =
        query(
                StockItemTransaction.class,
                (cb, root) -> {
                  List<Predicate> predicates = new ArrayList<>();
                  ...
                  if (safeFilter.getStockItemTransactionMin() != null) {
                    predicates.add(
                        cb.greaterThan(root.get("id"), safeFilter.getStockItemTransactionMin()));
                  }
                  ...
                  if (safeFilter.getStartDate() != null) {
                    predicates.add(
                        cb.greaterThanOrEqualTo(
                            root.<Date>get("dateCreated"), safeFilter.getStartDate()));
                  }
                  if (safeFilter.getEndDate() != null) {
                    predicates.add(
                        cb.lessThanOrEqualTo(
                            root.<Date>get("dateCreated"), safeFilter.getEndDate()));
                  }
                  if (safeFilter.getStockItemCategoryConceptId() != null) {
                    predicates.add(
                        cb.equal(
  ...
  private void setDispensingLineDrugOrder(DispensingLineItem lineItem, DrugOrder order) {
    ...
    lineItem.setFrequencyPerDay(
        order.getFrequency() == null ? null : order.getFrequency().getFrequencyPerDay());
    ...
    setConcept(
        lineItem::setDoseUnitsConceptId, lineItem::setDoseUnitsConceptName, order.getDoseUnits());
    setConcept(
        lineItem::setFrequencyConceptId,
        lineItem::setFrequencyConceptName,
        order.getFrequency() == null ? null : order.getFrequency().getConcept());
    setConcept(
        lineItem::setQuantityUnitsConceptId,
        lineItem::setQuantityUnitsConceptName,
        order.getQuantityUnits());
    setConcept(
        lineItem::setDurationUnitsConceptId,
        lineItem::setDurationUnitsConceptName,
        ...
        query(
                ...
                (cb, root) -> {
                  ...
                  if (safeFilter.getPrescriptionTransactionMin() != null) {
                    predicates.add(
                        cb.greaterThan(
                            root.get("orderId"), safeFilter.getPrescriptionTransactionMin()));
                  }
            ...
            .stream()
            .sorted(
                Comparator.comparing(Order::getOrderId, Comparator.nullsLast(Integer::compareTo)))
            .collect(Collectors.toList());

    Map<Integer, StockItem> stockItemsByDrugId =
        stockItemsByDrugId(
            orders.stream()
                ...
                .map(Drug::getDrugId)
                .collect(Collectors.toSet()));
    Map<Integer, List<StockItemTransaction>> transactionsByOrderId =
        stockTransactionsByOrderId(
            orders.stream()
                .map(Order::getOrderId)
                .filter(Objects::nonNull)
                .collect(Collectors.toSet()));
    List<PrescriptionLineItem> lineItems = new ArrayList<>();
    boolean includeFulfillmentInfo =
        safeFilter.getFullfillments() != null && !safeFilter.getFullfillments().isEmpty();
    for (DrugOrder order : orders) {
      StockItem stockItem =
          order.getDrug() == null ? null : stockItemsByDrugId.get(order.getDrug().getDrugId());
      if (!prescriptionStockItemMatchesFilter(stockItem, safeFilter)) {
        continue;
      }
      List<StockItemTransaction> transactions =
          transactionsByOrderId.getOrDefault(order.getOrderId(), new ArrayList<>());
      ...
      BigDecimal dispensedQuantity =
          transactions.stream()
              ...
              .filter(Objects::nonNull)
              .reduce(BigDecimal.ZERO, BigDecimal::add);
      if (!matchesFulfillmentFilter(
          safeFilter.getFullfillments(),
          orderedQuantity,
          dispensedQuantity,
      ...
      if (transactions.isEmpty()) {
        ...
        transactions.forEach(
            transaction -> lineItems.add(prescriptionLineItem(order, stockItem, transaction)));
      }
    }
    return reportResultFromList(
        lineItems,
  ...
  private PrescriptionLineItem prescriptionLineItem(
      DrugOrder order, StockItem stockItem, StockItemTransaction transaction) {
    PrescriptionLineItem lineItem = new PrescriptionLineItem();
    lineItem.setId(order.getOrderId());
    lineItem.setOrderId(order.getOrderId());
    lineItem.setPreviousOrderId(
        order.getPreviousOrder() == null ? null : order.getPreviousOrder().getOrderId());
  ...
  private void setPrescriptionLineOrderUom(
      PrescriptionLineItem lineItem, DrugOrder order, StockItem stockItem) {
  ...
  private void setPrescriptionFulfillment(
      PrescriptionLineItem lineItem, StockItemTransaction transaction) {
    if (transaction == null) {
      return;
    }
    lineItem.setStockItemTransactionId(transaction.getId());
    ...
    setLineUser(
        transaction.getCreator(),
        lineItem::setDispenserUserId,
        lineItem::setDispenserGivenName,
        lineItem::setDispenserFamilyName);
    Party party = transaction.getParty();
    if (party != null) {
  ...
  private Set<Integer> dispensingPartyIds(DispensingLineFilter filter) {
    ...
    Location location =
        first(listByIds(Location.class, "locationId", List.of(filter.getAtLocationId())));
    if (location == null) {
      return Set.of();
    }
    Party party = firstByEntity(Party.class, "location", location);
  ...
  private <T> Result<T> reportResultFromList(
      List<T> data, int pageIndex, int limit, boolean keysetPaging) {
  ...
  private Map<Integer, StockItem> stockItemsByDrugId(Collection<Integer> drugIds) {
    ...
    return query(
        ...
        .collect(
            Collectors.toMap(
                stockItem -> stockItem.getDrug().getDrugId(),
                Function.identity(),
                (existing, ignored) -> existing,
                LinkedHashMap::new));
  }

  private Map<Integer, List<StockItemTransaction>> stockTransactionsByOrderId(
    ...
    return query(
            StockItemTransaction.class,
            (cb, root) -> predicates(root.get("order").get("orderId").in(orderIds)))
        .stream()
        .filter(
            transaction ->
        ...
        .collect(
            Collectors.groupingBy(
                transaction -> transaction.getOrder().getOrderId(),
                LinkedHashMap::new,
                Collectors.toList()));
  }

  private boolean prescriptionStockItemMatchesFilter(
      StockItem stockItem, PrescriptionLineFilter filter) {
    if (filter.getStockItemId() != null
        && (stockItem == null || !Objects.equals(stockItem.getId(), filter.getStockItemId()))) {
      return false;
    }
    return filter.getStockItemCategoryConceptId() == null
        || (stockItem != null
            && stockItem.getCategory() != null
            && Objects.equals(
                stockItem.getCategory().getConceptId(), filter.getStockItemCategoryConceptId()));
  }
  ...
  private Result<StockBatchLineItem> getExpiringStockBatchList(StockExpiryFilter filter) {
    ...
    List<StockBatchLineItem> lineItems =
        query(
                StockBatch.class,
                (cb, root) -> {
                  List<Predicate> predicates = new ArrayList<>();
                  ...
                  if (safeFilter.getStartDate() != null) {
                    predicates.add(
                        cb.greaterThanOrEqualTo(
                            root.<Date>get("expiration"), safeFilter.getStartDate()));
                  }
                  if (safeFilter.getEndDate() != null) {
                    predicates.add(
                        cb.lessThanOrEqualTo(
                            root.<Date>get("expiration"), safeFilter.getEndDate()));
                  }
                  ...
                  if (safeFilter.getStockItemIdMin() != null) {
                    predicates.add(
                        cb.greaterThan(stockItem.get("id"), safeFilter.getStockItemIdMin()));
                  }
                  if (safeFilter.getStockItemCategoryConceptId() != null) {
                    predicates.add(
                        cb.equal(
            ...
            .sorted(
                Comparator.comparing(
                        (StockBatch batch) ->
                            batch.getStockItem() == null ? null : batch.getStockItem().getId(),
                        Comparator.nullsLast(Integer::compareTo))
                    .thenComparing(this::objectId, Comparator.nullsLast(Integer::compareTo)))
  ...
  private boolean matchesItemGroup(StockItem item, StockItemSearchFilter.ItemGroupFilter filter) {
    if (filter.getIsDrug() != null
        && !Objects.equals(Boolean.TRUE.equals(item.getIsDrug()), filter.getIsDrug())) {
      return false;
    }
    if (filter.getDrugId() != null
        && (item.getDrug() == null
            || !Objects.equals(item.getDrug().getDrugId(), filter.getDrugId()))) {
      return false;
    }
    return filter.getConceptId() == null
        || (item.getConcept() != null
            && Objects.equals(item.getConcept().getConceptId(), filter.getConceptId()));
  }
  ...
  private boolean uomMatchesFilter(
      StockItemPackagingUOM uom, StockItemPackagingUOMSearchFilter.ItemGroupFilter filter) {
    if (uom.getStockItem() == null
        || !Objects.equals(uom.getStockItem().getId(), filter.getStockItemId())) {
      return false;
    }
    return filter.getPackagingUomIds() == null
        || filter.getPackagingUomIds().isEmpty()
  ...
  private List<StockItem> stockItemsByConcept(Integer conceptId) {
    ...
    return query(
        ...
        (cb, root) -> {
          ...
          Join<StockItem, Concept> concept = root.join("concept", JoinType.LEFT);
          return predicates(
              cb.isNull(drug.get("drugId")), cb.equal(concept.get("conceptId"), conceptId));
        });
  }
  ...
  private StockItemPackagingUOM stockItemPackagingUOMByConcept(Object[] args) {
    ...
    List<StockItemPackagingUOM> matches =
        query(
            StockItemPackagingUOM.class,
            (cb, root) -> {
              Join<StockItemPackagingUOM, StockItem> stockItem =
                  root.join("stockItem", JoinType.LEFT);
              Join<StockItemPackagingUOM, Concept> packaging =
                  root.join("packagingUom", JoinType.LEFT);
              return predicates(
                  cb.equal(stockItem.get("id"), finalStockItemId),
                  cb.equal(packaging.get("conceptId"), finalConceptId));
            });
    matches.sort(
        Comparator.comparing((StockItemPackagingUOM uom) -> Boolean.TRUE.equals(uom.getVoided()))
            .thenComparing(this::objectId, Comparator.nullsLast(Integer::compareTo)));
  ...
  private List<OrderItem> getOrderItemsByOrder(Integer... orderIds) {
    ...
    return query(
        OrderItem.class, (cb, root) -> predicates(root.get("order").get("orderId").in(ids)));
  }
  ...
  private List<OrderItem> getOrderItemsByEncounter(Integer... encounterIds) {
    ...
    return query(
        OrderItem.class,
        (cb, root) -> predicates(root.get("order").get("encounter").get("encounterId").in(ids)));
  }
  ...
  private Result<OrderItemDTO> findOrderItems(
    ...
    Set<Integer> createdFromLocationIds =
        resolveOrderLocationIds(
            safeFilter.getCreatedFromLocationIds(),
            safeFilter.getCreatedFromLocationUuids(),
            safeFilter.getCreatedFromPartyUuids());
    if (hasOrderLocationFilter(
            safeFilter.getCreatedFromLocationIds(),
            safeFilter.getCreatedFromLocationUuids(),
            safeFilter.getCreatedFromPartyUuids())
        && createdFromLocationIds.isEmpty()) {
      return new Result<>(new ArrayList<>(), 0);
    }
    Set<Integer> fulfilmentLocationIds =
        resolveOrderLocationIds(
    ...
    List<OrderItemDTO> orderItems =
        query(
                ...
                (cb, root) -> {
                  ...
                  Join<StockItem, Concept> conceptJoin =
                      stockItemJoin.join("concept", JoinType.LEFT);
                  Join<OrderItem, Location> createdFromJoin =
                      root.join("createdFrom", JoinType.LEFT);
                  Join<OrderItem, Location> fulfilmentLocationJoin =
                      root.join("fulfilmentLocation", JoinType.LEFT);
                  if (safeFilter.getId() != null) {
                    predicates.add(cb.equal(root.get("id"), safeFilter.getId()));
                  }
                  if (StringUtils.isNotBlank(safeFilter.getUuid())) {
                  ...
                  addInPredicate(
                      predicates, root.get("order").get("orderId"), safeFilter.getOrderIds());
                  ...
                  addDateRangePredicate(
                      ...
                      orderJoin,
                      "dateActivated",
                      safeFilter.getOrderDateMin(),
                      safeFilter.getOrderDateMax());
                  addInPredicate(
                      predicates,
                      orderJoin.get("encounter").get("encounterId"),
                      safeFilter.getEncounterIds());
                  addInPredicate(
                      predicates,
                      orderJoin.get("encounter").get("uuid"),
                      safeFilter.getEncounterUuids());
                  addInPredicate(
                      predicates,
                      orderJoin.get("patient").get("patientId"),
                      safeFilter.getPatientIds());
                  if (StringUtils.isNotBlank(safeFilter.getOrderNumber())) {
                    ...
                    if (StringUtils.isBlank(orderNumber)) {
                      ...
                      predicates.add(
                          cb.like(
                              orderJoin.get("orderNumber"),
                              orderNumber.toUpperCase(Locale.ROOT) + "%"));
                    }
                  }
                  if (safeFilter.getIsDrug() != null) {
                    predicates.add(
                        safeFilter.getIsDrug()
                  ...
                  addInPredicate(
                      predicates, stockItemJoin.get("uuid"), safeFilter.getStockItemUuids());
                  addDrugConceptPredicates(cb, predicates, drugJoin, conceptJoin, safeFilter);
                  addInPredicate(
                      predicates, createdFromJoin.get("locationId"), createdFromLocationIds);
                  addInPredicate(
                      predicates, fulfilmentLocationJoin.get("locationId"), fulfilmentLocationIds);
                  if (allowedLocationIds != null) {
                    predicates.add(
                        cb.or(
  ...
  private void addDrugConceptPredicates(
      CriteriaBuilder cb,
      List<Predicate> predicates,
      Join<StockItem, Drug> drugJoin,
      Join<StockItem, Concept> conceptJoin,
    ...
    predicates.add(
        filter.getSearchEitherDrugOrConceptStockItems()
            ? cb.or(drugConceptPredicates.toArray(new Predicate[0]))
            : cb.and(drugConceptPredicates.toArray(new Predicate[0])));
  }

  private boolean hasOrderLocationFilter(
      List<Integer> locationIds, List<String> locationUuids, List<String> partyUuids) {
    return (locationIds != null && !locationIds.isEmpty())
        || (locationUuids != null && !locationUuids.isEmpty())
        || (partyUuids != null && !partyUuids.isEmpty());
  }

  private Set<Integer> resolveOrderLocationIds(
      List<Integer> locationIds, List<String> locationUuids, List<String> partyUuids) {
  ...
  private <T> void addInPredicate(
      List<Predicate> predicates, jakarta.persistence.criteria.Path<T> path, Collection<T> values) {
  ...
  private void sendStockOperationNotification(
      String stockOperationUuid,
      StockOperationAction.Action action,
      String actionReason,
    ...
    String body =
        replaceStockOperationNotificationTokens(
            template.getTemplate(), operation, actionName, actorName, details, healthCenterName);
    String subject =
        replaceStockOperationNotificationTokens(
            template.getSubject(), operation, actionName, actorName, details, healthCenterName);
    try {
  ...
  private List<User> notificationUsersForRole(
      String roleToNotify, StockOperationDTO operation, StockOperationAction.Action action) {
  ...
  private void createStockOperationAlert(
    ...
    alert.setText(
        String.format(
            ...
            operation.getAtLocationName(),
            operation.getOperationTypeName(),
            operation.getOperationNumber(),
            StockOperationAction.getActionName(action),
            actorName));
  ...
  private Template stockOperationNotificationTemplate() {
    try {
      List<Template> templates =
          Context.getMessageService().getTemplatesByName("STOCK_MGMT_OPERATION_ACTION");
  ...
  private String stockOperationNotificationDetails(
      StockOperationDTO operation, StockOperationAction.Action action, String actionReason) {
    ...
    if (StringUtils.isNotBlank(operation.getSourceUuid())) {
      appendNotificationRow(
          details,
          messages.getMessage("stockmanagement.stockoperation.notification.source"),
    ...
    appendNotificationRow(
        details,
        messages.getMessage("stockmanagement.stockoperation.notification.operationdate"),
        DateUtil.formatDDMMMyyyy(operation.getOperationDate()));
    String responsible =
        operation.getResponsiblePersonFamilyName() != null
            ? operation.getResponsiblePersonFamilyName()
                + " "
                + operation.getResponsiblePersonGivenName()
            : operation.getResponsiblePersonOther();
    appendNotificationRow(
        details,
        messages.getMessage("stockmanagement.stockoperation.notification.responsibleperson"),
        responsible);
    appendNotificationRow(
        details,
        messages.getMessage("stockmanagement.stockoperation.notification.remarks"),
        operation.getRemarks());
    if (action == StockOperationAction.Action.RETURN) {
      appendNotificationRow(
          details,
          messages.getMessage("stockmanagement.stockoperation.notification.returnreason"),
          actionReason);
    } else if (action == StockOperationAction.Action.REJECT) {
      appendNotificationRow(
          details,
          messages.getMessage("stockmanagement.stockoperation.notification.rejectionreason"),
          actionReason);
    }
  ...
  private void appendNotificationRow(StringBuilder builder, String label, String value) {
    builder
        .append("<tr><td style='padding: 0.2rem 0.5rem; font-size: 95%;'><b>")
  ...
  private String replaceStockOperationNotificationTokens(
      String template,
      StockOperationDTO operation,
      String actionName,
      String actorName,
  ...
  private void updateStockBatchExpiryNotificationDate(
      Collection<Integer> stockBatchIds, Date notificationDate) {
  ...
  private void updateStockRuleDate(
      List<Integer> stockRuleIds, Date nextEvaluationDate, boolean evaluationDate) {
  ...
  private void setStockItemCurrentBalanceWithDescendants(
      List<StockRuleCurrentQuantity> currentQuantities) {
    if (currentQuantities == null || currentQuantities.isEmpty()) {
      return;
    }
    Set<String> wantedKeys =
        currentQuantities.stream()
            .filter(
                quantity -> quantity.getLocationId() != null && quantity.getStockItemId() != null)
    ...
    Set<Integer> ruleLocationIds =
        currentQuantities.stream()
            .map(StockRuleCurrentQuantity::getLocationId)
            .filter(Objects::nonNull)
            .collect(Collectors.toSet());
    Set<Integer> descendantLocationIds =
        locationTrees.stream()
    ...
    Map<Integer, Set<Integer>> ancestorIdsByLocation =
        locationTrees.stream()
            .filter(tree -> tree.getChildLocationId() != null && tree.getParentLocationId() != null)
            .collect(
                Collectors.groupingBy(
                    LocationTree::getChildLocationId,
    ...
    for (StockItemTransaction transaction :
        currentBalanceTransactions(stockItemIds(currentQuantities), partyIdsByLocation.values())) {
      Party party = transaction.getParty();
      StockItem stockItem = transaction.getStockItem();
      if (party == null
          || party.getLocation() == null
          || stockItem == null
          || stockItem.getId() == null) {
        continue;
      }
      BigDecimal quantity = transactionQuantityInBaseUnits(transaction);
      if (quantity == null) {
  ...
  private void setStockItemCurrentBalanceWithoutDescendants(
      List<StockRuleCurrentQuantity> currentQuantities) {
    if (currentQuantities == null || currentQuantities.isEmpty()) {
      return;
    }
    Map<Integer, Integer> partyIdsByLocation =
        getLocationPartyIds(
            currentQuantities.stream()
                .map(StockRuleCurrentQuantity::getLocationId)
                .filter(Objects::nonNull)
  ...
  private List<StockItemTransaction> currentBalanceTransactions(
      Set<Integer> stockItemIds, Collection<Integer> partyIds) {
    ...
    return query(
        ...
        (cb, root) -> {
          ...
          return predicates(
              ...
              cb.or(
                  cb.isNull(batch.get("expiration")),
                  cb.greaterThan(batch.<Date>get("expiration"), today)));
        });
  }
  ...
  private void setRuleQuantities(
      List<StockRuleCurrentQuantity> currentQuantities,
      Map<String, BigDecimal> quantitiesByKey,
      Map<Integer, Integer> partyIdsByLocation) {
    for (StockRuleCurrentQuantity currentQuantity : currentQuantities) {
      ...
      Integer ownerId =
          partyIdsByLocation == null
              ? currentQuantity.getLocationId()
              : partyIdsByLocation.get(currentQuantity.getLocationId());
      BigDecimal quantity =
          quantitiesByKey.get(inventoryKey(ownerId, currentQuantity.getStockItemId()));
      if (quantity != null) {
  ...
  private Map<Integer, Integer> getLocationPartyIds(Collection<Integer> locationIds) {
    ...
    return query(
            Party.class,
            (cb, root) -> predicates(root.get("location").get("locationId").in(locationIds)))
        .stream()
        .filter(party -> party.getLocation() != null && party.getLocation().getLocationId() != null)
        .filter(party -> party.getId() != null)
        .collect(
            Collectors.toMap(
                party -> party.getLocation().getLocationId(),
                Party::getId,
                (a, b) -> b,
                LinkedHashMap::new));
  }
    ...
    List<StockRuleNotificationUser> rules =
        query(
                ...
                (cb, root) -> {
                  ...
                  predicates.add(
                      cb.greaterThan(
                          root.get("id"), lastStockRuleId == null ? 0 : lastStockRuleId));
                  predicates.add(
                      cb.or(
                          cb.isNull(root.get("nextEvaluation")),
                          cb.lessThanOrEqualTo(root.<Date>get("nextEvaluation"), now)));
                  predicates.add(
                      cb.or(
                          cb.isNull(root.get("nextActionDate")),
  ...
  private StockRuleNotificationUser stockRuleNotificationUser(StockRule rule) {
    ...
    notificationUser.setQuantity(
        rule.getQuantity() == null ? null : rule.getQuantity().multiply(factor));
  ...
  private List<Integer> getActiveUsersAssignedForScope(Integer locationId, List<String> roles) {
    ...
    return listAll(UserRoleScope.class).stream()
        .filter(
            scope -> scope.getUser() != null && !Boolean.TRUE.equals(scope.getUser().getRetired()))
  ...
  private Set<Integer> ancestorLocationIds(Integer locationId) {
    ...
    query(
            LocationTree.class,
            (cb, root) -> predicates(cb.equal(root.get("childLocationId"), locationId)))
        .stream()
  ...
  private boolean activeToday(UserRoleScope scope, Date today) {
    ...
    return scope.getActiveFrom() != null
        && scope.getActiveTo() != null
        && !scope.getActiveFrom().after(today)
        && !scope.getActiveTo().before(today);
  }

  private boolean scopeLocationsMatch(
      UserRoleScope scope, Integer locationId, Set<Integer> ancestorLocationIds) {
    return activeUserRoleScopeLocations(scope).stream()
        .anyMatch(
            scopeLocation -> {
  ...
  private Result<BatchJobDTO> findBatchJobs(BatchJobSearchFilter filter) {
    ...
    List<BatchJobDTO> dtos =
        findBatchJobEntities(safeFilter).stream()
  ...
  private List<BatchJob> findBatchJobEntities(BatchJobSearchFilter filter) {
    ...
    List<BatchJob> jobs =
        query(
            ...
            (cb, root) -> {
              ...
              if (safeFilter.getBatchJobUuids() != null
                  && !safeFilter.getBatchJobUuids().isEmpty()) {
              ...
              if (safeFilter.getBatchJobStatus() != null
                  && !safeFilter.getBatchJobStatus().isEmpty()) {
                predicates.add(root.get("status").in(safeFilter.getBatchJobStatus()));
              }
              if (safeFilter.getDateCreatedMin() != null) {
                predicates.add(
                    cb.greaterThanOrEqualTo(
                        root.get("dateCreated"), safeFilter.getDateCreatedMin()));
              }
              if (safeFilter.getDateCreatedMax() != null) {
                predicates.add(
                    cb.lessThanOrEqualTo(root.get("dateCreated"), safeFilter.getDateCreatedMax()));
              }
              if (safeFilter.getCompletedDateMin() != null) {
                predicates.add(
                    cb.greaterThanOrEqualTo(
                        root.get("completedDate"), safeFilter.getCompletedDateMin()));
              }
              if (safeFilter.getCompletedDateMax() != null) {
                predicates.add(
                    cb.lessThanOrEqualTo(
                        root.get("completedDate"), safeFilter.getCompletedDateMax()));
              }
              if (StringUtils.isNotBlank(safeFilter.getParameters())) {
                predicates.add(cb.equal(root.get("parameters"), safeFilter.getParameters()));
              }
              if (safeFilter.getLocationScopeIds() != null
                  && !safeFilter.getLocationScopeIds().isEmpty()) {
                predicates.add(
                    root.get("locationScope")
                        .get("locationId")
                        .in(safeFilter.getLocationScopeIds()));
              }
              if (StringUtils.isNotBlank(safeFilter.getPrivilegeScope())) {
                predicates.add(
                    cb.equal(root.get("privilegeScope"), safeFilter.getPrivilegeScope()));
              }
              if (!safeFilter.getIncludeVoided()) {
                predicates.add(cb.isFalse(root.get("voided")));
              }
    ...
    jobs.sort(
        Comparator.comparing(BatchJob::getDateCreated, Comparator.nullsLast(Date::compareTo))
            .reversed());
    return jobs;
  }
  ...
  private BatchJobDTO saveBatchJob(BatchJobDTO dto) {
    Location locationScope =
        StringUtils.isBlank(dto.getLocationScopeUuid())
            ? null
    ...
    if (currentUser != null
        && (batchJob.getBatchJobOwners() == null
  ...
  private Map<Integer, Boolean> checkStockBatchHasTransactionsAfterOperation(
      Integer stockOperationId, List<Integer> stockBatchIds) {
    if (stockOperationId == null || stockBatchIds == null || stockBatchIds.isEmpty()) {
      return new LinkedHashMap<>();
    }
    Integer lastOperationTransactionId =
        query(
                StockItemTransaction.class,
                (cb, root) ->
                    predicates(cb.equal(root.get("stockOperation").get("id"), stockOperationId)))
            .stream()
    ...
    return query(
        ...
        .map(
            transaction ->
                transaction.getStockBatch() == null ? null : transaction.getStockBatch().getId())
        .filter(Objects::nonNull)
        .distinct()
  ...
  private void deleteReservedTransations(Integer stockOperationId) {
    ...
    for (ReservedTransaction reservedTransaction :
        query(
            ReservedTransaction.class,
            (cb, root) ->
                predicates(cb.equal(root.get("stockOperation").get("id"), stockOperationId)))) {
  ...
  private List<StockItemReference> getStockItemReferenceByStockItem(String uuid) {
    ...
    return query(
        StockItemReference.class,
        (cb, root) ->
            predicates(cb.equal(root.get("stockItem"), stockItem), cb.isFalse(root.get("voided"))));
  }
  ...
  private String getUserEmailAddress(User user) {
    ...
    return org.openmrs.module.stockmanagement.api.utils.StringUtils.isValidEmail(email)
        ? email
        : null;
  }
  ...
  private <T> List<T> query(
      Class<T> type, BiFunction<CriteriaBuilder, Root<T>, List<Predicate>> predicateFactory) {
