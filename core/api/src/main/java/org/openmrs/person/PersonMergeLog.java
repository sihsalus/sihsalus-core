 ...
 * is represented by {@link #getWinner()}, the non-preferred <code>Person</code> by {@link
 * #getLoser()} and the the <code>User</code> who performed the merged by {@link #getCreator()}. The
 * details of the merge is represented in XML and stored in {@link #getPersonMergeLogData()}.
 *
...
public class PersonMergeLog extends BaseChangeableOpenmrsData {
  ...
  /**
   * object representing the deserialized form of the merge data. This field is not directly mapped
   * to the database.
   */
