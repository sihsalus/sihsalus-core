...
public class OrderSearchCriteriaBuilder {
   ...
   * @return this builder instance
   */
  public OrderSearchCriteriaBuilder setCanceledOrExpiredOnOrBeforeDate(
   ...
   * @return
   */
  public OrderSearchCriteriaBuilder setIncludeNullFulfillerStatus(
      Boolean includeNullFulfillerStatus) {
    this.includeNullFulfillerStatus = includeNullFulfillerStatus;
    return (this);
  }

  public OrderSearchCriteriaBuilder setExcludeCanceledAndExpired(
  ...
  public OrderSearchCriteria build() {
    return new OrderSearchCriteria(
        ...
        excludeCanceledAndExpired,
        excludeDiscontinueOrders,
        includeVoided,
        visit);
  }
}
