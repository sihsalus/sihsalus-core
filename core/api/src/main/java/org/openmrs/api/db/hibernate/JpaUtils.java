...
public class JpaUtils {
  ...
  /**
   * Tries to get a single result from a JPA query, similar to Hibernate's uniqueResult. Returns
   * null if no result is found, the single result if one result is found, and throws an exception
