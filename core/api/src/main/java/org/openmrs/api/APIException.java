...
public class APIException extends RuntimeException {
   ...
   * #APIException(String)} constructor to specify a helpful message to the end user
   */
  public APIException() {}
  ...
  /**
   * Constructor used to simply chain a parent exception cause to an APIException. Preference should
   * be given to the {@link #APIException(String, Throwable)} constructor if at all possible instead
   * of this one.
   *
   * @param cause the parent exception cause that this APIException is wrapping around
   */
