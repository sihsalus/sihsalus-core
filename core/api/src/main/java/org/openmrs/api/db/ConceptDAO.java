...
public interface ConceptDAO {
   ...
   *
   * <p><strong>Should</strong> not return concepts with matching names that are voided
   *
   * @param name
   * @param loc
  ...
  /**
   * <strong>Should</strong> return correct results for concept with names that contains words with
   * more weight<br>
   * <strong>Should</strong> return correct results if a concept name contains same word more than
   * once
   *
  ...
  /**
   * @param name
   * @return the {@link ConceptDatatype} that matches <em>name</em> exactly or null if one does not
   *     exist.
   * @throws DAOException
   */
   ...
   * @deprecated As of 2.5.0, this method has been deprecated in favor of {@link
   ...
   * bypassing any caches. This is used prior to saving an concept so that we can change the obs if
   * need be
   *
   * <p><strong>Should</strong> get saved conceptDatatype from database
   *
  ...
  /**
   * @see ConceptService#getConceptReferenceTerms(String, ConceptSource, Integer, Integer, boolean)
   */
   ...
   * specified term
   *
   * <p><strong>Should</strong> return true if a term has a conceptMap or more using it<br>
   ...
   * specified mapType
   *
   * <p><strong>Should</strong> return true if a mapType has a conceptMap or more using it<br>
  ...
  /**
   * It is in the DAO, because it must be done in the MANUAL flush mode to prevent premature flushes
   * in {@link ConceptService#saveConcept(Concept)}. It will be removed in 1.10 when we have a
   * better way to manage flush modes.
   *
