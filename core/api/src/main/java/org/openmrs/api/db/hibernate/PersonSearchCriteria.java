...
public class PersonSearchCriteria {
  ...
  Predicate preparePredicateForAttribute(
      CriteriaBuilder cb,
    ...
    predicates.add(
        cb.like(cb.lower(attributeJoin.get("value")), matchMode.toLowerCasePattern(value)));
