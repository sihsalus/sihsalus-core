...
@Transactional
public class DiagnosisServiceImpl extends BaseOpenmrsService
    implements DiagnosisService, RefByUuid {

  @Autowired private DiagnosisDAO diagnosisDAO;
   ...
   */
  @Override
  public DiagnosisAttributeType retireDiagnosisAttributeType(
   ...
   */
  @Override
  public DiagnosisAttributeType unretireDiagnosisAttributeType(
      DiagnosisAttributeType diagnosisAttributeType) throws APIException {
    if (diagnosisAttributeType == null) {
      throw new APIException("Diagnosis attribute type cannot be null");
    }
   ...
   */
  @Override
  public void purgeDiagnosisAttributeType(DiagnosisAttributeType diagnosisAttributeType)
      throws APIException {
