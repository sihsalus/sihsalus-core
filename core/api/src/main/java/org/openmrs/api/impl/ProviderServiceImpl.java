...
public class ProviderServiceImpl extends BaseOpenmrsService implements ProviderService, RefByUuid {
  ...
  @Autowired private ProviderDAO dao;
  ...
  /**
   * @see
   *     org.openmrs.api.ProviderService#saveProviderAttributeType(org.openmrs.ProviderAttributeType)
   */
  @Override
  ...
  /**
   * @see
   *     org.openmrs.api.ProviderService#retireProviderAttributeType(org.openmrs.ProviderAttributeType,
   *     java.lang.String)
   */
  @Override
  ...
  /**
   * @see
   *     org.openmrs.api.ProviderService#unretireProviderAttributeType(org.openmrs.ProviderAttributeType)
   */
  @Override
  ...
  /**
   * @see
   *     org.openmrs.api.ProviderService#purgeProviderAttributeType(org.openmrs.ProviderAttributeType)
   */
  @Override
  ...
  public Provider getUnknownProvider() {
    return getProviderByUuid(
        Context.getAdministrationService()
            .getGlobalProperty(OpenmrsConstants.GP_UNKNOWN_PROVIDER_UUID));
  }
  ...
  public List<Class<?>> getRefTypes() {
    return Arrays.asList(
        ProviderAttributeType.class, ProviderRole.class, Provider.class, ProviderAttribute.class);
  }
  ...
  public void purgeProviderRole(ProviderRole providerRole) {
    ...
    if (!providersWithRole.isEmpty()) {
      throw new APIException(
          "Cannot purge a provider role that is assigned to one or more providers");
    }
