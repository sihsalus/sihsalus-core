...
public interface EncounterDAO {
   ...
   * if need be
   *
   * <p><strong>Should</strong> get saved encounter datetime from database
   *
   ...
   */
  List<Encounter> getEncountersByVisitsAndPatient(
   ...
   */
  Integer getEncountersByVisitsAndPatientCount(
