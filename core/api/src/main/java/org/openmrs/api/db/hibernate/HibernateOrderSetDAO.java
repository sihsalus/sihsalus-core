...
public class HibernateOrderSetDAO implements OrderSetDAO {
  ...
  /**
   * @see
   *     org.openmrs.api.db.OrderSetDAO#saveOrderSetAttributeType(org.openmrs.OrderSetAttributeType)
   */
  @Override
  ...
  /**
   * @see
   *     org.openmrs.api.db.OrderSetDAO#deleteOrderSetAttributeType(org.openmrs.OrderSetAttributeType)
   */
  @Override
