...
public class PatientIdentifierTypeDefaultComparator
    implements Comparator<PatientIdentifierType>, Serializable {
  ...
  public PatientIdentifierTypeDefaultComparator() {
    ...
    comparatorChain.addComparator(
        (Comparator<PatientIdentifierType>)
            (o1, o2) -> nullLowerComparator.compare(o1.getRetired(), o2.getRetired()));

    // Required lower
    comparatorChain.addComparator(
        (Comparator<PatientIdentifierType>)
            (o1, o2) -> nullLowerComparator.compare(o1.getRequired(), o2.getRequired()),
        true);
   ...
   *
   * <p><strong>Should</strong> order properly
   */
  @Override
