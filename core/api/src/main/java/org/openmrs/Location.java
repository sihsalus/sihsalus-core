...
@Audited
public class Location extends BaseCustomizableMetadata<LocationAttribute>
   ...
   *
   * <p><strong>Should</strong> return a set of locations
   *
   ...
   *
   * <p><strong>Should</strong> return false given any null parameter<br>
   ...
   *
   * <p><strong>Should</strong> not fail given null parameter<br>
