 ...
 *
 * <p>This module is available to be used by any use-case that creates an ObjectMapper. However, it
 * is only registered by default for the Spring MappingJackson2HttpMessageConverter class.
 */
public class OpenmrsJacksonLocaleModule extends Module {
  ...
  private static final Version VERSION =
      new Version(1, 0, 0, null, "org.openmrs.web", "openmrs-locale");
  ...
  private static class OpenmrsLocaleSerializer extends StdSerializer<Locale> {
    ...
    public void serialize(
        Locale locale, JsonGenerator jsonGenerator, SerializerProvider serializerProvider)
        throws IOException {
