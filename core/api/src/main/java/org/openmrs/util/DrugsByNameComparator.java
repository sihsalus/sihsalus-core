...
public class DrugsByNameComparator implements Comparator<Drug>, Serializable {
   ...
   * to prevent a capital letter getting precedence over a simple letter which comes before it in
   * the alphabet.
   *
   * <p><strong>Should</strong> return negative if name for drug1 comes before that of drug2<br>
