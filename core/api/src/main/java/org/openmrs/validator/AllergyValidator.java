  ...
  public void validate(Object target, Errors errors) {
    ...
    if (allergy.getReactionNonCoded() != null) {
      if (NumberUtils.isParsable(allergy.getReactionNonCoded())) {
        errors.rejectValue(
            "reactionNonCoded", "error.allergyapi.allergy.ReactionNonCoded.cannotBeNumeric");
      }
    }
    if (allergy.getAllergen() == null) {
      ...
      if (allergen.getCodedAllergen() == null
          && StringUtils.isBlank(allergen.getNonCodedAllergen())) {
      ...
      if (allergy.getAllergyId() == null && allergy.getPatient() != null) {
        ...
        if (existingAllergies.containsAllergen(allergy)) {
          ...
          errors.rejectValue(
              "allergen", "allergyapi.message.duplicateAllergen", new Object[] {name}, null);
        }
      }
    }
  }
