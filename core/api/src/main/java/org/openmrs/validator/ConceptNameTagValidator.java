...
public class ConceptNameTagValidator implements Validator {
   ...
   *
   * <p><strong>Should</strong> fail validation if conceptNameTag is null<br>
  ...
  public void validate(Object obj, Errors errors) {
    ...
    if (cnt == null) {
      ...
      if (cnt.getTag() != null) {
        ConceptNameTag currentTag =
            Context.getConceptService().getConceptNameTagByName(cnt.getTag());
        if (currentTag != null
            && !OpenmrsUtil.nullSafeEqualsIgnoreCase(cnt.getUuid(), currentTag.getUuid())
