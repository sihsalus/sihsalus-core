...
public class EncounterTypeValidator implements Validator {
   ...
   *
   * <p><strong>Should</strong> fail validation if name is null or empty or whitespace<br>
   ...
   * <strong>Should</strong> pass validation for an existing EncounterType<br>
  ...
  public void validate(Object obj, Errors errors) {
    ...
    if (encounterType == null) {
      ...
      if (!errors.hasErrors()) {
        EncounterType duplicate =
            Context.getEncounterService().getEncounterType(encounterType.getName().trim());
        if (duplicate != null
