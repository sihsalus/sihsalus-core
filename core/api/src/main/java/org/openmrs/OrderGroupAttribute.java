...
/**
 * A value for a user-defined {@link OrderGroupAttributeType} that is stored in an {@link
 * OrderGroup}.
 *
 * @see Attribute
 * @since 2.4.0
...
public class OrderGroupAttribute extends BaseAttribute<OrderGroupAttributeType, OrderGroup>
    implements Attribute<OrderGroupAttributeType, OrderGroup> {
