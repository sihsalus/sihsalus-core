...
public class Drug extends BaseChangeableOpenmrsMetadata {
  ...
  @IndexedEmbedded
  @AssociationInverseSide(inversePath = @ObjectPath({@PropertyValue(propertyName = "drug")}))
  ...
  /**
   * Add the given DrugReferenceMap object to this drug's list of drug reference mappings. If there
   * is already a corresponding DrugReferenceMap object for this concept, this one will not be
   * added.
   *
   * <p><strong>Should</strong> set drug as the drug to which a mapping is being added<br>
