...
public interface ModuleActivator {
   ...
   * times i.e. whenever a new module gets started, at application startup or a developer chooses to
   * refresh the context.
   */
  ...
  /**
   * Called after a module has been loaded but before the application context is refreshed, at this
   * point the module's service methods aren't yet available so they can't be called. <br>
   * <br>
  ...
  default void setupOnVersionChangeBeforeSchemaChanges(
    ...
    ignore(previousCoreVersion, previousModuleVersion);
  }
