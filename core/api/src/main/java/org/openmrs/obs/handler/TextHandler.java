...
public class TextHandler extends AbstractHandler implements ComplexObsHandler {
  ...
  private static final String[] supportedViews = {
    ComplexObsHandler.TEXT_VIEW, ComplexObsHandler.RAW_VIEW, ComplexObsHandler.URI_VIEW
  };
  ...
  public Obs getObs(Obs obs, String view) {
    ...
    if (ComplexObsHandler.TEXT_VIEW.equals(view) || ComplexObsHandler.RAW_VIEW.equals(view)) {
      ...
      try (InputStream is = storageService.getData(key)) {
        complexData =
            ComplexObsHandler.RAW_VIEW.equals(view)
                ? new ComplexData(filename, IOUtils.toByteArray(is))
  ...
  public Obs saveObs(Obs obs) throws APIException {
    ...
    if (complexData == null) {
      log.error(
          "Cannot save complex data where obsId={} because its ComplexData is null.",
          obs.getObsId());
      return obs;
    }
    try {
                ...
                if (data instanceof char[]) {
                  ...
                  try (Reader reader = new BufferedReader((Reader) data)) {
                    ...
                    throw new APIException(
                        "Obs.error.unable.convert.complex.data", new Object[] {"Reader"}, e);
                  }
                  ...
                  try (Reader reader =
                    ...
                    throw new APIException(
                        "Obs.error.unable.convert.complex.data", new Object[] {"input stream"}, e);
                  }
                }
                writer.flush();
              },
              ObjectMetadata.builder().setFilename(obs.getComplexData().getTitle()).build(),
              getObsDir());
