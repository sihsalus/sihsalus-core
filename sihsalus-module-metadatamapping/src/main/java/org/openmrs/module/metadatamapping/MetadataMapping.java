...
public class MetadataMapping {
  ...
  public static final String GP_SUBSCRIBED_TO_SOURCE_UUIDS =
      MODULE_ID + ".subscribedToConceptSourceUuids";
  ...
  /**
   * Global property name, specifies whether the concept mappings to the local dictionary should be
   * created when exporting concepts
   */
