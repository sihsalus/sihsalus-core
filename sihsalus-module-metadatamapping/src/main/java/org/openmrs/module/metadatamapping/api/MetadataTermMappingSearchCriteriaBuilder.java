...
public class MetadataTermMappingSearchCriteriaBuilder {
  ...
  /**
   * @param mapped return defined or undefined mappings (null by default (returns both defined and
   *     undefined), possible: true, false, null)
   * @return this builder
   */
   ...
   * @return this builder
   */
  public MetadataTermMappingSearchCriteriaBuilder setReferredObject(
  ...
  public MetadataTermMappingSearchCriteria build() {
    if (referredObject != null) {
      return new MetadataTermMappingSearchCriteria(
          includeAll,
          mapped,
          firstResult,
          maxResults,
