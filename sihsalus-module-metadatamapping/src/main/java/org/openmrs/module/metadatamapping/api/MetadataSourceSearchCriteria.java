...
/**
 * Search criteria for {@link
 * MetadataMappingService#getMetadataSources(MetadataSourceSearchCriteria)}}. Use the convenience
 * builder {@link MetadataSourceSearchCriteriaBuilder}.
 *
 * @since 1.2
 */
public class MetadataSourceSearchCriteria extends MetadataSearchCriteria {
   ...
   */
  public MetadataSourceSearchCriteria(
      boolean includeAll, Integer firstResult, Integer maxResults, String sourceName) {
