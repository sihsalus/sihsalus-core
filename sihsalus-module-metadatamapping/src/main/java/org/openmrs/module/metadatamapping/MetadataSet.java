...
/**
 * A group or set of metadata terms mappings that relate to each other. MetadataSet doesn't directly
 * contain members, but its members refer to it. To obtain {@link MetadataSetMember}'s use {@link
 * org.openmrs.module.metadatamapping.api.MetadataMappingService#getMetadataSetMembers(MetadataSet,
 * int, int, RetiredHandlingMode)}
 */
