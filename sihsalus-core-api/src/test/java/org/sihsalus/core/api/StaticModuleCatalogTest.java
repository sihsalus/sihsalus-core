...
class StaticModuleCatalogTest {
  ...
  void includesFhirAndNoOmodRuntimeModule() {
    assertTrue(
        StaticModuleCatalog.modules().stream().anyMatch(module -> module.id().equals("fhir2")));
    assertTrue(
        StaticModuleCatalog.modules().stream()
            .noneMatch(module -> module.id().equals("omod-runtime")));
    assertTrue(
        StaticModuleCatalog.modules().stream()
            .noneMatch(module -> module.id().equals("identitylookup")));
    assertTrue(
  ...
  void authenticationIsStaticInternalSourceImport() {
    assertTrue(
        StaticModuleCatalog.modules().stream()
            .anyMatch(
                module ->
                    module.id().equals("authentication")
  ...
  void addressHierarchyIsStaticInternalSourceImport() {
    assertTrue(
        StaticModuleCatalog.modules().stream()
            .anyMatch(
                module ->
                    module.id().equals("addresshierarchy")
  ...
  void patientDocumentsIsStaticInternalSourceImport() {
    assertTrue(
        StaticModuleCatalog.modules().stream()
            .anyMatch(
                module ->
                    module.id().equals("patientdocuments")
  ...
  void metadataMappingIsStaticInternalSourceImport() {
    assertTrue(
        StaticModuleCatalog.modules().stream()
            .anyMatch(
                module ->
                    module.id().equals("metadatamapping")
  ...
  void stockManagementIsStaticInternalSourceImport() {
    assertTrue(
        StaticModuleCatalog.modules().stream()
            .anyMatch(
                module ->
                    module.id().equals("stockmanagement")
  ...
  void serializationXstreamIsStaticInternalSourceImport() {
    assertTrue(
        StaticModuleCatalog.modules().stream()
            .anyMatch(
                module ->
                    module.id().equals("serialization-xstream")
  ...
  void orderTemplatesIsStaticInternalSourceImport() {
    assertTrue(
        StaticModuleCatalog.modules().stream()
            .anyMatch(
                module ->
                    module.id().equals("ordertemplates")
  ...
  void reportingRestIsStaticInternalSourceImport() {
    assertTrue(
        StaticModuleCatalog.modules().stream()
            .anyMatch(
                module ->
                    module.id().equals("reportingrest")
