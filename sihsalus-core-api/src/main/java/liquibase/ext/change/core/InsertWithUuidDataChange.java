...
@DatabaseChange(
    name = "insertWithUuid",
    description = "Inserts data into an existing table and generates and inserts an uuid",
...
public class InsertWithUuidDataChange extends InsertDataChange {
  ...
  public SqlStatement[] generateStatements(final Database database) {
    ...
    // Check if the insert change set specifies a value for the uuid column. If that is the case
