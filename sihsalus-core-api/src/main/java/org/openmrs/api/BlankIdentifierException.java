...
public class BlankIdentifierException extends PatientIdentifierException {
   ...
   * #BlankIdentifierException(String, PatientIdentifier)} constructor to specify a helpful message
   * to the end user
   */
   ...
   * occurred. Preference should be given to {@link #BlankIdentifierException(String,
   * PatientIdentifier)} over this constructor
   *
  ...
  /**
   * This is the preferred constructor. This gives the end user both a message as to why this error
   * occurred and the identifier which is blank.
   *
   * @param message helpful message string for the end user
