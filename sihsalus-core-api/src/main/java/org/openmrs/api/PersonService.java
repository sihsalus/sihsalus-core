...
public interface PersonService extends OpenmrsService {
  ...
  /**
   * These enumerations are used when determining which person attr types to display. If listing off
   * a lot of patients/users, one set of types are shown. When only displaying one patient/user,
   * another type is shown.
   */
  ...
  /**
   * Find a similar person given the attributes. This does a very loose lookup with the <code>
   * nameSearch</code> parameter. This does a very loose lookup on <code>birthyear</code> as well.
   * Any person with a null/missing birthdate is included and anyone with a birthyear plus/minus one
   * year from the given <code>birthyear</code> is also included
   *
   * <p><strong>Should</strong> accept greater than three names<br>
   * <strong>Should</strong> match single search to any name part<br>
   * <strong>Should</strong> match two word search to any name part<br>
   * <strong>Should</strong> match three word search to any name part<br>
  ...
  public Set<Person> getSimilarPeople(String nameSearch, Integer birthyear, String gender)
      throws APIException;

  /**
   * Find a person matching the <tt>searchPhrase</tt> search string
   *
   * <p><strong>Should</strong> match search to familyName2
   *
  ...
  @Authorized({PrivilegeConstants.GET_PERSONS})
  public List<Person> getPeople(String searchPhrase, Boolean dead, Boolean voided)
      throws APIException;
   ...
   * prior to saving this given type. <br>
   *
   * <p><strong>Should</strong> set the date created and creator on new<br>
   * <strong>Should</strong> set the date changed and changed by on update<br>
   * <strong>Should</strong> update any global property which reference this type<br>
   * <strong>Should</strong> throw an error when trying to save person attribute type while person
   ...
   *
   * <p><strong>Should</strong> throw an error when trying to retire person attribute type while
   * person attribute types are locked
   *
   * @param type
   * @param retiredReason
   */
  @Authorized({PrivilegeConstants.MANAGE_PERSON_ATTRIBUTE_TYPES})
  public PersonAttributeType retirePersonAttributeType(
      PersonAttributeType type, String retiredReason) throws APIException;
  ...
  public RelationshipType retireRelationshipType(RelationshipType type, String retiredReason)
      throws APIException;
   ...
   *
   * <p><strong>Should</strong> delete person attribute type from database<br>
   * <strong>Should</strong> throw an error when trying to delete person attribute type while person
   * attribute types are locked
   *
   ...
   *
   * <p><strong>Should</strong> restore person attribute type from database<br>
   * <strong>Should</strong> throw an error when trying to unretire person attribute type while
   * person attribute types are locked
   *
   ...
   *
   * <p><strong>Should</strong> return voided person with given reason<br>
   * <strong>Should</strong> void patient<br>
   ...
   *
   * <p><strong>Should</strong> unvoid the given person<br>
   * <strong>Should</strong> unvoid patient<br>
   ...
   *
   * <p><strong>Should</strong> return all person attribute types including retired
   *
   ...
   *
   * <p><strong>Should</strong> return all person attribute types including retired when include
   * retired is true<br>
   * <strong>Should</strong> return all person attribute types excluding retired when include
   * retired is false
   *
   ...
   */
  @Authorized({PrivilegeConstants.GET_PERSON_ATTRIBUTE_TYPES})
  public List<PersonAttributeType> getAllPersonAttributeTypes(boolean includeRetired)
      throws APIException;
   ...
   * results
   *
   * <p><strong>Should</strong> return person attribute types matching given parameters<br>
  ...
  public List<PersonAttributeType> getPersonAttributeTypes(
      String exactName, String format, Integer foreignKey, Boolean searchable) throws APIException;

  /**
   * Get the PersonAttributeType given the type's PersonAttributeTypeId
   *
   * <p><strong>Should</strong> return null when no person attribute with the given id exist
   *
   ...
   *
   * <p><strong>Should</strong> return null when PersonAttribute with given id does not exist<br>
   ...
   *
   * <p><strong>Should</strong> return person attribute type when name matches given typeName<br>
   ...
   *
   * <p><strong>Should</strong> return relationship with given id<br>
   ...
   *
   * <p><strong>Should</strong> return all unvoided relationships
   *
   ...
   *
   * <p><strong>Should</strong> return all relationship including voided when include voided equals
   * true<br>
   * <strong>Should</strong> return all relationship excluding voided when include voided equals
   * false
   *
   ...
   *
   * <p><strong>Should</strong> only get unvoided relationships<br>
   * <strong>Should</strong> fetch relationships associated with the given person<br>
   ...
   *
   * <p><strong>Should</strong> only get unvoided relationships<br>
   * <strong>Should</strong> only get unvoided relationships regardless of effective date<br>
   * <strong>Should</strong> fetch relationships associated with the given person<br>
   ...
   */
  @Authorized({PrivilegeConstants.GET_RELATIONSHIPS})
  public List<Relationship> getRelationshipsByPerson(Person p, Date effectiveDate)
      throws APIException;

  /**
   * Get relationships stored in the database that
   *
   * <p><strong>Should</strong> fetch relationships matching the given from person<br>
   * <strong>Should</strong> fetch relationships matching the given to person<br>
   * <strong>Should</strong> fetch relationships matching the given rel type<br>
  ...
  public List<Relationship> getRelationships(
      Person fromPerson, Person toPerson, RelationshipType relType) throws APIException;
  ...
  @Authorized({PrivilegeConstants.GET_RELATIONSHIPS})
  public List<Relationship> getRelationships(
      Person fromPerson, Person toPerson, RelationshipType relType, Date effectiveDate)
      throws APIException;
   ...
   *     (lower bound)
   * @param endEffectiveDate (optional) The date during which the relationship was effective (upper
   *     bound)
   * @return relationships matching the given parameters
   * @throws APIException
   */
   ...
   *
   * <p><strong>Should</strong> return all relationship types
   *
   ...
   *
   * <p><strong>Should</strong> return relationship type with the given relationship type id<br>
   * <strong>Should</strong> return null when no relationship type matches given relationship type
   * id
   *
   ...
   *
   * <p><strong>Should</strong> return null when no relationship type match the given name
   *
   ...
   */
  @Authorized({PrivilegeConstants.GET_RELATIONSHIP_TYPES})
  public RelationshipType getRelationshipTypeByName(String relationshipTypeName)
      throws APIException;

  /**
   * Find relationshipTypes by exact name match and/or preferred status
   *
   * <p><strong>Should</strong> return list of preferred relationship type matching given name<br>
   * <strong>Should</strong> return empty list when no preferred relationship type match the given
   * name
   *
   * @param relationshipTypeName name to match on
   ...
   * searchString
   *
   * <p><strong>Should</strong> return empty list when no relationship type match the search string
   *
   ...
   * the database
   *
   * <p><strong>Should</strong> create new object when relationship id is null<br>
   ...
   *
   * <p><strong>Should</strong> delete relationship from the database
   *
   ...
   *
   * <p><strong>Should</strong> void relationship with the given reason
   *
  ...
  public Relationship voidRelationship(Relationship relationship, String voidReason)
      throws APIException;

  /**
   * Unvoid Relationship in the database, effectively marking this as a valid relationship again
   *
   * <p><strong>Should</strong> unvoid voided relationship
   *
   ...
   *
   * <p><strong>Should</strong> create new object when person id is null<br>
   * <strong>Should</strong> update existing object when person id is not null<br>
   * <strong>Should</strong> set the preferred name and address if none is specified<br>
   * <strong>Should</strong> not set the preferred name and address if they already exist<br>
   ...
   *
   * <p><strong>Should</strong> delete person from the database
   *
   ...
   *
   * <p><strong>Should</strong> find PersonName given valid personNameId<br>
   ...
   *
   * <p><strong>Should</strong> return null when no person has the given id
   *
   ...
   *
   * <p><strong>Should</strong> create new object when relationship type id is null<br>
   * <strong>Should</strong> update existing object when relationship type id is not null<br>
   ...
   *
   * <p><strong>Should</strong> delete relationship type from the database
   *
  ...
  /**
   * Gets the types defined for the given person type (person, user, patient) and the given type of
   * view (one person vs many person objects)
   *
  ...
  public List<PersonAttributeType> getPersonAttributeTypes(
      PERSON_TYPE personType, ATTR_VIEW_TYPE viewType) throws APIException;

  /**
   * Voids the given PersonName, effectively deleting the name, from the end-user's point of view.
   *
   * <p><strong>Should</strong> void personName with the given reason
   *
   ...
   *
   * <p><strong>Should</strong> unvoid voided personName
   *
   ...
   *
   * <p><strong>Should</strong> fail if you try to void the last non voided name
   *
   ...
   *
   * <p><strong>Should</strong> parse two person name with comma<br>
   * <strong>Should</strong> parse two person name without comma<br>
   * <strong>Should</strong> not fail when ending with whitespace<br>
   * <strong>Should</strong> not fail when ending with a comma<br>
   ...
   * personB's
   *
   * <p><strong>Should</strong> return empty map when no relationship has the matching relationship
   * type
   *
   ...
   */
  @Authorized({PrivilegeConstants.GET_RELATIONSHIPS})
  public Map<Person, List<Person>> getRelationshipMap(RelationshipType relationshipType)
      throws APIException;

  /**
   * Builds the serialized data from {@link
   * org.openmrs.person.PersonMergeLog#getPersonMergeLogData}, sets the mergedData String, and the
   * creator and date if null. It then saves the <code>PersonMergeLog</code> object to the model.
   *
   * <p><strong>Should</strong> require PersonMergeLogData<br>
   * <strong>Should</strong> require winner<br>
   * <strong>Should</strong> require loser<br>
   * <strong>Should</strong> set date created if null<br>
   * <strong>Should</strong> set creator if null<br>
   * <strong>Should</strong> serialize PersonMergeLogData<br>
   ...
   */
  public PersonMergeLog savePersonMergeLog(PersonMergeLog personMergeLog)
   ...
   *
   * <p><strong>Should</strong> require uuid<br>
   * <strong>Should</strong> retrieve personMergeLog without deserializing data<br>
   ...
   *
   * <p><strong>Should</strong> retrieve all PersonMergeLogs from the model<br>
   * <strong>Should</strong> retrieve all PersonMergeLogs and deserialize them
   *
   * @return list of PersonMergeLog objects
   * @throws SerializationException
   */
  public List<PersonMergeLog> getAllPersonMergeLogs(boolean deserialize)
      throws SerializationException;

  /**
   * Gets <code>PersonMergeLog</code> objects by winning person p. Useful for to getting all persons
   * merged into p.
   *
   * <p><strong>Should</strong> retrieve PersonMergeLogs by winner
   *
   * @param person the winning person
   * @return List of <code>PersonMergeLog</code> objects
   * @throws SerializationException
   */
  public List<PersonMergeLog> getWinningPersonMergeLogs(Person person, boolean deserialize)
      throws SerializationException;

  /**
   * Gets the <code>PersonMergeLog</code> where person p is the loser. Useful for getting the person
   * that p was merged into.
   *
   * <p><strong>Should</strong> find PersonMergeLog by loser
   *
   * @param person the losing person
   * @return The <code>PersonMergeLog</code> object
   * @throws SerializationException
   */
  public PersonMergeLog getLosingPersonMergeLog(Person person, boolean deserialize)
      throws SerializationException;
   ...
   * point of view.
   *
   * <p><strong>Should</strong> void personAddress with the given reason
   *
   ...
   *
   * <p><strong>Should</strong> unvoid voided personAddress
   *
  ...
  /**
   * Check if the person attribute types are locked, and if they are throws an exception during
