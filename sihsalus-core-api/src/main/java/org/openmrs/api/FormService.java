...
public interface FormService extends OpenmrsService {
   ...
   *
   * <p><strong>Should</strong> save given form successfully<br>
   ...
   *
   * <p><strong>Should</strong> return null if no form exists with given formId<br>
   ...
   *
   * <p><strong>Should</strong> return null if no form has the exact form name
   *
   ...
   * {@link #getForm(String)}
   *
   * <p><strong>Should</strong> get the specific version of the form with the given name
   *
   * @param name exact name of the form to fetch
   ...
   *
   * <p><strong>Should</strong> return all forms including retired
   *
   ...
   *
   * <p><strong>Should</strong> return retired forms if includeRetired is true<br>
   ...
   * not specified.)
   *
   * <p><strong>Should</strong> match forms with partial match on name<br>
   ...
   *
   * <p><strong>Should</strong> get multiple of the same form by field<br>
   ...
   * <strong>Should</strong> return forms that have any matching formFields in
  ...
  /**
   * Same as {@link #getForms(String, Boolean, Collection, Boolean, Collection, Collection,
   * Collection)} except that it returns an integer that is the size of the list that would be
   * returned
   *
   ...
   *
   * <p><strong>Should</strong> only return published forms that are not retired
   *
   ...
   *
   * <p><strong>Should</strong> should merge fields with similar attributes
   *
   * @throws APIException
   */
  @Authorized(PrivilegeConstants.MANAGE_FORMS)
   ...
   *
   * <p><strong>Should</strong> clear changed details and update creation details<br>
   ...
   *
   * <p><strong>Should</strong> set the retired bit before saving
   *
   ...
   *
   * <p><strong>Should</strong> unset the retired bit before saving
   *
   ...
   *
   * <p><strong>Should</strong> delete given form successfully<br>
   ...
   *
   * <p><strong>Should</strong> throw APIException if cascade is true
   *
   * @param form
   ...
   *
   * <p><strong>Should</strong> also get retired field types
   *
   ...
   *
   * <p><strong>Should</strong> get all field types including retired when includeRetired equals
   * true<br>
   ...
   *
   * <p><strong>Should</strong> return null when no field type matching given id
   *
   ...
   *
   * <p><strong>Should</strong> find object given valid name<br>
   ...
   * forms)
   *
   * <p><strong>Should</strong> get forms with field matching given concept<br>
   ...
   *
   * <p><strong>Should</strong> get all form fields including retired
   *
   ...
   *
   * <p><strong>Should</strong> get fields with name matching fuzzySearchPhrase at beginning<br>
   ...
   *
   * <p><strong>Should</strong> get fields with concept matching given concept
   *
   ...
   *
   * <p><strong>Should</strong> get all fields including retired
   *
   * @return all Fields
   * @throws APIException
   */
   ...
   *
   * <p><strong>Should</strong> get all fields including retired when includeRetired is true<br>
   ...
   *
   * <p><strong>Should</strong> get fields with form in given forms<br>
   ...
   *
   * <p><strong>Should</strong> return null if no field exists with given fieldId
   *
   ...
   *
   * <p><strong>Should</strong> save given field successfully<br>
   ...
   *
   * <p><strong>Should</strong> delete given field successfully
   *
   ...
   *
   * <p><strong>Should</strong> return null if no formField exists with given id
   *
   ...
   *
   * <p><strong>Should</strong> get form fields by form and concept<br>
   ...
   *
   * <p><strong>Should</strong> propagate save to the Field property on the given FormField<br>
   ...
   *
   * <p><strong>Should</strong> delete the given form field successfully
   *
   ...
   *
   * <p><strong>Should</strong> create new field type<br>
   ...
   *
   * <p><strong>Should</strong> delete the given field type successfully
   *
   ...
   *
   * <p><strong>Should</strong> find a saved FormResource<br>
   ...
   *
   * <p><strong>Should</strong> persist a FormResource<br>
   ...
   *
   * <p><strong>Should</strong> delete a form resource
   *
