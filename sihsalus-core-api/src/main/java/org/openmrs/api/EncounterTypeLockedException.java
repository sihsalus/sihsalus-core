...
public class EncounterTypeLockedException extends APIException {
  ...
  public EncounterTypeLockedException() {
    this(
        "Editing of encounter types is not allowed at this time since they are currently locked. ");
  }
   ...
   * #EncounterTypeLockedException(String, Throwable)} constructor is preferred over this one.
   *
   * @param cause the parent exception
   */
