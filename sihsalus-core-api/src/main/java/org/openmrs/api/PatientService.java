...
public interface PatientService extends OpenmrsService {
   ...
   *
   * <p><strong>Should</strong> create new patient from existing person plus user object<br>
   * <strong>Should</strong> not throw a NonUniqueObjectException when called with a hand
   * constructed patient<br>
   ...
   *
   * <p><strong>Should</strong> return null object if patient id doesnt exist<br>
   ...
   *
   * <p><strong>Should</strong> fetch patient with given uuid<br>
   ...
   *
   * <p><strong>Should</strong> fetch patient identifier with given uuid<br>
   ...
   *
   * <p><strong>Should</strong> fetch all non voided patients
   *
   ...
   *
   * <p><strong>Should</strong> fetch voided patients when given include voided is true<br>
  ...
  /**
   * Get patients based on given criteria The identifier is matched with the regex <code>
   * OpenmrsConstants.PATIENT_IDENTIFIER_REGEX</code> All parameters are optional and nullable. If
   * null, it is not included in the search. Will not return voided patients
   *
   * <p><strong>Should</strong> fetch all patients that partially match given name<br>
   * <strong>Should</strong> fetch all patients that partially match given identifier if <code>name
   * </code> argument<br>
   ...
   *     however applies only if <code>name</code> argument is null. Otherwise, its ignored.
   ...
   *     equal the id in the database. if false, then the identifier is 'searched' for by using a
   *     regular expression
   ...
   *
   * <p><strong>Should</strong> void given patient with given reason<br>
   ...
   *
   * <p><strong>Should</strong> unvoid given patient<br>
   ...
   *
   * <p><strong>Should</strong> delete patient from database
   *
   ...
   * returned
   *
   * <p><strong>Should</strong> return only non voided patients and patient identifiers<br>
   ...
   * @param isPreferred if true, limits to only preferred identifiers if false, only non preferred.
   *     if null, ignores preferred status
   ...
   *
   * <p><strong>Should</strong> create new patient identifier type<br>
   ...
   *
   * <p>Ordered same as {@link PatientIdentifierTypeDefaultComparator}.
   *
   * <p><strong>Should</strong> fetch all non retired patient identifier types<br>
   ...
   * <p>Ordered same as {@link PatientIdentifierTypeDefaultComparator}.
   *
   * <p><strong>Should</strong> fetch patient identifier types including retired when include
   * retired is true<br>
   * <strong>Should</strong> fetch patient identifier types excluding retired when include retired
   * is false<br>
   * <strong>Should</strong> order as default comparator
   *
   ...
   * <p>Ordered same as {@link PatientIdentifierTypeDefaultComparator}.
   *
   * <p><strong>Should</strong> fetch patient identifier types that match given name with given
   * format<br>
  ...
  public List<PatientIdentifierType> getPatientIdentifierTypes(
      String name, String format, Boolean required, Boolean hasCheckDigit) throws APIException;

  /**
   * Get patientIdentifierType by internal identifier
   *
   * <p><strong>Should</strong> fetch patient identifier with given patient identifier type id<br>
   ...
   */
  @Authorized({PrivilegeConstants.GET_IDENTIFIER_TYPES})
  public PatientIdentifierType getPatientIdentifierType(Integer patientIdentifierTypeId)
      throws APIException;

  /**
   * Get patient identifierType by universally unique identifier
   *
   * <p><strong>Should</strong> fetch patient identifier type with given uuid<br>
   ...
   *
   * <p><strong>Should</strong> fetch patient identifier type that exactly matches given name<br>
   ...
   *
   * <p><strong>Should</strong> retire patient identifier type with given reason<br>
   * <strong>Should</strong> throw error when reason is empty<br>
   * <strong>Should</strong> throw error when trying to retire a patient identifier type while
   * patient identifier
   *
   ...
   *
   * <p><strong>Should</strong> unretire patient identifier type<br>
   ...
   *
   * <p><strong>Should</strong> delete type from database<br>
   * <strong>Should</strong> delete patient identifier type from database<br>
   * <strong>Should</strong> throw error when trying to delete a patient identifier type while
   * patient identifier
   *
   ...
   *
   * <p><strong>Should</strong> validate when patient has all required and no duplicate and no blank
   * patient<br>
   ...
   *
   * <p><strong>Should</strong> force search string to be greater than minsearchcharacters global
   * property<br>
   ...
   *
   * <p><strong>Should</strong> find a patients with a matching identifier with no digits
   *
   * @param query the string to search on
  ...
  @Authorized({PrivilegeConstants.GET_PATIENTS})
  public List<Patient> getPatients(
      String query, boolean includeVoided, Integer start, Integer length) throws APIException;

  /**
   * This method tries to find a patient in the database given the attributes on the given <code>
   * patientToMatch</code> object. Assumes there could be a PersonAttribute on this Patient with
   * PersonAttributeType.name = "Other Matching Information". This PersonAttribute has a "value"
   * that is just key value pairs in the form of key:value;nextkey:nextvalue;
   *
   * <p><strong>Should</strong> fetch patient matching patient id of given patient<br>
   ...
   * passed in must be identical to what is stored for at least one other patient for both patients
   * to be returned.
   *
   * <p><strong>Should</strong> fetch patients that exactly match on all given attributes<br>
   ...
   *
   * <ol>
   *   <li>Moves object (encounters/obs) pointing to <code>nonPreferred</code> to point at <code>
   *       preferred</code>
   *   <li>Copies data (gender/birthdate/names/ids/etc) from <code>nonPreferred</code> to <code>
   *       preferred</code> IFF the data is missing or null in <code>preferred</code>
   *   <li><code>notPreferred</code> is marked as voided
   * </ol>
   *
   * <p><strong>Should</strong> not merge the same patient to itself<br>
   ...
   * empty<br>
   * <strong>Should</strong> merge non preferred death cause when preferred death cause is not null
   * or empty<br>
   ...
   *
   * <p><strong>Should</strong> merge all non Preferred patients in the the notPreferred list to
   * preferred patient
   *
   * @param preferred
   * @param notPreferred
   ...
   * @throws SerializationException
   */
  public void mergePatients(Patient preferred, List<Patient> notPreferred)
      throws APIException, SerializationException;
   ...
   *
   * <p><strong>Should</strong> throw API exception if patient is null
   *
   ...
   *
   * <p><strong>Should</strong> throw error when given patient is null<br>
   ...
   */
  @Authorized(
      value = {PrivilegeConstants.GET_PATIENTS, PrivilegeConstants.EDIT_OBS},
      requireAll = true)
  public void saveCauseOfDeathObs(
      Patient patient, Date dateDied, Concept causeOfDeath, String otherReason) throws APIException;

  /**
   * Gets an identifier validator matching the given class.
   *
   * <p><strong>Should</strong> return patient identifier validator given class
   *
   ...
   *
   * <p><strong>Should</strong> return true when patientIdentifier contains a patient and another
   * patient has this id<br>
   ...
   *     patientIdentifier.patient id id this id
   */
  @Authorized(PrivilegeConstants.GET_PATIENTS)
   ...
   *
   * <p><strong>Should</strong> return the patientIdentifier with the given id
   *
   ...
   *
   * <p><strong>Should</strong> void given patient identifier with given reaso<br>
   ...
   *
   * <p><strong>Should</strong> create new patientIndentifier<br>
   ...
   * <br>
   * <strong>Should</strong> throw an APIException if the patientIdentifier string is an empty
   * string
   *
  ...
  @Authorized({
    ...
    PrivilegeConstants.EDIT_PATIENT_IDENTIFIERS
  })
   ...
   *
   * <p><strong>Should</strong> delete patient identifier from database
   *
   ...
   *
   * <p><strong>Should</strong> get the allergy list and status
   *
   ...
   *
   * <p><strong>Should</strong> save the allergy list and status<br>
   * <strong>Should</strong> void removed allergies and maintain status as see list if some
   * allergies are removed<br>
   ...
   * <strong>Should</strong> void all allergies and set status to no known allergies if all
   * allergies are removed and status set as such<br>
   ...
   *
   * <p><strong>Should</strong> return allergy given valid uuid<br>
   ...
   * it is null.
   *
   * <p><strong>Should</strong> save the allergy
   *
   ...
   *
   * <p><strong>Should</strong> set the end date for the allergy
   *
   * @param allergy the Allergy
   ...
   *
   * <p><strong>Should</strong> return the right count when a patient has multiple matching person
   * names<br>
  ...
  /**
   * Get a limited size of patients from a given start index based on given criteria The identifier
   * is matched with the regex <code>OpenmrsConstants.PATIENT_IDENTIFIER_REGEX</code> All parameters
   * are optional and nullable. If null, it is not included in the search. Will not return voided
   * patients
   *
   * @param name (optional) this is a slight break from the norm, patients with a partial match on
   *     this name will be returned
   ...
   */
  @Authorized({PrivilegeConstants.GET_PATIENT_IDENTIFIERS})
  public List<PatientIdentifier> getPatientIdentifiersByPatientProgram(
