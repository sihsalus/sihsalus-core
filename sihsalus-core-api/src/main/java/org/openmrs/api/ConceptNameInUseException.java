...
public class ConceptNameInUseException extends APIException {
   ...
   *
   * @param message the String to show to the user as to why the conceptName's name can't be changed
   */
  ...
  /**
   * Convenience constructor to give the user a message other than the normal one and to chain this
  ...
  /**
   * Convenience constructor used to only set the parent exception to chain with. This does not set
   * the error message for the user as to why an exception is being thrown. The {@link
   * #ConceptNameInUseException(String, Throwable)} constructor is preferred over this one.
   *
   * @param cause the parent exception
   */
