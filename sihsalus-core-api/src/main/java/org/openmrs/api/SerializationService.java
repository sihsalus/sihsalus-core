...
public interface SerializationService extends OpenmrsService {
   ...
   *
   * <p><strong>Should</strong> return a serializer
   *
   ...
   *
   * <p><strong>Should</strong> return a serializer of the given class
   *
   ...
   *
   * <p><strong>Should</strong> Serialize And Deserialize Correctly<br>
