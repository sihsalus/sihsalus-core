...
public interface DiagnosisService extends OpenmrsService {
   ...
   */
  @Authorized({PrivilegeConstants.GET_DIAGNOSES})
  List<Diagnosis> getDiagnosesByEncounter(
   ...
   *
   * <p><strong>Should</strong> unset voided bit on given diagnosis
   *
   ...
   * don't want to ever lose data. The data really <i>should</i> be voided and then it is not seen
   * in interface any longer (see #voidDiagnosis(Diagnosis) for that one) If other things link to
   * this diagnosis, an error will be thrown.
   *
   * <p><strong>Should</strong> delete the given diagnosis from th e database
   *
   ...
   *
   * <p><strong>Should</strong> return all diagnosis attribute types including retired ones.
   *
   ...
   *
   * <p><strong>Should</strong> return the diagnosis attribute type with the given id<br>
   ...
   *
   * <p><strong>Should</strong> return the diagnosis attribute type with the given uuid<br>
   ...
   *
   * <p><strong>Should</strong> create a new diagnosis attribute type<br>
   ...
   *
   * <p><strong>Should</strong> retire a diagnosis attribute type
   *
   ...
   */
  @Authorized(PrivilegeConstants.EDIT_DIAGNOSES)
  DiagnosisAttributeType retireDiagnosisAttributeType(
      DiagnosisAttributeType diagnosisAttributeType, String reason) throws APIException;

  /**
   * Restores a diagnosis attribute type that was previously retired
   *
   * <p><strong>Should</strong> unretire a retired diagnosis attribute type
   *
   ...
   */
  @Authorized(PrivilegeConstants.EDIT_DIAGNOSES)
  DiagnosisAttributeType unretireDiagnosisAttributeType(
      DiagnosisAttributeType diagnosisAttributeType) throws APIException;

  /**
   * Completely removes a diagnosis attribute type from the database
   *
   * <p><strong>Should</strong> completely remove a diagnosis attribute type
   *
   ...
   *
   * <p><strong>Should</strong> get the diagnosis attribute with the given uuid<br>
