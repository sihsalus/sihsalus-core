...
public interface OrderService extends OpenmrsService {
  ...
  /**
   * Setter for the Order data access object. The dao is used for saving and getting orders to/from
   * the database
   *
  ...
  /**
   * Save or update the given <code>order</code> in the database. If the OrderType for the order is
   * not specified, then it will be set to the one set on the OrderContext if any, if none exists on
   * the orderContext, then it will be set to the one associated to the ConceptClass of the ordered
   * concept otherwise the save fails. If the CareSetting field of the order is not specified then
   * it will default to the one set on the passed in OrderContext if any otherwise the save fails.
   *
   * <p><strong>Should</strong> not save order if order doesnt validate<br>
   * <strong>Should</strong> discontinue existing active order if new order being saved with action
   * to discontinue<br>
   * <strong>Should</strong> pass if the existing drug order matches the concept and drug of the DC
   * order<br>
   * <strong>Should</strong> fail if the existing drug order matches the concept and not drug of the
   * DC order<br>
   * <strong>Should</strong> discontinue previousOrder if it is not already discontinued<br>
   * <strong>Should</strong> fail if concept in previous order does not match this concept<br>
   * <strong>Should</strong> not allow editing an existing order<br>
   * <strong>Should</strong> not allow revising a voided order<br>
   * <strong>Should</strong> not allow revising a stopped order<br>
   * <strong>Should</strong> not allow revising an expired order<br>
   * <strong>Should</strong> not allow revising an order with no previous order<br>
   * <strong>Should</strong> save a revised order<br>
   * <strong>Should</strong> save a revised order for a scheduled order which is not started<br>
   * <strong>Should</strong> set order number specified in the context if specified<br>
   * <strong>Should</strong> set the order number returned by the configured generator<br>
   * <strong>Should</strong> set order type if null but mapped to the concept class<br>
   * <strong>Should</strong> fail if order type is null and not mapped to the concept class<br>
   * <strong>Should</strong> default to care setting and order type defined in the order context if
   * null<br>
   * <strong>Should</strong> not allow changing the patient of the previous order when revising an
   * order<br>
   * <strong>Should</strong> not allow changing the careSetting of the previous order when revising
   * an order<br>
   * <strong>Should</strong> not allow changing the concept of the previous order when revising an
   * order<br>
   * <strong>Should</strong> not allow changing the drug of the previous drug order when revising an
   * order<br>
   * <strong>Should</strong> fail if concept in previous order does not match that of the revised
   * order<br>
   * <strong>Should</strong> fail if the existing drug order matches the concept and not drug of the
   * revised order<br>
   * <strong>Should</strong> fail if the order type of the previous order does not match<br>
   * <strong>Should</strong> fail if the java type of the previous order does not match<br>
   * <strong>Should</strong> fail if the careSetting of the previous order does not match<br>
   * <strong>Should</strong> set concept for drug orders if null<br>
   * <strong>Should</strong> pass for a discontinuation order with no previous order<br>
   * <strong>Should</strong> fail if an active drug order for the same concept and care setting
   * exists<br>
   * <strong>Should</strong> pass if an active test order for the same concept and care setting
   * exists<br>
   * <strong>Should</strong> pass if an active order for the same concept exists in a different care
   * setting<br>
   * <strong>Should</strong> set Order type of Drug Order to drug order if not set and concept not
   * mapped<br>
   * <strong>Should</strong> set Order type of Test Order to test order if not set and concept not
   * mapped<br>
   * <strong>Should</strong> throw AmbiguousOrderException if an active drug order for the same drug
   * formulation<br>
   * <strong>Should</strong> pass if an active order for the same concept exists in a different care
   * setting<br>
   * <strong>Should</strong> fail for revision order if an active drug order for the same concept
   * and care<br>
   * <strong>Should</strong> pass for revision order if an active test order for the same concept
   * and care<br>
   * <strong>Should</strong> roll the autoExpireDate to the end of the day if it has no time
   * component<br>
   * <strong>Should</strong> not change the autoExpireDate if it has a time component<br>
   * <strong>Should</strong> throw AmbiguousOrderException if disconnecting multiple active orders
   * for the given<br>
   * <strong>Should</strong> throw AmbiguousOrderException if disconnecting multiple active drug
   * orders with the
   *
  ...
  /**
   * Save or update the given retrospective <code>order</code> in the database. If the OrderType for
   * the order is not specified, then it will be set to the one set on the OrderContext if any, if
   * none exists on the orderContext, then it will be set to the one associated to the ConceptClass
   * of the ordered concept otherwise the save fails. If the CareSetting field of the order is not
   * specified then it will default to the one set on the passed in OrderContext if any otherwise
   * the save fails. Retrospective entry of orders can affect downstream systems that acts on orders
   * created. Orders cannot be stopped if they are already stopped in retrospective entry.
   *
   * @param order the Order to save
   * @param orderContext the OrderContext object
   * @return the Order that was saved
   ...
   *
   * <p><strong>Should</strong> delete order from the database
   *
   ...
   *
   * <p><strong>Should</strong> delete any Obs associated to the order when cascade is true
   *
   * @param order The Order to remove from the system
   * @param cascade
   * @throws APIException
   ...
   * semblance
   *
   * <p><strong>Should</strong> void an order<br>
   * <strong>Should</strong> unset dateStopped of the previous order if the specified order is a
   * discontinuation<br>
   * <strong>Should</strong> unset dateStopped of the previous order if the specified order is a
   * revision
   *
   ...
   *
   * <p><strong>Should</strong> find object given valid uuid<br>
  ...
  /**
   * Get discontinuation order for the given order, it is the un voided discontinuation order with a
   * previousOrder that matches the specified order.
   *
   * <p><strong>Should</strong> return discontinuation order if order has been discontinued<br>
   * <strong>Should</strong> return null if order has not been discontinued<br>
  ...
  /**
   * Get revision order for the given order, it is the order with the changes that was created as a
   * replacement for the specified order. In other words, it is the un voided revise order with a
   * previousOrder that matches the specified order.
   *
   * <p><strong>Should</strong> return revision order if order has been revised<br>
   * <strong>Should</strong> return null if order has not been revised<br>
   ...
   *
   * <p><strong>Should</strong> fail if patient is null<br>
   * <strong>Should</strong> fail if careSetting is null<br>
   * <strong>Should</strong> get the orders that match all the arguments<br>
   * <strong>Should</strong> get all unvoided matches if includeVoided is set to false<br>
   * <strong>Should</strong> include voided matches if includeVoided is set to true<br>
  ...
  public List<Order> getOrders(
      Patient patient, CareSetting careSetting, OrderType orderType, boolean includeVoided);
   ...
   * Each extra value for a parameter that is provided acts as an "and" and will reduce the number
   * of results returned
   *
   * <p><strong>Should</strong> get the order matching the search criteria
   *
   ...
   *
   * <p><strong>Should</strong> unvoid an order<br>
   * <strong>Should</strong> stop the previous order if the specified order is a discontinuation<br>
   * <strong>Should</strong> stop the previous order if the specified order is a revision<br>
   * <strong>Should</strong> fail for a discontinuation order if the previousOrder is inactive<br>
   ...
   *
   * <p><strong>Should</strong> set the new fulfillerStatus<br>
   * <strong>Should</strong> set the new fulFillerComment<br>
   * <strong>Should</strong> not update fulfillerStatus or fulFillerComment if null passed in to
   * that field<br>
  ...
  public Order updateOrderFulfillerStatus(
      Order order, Order.FulfillerStatus orderFulfillerStatus, String fullFillerComment);
   ...
   * <p><strong>Should</strong> set the new fulfillerStatus<br>
   * <strong>Should</strong> set the new fulFillerComment<br>
   * <strong>Should</strong> set the new accessionNumber<br>
   * <strong>Should</strong> not update fulfillerStatus or fulFillerComment or accessionNumber if
   * null passed in to that field<br>
   * <strong>Should</strong> save the changed order
   *
   * @param order order whose fulfillerStatus should be changed
   * @param orderFulfillerStatus describes the new Order.FulfillerStatus the order should be set to
   ...
   *
   * <p><strong>Should</strong> find object given valid order number<br>
   ...
   *
   * <p><strong>Should</strong> return orders with the given concept<br>
   * <strong>Should</strong> return empty list for concept without orders<br>
   * <strong>Should</strong> reject a null patient<br>
   ...
   * occurred, i.e if this order has a previous order, fetch it and if it also has a previous order
   * then fetch it until the original one with no previous order is reached
   *
   * <p><strong>Should</strong> return all order history for given order number
   *
  ...
  /**
   * Gets all active orders for the specified patient matching the specified CareSetting, OrderType
   * as of the specified date. Below is the criteria for determining an active order:
   *
   * <pre>
   * - Not voided
   ...
   * </pre>
   *
   * <p><strong>Should</strong> return all active orders for the specified patient<br>
   * <strong>Should</strong> return all active orders for the specified patient and care setting<br>
   * <strong>Should</strong> return all active drug orders for the specified patient<br>
   * <strong>Should</strong> return all active test orders for the specified patient<br>
   * <strong>Should</strong> fail if patient is null<br>
   * <strong>Should</strong> return active orders as of the specified date<br>
   * <strong>Should</strong> return all orders if no orderType is specified<br>
   * <strong>Should</strong> include orders for sub types if order type is specified
   *
   * @param patient the patient
  ...
  public List<Order> getActiveOrders(
      Patient patient, OrderType orderType, CareSetting careSetting, Date asOfDate);
   ...
   *
   * <p><strong>Should</strong> return the care setting with the specified uuid
   *
   ...
   *
   * <p><strong>Should</strong> return the care setting with the specified name
   *
   ...
   * included too
   *
   * <p><strong>Should</strong> return only un retired care settings if includeRetired is set to
   * false<br>
   ...
   *
   * <p><strong>Should</strong> return the order type that matches the specified name
   *
   ...
   *
   * <p><strong>Should</strong> return the order frequency that matches the specified id
   *
   ...
   *
   * <p><strong>Should</strong> return the order frequency that matches the specified uuid
   *
   ...
   *
   * <p><strong>Should</strong> return the order frequency that matches the specified concept
   *
   ...
   *
   * <p><strong>Should</strong> return only non retired order frequencies if includeRetired is set
   * to false<br>
   ...
   * phrase
   *
   * <p><strong>Should</strong> get non retired frequencies with names matching the phrase if
   * includeRetired is false<br>
   * <strong>Should</strong> include retired frequencies if includeRetired is set to true<br>
   * <strong>Should</strong> get frequencies with names that match the phrase and locales if exact
   * locale is false<br>
   * <strong>Should</strong> get frequencies with names that match the phrase and locale if exact
   * locale is true<br>
   * <strong>Should</strong> return unique frequencies<br>
   ...
   *     broader locale will be matched e.g in case en_GB is passed in then en will be matched
  ...
  public List<OrderFrequency> getOrderFrequencies(
      String searchPhrase, Locale locale, boolean exactLocale, boolean includeRetired);

  /**
   * Discontinues an order. Creates a new order that discontinues the orderToDiscontinue
   *
   * <p><strong>Should</strong> set correct attributes on the discontinue and discontinued orders
   * <br>
   * <strong>Should</strong> pass for an active order which is scheduled and not started as of
   * discontinue date<br>
   * <strong>Should</strong> not pass for a discontinuation order<br>
   * <strong>Should</strong> fail for a stopped order<br>
   * <strong>Should</strong> fail for an expired order<br>
   * <strong>Should</strong> reject a future discontinueDate<br>
   ...
   * @throws APIException if the <code>action</code> of orderToDiscontinue is <code>
   *     Order.Action.DISCONTINUE</code>
   * @since 1.10
   */
   ...
   * Discontinues an order. Creates a new order that discontinues the orderToDiscontinue.
   *
   * <p><strong>Should</strong> populate correct attributes on the discontinue and discontinued
   * orders<br>
   * <strong>Should</strong> pass for an active order which is scheduled and not started as of
   * discontinue date<br>
   * <strong>Should</strong> fail for a discontinuation order<br>
   * <strong>Should</strong> fail if discontinueDate is in the future<br>
   * <strong>Should</strong> fail for a voided order<br>
   ...
   *
   * <p><strong>Should</strong> add a new order frequency to the database<br>
   * <strong>Should</strong> edit an existing order frequency that is not in use<br>
   ...
   *
   * <p><strong>Should</strong> retire given order frequency
   *
   ...
   *
   * <p><strong>Should</strong> unretire given order frequency
   *
   ...
   *
   * <p><strong>Should</strong> delete given order frequency<br>
   ...
   *
   * <p><strong>Should</strong> find order type object given valid id<br>
   ...
   *
   * <p><strong>Should</strong> find order type object given valid uuid<br>
   ...
   * otherwise not
   *
   * <p><strong>Should</strong> get all order types if includeRetired is set to true<br>
   ...
   *
   * <p><strong>Should</strong> add a new order type to the database<br>
   ...
   *
   * <p><strong>Should</strong> delete order type if not in use<br>
   ...
   *
   * <p><strong>Should</strong> retire order type
   *
   ...
   *
   * <p><strong>Should</strong> unretire order type
   *
  ...
  /**
   * Returns all descendants of a given order type for example Given TEST will get back LAB TEST and
   * RADIOLOGY TEST; and Given LAB TEST, will might get back SEROLOGY, MICROBIOLOGY, and CHEMISTRY
   *
   ...
   *
   * <p><strong>Should</strong> get order type mapped to the given concept class
   *
   ...
   *
   * <p><strong>Should</strong> get order type mapped to the given concept
   *
   * @param concept the concept
   * @return the matching order type
   * @since 1.10
   ...
   *
   * <p><strong>Should</strong> find order types with the specified class name<br>
   ...
   */
  @Authorized(PrivilegeConstants.GET_ORDER_TYPES)
  public List<OrderType> getOrderTypesByClassName(String javaClassName, boolean includeRetired)
      throws APIException;
   ...
   */
  @Authorized(PrivilegeConstants.GET_ORDER_TYPES)
  public List<OrderType> getOrderTypesByClassName(
      String javaClassName, boolean includeSubclasses, boolean includeRetired) throws APIException;

  /**
   * Gets the possible drug routes, i.e the set members for the concept that matches the uuid
   * specified as the value for the global property {@link
   * OpenmrsConstants#GP_DRUG_ROUTES_CONCEPT_UUID}
   *
   * <p><strong>Should</strong> return an empty list if nothing is configured
   *
   ...
   *
   * <p><strong>Should</strong> return an empty list if nothing is configured<br>
   ...
   * uuid specified as the value for the global property {@link
   * OpenmrsConstants#GP_DRUG_DISPENSING_UNITS_CONCEPT_UUID}
   *
   * <p><strong>Should</strong> return an empty list if nothing is configured<br>
   * <strong>Should</strong> return a list if GP is set<br>
  ...
  /**
   * Gets the non coded drug concept, i.e the concept that matches the uuid specified as the value for
   * the global property {@link OpenmrsConstants#GP_DRUG_ORDER_DRUG_OTHER <p> <strong>Should</strong>
   ...
   * @param orderContext the order context data transfer object containing care setting and the
   *     order type to save with the order group
   * @return the order group that was saved with the specified order context data
   * @since 2.7.0
   * @throws APIException
   */
  @Authorized({PrivilegeConstants.EDIT_ORDERS, PrivilegeConstants.ADD_ORDERS})
  public OrderGroup saveOrderGroup(OrderGroup orderGroup, OrderContext orderContext)
      throws APIException;
   ...
   *
   * @param orderGroupAttributeTypeId The Id of the order group attribute type to fetch from the
   *     database
   ...
   */
  @Authorized(PrivilegeConstants.GET_ORDERS)
  OrderGroupAttributeType getOrderGroupAttributeType(Integer orderGroupAttributeTypeId)
      throws APIException;
   ...
   */
  @Authorized({PrivilegeConstants.EDIT_ORDERS, PrivilegeConstants.ADD_ORDERS})
  OrderGroupAttributeType saveOrderGroupAttributeType(
      OrderGroupAttributeType orderGroupAttributeType) throws APIException;
  ...
  OrderGroupAttributeType retireOrderGroupAttributeType(
      OrderGroupAttributeType orderGroupAttributeType, String reason) throws APIException;
   ...
   */
  @Authorized(PrivilegeConstants.MANAGE_ORDER_TYPES)
  OrderGroupAttributeType unretireOrderGroupAttributeType(
      OrderGroupAttributeType orderGroupAttributeType) throws APIException;
   ...
   */
  @Authorized(PrivilegeConstants.PURGE_ORDERS)
  void purgeOrderGroupAttributeType(OrderGroupAttributeType orderGroupAttributeType)
      throws APIException;
   ...
   */
  @Authorized({PrivilegeConstants.EDIT_ORDERS, PrivilegeConstants.ADD_ORDERS})
  OrderAttributeType saveOrderAttributeType(OrderAttributeType orderAttributeType)
      throws APIException;
   ...
   */
  @Authorized(PrivilegeConstants.MANAGE_ORDER_TYPES)
  OrderAttributeType retireOrderAttributeType(OrderAttributeType orderAttributeType, String reason)
      throws APIException;
   ...
   */
  @Authorized(PrivilegeConstants.MANAGE_ORDER_TYPES)
  OrderAttributeType unretireOrderAttributeType(OrderAttributeType orderAttributeType)
      throws APIException;
   ...
   *     org.openmrs.CareSetting, java.util.Date) This method works exactly the same; it only adds
  ...
  @Authorized(PrivilegeConstants.GET_ORDERS)
  public List<Order> getActiveOrders(
      Patient patient, Visit visit, OrderType orderType, CareSetting careSetting, Date asOfDate);

  /**
   * @see OrderService#getOrders(org.openmrs.Patient, org.openmrs.CareSetting,
   *     org.openmrs.OrderType, boolean) This method works exactly the same; it only adds visit to
   *     the search criteria. It effectively surpasses the above method; the old one is however kept
