...
public interface OrderService extends OpenmrsService {
	 ...
	 * concept otherwise the save fails. If the CareSetting field of the order is not specified then it
	 * will default to the one set on the passed in OrderContext if any otherwise the save fails.
	 * <p>
	 * <strong>Should</strong> not save order if order doesnt validate<br/>
	 * <strong>Should</strong> discontinue existing active order if new order being saved with action to
	 * discontinue<br/>
	 ...
	 * order<br/>
	 * <strong>Should</strong> not allow changing the careSetting of the previous order when revising an
	 * order<br/>
	 ...
	 * <strong>Should</strong> pass if an active order for the same concept exists in a different care
	 * setting<br/>
	 * <strong>Should</strong> fail for revision order if an active drug order for the same concept and
	 * care<br/>
	 * <strong>Should</strong> pass for revision order if an active test order for the same concept and
	 * care<br/>
	 ...
	 * <strong>Should</strong> throw AmbiguousOrderException if disconnecting multiple active orders for
	 * the given<br/>
	 ...
	 * none exists on the orderContext, then it will be set to the one associated to the ConceptClass of
	 * the ordered concept otherwise the save fails. If the CareSetting field of the order is not
	 * specified then it will default to the one set on the passed in OrderContext if any otherwise the
	 * save fails. Retrospective entry of orders can affect downstream systems that acts on orders
	...
	/**
	 * Completely delete an order from the database. This should not typically be used unless
	 * desperately needed. Most orders should just be voided. See {@link #voidOrder(Order, String)} This
	 * method is different from purgeOrder(Order order) above: If param cascade is false will completely
	 * delete an order from the database period If param cascade is true will completely delete an order
	 * from the database and delete any Obs that references the Order.
	 * <p>
	 ...
	 * semblance
	 * <p>
	 * <strong>Should</strong> void an order<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> return discontinuation order if order has been discontinued<br/>
	 ...
	 * previousOrder that matches the specified order.
	 * <p>
	 * <strong>Should</strong> return revision order if order has been revised<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> unvoid an order<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> set the new fulfillerStatus<br/>
	 * <strong>Should</strong> set the new fulFillerComment<br/>
	 * <strong>Should</strong> not update fulfillerStatus or fulFillerComment if null passed in to that
	 * field<br/>
	 ...
	 * <strong>Should</strong> not update fulfillerStatus or fulFillerComment or accessionNumber if null
	 * passed in to that field<br/>
	 * <strong>Should</strong> save the changed order
	 *
	 * @param order order whose fulfillerStatus should be changed
	 * @param orderFulfillerStatus describes the new Order.FulfillerStatus the order should be set to
	 ...
	 * <p>
	 * <strong>Should</strong> find object given valid order number<br/>
	...
	/**
	 * Gets all Order objects that use this Concept for a given patient. Orders will be returned in the
	 * order in which they occurred, i.e. sorted by startDate starting with the latest
	 * <p>
	 * <strong>Should</strong> return orders with the given concept<br/>
	...
	/**
	 * Gets all active orders for the specified patient matching the specified CareSetting, OrderType as
	 * of the specified date. Below is the criteria for determining an active order: <pre>
	 * - Not voided
	 ...
	 * </pre>
	 * <p>
	 * <strong>Should</strong> return all active orders for the specified patient<br/>
	 ...
	 * included too
	 * <p>
	 * <strong>Should</strong> return only un retired care settings if includeRetired is set to
	 * false<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> return only non retired order frequencies if includeRetired is set to
	 * false<br/>
	 ...
	 * phrase
	 * <p>
	 * <strong>Should</strong> get non retired frequencies with names matching the phrase if
	 ...
	 * @param exactLocale If false then order frequencies associated to concepts with names in a broader
	 ...
	 * <p>
	 * <strong>Should</strong> set correct attributes on the discontinue and discontinued orders<br/>
	 ...
	 * Discontinues an order. Creates a new order that discontinues the orderToDiscontinue.
	 * <p>
	 * <strong>Should</strong> populate correct attributes on the discontinue and discontinued
	 * orders<br/>
	 * <strong>Should</strong> pass for an active order which is scheduled and not started as of
	 * discontinue date<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> add a new order frequency to the database<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> delete given order frequency<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> find order type object given valid id<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> find order type object given valid uuid<br/>
	 ...
	 * otherwise not
	 * <p>
	 * <strong>Should</strong> get all order types if includeRetired is set to true<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> add a new order type to the database<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> delete order type if not in use<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> find order types with the specified class name<br/>
	 ...
	 * <p>
	 * <strong>Should</strong> find order types with the specified class name<br/>
	 * <strong>Should</strong> get include order types subclasses if includeSubclasses is set to
	 * true<br/>
	 * <strong>Should</strong> get include retired order types if includeRetired is set to true
	 *
	 * @param javaClassName the class name used to get the order types
	 ...
	 * <p>
	 * <strong>Should</strong> return an empty list if nothing is configured<br/>
	 ...
	 *      boolean) This method works exactly the same; it only adds visit to the search criteria. It
