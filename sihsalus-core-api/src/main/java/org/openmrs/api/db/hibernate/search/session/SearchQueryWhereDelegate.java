...
class SearchQueryWhereDelegate<
    ...
    implements SearchQueryWhereStep<SR, N, H, LOS, PDF> {
  ...
  public SearchQueryWhereDelegate(
      SearchQueryWhereStep<SR, N, H, LOS, PDF> delegate,
  ...
  @Override
  public N where(
      BiConsumer<? super PDF, ? super SimpleBooleanPredicateClausesCollector<SR, ?>>
