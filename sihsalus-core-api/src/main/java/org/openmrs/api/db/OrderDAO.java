 ...
 *
 * <p>This class should never be used directly. It should only be used through the {@link
...
public interface OrderDAO {
  ...
  /**
   * @see org.openmrs.api.OrderService#getOrders(org.openmrs.Patient, org.openmrs.Visit,
   *     org.openmrs.CareSetting, java.util.List, boolean, boolean)
   */
  public List<Order> getOrders(
      Patient patient,
      Visit visit,
