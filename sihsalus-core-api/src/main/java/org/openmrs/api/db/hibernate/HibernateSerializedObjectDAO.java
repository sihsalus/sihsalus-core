...
public class HibernateSerializedObjectDAO implements SerializedObjectDAO {
  ...
  @Autowired
  public HibernateSerializedObjectDAO(
      SessionFactory sessionFactory, List<Class<? extends OpenmrsObject>> supportedTypes) {
   ...
   */
  @Override
  public <T extends OpenmrsObject> T getObjectByUuid(Class<T> baseClass, String uuid)
      throws DAOException {
  ...
  public <T extends OpenmrsObject> T saveObject(T object, OpenmrsSerializer serializer)
    ...
    if (baseType == null) {
      throw new DAOException(
          "SerializedObjectDAO does not support saving objects of type <"
              + object.getClass()
              + ">");
    }
    ...
    try {
      ...
      throw new DAOException(
          "Unable to save object <" + object + "> because serialization failed.", e);
    }
