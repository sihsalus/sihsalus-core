 ...
 *
 * <p>When setting a final predicate, the code should first check if {@link #getFinalPredicate()} is
 * not null and include it in the new final predicate.
 *
 * <p>See {@link SearchCreatedEvent}.
 *
 * @since 2.8.0
 */
