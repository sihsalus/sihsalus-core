 ...
 * @since 2.8.0
 */
class SearchQuerySelectDelegate<SR, R, E, LOS>
    extends AbstractDelegatingSearchQuerySelectStep<SR, R, E, LOS>
    implements SearchQueryContributor {
  ...
  public SearchQueryOptionsStep<SR, ?, E, LOS, ?, ?> where(
      BiConsumer<
              ? super TypedSearchPredicateFactory<SR>,
              ? super SimpleBooleanPredicateClausesCollector<SR, ?>>
  ...
  @Override
  public SearchQueryOptionsStep<SR, ?, E, LOS, ?, ?> where(
      Function<? super TypedSearchPredicateFactory<SR>, ? extends PredicateFinalStep>
          predicateContributor) {
    if (finalPredicate != null) {
      return super.where(
          (f, root) -> {
  ...
  public <P> SearchQueryWhereStep<SR, ?, P, LOS, ?> select(
      Function<? super TypedSearchProjectionFactory<SR, R, E>, ? extends ProjectionFinalStep<P>>
