...
public class PersonQuery {
  ...
  public SearchPredicate getPatientNameQuery(
      SearchPredicateFactory predicateFactory, String query, boolean includeVoided) {
    return getPersonNameQuery(predicateFactory, query, false, includeVoided, true, null);
  }

  public SearchPredicate getPersonNameQueryWithOrParser(
      SearchPredicateFactory predicateFactory, String query, boolean includeVoided, Boolean dead) {
   ...
   */
  public SearchPredicate getSoundexPersonNameSearchOnThreeNames(
                          ...
                          bb -> {
                            ...
                            bb.should(
                                predicateFactory
                                    ...
                                    .boost(2f));
                            bb.should(
                                predicateFactory.match().field("givenNameSoundex").matching(name3));
                          }));
              b.should(
                  predicateFactory
                      .bool()
   ...
   */
  public SearchPredicate getSoundexPersonNameSearchOnTwoNames(
      SearchPredicateFactory predicateFactory,
      String name1,
      String name2,
      Integer birthyear,
   ...
   *     and the other defined search criteria
   */
  public SearchPredicate getSoundexPersonNameSearchOnNNames(
      SearchPredicateFactory predicateFactory,
      String[] searchNames,
      Integer birthyear,
      boolean includeVoided,
    ...
    return newPersonNameSearchQuery(
        predicateFactory, fields, query, true, includeVoided, null, null, birthyear, gender);
  }

  /**
   * The method creates a Lucene search query for a Person based on a soundex search on the
   * givenName, familyNames and middleName
   *
   ...
   */
  public SearchPredicate getSoundexPersonNameQuery(
      SearchPredicateFactory predicateFactory,
      String query,
      Integer birthyear,
      boolean includeVoided,
    ...
    return newPersonNameSearchQuery(
        predicateFactory,
        Arrays.asList(
            "familyNameSoundex", "familyName2Soundex", "middleNameSoundex", "givenNameSoundex"),
        query,
        true,
        includeVoided,
        null,
  ...
  private SearchPredicate getPersonNameQuery(
      SearchPredicateFactory predicateFactory,
      String query,
      boolean orQueryParser,
      boolean includeVoided,
      boolean patientsOnly,
      Boolean dead) {
    List<String> fields =
        new ArrayList<>(
            Arrays.asList(
  ...
  private SearchPredicate newPersonNameSearchQuery(
      SearchPredicateFactory predicateFactory,
      List<String> fields,
      String query,
      boolean orQueryParser,
    ...
    return predicateFactory
        ...
        .with(
            b -> {
              ...
              applyPersonFilters(
                  predicateFactory, b, includeVoided, patientsOnly, dead, birthyear, gender);
            })
        .toPredicate();
  }
  ...
  private void applyPersonFilters(
      SearchPredicateFactory predicateFactory,
      BooleanPredicateOptionsCollector<?, ?> b,
      boolean includeVoided,
      Boolean patientsOnly,
      Boolean dead,
      Integer birthyear,
    ...
    if (birthyear != null && birthyear != 0) {
      ZonedDateTime birthdate =
          LocalDate.ofYearDay(birthyear, 1).atStartOfDay(ZoneId.systemDefault());
      b.must(
          predicateFactory.or(
              predicateFactory
                  .range()
