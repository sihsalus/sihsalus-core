...
public interface SerializedObjectDAO {
   ...
   *
   * <p><strong>Should</strong> return the saved serialized object
   *
   ...
   *
   * <p><strong>Should</strong> return the saved object
   *
   ...
   * @throws DAOException
   */
  public <T extends OpenmrsObject> T getObjectByUuid(Class<T> type, String uuid)
      throws DAOException;

  /**
   * Saves an object to the database in serialized form
   *
   * <p><strong>Should</strong> save the passed object if supported<br>
  ...
  /**
   * Saves an object to the database, in serialized form, using the specified {@link
   * OpenmrsSerializer}
   *
   * <p><strong>Should</strong> save the passed object if supported<br>
   * <strong>Should</strong> throw an exception if object not supported<br>
   ...
   * @throws DAOException
   */
  public <T extends OpenmrsObject> T saveObject(T object, OpenmrsSerializer serializer)
      throws DAOException;
   ...
   * includeRetired flag
   *
   * <p><strong>Should</strong> return all objects of the passed type
   *
   * @param type The class of the object to retrieve
   ...
   *
   * <p><strong>Should</strong> return all non-retired objects of the passed type
   *
   * @param type The class of the object to retrieve
   * @return &lt;List&gt; T A list of all the saved objects that match the passed type
   * @throws DAOException
  ...
  /**
   * Retrieves all objects from the database that match the passed type that have been saved through
   * serialization Returns voided / retired Objects only if includeRetired parameter is true
   *
   * <p><strong>Should</strong> return all saved objects of the passed type if includeRetired<br>
   * <strong>Should</strong> return only non-retired objects of the passed type if not
   * includeRetired
   *
   * @param type The class of the object to retrieve
   ...
   * @throws DAOException
   */
  public <T extends OpenmrsObject> List<T> getAllObjects(Class<T> type, boolean includeRetired)
      throws DAOException;

  /**
   * Retrieves all raw Serialized Objects from the database that match the passed type and name
   *
   * <p><strong>Should</strong> return all saved objects with the given type and exact name<br>
   ...
   * @throws DAOException
   */
  public <T extends OpenmrsMetadata> List<T> getAllObjectsByName(
      Class<T> type, String name, boolean exactMatchOnly) throws DAOException;
   ...
   *
   * <p><strong>Should</strong> delete the object with the passed id
   *
