...
public class ChainingInterceptor implements Interceptor {
  ...
  public boolean onFlushDirty(
    ...
    for (Interceptor i : interceptors) {
      ...
      objectChanged =
          i.onFlushDirty(entity, id, currentState, previousState, propertyNames, types)
              || objectChanged;
    }
  ...
  public Object instantiate(
      String entityName, EntityRepresentationStrategy entityRepresentationStrategy, Object id) {
    for (Interceptor i : interceptors) {
