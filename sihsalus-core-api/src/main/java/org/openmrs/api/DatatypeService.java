...
public interface DatatypeService extends OpenmrsService {
   ...
   */
  <T extends CustomDatatype<?>> T getDatatype(Class<T> clazz, String config)
      throws CustomDatatypeException;

  /**
   * Gets the default handler for a {@link CustomDatatype}, and sets its configuration
   *
   * <p><strong>Should</strong> return a handler for the specified datatype<br>
  ...
  List<Class<? extends CustomDatatypeHandler>> getHandlerClasses(
