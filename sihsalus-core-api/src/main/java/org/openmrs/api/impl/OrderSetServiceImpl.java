...
public class OrderSetServiceImpl extends BaseOpenmrsService implements OrderSetService, RefByUuid {
  ...
  @Autowired protected OrderSetDAO dao;
  ...
  /**
   * @see
   *     org.openmrs.api.OrderSetService#saveOrderSetAttributeType(org.openmrs.OrderSetAttributeType)
   */
  @Override
  @Transactional(readOnly = false)
  public OrderSetAttributeType saveOrderSetAttributeType(
  ...
  /**
   * @see
   *     org.openmrs.api.OrderSetService#retireOrderSetAttributeType(org.openmrs.OrderSetAttributeType,
   *     java.lang.String)
   */
  @Override
  @Transactional(readOnly = false)
  public OrderSetAttributeType retireOrderSetAttributeType(
      OrderSetAttributeType orderSetAttributeType, String reason) {
    return dao.saveOrderSetAttributeType(orderSetAttributeType);
  }

  /**
   * @see
   *     org.openmrs.api.OrderSetService#unretireOrderSetAttributeType(org.openmrs.OrderSetAttributeType)
   */
  @Override
  @Transactional(readOnly = false)
  public OrderSetAttributeType unretireOrderSetAttributeType(
      OrderSetAttributeType orderSetAttributeType) {
  ...
  /**
   * @see
   *     org.openmrs.api.OrderSetService#purgeOrderSetAttributeType(org.openmrs.OrderSetAttributeType)
   */
  @Override
  @Transactional(readOnly = false)
  ...
  public List<Class<?>> getRefTypes() {
    return Arrays.asList(
        OrderSetMember.class, OrderSetAttribute.class, OrderSetAttributeType.class, OrderSet.class);
  }
}
