...
public interface EncounterService extends OpenmrsService {
   ...
   *
   * <p><strong>Should</strong> save encounter with basic details<br>
   ...
   *
   * <p><strong>Should</strong> throw error if given null parameter<br>
   ...
   *
   * <p><strong>Should</strong> not get voided encounters<br>
   ...
   *
   * <p><strong>Should</strong> get encounters by location<br>
  ...
  /**
   * Get all encounters that match a variety of (nullable) criteria contained in the parameter
   * object. Each extra value for a parameter that is provided acts as an "and" and will reduce the
   * number of results returned
   *
   * <p><strong>Should</strong> get encounters modified after specified date
   *
   ...
   *
   * <p><strong>Should</strong> void encounter and set attributes<br>
   ...
   *
   * <p><strong>Should</strong> cascade unvoid to obs<br>
   ...
   *
   * <p><strong>Should</strong> purgeEncounter<br>
   * <strong>Should</strong> fail if user is not supposed to edit encounters of type of given
   * encounter
   *
   ...
   * encounters, use <code>voidEncounter(org.openmrs.Encounter)</code>
   *
   * <p><strong>Should</strong> cascade purge to obs and orders<br>
   * <strong>Should</strong> fail if user is not supposed to edit encounters of type of given
   * encounter
   *
   * @param encounter encounter object to be purged
   ...
   *
   * <p><strong>Should</strong> save encounter type<br>
   ...
   *
   * <p><strong>Should</strong> throw error if given null parameter
   *
   ...
   *
   * <p><strong>Should</strong> not get retired types<br>
   ...
   *
   * <p><strong>Should</strong> not return retired types
   *
   ...
   *
   * <p><strong>Should</strong> not return retired types<br>
   ...
   *
   * <p><strong>Should</strong> return types by partial name match<br>
   ...
   *
   * <p><strong>Should</strong> retire type and set attributes<br>
   ...
   * used again
   *
   * <p><strong>Should</strong> unretire type and unmark attributes<br>
   * <strong>Should</strong> should throw error when trying to unretire encounter type when
   * encounter types are
   *
   ...
   *
   * <p><strong>Should</strong> purge type<br>
   ...
   * Search for encounters by patient name or patient identifier.
   *
   * <p><strong>Should</strong> get all unvoided encounters for the given patient name<br>
   ...
   * <strong>Should</strong> include voided encounters in the returned list if includedVoided is
   * true
   *
   * @param query patient name or identifier
   ...
   *
   * <p><strong>Should</strong> get all the unique encounters that match the specified parameter
   * values<br>
   ...
   * form or provider name. It returns a specific number of them from the specified starting
   * position. If start and length are not specified, then all matches are returned
   *
   * <p><strong>Should</strong> fetch encounters by patient id<br>
  ...
  @Authorized({PrivilegeConstants.GET_ENCOUNTERS})
  public List<Encounter> getEncounters(
      String query, Integer patientId, Integer start, Integer length, boolean includeVoided)
      throws APIException;

  /**
   * Get all encounters for a cohort of patients
   *
   * <p><strong>Should</strong> get all encounters for a cohort of patients
   *
   ...
   *
   * <p><strong>Should</strong> get the correct count of unique encounters
   *
   * @param query patient name or identifier
   * @param includeVoided Specifies whether voided encounters should be included
   ...
   *
   * <p><strong>Should</strong> get active encounters by visit<br>
   ...
   *
   * <p><strong>Should</strong> save encounter role with basic details<br>
   ...
   *
   * <p><strong>Should</strong> purge Encounter Role
   *
   ...
   *
   * <p><strong>Should</strong> get all encounter roles based on include retired flag.
   *
   * @param includeRetired
   ...
   *
   * <p><strong>Should</strong> find encounter role based on uuid
   *
   * @param uuid
   * @return EncounterRole
   * @since 1.9
   ...
   *
   * <p><strong>Should</strong> find an encounter role identified by its name
   *
   * @param name
   ...
   * used again
   *
   * <p><strong>Should</strong> unretire type and unmark attributes
   *
   ...
   *
   * <p><strong>Should</strong> return the unvoided encounters not assigned to any visit
   *
   ...
   *
   * <p>The empty encounters have only visit set.
   *
  ...
  /**
   * Returns result count for {@link #getEncountersByVisitsAndPatient(Patient, boolean, String,
   * Integer, Integer)}.
   *
   * @param patient
   * @param includeVoided
   ...
   */
  @Authorized({PrivilegeConstants.GET_VISITS})
  public Integer getEncountersByVisitsAndPatientCount(
      Patient patient, boolean includeVoided, String query) throws APIException;
   ...
   *
   * <p><strong>Should</strong> filter encounters if user is not allowed to see some encounters<br>
   * <strong>Should</strong> not filter all encounters when the encounter type's view privilege
   * column is null
   *
   ...
   *
   * <p><strong>Should</strong> return true if user is granted to view all encounters<br>
   ...
   *
   * <p><strong>Should</strong> return true if user is granted to edit all encounters<br>
   ...
   *
   * <p><strong>Should</strong> return true if user can edit encounter<br>
   ...
   * user will be taken by default
   *
   * <p><strong>Should</strong> return true if user can view encounter<br>
   ...
   *
   * <p><strong>Should</strong> find encounter roles based on their name
   *
   * @param name
   ...
   *
   * <p><strong>Should</strong> transfer an encounter with observations but not orders to given
   * patient<br>
