 ...
 *
 * <p>It delivers a default implementation for {@link EncounterVisitHandler#getDisplayName()}.
 *
 * @since 1.9
 */
public abstract class BaseEncounterVisitHandler implements EncounterVisitHandler {
  ...
  /**
   * Delegates to {@link EncounterVisitHandler#getDisplayName(java.util.Locale)} with {@link
