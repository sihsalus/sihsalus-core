...
/**
 * This is the super interface for all unvoid* actions that take place on all services. The {@link
 * RequiredDataAdvice} class uses AOP around each method in every service to check to see if its a
 * unvoid* method. If it is a unvoid* method, this class is called to handle setting the {@link
 * Voidable#getVoided()}, {@link Voidable#setVoidReason(String)}, {@link
 * Voidable#setVoidedBy(User)}, and {@link Voidable#setDateVoided(Date)} all to null. <br>
 * <br>
...
public class BaseUnvoidHandler implements UnvoidHandler<Voidable> {
   ...
   * <br>
   *
   * <p><strong>Should</strong> unset the voided bit<br>
  ...
  @Override
  public void handle(
      Voidable voidableObject, User voidingUser, Date origParentVoidedDate, String unused) {
