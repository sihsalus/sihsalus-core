...
/**
 * This is the super interface for all void* actions that take place on all services. The {@link
 * RequiredDataAdvice} class uses AOP around each method in every service to check to see if its a
 * void* method. If it is a void* method, this class is called to handle setting the {@link
 * Voidable#getVoided()}, {@link Voidable#setVoidReason(String)}, {@link
 * Voidable#setVoidedBy(User)}, and {@link Voidable#setDateVoided(Date)}. <br>
 * <br>
...
public class BaseVoidHandler implements VoidHandler<Voidable> {
   ...
   *
   * <p><strong>Should</strong> set the voided bit<br>
  ...
  @Override
  public void handle(
      Voidable voidableObject, User voidingUser, Date voidedDate, String voidReason) {
