 ...
 * Voidable}, this class is called to handle setting the {@link Voidable#setVoidedBy(User)}, and
 ...
 * Voidable} that are themselves a {@link Voidable} and voidedBy/dateVoided are set, but <b>ONLY
 * IF</b> the voided bit was set on them as well. Using the associated void* method in the service
 * on the parent instance is preferred so that all child objects are indeed voided.
 *
...
public class VoidSaveHandler implements SaveHandler<Voidable> {
   ...
   *
   * <p><strong>Should</strong> not set the voided bit<br>
