 ...
 */
@Handler(
    supports = {Patient.class, Encounter.class, Obs.class, Cohort.class, Order.class},
    order = 1 /* low order so this is run first */)
public class RequireVoidReasonVoidHandler implements VoidHandler<Voidable> {
   ...
   *
   * <p><strong>Should</strong> throw IllegalArgumentException if Patient voidReason is null<br>
