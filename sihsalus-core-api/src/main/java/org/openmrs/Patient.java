...
public class Patient extends Person {
   ...
   * attributes are copied over to the new object. NOTE! All child collection objects are copied as
   * pointers, each individual element is not copied. <br>
   * <br>
   *
   ...
   *
   * <p><strong>Should</strong> return allergy status maintained by the supporting infrastructure
   *
   ...
   *
   * <p><strong>Should</strong> not be called by service client
   *
   * @param allergyStatus
   * @since 2.0
   */
   ...
   *
   * <p><strong>Should</strong> not return null
   *
   ...
   *
   * <p><strong>Should</strong> not fail with null identifiers list<br>
   * <strong>Should</strong> add identifier to current list<br>
   ...
   *
   * <p><strong>Should</strong> remove identifier if exists
   *
  ...
  public PatientIdentifier getPatientIdentifier() {
    ...
    // has fetched a Patient, changed their identifiers around, and then calls this method, so we
    // have to be careful.
   ...
   * Otherwise, returns the first non-voided identifier Otherwise, null
   *
   ...
   *
   * <p><strong>Should</strong> return preferred identifiers first in the list
   *
