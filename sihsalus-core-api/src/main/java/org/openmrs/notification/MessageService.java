...
public interface MessageService {
  ...
  // TODO Should these be required or do we let the implementations constructor dictate the
  // dependencies?
   ...
   *
   * <p><strong>Should</strong> send message
   *
   * @param message
  ...
  public void sendMessage(String recipients, String sender, String subject, String message)
      throws MessageException;

  // Prepare message methods
  public Message createMessage(String subject, String message) throws MessageException;

  public Message createMessage(String sender, String subject, String message)
      throws MessageException;

  /**
   * TODO Auto generated method comment
   *
   * <p><strong>Should</strong> create message
   *
   * @param recipients
   * @param sender
   * @param subject
