...
@Audited
public class PatientState extends BaseFormRecordableOpenmrsData
    implements java.io.Serializable, Comparable<PatientState> {
   ...
   *
   * <p><strong>Should</strong> return false if voided and date in range<br>
   ...
   *
   * <p><strong>Should</strong> return positive if startDates equal and this endDate null<br>
