...
public class Diagnosis extends BaseCustomizableData<DiagnosisAttribute> implements FormRecordable {
  ...
  @AssociationOverrides({
    ...
    @AssociationOverride(
        name = "specificName",
        joinColumns = @JoinColumn(name = "diagnosis_coded_name"))
  })
   ...
   *
   * <p><strong>Should</strong> return the namespace for a form field with or without a path
   * otherwise null
   *
   ...
   *
   * <p><strong>Should</strong> return the path for a form field with or without a namespace
   * otherwise null
   *
   ...
   *
   * <p><strong>Should</strong> set the underlying formNamespaceAndPath in the correct pattern
   *
