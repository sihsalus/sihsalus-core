...
public class VerhoeffIdentifierValidator extends BaseHyphenatedIdentifierValidator {
  ...
  public boolean isValid(String identifier) throws UnallowedIdentifierException {
    ...
    if (identifier.length() != VERHOEFF_ID_LENGTH) {
      throw new UnallowedIdentifierException(
          "Identifier must be " + VERHOEFF_ID_LENGTH + " digits long.");
    }
   ...
   *
   * <p><strong>Should</strong> get valid identifier
   *
   * @see
   *     org.openmrs.patient.impl.BaseHyphenatedIdentifierValidator#getValidIdentifier(java.lang.String)
   */
  @Override
