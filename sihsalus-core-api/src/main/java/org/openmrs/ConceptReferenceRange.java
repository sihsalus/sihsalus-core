...
/**
 * A concept reference range defines the acceptable numeric values/ranges of a {@link
 * ConceptNumeric} for specific factors such as age, gender, e.t.c.
 *
 * <p>The criteria is used to evaluate if certain attributes of a patient meet a certain factor
 * range. For example, if criteria is of factor age(say age between 1-5), then the ranges only apply
 * for this age group.
 *
 * @since 2.7.0
 */
