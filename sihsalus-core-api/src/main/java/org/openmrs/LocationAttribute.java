...
public class LocationAttribute extends BaseAttribute<LocationAttributeType, Location>
    implements Attribute<LocationAttributeType, Location> {
  ...
  // BaseAttribute<Location> has an "owner" property of type Location, which we re-expose as
  // "location"
