 ...
 *
 * <ul>
 *   <li><strong>Context.</strong> The evaluation context (org.openmrs.logic.LogicContext) defines
 *       the index date and any global parameters. All criteria should be applied as if the current
 *       date is the index date, allowing for retrospective queries.
 *   <li><strong>Cohort.</strong> The list of patients for which results should be returned
 ...
 *
 * <ul>
 *   <li><strong>pharmacy</strong> &mdash; returns a text result with the name of the pharmacy
 *   <li><strong>visit date</strong> &mdash; returns a date result with the date of the pharmacy
 *       visit
 *   <li><strong>number of prescriptions</strong> &mdash; returns a numeric result with the number
 ...
 *       pharmacy visit date, the text value equal to the name of the pharmacy, and the numeric
 *       result overloaded with the number of prescriptions filled at the pharmacy visit.
 * </ul>
 *
...
public interface LogicDataSource {
  ...
  /**
   * The name by which this data source should be registered when it is loaded. Implementations
   * should override this like public static final String NAME = "person";
   */
