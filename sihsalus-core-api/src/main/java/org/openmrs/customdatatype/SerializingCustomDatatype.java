...
public abstract class SerializingCustomDatatype<T> implements CustomDatatype<T> {
   ...
   * value, as defined by {@link CustomDatatype#getTextSummary(String)}. If {@link
   * #deserialize(String)} is expensive, then the implementation should override {@link
   * #getTextSummary(String)} instead. The default implementation returns typedValue.toString(), and
   ...
   */
  @Override
  public String save(T typedValue, String existingValueReference)
