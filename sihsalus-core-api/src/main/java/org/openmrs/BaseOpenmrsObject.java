...
public abstract class BaseOpenmrsObject implements Serializable, OpenmrsObject {
   ...
   *
   * <p>If the <code>uuid</code> field is <code>null</code>, it delegates to {@link
   * Object#hashCode()}.
   *
   * <p><strong>Should</strong> not fail if uuid is null
   *
   ...
   * object (<code>x == y</code> has the value <code>true</code>) or both have the same <code>uuid
   * </code> (<code>((x.uuid != null) &amp;&amp; x.uuid.equals(y.uuid))</code> has the value <code>
   * true</code>).
   *
   * <p><strong>Should</strong> return false if given obj is not instance of BaseOpenmrsObject<br>
   ...
   * </blockquote>
   *
   * <p>If the <code>uuid</code> field is <code>null</code>, it returns:
   *
   * <blockquote>
   *
   * ClassName{hashCode=...}
   ...
   * </blockquote>
   *
   * <p><strong>Should</strong> include hashCode if uuid is null<br>
