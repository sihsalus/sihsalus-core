...
public class PersonMergeLogData {
  ...
  /**
   * List of UUIDs of patient programs copied from non-preferred to preferred (Deprecated in 2.6.8
   * and 2.7.0+, as we now move programs)
   */
  @Deprecated private List<String> createdPrograms;
  ...
  /**
   * List of UUIDs of users moved to be associated from non-preferred to be associated to preferred
   */
  ...
  /**
   * Whether the date of birth of preferred person was an estimated value before the merge occurred
   */
  ...
  /**
   * Whether the date of death of preferred person was an estimated value before the merge occurred
   */
  ...
  public int computeHashValue() {
    ...
    str += getPriorGender();
    str +=
        (getPriorDateOfBirth() != null) ? getPriorDateOfBirth().toString() : getPriorDateOfBirth();
    str +=
        (getPriorDateOfBirth() != null) ? getPriorDateOfDeath().toString() : getPriorDateOfDeath();
