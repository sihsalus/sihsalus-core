 ...
 */
@Handler(
    supports = {LocationAttributeType.class},
    order = 50)
public class LocationAttributeTypeValidator
    extends BaseAttributeTypeValidator<LocationAttributeType> {
   ...
   * <strong>Should</strong> pass validation if the location attribute type description is null or
   * empty or whitespace<br>
  ...
  public void validate(Object obj, Errors errors) {
    ...
    if (locationObj.getName() != null && !locationObj.getName().isEmpty()) {
      ...
      ValidationUtils.rejectIfEmptyOrWhitespace(
          errors, "name", "LocationAttributeType.error.nameEmpty");
    }
