...
public class ProviderValidator extends BaseCustomizableValidator implements Validator {
   ...
   * Provider name should be set and not both) Checks to see if there is a retired Reason in case a
   * provider is retired
   *
   * <p><strong>Should</strong> be valid if identifier is not set<br>
  ...
  public void validate(Object obj, Errors errors) throws APIException {
    ...
    if (obj == null || !(obj instanceof Provider)) {
      throw new IllegalArgumentException(
          "The parameter obj should not be null and must be of type " + Provider.class);
    }
    ...
    super.validateAttributes(
        provider, errors, Context.getProviderService().getAllProviderAttributeTypes());
  }
}
