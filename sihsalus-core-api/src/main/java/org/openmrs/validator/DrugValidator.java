...
public class DrugValidator implements Validator {
   ...
   *
   * <p><strong>Should</strong> fail if the drug object is null<br>
  ...
  public void validate(Object obj, Errors errors) {
    if (obj == null || !(obj instanceof Drug)) {
      ...
      for (DrugReferenceMap referenceMap : drugReferenceMaps) {
        ...
        if (mappedDrug == null) {
          errors.rejectValue(
              "drugReferenceMaps[" + index + "].drug", "Drug.drugReferenceMap.mappedDrug");
        }
        if (referenceTerm == null) {
          errors.rejectValue(
              "drugReferenceMaps[" + index + "].conceptReferenceTerm",
          ...
          try {
            ...
            ValidationUtils.invokeValidator(
                new ConceptReferenceTermValidator(), referenceTerm, errors);
          } finally {
        ...
        if (mapType == null) {
          errors.rejectValue(
              "drugReferenceMaps[" + index + "].conceptMapType",
