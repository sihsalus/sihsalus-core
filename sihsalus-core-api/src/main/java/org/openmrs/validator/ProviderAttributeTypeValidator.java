 ...
 */
@Handler(
    supports = {ProviderAttributeType.class},
    order = 50)
public class ProviderAttributeTypeValidator
    extends BaseAttributeTypeValidator<ProviderAttributeType> {
  ...
  public void validate(Object obj, Errors errors) {
    if (obj != null) {
      ...
      ValidationUtils.rejectIfEmpty(
          errors, "datatypeClassname", "ProviderAttributeType.error.datatypeEmpty");
