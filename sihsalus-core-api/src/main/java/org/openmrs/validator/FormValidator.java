...
public class FormValidator implements Validator {
   ...
   *
   * <p><strong>Should</strong> fail validation if name is null<br>
   * <strong>Should</strong> fail validation if version is null<br>
   * <strong>Should</strong> fail validation if version does not match regex<br>
   * <strong>Should</strong> fail validation if retiredReason is null<br>
   * <strong>Should</strong> fail validation if retiredReason is empty<br>
    ...
    if (form == null) {
      ...
      if (form.getRetired()) {
        ValidationUtils.rejectIfEmptyOrWhitespace(
            errors, "retireReason", "general.retiredReason.empty");
      }
      ValidateUtil.validateFieldLengths(
          errors, obj.getClass(), "name", "version", "description", "retireReason");
    }
  }
}
