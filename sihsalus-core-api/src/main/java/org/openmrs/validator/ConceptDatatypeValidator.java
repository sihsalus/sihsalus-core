 ...
 */
@Handler(
    supports = {ConceptDatatype.class},
    order = 50)
public class ConceptDatatypeValidator implements Validator {
   ...
   *
   * <p><strong>Should</strong> pass validation if description is null or empty or whitespace *<br>
  ...
  public void validate(Object obj, Errors errors) {
    ...
    if (cd == null) {
      ...
      ValidateUtil.validateFieldLengths(
          errors, obj.getClass(), "name", "hl7Abbreviation", "description", "retireReason");
    }
  }
}
