 ...
 */
@Handler(
    supports = {RelationshipType.class},
    order = 50)
  ...
  public void validate(Object obj, Errors errors) {
    ...
    if (relationshipType == null) {
      ...
      ValidationUtils.rejectIfEmptyOrWhitespace(
          errors, "aIsToB", "RelationshipType.aIsToB.required");
      ValidationUtils.rejectIfEmptyOrWhitespace(
          errors, "bIsToA", "RelationshipType.bIsToA.required");
      ValidationUtils.rejectIfEmptyOrWhitespace(
          errors, "description", "RelationshipType.description.required");
      RelationshipType exist =
      ...
      ValidateUtil.validateFieldLengths(
          errors, obj.getClass(), "aIsToB", "bIsToA", "description", "retireReason");
    }
  }
}
