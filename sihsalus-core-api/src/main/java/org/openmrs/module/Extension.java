 ...
 * user interface
 *
 * <p>An extension is not necessarily tied to only one certain point. If all of the need return
 * values are defined it can be used to extend any point. A module can contain many extensions for
...
public abstract class Extension {
   ...
   * media type, it is assumed to mainly work just within html rendering environments. If an
   ...
   * by overriding this property. Lower order numbers will generally appear first within the
   * extension point.
   *
   * @return 0
   */
