...
/**
 * Allows to specify a conditionally loaded resource in a module based on OpenMRS version and/or
 * modules listed as required or aware of.
 *
...
public class ModuleConditionalResource {
  ...
  public String toString() {
    return "ModuleConditionalResource{"
        + "path='"
        + path
        + '\''
