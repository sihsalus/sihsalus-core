...
public class ModuleConstants {
  ...
  /**
   * Name of the global property that will tell the system where to look for modules to load. Can be
  ...
  /**
   * Intended to be used by the testing framework in order to set a list of specific files that need
   * to be loaded by the Context. Should be space separated. Should be either absolute file paths or
   * classpath loadable file paths.
   */
  ...
  /**
   * A module message.properties file containing this key mapped to "true" will be allowed to define
   * messages outside of the module's namespace.
   *
   * @since 1.9.3
   */
  public static final String MESSAGE_PROPERTY_ALLOW_KEYS_OUTSIDE_OF_MODULE_NAMESPACE =
      "openmrs.property.MESSAGE_PROPERTY_ALLOW_KEYS_OUTSIDE_OF_MODULE_NAMESPACE";
}
