 ...
 *
 * <p>For example, to require that the user have <i>either</i> View or Add privileges:
 *
 * <pre>
...
public @interface Authorized {
  ...
  /**
   * If set to true, will require that the user have <i>all</i> privileges listed in <code>value
   * </code>. if false, user only has to have one of the privileges. Defaults to false
   *
