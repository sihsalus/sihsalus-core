 ...
 * As currently designed, a Validator takes in an open-ended Object to validate: <code>
 * public void validate(Object obj, Errors errors)</code> <br>
 * <br>
 * To provide more context around what type of objects may successfully be passed in here for
 * validation, a Validator also requires implementation of: <code>public boolean supports(Class c)
 * </code> <br>
 * <br>
...
public @interface Handler {
   ...
   * the same type. For example, if two handlers are registered as capable of handling a {@link
   * org.openmrs.customdatatype.datatype.DateDatatype} class, and one handler had an order of 100
   * and the other had an order of 50, the consuming code could utilize this information to
