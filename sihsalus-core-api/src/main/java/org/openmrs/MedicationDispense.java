...
public class MedicationDispense extends BaseFormRecordableOpenmrsData {
   ...
   *     https://www.hl7.org/fhir/valueset-medicationdispense-status-reason.html </a> i.e "Stock
   *     Out"
   */
  @ManyToOne(optional = true)
  ...
  /**
   * FHIR:dosageInstructions.doseAndRate.dose.quantity.unit and/or code Relates to
   * drugOrder.doseUnits
   */
  @ManyToOne(optional = true)
  ...
  /**
   * FHIR:substitution.wasSubstituted True/false whether a substitution was made during this
   * dispense event
   */
