...
public abstract class BaseCustomizableMetadata<A extends Attribute>
    extends BaseChangeableOpenmrsMetadata implements Customizable<A> {
   ...
   *
   * <p><strong>Should</strong> void the attribute if an attribute with same attribute type already
   * exists and the maxOccurs is set to 1<br>
   * <strong>Should</strong> work for attributes with datatypes whose values are stored in other
   * tables
   *
   * @param attribute
   */
