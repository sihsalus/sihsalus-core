...
public class OrderSet extends BaseCustomizableMetadata<OrderSetAttribute> {
   ...
   * selected for saving ONE: Only one of the member of the orderSet needs to be selected for saving
   ...
   * Adds an orderSetMember to the existing list of orderSetMembers
   *
   * @param orderSetMember the new orderSetMember to be added at the end of the current list of
   *     order set members
   */
