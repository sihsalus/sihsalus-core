...
public class PatientIdentifier extends BaseChangeableOpenmrsData
    implements java.io.Serializable, Cloneable, Comparable<PatientIdentifier> {
  ...
  /**
   * bitwise copy of the PatientIdentifier object. NOTICE: THIS WILL NOT COPY THE PATIENT OBJECT.
   * The PatientIdentifier.patient object in this object AND the cloned object will point at the
   * same patient
   *
  ...
  public static class DefaultComparator implements Comparator<PatientIdentifier>, Serializable {
    ...
    public int compare(PatientIdentifier pi1, PatientIdentifier pi2) {
      ...
      if (pi2 != null) {
        ...
        if (retValue == 0) {
          retValue =
              OpenmrsUtil.compareWithNullAsLatest(pi1.getDateCreated(), pi2.getDateCreated());
        }
        ...
        if (retValue == 0) {
          retValue =
              OpenmrsUtil.compareWithNullAsGreatest(pi1.getIdentifier(), pi2.getIdentifier());
        }
