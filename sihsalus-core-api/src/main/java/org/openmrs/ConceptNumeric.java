...
public class ConceptNumeric extends Concept {
   ...
   *
   * <p><strong>Should</strong> make deep copy of collections<br>
   * <strong>Should</strong> change reference to the parent object for objects in answers collection
   * <br>
   * <strong>Should</strong> change reference to the parent object for objects in conceptSets
   * collection<br>
   * <strong>Should</strong> change reference to the parent object for objects in names collection
   * <br>
   * <strong>Should</strong> change reference to the parent object for objects in descriptions
   * collection<br>
   * <strong>Should</strong> change reference to the parent object for objects in conceptMappings
   * collection
   *
   * @param c
   */
