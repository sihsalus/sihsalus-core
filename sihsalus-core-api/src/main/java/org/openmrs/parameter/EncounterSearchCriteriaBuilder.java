...
public class EncounterSearchCriteriaBuilder {
  ...
  /**
   * @param encounterTypes the type of the encounter must be in this collection. This search
   *     parameter is omitted if the set is null or empty.
   * @return this builder instance
   */
  public EncounterSearchCriteriaBuilder setEncounterTypes(
  ...
  /**
   * @param providers the provider of the encounter must be in this collection. This search
   *     parameter is omitted if the set is null or empty.
   * @return this builder instance
   */
  ...
  public EncounterSearchCriteria createEncounterSearchCriteria() {
    return new EncounterSearchCriteria(
        patient,
        location,
        fromDate,
        toDate,
