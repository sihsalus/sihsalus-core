...
public interface ComplexObsHandler {
   ...
   * This view is typically a contract between the view and the handler that has been registered, so
   * they those two know the types of views that can be handled.
   *
   ...
   * <br>
   * TODO: If we cannot delete the complex data object because of an error, do we want to return the
   * Obs, a boolean false, or an Exception?
   *
   * @param obs
   */
