...
public class Visit extends BaseCustomizableData<VisitAttribute>
    implements Auditable, Customizable<VisitAttribute> {
  ...
  /**
   * Convenience constructor that takes in the required fields i.e {@link Patient}, {@link
   * VisitType} and dateStarted
   *
   * @see VisitType
