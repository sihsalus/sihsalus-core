...
public class LocationUtility implements GlobalPropertyListener {
  ...
  /**
   * Cached version of the system default location. This is cached so that we don't have to look it
   * up in the global property table every time it is requested for
   */
   ...
   *
   * <p><strong>Should</strong> return the updated defaultLocation when the value of the global
   * property is changed
   *
   ...
   *
   * <p><strong>Should</strong> return the user specified location if any is set
   */
