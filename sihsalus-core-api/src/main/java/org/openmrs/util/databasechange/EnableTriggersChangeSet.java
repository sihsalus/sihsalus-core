...
/**
 * Enables all triggers for the current schema Postgres does not have a call to enable all foreign
 * key constraints. This changeset alters table and enable triggers for all tables.
 */
