...
public class LocaleUtility implements GlobalPropertyListener {
   ...
   *
   * <p><strong>Should</strong> not return null if global property does not exist<br>
   ...
   * languages match.
   *
   * <p><strong>Should</strong> confirm different language missing country as compatible<br>
   ...
   *
   * <p><strong>Should</strong> get locale from two character language code<br>
  ...
  private static Locale generateLocaleFromLegacyFormat(String localeSpecification) {
    ...
    if (localeComponents.length == 1) {
      ...
      String variant =
          localeSpecification.substring(localeSpecification.indexOf(localeComponents[2]));
   ...
   *
   * <p><strong>Should</strong> return a set of locales with a predictable order<br>
