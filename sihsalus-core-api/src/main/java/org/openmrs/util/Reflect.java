...
public class Reflect {
  ...
  /**
   * <strong>Should</strong> return true if given fieldClass is Collection class<br>
  ...
  /**
   * <strong>Should</strong> return true if given object is Collection class<br>
   ...
   * classes.
   *
   * <p><strong>Should</strong> return all fields include private and super classes
   *
  ...
  public static boolean isAnnotationPresent(
      Class<?> fieldClass, String fieldName, Class<? extends Annotation> annotation) {
    try {
  ...
  /**
   * <strong>Should</strong> return true if given subClass is accessible from given parameterized
   * class<br>
   * <strong>Should</strong> return false if given subClass is not accessible from given
   * parameterized class
   *
  ...
  /**
   * <strong>Should</strong> return true for a generic whose bound is a subclass<br>
  ...
  /**
   * <strong>Should</strong> return true if given object is accessible from given parameterized
   * class<br>
   * <strong>Should</strong> return false if given object is not accessible from given parameterized
   * class
   *
   * @param object Object
  ...
  /**
   * This method validate the given field is Collection and the elements should be of parameterized
   * type
   *
   * <p><strong>Should</strong> return true if given field is Collection and its element type is
   * given parameterized<br>
   * <strong>Should</strong> return false if given field is not a Collection<br>
   * <strong>Should</strong> return false if given field is Collection and element type is other
   * than given
   *
   * @param field Field
   ...
   *
   * <p><strong>Should</strong> return only the sub class fields of given parameterized class
   *
   * @param subClass Class
   * @return List&lt;Field&gt;
   */
