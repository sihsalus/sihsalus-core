...
public class DatabaseUtil {
  ...
  private static final Set<String> ALLOWED_JDBC_DRIVERS =
      Set.of(
          MYSQL_DRIVER,
          MYSQL_LEGACY_DRIVER,
          MARIADB_DRIVER,
  ...
  public static final String ORDER_ENTRY_UPGRADE_SETTINGS_FILENAME =
      "order_entry_upgrade_settings.txt";
   ...
   */
  public static String loadDatabaseDriver(String connectionUrl, String connectionDriver)
      throws ClassNotFoundException {
  ...
  private static boolean checkQueryForManipulationCommands(String sql, boolean selectOnly) {
    ...
    if (selectOnly
        && (dataManipulation
            || !READ_ONLY_SQL_PATTERN.matcher(sql).matches()
            || sql.contains(";"))) {
   ...
   * @throws Exception
   */
  public static <T> Set<T> getUniqueNonNullColumnValues(
      String columnName, String tableName, Class<T> type, Connection connection) throws Exception {
