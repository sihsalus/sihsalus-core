...
public class FormUtil {
   ...
   * root sections of the schema are stored under a key of zero (i.e., <code>
   * java.lang.Integer.<em>valueOf(0)</em></code>). All other entries represent sequences of
   * children stored under the identifier (<code>formField.<em>getFormFieldId()</em></code>) of
   * their parent FormField. The form structure is sorted by the natural sorting order of the <code>
   * FormField</code>s (as defined by the <em>.equals()</em> and <em>.compareTo()</em> methods).
   *
