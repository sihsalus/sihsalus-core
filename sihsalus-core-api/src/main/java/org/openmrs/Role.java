...
public class Role extends BaseChangeableOpenmrsMetadata {
   ...
   *
   * <p><strong>Should</strong> return false if not found<br>
   * <strong>Should</strong> return true if found<br>
   ...
   *
   * <p><strong>Should</strong> only return parent roles
   *
   ...
   *
   * <p><strong>Should</strong> only return child roles
   *
