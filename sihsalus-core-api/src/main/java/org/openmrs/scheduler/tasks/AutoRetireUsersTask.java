...
/**
 * A scheduled task that automatically retires users after the set number of days of inactivity. The
 * inactivity duration is set as a global property. <a href=
 * "https://openmrs.atlassian.net/wiki/spaces/docs/pages/101318663/Creating+Auto-Deactivating+User+Task">Documentation</a>
