...
@Component
public class FhirImmunizationServiceImpl extends BaseFhirService<Immunization, Obs>
    implements FhirImmunizationService {
  ...
  private SearchQuery<
          ...
          SearchQueryInclude<Immunization>>
      searchQuery;
  ...
  protected Immunization applyUpdate(Obs existingObject, Immunization updatedResource) {
    ...
    if (translator instanceof OpenmrsFhirUpdatableTranslator) {
      UpdatableOpenmrsTranslator<org.openmrs.Obs, Immunization> updatableOpenmrsTranslator =
          (OpenmrsFhirUpdatableTranslator<org.openmrs.Obs, Immunization>) translator;
