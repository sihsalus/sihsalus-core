...
@Component
public class FhirEncounterServiceImpl extends BaseFhirService<Encounter, org.openmrs.Encounter>
    implements FhirEncounterService {
  ...
  private SearchQuery<
          ...
          Encounter,
          FhirEncounterDao,
          EncounterTranslator<org.openmrs.Encounter>,
          SearchQueryInclude<Encounter>>
      searchQuery;
  ...
  public Encounter create(@Nonnull Encounter encounter) {
    ...
    FhirUtils.OpenmrsEncounterType result =
        FhirUtils.getOpenmrsEncounterType(encounter).orElse(null);
            ...
            tokenOrListParam ->
                tokenOrListParam.doesCodingListMatch(
                    Collections.singletonList(
                        new InternalCodingDt(
                            FhirConstants.OPENMRS_FHIR_EXT_ENCOUNTER_TAG, valueToCheck))));
  }
  ...
  public IBundleProvider getEncounterEverything(TokenParam encounterId) {
    ...
    IBundleProvider encounterBundle =
        searchQuery.getQueryResults(theParams, dao, translator, searchQueryInclude);
