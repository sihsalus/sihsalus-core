...
public class TelecomTranslatorImpl implements TelecomTranslator<BaseOpenmrsData> {
  ...
  @Override
  public BaseOpenmrsData toOpenmrsType(
      @Nonnull BaseOpenmrsData attribute, @Nonnull ContactPoint contactPoint) {
    ...
    if (attribute instanceof PersonAttribute) {
      ...
      personAttribute.setAttributeType(
          personService.getPersonAttributeTypeByUuid(
              globalPropertyService.getGlobalProperty(
                  FhirConstants.PERSON_CONTACT_POINT_ATTRIBUTE_TYPE)));
      ...
      locationAttribute.setAttributeType(
      ...
      providerAttribute.setAttributeType(
          providerService.getProviderAttributeTypeByUuid(
              globalPropertyService.getGlobalProperty(
  ...
  public ContactPoint toFhirResource(@Nonnull BaseOpenmrsData attribute) {
    ...
    if (attribute instanceof PersonAttribute) {
      ...
      fhirContactPointMapService
          .getFhirContactPointMapForPersonAttributeType(
  ...
  private static void mapContactPoint(
      ContactPoint contactPoint, FhirContactPointMap contactPointMap) {
