...
@Component
public class ObservationInterpretationTranslatorImpl
    implements ObservationInterpretationTranslator {
    ...
    switch (obs.getInterpretation()) {
      ...
      case VERY_SUSCEPTIBLE:
        interpretation.addCoding(
            new Coding()
                .setSystem(FhirConstants.OPENMRS_FHIR_EXT_VS_INTERPRETATION)
                .setCode("VS")
                .setDisplay("Very Susceptible"));
        setText(interpretation, obs.getInterpretation());
        break;
      default:
