...
@ResourceDef(
    name = "GroupMember",
    profile = "http://fhir.openmrs.org/R4/StructureDefinition/GroupMember")
public class GroupMember extends DomainResource {
  ...
  @Child(
      ...
      min = 1)
  @Description(
      shortDefinition = "Reference to the group member",
      formalDefinition =
  ...
  @Child(
      ...
      order = 2)
  @Description(
      shortDefinition = "Period member belonged to the group",
  ...
  @Child(
      ...
      order = 3)
  @Description(
      shortDefinition = "If member is no longer in group",
      formalDefinition =
