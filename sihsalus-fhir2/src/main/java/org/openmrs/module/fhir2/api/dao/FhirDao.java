...
public interface FhirDao<T extends OpenmrsObject & Auditable> extends FhirDaoAop, Serializable {
   ...
   * @return The object of type {@link T} corresponding to this UUID or {@code null} if no such
   *     object can be found
   */
  ...
  /**
   * Gets the count of objects that will match a search run with the supplied {@link
   * SearchParameterMap}
   *
   * @param theParams A {@link SearchParameterMap} defining any filters to apply
