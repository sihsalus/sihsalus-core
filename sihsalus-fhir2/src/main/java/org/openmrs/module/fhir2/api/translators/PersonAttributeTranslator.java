...
public interface PersonAttributeTranslator
    extends OpenmrsFhirUpdatableTranslator<org.openmrs.PersonAttribute, Extension> {
   ...
   */
  @Override
  PersonAttribute toOpenmrsType(
      @Nonnull PersonAttribute personAttribute, @Nonnull Extension extension);
}
