...
public class ObservationFhirResourceProvider implements IResourceProvider {
  ...
  @Patch
  public MethodOutcome patchObservation(
      @IdParam IdType id,
    ...
    Observation observation =
        observationService.patch(id.getIdPart(), patchType, body, requestDetails);
  ...
  public IBundleProvider searchObservations(
      ...
      @OptionalParam(
              name = Observation.SP_HAS_MEMBER,
      ...
      @IncludeParam(
              allow = {
                ...
                "Observation:" + Observation.SP_HAS_MEMBER
              })
