...
public class TaskVersionConverter {
  ...
  public static org.hl7.fhir.dstu3.model.Task convertTask(org.hl7.fhir.r4.model.Task src)
  ...
  public static org.hl7.fhir.r4.model.Task convertTask(org.hl7.fhir.dstu3.model.Task src)
      throws FHIRException {
    ...
    try {
      ...
      if (src.hasDefinition()) {
        tgt.setInstantiatesCanonical(
            String.valueOf(convertReference(src.getDefinitionReference())));
      }
      if (src.hasBasedOn()) {
  ...
  public static org.hl7.fhir.r4.model.Enumeration<org.hl7.fhir.r4.model.Task.TaskStatus>
      convertTaskStatus(
          org.hl7.fhir.dstu3.model.Enumeration<org.hl7.fhir.dstu3.model.Task.TaskStatus> src)
          throws FHIRException {
    if (src == null || src.isEmpty()) return null;
    org.hl7.fhir.r4.model.Enumeration<org.hl7.fhir.r4.model.Task.TaskStatus> tgt =
  ...
  public static org.hl7.fhir.dstu3.model.Enumeration<Task.TaskStatus> convertTaskStatus(
      org.hl7.fhir.r4.model.Enumeration<org.hl7.fhir.r4.model.Task.TaskStatus> src)
      throws FHIRException {
    if (src == null || src.isEmpty()) return null;
    org.hl7.fhir.dstu3.model.Enumeration<Task.TaskStatus> tgt =
        new org.hl7.fhir.dstu3.model.Enumeration<>(new Task.TaskStatusEnumFactory());
    switch (src.getValue()) {
      case DRAFT:
  ...
  public static org.hl7.fhir.r4.model.Enumeration<org.hl7.fhir.r4.model.Task.TaskIntent>
      convertTaskIntent(
          org.hl7.fhir.dstu3.model.Enumeration<org.hl7.fhir.dstu3.model.Task.TaskIntent> src)
          throws FHIRException {
    if (src == null || src.isEmpty()) return null;
    org.hl7.fhir.r4.model.Enumeration<org.hl7.fhir.r4.model.Task.TaskIntent> tgt =
        new org.hl7.fhir.r4.model.Enumeration<>(
  ...
  public static org.hl7.fhir.dstu3.model.Enumeration<Task.TaskIntent> convertTaskIntent(
      org.hl7.fhir.r4.model.Enumeration<org.hl7.fhir.r4.model.Task.TaskIntent> src)
      throws FHIRException {
    if (src == null || src.isEmpty()) return null;
    org.hl7.fhir.dstu3.model.Enumeration<org.hl7.fhir.dstu3.model.Task.TaskIntent> tgt =
        new org.hl7.fhir.dstu3.model.Enumeration<>(new Task.TaskIntentEnumFactory());
    switch (src.getValue()) {
      case PROPOSAL:
  ...
  public static org.hl7.fhir.r4.model.Enumeration<org.hl7.fhir.r4.model.Task.TaskPriority>
      convertProcedureRequestPriority(
          org.hl7.fhir.dstu3.model.Enumeration<org.hl7.fhir.dstu3.model.Task.TaskPriority> src)
          throws FHIRException {
    if (src == null || src.isEmpty()) return null;
    org.hl7.fhir.r4.model.Enumeration<org.hl7.fhir.r4.model.Task.TaskPriority> tgt =
        new org.hl7.fhir.r4.model.Enumeration<>(
  ...
  public static org.hl7.fhir.dstu3.model.Enumeration<Task.TaskPriority>
      convertProcedureRequestPriority(
          org.hl7.fhir.r4.model.Enumeration<org.hl7.fhir.r4.model.Task.TaskPriority> src)
          throws FHIRException {
    if (src == null || src.isEmpty()) return null;
    org.hl7.fhir.dstu3.model.Enumeration<org.hl7.fhir.dstu3.model.Task.TaskPriority> tgt =
        new org.hl7.fhir.dstu3.model.Enumeration<>(new Task.TaskPriorityEnumFactory());
    switch (src.getValue()) {
      case ROUTINE:
  ...
  public static void convertTaskInput(
      org.hl7.fhir.r4.model.Task src, org.hl7.fhir.dstu3.model.Task tgt) {
    src.getInput()
        .forEach(
            ti ->
                tgt.addInput()
                    .setType(convertCodeableConcept(ti.getType()))
                    .setValue(convertType(ti.getValue())));
  }

  public static void convertTaskInput(
      org.hl7.fhir.dstu3.model.Task src, org.hl7.fhir.r4.model.Task tgt) {
    src.getInput()
        .forEach(
            ti ->
                tgt.addInput()
  ...
  public static void convertTaskOutput(
      org.hl7.fhir.r4.model.Task src, org.hl7.fhir.dstu3.model.Task tgt) {
    src.getOutput()
        .forEach(
            to ->
                tgt.addOutput()
                    .setType(convertCodeableConcept(to.getType()))
                    .setValue(convertType(to.getValue())));
  }
