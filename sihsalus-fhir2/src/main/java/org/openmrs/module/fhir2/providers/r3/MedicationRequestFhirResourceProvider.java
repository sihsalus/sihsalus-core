...
public class MedicationRequestFhirResourceProvider implements IResourceProvider {
  ...
  public MedicationRequest getMedicationRequestById(@IdParam @Nonnull IdType id) {
    ...
    if (medicationRequest == null) {
      throw new ResourceNotFoundException(
          "Could not find medicationRequest with Id " + id.getIdPart());
    }
  ...
  @Patch
  public MethodOutcome patchMedicationRequest(
      @IdParam @Nonnull IdType id,
    ...
    org.hl7.fhir.r4.model.MedicationRequest medicationRequest =
        medicationRequestService.patch(id.getIdPart(), patchType, body, requestDetails);
  ...
  public IBundleProvider searchForMedicationRequests(
      ...
      @OptionalParam(
              name = MedicationRequest.SP_SUBJECT,
              chainWhitelist = {
                "",
                Patient.SP_IDENTIFIER,
                Patient.SP_GIVEN,
      ...
      @OptionalParam(
              name = MedicationRequest.SP_CONTEXT,
              chainWhitelist = {""},
      ...
      @OptionalParam(
              name = MedicationRequest.SP_REQUESTER,
              chainWhitelist = {
                "",
      ...
      @OptionalParam(
              name = MedicationRequest.SP_MEDICATION,
              chainWhitelist = {""},
              targetTypes = Medication.class)
      ...
      @IncludeParam(
              allow = {
                "MedicationRequest:" + MedicationRequest.SP_MEDICATION,
      ...
      @IncludeParam(
              reverse = true,
              allow = {"MedicationDispense:" + MedicationDispense.SP_PRESCRIPTION})
