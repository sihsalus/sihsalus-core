...
public final class FhirConstants {
  ...
  public static final String FHIR_TERMINOLOGY_DATA_OPERATION =
      HL7_FHIR_CODE_SYSTEM_PREFIX + "v3-DataOperation";

  public static final String FHIR_TERMINOLOGY_PROVENANCE_PARTICIPANT_TYPE =
      HL7_FHIR_CODE_SYSTEM_PREFIX + "provenance-participant-type";

  public static final String FHIR_TERMINOLOGY_PARTICIPATION_TYPE =
      HL7_FHIR_CODE_SYSTEM_PREFIX + "v3-ParticipationType";

  public static final String DIAGNOSTIC_REPORT_SERVICE_SYSTEM_URI =
      HL7_FHIR_CODE_SYSTEM_PREFIX + "/v2-0074";

  public static final String INTERPRETATION_SYSTEM_URI =
      HL7_FHIR_CODE_SYSTEM_PREFIX + "/v3-ObservationInterpretation";

  public static final String ALLERGY_INTOLERANCE_CLINICAL_STATUS_SYSTEM_URI =
      HL7_FHIR_CODE_SYSTEM_PREFIX + "/allergyintolerance-clinical";

  public static final String ALLERGY_INTOLERANCE_VERIFICATION_STATUS_SYSTEM_URI =
      HL7_FHIR_CODE_SYSTEM_PREFIX + "/allergyintolerance-verification";

  public static final String CONDITION_CLINICAL_STATUS_SYSTEM_URI =
      HL7_FHIR_CODE_SYSTEM_PREFIX + "/condition-clinical";

  public static final String CONDITION_CLINICAL_STATUS_SYSTEM_URI_R3 =
      HL7_FHIR_CODE_SYSTEM_PREFIX_R3 + "/condition-clinical";

  public static final String CONDITION_VERIFICATION_STATUS_SYSTEM_URI =
      HL7_FHIR_CODE_SYSTEM_PREFIX + "/condition-ver-status";

  public static final String CONDITION_VERIFICATION_STATUS_SYSTEM_URI_R3 =
      HL7_FHIR_CODE_SYSTEM_PREFIX_R3 + "/condition-ver-status";

  public static final String CLINICAL_FINDINGS_SYSTEM_URI =
      HL7_FHIR_CODE_SYSTEM_PREFIX + "/clinical-findings";

  public static final String TASK_STATUS_VALUE_SET_URI = "http://hl7.org/fhir/task-status";

  public static final String OBSERVATION_REFERENCE_RANGE_SYSTEM_URI =
      HL7_FHIR_CODE_SYSTEM_PREFIX + "/referencerange-meaning";
  ...
  public static final String OBSERVATION_CATEGORY_VALUE_SET_URI =
      HL7_FHIR_CODE_SYSTEM_PREFIX + "/observation-category";

  public static final String ENCOUNTER_CLASS_VALUE_SET_URI =
      HL7_FHIR_CODE_SYSTEM_PREFIX + "/v3-ActCode";
  ...
  public static final String ENCOUNTER_TYPE_SYSTEM_URI =
      OPENMRS_CODE_SYSTEM_PREFIX + "/encounter-type";

  public static final String VISIT_TYPE_SYSTEM_URI = OPENMRS_CODE_SYSTEM_PREFIX + "/visit-type";

  public static final String OPENMRS_FHIR_EXT_IMMUNIZATION_NEXT_DOSE_DATE =
      "http://hl7.eu/fhir/StructureDefinition/immunization-nextDoseDate";

  public static final String OPENMRS_FHIR_EXT_PREFIX = OPENMRS_FHIR_PREFIX + "/ext";

  public static final String OPENMRS_FHIR_EXT_OBS_LOCATION_VALUE =
      OPENMRS_FHIR_EXT_PREFIX + "/obs-location-value";

  public static final String OPENMRS_FHIR_EXT_NAME = OPENMRS_FHIR_EXT_PREFIX + "/name";

  public static final String OPENMRS_FHIR_EXT_GROUP_DESCRIPTION =
      OPENMRS_FHIR_EXT_PREFIX + "/group/description";

  public static final String OPENMRS_FHIR_EXT_ADDRESS = OPENMRS_FHIR_EXT_PREFIX + "/address";

  public static final String OPENMRS_FHIR_EXT_NON_CODED_CONDITION =
      OPENMRS_FHIR_EXT_PREFIX + "/non-coded-condition";

  public static final String OPENMRS_FHIR_EXT_MEDICINE = OPENMRS_FHIR_EXT_PREFIX + "/medicine";

  public static final String OPENMRS_FHIR_EXT_TASK_IDENTIFIER =
      OPENMRS_FHIR_EXT_PREFIX + "/task/identifier";

  public static final String OPENMRS_FHIR_EXT_USER_IDENTIFIER =
      OPENMRS_FHIR_EXT_PREFIX + "/user/identifier";

  public static final String OPENMRS_FHIR_EXT_PERSON_ATTRIBUTE =
      OPENMRS_FHIR_EXT_PREFIX + "/person-attribute";

  public static final String OPENMRS_FHIR_EXT_PERSON_ATTRIBUTE_TYPE =
      OPENMRS_FHIR_EXT_PREFIX + "/person-attribute-type";

  public static final String OPENMRS_FHIR_EXT_PERSON_ATTRIBUTE_VALUE =
      OPENMRS_FHIR_EXT_PREFIX + "/person-attribute-value";

  public static final String OPENMRS_FHIR_EXT_PROVIDER_IDENTIFIER =
      OPENMRS_FHIR_EXT_PREFIX + "/provider/identifier";

  public static final String OPENMRS_FHIR_EXT_LOCATION_TAG =
      OPENMRS_FHIR_EXT_PREFIX + "/location-tag";

  public static final String OPENMRS_FHIR_EXT_VS_INTERPRETATION =
      OPENMRS_FHIR_EXT_PREFIX + "/obs/interpretations";

  public static final String OPENMRS_FHIR_EXT_PATIENT_IDENTIFIER_LOCATION =
      OPENMRS_FHIR_EXT_PREFIX + "/patient/identifier#location";

  public static final String OPENMRS_FHIR_EXT_ENCOUNTER_TAG =
      OPENMRS_FHIR_EXT_PREFIX + "/encounter-tag";

  public static final String OPENMRS_FHIR_EXT_OBSERVATION_REFERENCE_RANGE =
      OPENMRS_FHIR_EXT_PREFIX + "/obs/reference-range";

  public static final String OPENMRS_FHIR_EXT_RECORDED =
      OPENMRS_FHIR_EXT_PREFIX + "/medicationdispense/recorded";

  public static final String OPENMRS_FHIR_EXT_MEDICATION_REQUEST_FULFILLER_STATUS =
      OPENMRS_FHIR_EXT_PREFIX + "/medicationrequest/fulfillerstatus";
  ...
  public static final String PERSON_CONTACT_POINT_ATTRIBUTE_TYPE =
      "fhir2.personContactPointAttributeTypeUuid";

  public static final String LOCATION_CONTACT_POINT_ATTRIBUTE_TYPE =
      "fhir2.locationContactPointAttributeTypeUuid";

  public static final String PROVIDER_CONTACT_POINT_ATTRIBUTE_TYPE =
      "fhir2.providerContactPointAttributeTypeUuid";

  public static final String LOCATION_TYPE_ATTRIBUTE_TYPE = "fhir2.locationTypeAttributeTypeUuid";

  public static final String IMMUNIZATIONS_ENCOUNTER_TYPE_PROPERTY =
      "fhir2.immunizationsEncounterTypeUuid";

  public static final String ADMINISTERING_ENCOUNTER_ROLE_PROPERTY =
      "fhir2.administeringEncounterRoleUuid";

  public static final String SUPPORTED_LOCATION_HIERARCHY_SEARCH_DEPTH =
      "fhir.supportedLocationHierarchySearchDepth";
  ...
  public static final String GLOBAL_PROPERTY_DEFAULT_CONCEPT_MAP_TYPE =
      "concept.defaultConceptMapType";

  public static final String GLOBAL_PROPERTY_URI_PREFIX = "fhir2.uriPrefix";

  public static final String ENCOUNTER_REFERENCE_SEARCH_HANDLER =
      "encounter.reference.search.handler";

  public static final String PATIENT_REFERENCE_SEARCH_HANDLER = "patient.reference.search.handler";

  public static final String MEDICATION_REQUEST_REFERENCE_SEARCH_HANDLER =
      "medicationRequest.reference.search.handler";

  public static final String MEDICATION_REFERENCE_SEARCH_HANDLER =
      "medication.reference.search.handler";
  ...
  public static final String PARTICIPANT_REFERENCE_SEARCH_HANDLER =
      "participant.reference.search.handler";
  ...
  public static final String LOCATION_REFERENCE_SEARCH_HANDLER =
      "location.reference.search.handler";
  ...
  public static final String HAPI_NARRATIVES_PROPERTY_FILE =
      "classpath:ca/uhn/fhir/narrative/narratives.properties";

  public static final String OPENMRS_NARRATIVES_PROPERTY_FILE =
      "classpath:org/openmrs/module/fhir2/narratives.properties";

  public static final String NARRATIVES_OVERRIDE_PROPERTY_FILE =
      "fhir2.narrativesOverridePropertyFile";
  ...
  public static final String CONDITION_CLINICAL_STATUS_HANDLER =
      "condition.clinical.status.handler";
  ...
  public static final String BASED_ON_REFERENCE_SEARCH_HANDLER =
      "based.on.reference.search.handler";
  ...
  public static final String ENCOUNTER_TYPE_REFERENCE_SEARCH_HANDLER =
      "type.reference.search.handler";
  ...
  public static final String CONDITION_OBSERVATION_CONCEPT_UUID =
  ...
  public static final String CONDITION_CATEGORY_SYSTEM_URI =
      HL7_FHIR_CODE_SYSTEM_PREFIX + "/condition-category";
  ...
  public static final String DIAGNOSIS_RANK_EXTENSION_URI =
      "http://fhir.openmrs.org/R4/StructureDefinition/diagnosis-rank";

  public static final String CONDITION_CLINICAL_SYSTEM_URI =
      HL7_FHIR_CODE_SYSTEM_PREFIX + "/condition-clinical";

  public static final String CONDITION_VER_STATUS_SYSTEM_URI =
      HL7_FHIR_CODE_SYSTEM_PREFIX + "/condition-ver-status";

  public static final String USER_DATA_KEY_CREATE_IF_NOT_EXISTS =
      "fhir2_module_create_if_not_exists";
