...
public class OpenmrsFhirCriteriaSubquery<V, U> extends BaseFhirCriteriaHolder<V> {
  ...
  /**
   * The projection expression for this subquery. This defines what the subquery will return (e.g.,
   * an ID field, a COUNT, or another expression). <br>
   ...
   */
  @Setter Expression<U> projection = null;

  public OpenmrsFhirCriteriaSubquery(
      @NonNull CriteriaBuilder criteriaBuilder,
      @Nonnull Subquery<U> subquery,
      @NonNull Root<V> root) {
  ...
  /**
   * Adds a new predicate to the list of predicates being applied to the subquery under
   * construction. <br>
   * This method overrides the parent to return the more specific {@link
   * OpenmrsFhirCriteriaSubquery} type for method chaining.
   *
   ...
   * should be called once the subquery has been fully constructed and is ready to be used within
   * the parent query. <br>
