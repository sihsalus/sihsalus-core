...
public class FhirGroupDaoImpl extends BaseFhirDao<Cohort> implements FhirGroupDao {
  ...
  protected <U> void setupSearchParams(
      @Nonnull OpenmrsFhirCriteriaContext<Cohort, U> criteriaContext,
   ...
   * make it reusable
   */
  protected <U> void handleManagingEntity(
      OpenmrsFhirCriteriaContext<Cohort, U> criteriaContext,
                ...
                if (participantToken.getChain() != null) {
                  switch (participantToken.getChain()) {
                    ...
                    case Practitioner.SP_RES_ID:
                      {
                        Join<?, ?> creatorPersonJoin =
                            criteriaContext.addJoin(creatorJoin, PERSON_ALIAS, "ps");
                        return Optional.of(
                            criteriaContext
                                .getCriteriaBuilder()
                    ...
                    case Practitioner.SP_GIVEN:
                      {
                        Join<?, ?> creatorPersonJoin =
                            criteriaContext.addJoin(creatorJoin, PERSON_ALIAS, "ps");
                        Join<?, ?> creatorPersonNameJoin =
                            criteriaContext.addJoin(creatorPersonJoin, NAMES_ALIAS, "pn");
                        return Optional.of(
                            criteriaContext
                                .getCriteriaBuilder()
                                .like(
                                    creatorPersonNameJoin.get("givenName"),
                    ...
                    case Practitioner.SP_FAMILY:
                      {
                        ...
                        return Optional.of(
                            criteriaContext
                                .getCriteriaBuilder()
                                .like(
                                    creatorPersonNameJoin.get("familyName"),
                                    participantToken.getValue()));
                      }
                        ...
                        for (String token :
                          ...
                          criterionList.add(
                              getSearchQueryHelper()
                                  .propertyLike(
                                      criteriaContext, creatorPersonNameJoin, "givenName", token));
                          criterionList.add(
                              getSearchQueryHelper()
                                  .propertyLike(
                                      criteriaContext, creatorPersonNameJoin, "middleName", token));
                          criterionList.add(
                              getSearchQueryHelper()
                                  .propertyLike(
                                      criteriaContext, creatorPersonNameJoin, "familyName", token));
                        }

                        return Optional.of(
                            criteriaContext
                                .getCriteriaBuilder()
                                .or(toCriteriaArray(criterionList)));
                      }
                  }
                } else {
                  ...
                  return Optional.of(
                      criteriaContext
                          .getCriteriaBuilder()
                          .equal(creatorJoin.get("uuid"), participantToken.getValue()));
                }
