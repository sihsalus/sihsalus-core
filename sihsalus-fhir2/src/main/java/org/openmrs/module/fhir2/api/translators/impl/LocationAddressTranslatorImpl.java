...
@Component
public class LocationAddressTranslatorImpl extends BaseAddressTranslator
    implements LocationAddressTranslator {
            ...
            ext ->
                ext.getExtension()
                    .forEach(
                        e ->
                            addAddressComponent(
                                omrsLocation, e.getUrl(), ((StringType) e.getValue()).getValue())));
    return omrsLocation;
  }
}
