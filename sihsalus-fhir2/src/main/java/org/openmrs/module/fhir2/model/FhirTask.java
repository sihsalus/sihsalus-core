...
public class FhirTask extends BaseOpenmrsMetadata {
  ...
  @JoinTable(
      name = "fhir_task_based_on_reference",
  ...
  /**
   * Additional information that may be needed in the execution of the task. see <a
   * href="https://www.hl7.org/fhir/task-definitions.html#Task.input">...</a>
   */
  @OneToMany(cascade = CascadeType.ALL)
  ...
  /**
   * Outputs produced by the Task. see <a
   * href="https://www.hl7.org/fhir/task-definitions.html#Task.output">...</a>
   */
  @OneToMany(cascade = CascadeType.ALL)
  @JoinColumn(name = "task_id")
  ...
  @OneToMany(cascade = CascadeType.ALL)
  @JoinTable(
      name = "fhir_task_part_of_reference",
      joinColumns = @JoinColumn(name = "task_id"),
      inverseJoinColumns = @JoinColumn(name = "reference_id"))
