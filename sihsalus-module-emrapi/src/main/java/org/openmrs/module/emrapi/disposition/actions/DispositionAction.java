...
public interface DispositionAction {
  ...
  /**
   * Actions will be called before the framework saves the encounter, but within the same
   * transaction. A typical implementation would add an additional observation to the obs group
