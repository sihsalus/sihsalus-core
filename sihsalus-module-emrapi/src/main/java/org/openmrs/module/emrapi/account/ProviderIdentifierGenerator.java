 ...
 *
 * <p>When saving an Account, if there is an associated Provider and that Provider does not have an
 * identifier, the generateIdentifier method will be called and the result set as the
 * provider.identifier
 *
 * <p>See MirebalaisProviderIdentifierGenerator for an example implementation; check out the
