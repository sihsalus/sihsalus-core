...
public class DiagnosisMetadata extends ConceptSetDescriptor {
	...
	public DiagnosisMetadata(ConceptService conceptService, ConceptSource emrConceptSource,
		...
		this.conceptMappings = conceptMappings == null ? EmrApiConceptMappings.defaults() : conceptMappings;
		setup(conceptService, this.conceptMappings.getConceptSourceName(),
		    ConceptSetDescriptorField.required("diagnosisSetConcept",
		        this.conceptMappings.getDiagnosisConceptSetCode()),
		    ConceptSetDescriptorField.required("codedDiagnosisConcept", this.conceptMappings.getCodedDiagnosisCode()),
		    ConceptSetDescriptorField.required("nonCodedDiagnosisConcept",
		        this.conceptMappings.getNonCodedDiagnosisCode()),
		    ConceptSetDescriptorField.required("diagnosisOrderConcept", this.conceptMappings.getDiagnosisOrderCode()),
		    ConceptSetDescriptorField.required("diagnosisCertaintyConcept",
		        this.conceptMappings.getDiagnosisCertaintyCode()));
	...
	public Obs buildDiagnosisObsGroup(Diagnosis diagnosis) {
		...
		Concept certaintyAnswer = findEmrAnswer(diagnosisCertaintyConcept,
		    getCodeFor(diagnosis.getCertainty()));
	...
	public boolean isPrimaryDiagnosis(Obs obsGroup) {
		return isDiagnosis(obsGroup) && hasDiagnosisOrder(obsGroup, conceptMappings.getDiagnosisOrderPrimaryCode());
	}
