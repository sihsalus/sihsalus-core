...
public abstract class ModuleProperties {
	...
	protected List<PatientIdentifierType> getPatientIdentifierTypesByGlobalProperty(String globalPropertyName,
	        boolean required) {
		...
		if (StringUtils.isNotEmpty(globalProperty)) {
			for (String type : globalProperty.split(",")) {
				...
				if (patientIdentifierType != null) {
					...
					log.warn(
					    "Global property " + globalPropertyName + " specifies an unknown patient identifier type: " + type);
				}
			}
		}
		return types;
