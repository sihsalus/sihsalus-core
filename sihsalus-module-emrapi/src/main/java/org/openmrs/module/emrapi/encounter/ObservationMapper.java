...
public class ObservationMapper {
  ...
  private String getDateString(Obs obs) {
    return obs.getValueDate() != null
        ? new SimpleDateFormat("yyyy-MM-dd").format(obs.getValueDate())
        : null;
  }

  private String getDatetimeString(Obs obs) {
    return obs.getValueDatetime() != null
        ? new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(obs.getValueDatetime())
        : null;
  }
}
