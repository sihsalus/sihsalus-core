...
public class EmrApiConceptMappings {
	...
	public EmrApiConceptMappings(String conceptSourceName, String sameAsConceptMapTypeUuid,
	    String narrowerThanConceptMapTypeUuid, String diagnosisConceptSetCode, String codedDiagnosisCode,
	    String nonCodedDiagnosisCode, String diagnosisOrderCode, String diagnosisOrderPrimaryCode,
	    String diagnosisOrderSecondaryCode, String diagnosisCertaintyCode, String diagnosisCertaintyConfirmedCode,
	    String diagnosisCertaintyPresumedCode, String dispositionConceptSetCode, String dispositionCode,
	    String admissionLocationCode, String internalTransferLocationCode, String dateOfDeathCode,
	    String unknownCauseOfDeathCode, String patientDiedCode, String admissionDecisionCode, String denyAdmissionCode,
	...
	public static EmrApiConceptMappings from(BiFunction<String, String, String> propertyResolver) {
		return new EmrApiConceptMappings(
		        resolve(propertyResolver, EmrApiConstants.GP_EMR_CONCEPT_SOURCE_NAME,
		            EmrApiConstants.EMR_CONCEPT_SOURCE_NAME),
		        resolve(propertyResolver, EmrApiConstants.GP_SAME_AS_CONCEPT_MAP_TYPE_UUID,
		            EmrApiConstants.SAME_AS_CONCEPT_MAP_TYPE_UUID),
		        resolve(propertyResolver, EmrApiConstants.GP_NARROWER_THAN_CONCEPT_MAP_TYPE_UUID,
		            EmrApiConstants.NARROWER_THAN_CONCEPT_MAP_TYPE_UUID),
		        resolve(propertyResolver, EmrApiConstants.GP_CONCEPT_CODE_DIAGNOSIS_CONCEPT_SET,
		            EmrApiConstants.CONCEPT_CODE_DIAGNOSIS_CONCEPT_SET),
		        resolve(propertyResolver, EmrApiConstants.GP_CONCEPT_CODE_CODED_DIAGNOSIS,
		            EmrApiConstants.CONCEPT_CODE_CODED_DIAGNOSIS),
		        resolve(propertyResolver, EmrApiConstants.GP_CONCEPT_CODE_NON_CODED_DIAGNOSIS,
		            EmrApiConstants.CONCEPT_CODE_NON_CODED_DIAGNOSIS),
		        resolve(propertyResolver, EmrApiConstants.GP_CONCEPT_CODE_DIAGNOSIS_ORDER,
		            EmrApiConstants.CONCEPT_CODE_DIAGNOSIS_ORDER),
		        resolve(propertyResolver, EmrApiConstants.GP_CONCEPT_CODE_DIAGNOSIS_ORDER_PRIMARY,
		            EmrApiConstants.CONCEPT_CODE_DIAGNOSIS_ORDER_PRIMARY),
		        resolve(propertyResolver, EmrApiConstants.GP_CONCEPT_CODE_DIAGNOSIS_ORDER_SECONDARY,
		            EmrApiConstants.CONCEPT_CODE_DIAGNOSIS_ORDER_SECONDARY),
		        resolve(propertyResolver, EmrApiConstants.GP_CONCEPT_CODE_DIAGNOSIS_CERTAINTY,
		            EmrApiConstants.CONCEPT_CODE_DIAGNOSIS_CERTAINTY),
		        resolve(propertyResolver, EmrApiConstants.GP_CONCEPT_CODE_DIAGNOSIS_CERTAINTY_CONFIRMED,
		            EmrApiConstants.CONCEPT_CODE_DIAGNOSIS_CERTAINTY_CONFIRMED),
		        resolve(propertyResolver, EmrApiConstants.GP_CONCEPT_CODE_DIAGNOSIS_CERTAINTY_PRESUMED,
		            EmrApiConstants.CONCEPT_CODE_DIAGNOSIS_CERTAINTY_PRESUMED),
		        resolve(propertyResolver, EmrApiConstants.GP_CONCEPT_CODE_DISPOSITION_CONCEPT_SET,
		            EmrApiConstants.CONCEPT_CODE_DISPOSITION_CONCEPT_SET),
		        resolve(propertyResolver, EmrApiConstants.GP_CONCEPT_CODE_DISPOSITION,
		            EmrApiConstants.CONCEPT_CODE_DISPOSITION),
		        resolve(propertyResolver, EmrApiConstants.GP_CONCEPT_CODE_ADMISSION_LOCATION,
		            EmrApiConstants.CONCEPT_CODE_ADMISSION_LOCATION),
		        resolve(propertyResolver, EmrApiConstants.GP_CONCEPT_CODE_INTERNAL_TRANSFER_LOCATION,
		            EmrApiConstants.CONCEPT_CODE_INTERNAL_TRANSFER_LOCATION),
		        resolve(propertyResolver, EmrApiConstants.GP_CONCEPT_CODE_DATE_OF_DEATH,
		            EmrApiConstants.CONCEPT_CODE_DATE_OF_DEATH),
		        resolve(propertyResolver, EmrApiConstants.GP_CONCEPT_CODE_UNKNOWN_CAUSE_OF_DEATH,
		            EmrApiConstants.CONCEPT_CODE_UNKNOWN_CAUSE_OF_DEATH),
		        resolve(propertyResolver, EmrApiConstants.GP_CONCEPT_CODE_PATIENT_DIED,
		            EmrApiConstants.CONCEPT_CODE_PATIENT_DIED),
		        resolve(propertyResolver, EmrApiConstants.GP_CONCEPT_CODE_ADMISSION_DECISION,
		            EmrApiConstants.CONCEPT_CODE_ADMISSION_DECISION),
		        resolve(propertyResolver, EmrApiConstants.GP_CONCEPT_CODE_DENY_ADMISSION,
		            EmrApiConstants.CONCEPT_CODE_DENY_ADMISSION),
		        resolve(propertyResolver, EmrApiConstants.GP_CONCEPT_CODE_CONSULT_FREE_TEXT_COMMENTS,
		            EmrApiConstants.CONCEPT_CODE_CONSULT_FREE_TEXT_COMMENTS));
	}

	private static String resolve(BiFunction<String, String, String> propertyResolver, String propertyName,
	        String defaultValue) {
