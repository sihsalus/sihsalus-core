...
public class AdtUtil {
  ...
  public static List<Concept> getAdmissionDispositionsConcepts(
      EmrConceptService emrConceptService, DispositionService dispositionService) {

    List<Disposition> admissionDispositions =
        dispositionService.getDispositionsByType(DispositionType.ADMIT);
