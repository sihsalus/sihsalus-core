...
public interface LogicService {
   ...
   *
   * <p><strong>Should</strong> return all registered token
   *
   ...
   *
   * <p><strong>Should</strong> return all registered token matching the input fully<br>
   * <strong>Should</strong> return all registered token matching the input partially<br>
   ...
   *
   * <p><strong>Should</strong> not fail when another rule is registered on the same token<br>
   ...
   *
   * <p><strong>Should</strong> not fail when no tags is specified<br>
   ...
   *
   * <p><strong>Should</strong> return Rule associated with the input token<br>
   * <strong>Should</strong> fail when no Rule is associated with the input token<br>
   ...
   *
   * <p><strong>Should</strong> update Rule when another Rule is registered under the same token
   *
   ...
   *
   * <p><strong>Should</strong> remove rule
   *
   ...
   * @since 1.6.3, 1.7.2, and 1.8
   */
  public Result eval(Integer patientId, String expression, Map<String, Object> parameters)
      throws LogicException;
   ...
   * @since 1.6.3, 1.7.2, and 1.8
   */
  public Result eval(Integer patientId, LogicCriteria criteria, Map<String, Object> parameters)
      throws LogicException;
   ...
   * @since 1.6.3, 1.7.2, and 1.8
   */
  public Map<String, Result> eval(
      Integer patientId, Map<String, Object> parameters, String... expressions)
      throws LogicException;
   ...
   * @since 1.6.3, 1.7.2, and 1.8
   */
  public Map<LogicCriteria, Result> eval(
      Integer patientId, Map<String, Object> parameters, LogicCriteria... criteria)
      throws LogicException;
   ...
   * @see #parse(String)
   */
  public Map<Integer, Result> eval(Cohort who, String expression, Map<String, Object> parameters)
      throws LogicException;
   ...
   * @throws LogicException
   */
  public Map<Integer, Result> eval(
      Cohort who, LogicCriteria criteria, Map<String, Object> parameters) throws LogicException;
   ...
   * @throws LogicException
   */
  public Map<LogicCriteria, Map<Integer, Result>> eval(Cohort who, List<LogicCriteria> criterias)
      throws LogicException;

  /**
   * Adds a tag to the given token.
   *
   * <p><strong>Should</strong> add tag for a token
   *
   * @param token
   * @param tag
   */
   ...
   *
   * <p><strong>Should</strong> remove tag from a token
   *
   * @param token
   * @param tag
   */
   ...
   *
   * <p><strong>Should</strong> return set of tags for a certain token
   *
   ...
   *
   * <p><strong>Should</strong> return set of token associated with a tag
   *
   ...
   *
   * <p><strong>Should</strong> return set of tags matching input tag partially
   *
   ...
   * (returned by the logic service) are loosely typed by design; however, the default datatype can
   * be a useful hint for managing user interfaces or providing default behavior when working with
   * rules.
   *
