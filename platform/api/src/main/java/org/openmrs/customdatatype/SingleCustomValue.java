 ...
 * {@link Customizable} object that may hold multiple (e.g. a {@link VisitAttribute} within a {@link
 * Visit}). The "referenceString" property is a String suitable for persistance in a database
 ...
 *
 * @param <D> the descriptor for this value, e.g. VisitAttribute implements
 *     SingleCustomValue&lt;VisitAttributeType&gt;
 * @see CustomDatatype
 * @since 1.9
 */
public interface SingleCustomValue<D extends CustomValueDescriptor> {
   ...
   * Implementations should validate this value and throw an {@link InvalidCustomValueException} if
   * it's invalid, rather than setting it blindly. If you are coding against the OpenMRS API, you
   * should use {@link #setValue(Object)} instead.
   *
  ...
  /**
   * Sets the typed value. (This will result in a call to {@link
  ...
  /**
   * @return whether or not setValue has been called (thus {@link CustomDatatype#save(Object,
   *     String)} needs to be called
   */
  boolean isDirty();
}
