...
public class Allergen {
   ...
   *
   * <p><strong>Should</strong> return true for same coded allergen<br>
  ...
  public boolean isSameAllergen(Allergen allergen) {
    if (isCoded()) {
      return allergen.getCodedAllergen() != null
          && codedAllergen.equals(allergen.getCodedAllergen());
    } else {
      return nonCodedAllergen != null
