...
public interface VisitDAO {
   ...
   *
   * <p><strong>Should</strong> return all unvoided visits if includeEnded is set to true<br>
   ...
   *
   * <p><strong>Should</strong> return the next unvoided active visit matching the specified types
   * and startDate
   *
