...
public interface ProviderService extends OpenmrsService {
   ...
   *
   * <p><strong>Should</strong> get all providers
   *
   ...
   * Gets all providers
   *
   * <p><strong>Should</strong> get all providers that are unretired
   *
   ...
   *
   * <p><strong>Should</strong> retire a provider
   *
   ...
   *
   * <p><strong>Should</strong> unretire a provider
   *
   ...
   *
   * <p><strong>Should</strong> delete a provider
   *
   ...
   *
   * <p><strong>Should</strong> get provider given ID
   *
   ...
   *
   * <p><strong>Should</strong> return providers for given person<br>
   ...
   *
   * <p><strong>Should</strong> return all providers by person including retired if includeRetired
   * is true<br>
  ...
  @Authorized({PrivilegeConstants.GET_PROVIDERS})
  public List<Provider> getProviders(
      String query, Integer start, Integer length, Map<ProviderAttributeType, Object> attributes);
   ...
   * query
   *
   * <p><strong>Should</strong> fetch number of provider matching given query<br>
   ...
   *
   * <p><strong>Should</strong> get all provider attribute types including retired by default
   *
   ...
   *
   * <p><strong>Should</strong> get all provider attribute types excluding retired<br>
   ...
   *
   * <p><strong>Should</strong> get provider attribute type for the given id
   *
   ...
   *
   * <p><strong>Should</strong> get the provider attribute type by its uuid
   *
   ...
   *
   * <p><strong>Should</strong> get the provider attribute type by its name
   *
   ...
   *
   * <p><strong>Should</strong> get the provider attribute by it's providerAttributeID
   *
   ...
   *
   * <p><strong>Should</strong> get the provider attribute by its providerAttributeUuid
   *
   ...
   */
  public ProviderAttributeType retireProviderAttributeType(
      ProviderAttributeType providerAttributeType, String reason);

  /**
   * Un-Retire a provider attribute type
   *
   * <p><strong>Should</strong> unretire a provider attribute type
   *
   * @param providerAttributeType the provider type attribute to unretire
   * @return the unretire provider attribute type
   */
  public ProviderAttributeType unretireProviderAttributeType(
      ProviderAttributeType providerAttributeType);

  /**
   * Deletes a provider attribute type
   *
   * <p><strong>Should</strong> delete a provider attribute type
   *
   ...
   *
   * <p><strong>Should</strong> return false if the identifier is a duplicate<br>
   ...
   *
   * <p><strong>Should</strong> get a provider matching the specified identifier ignoring case
   *
   ...
   * the value for the global property {@link
   * org.openmrs.util.OpenmrsConstants#GP_UNKNOWN_PROVIDER_UUID}
   *
   * <p><strong>Should</strong> get the unknown provider account
   *
   * @return a {@link Provider}
   * @since 1.10
   */
