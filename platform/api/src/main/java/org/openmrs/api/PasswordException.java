 ...
 *
 * <p>Preferred use of this class and its subclass are the {@link #PasswordException()} or the
 * {@link #PasswordException(String)}. The empty constructor will create an exception object using
 * without an exception message.
 *
 * <p>For details on what is checked, see {@link OpenmrsUtil#validatePassword(String, String,
 * String)}.
 *
 * @since 1.5
 */
