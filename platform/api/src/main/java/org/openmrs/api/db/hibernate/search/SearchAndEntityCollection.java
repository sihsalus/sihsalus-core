...
/**
 * Wrapper class around a {@link SearchQueryContributor} object and the Type of the entities to be
 * searched by the query. An instance of this class is set as the source of a {@link
 * SearchCreatedEvent} object.
 *
 * @since 2.8.0
 */
public class SearchAndEntityCollection<T> implements SearchQueryContributor {
  ...
  public SearchAndEntityCollection(
      SearchQueryContributor query, Collection<? extends Class<? extends T>> entityCollection) {
