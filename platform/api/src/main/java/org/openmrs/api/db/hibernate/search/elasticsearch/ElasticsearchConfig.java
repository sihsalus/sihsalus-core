...
public class ElasticsearchConfig implements ElasticsearchAnalysisConfigurer {
  ...
  public void configure(ElasticsearchAnalysisConfigurationContext context) {
    context
        .analyzer(SearchAnalysis.NAME_ANALYZER)
        .custom()
        .tokenizer("standard")
        .tokenFilters("lowercase", "asciifolding");

    context
        .analyzer(SearchAnalysis.PHRASE_ANALYZER)
        .custom()
        .tokenizer("whitespace")
        .tokenFilters("lowercase", "asciifolding");

    context
        .analyzer(SearchAnalysis.EXACT_ANALYZER)
        .custom()
        .tokenizer("whitespace")
        .tokenFilters("lowercase", "asciifolding");
    ...
    context
        .analyzer(SearchAnalysis.SOUNDEX_ANALYZER)
        .custom()
        .tokenizer("standard")
        .tokenFilters("lowercase", "asciifolding", "phonetic_soundex");

    context
        .tokenFilter("edge_ngram_2_20")
        .type("edge_ngram")
        .param("min_gram", "2")
        .param("max_gram", "20");
