...
public interface ProgramWorkflowService extends OpenmrsService {
   ...
   *
   * <p><strong>Should</strong> create program workflows<br>
   * <strong>Should</strong> save program successfully<br>
   * <strong>Should</strong> save workflows associated with program<br>
   * <strong>Should</strong> save states associated with program<br>
   ...
   *
   * <p><strong>Should</strong> return program matching the given programId<br>
  ...
  /**
   * Returns a program given the program's exact <code>name</code> A null value is returned if there
   * is no program with this name
   *
   * <p><strong>Should</strong> return program when name matches<br>
   * <strong>Should</strong> return null when program does not exist with given name<br>
   ...
   *
   * <p><strong>Should</strong> return all programs including retired when includeRetired equals
   * true<br>
   ...
   * will be returned if there are no programs matching this <code>nameFragment</code>
   *
   * <p><strong>Should</strong> return all programs with partial name match<br>
   * <strong>Should</strong> return all programs when exact name match<br>
   * <strong>Should</strong> return empty list when name does not match<br>
   * <strong>Should</strong> not return a null list<br>
   * <strong>Should</strong> return programs when nameFragment matches beginning of program name<br>
   * <strong>Should</strong> return programs when nameFragment matches ending of program name<br>
   * <strong>Should</strong> return programs when nameFragment matches middle of program name<br>
   * <strong>Should</strong> return programs when nameFragment matches entire program name<br>
   * <strong>Should</strong> return programs ordered by name<br>
   ...
   *
   * <p><strong>Should</strong> delete program successfully
   *
   ...
   *
   * <p><strong>Should</strong> delete program successfully<br>
   * <strong>Should</strong> not delete child associations when cascade equals false<br>
   * <strong>Should</strong> throw APIException when given cascade equals true<br>
   ...
   *
   * <p><strong>Should</strong> retire program successfully<br>
   * <strong>Should</strong> retire workflows associated with given program<br>
   ...
   *
   * <p><strong>Should</strong> unretire program successfully<br>
   * <strong>Should</strong> unretire workflows associated with given program<br>
   ...
   * <strong>Should</strong> return program with given uuid<br>
  ...
  /**
   * Get a program state by its uuid. There should be only one of these in the database. If multiple
   * are found, an error is thrown.
   *
   * <p><strong>Should</strong> find object given valid uuid<br>
   * <strong>Should</strong> return null if no object found with given uuid<br>
   * <strong>Should</strong> return program state with the given uuid<br>
   ...
   *
   * <p><strong>Should</strong> update patient program<br>
   * <strong>Should</strong> save patient program successfully<br>
  ...
  /**
   * Returns a PatientProgram given that PatientPrograms primary key <code>patientProgramId</code> A
   * null value is returned if no PatientProgram exists with this patientProgramId.
   *
   * <p><strong>Should</strong> return patient program with given patientProgramId<br>
   * <strong>Should</strong> get patient program with given identifier<br>
   ...
   * @return PatientProgram object that has patientProgram.patientProgramId = <code>patientProgramId
   *     </code> passed in.
   * @throws APIException
   */
  ...
  /**
   * Returns PatientPrograms that match the input parameters. If an input parameter is set to null,
   * the parameter will not be used. Calling this method will all null parameters will return all
   * PatientPrograms in the database A null list will never be returned. An empty list will be
   * returned if there are no programs matching the input criteria
   *
   * <p><strong>Should</strong> return patient programs for given patient<br>
   * <strong>Should</strong> return patient programs for given program<br>
   * <strong>Should</strong> return patient programs with dateEnrolled on or before
   * minEnrollmentDate<br>
   * <strong>Should</strong> return patient programs with dateEnrolled on or after maxEnrollmentDate
   * <br>
   * <strong>Should</strong> return patient programs with dateCompleted on or before
   * minCompletionDate<br>
   * <strong>Should</strong> return patient programs with dateCompleted on or after
   * maxCompletionDate<br>
   * <strong>Should</strong> return patient programs with dateCompleted<br>
   * <strong>Should</strong> return patient programs not yet completed<br>
   * <strong>Should</strong> return voided patient programs<br>
   * <strong>Should</strong> return all patient programs when all parameters are null<br>
   ...
   * @param minEnrollmentDate if supplied will limit PatientPrograms to those with enrollments on or
   *     after this Date
   * @param maxEnrollmentDate if supplied will limit PatientPrograms to those with enrollments on or
   *     before this Date
   * @param minCompletionDate if supplied will limit PatientPrograms to those completed on or after
   *     this Date OR not yet completed
   * @param maxCompletionDate if supplied will limit PatientPrograms to those completed on or before
   *     this Date
  ...
  /**
   * Completely remove a patientProgram from the database (not reversible) This method delegates to
   * #purgePatientProgram(patientProgram, boolean) method
   *
   * <p><strong>Should</strong> delete patient program from database without cascade
   *
   ...
   *
   * <p><strong>Should</strong> delete patient program from database<br>
   * <strong>Should</strong> cascade delete patient program states when cascade equals true<br>
   ...
   */
  @Authorized({PrivilegeConstants.PURGE_PATIENT_PROGRAMS})
  public void purgePatientProgram(PatientProgram patientProgram, boolean cascade)
      throws APIException;

  /**
   * Voids the given patientProgram
   *
   * <p><strong>Should</strong> void patient program when reason is valid<br>
   ...
   *
   * <p><strong>Should</strong> void patient program when reason is valid
   *
  ...
  /**
   * Get all possible outcome concepts for a program. Will return all concept answers {@link
   * org.openmrs.Concept#getAnswers()} if they exist, then all concept set members {@link
   * org.openmrs.Concept#getSetMembers()} if they exist, then empty List.
   *
   * @param programId
   ...
   *
   * <p><strong>Should</strong> save state conversion
   *
   ...
   */
  @Authorized({PrivilegeConstants.ADD_PATIENT_PROGRAMS, PrivilegeConstants.EDIT_PATIENT_PROGRAMS})
  public ConceptStateConversion saveConceptStateConversion(
      ConceptStateConversion conceptStateConversion) throws APIException;

  /**
   * Returns a conceptStateConversion given that conceptStateConversions primary key <code>
   * conceptStateConversionId</code> A null value is returned if no conceptStateConversion exists
   * with this conceptStateConversionId.
   *
   * <p><strong>Should</strong> return concept state conversion for given identifier
   *
   ...
   *
   * <p><strong>Should</strong> return all concept state conversions
   *
   ...
   *
   * <p><strong>Should</strong> cascade delete given concept state conversion when given cascade is
   * true<br>
   * <strong>Should</strong> not cascade delete given concept state conversion when given cascade is
   * false
   *
   * @param conceptStateConversion the ConceptStateConversion to clean out of the database.
   * @param cascade <code>true</code> to delete related content
   ...
   */
  @Authorized({PrivilegeConstants.MANAGE_PROGRAMS})
  public void purgeConceptStateConversion(
      ConceptStateConversion conceptStateConversion, boolean cascade) throws APIException;

  /**
   * Retrieves the ConceptStateConversion that matches the passed <code>ProgramWorkflow</code> and
   * <code>Concept</code>
   *
   * <p><strong>Should</strong> return concept state conversion for given workflow and trigger
   *
   * @param workflow - the ProgramWorkflow to check
   * @param trigger - the Concept to check
   * @return ConceptStateConversion that matches the passed <code>ProgramWorkflow</code> and <code>
   *     Concept</code>
   * @throws APIException
   */
   ...
   * <p><strong>Should</strong> find object given valid uuid<br>
   * <strong>Should</strong> return null if no object found with given uuid<br>
   * <strong>Should</strong> return a state with the given uuid<br>
   ...
   * <p><strong>Should</strong> find object given valid uuid<br>
   * <strong>Should</strong> return null if no object found with given uuid<br>
   * <strong>Should</strong> return a patient program with the given uuid<br>
  ...
  /**
   * <strong>Should</strong> return patient programs with patients in given cohort and programs<br>
   * <strong>Should</strong> return patient programs with patients in given cohort<br>
   * <strong>Should</strong> return patient programs with programs in given programs<br>
   * <strong>Should</strong> return empty list when there is no match for given cohort and programs
   * <br>
   * <strong>Should</strong> not return null when there is no match for given cohort and program<br>
   * <strong>Should</strong> not throw NullPointerException when given cohort and programs are null
   * <br>
   * <strong>Should</strong> not fail when given cohort is empty<br>
   ...
   * <p><strong>Should</strong> find object given valid uuid<br>
   * <strong>Should</strong> return null if no object found with given uuid<br>
   * <strong>Should</strong> return a program state with the given uuid<br>
  ...
  public Map<Object, Object> getPatientProgramAttributeByAttributeName(
      List<Integer> patients, String attributeName);

  @Transactional(readOnly = true)
  @Authorized({"Get Patient Programs"})
  public List<PatientProgram> getPatientProgramByAttributeNameAndValue(
