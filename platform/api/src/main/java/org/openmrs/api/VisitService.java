...
public interface VisitService extends OpenmrsService {
   ...
   *
   * <p><strong>Should</strong> get all visit types
   *
   ...
   *
   * <p><strong>Should</strong> get all visit types based on include retired flag.
   *
   ...
   *
   * <p><strong>Should</strong> get correct visit type
   *
   ...
   *
   * <p><strong>Should</strong> get correct visit types
   *
   ...
   *
   * <p><strong>Should</strong> save new visit type<br>
   ...
   *
   * <p><strong>Should</strong> retire given visit type
   *
   ...
   *
   * <p><strong>Should</strong> unretire given visit type
   *
   ...
   *
   * <p><strong>Should</strong> delete given visit type
   *
   ...
   *
   * <p><strong>Should</strong> return all unvoided visits
   *
   ...
   *
   * <p><strong>Should</strong> return a visit matching the specified uuid
   *
   ...
   *
   * <p><strong>Should</strong> add a new visit to the database<br>
   ...
   *
   * <p><strong>Should</strong> set the stopDateTime of visit<br>
   ...
   *
   * <p><strong>Should</strong> void the visit and set the voidReason<br>
   ...
   *
   * <p><strong>Should</strong> unvoid the visit and unset all the void related fields<br>
   ...
   *
   * <p><strong>Should</strong> erase the visit from the database<br>
   ...
   *
   * <p><strong>Should</strong> get visits by visit type<br>
   ...
   *
   * <p><strong>Should</strong> return all unvoided visits for the specified patient
   *
   ...
   *
   * <p><strong>Should</strong> return all active unvoided visits for the specified patient<br>
  ...
  public List<Visit> getVisitsByPatient(
      Patient patient, boolean includeInactive, boolean includeVoided) throws APIException;
   ...
   *
   * <p><strong>Should</strong> create a new visit attribute type<br>
   ...
   *
   * <p><strong>Should</strong> retire a visit attribute type
   *
   * @param visitAttributeType
   ...
   *
   * <p><strong>Should</strong> unretire a retired visit attribute type
   *
   * @param visitAttributeType
   ...
   *
   * <p><strong>Should</strong> completely remove a visit attribute type
   *
   * @param visitAttributeType
   */
   ...
   *
   * <p><strong>Should</strong> close all unvoided active visit matching the specified visit types
   *
