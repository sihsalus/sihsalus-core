...
public interface ConceptService extends OpenmrsService {
   ...
   *
   * <p>If this is a new concept, the returned concept will have a new {@link
   * Concept#getConceptId()} inserted into it that was generated by the database
   *
   * <p><strong>Should</strong> put generated concept id onto returned concept<br>
   ...
   * concept<br>
   * <strong>Should</strong> create a reference term for a concept mapping on the fly when creating
   * a concept<br>
   ...
   * database
   *
   * <p><strong>Should</strong> put generated drug id onto returned drug<br>
   ...
   * should not typically be used unless desperately needed. Most should just be retired. See {@link
   * #retireConcept(Concept, String)}
   *
   * <p><strong>Should</strong> purge the concept if not being used by an obs<br>
   ...
   *
   * <p><strong>Should</strong> fail if no reason is given<br>
   ...
   *
   * <p><strong>Should</strong> retire the given Drug
   *
   ...
   *
   * <p><strong>Should</strong> mark drug as not retired<br>
   ...
   *
   * <p><strong>Should</strong> purge the given drug
   *
   ...
   *
   * <p><strong>Should</strong> order by concept id and include retired when given no parameters<br>
   ...
   *
   * <p><strong>Should</strong> pass irrespective of the case of the passed parameter
   *
   ...
   *
   * <p><strong>Should</strong> get concept by name<br>
  ...
  /**
   * Get the concept by conceptRef where the conceptRef can either be: 1) an integer id like 5090 2)
   * a mapping type id like "XYZ:HT" 3) a uuid like "a3e12268-74bf-11df-9768-17cfc9833272" 4) a name
   ...
   *
   * <p><strong>Should</strong> return the matching drug object<br>
   ...
   *
   * <p><strong>Should</strong> return a list of all drugs
   *
   * @throws APIException
   ...
   *
   * <p><strong>Should</strong> return all drugs including retired ones if given true<br>
   ...
   *
   * <p><strong>Should</strong> not return drugs that are retired<br>
   ...
   *
   * <p><strong>Should</strong> return a list of all concept classes
   *
   * @throws APIException
   ...
   * Return a list of concept classes currently in the database
   *
   * <p><strong>Should</strong> return all concept classes including retired ones when given true
   * <br>
   ...
   *
   * <p><strong>Should</strong> save the the given ConceptClass
   *
   ...
   *
   * <p><strong>Should</strong> delete the given ConceptClass
   *
   ...
   *
   * <p><strong>Should</strong> delete the specified conceptNameTag from the database
   *
   ...
   *
   * <p><strong>Should</strong> give a list of all concept datatypes
   *
   * @throws APIException
   ...
   *
   * <p><strong>Should</strong> return all concept datatypes including retired ones when given true
   * <br>
   ...
   *
   * <p><strong>Should</strong> return an exact match on name<br>
   ...
   *
   * <p>For example to find all concepts for ARVs, you would do
   * getConceptSets(getConcept("ANTIRETROVIRAL MEDICATIONS")) and then take the conceptIds from the
   * resulting list.
   *
   ...
   *
   * <p><strong>Should</strong> give a list of ConceptSet containing the given Concept<br>
   ...
   *
   * <p><strong>Should</strong> return all concept proposals including retired ones when given true
   * <br>
   ...
   *
   * <p><strong>Should</strong> purge the given concept proposal
   *
   * @param cp
   * @throws APIException
   */
   ...
   *
   * <p><strong>Should</strong> not require mapped concept on reject action<br>
   ...
   *
   * <p><strong>Should</strong> return an empty list if concept id is null
   *
   * @param concept
   ...
   *
   * <p><strong>Should</strong> return the concept previous to the given concept
   *
   ...
   *
   * <p><strong>Should</strong> return the concept next to the given concept
   *
   * @param concept the offset Concept
   * @return the foundConcept
   * @throws APIException
   ...
   *
   * <p><strong>Should</strong> give a list of all matching concepts
   *
   ...
   *
   * <p><strong>Should</strong> return a concept complex object
   *
   ...
   *
   * <p><strong>Should</strong> return a list of matching locales
   *
   ...
   *
   * <p><strong>Should</strong> return all concept sources including retired ones when given true
   * <br>
   ...
   *
   * <p><strong>Should</strong> not set creator if one is supplied already<br>
   ...
   *
   * <p><strong>Should</strong> purge the given concept source
   *
   ...
   *
   * <p><strong>Should</strong> retire concept source
   *
   ...
   *
   * <p><strong>Should</strong> save a concept name tag if tag does not exist<br>
   ...
   *
   * <p><strong>Should</strong> give the maximum concept-id
   *
   ...
   *
   * <p><strong>Should</strong> start with the smallest concept id<br>
   ...
   * {@link ConceptMap} entry whose <code>sourceCode</code> is equal to the passed <code>conceptCode
   * </code> and whose {@link ConceptSource} has either a <code>name</code> or <code>hl7Code</code>
   * that is equal to the passed <code>mappingCode</code>. Delegates to
   * getConceptByMapping(code,sourceName,includeRetired) with includeRetired=true
   *
   * <p><strong>Should</strong> get concept with given code and and source hl7 code<br>
   ...
   * {@link ConceptMap} entry whose <code>sourceCode</code> is equal to the passed <code>conceptCode
   * </code> and whose {@link ConceptSource} has either a <code>name</code> or <code>hl7Code</code>
   * that is equal to the passed <code>mappingCode</code> . Operates under the assumption that each
   * mappingCode in a {@link ConceptSource} references one and only one non-retired {@link Concept}:
   * if the underlying dao method returns more than one non-retired concept, this method will throw
   * an exception; if the underlying dao method returns more than one concept, but only one
   * non-retired concept, this method will return the non-retired concept; if the dao only returns
   * retired concepts, this method will simply return the first concept in the list returns by the
   * dao method; retired concepts can be excluded by setting the includeRetired parameter to false,
  ...
  /**
   * Looks up a concept via {@link ConceptMap} This will return the list of concepts {@link
   * Concept}s which contain a {@link ConceptMap} entry whose <code>sourceCode</code> is equal to
   * the passed <code>conceptCode</code> and whose {@link ConceptSource} has either a <code>name
   * </code> or <code>hl7Code</code> that is equal to the passed <code>mappingCode</code>
   *
   * <p><strong>Should</strong> get concepts with given code and and source hl7 code<br>
   ...
   * contain a {@link ConceptMap} entry whose <code>sourceCode</code> is equal to the passed <code>
   * conceptCode</code> and whose {@link ConceptSource} has either a <code>name</code> or <code>
   * hl7Code</code> that is equal to the passed <code>mappingCode</code>. Delegates to
  ...
  /**
   * Looks up concepts via {@link ConceptMap} This will return the list of ids for all {@link
   * Concept}s which contain a {@link ConceptMap} entry whose <code>sourceCode</code> is equal to
   * the passed <code>conceptCode</code> and whose {@link ConceptSource} has either a <code>name
   * </code> or <code>hl7Code</code> that is equal to the passed <code>mappingCode</code>
   *
   ...
   * @param sourceName the name or hl7Code of the {@link ConceptSource} to check
   * @param includeRetired whether or not to include retired concepts
   * @return the list ids for all non-voided {@link Concept}s that have the given mapping, or an
   ...
   *
   * <p><strong>Should</strong> return a list of all concept name tags
   *
   * @since 1.5
   ...
   *
   * <p><strong>Should</strong> get ConceptSource with the given name<br>
   ...
   *
   * <p><strong>Should</strong> get concept source with the given unique id<br>
   ...
   *
   * <p><strong>Should</strong> get concept source with the given hl7Code<br>
   ...
   *
   * <p><strong>Should</strong> return the true concept
   *
   * @return true concept
   */
  @Authorized(PrivilegeConstants.GET_CONCEPTS)
   ...
   *
   * <p><strong>Should</strong> return the false concept
   *
   ...
   *
   * <p><strong>Should</strong> return the unknown concept
   *
   ...
   * associated to.
   *
   * <p><strong>Should</strong> convert the datatype of a boolean concept to coded<br>
   ...
   *
   * <p><strong>Should</strong> return concept search results that match unique concepts<br>
   ...
   *
   * <p><strong>Should</strong> return a list of all matching concept search results
   *
   * @param phrase
   * @param locale
   ...
   * note that this only updates the index of the specified concept. Use {@link
   * ConceptService#updateConceptIndexes()} if you wish to update the entire concept index.
   *
   ...
   *
   * <p><strong>Should</strong> give a list of ConceptSearchResult for the matching Concepts
   *
   ...
   *
   * <p><strong>Should</strong> return a count of unique concepts
   *
   ...
   *
   * <p><strong>Should</strong> return the total number of matching drugs
   *
   ...
   *
   * <p><strong>Should</strong> return a list of matching drugs
   *
   * @param drugName the name of the drug
   * @param concept the drug concept
   ...
   *
   * <p><strong>Should</strong> return list of concept stop words for given locale<br>
   ...
   *
   * <p>If this is a new concept stop word, the returned concept stop word will have a new {@link
   * org.openmrs.ConceptStopWord#getConceptStopWordId()} inserted into it that was generated by the
   * database
   *
   * <p><strong>Should</strong> generated concept stop word id onto returned concept stop word<br>
   ...
   *
   * <p><strong>Should</strong> delete the given concept stop word from the database
   *
   ...
   *
   * <p><strong>Should</strong> return all the concept stop words<br>
   ...
   *
   * <p><strong>Should</strong> return drugs matched by intermediate concept<br>
   ...
   *
   * <p><strong>Should</strong> return all the concept map types excluding hidden ones
   *
   ...
   *
   * <p><strong>Should</strong> return all the concept map types if includeRetired and hidden are
   * set to true<br>
   ...
   *
   * <p><strong>Should</strong> return a conceptMapType matching the specified uuid
   *
   ...
   *
   * <p><strong>Should</strong> return a conceptMapType matching the specified name<br>
   ...
   *
   * <p><strong>Should</strong> add the specified concept map type to the database and assign to it
   * an id<br>
   ...
   *
   * <p><strong>Should</strong> retire the specified conceptMapType with the given retire reason<br>
   ...
   *
   * <p><strong>Should</strong> unretire the specified concept map type and drop all retire related
   * fields
   *
   ...
   *
   * <p><strong>Should</strong> delete the specified conceptMapType from the database
   *
   ...
   *
   * <p><strong>Should</strong> return a List of ConceptMaps from the given source
   *
   * @param conceptSource
   ...
   *
   * <p><strong>Should</strong> return all concept reference terms in the database
   *
   ...
   *
   * <p><strong>Should</strong> return all the concept reference terms if includeRetired is set to
   * true<br>
   ...
   *
   * <p><strong>Should</strong> return the concept reference term that matches the given uuid
   *
   * @param uuid the uuid to search against
   ...
   *
   * <p><strong>Should</strong> return a concept reference term that matches the given name from the
   * given source<br>
   ...
   *
   * <p><strong>Should</strong> return a concept reference term that matches the given code from the
   * given source
   *
  ...
  /**
   * Gets a list of concept reference terms with the specified code from the specified concept
   * source
   *
   * <p><strong>Should</strong> return a list of concept reference terms that matches the given code
   ...
   *
   * <p><strong>Should</strong> add a concept reference term to the database and assign an id to it
   * <br>
   ...
   *
   * <p><strong>Should</strong> retire the specified concept reference term with the given retire
   * reason<br>
   * <strong>Should</strong> should set the default retire reason if none is given
   *
   ...
   *
   * <p><strong>Should</strong> unretire the specified concept reference term and drop all retire
   * related fields
   *
   ...
   *
   * <p><strong>Should</strong> purge the given concept reference term<br>
   ...
   *
   * <p><strong>Should</strong> return unique terms with a code or name containing the search phrase
   * <br>
   ...
   *
   * <p><strong>Should</strong> include retired terms if includeRetired is set to true<br>
  ...
  public Integer getCountOfConceptReferenceTerms(
      String query, ConceptSource conceptSource, boolean includeRetired) throws APIException;
   ...
   *
   * <p><strong>Should</strong> return all concept reference term maps where the specified term is
   * the termB
   *
   ...
   *
   * <p>This method is case insensitive. It searches for exactly matching names and close matching
   * locales (if exactLocale = false). It considers only non-voided names and all concepts.
   *
   * <p><strong>Should</strong> return concepts for all countries and global language given language
   * only locale<br>
   ...
   * @param exactLocale <code>false</code> if search for both global and country specific, <code>
   *     true</code> if <code>null</code>
  ...
  /**
   * Gets the concept map type to be used as the default. It is specified by the <code>
   * concept.defaultConceptMapType</code> global property.
   *
   * <p><strong>Should</strong> return same as by default<br>
   ...
   *
   * <p>Concept name is considered duplicate if it is a default non-retired name for a non-voided
   * concept and there is another name, which is:
   *
   * <ol>
   *   <li>equal ignoring case
   *   <li>non voided
   *   <li>in same locale or in same general language
   *   <li>non-retired and different concept
   *   <li>default name for concept
   * </ol>
   *
   * @param name
   ...
   * names, concept names of the associated concepts or the concept reference term codes of the drug
   * reference term mappings
   *
   * <p><strong>Should</strong> get drugs with names matching the search phrase<br>
   ...
   *
   * <p><strong>Should</strong> get a list of all drugs that match on all the parameter values<br>
   ...
   *
   * <p><strong>Should</strong> return a drug that matches the code and source<br>
   ...
   *
   * <p><strong>Should</strong> get orderable concepts<br>
   ...
   *
   * <p><strong>Should</strong> create a new concept attribute type<br>
   ...
   *
   * <p><strong>Should</strong> completely remove a concept attribute type
   *
   * @param conceptAttributeType
   * @since 2.0
   */
   ...
   * results
   *
   * <p><strong>Should</strong> return concept attribute types performing fuzzy match on given name
   * <br>
   ...
   *
   * <p><strong>Should</strong> return the concept attribute type with the exact specified name<br>
   * <strong>Should</strong> return null if no concept attribute type exists with the exact
   * specified name
   *
   * @param exactName
   ...
   *
   * <p><strong>Should</strong> retire concept type attribute
   *
   ...
   *
   * <p><strong>Should</strong> unretire a concept attribute type
   *
   ...
   *
   * <p><strong>Should</strong> create a new concept reference range<br>
   ...
   *
   * <p><strong>Should</strong> get a list of conceptReferenceRanges with the given conceptId<br>
   ...
   *
   * <p><strong>Should</strong> get a conceptReferenceRange if found<br>
