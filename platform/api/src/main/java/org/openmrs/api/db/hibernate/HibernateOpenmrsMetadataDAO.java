 ...
 * @param <T>
 */
public class HibernateOpenmrsMetadataDAO<T extends BaseOpenmrsMetadata>
    extends HibernateOpenmrsObjectDAO<T> implements OpenmrsMetadataDAO<T> {
  ...
  /**
   * @see org.openmrs.api.db.OpenmrsMetadataDAO#getAll(boolean, java.lang.Integer,
   *     java.lang.Integer)
   */
  @Override
