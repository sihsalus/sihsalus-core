...
public interface LocationService extends OpenmrsService {
  ...
  /**
   * Set the data access object that the service will use to interact with the database. This is set
   * by spring in the applicationContext-service.xml file
   *
   * @param dao
   */
   ...
   *
   * <p><strong>Should</strong> throw APIException if location has no name<br>
   * <strong>Should</strong> overwrite transient tag if tag with same name exists<br>
   * <strong>Should</strong> throw APIException if transient tag is not found<br>
   ...
   *
   * <p><strong>Should</strong> return null when no location match given location id
   *
   ...
   *
   * <p><strong>Should</strong> return null when no location match given location name
   *
   ...
   *
   * <p><strong>Should</strong> return default location for the implementation<br>
   * <strong>Should</strong> return Unknown Location if the global property is something else that
   * doesnot exist
   *
   ...
   *
   * <p><strong>Should</strong> return all locations including retired
   *
   ...
   *
   * <p><strong>Should</strong> return all locations when includeRetired is true<br>
   ...
   * returned. An empty list will be returned if there are no locations. Search is case insensitive.
   * matching this <code>nameFragment</code>
   *
   * <p><strong>Should</strong> return empty list when no location match the name fragment
   *
  ...
  /**
   * Gets the locations matching the specified arguments. A null list will never be returned. An
   * empty list will be returned if there are no locations. Search is case insensitive. matching
   * this <code>nameFragment</code>. If start and length are not specified, then all matches are
   * returned.
   *
   * <p><strong>Should</strong> return empty list when no location has matching attribute values<br>
   ...
   *
   * <p><strong>Should</strong> get locations by tag<br>
   ...
   *
   * <p><strong>Should</strong> get locations having all tags<br>
   ...
   *
   * <p><strong>Should</strong> get locations having any tag<br>
   * <strong>Should</strong> return empty list when no location has the given tags<br>
   ...
   *
   * <p><strong>Should</strong> retire location successfully
   *
  ...
  /**
   * Unretire the given location. This restores a previously retired location back into circulation
   * and use.
   *
   * <p><strong>Should</strong> unretire retired location
   *
   * @param location
   ...
   *
   * <p><strong>Should</strong> delete location successfully
   *
   ...
   *
   * <p><strong>Should</strong> throw APIException if tag has no name<br>
   * <strong>Should</strong> return saved object<br>
   * <strong>Should</strong> update location tag successfully<br>
   * <strong>Should</strong> create location tag successfully<br>
   ...
   *
   * <p><strong>Should</strong> return null when no location tag match given id
   *
  ...
  /**
   * Returns a location tag given the location's exact name (tag). A null value is returned if there
   * is no tag with this name.
   *
   * <p><strong>Should</strong> get location tag by name<br>
   ...
   *
   * <p><strong>Should</strong> return all location tags including retired
   *
   ...
   *
   * <p><strong>Should</strong> return all location tags if includeRetired is true<br>
   ...
   *
   * <p><strong>Should</strong> return empty list when no location tag match given search string
   *
   ...
   *
   * <p><strong>Should</strong> retire location tag successfully<br>
   ...
   * and use.
   *
   * <p><strong>Should</strong> unretire retired location tag
   *
   * @param tag
   ...
   *
   * <p><strong>Should</strong> delete location tag
   *
   ...
   * retired ones.
   *
   * <p><strong>Should</strong> return all root locations when includeRetired is true<br>
   ...
   *
   * <p><strong>Should</strong> return empty list if no possible address matches<br>
   * <strong>Should</strong> return null if method not implemented<br>
   ...
   * @since 1.7.2
   */
  public List<String> getPossibleAddressValues(Address incomplete, String fieldName)
      throws APIException;
   ...
   *
   * <p><strong>Should</strong> throw APIException if the string is empty<br>
   * <strong>Should</strong> update default address template successfully<br>
  ...
  /**
   * <strong>Should</strong> return the location attribute type with the given id<br>
  ...
  /**
   * <strong>Should</strong> return the location attribute type with the given uuid<br>
   ...
   *
   * <p><strong>Should</strong> create a new location attribute type<br>
   ...
   *
   * <p><strong>Should</strong> retire a location attribute type
   *
   * @param locationAttributeType
   ...
   */
  @Authorized(PrivilegeConstants.MANAGE_LOCATION_ATTRIBUTE_TYPES)
  LocationAttributeType retireLocationAttributeType(
      LocationAttributeType locationAttributeType, String reason);

  /**
   * Restores a location attribute type that was previous retired in the database
   *
   * <p><strong>Should</strong> unretire a retired location attribute type
   *
   * @param locationAttributeType
   ...
   *
   * <p><strong>Should</strong> completely remove a location attribute type
   *
   * @param locationAttributeType
   * @since 1.9
   */
  ...
  /**
   * <strong>Should</strong> get the location attribute with the given uuid<br>
   ...
   *
   * <p><strong>Should</strong> return the location attribute type with the specified name<br>
   * <strong>Should</strong> return null if no location attribute type exists with the specified
   * name
   *
