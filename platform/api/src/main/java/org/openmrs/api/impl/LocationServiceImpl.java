...
public class LocationServiceImpl extends BaseOpenmrsService implements LocationService, RefByUuid {
  ...
  public Location saveLocation(Location location) throws APIException {
    ...
    // Check for transient tags. If found, try to match by name and overwrite, otherwise throw
    // exception.
  ...
  private Location getDefaultLocationFromSting(
      Location location, String locationGP, String defaultLocation) {
    Location result = null;
    if (location == null
        && (!StringUtils.hasText(locationGP) || !defaultLocation.equalsIgnoreCase(locationGP))) {
  ...
  public List<Location> getLocationsHavingAllTags(List<LocationTag> tags) throws APIException {
    return CollectionUtils.isEmpty(tags)
        ...
        : dao.getLocationsHavingAllTags(tags);
  }
  ...
  public List<Location> getLocations(
    ...
    Map<LocationAttributeType, String> serializedAttributeValues =
        CustomDatatypeUtil.getValueReferences(attributeValues);

    return dao.getLocations(
        nameFragment, parent, serializedAttributeValues, includeRetired, start, length);
  }
  ...
  /**
   * @see
   *     org.openmrs.api.LocationService#saveLocationAttributeType(org.openmrs.LocationAttributeType)
   */
  @Override
  public LocationAttributeType saveLocationAttributeType(
  ...
  /**
   * @see
   *     org.openmrs.api.LocationService#retireLocationAttributeType(org.openmrs.LocationAttributeType,
   *     java.lang.String)
   */
  @Override
  public LocationAttributeType retireLocationAttributeType(
  ...
  /**
   * @see
   *     org.openmrs.api.LocationService#unretireLocationAttributeType(org.openmrs.LocationAttributeType)
   */
  @Override
  public LocationAttributeType unretireLocationAttributeType(
      LocationAttributeType locationAttributeType) {
  ...
  /**
   * @see
   *     org.openmrs.api.LocationService#purgeLocationAttributeType(org.openmrs.LocationAttributeType)
   */
  @Override
  ...
  public List<Class<?>> getRefTypes() {
    return Arrays.asList(
        LocationAttributeType.class, LocationTag.class, LocationAttribute.class, Location.class);
  }
}
