...
public @interface Logging {
  ...
  /**
   * This list should set the argument indexes that should not be printed. This is useful if one of
   * the arguments/parameters is more sensitive than others. Note: This parameter does not need
