...
/**
 * A custom Jackson module that enables UUID-based serialization and deserialization of {@link
 * OpenmrsObject} references.
 *
 * <p>During serialization, fields referencing {@code OpenmrsObject}s are serialized as their UUIDs
 * rather than as full nested objects. During deserialization, UUID strings are resolved back to
 * full {@code OpenmrsObject} instances using the {@link DomainService}. This approach helps to:
 *
 * <ul>
 *   <li>Reduce object size by avoiding full object nesting
 *   <li>Enable reference-based object graph resolution
 *   <li>Support lazy loading of related entities based on UUIDs
 * </ul>
 *
 * @since 3.0.0
 */
public class UuidReferenceModule extends SimpleModule {
  ...
  /**
   * Sets up custom serializer and deserializer modifiers to intercept and override Jackson's
   * default behavior for properties referencing {@link OpenmrsObject}s.
   *
        ...
        new BeanSerializerModifier() {
          ...
          public List<BeanPropertyWriter> changeProperties(
            ...
            for (int i = 0; i < beanProperties.size(); i++) {
              ...
              beanProperties.set(
                  i,
                  new BeanPropertyWriter(original) {

                    @Override
                    public void serializeAsField(
                        Object bean, JsonGenerator gen, SerializerProvider prov) throws Exception {
          ...
          public BeanDeserializerBuilder updateBuilder(
            ...
            while (properties.hasNext()) {
              ...
              if (OpenmrsObject.class.isAssignableFrom(rawType)) {
                JsonDeserializer<?> uuidDeserializer =
