...
public class OrderValidator implements Validator {
   ...
   *
   * <p><strong>Should</strong> fail validation if order is null<br>
  ...
  private void validateScheduledDate(Order order, Errors errors) {
    boolean isUrgencyOnScheduledDate =
        (order.getUrgency() != null && order.getUrgency().equals(Order.Urgency.ON_SCHEDULED_DATE));
  ...
  private void validateOrderGroupEncounter(Order order, Errors errors) {
    if (order.getOrderGroup() != null
        && !(order.getEncounter().equals(order.getOrderGroup().getEncounter()))) {
  ...
  private void validateOrderGroupPatient(Order order, Errors errors) {
    if (order.getOrderGroup() != null
        && !(order.getPatient().equals(order.getOrderGroup().getPatient()))) {
