...
public class EncounterRoleValidator extends RequireNameValidator {
  ...
  public void validate(Object obj, Errors errors) {
    ...
    if (!errors.hasErrors()) {
      EncounterRole duplicate =
          Context.getEncounterService().getEncounterRoleByName(encounterRole.getName().trim());
      if (duplicate != null
          && duplicate.getUuid() != null
