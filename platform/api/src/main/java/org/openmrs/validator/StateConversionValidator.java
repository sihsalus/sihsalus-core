 ...
 */
@Handler(
    supports = {ConceptStateConversion.class},
    order = 50)
public class StateConversionValidator implements Validator {
   ...
   *
   * <p><strong>Should</strong> fail validation if concept is null or empty or whitespace<br>
  ...
  public void validate(Object obj, Errors errors) {
    ...
    if (c == null) {
      ...
      ValidationUtils.rejectIfEmptyOrWhitespace(
          errors, "programWorkflowState", "error.programWorkflowState");
    }
  }
}
