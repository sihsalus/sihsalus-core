...
public class ServiceOrderValidator extends OrderValidator implements Validator {
   ...
   *
   * <p><strong>Should</strong> fail validation if the specimen source is invalid<br>
    ...
    if (order == null) {
      ...
      if (order.getSpecimenSource() != null) {
        ...
        if (!specimenSources.contains(order.getSpecimenSource())) {
          errors.rejectValue(
              "specimenSource", "ServiceOrder.error.specimenSourceNotAmongAllowedConcepts");
        }
      }
    }
  }
