...
public final class OpenmrsConstants {
  ...
  public static String KEY_OPENMRS_APPLICATION_DATA_DIRECTORY =
  ...
  /**
   * hack alert: During an ant build, the openmrs api jar manifest file is loaded with these values.
   * When constructing the OpenmrsConstants class file, the api jar is read and the values are
   * copied in as constants
   */
  ...
  public static final String OPENMRS_VERSION =
      THIS_PACKAGE.getSpecificationVendor() != null
          ? THIS_PACKAGE.getSpecificationVendor()
          : (getBuildVersion() != null ? getBuildVersion() : getVersion());
  ...
  public static final String OPENMRS_VERSION_SHORT =
      THIS_PACKAGE.getSpecificationVersion() != null
          ? THIS_PACKAGE.getSpecificationVersion()
          : (getBuildVersionShort() != null ? getBuildVersionShort() : getVersion());
  ...
  public static String getOpenmrsProperty(String property) {
    InputStream file =
        OpenmrsConstants.class
            .getClassLoader()
            .getResourceAsStream("org/openmrs/api/openmrs.properties");
    if (file == null) {
  ...
  public static final String REGEX_LARGE =
      "[!\"#\\$%&'\\(\\)\\*,+-\\./:;<=>\\?@\\[\\\\\\\\\\]^_`{\\|}~]";

  public static final String REGEX_SMALL =
      "[!\"#\\$%&'\\(\\)\\*,\\./:;<=>\\?@\\[\\\\\\\\\\]^_`{\\|}~]";

  public static final Integer CIVIL_STATUS_CONCEPT_ID = 1054;

  /**
   * The directory which OpenMRS should attempt to use as its application data directory in case the
   * current users home dir is not writeable (e.g. when using application servers like tomcat to
   * deploy OpenMRS).
   *
   ...
   */
  public static final String APPLICATION_DATA_DIRECTORY_RUNTIME_PROPERTY =
      "application_data_directory";

  /**
   * The name of the runtime property that a user can set that will specify whether the database is
   * automatically updated on startup
   */
  ...
  public static final String GLOBAL_PROPERTY_DRUG_FREQUENCIES =
      "dashboard.regimen.displayFrequencies";

  public static final String GLOBAL_PROPERTY_CONCEPTS_LOCKED = "concepts.locked";

  public static final String GLOBAL_PROPERTY_PATIENT_LISTING_ATTRIBUTES =
      "patient.listingAttributeTypes";

  public static final String GLOBAL_PROPERTY_PATIENT_VIEWING_ATTRIBUTES =
      "patient.viewingAttributeTypes";

  public static final String GLOBAL_PROPERTY_PATIENT_HEADER_ATTRIBUTES =
  ...
  public static final String GLOBAL_PROPERTY_USER_REQUIRE_EMAIL_AS_USERNAME =
  ...
  public static final String[] GLOBAL_PROPERTIES_OF_PERSON_ATTRIBUTES = {
    ...
    GLOBAL_PROPERTY_USER_REQUIRE_EMAIL_AS_USERNAME
  };
  ...
  public static final String GLOBAL_PROPERTY_PATIENT_IDENTIFIER_SEARCH_PATTERN =
  ...
  public static final String GLOBAL_PROPERTY_PERSON_ATTRIBUTE_SEARCH_MATCH_MODE =
  ...
  public static final String GLOBAL_PROPERTY_GZIP_ACCEPT_COMPRESSED_REQUESTS_FOR_PATHS =
      "gzip.acceptCompressedRequestsForPaths";

  public static final String GLOBAL_PROPERTY_MEDICAL_RECORD_OBSERVATIONS =
  ...
  public static final String GLOBAL_PROPERTY_ALLOW_OVERLAPPING_VISITS =
      "visits.allowOverlappingVisits";

  public static final String GLOBAL_PROPERTY_DEFAULT_PATIENT_IDENTIFIER_VALIDATOR =
      "patient.defaultPatientIdentifierValidator";

  public static final String GLOBAL_PROPERTY_PATIENT_IDENTIFIER_IMPORTANT_TYPES =
      "patient_identifier.importantTypes";

  public static final String GLOBAL_PROPERTY_ENCOUNTER_FORM_OBS_SORT_ORDER =
  ...
  public static final String GLOBAL_PROPERTY_NEWPATIENTFORM_SHOW_RELATIONSHIPS =
      "new_patient_form.showRelationships";

  public static final String GLOBAL_PROPERTY_NEWPATIENTFORM_RELATIONSHIPS =
  ...
  public static final String GLOBAL_PROPERTY_PATIENT_IDENTIFIER_SEARCH_MATCH_MODE =
  ...
  public static final String GLOBAL_PROPERTY_PROVIDER_SEARCH_MATCH_MODE =
  ...
  public static final String GLOBAL_PROPERTY_ENCOUNTER_TYPES_LOCKED =
      "EncounterType.encounterTypes.locked";

  public static final String GLOBAL_PROPERTY_FORMS_LOCKED = "forms.locked";

  public static final String GLOBAL_PROPERTY_PERSON_ATRIBUTE_TYPES_LOCKED =
      "personAttributeTypes.locked";

  public static final String GLOBAL_PROPERTY_PATIENT_IDENTIFIER_TYPES_LOCKED =
      "patientIdentifierTypes.locked";

  public static final String GLOBAL_PROPERTY_DRUG_ORDER_REQUIRE_DRUG = "drugOrder.requireDrug";

  public static final String GLOBAL_PROPERTY_DRUG_ORDER_REQUIRE_OUTPATIENT_QUANTITY =
      "drugOrder.requireOutpatientQuantity";
   ...
   */
  public static final String GP_PASSWORD_REQUIRES_UPPER_AND_LOWER_CASE =
  ...
  /**
   * Global property name that allows specification of whether user passwords can match username or
   * system id. Allowable values are "true", "false", and null
   */
  public static final String GP_PASSWORD_CANNOT_MATCH_USERNAME_OR_SYSTEMID =
      "security.passwordCannotMatchUsername";

  /**
   * Global property name that allows specification of whether user passwords have a minimum length
   * requirement Allowable values are any integer
   */
  ...
  public static final String GP_ENABLE_CONCEPT_MAP_TYPE_MANAGEMENT =
  ...
  public static final String GP_ENCOUNTER_TYPE_TO_VISIT_TYPE_MAPPING =
   ...
   */
  public static final String GP_DASHBOARD_PROVIDER_DISPLAY_ENCOUNTER_ROLES =
   ...
   */
  public static final String GP_DASHBOARD_MAX_NUMBER_OF_ENCOUNTERS_TO_SHOW =
      "dashboard.encounters.maximumNumberToShow";

  /** Global property name to display program, workflow and states in a specific case */
  public static final String GP_DASHBOARD_METADATA_CASE_CONVERSION =
      "dashboard.metadata.caseConversion";

  /**
   * Global property name for the default ConceptMapType which is set automatically when no other is
   * set manually.
   */
   ...
   */
  public static final String GP_CONCEPT_DRUG_DOSAGE_FORM_CONCEPT_CLASSES =
   ...
   * management form.
   */
  public static final String GP_CONCEPT_DRUG_ROUTE_CONCEPT_CLASSES =
   ...
   * management form.
   */
  public static final String GP_ALLERGY_ALLERGEN_CONCEPT_CLASSES =
   ...
   * management form.
   */
  public static final String GP_ALLERGY_REACTION_CONCEPT_CLASSES =
      "allergy.reaction.ConceptClasses";

  /**
   * Global property name of other non coded allergen, stored in allergen coded allergen when other
   * non coded allergen is represented
   */
  ...
  public static final String GP_ALLOWED_FAILED_LOGINS_BEFORE_LOCKOUT =
   ...
   */
  public static final String GP_CASE_SENSITIVE_DATABASE_STRING_COMPARISON =
   ...
   * @since 2.7.8, 2.8.2
   */
  public static final String GP_ALLOW_SETTING_STOP_DATE_ON_INACTIVE_ORDERS =
      "order.allowSettingStopDateOnInactiveOrders";
  ...
  public static final String GP_DRUG_DISPENSING_UNITS_CONCEPT_UUID =
  ...
  public static final String GP_TEST_SPECIMEN_SOURCES_CONCEPT_UUID =
   ...
   */
  @Deprecated public static final String GP_HOST_URL = "host.url";
  ...
  public static final List<GlobalProperty> CORE_GLOBAL_PROPERTIES() {
    ...
    props.add(
        new GlobalProperty(
            ...
            "false",
            "Indicates whether or not the 'health center' attribute is shown when viewing/searching"
                + " for patients",
    ...
    props.add(
        new GlobalProperty(
            GLOBAL_PROPERTY_NEWPATIENTFORM_SHOW_RELATIONSHIPS,
            "false",
            "true/false whether or not to show the relationship editor on the addPatient.htm"
                + " screen",
            BooleanDatatype.class,
            null));
    ...
    props.add(
        new GlobalProperty(
            ...
            "smart",
            "true/false/smart on how to show the pages on the 'View Encounter' window.  'smart'"
                + " means that if > 50% of the fields have page numbers defined, show data in"
                + " pages"));
    props.add(
        new GlobalProperty(
    ...
    props.add(
        new GlobalProperty(
            ...
            "",
            "List of programs to show Enrollment details of in the patient header. (Should be an"
                + " ordered comma-separated list of program_ids or names.)"));
    props.add(
        new GlobalProperty(
            "dashboard.header.workflows_to_show",
            "",
            "List of programs to show Enrollment details of in the patient header. List of"
                + " workflows to show current status of in the patient header. These will only be"
                + " displayed if they belong to a program listed above. (Should be a"
                + " comma-separated list of program_workflow_ids.)"));
    props.add(
        new GlobalProperty(
    ...
    props.add(
        new GlobalProperty(
            ...
            "false",
            "true/false whether or not to show a Enter Form button on the encounters tab of the"
                + " patient dashboard",
            BooleanDatatype.class,
            null));
    props.add(
        new GlobalProperty(
            ...
            "Drug sets that appear on the Patient Dashboard Regimen tab. Comma separated list of"
                + " name of concepts that are defined as drug sets."));

    props.add(
        new GlobalProperty(
            GLOBAL_PROPERTY_DRUG_FREQUENCIES,
            "7 days/week,6 days/week,5 days/week,4 days/week,3 days/week,2 days/week,1 days/week",
            "Frequency of a drug order that appear on the Patient Dashboard. Comma separated list"
                + " of name of concepts that are defined as drug frequencies."));
    ...
    props.add(
        new GlobalProperty(
            GP_PASSWORD_RESET_URL,
            "",
            "The URL to redirect to after requesting for a password reset. Always provide a place"
                + " holder in this url with name {activationKey}, it will get substituted by the"
    ...
    props.add(
        new GlobalProperty(
            "mail.from", "info@openmrs.org", "Email address to use as the default from address"));
    props.add(
        new GlobalProperty(
            "mail.debug",
            "false",
    ...
    props.add(
        new GlobalProperty(
            "mail.smtp_auth", "false", "true/false whether the smtp host requires authentication"));
    props.add(
        new GlobalProperty(
            "mail.user", "test", "Username of the SMTP user (if smtp_auth is enabled)"));
    props.add(
        new GlobalProperty(
            "mail.password", "test", "Password for the SMTP user (if smtp_auth is enabled)"));
    props.add(
        new GlobalProperty(
    ...
    props.add(
        new GlobalProperty(
            GLOBAL_PROPERTY_ADDRESS_TEMPLATE,
    ...
    props.add(
        new GlobalProperty(
            ...
            "false",
            "if true, do not allow editing concepts",
            BooleanDatatype.class,
            null));
    ...
    props.add(
        new GlobalProperty(
            GLOBAL_PROPERTY_PATIENT_LISTING_ATTRIBUTES,
            "",
            "A comma delimited list of PersonAttributeType names that should be displayed for"
                + " patients in _lists_"));
    props.add(
        new GlobalProperty(
            GLOBAL_PROPERTY_PATIENT_VIEWING_ATTRIBUTES,
            "",
            "A comma delimited list of PersonAttributeType names that should be displayed for"
                + " patients when _viewing individually_"));
    props.add(
        new GlobalProperty(
            GLOBAL_PROPERTY_PATIENT_HEADER_ATTRIBUTES,
            "",
            "A comma delimited list of PersonAttributeType names that will be shown on the patient"
                + " dashboard"));
    ...
    props.add(
        new GlobalProperty(
            GLOBAL_PROPERTY_USER_LISTING_ATTRIBUTES,
            "",
            "A comma delimited list of PersonAttributeType names that should be displayed for users"
                + " in _lists_"));
    props.add(
        new GlobalProperty(
            GLOBAL_PROPERTY_USER_VIEWING_ATTRIBUTES,
            "",
            "A comma delimited list of PersonAttributeType names that should be displayed for users"
                + " when _viewing individually_"));
    props.add(
        new GlobalProperty(
            GLOBAL_PROPERTY_USER_HEADER_ATTRIBUTES,
            "",
            "A comma delimited list of PersonAttributeType names that will be shown on the user"
                + " dashboard. (not used in v1.5)"));

    props.add(
        new GlobalProperty(
            GLOBAL_PROPERTY_PATIENT_IDENTIFIER_REGEX,
            "",
            "WARNING: Using this search property can cause a drop in mysql performance with large"
                + " patient sets.  A MySQL regular expression for the patient identifier search"
                + " strings.  The @SEARCH@ string is replaced at runtime with the user's search"
                + " string.  An empty regex will cause a simply 'like' sql search to be used."
                + " Example: ^0*@SEARCH@([A-Z]+-[0-9])?$"));
    props.add(
        new GlobalProperty(
            ...
            "This property is only used if "
                + GLOBAL_PROPERTY_PATIENT_IDENTIFIER_REGEX
                + " is empty.  The string here is prepended to the sql indentifier search string. "
                + " The sql becomes \"... where identifier like '<PREFIX><QUERY"
                + " STRING><SUFFIX>';\".  Typically this value is either a percent sign (%) or"
                + " empty."));
    props.add(
        new GlobalProperty(
    ...
    props.add(
        new GlobalProperty(
            ...
            "",
            "If this is empty, the regex or suffix/prefix search is used.  Comma separated list of"
                + " identifiers to check.  Allows for faster searching of multiple options rather"
                + " than the slow regex. e.g."
                + " @SEARCH@,0@SEARCH@,@SEARCH-1@-@CHECKDIGIT@,0@SEARCH-1@-@CHECKDIGIT@ would turn"
                + " a request for \"4127\" into a search for \"in"
                + " ('4127','04127','412-7','0412-7')\""));

    props.add(
        new GlobalProperty(
            GLOBAL_PROPERTY_PATIENT_NAME_REGEX,
            "",
            "Names of the patients must pass this regex. Eg : ^[a-zA-Z \\-]+$ contains only english"
                + " alphabet letters, spaces, and hyphens. A value of .* or the empty string means"
                + " no validation is done."));

    props.add(
        new GlobalProperty(
            GLOBAL_PROPERTY_PERSON_SEARCH_MAX_RESULTS,
            String.valueOf(GLOBAL_PROPERTY_PERSON_SEARCH_MAX_RESULTS_DEFAULT_VALUE),
    ...
    props.add(
        new GlobalProperty(
            ...
            "false",
            "Set to 'true' to turn on OpenMRS's gzip filter, and have the webapp compress data"
                + " before sending it to any client that supports it. Generally use this if you are"
                + " running Tomcat standalone. If you are running Tomcat behind Apache, then you'd"
                + " want to use Apache to do gzip compression.",
            BooleanDatatype.class,
            null));
    ...
    props.add(
        new GlobalProperty(
            ...
            "Logging levels for log4j2.xml. Valid format is class:level,class:level. If class not"
                + " specified, 'org.openmrs.api' presumed. Valid levels are trace, debug, info,"
                + " warn, error or fatal"));
    ...
    props.add(
        new GlobalProperty(
            GP_LOG_LOCATION,
            "",
            "A directory where the OpenMRS log file appender is stored. The log file name is"
                + " 'openmrs.log'."));
    ...
    props.add(
        new GlobalProperty(
            ...
            "This property sets the default patient identifier validator.  The default validator is"
                + " only used in a handful of (mostly legacy) instances.  For example, it's used to"
                + " generate the isValidCheckDigit calculated column and to append the string"
                + " \"(default)\" to the name of the default validator on the"
                + " editPatientIdentifierType form."));

    props.add(
        new GlobalProperty(
            GLOBAL_PROPERTY_PATIENT_IDENTIFIER_IMPORTANT_TYPES,
            "",
            "A comma delimited list of PatientIdentifier names : PatientIdentifier locations that"
                + " will be displayed on the patient dashboard.  E.g.: TRACnet"
                + " ID:Rwanda,ELDID:Kenya"));
    ...
    props.add(
        new GlobalProperty(
            ...
            "number",
            "The sort order for the obs listed on the encounter edit form.  'number' sorts on the"
                + " associated numbering from the form schema.  'weight' sorts on the order"
                + " displayed in the form schema."));

    props.add(
        new GlobalProperty(
            GLOBAL_PROPERTY_LOCALE_ALLOWED_LIST,
            "en, en_GB, es, fr, it, pt",
    ...
    props.add(
        new GlobalProperty(
            ...
            "",
            "Comma separated list of the RelationshipTypes to show on the new/short patient form. "
                + " The list is defined like '3a, 4b, 7a'.  The number is the RelationshipTypeId"
                + " and the 'a' vs 'b' part is which side of the relationship is filled in by the"
                + " user."));
    ...
    props.add(
        new GlobalProperty(
            ...
            "Specifies the default locale. You can specify both the language code(ISO-639) and the"
                + " country code(ISO-3166), e.g. 'en_GB' or just country: e.g. 'en'"));

    props.add(
        new GlobalProperty(
            OpenmrsConstants.GLOBAL_PROPERTY_DEFAULT_WEEK_START_DAY,
            OpenmrsConstants.GLOBAL_PROPERTY_DEFAULT_WEEK_START_DAY_DEFAULT_VALUE,
            "First day of the week in the date picker. Domingo/Dimanche/Sunday:0 "
                + " Lunes/Lundi/Monday:1"));
    ...
    props.add(
        new GlobalProperty(
            GP_PASSWORD_RESET_VALIDTIME,
            "600000",
            " Specifies the duration of time in seconds for which a password reset token is valid,"
                + " the default value is 10 minutes and the allowed values range from 1 minute to"
                + " 12hrs"));
    ...
    props.add(
        new GlobalProperty(
            ...
            "false",
            "If true, hl7 messages for patients that are not found and are non-local will silently"
                + " be dropped/ignored",
            BooleanDatatype.class,
            null));
    ...
    props.add(
        new GlobalProperty(
            ...
            "false",
            "Whether or not to display the patient name in the patient dashboard title. Note that"
                + " enabling this could be security risk if multiple users operate on the same"
                + " computer.",
            BooleanDatatype.class,
            null));
    ...
    props.add(
        new GlobalProperty(
            ...
            "",
            "Default theme for users.  OpenMRS ships with themes of 'green', 'orange', 'purple',"
                + " and 'legacy'"));

    props.add(
        new GlobalProperty(
            GLOBAL_PROPERTY_HL7_ARCHIVE_DIRECTORY,
            HL7Constants.HL7_ARCHIVE_DIRECTORY_NAME,
            "The default name or absolute path for the folder where to write the"
                + " hl7_in_archives."));
    ...
    props.add(
        new GlobalProperty(
            ...
            "false",
            "Specifies whether the search widgets should make ajax requests in serial or parallel"
                + " order, a value of true is appropriate for implementations running on a slow"
    ...
    props.add(
        new GlobalProperty(
            ...
            "300",
            "Specifies time interval in milliseconds when searching, between keyboard keyup event"
                + " and triggering the search off, should be higher if most users are slow when"
                + " typing so as to minimise the load on the server"));

    props.add(
        new GlobalProperty(
            GP_SEARCH_DATE_DISPLAY_FORMAT,
            null,
            "Date display format to be used to display the date somewhere in the UI i.e the search"
                + " widgets and autocompletes"));

    props.add(
        new GlobalProperty(
            GLOBAL_PROPERTY_DEFAULT_LOCATION_NAME,
            "Unknown Location",
    ...
    props.add(
        new GlobalProperty(
            ...
            "Specifies how patient identifiers are matched while searching for a patient. Valid"
                + " values are 'EXACT, 'ANYWHERE' or 'START'. Defaults to 'EXACT' if missing or"
    ...
    props.add(
        new GlobalProperty(
            ...
            "Specifies how patient names are matched while searching patient. Valid values are"
                + " 'ANYWHERE' or 'START'. Defaults to start if missing or invalid value is"
                + " present."));

    props.add(
        new GlobalProperty(
            GP_ENABLE_CONCEPT_MAP_TYPE_MANAGEMENT,
            "false",
    ...
    props.add(
        new GlobalProperty(
            ...
            "true",
            "Set to true to enable the Visits feature. This will replace the 'Encounters' tab with"
                + " a 'Visits' tab on the dashboard.",
            BooleanDatatype.class,
            null));
    ...
    props.add(
        new GlobalProperty(
            ...
            ExistingVisitAssignmentHandler.class.getName(),
    ...
    props.add(
        new GlobalProperty(
            ...
            "OpenMRS",
            "The name of this application, as presented to the user, for example on the login and"
                + " welcome pages."));
    ...
    props.add(
        new GlobalProperty(
            ...
            "",
            "Specifies how encounter types are mapped to visit types when automatically assigning"
                + " encounters to visits. e.g 1:1, 2:1, 3:2 in the format"
                + " encounterTypeId:visitTypeId or encounterTypeUuid:visitTypeUuid or a combination"
                + " of encounter/visit type uuids and ids e.g"
                + " 1:759799ab-c9a5-435e-b671-77773ada74e4"));
    ...
    props.add(
        new GlobalProperty(
            ...
            "",
            "A comma-separated list of encounter roles (by name or id). Providers with these roles"
                + " in an encounter will be displayed on the encounter tab of the patient"
                + " dashboard."));

    props.add(
        new GlobalProperty(
            GP_SEARCH_WIDGET_MAXIMUM_RESULTS,
            "2000",
            "Specifies the maximum number of results to return from a single search in the search"
                + " widgets"));
    ...
    props.add(
        new GlobalProperty(
            ...
            "3",
            "An integer which, if specified, would determine the maximum number of encounters to"
                + " display on the encounter tab of the patient dashboard."));

    props.add(
        new GlobalProperty(
            GP_VISIT_TYPES_TO_AUTO_CLOSE,
            "",
            "comma-separated list of the visit type(s) to automatically close"));

    props.add(
        new GlobalProperty(
            GP_ALLOWED_FAILED_LOGINS_BEFORE_LOCKOUT,
            "7",
    ...
    props.add(
        new GlobalProperty(
            ...
            "5",
            "Waiting time for account to get automatically unlocked after getting locked due to"
                + " multiple invalid login tries"));

    props.add(
        new GlobalProperty(
            GP_DEFAULT_CONCEPT_MAP_TYPE,
            "NARROWER-THAN",
            "Default concept map type which is used when no other is set"));

    props.add(
        new GlobalProperty(
            GP_CONCEPT_DRUG_DOSAGE_FORM_CONCEPT_CLASSES,
            "",
            "A comma-separated list of the allowed concept classes for the dosage form field of the"
                + " concept drug management form."));

    props.add(
        new GlobalProperty(
            GP_CONCEPT_DRUG_ROUTE_CONCEPT_CLASSES,
            "",
            "A comma-separated list of the allowed concept classes for the route field of the"
                + " concept drug management form."));
    ...
    props.add(
        new GlobalProperty(
            ...
            "false",
            "Indicates whether database string comparison is case sensitive or not. Setting this to"
                + " false for MySQL with a case insensitive collation improves search"
                + " performance."));
    props.add(
        new GlobalProperty(
            GP_DASHBOARD_METADATA_CASE_CONVERSION,
            "",
            "Indicates which type automatic case conversion is applied to program/workflow/state in"
                + " the patient dashboard. Valid values: lowercase, uppercase, capitalize. If empty"
                + " no conversion is applied."));

    props.add(
        new GlobalProperty(
            GP_ALLERGY_ALLERGEN_CONCEPT_CLASSES,
            "Drug,MedSet",
            "A comma-separated list of the allowed concept classes for the allergen field of the"
                + " allergy dialog"));

    props.add(
        new GlobalProperty(
            GP_ALLERGY_REACTION_CONCEPT_CLASSES,
            "Symptom",
            "A comma-separated list of the allowed concept classes for the reaction field of the"
                + " allergy dialog"));
    ...
    props.add(
        new GlobalProperty(
            GLOBAL_PROPERTY_FORMS_LOCKED,
            "false",
            "Set to a value of true if you do not want any changes to be made on forms, else set to"
                + " false."));

    props.add(
        new GlobalProperty(
            GLOBAL_PROPERTY_DRUG_ORDER_REQUIRE_DRUG,
            "false",
            "Set to value true if you need to specify a formulation(Drug) when creating a drug"
                + " order."));

    props.add(
        new GlobalProperty(
            GLOBAL_PROPERTY_DRUG_ORDER_REQUIRE_OUTPATIENT_QUANTITY,
            "true",
            "true/false whether to require quantity, quantityUnits, and numRefills for outpatient"
                + " drug orders"));

    props.add(
        new GlobalProperty(
            GLOBAL_PROPERTY_PERSON_ATRIBUTE_TYPES_LOCKED,
            "false",
            "Set to a value of true if you do not want allow editing person attribute types, else"
                + " set to false."));

    props.add(
        new GlobalProperty(
            GLOBAL_PROPERTY_PATIENT_IDENTIFIER_TYPES_LOCKED,
            "false",
            "Set to a value of true if you do not want allow editing patient identifier types, else"
                + " set to false."));

    props.add(
        new GlobalProperty(
            GP_NEXT_ORDER_NUMBER_SEED, "1", "The next order number available for assignment"));
    ...
    props.add(
        new GlobalProperty(
            GP_ALLOW_SETTING_ORDER_NUMBER,
            "false",
            "Specifies whether the order number property on an order can be set. If false, the"
                + " order number must be generated by an order number generator."));

    props.add(
        new GlobalProperty(
            GP_ALLOW_SETTING_STOP_DATE_ON_INACTIVE_ORDERS,
            "false",
            "Allow setting a stop date on an order that is already inactive. May be necessary when"
                + " importing orders from another system."));

    props.add(
        new GlobalProperty(
            GP_DRUG_ROUTES_CONCEPT_UUID,
            "",
            "Specifies the uuid of the concept set where its members represent the possible drug"
                + " routes"));

    props.add(
        new GlobalProperty(
            GP_DRUG_DOSING_UNITS_CONCEPT_UUID,
            "",
            "Specifies the uuid of the concept set where its members represent the possible drug"
                + " dosing units"));
    ...
    props.add(
        new GlobalProperty(
            GP_DRUG_DISPENSING_UNITS_CONCEPT_UUID,
            "",
            "Specifies the uuid of the concept set where its members represent the possible drug"
                + " dispensing units"));
    ...
    props.add(
        new GlobalProperty(
            GP_DURATION_UNITS_CONCEPT_UUID,
            "",
            "Specifies the uuid of the concept set where its members represent the possible"
                + " duration units"));

    props.add(
        new GlobalProperty(
            GP_TEST_SPECIMEN_SOURCES_CONCEPT_UUID,
            "",
            "Specifies the uuid of the concept set where its members represent the possible test"
                + " specimen sources"));

    props.add(
        new GlobalProperty(
            GP_UNKNOWN_PROVIDER_UUID, "", "Specifies the uuid of the Unknown Provider account"));

    props.add(
        new GlobalProperty(
            GLOBAL_PROPERTY_PROVIDER_SEARCH_MATCH_MODE,
            "EXACT",
            "Specifies how provider identifiers are matched while searching for providers. Valid"
                + " values are START,EXACT, END or ANYWHERE"));

    props.add(
        new GlobalProperty(
            GLOBAL_PROPERTY_PERSON_ATTRIBUTE_SEARCH_MATCH_MODE,
            GLOBAL_PROPERTY_PERSON_ATTRIBUTE_SEARCH_MATCH_EXACT,
            "Specifies how person attributes are matched while searching person. Valid values are"
                + " 'ANYWHERE' or 'EXACT'. Defaults to exact if missing or invalid value is"
                + " present."));
    ...
    props.add(
        new GlobalProperty(
            ...
            "false",
            "Disables validation of OpenMRS Objects. Only takes affect on next restart. Warning:"
                + " only do this is you know what you are doing!"));
    ...
    props.add(
        new GlobalProperty(
            GP_DRUG_ORDER_DRUG_OTHER,
            "",
            "Specifies the uuid of the concept which represents drug other non coded"));
    props.add(
        new GlobalProperty(
            GP_LOGIN_URL, LOGIN_URL, "Responsible for defining the Authentication URL "));
  ...
  public static final String USER_PROPERTY_NOTIFICATION_FORMAT =
      "notificationFormat"; // text/plain, text/html
   ...
   * locales within which the user is a proficient speaker. The list should be ordered from the most
   * to the least proficiency. Example: <code>proficientLocales = en_US, en_GB, en, fr_RW</code>
   */
  ...
  public static final String IMPLEMENTATION_ID_REMOTE_CONNECTION_URL =
      "https://implementation.openmrs.org";
  ...
  public static final boolean UNIX_BASED_OPERATING_SYSTEM =
      (OPERATING_SYSTEM.contains(OPERATING_SYSTEM_LINUX)
          || OPERATING_SYSTEM.contains(OPERATING_SYSTEM_SUNOS)
          || OPERATING_SYSTEM.contains(OPERATING_SYSTEM_FREEBSD)
          || OPERATING_SYSTEM.contains(OPERATING_SYSTEM_OSX));
  ...
  /**
   * Global property name that defines the default url responsible for authentication if user is not
   * logged in.
   *
   * @see #LOGIN_URL
   */
  ...
  // Liquibase Constants
  public static final String LIQUIBASE_DUPLICATE_FILE_MODE_DEFAULT =
      GlobalConfiguration.DuplicateFileMode.SILENT.name();
