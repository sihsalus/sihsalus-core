...
public class DoubleRange implements Comparable<DoubleRange> {
  ...
  /**
   * <strong>Should</strong> return correct value of high if it high was set previously<br>
  ...
  /**
   * <strong>Should</strong> set high to positive infinity on null parameter<br>
  ...
  /**
   * <strong>Should</strong> return correct value of low if low was set previously<br>
  ...
  /**
   * <strong>Should</strong> set low to negative infinity on null parameter<br>
   * <strong>Should</strong> cause low to have the set value
   *
   ...
   *
   * <p><strong>Should</strong> return plus 1 if this low is greater than other low<br>
   * <strong>Should</strong> return minus one if this low is lower than other low<br>
   * <strong>Should</strong> return plus one if both lows are equal but other high is greater than
   * this high<br>
   * <strong>Should</strong> return minus one if both lows are equal but other high is less than
   * this high<br>
   * <strong>Should</strong> return zero if both lows and both highs are equal<br>
   ...
   *
   * <p><strong>Should</strong> return true if parameter is in range<br>
  ...
  /**
   * <strong>Should</strong> print the range if high and low are not null and not infinite<br>
   * <strong>Should</strong> print empty high if high is infinite<br>
   * <strong>Should</strong> print empty low if low is infinite<br>
