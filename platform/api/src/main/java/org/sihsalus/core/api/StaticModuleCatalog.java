...
public final class StaticModuleCatalog {
  ...
  private static final List<SihsalusModuleDescriptor> MODULES =
      List.of(
          ...
          module(
              "patientflags", "patientflags-omod", "3.0.10", SihsalusModuleStatus.STATIC_INTERNAL),
          ...
          module("queue", "queue-omod", "3.0.0", SihsalusModuleStatus.STATIC_INTERNAL),
          module(
              "appointments",
              "appointments-omod",
          ...
          module(
              ...
              SihsalusModuleStatus.STATIC_INTERNAL),
          module(
              "bedmanagement", "bedmanagement-omod", "7.2.0", SihsalusModuleStatus.STATIC_INTERNAL),
          module("reporting", "reporting-omod", "2.1.0", SihsalusModuleStatus.STATIC_INTERNAL),
          module(
              "reportingrest", "reportingrest-omod", "2.0.0", SihsalusModuleStatus.STATIC_INTERNAL),
          module(
              "calculation",
              "calculation-api",
              "2.1.0-SNAPSHOT",
