...
public class RecurringAppointmentMapper {
  ...
  public List<RecurringAppointmentDefaultResponse> constructResponse(
      List<Appointment> appointments) {
    return appointments.stream().map(this::constructResponse).collect(Collectors.toList());
  }
  ...
  public RecurringAppointmentDefaultResponse constructResponse(Appointment appointment) {
    ...
    AppointmentDefaultResponse appointmentDefaultResponse =
        appointmentMapper.constructResponse(appointment);
