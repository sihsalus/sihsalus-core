...
public class AppointmentServiceAttribute
    extends BaseAttribute<AppointmentServiceAttributeType, AppointmentServiceDefinition>
    implements Attribute<AppointmentServiceAttributeType, AppointmentServiceDefinition> {
