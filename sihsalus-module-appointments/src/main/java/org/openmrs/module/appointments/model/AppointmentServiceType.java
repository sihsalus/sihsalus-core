...
public class AppointmentServiceType extends BaseOpenmrsData
    implements Serializable, Comparable<AppointmentServiceType> {
  ...
  public void setAppointmentServiceDefinition(
  ...
  public int compareTo(AppointmentServiceType o) {
    ...
    } else if (this.getAppointmentServiceDefinition()
            .getUuid()
            .compareTo(o.getAppointmentServiceDefinition().getUuid())
        != 0) {
      return this.getAppointmentServiceDefinition()
          .getUuid()
          .compareTo(o.getAppointmentServiceDefinition().getUuid());
    }
