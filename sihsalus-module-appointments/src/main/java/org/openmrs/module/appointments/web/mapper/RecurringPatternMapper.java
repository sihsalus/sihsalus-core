...
public class RecurringPatternMapper {
  ...
  public AppointmentRecurringPattern fromRequest(RecurringPattern recurringPattern) {
    ...
    if (appointmentRecurringPattern.getType() == WEEK) {
      appointmentRecurringPattern.setDaysOfWeek(
          recurringPattern.getDaysOfWeek().stream()
  ...
  public RecurringPattern mapToResponse(AppointmentRecurringPattern appointmentRecurringPattern) {
    ...
    List<String> daysOfWeek =
        appointmentRecurringPattern.getDaysOfWeek() != null
            ? Arrays.asList(appointmentRecurringPattern.getDaysOfWeek().split(","))
            : null;
    recurringPattern.setDaysOfWeek(daysOfWeek);
    return recurringPattern;
  }

  public AppointmentRecurringPattern cloneAppointmentRecurringPattern(
      AppointmentRecurringPattern recurringPattern) {
