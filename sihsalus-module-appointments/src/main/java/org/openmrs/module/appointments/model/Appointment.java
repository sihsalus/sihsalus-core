...
public class Appointment extends BaseOpenmrsData implements Serializable {
  ...
  /**
   * The date when the appointment was scheduled. This can be today or in the past (for
   * retrospective entry), but not in the future. This property is useful for documenting the visit
   * when the patient booked the appointment or when the patient called to book the appointment
   * NOTE: This is *not* the date the appointment is scheduled to take place. We use startDateTime
   * for this
   */
  ...
  @Independent private Set<Encounter> fulfillingEncounters;
  private Set<AppointmentReason> reasons;

  /**
   * This attribute is not a entity property. Just a placeholder for the clients to prepare response
  ...
  public void setAppointmentRecurringPattern(
