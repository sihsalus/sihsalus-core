...
public class EncounterSavedListener {
	...
	public static void onEncounterSaved(Encounter encounter) {
		...
		StaticModuleTaskRunner.runInBackground(null, () -> processEncounter(encounter.getEncounterId()));
	}
	...
	private static BundleBuilderService getBundleBuilderService() {
		try {
			return Context.getRegisteredComponent("sihsalusinterop.BundleBuilderService", BundleBuilderService.class);
		}
		catch (Exception e) {
