...
public class ManagePatientFlagsProperties {
  ...
  public ModelAndView showForm(ModelMap model) {
    ...
    PatientFlagsProperties properties =
        Context.getService(FlagService.class).getPatientFlagsProperties();
  ...
  public ModelAndView processSubmit(
      @ModelAttribute("properties") PatientFlagsProperties properties,
