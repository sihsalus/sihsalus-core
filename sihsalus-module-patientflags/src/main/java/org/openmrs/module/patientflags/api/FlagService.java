...
public interface FlagService extends OpenmrsService {
  ...
  /**
   * Generates a list of Flags that are triggers for the specified Patient, filtered by Flags Tagged
   ...
   * for a specified location and role
   *
   * <p>(This method is identical to generateFlagsForPatient(Patient,Set<Role>,DisplayPoint) except
   * that it takes a display point name as a string, instead of an actual DisplayPoint object)
   *
   * @param patient the patient to test
   * @param roles to filter tagged flags by
   ...
   */
  @Authorized(
      value = {"Manage Flags", "Manage Global Properties"},
      requireAll = true)
  ...
  /**
   * Gets a list of Flags that are triggers for the specified Patient, filtered by Flags Tagged for
   * a specified location and role
   *
   * @param patient the patient to test
   * @param roles to filter tagged flags by
   * @param displayPoint displayPoint to filter tagged flags by
   ...
   *
   * <p>There is no need to call this method in normal usage since flags are automatically
