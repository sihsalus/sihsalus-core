...
public interface BedManagementService extends OpenmrsService {
   ...
   */
  @Authorized({"Edit Admission Locations", "Manage Locations"})
  AdmissionLocation setBedLayoutForAdmissionLocation(
      AdmissionLocation admissionLocation, Integer row, Integer column);

  @Authorized(
      value = {"Assign Beds", "Edit Admission Locations"},
      requireAll = true)
  ...
  @Authorized(
      value = {"Get Beds", "Get Admission Locations"},
      requireAll = true)
  BedDetails getBedAssignmentDetailsByPatient(Patient patient);

  @Authorized(
      value = {"Get Admission Locations", "Get Beds"},
      requireAll = true)
  ...
  @Authorized(
      value = {"Get Admission Locations", "Get Beds"},
      requireAll = true)
  List<BedPatientAssignment> getBedPatientAssignmentByPatient(
      String patientUuid, boolean includeEnded);

  @Authorized(
      value = {"Get Admission Locations", "Get Beds"},
      requireAll = true)
  List<BedPatientAssignment> getBedPatientAssignmentByEncounter(
  ...
  /**
   * Unassign all assigned beds from a patient associated with the given visit. The number of
   * assigned beds for the patient *should* be at most one, but this function does not assume that.
   *
   * @param visit
   ...
   */
  @Authorized(value = "Get Beds", requireAll = true)
  BedLocationMapping getBedLocationMappingByLocationUuidAndRowColumn(
