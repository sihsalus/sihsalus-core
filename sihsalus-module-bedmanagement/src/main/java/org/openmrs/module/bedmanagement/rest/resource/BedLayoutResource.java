...
public class BedLayoutResource extends BaseDelegatingResource<BedLayout> {
  ...
  private static final String DEFAULT_PATIENT_REP =
      "(uuid,person:(gender,age,preferredName:(givenName,familyName),preferredAddress:default),identifiers:(identifier))";
  ...
  @Override
  protected void delete(BedLayout delegate, String reason, RequestContext context)
