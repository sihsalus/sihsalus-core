...
@Resource(
    name = RestConstants.VERSION_1 + "/bedPatientAssignment",
    supportedClass = BedPatientAssignment.class,
...
public class BedPatientAssignmentResource extends DelegatingCrudResource<BedPatientAssignment> {
  ...
  protected void delete(
      BedPatientAssignment bedPatientAssignment, String s, RequestContext requestContext)
      throws ResponseException {
    throw new ResourceDoesNotSupportOperationException(
        "delete of bed patient assignment not supported");
  }

  @Override
  public void purge(BedPatientAssignment bedPatientAssignment, RequestContext requestContext)
      throws ResponseException {
    throw new ResourceDoesNotSupportOperationException(
        "purge of bed patient assignment not supported");
  }
  ...
  public DelegatingResourceDescription getCreatableProperties()
    ...
    throw new ResourceDoesNotSupportOperationException(
        "create of bed patient assignment not supported");
  }
  ...
  public BedPatientAssignment save(BedPatientAssignment bedPatientAssignment) {
    throw new ResourceDoesNotSupportOperationException(
        "save of bed patient assignment not supported");
  }
}
