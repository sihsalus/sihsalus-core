...
public class AttachmentsConstants {
  ...
  public static final String COMPONENT_COMPLEXDATA_HELPER =
      MODULE_ARTIFACT_ID + ".ComplexDataHelper";

  public static final String COMPONENT_VISIT_COMPATIBILITY =
      MODULE_ARTIFACT_ID + ".VisitCompatibility";

  public static final String COMPONENT_COMPLEXOBS_SAVER = MODULE_ARTIFACT_ID + ".ComplexObsSaver";

  public static final String COMPONENT_COMPLEXVIEW_HELPER =
      MODULE_ARTIFACT_ID + ".ComplexViewHelper";
  ...
  public static final String ATT_VIEW_CRUD =
      ATT_VIEW_ORIGINAL; // Use this view for CRUD operations where a view must
  // be provided.

  public static final String ATT_VIEW_RANDOM = "complexdata.view.random:m3k0m";

  public static final String IMAGE_HANDLER_VIEW =
      "RAW_VIEW"; // Default/unique view handled by Core's ImageHandler

  public static final String BINARYDATA_HANDLER_VIEW =
      "RAW_VIEW"; // Default/unique view handled by Core's
  // BinaryDataHandler

  /*
   * Global properties
   */
  public static final String GP_DEFAULT_CONCEPT_COMPLEX_UUID =
      MODULE_ARTIFACT_ID + ".defaultConceptComplexUuid";

  public static final String GP_DEFAULT_CONCEPT_COMPLEX_NAME =
      MODULE_ARTIFACT_ID + ".defaultConceptComplexName";

  public static final String GP_DEFAULT_CONCEPT_COMPLEX_DESCRIPTION =
      MODULE_ARTIFACT_ID + ".defaultConceptComplexDescription";

  public static final String GP_IMAGE_CONCEPT_COMPLEX_NAME =
      MODULE_ARTIFACT_ID + ".imageConceptComplexName";

  public static final String GP_IMAGE_CONCEPT_COMPLEX_DESCRIPTION =
      MODULE_ARTIFACT_ID + ".imageConceptComplexDescription";

  public static final String GP_CONCEPT_COMPLEX_UUID_MAP =
      MODULE_ARTIFACT_ID + ".conceptComplexUuidMap"; // Map
  // between
  // content
  // families
  // and
  ...
  public static final String GP_CONCEPT_COMPLEX_UUID_LIST =
      MODULE_ARTIFACT_ID + ".conceptComplexUuidList"; // List of
  // concepts
  // complex
  // UUIDs
  // for
  ...
  public static final String GP_ALLOWED_FILE_EXTENSIONS =
      MODULE_ARTIFACT_ID + ".allowedFileExtensions";
  ...
  public static final String GP_DASHBOARD_THUMBNAIL_COUNT =
      MODULE_ARTIFACT_ID + ".dashboardThumbnailCount";

  // Should always be the same as
  // RestConstants.MAX_RESULTS_DEFAULT_GLOBAL_PROPERTY_NAME
  public static final String GP_RESTWS_MAX_RESULTS_DEFAULT_GLOBAL_PROPERTY_NAME =
