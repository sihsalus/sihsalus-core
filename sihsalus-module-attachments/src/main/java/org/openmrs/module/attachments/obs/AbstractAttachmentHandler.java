...
/**
 * Double inheritance class. The actual implementation parent must be set through {@link
...
public abstract class AbstractAttachmentHandler implements ComplexObsHandler {
  ...
  public static final int THUMBNAIL_MAX_WIDTH = THUMBNAIL_MAX_HEIGHT;
  ...
  public AttachmentComplexData getAttachmentComplexData(ComplexData complexData) {
    ...
    if (!(complexData instanceof AttachmentComplexData)) {
      return complexDataHelper.build(
   ...
   */
  @Override
  public final Obs getObs(Obs obs, String view) {
   ...
   */
  @Override
  public final boolean purgeComplexData(Obs obs) {
   ...
   */
  @Override
  public final Obs saveObs(Obs obs) {
