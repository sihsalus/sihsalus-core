...
public interface AttachmentsService extends OpenmrsService {
   ...
   * encounters.
   *
   * @param includeVoided Specifies whether the underlying complex obs that are fetched should
   *     include voided ones or not.
   ...
   * @param includeVoided Specifies whether the underlying complex obs that are fetched should
   *     include voided ones or not.
   * @param includeEncounterless Specifies whether the underlying attachments that are fetched
   *     should include attachments that are not associated with any visits or encounters.
   * @throws APIException if non-complex obs are mistakenly returned
   */
  @Authorized(AttachmentsConstants.VIEW_ATTACHMENTS)
  List<Attachment> getAttachments(
      Patient patient, boolean includeEncounterless, boolean includeVoided);
