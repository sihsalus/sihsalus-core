...
public class Utility {
  ...
  /**
   * Clears the time portion of the specified {@link Calendar}, setting the hour, minute, second,
   * and millisecond parts to 0.
   *
  ...
  /**
   * Parses a standard OpenHMIS formatted (openhmis.dateFormat) date returning the {@link
