...
public class BillableServiceMapper {
  ...
  public BillableService billableServiceMapper(BillableServiceMapper mapper) {
    ...
    service.setServiceCategory(
        Context.getConceptService().getConceptByUuid(mapper.getServiceCategory()));
    service.setServiceStatus(mapper.getServiceStatus());
    for (CashierItemPriceMapper itemPrice :
        mapper.getServicePrices() == null
            ? Collections.<CashierItemPriceMapper>emptyList()
      ...
      price.setPaymentMode(
          Context.getService(PaymentModeService.class)
              .getPaymentModeByUuid(itemPrice.getPaymentMode()));
