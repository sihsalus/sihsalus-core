...
public class BillAddEditController {
  ...
  public String bill(
    ...
    boolean showAdjustmentReasonField =
        Boolean.parseBoolean(
            adminService.getGlobalProperty(ModuleSettings.ADJUSTMENT_REASON_FIELD));
    model.addAttribute("showAdjustmentReasonField", showAdjustmentReasonField);

    boolean allowBillAdjustment =
        Boolean.parseBoolean(adminService.getGlobalProperty(ModuleSettings.ALLOW_BILL_ADJUSTMENT));
    model.addAttribute("allowBillAdjustment", allowBillAdjustment);

    boolean autofillPaymentAmount =
        Boolean.parseBoolean(
            adminService.getGlobalProperty(ModuleSettings.AUTOFILL_PAYMENT_AMOUNT));
