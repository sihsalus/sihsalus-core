...
@Resource(
    name = RestConstants.VERSION_1 + CashierResourceController.BILLING_NAMESPACE + "/cashPoint",
    supportedClass = CashPoint.class,
...
public class CashPointResource extends MetadataDelegatingCrudResource<CashPoint> {
  ...
  @Override
  public void delete(CashPoint cashpoint, String reason, RequestContext context)
