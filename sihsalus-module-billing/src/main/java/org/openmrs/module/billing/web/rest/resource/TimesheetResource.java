...
@Resource(
    name = RestConstants.VERSION_2 + CashierResourceController.BILLING_NAMESPACE + "/timesheet",
    supportedClass = Timesheet.class,
...
public class TimesheetResource extends BaseRestDataResource<Timesheet> {
  ...
  @Override
  protected NeedsPaging<Timesheet> doGetAll(RequestContext context) {
  ...
  public String getDisplayString(Timesheet instance) {
    DateFormat dateFormat =
        DateFormat.getDateTimeInstance(
            DateFormat.DEFAULT, DateFormat.SHORT, LocaleUtility.getDefaultLocale());
    return dateFormat.format(instance.getClockIn())
        + " to "
