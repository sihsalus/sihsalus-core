...
public class BaseHibernateRepositoryImpl implements BaseHibernateRepository {
	...
	public <E extends OpenmrsObject> BillingCriteria createCriteria(Class<E> cls) {
		return new BillingCriteria(sessionFactory.getHibernateSessionFactory().getCurrentSession(), cls);
	}
	...
	public <E extends OpenmrsObject> E save(E entity) {
		...
		try {
			...
			throw new APIException(
			        "An exception occurred while attempting to add a " + entity.getClass().getSimpleName() + " entity.",
			        ex);
		}
		return entity;
	}
	...
	public <E extends OpenmrsObject> List<E> select(Class<E> cls) {
		try {
			...
			throw new APIException(
			        "An exception occurred while attempting to get " + cls.getSimpleName() + " entities.", ex);
		}
	}
