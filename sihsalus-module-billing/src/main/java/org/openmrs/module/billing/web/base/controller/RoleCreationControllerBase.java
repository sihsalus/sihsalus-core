...
public abstract class RoleCreationControllerBase {
  ...
  public void submit(
      HttpServletRequest request, RoleCreationViewModel viewModel, Errors errors, ModelMap model) {
    Context.requirePrivilege(PrivilegeConstants.MANAGE_ROLES);
    ...
    if (action.equals("add")) {
      ...
      session.setAttribute(
          WebConstants.OPENMRS_MSG_ATTR, "openhmis.commons.roleCreation.page.feedback.add");
    } else if (action.equals("remove")) {
      removePrivileges(viewModel.getRemoveFromRole());
      session.setAttribute(
          WebConstants.OPENMRS_MSG_ATTR, "openhmis.commons.roleCreation.page.feedback.remove");
  ...
  private void createRole(RoleCreationViewModel viewModel, HttpSession session) {
    ...
    session.setAttribute(
        WebConstants.OPENMRS_MSG_ATTR, "openhmis.commons.roleCreation.page.feedback.new");
  }
