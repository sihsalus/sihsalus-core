...
public interface BillService extends OpenmrsService {
   ...
   *
   * <p>By default, voided bills are excluded from search results unless explicitly included via
   ...
   *
   * <p>If the bill is new (no ID), it will be created. If it already exists, it will be updated.
   ...
   *
   * <p><strong>Warning:</strong> This operation cannot be undone. Consider using {@link
   * #voidBill(Bill, String)} instead for soft deletion.
   *
   ...
   *
   * <p>Voided bills are hidden from normal queries but remain in the database for audit purposes.
   ...
   *
   * <p>This operation removes the void flag and makes the bill visible in normal queries again.
   *
