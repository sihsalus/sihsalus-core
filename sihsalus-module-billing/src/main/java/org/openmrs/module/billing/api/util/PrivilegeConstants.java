...
public class PrivilegeConstants {
	...
	public static final String[] PRIVILEGE_NAMES = new String[] { MANAGE_BILLS, ADJUST_BILLS, VIEW_BILLS, DELETE_BILLS,
	        PURGE_BILLS, REFUND_MONEY, REPRINT_RECEIPT, MANAGE_BILL_DISCOUNTS, APPROVE_BILL_DISCOUNTS,
	        VIEW_BILL_DISCOUNTS, REQUEST_REFUNDS, APPROVE_REFUNDS, COMPLETE_REFUNDS, VIEW_REFUNDS,
