...
/**
 * Represents classes that provide data access services to model types that implement {@link
...
public interface IObjectDataService<E extends OpenmrsObject> extends OpenmrsService {
  ...
  /**
   * Saves an object to the database along with the specified related {@link OpenmrsObject}'s within
