...
public class ReceiptNumberGeneratorFactory {
  ...
  public static void setGenerator(IReceiptNumberGenerator generator) {
    Class<? extends IReceiptNumberGenerator> cls =
  ...
  private static IReceiptNumberGenerator createGeneratorInstance() {
    ...
    try {
      ...
      throw new APIException(
          "Could not instantiate the '" + getGeneratorClassName(cls) + "' class.", instantiationEx);
    } catch (IllegalAccessException accessEx) {
      throw new APIException(
          "Could not access the '" + getGeneratorClassName(cls) + "' class.", accessEx);
    }
  }
  ...
  public static IReceiptNumberGenerator[] locateGenerators() {
    // Search for any modules that define classes which implement the IReceiptNumberGenerator
    // interface
    Reflections reflections = new Reflections("org.openmrs.module");
    List<Class<? extends IReceiptNumberGenerator>> classes =
        new ArrayList<Class<? extends IReceiptNumberGenerator>>();
    for (Class<? extends IReceiptNumberGenerator> cls :
        reflections.getSubTypesOf(IReceiptNumberGenerator.class)) {
  ...
  private enum FactoryImpl {
    ...
    public Class<? super IReceiptNumberGenerator> getGeneratorClass()
    ...
    public void setGeneratorClass(Class<? extends IReceiptNumberGenerator> generatorClass) {
      ...
      GlobalProperty property =
          new GlobalProperty(ModuleSettings.SYSTEM_RECEIPT_NUMBER_GENERATOR, className);
