...
public class CashPointServiceImpl extends BaseOpenmrsService implements CashPointService {
  ...
  @Override
  @Transactional(readOnly = true)
  public List<CashPoint> getCashPointsByLocation(
      final Location location, final boolean includeRetired, PagingInfo pagingInfo) {
    if (location == null) {
  ...
  @Override
  @Transactional(readOnly = true)
  public List<CashPoint> getCashPointsByLocationAndName(
      Location location, String name, boolean includeRetired) {
  ...
  public List<CashPoint> getAllCashPoints(boolean includeRetired) {
    CashPointSearch cashPointSearch =
        CashPointSearch.builder().includeRetired(includeRetired).build();
