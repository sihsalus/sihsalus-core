 ...
 * want the default bill creation, voiding, and exemption logic should extend {@link
 * AbstractDefaultOrderBillingStrategy} instead.
 */
@Slf4j
public abstract class AbstractOrderBillingStrategy implements OrderBillingStrategy {
  ...
  /**
   * Whether this strategy handles the given (already deproxied) order. Subclasses only need to
   * check the order type here — the base class handles action filtering and deproxying.
   */
