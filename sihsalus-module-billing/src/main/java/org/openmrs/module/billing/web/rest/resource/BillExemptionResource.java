...
@Resource(
    name = RestConstants.VERSION_1 + CashierResourceController.BILLING_NAMESPACE + "/billExemption",
    supportedClass = BillExemption.class,
...
public class BillExemptionResource extends MetadataDelegatingCrudResource<BillExemption> {
  ...
  @Override
  public void delete(BillExemption delegate, String reason, RequestContext context)
  ...
  public void purge(BillExemption delegate, RequestContext context) throws ResponseException {
    throw new ResourceDoesNotSupportOperationException(
        "Purge is not supported for BillingExemption");
  }
