...
public interface ConfigurableAuthenticationScheme extends AuthenticationScheme {
  ...
  /**
   * @param schemeId - the unique schemeId that this AuthenticationScheme instance is registered
   *     under
   * @param config - the configuration to use when constructing a new instance of this
