...
/**
 * This AuthenticationScheme overrides the core authentication scheme as soon as this module is
 * installed This delegates to another authentication scheme based on configuration, defaulting to
 * the UsernamePasswordAuthenticationScheme if no configuration has been specified
 */
@Component
