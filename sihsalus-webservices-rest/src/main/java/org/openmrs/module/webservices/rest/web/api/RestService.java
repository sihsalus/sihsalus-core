...
public interface RestService {
   ...
   *
   * @param requested
   * @return <strong>Should</strong> get ref representation when specified <strong>Should</strong>
   *     get default representation when specified <strong>Should</strong> get full representation
   *     when specified <strong>Should</strong> get a named representation when specified
   */
   ...
   * @throws APIException
   */
  SearchHandler getSearchHandler(String resourceName, Map<String, String[]> parameters)
      throws APIException;
  ...
  /** Initializes all Resources and Search handlers for use; called in tests */
  public void initialize();

  /**
   * Initializes all Resources and Search handlers for use asynchronously; called after module
   * startup
   */
