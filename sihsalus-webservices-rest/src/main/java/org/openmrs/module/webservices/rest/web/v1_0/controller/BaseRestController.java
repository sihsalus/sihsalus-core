...
public class BaseRestController {
  ...
  /**
   * <strong>Should</strong> return unauthorized if not logged in <strong>Should</strong> return
   * forbidden if logged in
   */
  @ExceptionHandler({APIAuthenticationException.class, ContextAuthenticationException.class})
  @ResponseBody
  public SimpleObject apiAuthenticationExceptionHandler(
    ...
    if (Context.isAuthenticated()) {
      ...
      if (shouldAddWWWAuthHeader(request)) {
        response.addHeader(
            "WWW-Authenticate", "Basic realm=\"OpenMRS at " + RestConstants.URI_PREFIX + "\"");
      }
    }
  ...
  @ResponseBody
  public SimpleObject validationExceptionHandler(
  ...
  @ResponseBody
  public SimpleObject conversionExceptionHandler(
  ...
  @ResponseBody
  public SimpleObject httpMessageNotReadableExceptionHandler(
  ...
  @ResponseBody
  public SimpleObject handleException(
      Exception ex, HttpServletRequest request, HttpServletResponse response) throws Exception {
