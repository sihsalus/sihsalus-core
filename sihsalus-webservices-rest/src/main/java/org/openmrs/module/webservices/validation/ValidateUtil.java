 ...
 *
 * @deprecated since 3.2.0, use {@link org.openmrs.validator.ValidateUtil} instead Remove this when
 *     this ticket is done: https://openmrs.atlassian.net/browse/RESTWS-1016
 */
@Deprecated
public class ValidateUtil {
   ...
   * @throws ValidationException thrown if a binding exception occurs <strong>Should</strong> throw
  ...
  public static void validate(Object obj) throws ValidationException {
    ...
    try {
      ...
      Method validate =
          AdministrationService.class.getMethod("validate", Object.class, Errors.class);
      ...
      throw new APIException(
          "Unable to invoke administrationService.validate(Object, Errors) via reflection", ex);
