...
public class DelegatingResourceDescription implements RepresentationDescription {
  ...
  public void addRequiredProperty(
      String propertyName, String delegatePropertyName, Representation rep) {
  ...
  public void addProperty(
      String propertyName, String delegatePropertyName, Representation rep, boolean required) {
  ...
  public void addProperty(
      ...
      boolean required,
      Class<?> convertAs) {
    if (rep == null) rep = Representation.DEFAULT;
  ...
  public void addProperty(
      String propertyName, Method method, Representation rep, boolean required) {
    if (rep == null) rep = Representation.DEFAULT;
  ...
  public static class Property {
    ...
    /**
     * In case you want to force a specific converter, e.g. in relationship resource, force personA
     * to be converted by the person resource even if personA is actually a Patient
     *
    ...
    public <T> Object evaluate(BaseDelegatingConverter<T> converter, T delegate)
