 ...
 * resource
 */
public interface DelegatingSubclassHandler<Superclass, Subclass extends Superclass>
    extends DelegatingResourceHandler<Subclass> {
  ...
  /**
   * Convenience method that lets you retrieve the declared superclass at runtime without needing to
   ...
   *     operation
   */
  PageableResult getAllByType(RequestContext context)
