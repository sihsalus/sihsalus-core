...
public interface SubResource extends Resource {
   ...
   */
  Object create(String parentUniqueId, SimpleObject post, RequestContext context)
      throws ResponseException;
   ...
   * @throws ResponseException
   */
  Object retrieve(String parentUniqueId, String uniqueId, RequestContext context)
      throws ResponseException;
   ...
   * @throws ResponseException
   */
  void delete(String parentUniqueId, String uniqueId, String reason, RequestContext context)
      throws ResponseException;
   ...
   * @throws ResponseException
   */
  void purge(String parentUniqueId, String uniqueId, RequestContext context)
      throws ResponseException;
   ...
   * @throws ResponseException
   */
  void put(String parentUniqueId, SimpleObject post, RequestContext context)
      throws ResponseException;
}
