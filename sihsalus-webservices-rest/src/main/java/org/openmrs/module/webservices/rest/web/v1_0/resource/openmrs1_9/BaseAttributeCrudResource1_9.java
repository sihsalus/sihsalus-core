 ...
 */
public abstract class BaseAttributeCrudResource1_9<T extends Attribute<?, ?>, P, PR>
    extends DelegatingSubResource<T, P, DelegatingCrudResource<P>> {
  ...
  /**
   * @see
   *     org.openmrs.module.webservices.rest.web.resource.impl.BaseDelegatingResource#getRepresentationDescription(Representation)
   */
  @Override
  ...
  public String getDisplayString(T attr) {
    if (attr.getAttributeType() == null) return "";
  ...
  /**
   * @see
   *     org.openmrs.module.webservices.rest.web.resource.impl.BaseDelegatingResource#getPropertiesToExposeAsSubResources()
   */
  @Override
