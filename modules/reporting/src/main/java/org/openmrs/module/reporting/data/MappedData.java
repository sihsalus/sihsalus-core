...
/**
 * Extends the Mapped wrapper class for a DataDefintion, providing a means for associating an
 * optional DataConverter and format to the particular instance of a Mapped Data Definition.
 *
 * @see Mapped
 */
public class MappedData<T extends DataDefinition> extends Mapped<T> {
  ...
  public MappedData(
      T dataDefinition, Map<String, Object> parameterMappings, DataConverter... converters) {
