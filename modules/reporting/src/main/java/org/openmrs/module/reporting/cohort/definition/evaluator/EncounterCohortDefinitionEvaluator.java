...
public class EncounterCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
   ...
   * @should find patients with encounters created on the specified date if passed in time is at
   *     midnight
   */
  @Override
  public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context)
    ...
    Cohort c =
        Context.getService(CohortQueryService.class)
            .getPatientsHavingEncounters(
                ...
                cd.getLocationList(),
                cd.getProviderList(),
                cd.getEncounterTypeList(),
                cd.getFormList(),
                cd.getAtLeastCount(),
                cd.getAtMostCount(),
                cd.getCreatedBy(),
                cd.getCreatedOnOrAfter(),
                cd.getCreatedOnOrBefore());
