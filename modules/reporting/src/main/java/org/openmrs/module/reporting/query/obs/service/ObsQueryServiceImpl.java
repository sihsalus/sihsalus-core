...
public class ObsQueryServiceImpl extends BaseDefinitionService<ObsQuery>
    implements ObsQueryService {
   ...
   */
  public ObsQueryResult evaluate(ObsQuery query, EvaluationContext context)
   ...
   */
  public ObsQueryResult evaluate(Mapped<? extends ObsQuery> mappedQuery, EvaluationContext context)
      throws EvaluationException {
