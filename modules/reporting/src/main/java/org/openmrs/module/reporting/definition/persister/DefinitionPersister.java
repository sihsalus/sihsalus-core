...
/**
 * This interface provides a means for specific definition implementations to plug in specific
 * implementations for how they should be persisted and retrieved.
 */
