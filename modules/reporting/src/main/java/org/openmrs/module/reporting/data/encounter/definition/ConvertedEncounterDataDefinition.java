...
public class ConvertedEncounterDataDefinition
    extends ConvertedDataDefinition<EncounterDataDefinition> implements EncounterDataDefinition {
  ...
  public ConvertedEncounterDataDefinition(
      String name, EncounterDataDefinition definitionToConvert, DataConverter... converters) {
    super(name, definitionToConvert, converters);
  }

  public ConvertedEncounterDataDefinition(
      EncounterDataDefinition definitionToConvert, DataConverter... converters) {
