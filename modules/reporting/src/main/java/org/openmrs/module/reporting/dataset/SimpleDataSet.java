...
public class SimpleDataSet implements DataSet {
  ...
  /**
   * Default Constructor which creates an empty DataSet for the given definition and
   * evaluationContext
   *
   * @param definition
  ...
  /**
   * Add the passed Row to the dataset at the passed index. Also ensures all the Columns are added
   * to the metadata
   */
