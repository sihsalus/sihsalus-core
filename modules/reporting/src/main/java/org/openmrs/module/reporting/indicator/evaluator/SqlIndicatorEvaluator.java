...
public class SqlIndicatorEvaluator implements IndicatorEvaluator {
  ...
  public SimpleIndicatorResult evaluate(Indicator indicator, EvaluationContext context)
    ...
    result.setDenominatorResult(
        evaluateSql(sqlIndicator.getDenominatorSql(), context, "denominatorSql"));
    return result;
  }

  protected Number evaluateSql(String sql, EvaluationContext context, String propertyName)
      throws EvaluationException {
