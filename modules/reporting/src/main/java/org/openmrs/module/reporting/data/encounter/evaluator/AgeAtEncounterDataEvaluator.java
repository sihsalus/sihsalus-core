...
public class AgeAtEncounterDataEvaluator implements EncounterDataEvaluator {
  ...
  @Autowired EncounterDataService encounterDataService;
  ...
  public EvaluatedEncounterData evaluate(
    ...
    EvaluatedEncounterData encounterDatetimes =
        encounterDataService.evaluate(datetimeDataDefinition, context);

    PersonToEncounterDataDefinition birthdateDataDefinition =
        new PersonToEncounterDataDefinition(new BirthdateDataDefinition());
    EvaluatedEncounterData birthdates =
        encounterDataService.evaluate(birthdateDataDefinition, context);
