...
/**
 * A Parameter represents a value that may be used to configure an Object at runtime. Examples of
 * classes where Parameters are used are ReportDefinition, CohortDefinition, and DataSetDefinition
 * If an object is parameterizable, it is able to accept a parameter like this. Examples of a
 * parameter would be "What start date do you want to use?" Typically Parameter Values are retrieved
 * in the context of an {@link EvaluationContext}
 *
 * @see Parameterizable
...
public class Parameter implements Serializable {
  ...
  /**
   * The name by which this Parameter can be uniquely retrieved in the Context within which it is
   * being used.
   */
  private String name;
  ...
  /**
   * Indicates whether this parameter is required, or should accept a value of null. Default to
   * required = true.
   */
  private boolean required = true;

  /**
   * Configuration properties that will be sent to the widgets to control how they are configured
   * and displayed
   */
  ...
  public Parameter(
      ...
      Object defaultValue,
      Properties widgetConfiguration,
      Boolean required) {
    super();
    setName(name);
    setLabel(label);
  ...
  /**
   * Initialize this Parameter with the values from an existing Parameter. This is equivalent to
   * cloning.
   *
   ...
   *
   * @return An expression based on the parameter's name.
   */
