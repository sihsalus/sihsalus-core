...
/**
 * Utility method that which allows you to evaluate multiple CohortDefinitions and returning the
 * resulting Cohort which represents the intersection of all evaluated Cohorts
 */
public class CohortFilter {
   ...
   */
  public static Cohort filter(
      EvaluationContext context, Mapped<? extends CohortDefinition>... definitions)
