...
/**
 * Extends the patient-based EvaluationContext to add an additional Person filter for use within
 * Person specific queries and data extraction Note that this cache is cleared whenever any changes
 * are made to basePersons
 */
