...
public interface SerializedDefinitionService extends OpenmrsService {
  ...
  /**
   * Returns a List of {@link Definition} whose name contains the passed name. An empty list will be
   * returned if there are none found. Search is case insensitive.
   *
  ...
  public <T extends Definition> List<T> getDefinitions(
      Class<T> definitionType, String name, boolean exactMatchOnly) throws APIException;
