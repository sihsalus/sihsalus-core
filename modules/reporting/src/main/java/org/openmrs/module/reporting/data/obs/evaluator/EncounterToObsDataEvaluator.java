...
public class EncounterToObsDataEvaluator implements ObsDataEvaluator {
  ...
  public EvaluatedObsData evaluate(ObsDataDefinition definition, EvaluationContext context)
    ...
    if (!convertedIds.keySet().isEmpty()) {
      ...
      EncounterEvaluationContext encounterEvaluationContext =
          new EncounterEvaluationContext(context, null);
      ...
      EvaluatedEncounterData ed =
          Context.getService(EncounterDataService.class)
              .evaluate(def.getJoinedDefinition(), encounterEvaluationContext);
