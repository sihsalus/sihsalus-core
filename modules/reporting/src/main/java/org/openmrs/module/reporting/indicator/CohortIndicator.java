...
public class CohortIndicator extends BaseIndicator {
  ...
  @ConfigurationProperty private IndicatorType type = IndicatorType.COUNT;

  @ConfigurationProperty private Mapped<? extends CohortDefinition> cohortDefinition;

  @ConfigurationProperty private Mapped<? extends CohortDefinition> denominator;

  @ConfigurationProperty private Mapped<? extends CohortDefinition> locationFilter;

  @ConfigurationProperty private Class<? extends Aggregator> aggregator;

  @ConfigurationProperty private Mapped<? extends PatientDataDefinition> dataToAggregate;

  @Deprecated @ConfigurationProperty private String logicExpression;
  ...
  public static CohortIndicator newCountIndicator(
      String name,
  ...
  public static CohortIndicator newFractionIndicator(
      String name,
  ...
  @Deprecated
  public static CohortIndicator newLogicIndicator(
      String name,
      Mapped<? extends CohortDefinition> cohortDefinition,
      Mapped<? extends CohortDefinition> locationFilter,
