...
/**
 * Evaluates a sql script found at the configured file path or resource path or with the sql
 * contents specified By default, this will utilize the database connection properties in the
 * openmrs runtime properties This can use an alternative database connection by specifying the
 * file. Property names follow those in openmrs runtime properties
 */
public class SqlFileDataSetDefinition extends BaseDataSetDefinition {
  ...
  @ConfigurationProperty private String sqlFile;

  @ConfigurationProperty private String sqlResource;

  @ConfigurationProperty private String sql;

  @ConfigurationProperty private String connectionPropertyFile;
  ...
  public void setMetadataParameterConversion(
      MetadataParameterConversion metadataParameterConversion) {
