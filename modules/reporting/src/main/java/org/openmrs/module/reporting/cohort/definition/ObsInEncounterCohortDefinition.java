...
public class ObsInEncounterCohortDefinition extends BaseCohortDefinition {
  ...
  @ConfigurationProperty private TimeQualifier whichEncounter;

  @ConfigurationProperty private List<EncounterType> encounterTypes;

  @ConfigurationProperty private Date encounterOnOrAfter;

  @ConfigurationProperty private Date encounterOnOrBefore;

  @ConfigurationProperty private List<Location> encounterLocations;

  @ConfigurationProperty private Concept question;

  @ConfigurationProperty private RangeComparator valueOperator1;

  @ConfigurationProperty private Date valueDatetime1;

  @ConfigurationProperty private RangeComparator valueOperator2;

  @ConfigurationProperty private Date valueDatetime2;
