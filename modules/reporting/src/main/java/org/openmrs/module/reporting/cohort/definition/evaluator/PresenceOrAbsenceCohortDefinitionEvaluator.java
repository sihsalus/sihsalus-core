...
public class PresenceOrAbsenceCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
  ...
  public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context)
    ...
    // Iterate across all of the cohorts to check, and keep track of how many there are for each
    // patient
    ...
    // Finally, if zero matches are allowed, we need to include patients from the base cohort that
    // were not in any of the cohorts to check
