...
public class LogicUtil {
  ...
  /**
   * Tries to parse a String into a {@link LogicCriteria}. This method is safe to run on versions of
   * logic before 0.4.1--if the parser runs for more than 2 seconds, this method will throw an
   * exception.
   *
  ...
  public static LogicCriteria parse(final String logic) throws LogicException {
    ...
    if (resultHolder[0] != null) return resultHolder[0];
    else throw new LogicException("Took too long to parse");
  }
    ...
    if (testPatientId != null) {
      ...
      throw new LogicException(
          Context.getMessageSourceService()
              .getMessage(
                  "reporting.noPatientData", null, "No Patient Data found", Context.getLocale()));
    }
