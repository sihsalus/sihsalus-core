...
public class SimpleIndicatorResult implements IndicatorResult {
  ...
  public static Number getResultValue(SimpleIndicatorResult indicatorResult) {
    if (indicatorResult.getNumeratorResult() == null) {
      ...
      if (Math.rint(indicatorResult.getNumeratorResult().doubleValue())
              == indicatorResult.getNumeratorResult().doubleValue()
          && Math.rint(indicatorResult.getDenominatorResult().doubleValue())
              == indicatorResult.getDenominatorResult().doubleValue()) { // check for whole numbers
        return new Fraction(
            indicatorResult.getNumeratorResult().intValue(),
