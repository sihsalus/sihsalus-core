...
public class AgeDataEvaluator implements PersonDataEvaluator {
  ...
  public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
    ...
    EvaluatedPersonData birthdateData =
        personDataService.evaluate(new BirthdateDataDefinition(), context);
    EvaluatedPersonData vitalStatusData =
        personDataService.evaluate(new VitalStatusDataDefinition(), context);
