 ...
 * encounterId the second should be the data you wish to retrieve for each Encounter Expects that
 * you use "encounterIds" within your query to limit by the base id set in the evaluation context:
...
public class SqlEncounterDataEvaluator implements EncounterDataEvaluator {
  ...
  @Override
  public EvaluatedEncounterData evaluate(EncounterDataDefinition def, EvaluationContext context)
