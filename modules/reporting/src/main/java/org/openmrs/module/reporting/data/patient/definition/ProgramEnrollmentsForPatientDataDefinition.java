...
public class ProgramEnrollmentsForPatientDataDefinition extends BaseDataDefinition
    implements PatientDataDefinition {

  // ***** PROPERTIES *****

  @ConfigurationProperty private TimeQualifier whichEnrollment;

  @ConfigurationProperty(required = true)
  private Program program;

  @ConfigurationProperty private Date activeOnDate;

  @ConfigurationProperty private Date enrolledOnOrBefore;

  @ConfigurationProperty private Date enrolledOnOrAfter;

  @ConfigurationProperty private Date completedOnOrBefore;

  @ConfigurationProperty private Date completedOnOrAfter;
  ...
  public Class<?> getDataType() {
    if (whichEnrollment == TimeQualifier.LAST
        || whichEnrollment == TimeQualifier.FIRST
        || activeOnDate != null) {
