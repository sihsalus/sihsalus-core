...
public class EncounterDataSetDefinition extends RowPerObjectDataSetDefinition {
  ...
  @ConfigurationProperty private List<Mapped<? extends EncounterQuery>> rowFilters;
  ...
  public void addColumn(
    ...
    if (dataDefinition == null) {
      ...
      EncounterDataDefinition edd =
          new PatientToEncounterDataDefinition((PatientDataDefinition) dataDefinition);
      ...
      EncounterDataDefinition edd =
          new PersonToEncounterDataDefinition((PersonDataDefinition) dataDefinition);
      getColumnDefinitions().add(new RowPerObjectColumnDefinition(name, edd, mappings, converters));
    } else {
  ...
  /**
   * @see RowPerObjectDataSetDefinition#addColumns(String, RowPerObjectDataSetDefinition, String,
   *     TimeQualifier, Integer, DataConverter...)
   */
  @Override
  ...
  public void addRowFilter(EncounterQuery filter, String mappings) {
    addRowFilter(
        new Mapped<EncounterQuery>(filter, ParameterizableUtil.createParameterMappings(mappings)));
  }
