...
public class ReportingConstants implements GlobalPropertyListener {
  ...
  public static final String GLOBAL_PROPERTY_PREFERRED_IDENTIFIER_TYPES =
      "reporting.preferredIdentifierTypes";
  public static final String GLOBAL_PROPERTY_DELETE_REPORTS_AGE_IN_HOURS =
  ...
  public static final String GLOBAL_PROPERTY_DATA_EVALUATION_BATCH_SIZE =
      "reporting.dataEvaluationBatchSize";
  public static final String GLOBAL_PROPERTY_INCLUDE_DATA_EXPORTS =
      "reporting.includeDataExportsAsDataSetDefinitions";
  public static final String GLOBAL_PROPERTY_RUN_REPORT_COHORT_FILTER_MODE =
  ...
  public static final String GLOBAL_PROPERTY_TEST_PATIENTS_COHORT_DEFINITION =
      "reporting.testPatientsCohortDefinition";
  public static final String GLOBAL_PROPERTY_EVALUATION_LOGGER_ENABLED =
      "reporting.evaluationLoggerEnabled";
  public static final String GLOBAL_PROPERTY_LOAD_REPORTS_FROM_CONFIGURATION_AT_STARTUP =
      "reporting.loadReportsFromConfigurationAtStartup";
  public static final String DEFAULT_LOCALE_GP_NAME = "reporting.defaultLocale";

  public static final List<String> CACHED_PROPERTIES =
      Arrays.asList(
          GLOBAL_PROPERTY_DEFAULT_DATE_FORMAT,
          DEFAULT_LOCALE_GP_NAME,
          GLOBAL_PROPERTY_DATA_EVALUATION_BATCH_SIZE,
  ...
  public static final Parameter START_DATE_PARAMETER =
      new Parameter("startDate", "Start date", Date.class);
  public static final Parameter END_DATE_PARAMETER =
      new Parameter("endDate", "End date", Date.class);
  public static final Parameter LOCATION_PARAMETER =
  ...
  public static final List<PatientIdentifierType> GLOBAL_PROPERTY_PREFERRED_IDENTIFIER_TYPES() {
    String propertyValue =
        Context.getAdministrationService()
            .getGlobalProperty(GLOBAL_PROPERTY_PREFERRED_IDENTIFIER_TYPES);
  ...
  public static final boolean GLOBAL_PROPERTY_LOAD_REPORTS_FROM_CONFIGURATION_AT_STARTUP() {
    return getPropertyValueAsBoolean(
        GLOBAL_PROPERTY_LOAD_REPORTS_FROM_CONFIGURATION_AT_STARTUP, false);
  }
  ...
  public static final CohortDefinition GLOBAL_PROPERTY_TEST_PATIENTS_COHORT_DEFINITION() {
    ...
    if (StringUtils.hasText(prop)) {
      if (prop.startsWith("library:")) {
        ...
        cohortDefinition =
            Context.getRegisteredComponents(AllDefinitionLibraries.class)
                .get(0)
                .getDefinition(CohortDefinition.class, prop);
        if (cohortDefinition == null) {
          throw new IllegalStateException(
              "Global property "
                  + GLOBAL_PROPERTY_TEST_PATIENTS_COHORT_DEFINITION
                  + " refers to a library definition that cannot be found: "
                  + prop);
        }
      } else {
        // this is the UUID of a saved CohortDefinition
        cohortDefinition =
            Context.getService(CohortDefinitionService.class).getDefinitionByUuid(prop);
        if (cohortDefinition == null) {
          throw new IllegalStateException(
              "Global property "
                  + GLOBAL_PROPERTY_TEST_PATIENTS_COHORT_DEFINITION
                  + " refers to a cohort definition that cannot be found by uuid: "
                  + prop);
        }
      }
    } else {
    ...
    if (cohortDefinition.getParameters().size() > 0) {
      throw new IllegalStateException(
          "Global property "
              + GLOBAL_PROPERTY_TEST_PATIENTS_COHORT_DEFINITION
              + " must refer to a cohort definition with no parameters, but this has "
              + cohortDefinition.getParameters().size()
              + ": "
              + prop);
    }
    ...
    if (StringUtils.hasText(propertyValue)) {
      try {
        ...
        log.warn(
            "Invalid setting <"
                + propertyValue
                + "> found for global property: "
                + propertyName
                + ".  An Integer is required.  Using default of "
                + defaultValue);
      }
    }
    return defaultValue;
      ...
      try {
        ...
        log.warn(
            "Invalid setting <"
                ...
                + "> found for global property: "
                + propertyName
                + ".  A Boolean is required.  Using default of "
                + defaultValue);
      }
    }
    return defaultValue;
      ...
      try {
        ...
        log.warn(
            "Invalid setting <"
                ...
                + "> found for global property: "
                + propertyName
                + ".  A Locale is required.  Using default of "
                + defaultValue);
      }
    }
    return defaultValue;
