...
/**
 * This class returns PersonQuerys that have been Serialized to the database This class is annotated
 * as a Handler that supports all PersonQuery classes Specifying no order on this indicates that
 * this is the default means of Persisting an PersonQuery. To override this behavior, any additional
 * PersonQueryPersister should specify the order field on the Handler annotation.
 */
