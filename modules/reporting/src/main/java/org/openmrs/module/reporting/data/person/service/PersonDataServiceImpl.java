...
public class PersonDataServiceImpl extends BaseDefinitionService<PersonDataDefinition>
    implements PersonDataService {
  ...
  public EvaluatedPersonData evaluate(
      Mapped<? extends PersonDataDefinition> mappedDefinition, EvaluationContext context)
      throws EvaluationException {
