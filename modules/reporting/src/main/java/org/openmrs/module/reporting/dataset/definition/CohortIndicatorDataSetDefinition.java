...
public class CohortIndicatorDataSetDefinition extends BaseDataSetDefinition {
  ...
  Map<String, Mapped<CohortDefinitionDimension>> dimensions =
      new HashMap<String, Mapped<CohortDefinitionDimension>>();

  @ConfigurationProperty
  List<CohortIndicatorAndDimensionColumn> columns =
      new ArrayList<CohortIndicatorAndDimensionColumn>();
  ...
  public void addDimension(
      String dimensionKey,
      CohortDefinitionDimension dimension,
  ...
  public void removeDimension(String dimensionKey) {
    List<CohortIndicatorAndDimensionColumn> listToRemove =
        new ArrayList<CohortIndicatorAndDimensionColumn>();
  ...
  public void addColumn(
    ...
    getColumns()
        .add(new CohortIndicatorAndDimensionColumn(name, label, indicator, dimensionOptions));
  }
   ...
   * Adds a Column with the given properties
   *
   * @param dimensionOptions something like gender=male|age=adult, where gender and age are keys
   *     into 'dimensions'
   */
  public void addColumn(
      String name,
  ...
  /**
   * Column Definition which encapsulates information about the indicator and dimensions chosen for
   * each column
   */
  public static class CohortIndicatorAndDimensionColumn extends DataSetColumn implements Cloneable {
