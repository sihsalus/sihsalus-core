...
public abstract class ReportTemplateRenderer extends ReportDesignRenderer {
  ...
  /**
   * Constructs a Map from String to Object of all data than can be used as replacements within an
   * entire template This includes all parameters, design properties, context values, and data for
   * any datasets that have only a single row
   *
  ...
  public Map<String, Object> getBaseReplacementData(ReportData reportData, ReportDesign design) {
    ...
    for (Map.Entry<String, Object> entry :
        reportData.getContext().getParameterValues().entrySet()) {
  ...
  /**
   * Constructs a Map from String to Object of all data than can be used as replacements for the
   * given data set row
   *
   * @param reportData
   * @param design
  ...
  public Map<String, Object> getReplacementData(
      ReportData reportData, ReportDesign design, String dataSetName, DataSetRow row) {
  ...
  /**
   * @return the message code prefix to use for translation columns. For example, if a column had a
   *     label of "gender" and a translation prefix of "myreports.reportcolumns.", then it would
   *     look for a message code named "myreports.reportcolumns.gender"
   */
  ...
  /**
   * @return the locale to use for translating columns. This will first look at a design property
   *     named columnTranslationLocale
   */
  protected Locale getTranslationLocale(ReportDesign design) {
    Locale translationLocale = null;
    String translationLocaleProperty =
        design.getPropertyValue(COLUMN_TRANSLATION_LOCALE_DESIGN_PROPERTY, null);
