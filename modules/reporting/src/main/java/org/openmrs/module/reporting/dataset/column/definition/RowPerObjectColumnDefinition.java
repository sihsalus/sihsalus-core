...
public class RowPerObjectColumnDefinition extends BaseColumnDefinition {
  ...
  @ConfigurationProperty private MappedData<? extends DataDefinition> dataDefinition;
  ...
  public RowPerObjectColumnDefinition(
      String name, MappedData<? extends DataDefinition> dataDefinition) {
    this(name);
  ...
  public RowPerObjectColumnDefinition(
    ...
    this(
        name,
        new MappedData<DataDefinition>(
            dataDefinition, ParameterizableUtil.createParameterMappings(mappings), converters));
  }
