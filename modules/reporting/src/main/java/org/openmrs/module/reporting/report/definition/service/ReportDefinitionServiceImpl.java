...
public class ReportDefinitionServiceImpl extends BaseDefinitionService<ReportDefinition>
  ...
  public List<Class<? extends ReportDefinition>> getDefinitionTypes() {
    List<Class<? extends ReportDefinition>> ret =
        new ArrayList<Class<? extends ReportDefinition>>();
   ...
   */
  @Transactional(readOnly = true)
  public <D extends ReportDefinition> D getDefinition(Class<D> type, Integer id)
      throws APIException {
  ...
  public void purgeDefinition(ReportDefinition definition) {
    ...
    for (ReportRequest request :
        reportService.getReportRequests(definition, null, null, (Status[]) null)) {
  ...
  public void purgeDefinition(String uuid) {
    ...
    reportService.purgeReportRequestsForReportDefinition(uuid);
    reportService.purgeReportDesignsForReportDefinition(uuid);
   ...
   */
  @Override
  public ReportData evaluate(
      Mapped<? extends ReportDefinition> definition, EvaluationContext context)
  ...
  public ReportData evaluate(ReportDefinition definition, EvaluationContext context)
      throws EvaluationException {
    return (ReportData) super.evaluate(definition, context);
  }
