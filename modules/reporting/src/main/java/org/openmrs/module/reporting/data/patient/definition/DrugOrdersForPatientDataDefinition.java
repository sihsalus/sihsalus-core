...
public class DrugOrdersForPatientDataDefinition extends BaseDataDefinition
    implements PatientDataDefinition {

  // ***** PROPERTIES *****

  @ConfigurationProperty private List<Drug> drugsToInclude;

  @ConfigurationProperty private List<Concept> drugConceptsToInclude;

  @ConfigurationProperty private List<Concept> drugConceptSetsToInclude;

  @ConfigurationProperty private Date activeOnDate;

  @ConfigurationProperty private Date startedOnOrBefore;
