...
public class InverseCohortDefinition extends BaseCohortDefinition {
  ...
  /**
   * Takes a Mapped<CohortDefinition> and returns <Mapped<NOT CohortDefinition>> The inverted cohort
   * definition will have the same parameters as the original cohort definition.
   */
  public static Mapped<InverseCohortDefinition> invert(
      Mapped<? extends CohortDefinition> original) {
    InverseCohortDefinition inv = new InverseCohortDefinition(original.getParameterizable());
    Mapped<InverseCohortDefinition> ret =
        new Mapped<InverseCohortDefinition>(inv, original.getParameterMappings());
    return ret;
  }
