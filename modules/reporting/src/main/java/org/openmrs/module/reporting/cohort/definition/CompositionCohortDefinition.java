...
public class CompositionCohortDefinition extends CompositionQuery<CohortDefinition, Patient>
    implements CohortDefinition {

  @ConfigurationProperty private Map<String, Mapped<CohortDefinition>> searches;
