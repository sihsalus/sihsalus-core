...
/**
 * Extends the patient-based EvaluationContext to add an additional Obs filter for use within obs
 * specific queries and data extraction Note that this cache is cleared whenever any changes are
 * made to baseObs
 */
