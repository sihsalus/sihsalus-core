...
public class PersonQueryServiceImpl extends BaseDefinitionService<PersonQuery>
    implements PersonQueryService {
   ...
   */
  public PersonQueryResult evaluate(PersonQuery query, EvaluationContext context)
   ...
   */
  public PersonQueryResult evaluate(
      Mapped<? extends PersonQuery> mappedQuery, EvaluationContext context)
      throws EvaluationException {
