...
public class ConvertedPatientDataDefinition extends ConvertedDataDefinition<PatientDataDefinition>
  ...
  public ConvertedPatientDataDefinition(
      PatientDataDefinition definitionToConvert, DataConverter... converters) {
    super(null, definitionToConvert, converters);
  }

  public ConvertedPatientDataDefinition(
      String name, PatientDataDefinition definitionToConvert, DataConverter... converters) {
