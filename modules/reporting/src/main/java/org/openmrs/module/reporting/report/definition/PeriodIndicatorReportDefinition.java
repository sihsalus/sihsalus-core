...
/**
 * A thin wrapper around a ReportDefinition that gives it startDate, endDate, and location
 * parameters, and a single {@link CohortIndicatorDataSetDefinition} by default.
 *
...
public class PeriodIndicatorReportDefinition extends ReportDefinition {
  ...
  public void addIndicator(CohortIndicator indicator) {
    addIndicator(
        indicator.getUuid(), indicator.getName(), indicator, new HashMap<String, String>());
  }
