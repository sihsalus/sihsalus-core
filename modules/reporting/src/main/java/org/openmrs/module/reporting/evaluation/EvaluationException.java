 ...
 *
 * <p>Note that this is a *checked* exception, which differs from most OpenMRS exceptions. We do
 * this because there's no other way to reliably propagate error message for exceptions in nested
 * evaluations.
 */
public class EvaluationException extends Exception {
  ...
  public String getMessage() {
    ...
    if (propertyThatFailed != null) sb.append(" " + propertyThatFailed);
    if (getCause() != null) sb.append(" because:\n" + getCause().getMessage());
    return sb.toString();
  }
