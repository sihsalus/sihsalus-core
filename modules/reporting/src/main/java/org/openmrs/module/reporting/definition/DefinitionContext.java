...
public class DefinitionContext {
  ...
  public static <T extends Definition> DefinitionService<T> getDefinitionService(
    ...
    throw new IllegalArgumentException(
        "No DefinitionService found that is registered for type " + definitionType);
  }
  ...
  /**
   * @return all definitions of the passed type, including retired if specified by the
   *     includeRetired parameter
   * @see DefinitionService#getAllDefinitions(boolean)
   */
  public static <T extends Definition> List<T> getAllDefinitions(
   ...
   */
  @SuppressWarnings("unchecked")
  public static <T extends Definition> Evaluated<T> evaluate(
      Mapped<? extends T> definition, EvaluationContext context) throws EvaluationException {
    Class<T> c = (Class<T>) definition.getClass();
