...
public class AggregationUtil {
  ...
  /**
   * Utility method which takes a Collection of Numbers, and returns this back as a List, in order
   * of each Number's double value If removeNull is true, null values will be ignored and not
   * returned If removeNull is false, null values will be sorted to the end of the list
   *
