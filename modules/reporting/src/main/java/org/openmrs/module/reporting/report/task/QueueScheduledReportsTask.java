...
/**
 * This task checks whether any reports are scheduled to be run at that time. If it finds any
 * matches, it clones them and adds the report request to the queue
 */
public class QueueScheduledReportsTask extends ReportingTask {
  ...
  public synchronized void executeTask() {
    ...
    for (ReportRequest scheduledReport :
        getReportService().getReportRequests(null, null, null, Status.SCHEDULED)) {
      try {
