...
public class ListConverter implements DataConverter {
  ...
  public Object convert(Object original) {
    ...
    if (l != null) {
      ...
      // Next, handle the case where a certain number of items from the beginning or end of the list
      // is requested
      TimeQualifier which = ObjectUtil.nvl(whichItems, TimeQualifier.ANY);
      int max =
          (maxNumberOfItems == null || maxNumberOfItems > l.size() ? l.size() : maxNumberOfItems);
