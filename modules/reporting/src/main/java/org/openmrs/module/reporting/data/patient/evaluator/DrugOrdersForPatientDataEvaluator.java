...
public class DrugOrdersForPatientDataEvaluator implements PatientDataEvaluator {
  ...
  private static final String ORDER_STOP_DATE_FIELD_NAME =
      (ModuleUtil.compareVersion(OpenmrsConstants.OPENMRS_VERSION_SHORT, "1.10") > -1)
          ? NEW_STOP_DATE_FIELD_NAME
          : "discontinuedDate";

  private static final String ORDER_ACTIVATION_DATE_FIELD_NAME =
      (ModuleUtil.compareVersion(OpenmrsConstants.OPENMRS_VERSION_SHORT, "1.10") > -1)
          ? "dateActivated"
          : "startDate";
