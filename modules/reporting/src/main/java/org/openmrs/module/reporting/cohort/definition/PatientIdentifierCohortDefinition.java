...
public class PatientIdentifierCohortDefinition extends BaseCohortDefinition {
  ...
  @ConfigurationProperty private List<PatientIdentifierType> typesToMatch;

  @ConfigurationProperty private List<Location> locationsToMatch;

  @ConfigurationProperty
  private String
      textToMatch; // This can contain % as a wild card.  So "ID-%" matches anything that starts

  // with "ID-"

  @ConfigurationProperty private String regexToMatch;
