...
/**
 * The cohort definition dimension category uses a cohort definition to narrow patients into a
 * specific category. For example, the "male" category would use the GenderCohortDefinition
 * (gender=M) to narrow a set of patients into the "male" category.
 */
public class CohortDefinitionDimensionCategory implements DimensionCategory {
  ...
  private Mapped<CohortDefinition>
      cohortDefinition; // the cohort definition that narrows patients in this category

  public CohortDefinitionDimensionCategory(
      String uniqueName, CohortDefinition cohortDefinition, Map<String, Object> parameterMapping) {
