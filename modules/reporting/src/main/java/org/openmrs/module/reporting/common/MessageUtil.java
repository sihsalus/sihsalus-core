...
public class MessageUtil {
  ...
  public static String translate(
      String messageCode, Object[] args, String defaultMessage, Locale locale) {
  ...
  /**
   * @return the active message source, returning from the cache if present, otherwise from the
   *     service
   */
  ...
  /**
   * @param messageSource enables configuring a specific message source to be used, or to reset the
   *     cached value
   */
