...
/**
 * Provides base queries shared by various evaluator subclasses for each ObsCohortDefinition TODO:
 * Rewrite this with HQL
 */
public abstract class BaseObsCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
  ...
  /**
   * Encapsulates the common logic between getPatientsHavingRangedObs and
   * getPatientsHavingDiscreteObs
   *
   * <p>The arguments passed in fall into two types:
   *
   * <ol>
   *   <li>arguments that limit which obs we will look at
   *       <ul>
   *         <li>cd
   *       </ul>
   *   <li>arguments that the obs values must match after being limited by the above arguments
   *       <ul>
   *         <li>operator1
   *         <li>value1
   *         <li>operator2
   ...
   * </ol>
   */
  protected Cohort getPatientsHavingObs(
      BaseObsCohortDefinition cd,
      RangeComparator operator1,
      Object value1,
      RangeComparator operator2,
      Object value2,
      SetComparator setOperator,
    ...
    boolean doSqlAggregation =
        tm == TimeModifier.MIN || tm == TimeModifier.MAX || tm == TimeModifier.AVG;
    ...
    if (value1 != null || value2 != null) {
      valueSql =
          (value1 != null && value1 instanceof Number) ? " o.value_numeric " : " o.value_datetime ";
    ...
    if (tm == TimeModifier.ANY || tm == TimeModifier.NO) {
      ...
      sql.append(
          "             where obs.voided = false and obs.concept_id = :questionConceptId "
              + dateAndLocationSqlForSubquery
              + " group by person_id ");
      sql.append(" ) subq on o.person_id = subq.person_id and o.obs_datetime = subq.odt ");
      sql.append(
          " where o.voided = false and p.voided = false and o.concept_id = :questionConceptId ");
      sql.append(dateAndLocationSql);
