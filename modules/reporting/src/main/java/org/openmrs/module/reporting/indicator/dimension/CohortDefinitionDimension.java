...
public class CohortDefinitionDimension extends BaseDefinition implements CohortDimension {
  ...
  @ConfigurationProperty private Map<String, Mapped<CohortDefinition>> cohortDefinitions;
   ...
   */
  public void addCohortDefinition(
      String key, CohortDefinition definition, Map<String, Object> mappings) {
