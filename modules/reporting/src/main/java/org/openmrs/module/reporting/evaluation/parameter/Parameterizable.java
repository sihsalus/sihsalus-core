...
/**
 * A class that implements this interface indicates that it is capable of being configured at
...
public interface Parameterizable extends OpenmrsMetadata {
   ...
   *
   * @param parameterName the name of the {@link Parameter} to remove
   */
