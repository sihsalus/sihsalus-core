 ...
 */
public abstract class CompositionQuery<Q extends Query<T>, T extends OpenmrsObject>
    extends BaseQuery<T> {
  ...
  /**
   * This method allows for setting the composition string and query elements based on the passed in
   * arguments
   */
  ...
  /**
   * This method will initialize this CompositionQuery with the passed Queries all combined with the
   * passed boolean operator
   */
