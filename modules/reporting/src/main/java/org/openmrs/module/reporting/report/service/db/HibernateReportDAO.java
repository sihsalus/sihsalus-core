...
public class HibernateReportDAO implements ReportDAO {
  ...
  /**
   * Return a list of {@link ReportDesign}s for the passed {@link ReportDefinition} and {@link
   * ReportRenderer} class, optionally including those that are retired
   *
  ...
  public ReportProcessorConfiguration saveReportProcessorConfiguration(
    ...
    return (ReportProcessorConfiguration)
        sessionFactory.getCurrentSession().merge(processorConfiguration);
  }
  ...
  public ReportProcessorConfiguration getReportProcessorConfiguration(Integer id) {
    return (ReportProcessorConfiguration)
        sessionFactory.getCurrentSession().get(ReportProcessorConfiguration.class, id);
  }
