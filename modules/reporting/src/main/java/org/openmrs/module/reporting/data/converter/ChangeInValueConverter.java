...
/**
 * Takes in a List of objects in a pre-defined order, a Converter to get the value to check, and
 * returns a new List that removes any elements that have the same value as the one which preceeded
 * it
 */
