...
public class PersonAttributeCohortDefinition extends BaseCohortDefinition {
  ...
  // ***** PROPERTIES *****
  /** Configuration group that allows you to match on the person attribute type. */
  @ConfigurationProperty(group = "attributeTypeGroup")
  private PersonAttributeType attributeType;

  /** Configuration group that allows you to match on the person attribute value. */
    ...
    if (value != null) {
      if (value instanceof Concept) {
        ...
        throw new IllegalArgumentException(
            "You cannot add value " + value + " that is not a Location, Concept, or String");
      }
    }
  }
