...
public class DataSetDefinitionServiceImpl extends BaseDefinitionService<DataSetDefinition>
    implements DataSetDefinitionService {
   ...
   */
  @Override
  public DataSet evaluate(Mapped<? extends DataSetDefinition> definition, EvaluationContext context)
      throws EvaluationException {
    return (DataSet) super.evaluate(definition, context);
  }
}
