...
/**
 * Convenience class that gives you a shorthand way of getting common cohorts of patients.
 * Evaluation is still done using the whole framework, e.g. caching is done (if you provide an
 * EvaluationContext), and test patients are excluded
 */
public class Cohorts {

  /**
   * If your use case allows it you should always use #allPatients(EvaluationContext); this method
   * will not cache results, which can significantly impact efficiency.
   *
   * @return All non-test patients in the system (with test patients excluded per the global
   *     property {@link
   *     org.openmrs.module.reporting.ReportingConstants#GLOBAL_PROPERTY_TEST_PATIENTS_COHORT_DEFINITION}
   */
