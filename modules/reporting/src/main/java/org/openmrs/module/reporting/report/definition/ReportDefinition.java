...
/**
 * This class represents the metadata that describes a particular report that can be evaluated. A
 * {@link ReportDefinition} will typically be evaluated upon a base {@link Cohort} in the context of
 * an {@link EvaluationContext}. Evaluating a report generally means evaluating all of the {@link
 * DataSetDefinition}s it contains, resulting in a {@link ReportData}.
 *
...
public class ReportDefinition extends BaseDefinition {
  ...
  @ConfigurationProperty private Mapped<? extends CohortDefinition> baseCohortDefinition;
   ...
   *
   * @return true If report definition has at least one dataset definition. false If report
   *     definition has no dataset definitions.
   */
   ...
   * @param definition the DataSetDefinition to add
   */
  public void addDataSetDefinition(
      String key, DataSetDefinition definition, Map<String, Object> mappings) {
   ...
   * @param cohortDefinition the baseCohortDefinition to set
   */
  public void setBaseCohortDefinition(
      CohortDefinition cohortDefinition, Map<String, Object> mappings) {
   ...
   */
  public void setDataSetDefinitions(
