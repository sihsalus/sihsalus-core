...
public class ConvertedPersonDataDefinition extends ConvertedDataDefinition<PersonDataDefinition>
  ...
  /** Default Constructor */
  public ConvertedPersonDataDefinition(
      String name, PersonDataDefinition definitionToConvert, DataConverter... converters) {
