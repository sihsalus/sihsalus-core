...
/**
 * Fetches other encounters with the same patient and encounterDatetime as the one in question E.g.
 * you could find any encounters of type "Admission" simultaneous to visit note encounters
 */
@Caching(strategy = ConfigurationPropertyCachingStrategy.class)
public class SimultaneousEncountersDataDefinition extends BaseDataDefinition
    implements EncounterDataDefinition {

  public static final long serialVersionUID = 1L;

  @ConfigurationProperty private List<EncounterType> encounterTypeList;
