...
public class Age {
  ...
  public Integer getFullYears() {
    if (birthDate != null) {
      return Years.yearsBetween(
              birthDate.withTimeAtStartOfDay(), currentDate.withTimeAtStartOfDay())
          .getYears();
    }
    return null;
  }
  ...
  public boolean equals(Object o) {
    ...
    Age other = (Age) o;
    return OpenmrsUtil.nullSafeEquals(getBirthDate(), other.getBirthDate())
        && OpenmrsUtil.nullSafeEquals(getCurrentDate(), other.getCurrentDate());
  }

  @Override
  public int hashCode() {
    return (getBirthDate() != null ? getBirthDate().hashCode() : 0)
        + (getCurrentDate() != null ? getCurrentDate().hashCode() : 0);
  }
