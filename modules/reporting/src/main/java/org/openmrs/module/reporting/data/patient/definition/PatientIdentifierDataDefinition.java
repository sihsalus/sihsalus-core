...
public class PatientIdentifierDataDefinition extends BaseDataDefinition
  ...
  @ConfigurationProperty private Boolean includeFirstNonNullOnly = Boolean.FALSE;
  ...
  /**
   * @param includeFirstNonNullOnly whether or not to include only the first non-null value for each
   *     patient
   */
