...
public class ConvertedEncounterDataEvaluator implements EncounterDataEvaluator {
  ...
  /**
   * @see
   *     org.openmrs.module.reporting.data.patient.evaluator.PatientDataEvaluator#evaluate(org.openmrs.module.reporting.data.patient.definition.PatientDataDefinition,
  ...
  public EvaluatedEncounterData evaluate(
    ...
    EvaluatedEncounterData unconvertedData =
        Context.getService(EncounterDataService.class)
            .evaluate(def.getDefinitionToConvert(), context);
