...
public class ReportDesignRendererTest extends BaseModuleContextSensitiveTest {
  ...
  @Test
  public void getFilenameBase_shouldHaveSensibleDefaultIfNotSpecifiedAsDesignProperty()
      throws Exception {
  ...
  public void getFilenameBase_shouldBeBasedOnDesignProperty() throws Exception {
    ...
    design.addPropertyValue(
        ...
        "{{formatDate request.evaluateStartDatetime \"yyyyMMdd\"}}-{{request.reportDefinition.parameterizable.name}}");
