  ...
  public void evaluate_shouldSupportIntegerParameter() throws Exception {
    ...
    Cohort allPatients =
        cohortDefinitionService.evaluate(
            new AllPatientsCohortDefinition(), new EvaluationContext());
    Cohort males =
        cohortDefinitionService.evaluate(
    ...
    OptionalParameterCohortDefinition cd =
        new OptionalParameterCohortDefinition(gender, "maleIncluded", "femaleIncluded");
