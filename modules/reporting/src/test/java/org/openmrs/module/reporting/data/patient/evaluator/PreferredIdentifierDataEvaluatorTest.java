...
public class PreferredIdentifierDataEvaluatorTest extends BaseModuleContextSensitiveTest {
   ...
   * @verifies return the preferred identifier of the passed type for each patient in the passed
   *     context
   */
  @Test
  public void
      evaluate_shouldReturnThePreferredIdentifierOfThePassedTypeForEachPatientInThePassedContext()
          throws Exception {
    ...
    Assert.assertEquals(
        3,
        pd.getData()
            .size()); // TODO: Is this what we want, or do we want all 4 patients returned, with
   ...
   */
  @Test
  public void evaluate_shouldLimitTheReturnedIdentifierToTheConfiguredLocationIfSet()
      throws Exception {
