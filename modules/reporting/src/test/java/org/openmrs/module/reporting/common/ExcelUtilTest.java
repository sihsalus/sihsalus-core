...
public class ExcelUtilTest extends BaseModuleContextSensitiveTest {
  ...
  public void shouldGetCellContents() throws Exception {
    Workbook wb =
        ExcelUtil.loadWorkbookFromResource("org/openmrs/module/reporting/common/ExcelUtilTest.xls");
  ...
  public void shouldFormatSheetTitle() throws Exception {
    ...
    Assert.assertEquals(
        "This is a title with over 31 ch",
  ...
  protected void testCellContentsToTheRightOf(
      Sheet sheet, String contentsBefore, Object contentsToTest) {
  ...
  protected void testSettingCellContents(
      Sheet sheet,
      String contentsBefore,
      Object valueToSet,
      int expectedCellType,
