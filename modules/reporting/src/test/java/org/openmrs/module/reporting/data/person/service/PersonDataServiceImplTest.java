...
public class PersonDataServiceImplTest extends BaseModuleContextSensitiveTest {
  ...
  public void evaluate_shouldEvaluateAnPersonData() throws Exception {
    ...
    PersonData data =
        Context.getService(PersonDataService.class).evaluate(definition, new EvaluationContext());
  ...
  public void saveDefinition_shouldSaveAnPersonData() throws Exception {
    ...
    PersonDataDefinition loadedDefinition =
        Context.getService(PersonDataService.class).getDefinitionByUuid(definition.getUuid());
