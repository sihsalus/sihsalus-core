...
public class BirthAndDeathCohortDefinitionEvaluatorTest extends BaseModuleContextSensitiveTest {
  ...
  /**
   * @see {@link
   *     BirthAndDeathCohortDefinitionEvaluator#evaluate(CohortDefinition,EvaluationContext)}
   */
  @Test
  @Verifies(
      value = "should find patients by birth range",
  ...
  @Test
  @Verifies(
      value = "should find patients by death range",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  ...
  @Test
  @Verifies(
      value = "should find patients by birth range and death range",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  ...
  @Test
  @Verifies(
      value = "should find patients born on the onOrBefore date if passed in time is at midnight",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  public void evaluate_shouldFindPatientsBornOnTheOnOrBeforeDateIfPassedInTimeIsAtMidnight()
      throws Exception {
  ...
  @Verifies(
      ...
      method = "evaluate(CohortDefinition,EvaluationContext)")
  public void evaluate_shouldFindPatientsThatDiedOnTheOnOrBeforeDateIfPassedInTimeIsAtMidnight()
      throws Exception {
    PatientService ps = Context.getPatientService();
  ...
  @Test
  @Verifies(
      value = "should find patients born after the specified date",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  ...
  @Test
  @Verifies(
      value = "should find patients that died after the specified date",
      method = "evaluate(CohortDefinition,EvaluationContext)")
