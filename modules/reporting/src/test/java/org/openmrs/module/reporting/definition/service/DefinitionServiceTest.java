...
public class DefinitionServiceTest extends BaseModuleContextSensitiveTest {
   ...
   *
   * <p>In JDK 1.7 inner classes must be static to be properly deserialized by xstream.
   *
   * @see DefinitionService#getDefinitionByUuid(String)
   * @verifies deserialize CohortIndicatorAndDimensionDataSetDefinition
   */
  @Test
  public void getDefinitionByUuid_shouldDeserializeCohortIndicatorAndDimensionDataSetDefinition()
      throws Exception {
    executeDataSet("org/openmrs/module/reporting/include/DefinitionServiceTest.xml");

    CohortIndicatorAndDimensionDataSetDefinition persistedDefinition =
        (CohortIndicatorAndDimensionDataSetDefinition)
            dataSetDefinitionService.getDefinitionByUuid("bb1dc014-82a0-4847-8bcd-f74f91282e8d");
