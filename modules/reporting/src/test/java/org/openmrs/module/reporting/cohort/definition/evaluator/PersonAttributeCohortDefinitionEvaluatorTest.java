...
public class PersonAttributeCohortDefinitionEvaluatorTest extends BaseModuleContextSensitiveTest {
  ...
  /**
   * @see {@link
   *     PersonAttributeCohortDefinitionEvaluator#evaluate(CohortDefinition,EvaluationContext)}
   */
  @Test
  @Verifies(
      value = "should get patients having attributes with given attribute type and values",
  ...
  @Test
  @Verifies(
      value = "should get patients having any attributes",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  ...
  @Test
  @Verifies(
      value = "should get patients having attributes with any given attribute values",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  public void evaluate_shouldGetPatientsHavingAttributesWithAnyGivenAttributeValues()
      throws Exception {
    PersonAttributeCohortDefinition pacd = new PersonAttributeCohortDefinition();
  ...
  @Test
  @Verifies(
      value = "should get patients having attributes with concept attribute values",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  public void evaluate_shouldGetPatientsHavingAttributesWithLocationAttributeValues()
      throws Exception {
    PersonAttributeCohortDefinition pacd = new PersonAttributeCohortDefinition();
