...
public class EncountersForPatientDataEvaluatorTest extends BaseModuleContextSensitiveTest {
  ...
  public void shouldReturnEncountersInActiveVisit() throws Exception {
    ...
    EncounterType encounterType =
        new EncounterType("Admission", "Patient admitted for inpatient care");
    ...
    Visit v1 =
        data.visit()
            .patient(patient)
            .visitType(visitType)
            .started("2013-10-01 09:30:00")
            .stopped("2013-10-03 09:30:00")
            .location(location)
            .save();
    Encounter e1 =
        data.randomEncounter()
            ...
            .visit(v1)
            .patient(patient)
            .encounterDatetime("2013-10-01 10:30:00")
            .location(location)
            .save();
    ...
    Encounter e2 =
        data.randomEncounter()
            ...
            .visit(v2)
            .patient(patient)
            .encounterDatetime("2013-12-02 10:30:00")
            .location(location)
            .save();
    ...
    EvaluatedPatientData pd =
        Context.getService(PatientDataService.class).evaluate((PatientDataDefinition) d, context);
