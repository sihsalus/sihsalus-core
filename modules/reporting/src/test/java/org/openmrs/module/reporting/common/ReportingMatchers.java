...
public class ReportingMatchers {
  ...
  public static Matcher<Definition> hasParameter(
      final String withName,
      final Class<?> ofType,
      final Class<? extends Collection> ofCollectionType) {
      ...
      public boolean matches(Object o) {
        ...
        return parameter != null
            ...
            && ((ofCollectionType == null && parameter.getCollectionType() == null)
                || (ofCollectionType != null
                    && ofCollectionType.equals(parameter.getCollectionType())));
      }
