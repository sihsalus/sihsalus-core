...
public class MappedParametersEncounterQueryEvaluatorTest extends BaseModuleContextSensitiveTest {
  ...
  public void testEvaluate() throws Exception {
    ...
    MappedParametersEncounterQuery renamed =
        new MappedParametersEncounterQuery(original, renamedParameters);

    EvaluationContext context = new EvaluationContext();
    context.addParameterValue("date", date);
    EncounterQueryResult result =
        Context.getService(EncounterQueryService.class).evaluate(renamed, context);
