...
public class VisitCohortDefinitionEvaluatorTest extends BaseModuleContextSensitiveTest {
  ...
  @Test
  public void shouldIncludeVisit_ifActiveVisitRangeStartBeforeVisitAndRangeEndDuringVisit()
      throws Exception {
  ...
  @Test
  public void shouldIncludeVisit_ifActiveVisitRangeStartDuringVisitAndRangeEndAfterVisit()
      throws Exception {
  ...
  @Test
  public void shouldIncludeVisit_ifActiveVisitRangeStartBeforeVisitAndRangeEndAfterVisit()
      throws Exception {
  ...
  @Test
  public void shouldNotIncludeVisit_ifActiveVisitRangeStartBeforeVisitAndRangeEndBeforeVisit()
      throws Exception {
  ...
  @Test
  public void shouldIncludeVisit_ifActiveVisitRangeStartAfterVisitAndRangeEndAfterVisit()
      throws Exception {
  ...
  @Test
  public void shouldIncludeVisit_ifActiveVisitRangeStartAfterVisitStartAndVisitCurrentlyActive()
      throws Exception {

    Patient patient = data.randomPatient().birthdate("1975-05-27").save();
    // early dates to avoid active visits in standard test dataset
    Visit visit =
        data.visit().started("1999-01-01").visitType(someVisitType).patient(patient).save();
  ...
  @Test
  public void shouldNotIncludeVisit_ifActiveVisitRangeEndBeforeVisitStartAndVisitCurrentlyActive()
      throws Exception {
