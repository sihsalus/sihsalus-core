...
public class CohortQueryServiceTest extends BaseModuleContextSensitiveTest {
  ...
  @Test
  @Verifies(
      value = "should get patients having encounters with a specified provider",
      method =
          "getPatientsHavingEncounters(Date, Date, TimeQualifier, List<Location>, List<Person>, List<EncounterType>, List<Form>, Integer, Integer, User, Date, Date)")
  public void getPatientsHavingEncounters_shouldGetPatientsHavingEncountersWithASpecifiedProvider()
      throws Exception {
    ...
    Cohort cohort =
        service.getPatientsHavingEncounters(
            null,
            null,
            TimeQualifier.ANY,
            null,
