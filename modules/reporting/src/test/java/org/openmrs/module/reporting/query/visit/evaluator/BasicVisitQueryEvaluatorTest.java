...
public class BasicVisitQueryEvaluatorTest extends BaseModuleContextSensitiveTest {
  ...
  @Autowired private VisitQueryService visitQueryService;
  ...
  public void testEvaluate() throws Exception {
...

    {
      ...
      query.setStartedOnOrBefore(
          DateUtil.adjustDate(
              visitService.getVisit(activeVisits.get(0)).getStartDatetime(),
              -1,
              DurationUnit.DAYS));
...

    {
      ...
      query.setStartedOnOrBefore(
          DateUtil.adjustDate(inactive1.getStartDatetime(), +1, DurationUnit.DAYS));
...

    {
      ...
      query.setStartedOnOrBefore(
          DateUtil.adjustDate(inactive1.getStartDatetime(), +1, DurationUnit.DAYS));
      query.setEndedOnOrAfter(inactive1.getStopDatetime());
      query.setEndedOnOrBefore(
          DateUtil.adjustDate(inactive1.getStopDatetime(), +1, DurationUnit.DAYS));
      VisitQueryResult result = visitQueryService.evaluate(query, new VisitEvaluationContext());
