...
public class EncounterCohortDefinitionEvaluatorTest extends BaseModuleContextSensitiveTest {
  ...
  public void
      evaluate_shouldReturnAllPatientsWithEncountersIfAllArgumentsToCohortDefinitionAreEmpty()
          throws Exception {
    EncounterCohortDefinition cd = new EncounterCohortDefinition();
    cd.setEncounterTypeList(
        new ArrayList<EncounterType>()); // this is a regression test for a NPE on empty lists
  ...
  @Test
  @Verifies(
      value = "should return correct patients when all non grouping parameters are set",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  public void evaluate_shouldReturnCorrectPatientsWhenAllNonGroupingParametersAreSet()
      throws Exception {
    EncounterCohortDefinition cd = new EncounterCohortDefinition();
  ...
  @Test
  @Verifies(
      value = "should return correct patients when all parameters are set",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  ...
  @Test
  @Verifies(
      value = "should return correct patients when creation date parameters are set",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  public void evaluate_shouldReturnCorrectPatientsWhenCreationDateParametersAreSet()
      throws Exception {
    ...
    // If parameter dates do have time components, they should return all encounters between the
    // specific datetimes
    {
      EncounterCohortDefinition cd = new EncounterCohortDefinition();
  ...
  @Test
  @Verifies(
      value = "should return correct patients when time qualifier parameters are set",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  public void evaluate_shouldReturnCorrectPatientsWhenTimeQualifierParametersAreSet()
      throws Exception {
    ...
    // None specified use case
    {
      ...
      Assert.assertEquals(
          3, DefinitionContext.getCohortDefinitionService().evaluate(cd, context).size());
    }
    ...
    }
    {
      ...
      Assert.assertEquals(
          2, DefinitionContext.getCohortDefinitionService().evaluate(cd, context).size());
    }
  ...
  public void evaluate_shouldReturnCorrectPatientsWhenProviderParametersAreSet() throws Exception {
    ...
    Assert.assertEquals(
        2,
        DefinitionContext.getCohortDefinitionService()
            .evaluate(cd, new EvaluationContext())
            .size());
  }
  ...
  @Test
  @Verifies(
      value = "should not return voided patients",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  ...
  @Verifies(
      ...
      method = "evaluate(CohortDefinition,EvaluationContext)")
  public void
      evaluate_shouldFindPatientsWithEncountersOnTheOnOrBeforeDateIfPassedInTimeIsAtMidnight()
          throws Exception {
  ...
  @Verifies(
      ...
      method = "evaluate(CohortDefinition,EvaluationContext)")
  public void
      evaluate_shouldFindPatientsWithEncountersCreatedOnTheSpecifiedDateIfPassedInTimeIsAtMidnight()
          throws Exception {
