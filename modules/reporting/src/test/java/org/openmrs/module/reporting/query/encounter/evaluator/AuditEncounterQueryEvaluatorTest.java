...
public class AuditEncounterQueryEvaluatorTest extends BaseModuleContextSensitiveTest {
  ...
  public void setup() throws Exception {
    ...
    e1 =
        data.randomEncounter()
            ...
            .dateCreated("2013-08-09 10:10:10")
            .save()
            .getId();
    e2 =
        data.randomEncounter()
    ...
    e3 =
        data.randomEncounter()
            .patient(patient)
            .encounterType("Scheduled")
            .dateCreated("2013-08-10 09:09:09")
            .save()
            .getId();
    e4 =
        data.randomEncounter()
            ...
            .dateCreated("2013-08-11 10:10:10")
            .save()
            .getId();
  }
  ...
  public void evaluate_shouldFilterByEncounterType() throws Exception {
    AuditEncounterQuery query = new AuditEncounterQuery();
    query.setEncounterTypes(
        Arrays.asList(Context.getEncounterService().getEncounterType("Scheduled")));
    testQueryResults(query, e1, e2);
    query.setEncounterTypes(
        Arrays.asList(Context.getEncounterService().getEncounterType("Emergency")));
