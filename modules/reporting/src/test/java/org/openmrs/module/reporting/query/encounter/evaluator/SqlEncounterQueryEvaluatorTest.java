...
public class SqlEncounterQueryEvaluatorTest extends BaseModuleContextSensitiveTest {
  ...
  @Test
  public void evaluate_shouldFilterResultsGivenABaseEncounterQueryInAnEvaluationContext()
      throws Exception {
  ...
  public EncounterQueryResult evaluate(SqlEncounterQuery definition, EvaluationContext context)
      throws Exception {
