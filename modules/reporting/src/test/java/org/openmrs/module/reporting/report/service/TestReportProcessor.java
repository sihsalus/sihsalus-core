...
public class TestReportProcessor implements ReportProcessor {
  ...
  /**
   * This adds an error message to the report -- I just want the processor to do something, so i
   * know that it ran
   *
   * @param report the Report to process
   */
  public void process(Report report, Properties configuration) {
    // using error message as a very simple way to pass something back to ReportServiceTest test
    // cases.
