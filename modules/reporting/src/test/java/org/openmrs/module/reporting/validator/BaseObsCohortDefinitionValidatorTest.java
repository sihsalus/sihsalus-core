...
public class BaseObsCohortDefinitionValidatorTest extends BaseModuleContextSensitiveTest {
  ...
  @Test
  @Verifies(
      value = "should fail validation if time modifier is null",
      method = "validate(Object,Errors)")
  public void validate_shouldFailValidationIfTimeModifierIsNullForCodedObsCohortDefinition()
      throws Exception {
  ...
  @Test
  @Verifies(
      value = "should fail validation if question is null",
      method = "validate(Object,Errors)")
  public void validate_shouldFailValidationIfQuestionIsNullForCodedObsCohortDefinition()
      throws Exception {
    CodedObsCohortDefinition codedObsCohortDefinition = new CodedObsCohortDefinition();
  ...
  @Verifies(
      ...
      method = "validate(Object,Errors)")
  public void validate_shouldPassValidationIfAllFieldsAreCorrectForCodedObsCohortDefinition()
      throws Exception {
    CodedObsCohortDefinition codedObsCohortDefinition = new CodedObsCohortDefinition();
  ...
  @Verifies(
      value = "should fail validation if time modifier is null",
      method = "validate(Object,Errors)")
  public void validate_shouldFailValidationIfTimeModifierIsNullForDateObsCohortDefinition()
      throws Exception {
  ...
  @Verifies(
      value = "should fail validation if question is null",
      method = "validate(Object,Errors)")
  public void validate_shouldFailValidationIfQuestionIsNullForDateObsCohortDefinition()
      throws Exception {
    DateObsCohortDefinition dateObsCohortDefinition = new DateObsCohortDefinition();
  ...
  @Verifies(
      value = "should pass validation if all fields are correct",
      method = "validate(Object,Errors)")
  public void validate_shouldPassValidationIfAllFieldsAreCorrectForDateObsCohortDefinition()
      throws Exception {
    DateObsCohortDefinition dateObsCohortDefinition = new DateObsCohortDefinition();
  ...
  @Verifies(
      value = "should fail validation if time modifier is null",
      method = "validate(Object,Errors)")
  public void validate_shouldFailValidationIfTimeModifierIsNullForNumericObsCohortDefinition()
      throws Exception {
  ...
  @Verifies(
      value = "should fail validation if question is null",
      method = "validate(Object,Errors)")
  public void validate_shouldFailValidationIfQuestionIsNullForNumericObsCohortDefinition()
      throws Exception {
    NumericObsCohortDefinition numericObsCohortDefinition = new NumericObsCohortDefinition();
  ...
  @Verifies(
      value = "should pass validation if all fields are correct",
      method = "validate(Object,Errors)")
  public void validate_shouldPassValidationIfAllFieldsAreCorrectForNumericObsCohortDefinition()
      throws Exception {
    NumericObsCohortDefinition numericObsCohortDefinition = new NumericObsCohortDefinition();
  ...
  @Verifies(
      value = "should fail validation if time modifier is null",
      method = "validate(Object,Errors)")
  public void validate_shouldFailValidationIfTimeModifierIsNullForTextObsCohortDefinition()
      throws Exception {
  ...
  @Verifies(
      value = "should fail validation if question is null",
      method = "validate(Object,Errors)")
  public void validate_shouldFailValidationIfQuestionIsNullForTextObsCohortDefinition()
      throws Exception {
    TextObsCohortDefinition textObsCohortDefinition = new TextObsCohortDefinition();
  ...
  @Verifies(
      value = "should pass validation if all fields are correct",
      method = "validate(Object,Errors)")
  public void validate_shouldPassValidationIfAllFieldsAreCorrectForTextObsCohortDefinition()
      throws Exception {
    TextObsCohortDefinition textObsCohortDefinition = new TextObsCohortDefinition();
