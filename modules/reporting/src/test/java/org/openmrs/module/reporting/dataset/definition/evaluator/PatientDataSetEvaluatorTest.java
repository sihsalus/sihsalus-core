...
public class PatientDataSetEvaluatorTest extends BaseModuleContextSensitiveTest {
  ...
  public void evaluate_shouldExportPersonData() throws Exception {
    ...
    SimpleDataSet dataset =
        (SimpleDataSet)
            Context.getService(DataSetDefinitionService.class).evaluate(d, getEvaluationContext());
  ...
  public void evaluate_shouldExportParameterizedData() throws Exception {
    ...
    d.addColumn(
        "Age in Months At End", ageOnDate, "effectiveDate=${endDate}", new AgeConverter("{m}"));
  ...
  public void evaluate_shouldExportAMultiColumnDataItem() throws Exception {
    ...
    encounterDataSet.addColumn(
        "Last Encounter Type", new EncounterTypeDataDefinition(), null, new ObjectFormatter());
    encounterDataSet.addColumn(
        "Last Encounter Date",
  ...
  public void evaluate_shouldExportAndFlattenAMultiValueDataItem() throws Exception {
    ...
    encounterDataSet.addColumn(
        "Encounter Type", new EncounterTypeDataDefinition(), null, new ObjectFormatter());
    encounterDataSet.addColumn(
        "Encounter Date",
        new EncounterDatetimeDataDefinition(),
        null,
