...
public class CompositionCohortDefinitionValidatorTest extends BaseModuleContextSensitiveTest {
  ...
  @Test
  @Verifies(
      value = "should fail validation if searches is null",
  ...
  @Test
  @Verifies(
      value = "should fail validation if searches is empty",
      method = "validate(Object,Errors)")
  ...
  @Test
  @Verifies(
      value = "should fail validation if composition string is null",
      method = "validate(Object,Errors)")
  public void validate_shouldFailValidationIfCompositionStringIsNull() throws Exception {
    HashMap<String, Mapped<CohortDefinition>> searches =
        new HashMap<String, Mapped<CohortDefinition>>();
  ...
  @Test
  @Verifies(
      value = "should fail validation if composition string is empty",
      method = "validate(Object,Errors)")
