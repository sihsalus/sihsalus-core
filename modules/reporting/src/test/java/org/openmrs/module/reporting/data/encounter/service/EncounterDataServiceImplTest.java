...
public class EncounterDataServiceImplTest extends BaseModuleContextSensitiveTest {
  ...
  public void evaluate_shouldEvaluateAnEncounterData() throws Exception {
    ...
    EncounterData data =
        Context.getService(EncounterDataService.class)
            .evaluate(definition, new EvaluationContext());
  ...
  public void saveDefinition_shouldSaveAnEncounterData() throws Exception {
    ...
    EncounterDataDefinition loadedDefinition =
        Context.getService(EncounterDataService.class).getDefinitionByUuid(definition.getUuid());
