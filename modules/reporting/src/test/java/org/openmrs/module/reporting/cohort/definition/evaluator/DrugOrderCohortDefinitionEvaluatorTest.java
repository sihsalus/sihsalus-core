...
public class DrugOrderCohortDefinitionEvaluatorTest extends BaseModuleContextSensitiveTest {
  ...
  protected static final String TEST_DATA =
      "org/openmrs/module/reporting/include/DrugOrderCohortEvaluationData.xml";
  ...
  public void evaluateShouldReturnAllPatients() throws Exception {
    Cohort cohort =
        Context.getService(CohortDefinitionService.class).evaluate(cohortDefinition, null);
  ...
  @Test
  public void evaluateShouldReturnAllPatientsThatHaveTakenAnyListedDrugByDefault()
      throws Exception {
    List drugSetList = new ArrayList<Concept>();
  ...
  @Test
  public void evaluateShouldReturnAllPatientsWhoStartedTakingDrugsBeforeSpecifiedDate()
      throws Exception {
  ...
  @Test
  public void evaluateShouldReturnAllPatientsWhoStartedTakingDrugsAfterSpecifiedDate()
      throws Exception {
