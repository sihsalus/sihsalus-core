...
public class ProgramStatesForPatientDataEvaluatorTest extends BaseModuleContextSensitiveTest {
  ...
  public void evaluate_shouldReturnPatientStatesThatAreActiveOnAGivenDate() throws Exception {
    ...
    def.setState(
        Context.getProgramWorkflowService().getStateByUuid("0d521bb4-2edb-4dd1-8d9f-34489bb4d9ea"));
   ...
   */
  @Test
  public void evaluate_shouldReturnTheLastPatientStateByStateStartDateAndEnrollmentDate()
      throws Exception {
    EvaluationContext context = new EvaluationContext();
