...
public class ConvertedObsDataEvaluatorTest extends BaseModuleContextSensitiveTest {
  ...
  /**
   * @see
   *     org.openmrs.module.reporting.data.patient.evaluator.ConvertedPatientDataEvaluator#evaluate(org.openmrs.module.reporting.data.patient.definition.PatientDataDefinition,
  ...
  public void evaluate_shouldReturnConvertedData() throws Exception {
    ...
    EncounterToObsDataDefinition d =
        new EncounterToObsDataDefinition(new EncounterDatetimeDataDefinition());
