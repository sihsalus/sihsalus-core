...
public class MockLogicContext implements LogicContext {
   ...
   */
  public Result eval(Integer patientId, String token, Map<String, Object> parameters)
   ...
   */
  public Result read(Integer patientId, LogicDataSource dataSource, String key)
      throws LogicException {
   ...
   */
  public Result read(Integer patientId, LogicDataSource dataSource, LogicCriteria criteria)
      throws LogicException {
