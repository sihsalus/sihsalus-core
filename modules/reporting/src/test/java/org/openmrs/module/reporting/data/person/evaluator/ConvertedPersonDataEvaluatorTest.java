...
public class ConvertedPersonDataEvaluatorTest extends BaseModuleContextSensitiveTest {
  ...
  /**
   * @see
   *     org.openmrs.module.reporting.data.person.evaluator.ConvertedPersonDataEvaluator#evaluate(org.openmrs.module.reporting.data.person.definition.PersonDataDefinition,
