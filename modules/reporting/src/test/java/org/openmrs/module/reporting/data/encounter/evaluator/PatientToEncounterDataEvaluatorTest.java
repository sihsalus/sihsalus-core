...
public class PatientToEncounterDataEvaluatorTest extends BaseModuleContextSensitiveTest {
  ...
  @Autowired
  @Qualifier("reportingEncounterDataService")
  ...
  @Test
  public void evaluate_shouldReturnPatientDataForEachEncounterInThePassedContext()
      throws Exception {
    ...
    context.setBaseEncounters(
        new EncounterIdSet(8, 9, 10)); // in our demo set include two encounters for same patient
