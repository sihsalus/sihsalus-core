...
public class CurrentPatientStateDataEvaluatorTest extends BaseModuleContextSensitiveTest {
   ...
   * @verifies return the current state of the configured workflow for each patient in the passed
   *     context
   */
  @Test
  public void
      evaluate_shouldReturnTheCurrentStateOfTheConfiguredWorkflowForEachPatientInThePassedContext()
          throws Exception {
    ...
    EvaluatedPatientData data =
        Context.getService(PatientDataService.class).evaluate(mdrtbState, context);
