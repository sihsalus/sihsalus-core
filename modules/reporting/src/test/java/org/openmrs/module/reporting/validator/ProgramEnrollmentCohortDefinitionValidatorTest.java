...
public class ProgramEnrollmentCohortDefinitionValidatorTest extends BaseModuleContextSensitiveTest {
  ...
  @Test
  @Verifies(
      value = "should fail validation if programs is null",
      method = "validate(Object,Errors)")
  public void validate_shouldFailValidationIfProgramsIsNull() throws Exception {
    ProgramEnrollmentCohortDefinition programEnrollmentCohortDefinition =
        new ProgramEnrollmentCohortDefinition();
  ...
  @Test
  @Verifies(
      value = "should fail validation if programs is empty",
      method = "validate(Object,Errors)")
