...
public class RepeatPerTimePeriodDataSetEvaluatorTest extends AuthenticatedUserTestHelper {
  ...
  public void testEvaluate() throws Exception {
    ...
    context.addParameterValue(
        "endDate", DateUtils.addMilliseconds(DateUtil.parseYmd("2014-01-01"), -1));
                ...
                argThat(
                    new ArgumentMatcher() {
                      ...
                      public boolean matches(Object argument) {
                        MultiParameterDataSetDefinition actualDelegate =
                            (MultiParameterDataSetDefinition) argument;
                        return actualDelegate
                                .getParameters()
                                .equals(expectedDelegate.getParameters())
                            && actualDelegate
                                .getIterations()
                                .equals(expectedDelegate.getIterations());
                      }
                    }),
            eq(context));
  }
  ...
  public void testEvaluateWithMoreParameters() throws Exception {
    ...
    dsd.setBaseDefinition(
        Mapped.map(
            baseDsd, "startOfPeriod=${startDate},endOfPeriod=${endDate},hospital=${location}"));
    dsd.setRepeatPerTimePeriod(TimePeriod.DAILY);
