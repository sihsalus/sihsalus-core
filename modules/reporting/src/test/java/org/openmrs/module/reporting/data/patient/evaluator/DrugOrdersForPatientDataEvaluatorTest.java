...
public class DrugOrdersForPatientDataEvaluatorTest extends BaseModuleContextSensitiveTest {
  ...
  public void evaluate_shouldReturnDrugOrdersRestrictedByDrug() throws Exception {
    ...
    DrugOrderSet history =
        (DrugOrderSet)
            Context.getService(PatientDataService.class).evaluate(def, context).getData().get(2);
    ...
    CollectionConverter drugOrderListConverter =
        new CollectionConverter(new ObjectFormatter("{drug}"), true, null);
  ...
  public void evaluate_shouldReturnDrugOrdersRestrictedByDrugConcept() throws Exception {
    ...
    EvaluatedPatientData evaluated =
        Context.getService(PatientDataService.class).evaluate(def, context);
