...
public class BuiltInEncounterDataLibraryTest extends BaseModuleContextSensitiveTest {
  ...
  @Autowired private BuiltInEncounterDataLibrary library;
  ...
  public void setUp() throws Exception {
    e1 =
        data.encounter()
            ...
            .dateCreated("2013-10-03 00:00:00.0")
            .creator(1)
            .save();
  ...
  public void testEncounterDatetime() throws EvaluationException {
    ...
    EvaluatedEncounterData data = encounterDataService.evaluate(definition, context);
    assertThat(
        (Timestamp) data.getData().get(e1.getId()),
        is(new Timestamp(DateUtil.parseYmdhms("2013-10-02 09:15:00").getTime())));
  }
  ...
  public void testEncounterDateCreated() throws EvaluationException {
    ...
    assertThat(
        (Timestamp) data.getData().get(e1.getId()),
        is(new Timestamp(DateUtil.parseYmd("2013-10-03").getTime())));
  }
}
