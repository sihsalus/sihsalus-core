...
public class SqlIndicatorTest extends BaseModuleContextSensitiveTest {
  ...
  public void setup() throws Exception {
    executeDataSet(
        "org/openmrs/module/reporting/include/"
            + new TestUtil().getTestDatasetFilename("ReportTestDataset"));
  }
  ...
  public void sqlIndicator_shouldEvaluateSqlIndicatorNullDenominator() throws Exception {
    assertIndicatorValue(
        "SELECT distinct(55) as res from patient", "SELECT distinct(null) as res from patient", 55);
  }
  ...
  public void sqlIndicator_shouldEvaluateSqlIndicatorDecimals() throws Exception {
    assertIndicatorValue(
        "SELECT distinct(.222) as res from patient",
        "SELECT distinct(.44) as res2 from patient",
        null);
  }
  ...
  protected void assertIndicatorValue(
      SqlIndicator indicator, Number expectedValue, EvaluationContext context) throws Exception {
  ...
  protected void assertIndicatorValue(SqlIndicator indicator, Number expectedValue)
      throws Exception {
  ...
  protected void assertIndicatorValue(
      String numeratorSql, String denominatorSql, Number expectedValue) throws Exception {
    SqlIndicator indicator = new SqlIndicator();
