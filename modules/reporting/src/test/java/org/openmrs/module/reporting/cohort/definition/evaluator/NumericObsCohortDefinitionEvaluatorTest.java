...
public class NumericObsCohortDefinitionEvaluatorTest extends BaseModuleContextSensitiveTest {
  ...
  @Test
  @Verifies(
      value = "should get patients with any obs of a specified concept",
  ...
  @Test
  @Verifies(
      value = "should test any with many properties specified",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  ...
  @Test
  @Verifies(
      value = "should test avg with many properties specified",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  ...
  @Test
  @Verifies(
      value = "should test last with many properties specified",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  ...
  @Test
  public void getPatientsHavingRangedObs_shouldGetPatientsWithAnyObsOfASpecifiedConcept()
      throws Exception {
    Cohort cohort =
        getCohort(
            TimeModifier.ANY, new Concept(5089), null, null, null, null, null, null, null, null);
    assertCohort(cohort, 7, 20, 21, 22);
  }

  @Test
  public void
      getPatientsHavingRangedObs_shouldGetPatientsWhoseFirstObsOfASpecifiedConceptIsInARange()
          throws Exception {
    Cohort cohort =
        getCohort(
            TimeModifier.FIRST,
  ...
  @Test
  public void
      getPatientsHavingRangedObs_shouldGetPatientsWhoseMaximumObsOfASpecifiedConceptIsEqualToASpecifiedValue()
          throws Exception {
    Cohort cohort =
        getCohort(
            TimeModifier.MAX,
  ...
  @Test
  public void
      getPatientsHavingRangedObs_shouldGetPatientsWithAnyObsOfASpecifiedConceptInASpecifiedEncounterType()
          throws Exception {
  ...
  @Test
  public void
      getPatientsHavingRangedObs_shouldGetPatientsWhoseFirstObsOfASpecifiedConceptInASpecifiedEncounterTypeIsInARange()
          throws Exception {
    List<EncounterType> encTypeList = Collections.singletonList(new EncounterType(1));
    Cohort cohort =
        getCohort(
  ...
  @Test
  public void
      getPatientsHavingRangedObs_shouldGetPatientsWhoseMaximumObsOfASpecifiedConceptInASpecifiedEncounterTypeIsEqualsToASpecifiedValue()
          throws Exception {
    List<EncounterType> encTypeList = Collections.singletonList(new EncounterType(1));
    Cohort cohort =
        getCohort(
  ...
  @Test
  public void getPatientsHavingRangedObs_shouldGetPatientsWithAQueryWithAllParameters()
      throws Exception {
  ...
  private void assertCohort(Cohort cohort, Integer... memberIds) {
    Assert.assertEquals(
        "Cohort was supposed to be: "
            + Arrays.asList(memberIds)
            + " but was instead: "
            + cohort.getCommaSeparatedPatientIds(),
        memberIds.length,
        cohort.size());
