...
public class PatientCalculationDataEvaluatorTest extends BaseModuleContextSensitiveTest {
   ...
   * @see
   *     PatientCalculationDataEvaluator#evaluate(org.openmrs.module.reporting.data.patient.definition.PatientDataDefinition,
   *     org.openmrs.module.reporting.evaluation.EvaluationContext)
   */
  @Test
  public void evaluate_shouldReturnDataGeneratedByTheCalculationReferencedByTheDefinition()
      throws Exception {
    // set up the context
    ...
    // create a definition
    PatientCalculationDataDefinition d =
        new PatientCalculationDataDefinition("Example", registration);
  ...
  public void evaluate_shouldThrowAnErrorIfNoCalculationRegistrationExistsOnTheDefinition()
      throws Exception {
    EvaluationContext context = new EvaluationContext();
