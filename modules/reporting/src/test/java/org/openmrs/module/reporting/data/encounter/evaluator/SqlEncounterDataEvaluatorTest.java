...
public class SqlEncounterDataEvaluatorTest extends BaseModuleContextSensitiveTest {
  ...
  public void testEvaluate() throws Exception {
    String sql =
        "select e.encounter_id, o.value_coded from encounter e inner join obs o on e.encounter_id = o.encounter_id where o.concept_id = 21 and e.encounter_id in (:encounterIds)";
