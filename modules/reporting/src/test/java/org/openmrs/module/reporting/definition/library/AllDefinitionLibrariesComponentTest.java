...
import org.openmrs.module.reporting.definition.library.implementerconfigured.ImplementerConfiguredEncounterDataDefinitionLibrary;
import org.openmrs.module.reporting.definition.library.implementerconfigured.ImplementerConfiguredPatientDataDefinitionLibrary;
...
public class AllDefinitionLibrariesComponentTest extends BaseModuleContextSensitiveTest {
  ...
  @Autowired AllDefinitionLibraries libraries;
  ...
  public void testGetAllDefinitionTypes() throws Exception {
    assertThat(
        libraries.getAllDefinitionTypes(),
        containsInAnyOrder(
