...
/** */
public class CohortsWithVaryingParametersDataSetEvaluatorTest
  ...
  @Autowired DataSetDefinitionService dsdService;
  ...
  public void testEvaluate() throws Exception {
    ...
    CohortsWithVaryingParametersDataSetDefinition dsd =
        new CohortsWithVaryingParametersDataSetDefinition();
    dsd.addColumn(cd);
    ...
    assertThat(
        (Cohort) row.getColumnValue("Has Encounter"),
        isCohortWithExactlyIds(7, 20, 21, 22, 23, 24));
  }
  ...
  /**
   * We can't use IsIterableContainingInOrder from Hamcrest because the OpenMRS 1.6.6 version of
   * JUnit contains bad versions of hamcrest classes
   *
   * @param collection
   * @param matchers
   */
