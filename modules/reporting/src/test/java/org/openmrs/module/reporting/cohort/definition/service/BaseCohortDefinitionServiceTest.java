...
public class BaseCohortDefinitionServiceTest extends BaseModuleContextSensitiveTest {
  ...
  @Test
  @Verifies(
      value = "should save sql cohort definition",
  ...
  public void evaluate_shouldSaveSqlCohortDefinition() throws Exception {
    ...
    CohortDefinition savedCohortDefinition =
        Context.getService(CohortDefinitionService.class)
            .getDefinitionByUuid(sqlCohortDefinition.getUuid());

    SqlCohortDefinition savedSqlCohortDefinition = (SqlCohortDefinition) savedCohortDefinition;
