...
public class ProgramEnrollmentCohortDefinitionEvaluatorTest extends BaseModuleContextSensitiveTest {
  ...
  /**
   * @see {@link
   *     ProgramEnrollmentCohortDefinitionEvaluator#evaluate(CohortDefinition,EvaluationContext)}
   */
  @Test
  @Verifies(
      value = "should return patients enrolled in the given programs after the given date",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  public void evaluate_shouldReturnPatientsEnrolledInTheGivenProgramsAfterTheGivenDate()
      throws Exception {
  ...
  @Test
  @Verifies(
      value = "should return patients enrolled in the given programs before the given date",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  public void evaluate_shouldReturnPatientsEnrolledInTheGivenProgramsBeforeTheGivenDate()
      throws Exception {
    PatientProgram pp = ps.getPatientProgram(7);
    pp.setDateEnrolled(DateUtil.getDateTime(2008, 8, 1, 10, 0, 0, 0));
    ps.savePatientProgram(pp);
  ...
  @Test
  @Verifies(
      value = "should return patients that completed the given programs before the given date",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  public void evaluate_shouldReturnPatientsThatCompletedTheGivenProgramsBeforeTheGivenDate()
      throws Exception {
    PatientProgram pp = ps.getPatientProgram(7);
  ...
  @Test
  @Verifies(
      value = "should return patients that completed the given programs after the given date",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  public void evaluate_shouldReturnPatientsThatCompletedTheGivenProgramsAfterTheGivenDate()
      throws Exception {
    PatientProgram pp = ps.getPatientProgram(7);
    pp.setDateCompleted(DateUtil.getDateTime(2008, 8, 1, 12, 0, 0, 0));
    ps.savePatientProgram(pp);
  ...
  @Verifies(
      ...
      method = "evaluate(CohortDefinition,EvaluationContext)")
  public void
      evaluate_shouldReturnPatientsThatCompletedTheGivenProgramsOnTheGivenDateIfPassedInTimeIsAtMidnight()
          throws Exception {
    PatientProgram pp = ps.getPatientProgram(7);
    pp.setDateCompleted(DateUtil.getDateTime(2008, 8, 1, 12, 0, 0, 0));
    ps.savePatientProgram(pp);
  ...
  @Verifies(
      ...
      method = "evaluate(CohortDefinition,EvaluationContext)")
  public void
      evaluate_shouldReturnPatientsEnrolledInTheGivenProgramsOnTheGivenDateIfPassedInTimeIsAtMidnight()
          throws Exception {
    PatientProgram pp = ps.getPatientProgram(7);
    pp.setDateEnrolled(DateUtil.getDateTime(2008, 8, 1, 10, 0, 0, 0));
    ps.savePatientProgram(pp);
  ...
  @Test
  @Verifies(
      value = "should return patients enrolled at the given locations",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  public void evaluate_shouldReturnPatientsEnrolledAtTheGivenLocations() throws Exception {
    ...
    Cohort c =
        Context.getService(CohortDefinitionService.class).evaluate(cd, new EvaluationContext());
