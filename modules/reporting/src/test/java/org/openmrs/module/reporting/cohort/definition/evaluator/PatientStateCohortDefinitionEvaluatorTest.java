...
public class PatientStateCohortDefinitionEvaluatorTest extends BaseModuleContextSensitiveTest {
  ...
  @Test
  @Verifies(
      value = "should return patients in the specified states after the start date",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  public void evaluate_shouldReturnPatientsInTheSpecifiedStatesAfterTheStartDate()
      throws Exception {
  ...
  @Test
  @Verifies(
      value = "should return patients in the specified states before the end date",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  ...
  @Test
  @Verifies(
      value = "should return patients in the specified states after the end date",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  ...
  @Test
  @Verifies(
      value = "should return patients in the specified states before the start date",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  public void evaluate_shouldReturnPatientsInTheSpecifiedStatesBeforeTheStartDate()
      throws Exception {
    PatientState patientState = ps.getPatientStateByUuid("ea89deaa-23cc-4840-92fe-63d199c37edd");
    patientState.setStartDate(DateUtil.getDateTime(2008, 8, 1, 10, 0, 0, 0));
    ps.savePatientProgram(patientState.getPatientProgram());
  ...
  @Verifies(
      ...
      method = "evaluate(CohortDefinition,EvaluationContext)")
  public void
      evaluate_shouldFindPatientsInSpecifiedStatesOnTheBeforeEndDateIfPassedInTimeIsAtMidnight()
          throws Exception {
    PatientState patientState = ps.getPatientStateByUuid("ea89deaa-23cc-4840-92fe-63d199c37edd");
    patientState.setEndDate(DateUtil.getDateTime(2008, 12, 15, 10, 0, 0, 0));
    ps.savePatientProgram(patientState.getPatientProgram());
  ...
  @Verifies(
      ...
      method = "evaluate(CohortDefinition,EvaluationContext)")
  public void
      evaluate_shouldFindPatientsInSpecifiedStatesOnTheBeforeStartDateIfPassedInTimeIsAtMidnight()
          throws Exception {
    PatientState patientState = ps.getPatientStateByUuid("ea89deaa-23cc-4840-92fe-63d199c37edd");
    patientState.setStartDate(DateUtil.getDateTime(2008, 8, 1, 10, 0, 0, 0));
    ps.savePatientProgram(patientState.getPatientProgram());
  ...
  @Test
  @Verifies(
      value = "should find patients in specified states for the specified locations",
      method = "evaluate(CohortDefinition,EvaluationContext)")
  public void evaluate_shouldFindPatientsInSpecifiedStatesForTheSpecifiedLocations()
      throws Exception {
    PatientStateCohortDefinition cd = new PatientStateCohortDefinition();
