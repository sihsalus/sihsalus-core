...
public class PatientIdentifierCohortDefinitionEvaluatorTest extends BaseModuleContextSensitiveTest {
  ...
  public void evaluate_shouldReturnPatientsWhoHaveIdentifiersOfThePassedTypes() throws Exception {
    {
      ...
      EvaluatedCohort c =
          Context.getService(CohortDefinitionService.class).evaluate(picd, new EvaluationContext());
   ...
   */
  @Test
  public void evaluate_shouldReturnPatientsWhoHaveIdentifiersMatchingThePassedLocations()
      throws Exception {
    PatientIdentifierCohortDefinition picd = new PatientIdentifierCohortDefinition();
    picd.addTypeToMatch(new PatientIdentifierType(2));
    Assert.assertEquals(
        ...
        Context.getService(CohortDefinitionService.class)
            .evaluate(picd, new EvaluationContext())
            .getMemberIds()
            .size());
   ...
   */
  @Test
  public void evaluate_shouldReturnPatientsWhoHaveIdentifiersMatchingThePassedText()
      throws Exception {
    PatientIdentifierCohortDefinition picd = new PatientIdentifierCohortDefinition();
    {
   ...
   */
  @Test
  public void evaluate_shouldReturnPatientsWhoHaveIdentifiersMatchingThePassedRegularExpression()
      throws Exception {
    PatientIdentifierCohortDefinition picd = new PatientIdentifierCohortDefinition();
