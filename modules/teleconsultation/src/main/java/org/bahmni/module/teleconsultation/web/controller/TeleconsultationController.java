...
public class TeleconsultationController extends BaseRestController {
  ...
  @Autowired private TeleconsultationService teleconsultationService;

  @RequestMapping(value = "/generateLink", method = RequestMethod.GET)
  @ResponseBody
  public ResponseEntity<String> generateTeleconsultationLink(
      @RequestParam(value = "uuid", required = true) String uuid) {
    try {
      return new ResponseEntity<>(
          teleconsultationService.generateTeleconsultationLink(uuid), HttpStatus.OK);
