...
/**
 * A IdentifierValidator based on the Luhn Mod-N Algorithm This allows alphanumeric characters,
 * excluding 0,1,2,5,8,B,I,O,Q,S,Z See http://en.wikipedia.org/wiki/Luhn_mod_N_algorithm
 */
