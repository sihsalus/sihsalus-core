...
@Resource(
    ...
    supportedClass = IdentifierSource.class,
...
public class IdentifierSourceResource extends MetadataDelegatingCrudResource<IdentifierSource> {
  ...
  public Object create(SimpleObject postBody, RequestContext context) throws ResponseException {
        ...
        if (identifierSource != null) {
          List<String> identifiers =
              Context.getService(IdentifierSourceService.class)
                  .generateIdentifiers(
                      identifierSource,
                      Integer.parseInt(numberToGenerate.toString()),
                      comment.toString());
    ...
    if (identifierSourceType.equals(Sequential_Identifier_Generator)) {
      ...
      if (sourceUuid != null && StringUtils.isNotBlank(sourceUuid.toString())) {
        IdentifierSource poolIdentifierSource =
            Context.getService(IdentifierSourceService.class)
                .getIdentifierSourceByUuid(sourceUuid.toString());
      ...
      if (refillWithScheduledTask != null
          && StringUtils.isNotBlank(refillWithScheduledTask.toString())) {
  ...
  public Object update(String uuid, SimpleObject updateBody, RequestContext context)
    ...
    IdentifierSource identifierSourceToUpdate =
        Context.getService(IdentifierSourceService.class).getIdentifierSourceByUuid(uuid);
    if (reservedIdentifiersToUpload != null) {
      List<String> reservedIdentifiersList =
          new ArrayList<String>(Arrays.asList(reservedIdentifiersToUpload.toString().split(",")));
      if (identifierSourceToUpdate != null) {
        ...
        Context.getService(IdentifierSourceService.class)
            .saveIdentifierSource(identifierSourceToUpdate);
      }
    }
    if (operation != null && operation.toString().equals("uploadFromSource")) {
      if (identifierSourceToUpdate != null) {
        ...
        if (pool != null && batchSize != null && StringUtils.isNumeric(batchSize.toString())) {
          Context.getService(IdentifierSourceService.class)
              .addIdentifiersToPool(pool, Integer.parseInt(batchSize.toString()));
        }
      }
    }
    ...
    if (identifierSourceToUpdate instanceof SequentialIdentifierGenerator) {
      SequentialIdentifierGenerator identifierSource =
          (SequentialIdentifierGenerator) identifierSourceToUpdate;
  ...
  @Override
  public void delete(IdentifierSource identifierSource, String reason, RequestContext context)
      throws ResponseException {
    Context.getService(IdentifierSourceService.class)
        .retireIdentifierSource(identifierSource, reason);
  }

  @Override
  public void purge(IdentifierSource identifierSource, RequestContext context)
      throws ResponseException {
  ...
  protected PageableResult doGetAll(RequestContext context) throws ResponseException {
    return new NeedsPaging<IdentifierSource>(
        Context.getService(IdentifierSourceService.class).getAllIdentifierSources(false), context);
  }
  ...
  protected PageableResult doSearch(RequestContext context) throws ResponseException {
    ...
    if (identifierType != null) {
      PatientIdentifierType requestedPatientIdentifierType =
          Context.getPatientService().getPatientIdentifierTypeByUuid(identifierType);
      if (requestedPatientIdentifierType != null) {
        List<IdentifierSource> requestedIdentifierSources =
            Context.getService(IdentifierSourceService.class)
