...
/**
 * Identifier Source which contains a pre-generated pool of identifiers, and which typically is used
 * in conjunction with another IdentifierSource which populates the pool
 */
public class IdentifierPool extends BaseIdentifierSource {
  ...
  private boolean refillWithScheduledTask =
      true; // if true, refill with a scheduled task, otherwise refill on demands for ids
