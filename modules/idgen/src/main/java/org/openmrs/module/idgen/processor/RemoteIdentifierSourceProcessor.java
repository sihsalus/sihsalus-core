...
/**
 * Evaluates a RemoteIdentifierSource By default, this expects an HTTP request to return a
 * comma-separated String of identifiers. This can be overridden in subclasses as needed
 */
@Component
public class RemoteIdentifierSourceProcessor implements IdentifierSourceProcessor {
  ...
  protected String doHttpPost(RemoteIdentifierSource source, int batchSize)
