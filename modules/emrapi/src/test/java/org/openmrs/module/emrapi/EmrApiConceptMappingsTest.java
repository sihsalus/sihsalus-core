...
class EmrApiConceptMappingsTest {
  ...
  void defaultsKeepLegacyEmrApiConceptMappings() {
    ...
    assertEquals(
        EmrApiConstants.CONCEPT_CODE_DIAGNOSIS_CONCEPT_SET, mappings.getDiagnosisConceptSetCode());
  ...
  void globalPropertyValuesOverrideLegacyDefaults() {
    ...
    EmrApiConceptMappings mappings =
        EmrApiConceptMappings.from(
            (propertyName, defaultValue) -> properties.getOrDefault(propertyName, defaultValue));
    ...
    EmrApiConceptMappings mappings =
        EmrApiConceptMappings.from(
            (propertyName, defaultValue) ->
                EmrApiConstants.GP_CONCEPT_CODE_DISPOSITION.equals(propertyName)
                    ? " "
                    : defaultValue);
