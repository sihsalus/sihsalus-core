...
public class MostRecentAdmissionRequestVisitDataEvaluatorTest extends BaseReportingTest {
  ...
  @Autowired private VisitDataService visitDataService;
  ...
  public void shouldReturnMostRecentAdmissionRequestForVisit() throws Exception {
    ...
    assertThat(
        (Date) ((Map<String, Object>) data.getData().get(visit.getId())).get("datetime"),
        is(mostRecentDate));
    assertThat(
        (Provider) ((Map<String, Object>) data.getData().get(visit.getId())).get("provider"),
        is(mostRecentProvider));
    assertThat(
        (Location) ((Map<String, Object>) data.getData().get(visit.getId())).get("fromLocation"),
        is(mostRecentLocation));
    assertThat(
        (Location) ((Map<String, Object>) data.getData().get(visit.getId())).get("toLocation"),
        is(mostRecentAdmissionLocation));

    List<Diagnosis> diagnoses =
        (List<Diagnosis>)
            ((Map<String, Object>) data.getData().get(visit.getId())).get("diagnoses");
