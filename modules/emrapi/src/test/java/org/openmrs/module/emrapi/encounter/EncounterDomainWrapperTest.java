...
public class EncounterDomainWrapperTest {
  ...
  public void shouldReturnTrueWhenTheCurrentUserIsOneOfTheProviders() {
    ...
    Set<EncounterProvider> encounterProviders =
        createListWithEncounterProviders(providerPerson, providerPerson1, providerPerson2);
  ...
  @Test
  public void
      test_attachToVisit_shouldSetEncounterDatetimeToMidnightOfEncounterDateForOpenVisitIfNotToday()
          throws Exception {
  ...
  public void test_attachToVisit_shouldSetStartDateToVisitStartDateOnCurrentDayForClosedVisit()
    ...
    visit.setStartDatetime(
        currentDateTime
            .minus(1000)
            .toDate()); // i guess this test will fail if run in the first minute of the day
  ...
  public void test_attachToVisit_shouldSetStartDateToCurrentDatetimeForOpenVisit()
    ...
    assertThat(
        encounter.getEncounterDatetime(), greaterThanOrEqualTo(shouldBeLessThanEncounterDatetime));
    assertThat(
        encounter.getEncounterDatetime(), lessThanOrEqualTo(shouldBeGreaterThanEncounterDatetime));
    assertThat(encounter.getVisit(), is(visit));
  }

  @Test
  public void
      test_attachToVisit_shouldSetStartDateToCurrentDatetimeForOpenVisitWithNoEncounterDatetime()
          throws Exception {
    DateTime currentDate = new DateTime().withTime(0, 0, 0, 0);
    ...
    assertThat(
        encounter.getEncounterDatetime(), greaterThanOrEqualTo(shouldBeLessThenEncounterDatetime));
    assertThat(
        encounter.getEncounterDatetime(), lessThanOrEqualTo(shouldBeGreaterThanEncounterDatetime));
    assertThat(encounter.getVisit(), is(visit));
  }
