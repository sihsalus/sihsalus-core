...
public class VisitControllerTest extends BaseModuleWebContextSensitiveTest {
  ...
  @Autowired private ObjectFactory<VisitController> controllerFactory;
  ...
  public void shouldGetVisitsWithNotesAndDiagnosesByPatient() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                get("/rest/v1/emrapi/patient/" + patientUuid + "/visit")
    ...
    List<Map<String, Object>> visitEntries =
        (List<Map<String, Object>>) result.get("pageOfResults");
    ...
    List<Map<String, Object>> firstVisitNotes =
        (List<Map<String, Object>>) firstVisitEntry.get("visitNotes");
    List<Map<String, Object>> firstVisitDiagnoses =
        (List<Map<String, Object>>) firstVisitEntry.get("diagnoses");
    ...
    List<Map<String, Object>> secondVisitNotes =
        (List<Map<String, Object>>) secondVisitEntry.get("visitNotes");
    List<Map<String, Object>> secondVisitDiagnoses =
        (List<Map<String, Object>>) secondVisitEntry.get("diagnoses");
    ...
    List<Map<String, Object>> thirdVisitNotes =
        (List<Map<String, Object>>) thirdVisitEntry.get("visitNotes");
    List<Map<String, Object>> thirdVisitDiagnoses =
        (List<Map<String, Object>>) thirdVisitEntry.get("diagnoses");
  ...
  public void shouldGetVisitsWithNotesAndDiagnosesByPatientWithPagination() throws Exception {
    ...
    List<Map<String, Object>> visitsEntries =
        (List<Map<String, Object>>) result.get("pageOfResults");
  ...
  public void shouldGetVisitsWithObsGroupDiagnosesByPatient() throws Exception {
    ...
    administrationService.setGlobalProperty(
        EmrApiConstants.GP_USE_LEGACY_DIAGNOSIS_SERVICE, "true");
    ...
    encounter.addObs(
        new ObsBuilder()
            ...
            .addMember(
                dmd.getDiagnosisCertaintyConcept(),
    ...
    encounter.addObs(
        new ObsBuilder()
            ...
            .addMember(
                dmd.getDiagnosisCertaintyConcept(), dmd.getConceptFor(Diagnosis.Certainty.PRESUMED))
            .get());
    ...
    // extract the first visit and check its properties
    List<Map<String, Object>> firstVisitDiagnoses =
        (List<Map<String, Object>>) visitEntries.get(2).get("diagnoses");
    List<Map<String, Object>> secondVisitDiagnoses =
        (List<Map<String, Object>>) visitEntries.get(1).get("diagnoses");
    List<Map<String, Object>> thirdVisitDiagnoses =
        (List<Map<String, Object>>) visitEntries.get(0).get("diagnoses");
