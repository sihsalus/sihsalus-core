...
public class ConceptSetDescriptorTest {
  ...
  public void setup() {
    ...
    when(conceptService.getConceptByMapping("setConceptCode", "someConceptSource"))
        .thenReturn(setConcept);
    when(conceptService.getConceptByMapping("firstMemberConceptCode", "someConceptSource"))
        .thenReturn(firstMemberConcept);
    when(conceptService.getConceptByMapping("secondMemberConceptCode", "someConceptSource"))
        .thenReturn(secondMemberConcept);
  }
  ...
  public void shouldProperlySetupConcepts() {
    ...
    conceptSetDescriptorImpl.setup(
        conceptService,
        "someConceptSource",
