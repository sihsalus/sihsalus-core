...
public class EmrEncounterServiceImpIT extends BaseModuleWebContextSensitiveTest {
  ...
  public void shouldSaveDispositionInEncounter() throws Exception {
    ...
    EncounterTransaction.Disposition disposition =
        new EncounterTransaction.Disposition().setCode("ADMIT");
  ...
  public void shouldNotRecreateDispositionWhenThereIsNoChange() throws Exception {
    ...
    EncounterTransaction encounterTransaction =
        emrEncounterService.getEncounterTransaction(encounterUuid, true);
    Encounter encounterWithDisposition =
        Context.getEncounterService().getEncounterByUuid(encounterTransaction.getEncounterUuid());
  ...
  public void shouldVoidAndRecreateOnlyNotesObsWhenNotesIsUpdated() throws Exception {
    ...
    assertEquals(
        Context.getConceptService().getConceptByName("My Admit"),
        dispositionCodeObs.getValueCoded());
