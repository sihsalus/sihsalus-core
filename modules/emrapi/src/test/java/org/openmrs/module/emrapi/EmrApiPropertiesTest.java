...
public class EmrApiPropertiesTest {
  ...
  public void visitExpireHours_shouldBeConfiguredValueFromGlobalProperty() {
    when(administrationService.getGlobalProperty(EmrApiConstants.GP_VISIT_EXPIRE_HOURS))
        .thenReturn("10");
  ...
  public void inpatientVisitExpireHours_shouldBeConfiguredValueFromGlobalProperty() {
    when(administrationService.getGlobalProperty(EmrApiConstants.GP_INPATIENT_VISIT_EXPIRE_HOURS))
        .thenReturn("72");
