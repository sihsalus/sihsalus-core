...
public class ContextSensitiveMetadataTestUtils {
	...
	public static DispositionDescriptor setupDispositionDescriptor(ConceptService conceptService,
		...
		Concept admit = new ConceptBuilder(conceptService, naDatatype, misc).addName("Admit to hospital")
		        .addMapping(sameAs, emrSource, "Admit to hospital") // not a real code, just for testing
		        .saveAndGet();

		Concept discharge = new ConceptBuilder(conceptService, naDatatype, misc).addName("Discharged")
		        .addMapping(sameAs, emrSource, "Discharged") // not a real code, just for testing
		        .saveAndGet();

		Concept death = new ConceptBuilder(conceptService, naDatatype, misc).addName("Death")
		        .addMapping(sameAs, emrSource, "Death") // not a real code, just for testing
		        .saveAndGet();

		Concept observation = new ConceptBuilder(conceptService, naDatatype, misc).addName("ED Observation")
		        .addMapping(sameAs, emrSource, "ED Observation") // not a real code, just for testing
		        .saveAndGet();

		Concept transferOut = new ConceptBuilder(conceptService, naDatatype, misc).addName("Transfer out of hospital")
		        .addMapping(sameAs, emrSource, "Transfer out of hospital") // not a real code, just for testing
		        .saveAndGet();

		Concept transferTo = new ConceptBuilder(conceptService, textDatatype, misc).addName("Transfer to location")
		        .saveAndGet();

		Concept admissionLocation = new ConceptBuilder(conceptService, textDatatype, misc).addName("Admission Location")
		        .addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_ADMISSION_LOCATION).saveAndGet();

		Concept internalTransferLocation = new ConceptBuilder(conceptService, textDatatype, misc)
		        .addName("Internal Transfer Location")
		        .addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_INTERNAL_TRANSFER_LOCATION).saveAndGet();

		Concept dateOfDeath = new ConceptBuilder(conceptService, dateDatatype, misc).addName("Date of Death")
		        .addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_DATE_OF_DEATH).saveAndGet();

		Concept disposition = new ConceptBuilder(conceptService, codedDatatype, convSet).addName("Disposition")
		...
		new ConceptBuilder(conceptService, naDatatype, convSet).addName("Disposition Construct")
	 ...
	 */
	public static DiagnosisMetadata setupDiagnosisMetadata(ConceptService conceptService,
		...
		Concept primary = new ConceptBuilder(conceptService, naDatatype, misc).addName("Primary")
		        .addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_DIAGNOSIS_ORDER_PRIMARY).saveAndGet();

		Concept secondary = new ConceptBuilder(conceptService, naDatatype, misc).addName("Secondary")
		        .addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_DIAGNOSIS_ORDER_SECONDARY).saveAndGet();

		Concept order = new ConceptBuilder(conceptService, codedDatatype, misc).addName("Diagnosis order")
		        .addAnswers(primary, secondary).addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_DIAGNOSIS_ORDER)
		        .saveAndGet();

		Concept confirmed = new ConceptBuilder(conceptService, naDatatype, misc).addName("Confirmed")
		        .addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_DIAGNOSIS_CERTAINTY_CONFIRMED).saveAndGet();

		Concept presumed = new ConceptBuilder(conceptService, naDatatype, misc).addName("Presumed")
		        .addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_DIAGNOSIS_CERTAINTY_PRESUMED).saveAndGet();

		Concept certainty = new ConceptBuilder(conceptService, codedDatatype, misc).addName("Diagnosis certainty")
		        .addAnswers(confirmed, presumed)
		        .addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_DIAGNOSIS_CERTAINTY).saveAndGet();

		Concept codedDiagnosis = new ConceptBuilder(conceptService, codedDatatype, misc).addName("Coded diagnosis")
		        .addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_CODED_DIAGNOSIS).saveAndGet();

		Concept nonCodedDiagnosis = new ConceptBuilder(conceptService, textDatatype, misc).addName("Non-coded diagnosis")
		        .addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_NON_CODED_DIAGNOSIS).saveAndGet();

		new ConceptBuilder(conceptService, naDatatype, convSet).addName("Visit diagnoses")
	...
	public static Concept setupAdmissionDecisionConcept(ConceptService conceptService, EmrApiProperties emrApiProperties) {
		...
		Concept deny = new ConceptBuilder(conceptService, naDatatype, misc).addName("Deny")
		        .addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_DENY_ADMISSION).saveAndGet();

		new ConceptBuilder(conceptService, codedDatatype, misc).addName("Admission Decision").addAnswers(deny)
