...
public class ContextSensitiveMetadataTestUtils {
   ...
   * @return
   */
  public static DispositionDescriptor setupDispositionDescriptor(
      ConceptService conceptService, DispositionService dispositionService) {
    ...
    Concept transferOut =
        new ConceptBuilder(conceptService, naDatatype, misc)
            ...
            .addMapping(
                sameAs, emrSource, "Transfer out of hospital") // not a real code, just for testing
            .saveAndGet();

    Concept transferTo =
        new ConceptBuilder(conceptService, textDatatype, misc)
            .addName("Transfer to location")
            .saveAndGet();
    ...
    Concept dateOfDeath =
        new ConceptBuilder(conceptService, dateDatatype, misc)
            .addName("Date of Death")
            .addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_DATE_OF_DEATH)
            .saveAndGet();

    Concept disposition =
        new ConceptBuilder(conceptService, codedDatatype, convSet)
            .addName("Disposition")
            .addAnswers(admit, discharge, death, transferOut, observation)
            .addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_DISPOSITION)
            .saveAndGet();

    new ConceptBuilder(conceptService, naDatatype, convSet)
        .addName("Disposition Construct")
        .addSetMembers(
            disposition, transferTo, admissionLocation, internalTransferLocation, dateOfDeath)
        .addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_DISPOSITION_CONCEPT_SET)
        .saveAndGet();
  ...
  public static Concept setupAdmissionDecisionConcept(
      ConceptService conceptService, EmrApiProperties emrApiProperties) {
    ...
    Concept deny =
        new ConceptBuilder(conceptService, naDatatype, misc)
            .addName("Deny")
            .addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_DENY_ADMISSION)
            .saveAndGet();

    new ConceptBuilder(conceptService, codedDatatype, misc)
        .addName("Admission Decision")
        .addAnswers(deny)
        .addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_ADMISSION_DECISION)
        .saveAndGet();
