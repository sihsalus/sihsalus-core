...
public class DispositionDescriptorTest {
	...
	public void shouldFetchTransferLocationOffObsGroup() {
		...
		assertThat(dispositionDescriptor.getInternalTransferLocation(dispositionObsGroup, locationService),
		    is(transferLocation));
	}
	 ...
	 *       emrConceptService); assertThat(dispositionObsGroup.getConcept(),
	 *       is(dispositionSetConcept)); assertTrue(dispositionObsGroup.hasGroupMembers());
