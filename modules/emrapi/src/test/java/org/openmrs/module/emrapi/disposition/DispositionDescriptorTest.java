...
public class DispositionDescriptorTest {
  ...
  public void shouldBuildDispositionObsGroup() {
    ...
    Obs dispositionObsGroup =
        dispositionDescriptor.buildObsGroup(admissionDisposition, emrConceptService);
  ...
  public void shouldFetchAdmissionLocationObsOffObsGroup() {
    ...
    assertThat(
        dispositionDescriptor.getAdmissionLocationObs(dispositionObsGroup), is(admissionLocation));
  }
  ...
  public void shouldFetchTransferLocationObsOffObsGroup() {
    ...
    assertThat(
        dispositionDescriptor.getInternalTransferLocationObs(dispositionObsGroup),
        is(transferLocation));
  }
  ...
  public void shouldFetchAdmissionLocationOffObsGroup() {
    ...
    assertThat(
        dispositionDescriptor.getAdmissionLocation(dispositionObsGroup, locationService),
  ...
  public void shouldFetchTransferLocationOffObsGroup() {
    ...
    assertThat(
        dispositionDescriptor.getInternalTransferLocation(dispositionObsGroup, locationService),
        is(transferLocation));
  }
  ...
  /**
   * commenting this out until we know if we actually need to build this functionality @Test public
   * void shouldBuildDipositionObsWithAdmissionLocation() { Disposition admissionDisposition = new
   * Disposition(); admissionDisposition.setConceptCode("ADMISSION"); Location admissionLocation =
   * new Location(); Obs dispositionObsGroup =
   * dispositionDescriptor.buildObsGroup(admissionDisposition, admissionLocation,
   * emrConceptService); assertThat(dispositionObsGroup.getConcept(), is(dispositionSetConcept));
   * assertTrue(dispositionObsGroup.hasGroupMembers());
