...
public class DosingInstructionsMapperTest {
  ...
  public void shouldMapDosingInstructionsToDrugOrder() {
    ...
    when(orderMetadataService.getDoseUnitsConceptByName(dosingInstructions.getDoseUnits()))
        .thenReturn(capsuleConcept);
    Concept routeConcept = new Concept();
    when(orderMetadataService.getRouteConceptByName(dosingInstructions.getRoute()))
        .thenReturn(routeConcept);
    Concept frequencyConcept = new Concept();
    when(conceptService.getConceptByName(dosingInstructions.getFrequency()))
        .thenReturn(frequencyConcept);
    ...
    DosingInstructionsMapper dosingInstructionsMapper =
        new DosingInstructionsMapper(conceptService, orderMetadataService);
