...
public class MockMetadataTestUtil {
	...
	public static void setupMockConceptService(ConceptService conceptService, EmrApiProperties emrApiProperties) {
		...
		ConceptDatatype codedDatatype = setupConceptDatatype(conceptService, "Coded", ConceptDatatype.CODED,
		    ConceptDatatype.CODED_UUID);
		ConceptDatatype textDatatype = setupConceptDatatype(conceptService, "Text", ConceptDatatype.TEXT,
		    ConceptDatatype.TEXT_UUID);
	...
	private static ConceptDatatype setupConceptDatatype(ConceptService mockConceptService, String name, String hl7Code,
	        String uuid) {
	...
	public static DispositionDescriptor setupDispositionDescriptor(ConceptService conceptService) {
		...
		Concept disposition = new ConceptBuilder(conceptService, codedDatatype, misc).addName("Disposition")
		        .addAnswers(admit, home).get();

		Concept dispositionSet = new ConceptBuilder(conceptService, naDatatype, misc).addName("Disposition Construct")
		...
		Concept dateOfDeath = new ConceptBuilder(conceptService, dateDatatype, misc).addName("Date of death").get();
	...
	public static DiagnosisMetadata setupDiagnosisMetadata(EmrApiProperties emrApiProperties,
		...
		Concept diagnosisSet = new ConceptBuilder(conceptService, naDatatype, convSet).addName("Visit diagnoses")
