...
public class MockMetadataTestUtil {
  ...
  public static void setupMockConceptService(
      ConceptService conceptService, EmrApiProperties emrApiProperties) {
    ConceptDatatype naDatatype =
        setupConceptDatatype(conceptService, "N/A", "ZZ", ConceptDatatype.N_A_UUID);
    ConceptDatatype codedDatatype =
        setupConceptDatatype(
            conceptService, "Coded", ConceptDatatype.CODED, ConceptDatatype.CODED_UUID);
    ConceptDatatype textDatatype =
        setupConceptDatatype(
            conceptService, "Text", ConceptDatatype.TEXT, ConceptDatatype.TEXT_UUID);
    ...
    when(conceptService.getConceptSourceByName(EmrApiConstants.EMR_CONCEPT_SOURCE_NAME))
        .thenReturn(emrConceptSource);
  ...
  private static ConceptDatatype setupConceptDatatype(
      ConceptService mockConceptService, String name, String hl7Code, String uuid) {
  ...
  public static DispositionDescriptor setupDispositionDescriptor(ConceptService conceptService) {
    ...
    Concept disposition =
        new ConceptBuilder(conceptService, codedDatatype, misc)
            .addName("Disposition")
            .addAnswers(admit, home)
            .get();

    Concept dispositionSet =
        new ConceptBuilder(conceptService, naDatatype, misc)
            .addName("Disposition Construct")
            .addSetMember(disposition)
            .get();

    Concept admissionLocation =
        new ConceptBuilder(conceptService, textDatatype, misc).addName("Admission Location").get();

    Concept internalTransferLocation =
        new ConceptBuilder(conceptService, textDatatype, misc).addName("Transfer Location").get();

    Concept dateOfDeath =
        new ConceptBuilder(conceptService, dateDatatype, misc).addName("Date of death").get();
  ...
  public static DiagnosisMetadata setupDiagnosisMetadata(
    ...
    Concept primary =
        new ConceptBuilder(conceptService, naDatatype, misc)
            .addName("Primary")
            .addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_DIAGNOSIS_ORDER_PRIMARY)
            .get();

    Concept secondary =
        new ConceptBuilder(conceptService, naDatatype, misc)
            .addName("Secondary")
            .addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_DIAGNOSIS_ORDER_SECONDARY)
            .get();
    ...
    Concept order =
        new ConceptBuilder(conceptService, codedDatatype, misc)
            ...
            .addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_DIAGNOSIS_ORDER)
            .get();
    ...
    Concept confirmed =
        new ConceptBuilder(conceptService, naDatatype, misc)
            .addName("Confirmed")
            .addMapping(
                sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_DIAGNOSIS_CERTAINTY_CONFIRMED)
            .get();
    ...
    Concept presumed =
        new ConceptBuilder(conceptService, naDatatype, misc)
            .addName("Presumed")
            .addMapping(
                sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_DIAGNOSIS_CERTAINTY_PRESUMED)
            .get();
    ...
    Concept certainty =
        new ConceptBuilder(conceptService, codedDatatype, misc)
            ...
            .addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_DIAGNOSIS_CERTAINTY)
            .get();

    Concept codedDiagnosis =
        new ConceptBuilder(conceptService, codedDatatype, misc)
            .addName("Coded diagnosis")
            .addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_CODED_DIAGNOSIS)
            .get();

    Concept nonCodedDiagnosis =
        new ConceptBuilder(conceptService, textDatatype, misc)
            .addName("Non-coded diagnosis")
            .addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_NON_CODED_DIAGNOSIS)
            .get();

    Concept diagnosisSet =
        new ConceptBuilder(conceptService, naDatatype, convSet)
            ...
            .addMapping(sameAs, emrSource, EmrApiConstants.CONCEPT_CODE_DIAGNOSIS_CONCEPT_SET)
            .get();
