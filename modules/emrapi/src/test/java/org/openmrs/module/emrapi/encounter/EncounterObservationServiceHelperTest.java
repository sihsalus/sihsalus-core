...
public class EncounterObservationServiceHelperTest {
  ...
  public void shouldAddCodedObservation() throws ParseException {
    ...
    List<EncounterTransaction.Observation> observations =
        asList(
            new EncounterTransaction.Observation()
                .setConcept(getConcept(CODED_CONCEPT_UUID))
                .setValue("answer-uuid"));
  ...
  public void shouldUpdateExistingObservation() throws ParseException {
    Concept numericConcept =
        newConcept(new ConceptDataTypeBuilder().numeric(), NUMERIC_CONCEPT_UUID);
  ...
  public void shouldVoidExistingObservation() throws ParseException {
    ...
    List<EncounterTransaction.Observation> observations =
        asList(
            new EncounterTransaction.Observation()
                .setUuid("o-uuid")
                .setConcept(getConcept(NUMERIC_CONCEPT_UUID))
                .setVoided(true)
                .setVoidReason("closed"));
  ...
  public void shouldReturnErrorWhenObservationConceptIsNotFound() throws Exception {
    List<EncounterTransaction.Observation> observations =
        asList(new EncounterTransaction.Observation().setConcept(getConcept("non-existent")));
    Encounter encounter = new Encounter();
    encounterObservationServiceHelper.update(encounter, observations);
  }
  ...
  public void shouldSaveDiagnosisAsAnObservationWhenPassedTheUuidOfDiagnosisConcept() {
    ...
    List<EncounterTransaction.Diagnosis> diagnosises =
        asList(
            new EncounterTransaction.Diagnosis()
                .setCertainty("CONFIRMED")
                .setOrder("PRIMARY")
                .setComments("comments")
                .setCodedAnswer(
                    new EncounterTransaction.Concept(diagnosisConceptUuid, "conceptName")));
    ...
    when(diagnosisMetadata.buildDiagnosisObsGroup(
            any(org.openmrs.module.emrapi.diagnosis.Diagnosis.class)))
    ...
    ArgumentCaptor<org.openmrs.module.emrapi.diagnosis.Diagnosis> diagnosisCaptor =
        ArgumentCaptor.forClass(org.openmrs.module.emrapi.diagnosis.Diagnosis.class);
    ...
    assertEquals(
        org.openmrs.module.emrapi.diagnosis.Diagnosis.Certainty.CONFIRMED,
  ...
  public void shouldSetObsdatetimeWithDiagnosisDateTimeIfProvided() {
    ...
    assertEquals(
        org.openmrs.module.emrapi.diagnosis.Diagnosis.Certainty.CONFIRMED,
        actualDiagnosis.getCertainty());
    assertEquals(
        org.openmrs.module.emrapi.diagnosis.Diagnosis.Order.PRIMARY, actualDiagnosis.getOrder());
    verify(conceptService).getConceptByUuid(diagnosisConceptUuid);
    verify(conceptService, never()).getConcept(anyInt());
  }
  ...
  public void shouldVoidDiagnosisObservation() {
    ...
    List<EncounterTransaction.Diagnosis> diagnoses =
        asList(
            new EncounterTransaction.Diagnosis()
                .setCertainty("CONFIRMED")
                .setOrder("PRIMARY")
  ...
  public void shouldLinkOrderWithObservation() throws ParseException {
    ...
    EncounterTransaction.Concept encConcept =
        new EncounterTransaction.Concept(numericConcept.getUuid());
    List<EncounterTransaction.Observation> observations =
        asList(
            new EncounterTransaction.Observation()
                .setUuid("o-uuid")
  ...
  public void shouldHandleVoidedObservations() throws ParseException {
    ...
    EncounterTransaction.Concept obsConcept =
        new EncounterTransaction.Concept(numericConcept.getUuid());
    double value = 35.0;
