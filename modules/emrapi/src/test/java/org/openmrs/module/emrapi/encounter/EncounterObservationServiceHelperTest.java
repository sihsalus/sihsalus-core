...
public class EncounterObservationServiceHelperTest {
	...
	public void setUp() throws Exception {
		...
		encounterObservationServiceHelper = new EncounterObservationServiceHelper(conceptService, emrApiProperties,
		        obsService, orderService, obsMapper);
	...
	public void shouldAddNewObservation() throws ParseException {
		...
		List<EncounterTransaction.Observation> observations = asList(new EncounterTransaction.Observation()
		        .setConcept(getConcept(TEXT_CONCEPT_UUID)).setValue("text value").setComment("overweight"));
	...
	public void shouldUpdateExistingObservation() throws ParseException {
		...
		List<EncounterTransaction.Observation> observations = asList(new EncounterTransaction.Observation().setUuid("o-uuid")
		        .setValue(35.0).setComment("overweight").setObservationDateTime(observationDateTime));
	...
	public void shouldHandleNullValueObservationWhileSaving() throws Exception {
		...
		List<EncounterTransaction.Observation> observations = asList(new EncounterTransaction.Observation()
		        .setConcept(getConcept(TEXT_CONCEPT_UUID)).setValue(null).setComment("overweight"));
	...
	public void shouldVoidExistingObservation() throws ParseException {
		...
		List<EncounterTransaction.Observation> observations = asList(new EncounterTransaction.Observation().setUuid("o-uuid")
		        .setConcept(getConcept(NUMERIC_CONCEPT_UUID)).setVoided(true).setVoidReason("closed"));
	...
	public void shouldSaveDiagnosisAsAnObservationWhenPassedTheUuidOfDiagnosisConcept() {
		...
		List<EncounterTransaction.Diagnosis> diagnosises = asList(
		    new EncounterTransaction.Diagnosis().setCertainty("CONFIRMED").setOrder("PRIMARY").setComments("comments")
		...
		ArgumentCaptor<org.openmrs.module.emrapi.diagnosis.Diagnosis> diagnosisCaptor = ArgumentCaptor
		        .forClass(org.openmrs.module.emrapi.diagnosis.Diagnosis.class);
	...
	public void shouldSetObsdatetimeWithDiagnosisDateTimeIfProvided() {
		...
		EncounterTransaction.Diagnosis diagnosis = new EncounterTransaction.Diagnosis().setCertainty("CONFIRMED")
		        .setOrder("PRIMARY").setComments("comments")
		        .setCodedAnswer(new EncounterTransaction.Concept(diagnosisConceptUuid, "conceptName"));
	...
	public void shouldVoidDiagnosisObservation() {
		...
		List<EncounterTransaction.Diagnosis> diagnoses = asList(
		    new EncounterTransaction.Diagnosis().setCertainty("CONFIRMED").setOrder("PRIMARY")
		            .setCodedAnswer(new EncounterTransaction.Concept(diagnosisConceptUuid, "conceptName")).setVoided(true)
		            .setExistingObs(existingObsUuid));
	...
	public void shouldLinkOrderWithObservation() throws ParseException {
		...
		List<EncounterTransaction.Observation> observations = asList(new EncounterTransaction.Observation().setUuid("o-uuid")
		        .setValue(35.0).setComment("overweight").setOrderUuid("order-uuid").setConcept(encConcept));
	...
	public void shouldIgnoreNullOrdersInObservation() throws ParseException {
		...
		EncounterTransaction.Concept encConcept = new EncounterTransaction.Concept(numericConcept.getUuid());
		List<EncounterTransaction.Observation> observations = asList(new EncounterTransaction.Observation().setUuid("o-uuid")
		        .setValue(35.0).setComment("overweight").setOrderUuid(null).setConcept(encConcept));
	...
	public void shouldCreateNewObservationWithNamespace() throws ParseException {
		...
		newConcept(new ConceptDataTypeBuilder().text(), TEXT_CONCEPT_UUID);
		List<EncounterTransaction.Observation> observations = asList(
		    new EncounterTransaction.Observation().setConcept(getConcept(TEXT_CONCEPT_UUID)).setValue("text value")
		            .setComment("overweight").setFormNamespace("formNamespace").setFormFieldPath("formFieldPath"));
