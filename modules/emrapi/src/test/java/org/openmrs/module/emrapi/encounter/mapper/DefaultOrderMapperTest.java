...
public class DefaultOrderMapperTest {
	...
	public void shouldMapNewDrugOrder() throws ParseException, NoSuchFieldException, IllegalAccessException {
		...
		DrugOrder openMrsDrugOrder = drugOrder(CareSetting.CareSettingType.OUTPATIENT, 3, "3-0-2", 5, "before meals",
		    "boil in water", null, "ORD-100");
	...
	public void shouldMapNewNonCodedDrugOrder() throws ParseException, NoSuchFieldException, IllegalAccessException {
		...
		DrugOrder nonCodedDrugOrder = drugOrder(CareSetting.CareSettingType.OUTPATIENT, 3, "3-0-2", 5, "before meals",
		    "boil in water", null, "ORD-100");
	...
	public void shouldSetPreviousDrugOrder() throws NoSuchFieldException, IllegalAccessException {
		DrugOrder openMrsDrugOrder = drugOrder(CareSetting.CareSettingType.OUTPATIENT, 3, "3-0-2", 5, "before meals",
		    "boil in water", "previousOrderUuid", "ORD-100");
		EncounterTransaction.DrugOrder drugOrder = orderMapper.mapDrugOrder(openMrsDrugOrder);
	...
	public void shouldReturnDrugOrdersSortedByOrderNumber() throws NoSuchFieldException, IllegalAccessException {
		DrugOrder drugOrder100 = drugOrder(CareSetting.CareSettingType.OUTPATIENT, 3, "3-0-2", 5, "before meals",
		    "boil in water", null, "ORD-100");
		DrugOrder drugOrder201 = drugOrder(CareSetting.CareSettingType.OUTPATIENT, 3, "3-0-2", 5, "before meals",
		    "boil in water", null, "ORD-201");
		DrugOrder drugOrder350 = drugOrder(CareSetting.CareSettingType.OUTPATIENT, 3, "3-0-2", 5, "before meals",
		    "boil in water", null, "ORD-350");
	...
	private Order order(String instructions, String commentToFulfiller, String previousOrderUuid, String orderNumber,
	        String orderType, String urgency) throws NoSuchFieldException, IllegalAccessException {
		...
		durationConcept.addConceptMapping(
		    new ConceptMap(new ConceptReferenceTerm(durationConceptSource, "D", "Day"), new ConceptMapType()));
	...
	private DrugOrder drugOrder(CareSetting.CareSettingType careSettingType, int daysToStartAfter, String dosingInstructions,
	        int duration, String instructions, String commentToFulfiller, String previousOrderUuid, String orderNumber)
