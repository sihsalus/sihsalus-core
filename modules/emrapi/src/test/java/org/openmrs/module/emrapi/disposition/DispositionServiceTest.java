...
public class DispositionServiceTest {
	...
	private Disposition getAdmitDisposition() {
		return new Disposition("66de7f60-b73a-11e2-9e96-0800200c9a66", "disposition.admit",
		        "org.openmrs.module.emrapi:Admit to hospital", Collections.<String> emptyList(),
		        Collections.<DispositionObs> emptyList());
	}

	private Disposition getDeathDisposition() {
		return new Disposition("d2d89630-b698-11e2-9e96-0800200c9a66", "disposition.death",
		        "org.openmrs.module.emrapi:Death", getActions(), getAdditionalObs());
	}
