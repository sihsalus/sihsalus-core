...
public class DispositionServiceTest {
  ...
  public void shouldGetDispositionByType() throws Exception {
    ...
    List<Disposition> dispositions =
        dispositionService.getDispositionsByType(DispositionType.TRANSFER);
  ...
  public void shouldGetDispositionsByEncounterType() throws Exception {
    ...
    List<Disposition> dispositions =
        dispositionService.getValidDispositions(visitDomainWrapper, encounterType);
  ...
  public void shouldGetDispositionByObs() throws IOException {
    ...
    when(emrConceptService.getConcept("org.openmrs.module.emrapi:Death"))
        .thenReturn(deathDispositionConcept);
  ...
  private Disposition getAdmitDisposition() {
    return new Disposition(
        "66de7f60-b73a-11e2-9e96-0800200c9a66",
        "disposition.admit",
        "org.openmrs.module.emrapi:Admit to hospital",
  ...
  private Disposition getDeathDisposition() {
    return new Disposition(
        "d2d89630-b698-11e2-9e96-0800200c9a66",
        "disposition.death",
        "org.openmrs.module.emrapi:Death",
        getActions(),
        getAdditionalObs());
  }
