...
public class ModulePropertiesTest {
  ...
  public void getPatientIdentifierTypesByGlobalProperty_shouldHandleASingleType() throws Exception {
    ...
    List<PatientIdentifierType> oneIdentifierType =
        moduleProperties.getPatientIdentifierTypesByGlobalProperty("oneIdentifierType", true);
    assertThat(oneIdentifierType.size(), is(1));
    assertThat(oneIdentifierType.get(0), is(identifierType));
  }

  @Test
  public void getPatientIdentifierTypesByGlobalProperty_shouldHandleMultipleTypes()
      throws Exception {
    ...
    List<PatientIdentifierType> oneIdentifierType =
        moduleProperties.getPatientIdentifierTypesByGlobalProperty("twoIdentifierTypes", true);
