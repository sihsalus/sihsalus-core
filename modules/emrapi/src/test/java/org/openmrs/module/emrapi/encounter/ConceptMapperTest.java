...
public class ConceptMapperTest {
	...
	@Test
	public void should_use_short_name_of_default_locale_if_both_fully_specified_name_and_short_name_are_not_available_in_a_locale()
	        throws Exception {
		when(authenticatedUser.getUserProperty(OpenmrsConstants.USER_PROPERTY_DEFAULT_LOCALE)).thenReturn("fr");
		when(administrationService.getGlobalProperty("default_locale")).thenReturn("en");
		localeUtility.when(() -> LocaleUtility.fromSpecification("fr")).thenReturn(Locale.FRENCH);
	...
	@Test
	public void should_use_fully_specified_name_of_default_locale_if_both_fully_specified_name_and_short_name_are_not_available_in_a_locale_and_short_name_of_the_default_locale_is_also_not_available()
	        throws Exception {
		when(authenticatedUser.getUserProperty(OpenmrsConstants.USER_PROPERTY_DEFAULT_LOCALE)).thenReturn("fr");
		when(administrationService.getGlobalProperty("default_locale")).thenReturn("en");
		localeUtility.when(() -> LocaleUtility.fromSpecification("fr")).thenReturn(Locale.FRENCH);
	...
	@Test
	public void should_use_any_available_name_when_no_name_in_either_default_locale_or_users_locale_is_available()
	        throws Exception {
		when(authenticatedUser.getUserProperty(OpenmrsConstants.USER_PROPERTY_DEFAULT_LOCALE)).thenReturn("fr");
		when(administrationService.getGlobalProperty("default_locale")).thenReturn("en");
		localeUtility.when(() -> LocaleUtility.fromSpecification("fr")).thenReturn(Locale.FRENCH);
