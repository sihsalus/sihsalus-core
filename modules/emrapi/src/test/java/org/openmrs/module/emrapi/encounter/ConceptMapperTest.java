...
public class ConceptMapperTest {
  ...
  @Mock private User authenticatedUser;
  ...
  public void should_convert_concept_to_encounter_concept() {
    ...
    ConceptBuilder conceptBuilder =
        new ConceptBuilder(null, new ConceptDatatype(), new ConceptClass());
    ...
    EncounterTransaction.Concept encounterTransactionConcept =
        conceptMapper.map(conceptBuilder.get());
  ...
  public void should_use_locale_specific_short_name_if_available() throws Exception {
    when(authenticatedUser.getUserProperty(OpenmrsConstants.USER_PROPERTY_DEFAULT_LOCALE))
        .thenReturn("fr");
  ...
  @Test
  public void should_use_fully_specified_name_if_short_name_is_not_available_in_a_locale()
      throws Exception {
    when(authenticatedUser.getUserProperty(OpenmrsConstants.USER_PROPERTY_DEFAULT_LOCALE))
        .thenReturn("fr");
  ...
  @Test
  public void
      should_use_short_name_of_default_locale_if_both_fully_specified_name_and_short_name_are_not_available_in_a_locale()
          throws Exception {
    when(authenticatedUser.getUserProperty(OpenmrsConstants.USER_PROPERTY_DEFAULT_LOCALE))
        .thenReturn("fr");
    when(administrationService.getGlobalProperty("default_locale")).thenReturn("en");
  ...
  @Test
  public void
      should_use_fully_specified_name_of_default_locale_if_both_fully_specified_name_and_short_name_are_not_available_in_a_locale_and_short_name_of_the_default_locale_is_also_not_available()
          throws Exception {
    when(authenticatedUser.getUserProperty(OpenmrsConstants.USER_PROPERTY_DEFAULT_LOCALE))
        .thenReturn("fr");
    when(administrationService.getGlobalProperty("default_locale")).thenReturn("en");
  ...
  @Test
  public void
      should_use_any_available_name_when_no_name_in_either_default_locale_or_users_locale_is_available()
          throws Exception {
    when(authenticatedUser.getUserProperty(OpenmrsConstants.USER_PROPERTY_DEFAULT_LOCALE))
        .thenReturn("fr");
    when(administrationService.getGlobalProperty("default_locale")).thenReturn("en");
