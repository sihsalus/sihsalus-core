...
public class ExitFromCareServiceTest {
  ...
  public void closePatientPrograms_shouldCloseActivePatientPrograms() {
    ...
    when(mockProgramWorkflowService.getPatientPrograms(
            patient, null, null, null, null, null, false))
        .thenReturn(Arrays.asList(pp1, pp2));

    when(mockProgramWorkflowService.getPossibleOutcomes(pp1.getPatientProgramId()))
        .thenReturn(Arrays.asList(validOutcome1, validOutcome2));
  ...
  @Test
  public void
      closePatientPrograms_shouldNotCloseActivePatientProgramIfOutcomeConceptNotValidForProgram() {
  ...
  @Test
  public void
      closePatientPrograms_shouldCloseActivePatientProgramOnStartDateIfCloseDateBeforeStartDate() {
    ...
    when(mockProgramWorkflowService.getPossibleOutcomes(pp1.getPatientProgramId()))
        .thenReturn(Arrays.asList(outcome));
  ...
  @Test
  public void
      updatePatientProgramCompletionDate_ShouldUpdateCompletionDateForProgramWithMatchingOutcome() {
  ...
  @Test
  public void
      updatePatientProgramCompletionDate_ShouldNotUpdateCompletionDatesForProgramsWithDifferentOutcomes() {
    ...
    exitFromCareService.updatePatientProgramCompletionDate(
        patient, anotherOutcome, newDateCompleted);
  ...
  @Test
  public void
      updatePatientProgramCompletionDate_ShouldNotUpdateCompletionDatesForProgramsWithNoOutcome() {
  ...
  @Test
  public void
      updatePatientProgramCompletionDate_ShouldSetCompletionDatesToEnrollmentDateIfSpecifiedDateBeforeEnrollmentDate() {
  ...
  public void markPatientDead_shouldMarkPatientDeadOnCurrentDateIfNoDateSpecified() {
    ...
    assertTrue(patient.isDead());
    assertThat(patient.getCauseOfDeath(), is(causeOfDeath));
    // we took a timestamp before calling "markPatientDied", so death date should be equal to or
    // greater than that timestamp
