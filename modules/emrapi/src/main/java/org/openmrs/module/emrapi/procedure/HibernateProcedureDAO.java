...
public class HibernateProcedureDAO implements ProcedureDAO {
  ...
  public ProcedureType getProcedureTypeByUuid(String uuid) {
    ...
    TypedQuery<ProcedureType> query =
        getEntityManager()
            .createQuery(
                "SELECT pt FROM ProcedureType pt WHERE pt.uuid = :uuid", ProcedureType.class);
    query.setParameter("uuid", uuid);
  ...
  public List<ProcedureType> getProcedureTypesByName(String name) {
    ...
    TypedQuery<ProcedureType> query =
        getEntityManager()
            .createQuery(
                "SELECT pt FROM ProcedureType pt WHERE pt.name = :name", ProcedureType.class);
