...
public class MothersAndChildrenSearchCriteria {
  ...
  private boolean motherRequiredToHaveActiveVisit =
      false; // restrict to mothers who have an active visit

  private boolean childRequiredToHaveActiveVisit =
      false; // restrict to mothers of children who have an active visit

  private boolean childRequiredToBeBornDuringMothersActiveVisit =
