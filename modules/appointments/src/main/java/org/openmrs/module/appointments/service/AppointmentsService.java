...
public interface AppointmentsService {
  ...
  @Transactional
  @Authorized({VIEW_APPOINTMENTS, MANAGE_APPOINTMENTS})
  List<Appointment> getAllAppointmentsReminder(String hours);
  ...
  Appointment reschedule(
      String originalAppointmentUuid, Appointment appointment, boolean retainAppointmentNumber);
   ...
   * comments on the appointmentController. Once we refactor the code, this method should be
   * removed.
   *
   * @param mapper
   * @return
  ...
  @Transactional
  @Authorized({MANAGE_APPOINTMENTS, MANAGE_OWN_APPOINTMENTS})
  List<Appointment> changeStatusForAppointments(
