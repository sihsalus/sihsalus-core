...
@Transactional
public class AppointmentServiceDefinitionServiceImpl
    implements AppointmentServiceDefinitionService {
  ...
  @Override
  public AppointmentServiceDefinition save(
      AppointmentServiceDefinition appointmentServiceDefinition) {
    AppointmentServiceDefinition service =
        appointmentServiceDao.getNonVoidedAppointmentServiceByName(
            appointmentServiceDefinition.getName());
    if (service != null && !service.getUuid().equals(appointmentServiceDefinition.getUuid())) {
      throw new RuntimeException(
          "The service '" + appointmentServiceDefinition.getName() + "' is already present");
    }
  ...
  @Override
  public AppointmentServiceDefinition voidAppointmentService(
      AppointmentServiceDefinition appointmentServiceDefinition, String voidReason) {
    List<Appointment> allFutureAppointmentsForService =
  ...
  public Integer calculateCurrentLoad(
    ...
    AppointmentStatus[] includeStatus =
        new AppointmentStatus[] {
          AppointmentStatus.CheckedIn, AppointmentStatus.Completed, AppointmentStatus.Scheduled
        };
    List<Appointment> appointmentsForService =
        appointmentsService.getAppointmentsForService(
            appointmentServiceDefinition, startDateTime, endDateTime, Arrays.asList(includeStatus));
    return appointmentsForService.size();
  }

  private void setVoidInfoForAppointmentService(
      AppointmentServiceDefinition appointmentServiceDefinition, String voidReason) {
  ...
  private void setVoidInfoForService(
      AppointmentServiceDefinition appointmentServiceDefinition, String voidReason) {
  ...
  private void setVoidInfoForServiceTypes(
      AppointmentServiceDefinition appointmentServiceDefinition, String voidReason) {
    for (AppointmentServiceType appointmentServiceType :
        appointmentServiceDefinition.getServiceTypes()) {
  ...
  private void setVoidInfoForWeeklyAvailability(
      AppointmentServiceDefinition appointmentServiceDefinition, String voidReason) {
    for (ServiceWeeklyAvailability serviceWeeklyAvailability :
        appointmentServiceDefinition.getWeeklyAvailability()) {
  ...
  private void setVoidInfoForAttributes(
      AppointmentServiceDefinition appointmentServiceDefinition, String voidReason) {
