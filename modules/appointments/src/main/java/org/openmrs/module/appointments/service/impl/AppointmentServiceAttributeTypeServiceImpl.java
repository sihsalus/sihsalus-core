...
@Transactional
public class AppointmentServiceAttributeTypeServiceImpl
    implements AppointmentServiceAttributeTypeService {

  private AppointmentServiceAttributeTypeDao appointmentServiceAttributeTypeDao;

  public void setAppointmentServiceAttributeTypeDao(
  ...
  @Override
  public AppointmentServiceAttributeType retire(
      AppointmentServiceAttributeType attributeType, String retireReason) {
