...
public class WeeklyRecurringAppointmentDateTest {
  ...
  @Test
  public void
      shouldReturnEndDateForGivenOddFrequencyAndEvenPeriodAndRecurrenceStartDayFallBetweenSelectedDays() {

    final RecurringPattern recurringPattern =
        new RecurringPatternBuilder()
            .setFrequency(5)
            .setPeriod(2)
            .setType(WEEK)
            .setDaysOfWeek(asList("MONDAY", "SATURDAY"))
            .get();
  ...
  @Test
  public void
      shouldReturnEndDateForGivenEvenFrequencyAndEvenPeriodAndRecurrenceStartDayFallBetweenSelectedDays() {
  ...
  @Test
  public void
      shouldReturnEndDateForGivenOddFrequencyAndOddPeriodAndRecurrenceStartDayFallBetweenSelectedDays() {
  ...
  @Test
  public void
      shouldReturnEndDateForGivenEvenFrequencyAndOddPeriodAndRecurrenceStartDayFallBetweenSelectedDays() {
  ...
  @Test
  public void
      shouldReturnEndDateForGivenOddFrequencyAndEvenPeriodAndRecurrenceStartDayFallsBeforeSelectedDays() {
  ...
  @Test
  public void
      shouldReturnEndDateForGivenEvenFrequencyAndEvenPeriodAndRecurrenceStartDayFallsBeforeSelectedDays() {
  ...
  @Test
  public void
      shouldReturnEndDateForGivenOddFrequencyAndOddPeriodAndRecurrenceStartDayFallsBeforeSelectedDays() {
  ...
  @Test
  public void
      shouldReturnEndDateForGivenEvenFrequencyAndOddPeriodAndRecurrenceStartDayFallsBeforeSelectedDays() {
  ...
  @Test
  public void
      shouldReturnEndDateForGivenOddFrequencyAndEvenPeriodAndRecurrenceStartDayFallsAfterSelectedDays() {
    ...
    final RecurringPattern recurringPattern =
        new RecurringPatternBuilder()
            ...
            .setPeriod(2)
            .setType(WEEK)
            .setDaysOfWeek(asList("MONDAY", "TUESDAY", "WEDNESDAY"))
            .get();
  ...
  @Test
  public void
      shouldReturnEndDateForGivenEvenFrequencyAndEvenPeriodAndRecurrenceStartDayFallsAfterSelectedDays() {
  ...
  @Test
  public void
      shouldReturnEndDateForGivenOddFrequencyAndOddPeriodAndRecurrenceStartDayFallsAfterSelectedDays() {
  ...
  @Test
  public void
      shouldReturnEndDateForGivenEvenFrequencyAndOddPeriodAndRecurrenceStartDayFallsAfterSelectedDays() {
  ...
  @Test
  public void
      shouldReturnAppointmentsForGivenOddFrequencyAndEvenPeriodAndRecurrenceStartDayFallBetweenSelectedDays() {
    final RecurringPattern recurringPattern =
        new RecurringPatternBuilder()
            .setFrequency(3)
            .setPeriod(2)
    ...
    final List<Pair<Date, Date>> appointmentDates =
        getAppointmentDates(
            endDate, appointmentStartDate, appointmentEndDate, asList(MONDAY, SATURDAY), 2);
  ...
  @Test
  public void
      shouldReturnAppointmentsForGivenEvenFrequencyAndEvenPeriodAndRecurrenceStartDayFallBetweenSelectedDays() {
    final RecurringPattern recurringPattern =
        new RecurringPatternBuilder()
            .setFrequency(4)
            .setPeriod(2)
  ...
  @Test
  public void
      shouldReturnTwoAppointmentDatesFromGivenActiveAppointmentsAndAppointmentStartAndEndDates() {
    ...
    appointmentStartAndEndDates.add(
        new ImmutablePair<>(
            getDate(2020, FEBRUARY, 17, 14, 0, 0), getDate(2020, FEBRUARY, 17, 14, 30, 0)));
    appointmentStartAndEndDates.add(
        new ImmutablePair<>(
            getDate(2020, FEBRUARY, 21, 14, 0, 0), getDate(2020, FEBRUARY, 21, 14, 30, 0)));
    appointmentStartAndEndDates.add(
        new ImmutablePair<>(
            getDate(2020, FEBRUARY, 24, 14, 0, 0), getDate(2020, FEBRUARY, 24, 14, 30, 0)));
    appointmentStartAndEndDates.add(
        new ImmutablePair<>(
            getDate(2020, FEBRUARY, 28, 14, 0, 0), getDate(2020, FEBRUARY, 28, 14, 30, 0)));
    appointmentStartAndEndDates.add(
        new ImmutablePair<>(getDate(2020, MARCH, 2, 14, 0, 0), getDate(2020, MARCH, 2, 14, 30, 0)));

    final List<Pair<Date, Date>> newAppointmentDates =
        getNewAppointmentDates(activeAppointments, appointmentStartAndEndDates);
  ...
  @Test
  public void
      shouldReturnTwoAppointmentDatesFromGivenActiveAppointmentsHavingOneRelatedAppointment() {
    ArrayList<Appointment> activeAppointments = new ArrayList<>();
  ...
  public void shouldReturnOriginalFirstAppointmentEvenAfterItIsRemoved() {
    ...
    final Appointment firstOriginalAppointmentInThePattern =
        getFirstOriginalAppointmentInThePattern(activeAppointments, removedAppointments);

    assertEquals(
        appointment1.getStartDateTime(), firstOriginalAppointmentInThePattern.getStartDateTime());
  }
  ...
  public void shouldReturnOriginalFirstAppointmentIfItHasARelatedAppointmentAndRemoved() {
    ...
    assertEquals(
        relatedAppointment.getStartDateTime(),
        firstOriginalAppointmentInThePattern.getStartDateTime());
  }
}
