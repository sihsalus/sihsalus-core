...
public class DailyRecurringAppointmentsGenerationServiceTest {
  ...
  private RecurringAppointmentRequest getAppointmentRequest(
  ...
  private AppointmentRecurringPattern getAppointmentRecurringPattern(
      int period, int frequency, Date endDate) {
  ...
  public void shouldReturnAppointmentsForGivenRecurringPatternAndAppointmentRequest() {
    ...
    RecurringAppointmentRequest recurringAppointmentRequest =
        getAppointmentRequest(appointmentStartDateTime, appointmentEndDateTime);
    ...
    List<Appointment> appointments =
        dailyRecurringAppointmentsGenerationService.generateAppointments(
            recurringAppointmentRequest);

    assertEquals(2, appointments.size());
    assertEquals(
        appointmentStartDateTime.toString(), appointments.get(0).getStartDateTime().toString());
    assertEquals(
        appointmentEndDateTime.toString(), appointments.get(0).getEndDateTime().toString());
    assertEquals(
        getDate(2019, Calendar.MAY, 16, 16, 00, 00).toString(),
        appointments.get(1).getStartDateTime().toString());
    assertEquals(
        getDate(2019, Calendar.MAY, 16, 16, 30, 00).toString(),
  ...
  public void shouldReturnAppointmentsAcrossDaysForGivenRecurringPatternAndAppointmentRequest()
    ...
    assertEquals(
        appointmentEndDateTime.toString(), appointments.get(0).getEndDateTime().toString());
    assertEquals(
        getDate(2019, Calendar.MAY, 19, 23, 45, 0).toString(),
        appointments.get(1).getStartDateTime().toString());
    assertEquals(
        getDate(2019, Calendar.MAY, 20, 0, 15, 0).toString(),
        appointments.get(1).getEndDateTime().toString());
  }

  @Test
  public void
      shouldReturnAppointmentsWithSlotStartsAndEndsOnDifferentDatesForGivenRecurringPatternWithEndDate() {
    Date appointmentStartDateTime = getDate(2019, Calendar.MAY, 16, 23, 45, 00);
    Date appointmentEndDateTime = getDate(2019, Calendar.MAY, 17, 00, 15, 00);
    RecurringAppointmentRequest recurringAppointmentRequest =
        getAppointmentRequest(appointmentStartDateTime, appointmentEndDateTime);
    RecurringPattern recurringPattern =
        getRecurringPattern(3, 0, getDate(2019, Calendar.MAY, 25, 23, 45, 00));
    recurringAppointmentRequest.setRecurringPattern(recurringPattern);
    Mockito.when(appointmentMapper.fromRequest(recurringAppointmentRequest.getAppointmentRequest()))
        .thenAnswer(x -> new Appointment());
    ...
    assertEquals(
        ...
        appointments.get(1).getEndDateTime().toString());
    assertEquals(
        getDate(2019, Calendar.MAY, 22, 23, 45, 0).toString(),
        appointments.get(2).getStartDateTime().toString());
    assertEquals(
        getDate(2019, Calendar.MAY, 23, 0, 15, 0).toString(),
        appointments.get(2).getEndDateTime().toString());
    assertEquals(
        getDate(2019, Calendar.MAY, 25, 23, 45, 0).toString(),
        appointments.get(3).getStartDateTime().toString());
    assertEquals(
        getDate(2019, Calendar.MAY, 26, 0, 15, 0).toString(),
  ...
  public void shouldReturnAppointmentsForGivenRecurringPatternWithEndDate() {
    ...
    RecurringAppointmentRequest recurringAppointmentRequest =
        getAppointmentRequest(appointmentStartDateTime, appointmentEndDateTime);
    RecurringPattern recurringPattern =
        getRecurringPattern(3, 0, getDate(2019, Calendar.MAY, 25, 8, 45, 00));
    recurringAppointmentRequest.setRecurringPattern(recurringPattern);
    Mockito.when(appointmentMapper.fromRequest(recurringAppointmentRequest.getAppointmentRequest()))
        .thenAnswer(x -> new Appointment());
    ...
    assertEquals(
        appointmentEndDateTime.toString(), appointments.get(0).getEndDateTime().toString());
    assertEquals(
        getDate(2019, Calendar.MAY, 19, 8, 45, 0).toString(),
        appointments.get(1).getStartDateTime().toString());
    assertEquals(
        getDate(2019, Calendar.MAY, 19, 9, 15, 0).toString(),
        appointments.get(1).getEndDateTime().toString());
    assertEquals(
        getDate(2019, Calendar.MAY, 22, 8, 45, 0).toString(),
        appointments.get(2).getStartDateTime().toString());
    assertEquals(
        getDate(2019, Calendar.MAY, 22, 9, 15, 0).toString(),
        appointments.get(2).getEndDateTime().toString());
    assertEquals(
        getDate(2019, Calendar.MAY, 25, 8, 45, 0).toString(),
        appointments.get(3).getStartDateTime().toString());
    assertEquals(
        getDate(2019, Calendar.MAY, 25, 9, 15, 0).toString(),
        appointments.get(3).getEndDateTime().toString());
  }
  ...
  public void shouldAddNewAppointmentsForGivenRecurringPatternWhenEndDateIsIncreased() {
    ...
    AppointmentRecurringPattern appointmentRecurringPattern =
        getAppointmentRecurringPattern(3, 0, getDate(2019, Calendar.MAY, 25, 8, 45, 00));
    RecurringPattern recurringPattern = new RecurringPattern();
    ...
    List<Appointment> existingAppointments =
        Arrays.asList(appointment1, appointment2, appointment3);
    List<Appointment> expectedAppointments =
        Arrays.asList(appointment1, appointment2, appointment3, appointment4, appointment5);
    appointmentRecurringPattern.setAppointments(
        existingAppointments.stream().collect(Collectors.toSet()));
    List<Appointment> updatedAppointments =
        dailyRecurringAppointmentsGenerationService.addAppointments(
    ...
    for (int i = 0; i < updatedAppointments.size(); i++) {
      assertEquals(
          expectedAppointments.get(i).getStartDateTime().toString(),
          updatedAppointments.get(i).getStartDateTime().toString());
      assertEquals(
          expectedAppointments.get(i).getEndDateTime().toString(),
  ...
  public void shouldAddNewAppointmentsForGivenRecurringPatternWhenFrequencyIsIncreased() {
    ...
    RecurringAppointmentRequest recurringAppointmentRequest =
        getAppointmentRequest(appointmentStartDateTime, appointmentEndDateTime);
    AppointmentRecurringPattern appointmentRecurringPattern =
        getAppointmentRecurringPattern(3, 3, null);
    RecurringPattern recurringPattern = new RecurringPattern();
  ...
  @Test
  public void
      shouldAddNewAppointmentsForGivenRecurringPatternWhenEndDateIsIncreasedWithVoidedAndRelatedAppointments() {
    Date appointmentStartDateTime = getDate(2019, Calendar.MAY, 25, 8, 45, 00);
    Date appointmentEndDateTime = getDate(2019, Calendar.MAY, 25, 9, 15, 00);
    RecurringAppointmentRequest recurringAppointmentRequest =
        getAppointmentRequest(appointmentStartDateTime, appointmentEndDateTime);
    ...
    List<Appointment> existingAppointments =
        Arrays.asList(
            appointment1, appointment2, appointment3, relatedAppointment, removedAppointment);
    List<Appointment> expectedAppointments =
        Arrays.asList(
            appointment1,
            appointment2,
  ...
  @Test
  public void
      shouldAddNewAppointmentsFromLastActiveDateWhenNoOfOccurencesIsIncreasedFromAnUpdatedAppointmentWhichIsNotTheLastActiveAppointment() {
    ...
    RecurringAppointmentRequest recurringAppointmentRequest =
        getAppointmentRequest(appointmentStartDateTime, appointmentEndDateTime);
    AppointmentRecurringPattern appointmentRecurringPattern =
        getAppointmentRecurringPattern(1, 3, null);
    RecurringPattern recurringPattern = new RecurringPattern();
    recurringPattern.setFrequency(5);
    ...
    List<Appointment> existingAppointments =
        Arrays.asList(appointment1, appointment2, appointment3, relatedAppointment);
    List<Appointment> expectedAppointments =
        Arrays.asList(
            relatedAppointment,
            appointment1,
  ...
  @Test
  public void
      shouldAddNewAppointmentsFromUpdatedAppointmentDateWhenUpdatedAppointmentIsTheOnlyActiveAppointmentAndThenIncreaseNumberOfOccurrences() {
    ...
    RecurringAppointmentRequest recurringAppointmentRequest =
        getAppointmentRequest(appointmentStartDateTime, appointmentEndDateTime);
    AppointmentRecurringPattern appointmentRecurringPattern =
        getAppointmentRecurringPattern(1, 1, null);
    RecurringPattern recurringPattern = new RecurringPattern();
  ...
  @Test
  public void
      shouldAddNewAppointmentsFromLastActiveAppointmentDateIrrespectiveOfTheFutureDateAppointmentsWhichWereRemoved() {
  ...
  @Test
  public void
      shouldAddNewAppointmentsFromUpdatedAppointmentWhenUpdatedAppointmentIsTheLastActiveAppointmentAndNoOfOccurencesIsIncreased() {
    Date appointmentStartDateTime = getDate(2020, Calendar.FEBRUARY, 01, 8, 45, 00);
    Date appointmentEndDateTime = getDate(2020, Calendar.FEBRUARY, 01, 9, 15, 00);
    RecurringAppointmentRequest recurringAppointmentRequest =
        getAppointmentRequest(appointmentStartDateTime, appointmentEndDateTime);
  ...
  public void shouldAddNewAppointmentsWithPeriodAppliedFromLastActiveDate() {
    ...
    RecurringAppointmentRequest recurringAppointmentRequest =
        getAppointmentRequest(appointmentStartDateTime, appointmentEndDateTime);
    AppointmentRecurringPattern appointmentRecurringPattern =
        getAppointmentRecurringPattern(2, 3, null);
    RecurringPattern recurringPattern = new RecurringPattern();
    recurringPattern.setFrequency(5);
  ...
  @Ignore
  public void
      shouldThrowExceptionWhenFrequencyIsDecreasedAndFutureRecurringAppointmentHaveMissedStatus() {
    Date appointmentStartDateTime = getDate(2020, Calendar.FEBRUARY, 01, 8, 45, 00);
    Date appointmentEndDateTime = getDate(2020, Calendar.FEBRUARY, 01, 9, 15, 00);
    RecurringAppointmentRequest recurringAppointmentRequest =
        getAppointmentRequest(appointmentStartDateTime, appointmentEndDateTime);
    AppointmentRecurringPattern appointmentRecurringPattern =
        getAppointmentRecurringPattern(1, 5, null);
    RecurringPattern recurringPattern = new RecurringPattern();
    recurringPattern.setFrequency(3);
    recurringPattern.setPeriod(1);
    recurringAppointmentRequest.setRecurringPattern(recurringPattern);
    ...
    dailyRecurringAppointmentsGenerationService.removeRecurringAppointments(
        appointmentRecurringPattern, recurringAppointmentRequest);
  }

  @Test
  public void
      shouldNotAddNewAppointmentForGivenRecurringPatternWhenUpdatedEndDateIsBeforeLastActiveAppointmentDate() {
    ...
    RecurringAppointmentRequest recurringAppointmentRequest =
        getAppointmentRequest(appointmentStartDateTime, appointmentEndDateTime);
    AppointmentRecurringPattern appointmentRecurringPattern =
        getAppointmentRecurringPattern(1, 0, getDate(2020, Calendar.FEBRUARY, 5, 8, 45, 00));
    RecurringPattern recurringPattern = new RecurringPattern();
    ...
    for (int i = 0; i < updatedAppointments.size(); i++) {
      ...
      assertEquals(
          ...
          updatedAppointments.get(i).getEndDateTime().toString());
      assertEquals(
          getDate(2020, Calendar.FEBRUARY, 7, 8, 45, 0),
