 ...
 *
 * <p>Specifically, the business logic is this:
 *
 * <ol>
 *   <li>When initially created, a bill is PENDING. In the PENDING status, any property is editable
 *   <li>Once a bill has been moved into a non-PENDING state, only payments or adjustments can be
 *       made to the bill
 * </ol>
 */
      ...
      if (idx > 0) {
        ...
        if (currentStatus == BillStatus.PENDING && previousStatus != BillStatus.PENDING) {
          throw new UnchangeableObjectException(
              "editing.fields.not.allowed", new Object[] {"status"});
        }
      }
    }
