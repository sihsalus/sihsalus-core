...
public final class BillingRestrictions {
  ...
  public static BillingCriterion ilike(
      String propertyName, String value, BillingMatchMode matchMode) {
    return (builder, root) -> {
  ...
  public static BillingCriterion gt(String propertyName, Comparable value) {
    return (builder, root) ->
        builder.greaterThan(path(root, propertyName).as(value.getClass()), value);
  }

  @SuppressWarnings({"rawtypes", "unchecked"})
  public static BillingCriterion ge(String propertyName, Comparable value) {
    return (builder, root) ->
        builder.greaterThanOrEqualTo(path(root, propertyName).as(value.getClass()), value);
  }

  @SuppressWarnings({"rawtypes", "unchecked"})
  public static BillingCriterion lt(String propertyName, Comparable value) {
    return (builder, root) ->
        builder.lessThan(path(root, propertyName).as(value.getClass()), value);
  }

  @SuppressWarnings({"rawtypes", "unchecked"})
  public static BillingCriterion le(String propertyName, Comparable value) {
    return (builder, root) ->
        builder.lessThanOrEqualTo(path(root, propertyName).as(value.getClass()), value);
  }

  @SuppressWarnings({"rawtypes", "unchecked"})
  public static BillingCriterion between(String propertyName, Comparable low, Comparable high) {
    return (builder, root) ->
        builder.between(path(root, propertyName).as(low.getClass()), low, high);
  }
  ...
  private static Predicate[] predicates(
      CriteriaBuilder builder, Root<?> root, BillingCriterion[] criteria) {
