...
@Resource(
    name = RestConstants.VERSION_1 + CashierResourceController.BILLING_NAMESPACE + "/paymentMode",
    supportedClass = PaymentMode.class,
...
public class PaymentModeResource extends MetadataDelegatingCrudResource<PaymentMode> {
  ...
  @Override
  public void purge(PaymentMode paymentMode, RequestContext requestContext)
