...
public interface CashPointService extends OpenmrsService {
   ...
   */
  @Authorized({PrivilegeConstants.MANAGE_METADATA})
  List<CashPoint> getCashPointsByLocation(
      Location location, boolean includeRetired, PagingInfo pagingInfo);
   ...
   */
  @Authorized({PrivilegeConstants.MANAGE_METADATA})
  List<CashPoint> getCashPointsByLocationAndName(
  ...
  @Authorized({PrivilegeConstants.MANAGE_METADATA})
  List<CashPoint> getCashPointsByLocationAndName(
      Location location, String name, boolean includeRetired, PagingInfo pagingInfo);
