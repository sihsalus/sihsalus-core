...
public abstract class BaseRestObjectResource<E extends OpenmrsObject>
  ...
  public E save(E delegate) {
    ...
    if (clazz == null) {
      throw new IllegalStateException(
          "This resource has not be defined to allow saving.  "
  ...
  public E getByUniqueId(String uniqueId) {
    ...
    if (clazz == null) {
      throw new IllegalStateException(
          "This resource has not be defined to allow searching. "
  ...
  public void purge(E delegate, RequestContext context) {
    ...
    if (clazz == null) {
      throw new IllegalStateException(
          "This resource has not be defined to allow purging. "
