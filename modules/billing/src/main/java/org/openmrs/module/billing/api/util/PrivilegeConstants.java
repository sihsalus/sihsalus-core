...
public class PrivilegeConstants {
  ...
  public static final String[] PRIVILEGE_NAMES =
      new String[] {
        ...
        REFUND_MONEY,
        REPRINT_RECEIPT,
        MANAGE_BILL_DISCOUNTS,
        APPROVE_BILL_DISCOUNTS,
        VIEW_BILL_DISCOUNTS,
        REQUEST_REFUNDS,
        APPROVE_REFUNDS,
        COMPLETE_REFUNDS,
        ...
        TASK_CREATE_NEW_BILL_PAGE,
        TASK_ADJUST_CASHIER_BILL,
        TASK_CASHIER_TIMESHEETS_PAGE,
        TASK_MANAGE_CASHIER_MODULE_PAGE,
