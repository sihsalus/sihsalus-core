...
// @formatter:off
/**
 * Base class for {@link org.openmrs.OpenmrsObject} models that can be customized based on an {@link
 * IInstanceType}
 *
...
public abstract class BaseInstanceCustomizableObject<
  ...
  static <TA extends IInstanceAttribute, I extends IInstanceCustomizable> void addAttribute(
  ...
  @SuppressWarnings({"unchecked"})
  static <TA extends IInstanceAttribute<?, ?, ?>, I extends IInstanceCustomizable<?, ? extends TA>>
  ...
  // @formatter:off
  public static <
          TA extends IInstanceAttribute<?, ?, ?>, I extends IInstanceCustomizable<?, ? extends TA>>
