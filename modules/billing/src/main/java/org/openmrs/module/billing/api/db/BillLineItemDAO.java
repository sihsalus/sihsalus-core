...
public interface BillLineItemDAO {
   ...
   *
   * <p>This method uses a native query to bypass Hibernate's first-level cache, ensuring it returns
   * the actual persisted state of line items rather than any in-memory modifications.
   *
