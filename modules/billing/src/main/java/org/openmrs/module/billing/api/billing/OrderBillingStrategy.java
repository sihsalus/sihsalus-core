 ...
 * {@code Context.getRegisteredComponents(OrderBillingStrategy.class)} and sorted by {@link
 * Ordered#getOrder()} (lowest value = highest priority). The first strategy whose {@link
 * #supports(Order)} returns {@code true} handles the order. To override a default strategy,
