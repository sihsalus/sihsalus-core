...
public class AttributeUtil {
  ...
  public static Object tryToHydrateObject(String className, String value) {
    // TODO: Refactor this.
    //  This method assumes a lot about what kind of class is being used to store the serialized
    // data
    //  (Attributable). If we assume that the data is in an Attributable than this method can be
    // simplified.  If
    //  not, it should use the general java serialization stuff unless the class is some type we
    // know about and can
