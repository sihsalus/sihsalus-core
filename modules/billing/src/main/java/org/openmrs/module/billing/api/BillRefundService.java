 ...
 *
 * <p>Throughout this interface, a refund is considered <b>"active"</b> when {@code voided=false}
 * AND its {@link RefundStatus} is {@code REQUESTED} or {@code APPROVED}. {@code COMPLETED} and
...
public interface BillRefundService {
   ...
   *       server-side when status moves into {@code APPROVED}/{@code REJECTED} or {@code
   *       COMPLETED}.
   ...
   */
  @Authorized({
    PrivilegeConstants.REQUEST_REFUNDS,
    PrivilegeConstants.APPROVE_REFUNDS,
