...
public class BillValidator implements Validator {
  ...
  /**
   * Validates that line items have not been added or removed from a non-editable bill. This check
   * is necessary because the ImmutableBillInterceptor cannot detect collection changes due to
