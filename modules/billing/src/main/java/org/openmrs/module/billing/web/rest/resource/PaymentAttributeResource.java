...
@Resource(
    name =
        RestConstants.VERSION_1 + CashierResourceController.BILLING_NAMESPACE + "/paymentAttribute",
    supportedClass = PaymentAttribute.class,
    supportedOpenmrsVersions = {"2.0 - 9.*"})
@Slf4j
public class PaymentAttributeResource
    extends BaseRestAttributeDataResource<PaymentAttribute, PaymentModeAttributeType> {

  protected org.openmrs.module.webservices.rest.web.resource.impl.NeedsPaging<PaymentAttribute>
