...
/**
 * Helper class that lets modules centralize their configuration details. See EmrProperties for an
 * example.
 */
...
public abstract class ModuleProperties {
  ...
  /** services */
  @Autowired protected MetadataMappingService metadataMappingService;
  ...
  /**
   * Module should use single metadata source for all its mappings, source name returned by this
   * method will be used to lookup metadata
   */
