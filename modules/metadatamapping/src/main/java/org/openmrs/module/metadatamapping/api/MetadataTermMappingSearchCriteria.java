 ...
 * MetadataMappingService#getMetadataTermMappings(MetadataTermMappingSearchCriteria)}. Use the
...
public class MetadataTermMappingSearchCriteria extends MetadataSearchCriteria {
  ...
  /**
   * Prefer using {@link MetadataTermMappingSearchCriteriaBuilder} instead. Every parameter is
   * optional.
   *
   ...
   */
  public MetadataTermMappingSearchCriteria(
      boolean includeAll,
      Boolean mapped,
      Integer firstResult,
      Integer maxResults,
