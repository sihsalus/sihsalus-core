  ...
  public void validate(Object o, Errors errors) {
    if (o == null || !(o instanceof MetadataTermMapping)) {
      throw new IllegalArgumentException(
          "The parameter obj should not be null and must be of type" + MetadataTermMapping.class);
    } else {
      MetadataTermMapping metadataTermMapping = (MetadataTermMapping) o;
      try {
        Class<?> aClass =
            getClass().getClassLoader().loadClass(metadataTermMapping.getMetadataClass());
