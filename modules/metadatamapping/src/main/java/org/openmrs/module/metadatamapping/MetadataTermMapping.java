...
/**
 * Maps a "term" withing a specific namespace or "source" to a local metadata object. {@link
 * #getCode()} is the public identifier of this term withing the {@link #getMetadataSource()}.
 *
 * @since 1.1
 */
public class MetadataTermMapping extends BaseOpenmrsMetadata {
   ...
   */
  public MetadataTermMapping(
      MetadataSource metadataSource, String metadataTermCode, OpenmrsMetadata mappedObject) {
    this();
   ...
   */
  public MetadataTermMapping(
      MetadataSource metadataSource, String metadataTermCode, String metadataClass) {
    this();
    ArgUtil.notNull(metadataSource, "metadataSource");
    ArgUtil.notNull(metadataTermCode, "metadataTermCode");
    ArgUtil.notNull(metadataClass, "metadataClass");
