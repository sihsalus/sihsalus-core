...
public class MetadataMappingConstructors {
  ...
  public static MetadataTermMapping metadataTermMapping(
  ...
  public static MetadataSetMember metadataSetMember(
      MetadataSet set, String metadataClass, String metadataUuid, Double sortWeight, String uuid) {
