...
public class ValueComplexTest {
  ...
  @Test
  @Verifies(
      value = "ValueComplex should handle file names even when containing the reserved separator.",
      method = "ValueComplex(String, String, String)")
  public void valueComplex_shouldHandleFileNamesWithSeparator() {
    ...
    // Replay
    fileName =
        ValueComplex.PIPE_WITH_LEADING_AND_TRAILING_SPACE
            + ValueComplex.PIPE_WITH_LEADING_AND_TRAILING_SPACE
            + ValueComplex.PIPE_WITH_LEADING_AND_TRAILING_SPACE
            + ValueComplex.PIPE_WITH_LEADING_AND_TRAILING_SPACE
            + ValueComplex.PIPE_WITH_LEADING_AND_TRAILING_SPACE
  ...
  public void valueComplex_shouldProperlyParsePreCore2_8ValueComplexString() {
    ...
    assertEquals(
        "sample-local-pdf_20251112_130823_218e5c1b-4091-462b-9e83-c124425e8a91.pdf",
  ...
  public void valueComplex_shouldProperlyParseCore2_8ValueComplexString() {
    String valueComplexString =
        "m3ks | instructions.default | application/pdf | sample-local-pdf_20251114_093817.pdf file |complex_obs/2025/11-14/2025-11-14-10-45-05-281-dEuO5wCG-sample-local-pdf_20251114_093817.pdf";
    ...
    String valueComplexStringImage =
        "m3ks | instructions.default | image/jpeg | IMG_3869.jpg image |complex_obs/2025/12-04/2025-12-04-14-33-53-304-lt1wjrkK-IMG_3869.jpg";
    ...
    assertEquals(
        "complex_obs/2025/12-04/2025-12-04-14-33-53-304-lt1wjrkK-IMG_3869.jpg",
