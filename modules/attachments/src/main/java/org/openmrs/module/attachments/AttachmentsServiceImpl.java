...
public class AttachmentsServiceImpl extends BaseOpenmrsService implements AttachmentsService {
  ...
  @Override
  public List<Attachment> getAttachments(
      Patient patient, Encounter encounter, boolean includeVoided) {
    List<Person> persons = new ArrayList<>();
  ...
  @Override
  public List<Attachment> getAttachments(
      Patient patient, final Visit visit, boolean includeVoided) {
    ...
    List<Encounter> encounters =
        getCtx()
            .getEncounterService()
            .getEncounters(
                patient, null, null, null, null, null, null, null, visits, includeVoided);
  ...
  private Obs getComplexObs(Obs obs) {
    ...
    String view =
        getCtx().getComplexViewHelper().getView(obs, AttachmentsConstants.ATT_VIEW_THUMBNAIL);
