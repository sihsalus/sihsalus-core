...
public class RoomProviderMapServiceTest {
  ...
  @Mock private RoomProviderMapDao dao;

  @Captor ArgumentCaptor<RoomProviderMapSearchCriteria> roomProviderMapSearchCriteriaArgumentCaptor;
  ...
  public void shouldGetByUuid() {
    ...
    Optional<RoomProviderMap> result =
        roomProviderMapService.getRoomProviderMapByUuid(ROOM_PROVIDER_MAP_UUID);
  ...
  public void shouldPurgeRoomProviderMap() {
    ...
    assertThat(
        roomProviderMapService.getRoomProviderMapByUuid(ROOM_PROVIDER_MAP_UUID).isPresent(),
        is(false));
  }
  ...
  public void shouldGetRoomProviderMapsByCriteria() {
    ...
    RoomProviderMapSearchCriteria daoCriteria =
        roomProviderMapSearchCriteriaArgumentCaptor.getValue();
