...
public class QueueEntrySubResource extends DelegatingSubResource<QueueEntry, Queue, QueueResource> {
  ...
  @Override
  public PageableResult doGetAll(Queue queue, RequestContext requestContext)
      throws ResponseException {
    QueueEntrySearchCriteria criteria = new QueueEntrySearchCriteria();
    criteria.setQueues(Collections.singletonList(queue));
    criteria.setIsEnded(false);
    Collection<QueueEntry> queueEntries =
        getServices().getQueueEntryService().getQueueEntries(criteria);
  ...
  @Override
  protected void delete(QueueEntry queueEntry, String voidReason, RequestContext requestContext)
      throws ResponseException {
