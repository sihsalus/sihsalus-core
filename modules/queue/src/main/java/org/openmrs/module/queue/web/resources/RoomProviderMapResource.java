...
public class RoomProviderMapResource extends DelegatingCrudResource<RoomProviderMap> {
  ...
  public RoomProviderMapResource(
      QueueServicesWrapper services, RoomProviderMapSearchCriteriaParser parser) {
  ...
  public NeedsPaging<RoomProviderMap> doGetAll(RequestContext ctx) throws ResponseException {
    return new NeedsPaging<>(
        new ArrayList<>(getServices().getRoomProviderMapService().getAllRoomProviderMaps()), ctx);
  }

  @Override
  public RoomProviderMap getByUniqueId(String uuid) {
    Optional<RoomProviderMap> optional =
        getServices().getRoomProviderMapService().getRoomProviderMapByUuid(uuid);
  ...
  @Override
  protected void delete(RoomProviderMap rpm, String voidReason, RequestContext context)
  ...
  @Override
  public void purge(RoomProviderMap roomProviderMap, RequestContext requestContext)
      throws ResponseException {
  ...
  protected PageableResult doSearch(RequestContext requestContext) {
    ...
    RoomProviderMapSearchCriteria criteria =
        getSearchCriteriaParser().constructFromRequest(parameters);
    List<RoomProviderMap> rpms =
        getServices().getRoomProviderMapService().getRoomProviderMaps(criteria);
  ...
  private void addSharedResourceDescriptionProperties(
  ...
  public Model getGETModel(Representation rep) {
    ...
    if (rep instanceof DefaultRepresentation || rep instanceof FullRepresentation) {
      model
          ...
          .property("queueRoom", new StringProperty())
  ...
  public Model getCREATEModel(Representation rep) {
    ModelImpl model =
        new ModelImpl()
            ...
            .property("queueRoom", new StringProperty().example("uuid"));
    if (rep instanceof FullRepresentation) {
  ...
  public RoomProviderMapSearchCriteriaParser getSearchCriteriaParser() {
    if (searchCriteriaParser == null) {
      searchCriteriaParser =
          Context.getRegisteredComponents(RoomProviderMapSearchCriteriaParser.class).get(0);
    }
