...
public class QueueEntryResource extends DelegatingCrudResource<QueueEntry> {
  ...
  public QueueEntryResource(
      QueueServicesWrapper services, QueueEntrySearchCriteriaParser searchCriteriaParser) {
  ...
  public QueueEntry getByUniqueId(@NotNull String uuid) {
    Optional<QueueEntry> queueEntryOptional =
        getServices().getQueueEntryService().getQueueEntryByUuid(uuid);
  ...
  @Override
  protected void delete(QueueEntry qe, String reason, RequestContext requestContext)
  ...
  public Model getCREATEModel(Representation rep) {
    return new ModelImpl()
        ...
        .property("visit", new RefProperty("#/definitions/VisitCreate"))
        .property("sortWeight", new DoubleProperty())
        .property("startedAt", new DateProperty())
  ...
  public QueueEntrySearchCriteriaParser getSearchCriteriaParser() {
    if (searchCriteriaParser == null) {
      searchCriteriaParser =
          Context.getRegisteredComponents(QueueEntrySearchCriteriaParser.class).get(0);
    }
