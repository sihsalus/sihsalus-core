...
@Component
public class AllergyIntoleranceReactionComponentTranslatorImpl
    implements AllergyIntoleranceReactionComponentTranslator {
  ...
  @Override
  public AllergyIntolerance.AllergyIntoleranceReactionComponent toFhirResource(
              ...
              manifestation ->
                  allergy
                      ...
                      .add(
                          new AllergyReaction(
                              allergy,
                              conceptTranslator.toOpenmrsType(manifestation),
  ...
  @Override
  public Allergy toOpenmrsType(
      @Nonnull AllergyIntolerance.AllergyIntoleranceReactionComponent resource) {
