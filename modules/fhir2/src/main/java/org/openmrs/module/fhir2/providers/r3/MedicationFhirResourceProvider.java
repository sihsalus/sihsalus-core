...
public class MedicationFhirResourceProvider implements IResourceProvider {
        ...
        VersionConvertorFactory_30_40.convertResource(
            medicationService.create(
                (org.hl7.fhir.r4.model.Medication)
                    VersionConvertorFactory_30_40.convertResource(medication))));
  }
  ...
  public IBundleProvider searchForMedication(
    ...
    return new SearchQueryBundleProviderR3Wrapper(
        medicationService.searchForMedications(
            new MedicationSearchParams(
                code, dosageForm, ingredientCode, id, lastUpdated, revIncludes)));
  }
}
