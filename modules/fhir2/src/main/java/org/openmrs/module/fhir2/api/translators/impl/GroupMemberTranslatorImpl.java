...
public class GroupMemberTranslatorImpl implements GroupMemberTranslator {
  ...
  public GroupMember toFhirResource(@Nonnull Integer memberId) {
    ...
    return new GroupMember(
        patientReferenceTranslator.toFhirResource(patientDao.getPatientById(memberId)));
  }
  ...
  @Override
  public Integer toOpenmrsType(
      @Nonnull Integer existingMemberId, @Nonnull GroupMember groupMember) {
