...
public class EpisodeOfCareTranslatorImpl implements EpisodeOfCareTranslator {
  ...
  public EpisodeOfCare toFhirResource(@Nonnull PatientProgram patientProgram) {
    ...
    episodeOfCare.setPatient(
        patientReferenceTranslator.toFhirResource(patientProgram.getPatient()));
  ...
  @Override
  public PatientProgram toOpenmrsType(
      @Nonnull PatientProgram patientProgram, @Nonnull EpisodeOfCare episodeOfCare) {
    throw new UnsupportedOperationException(
        "Translation from FHIR resource EpisodeOfCare to OpenMRS object PatientProgram is not"
            + " supported.");
  }
  ...
  private List<CodeableConcept> getType(PatientProgram patientProgram) {
    ...
    CodeableConcept codeableConcept =
        conceptTranslator.toFhirResource(patientProgram.getProgram().getConcept());
