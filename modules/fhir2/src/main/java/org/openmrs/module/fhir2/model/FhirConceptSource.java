 ...
 * In order to properly map between the representation of concepts in FHIR, e.g.,
 *
 * <pre>{@code
 * {
 ...
 * }</pre>
 *
 * and the way concepts are represented in the OpenMRS concept dictionary (using a {@link
 * ConceptSource}, a {@link org.openmrs.ConceptReferenceTerm}, and a {@link
 * org.openmrs.ConceptReferenceTermMap}), we need a way of translating this URL into a {@link
 * ConceptSource}, which is the mapping this class provides.
 *
 * <p>While it's less common, occasionally FHIR will use URNs rather than URLs to represent code
