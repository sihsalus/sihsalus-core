...
public class PractitionerFhirResourceProvider extends BaseUpsertFhirResourceProvider<Practitioner> {
  ...
  protected MethodOutcome doUpsert(
    ...
    return FhirProviderUtils.buildUpdate(
        practitionerService.update(
            id.getIdPart(), practitioner, requestDetails, createIfNotExists));
  }

  @Patch
  public MethodOutcome patchPractitioner(
      @IdParam IdType id,
    ...
    Practitioner practitioner =
        practitionerService.patch(id.getIdPart(), patchType, body, requestDetails);
  ...
  @Search
  public IBundleProvider searchForPractitioners(
    ...
    return practitionerService.searchForPractitioners(
