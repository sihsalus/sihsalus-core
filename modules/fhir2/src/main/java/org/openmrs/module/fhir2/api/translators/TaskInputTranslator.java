...
public interface TaskInputTranslator
    extends ToFhirTranslator<FhirTaskInput, Task.ParameterComponent>,
        ToOpenmrsTranslator<FhirTaskInput, Task.ParameterComponent> {

  /**
   * Maps an {@link org.openmrs.module.fhir2.model.FhirTaskInput} to a corresponding {@link
  ...
  /**
   * Maps an {@link org.hl7.fhir.r4.model.Task.ParameterComponent} to a existing {@link
   * org.openmrs.module.fhir2.model.FhirTaskInput}
   *
