...
public interface ReferenceTranslator
    extends OpenmrsFhirUpdatableTranslator<FhirReference, Reference> {
   ...
   */
  FhirReference toOpenmrsType(
      @Nonnull FhirReference currentReference, @Nonnull Reference fhirReference);
}
