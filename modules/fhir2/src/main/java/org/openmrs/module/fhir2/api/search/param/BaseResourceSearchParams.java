...
/**
 * Class containing shared search (and search result) parameters that apply to all resources See <a
 * href="https://www.hl7.org/fhir/search.html#Summary">The HL7 Search API</a> for a comprehensive
...
public abstract class BaseResourceSearchParams implements Serializable {
  ...
  protected final SearchParameterMap baseSearchParameterMap() {
    return new SearchParameterMap()
        .addParameter(FhirConstants.COMMON_SEARCH_HANDLER, FhirConstants.ID_PROPERTY, getId())
        .addParameter(
        ...
        .addParameter(FhirConstants.REVERSE_INCLUDE_SEARCH_HANDLER, getRevIncludes())
        .setSortSpec(getSort())
