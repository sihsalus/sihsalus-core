...
public class AllergyIntoleranceFhirResourceProvider implements IResourceProvider {
  ...
  public IBundleProvider searchForAllergies(
    ...
    return fhirAllergyIntoleranceService.searchForAllergies(
  ...
  public MethodOutcome updateAllergy(
    ...
    return FhirProviderUtils.buildUpdate(
        fhirAllergyIntoleranceService.update(id.getIdPart(), allergy));
  }

  @Patch
  public MethodOutcome patchAllergy(
      @IdParam IdType id,
    ...
    if (id == null || id.getIdPart() == null) {
      throw new InvalidRequestException(
          "id must be specified to patch AllergyIntolerance resource");
    }

    AllergyIntolerance allergyIntolerance =
        fhirAllergyIntoleranceService.patch(id.getIdPart(), patchType, body, requestDetails);
