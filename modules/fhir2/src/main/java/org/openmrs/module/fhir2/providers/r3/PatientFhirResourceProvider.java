...
public class PatientFhirResourceProvider implements IResourceProvider {
        ...
        VersionConvertorFactory_30_40.convertResource(
            patientService.create(
                (org.hl7.fhir.r4.model.Patient)
                    VersionConvertorFactory_30_40.convertResource(patient))));
  }
  ...
  public IBundleProvider searchOpenmrsPatients(
      ...
      @OptionalParam(name = org.hl7.fhir.r4.model.Patient.SP_ADDRESS_STATE)
          StringAndListParam state,
      @OptionalParam(name = org.hl7.fhir.r4.model.Patient.SP_ADDRESS_POSTALCODE)
          StringAndListParam postalCode,
      @OptionalParam(name = org.hl7.fhir.r4.model.Patient.SP_ADDRESS_COUNTRY)
      ...
      @IncludeParam(
              reverse = true,
              allow = {
                "Observation:" + org.hl7.fhir.r4.model.Observation.SP_PATIENT,
                ...
                "MedicationDispense:" + org.hl7.fhir.r4.model.MedicationDispense.SP_PRESCRIPTION
              })
          HashSet<Include> revIncludes) {
    if (CollectionUtils.isEmpty(revIncludes)) {
      revIncludes = null;
    ...
    return new SearchQueryBundleProviderR3Wrapper(
        patientService.searchForPatients(
            new OpenmrsPatientSearchParams(
                query,
                gender,
                birthDate,
                deathDate,
  ...
  public IBundleProvider getPatientEverything(@IdParam IdType patientId) {
    ...
    return new SearchQueryBundleProviderR3Wrapper(
        patientService.getPatientEverything(patientReference));
  }
