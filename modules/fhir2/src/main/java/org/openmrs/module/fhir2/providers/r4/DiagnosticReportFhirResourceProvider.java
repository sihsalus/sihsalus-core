...
public class DiagnosticReportFhirResourceProvider implements IResourceProvider {
  ...
  public DiagnosticReport getDiagnosticReportById(@IdParam @Nonnull IdType id) {
    ...
    if (diagnosticReport == null) {
      throw new ResourceNotFoundException(
          "Could not find Diagnostic Report with Id " + id.getIdPart());
    }
  ...
  @Patch
  public MethodOutcome patchDiagnosticReport(
      @IdParam IdType id,
    ...
    DiagnosticReport diagnosticReport =
        service.patch(id.getIdPart(), patchType, body, requestDetails);
  ...
  public IBundleProvider searchForDiagnosticReports(
    ...
    return service.searchForDiagnosticReports(
