...
public interface MedicationRequestTimingRepeatComponentTranslator
    extends ToFhirTranslator<DrugOrder, Timing.TimingRepeatComponent>,
        UpdatableOpenmrsTranslator<DrugOrder, Timing.TimingRepeatComponent> {
  ...
  /**
   * Populates a {@link DrugOrder} with dosing information from a {@link
  ...
  DrugOrder toOpenmrsType(
      @Nonnull DrugOrder drugOrder, @Nonnull Timing.TimingRepeatComponent resource);
}
