...
public final class ReferenceHandlingTranslator {
  ...
  public static Reference createLocationReference(@Nonnull Location location) {
    return createReferenceOfType(location, FhirConstants.LOCATION)
        .setDisplay(getMetadataTranslation(location));
  }
  ...
  public static Reference createOrderReference(
      @Nonnull Order order, OrderIdentifierTranslator orderIdentifierTranslator) {
    if (order == null) {
      return null;
    }
  ...
  public static Reference createDrugOrderReference(
      @Nonnull DrugOrder drugOrder, OrderIdentifierTranslator orderIdentifierTranslator) {
    if (drugOrder == null) {
      return null;
    }
  ...
  public static Reference createTestOrderReference(
      @Nonnull TestOrder order, OrderIdentifierTranslator orderIdentifierTranslator) {
    if (order == null) {
      return null;
    }
  ...
  private static Reference createReferenceOfType(
      @Nonnull OpenmrsObject object, @Nonnull String referenceType) {
    return createReferenceOfType(object.getUuid(), referenceType);
  }

  private static Reference createReferenceOfType(
      @Nonnull String uuid, @Nonnull String referenceType) {
