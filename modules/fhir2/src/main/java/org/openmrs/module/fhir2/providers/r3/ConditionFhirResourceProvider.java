...
public class ConditionFhirResourceProvider implements IResourceProvider {
    ...
    org.hl7.fhir.r4.model.Condition created =
        conditionService.create(
            (org.hl7.fhir.r4.model.Condition)
                VersionConvertorFactory_30_40.convertResource(newCondition));

    return FhirProviderUtils.buildCreate(convertToR3Condition(created));
  }

  @Update
  public MethodOutcome updateCondition(
      @IdParam IdType id, @ResourceParam Condition updatedCondition) {
    ...
    org.hl7.fhir.r4.model.Condition updated =
        conditionService.update(
            id.getIdPart(),
            (org.hl7.fhir.r4.model.Condition)
                VersionConvertorFactory_30_40.convertResource(updatedCondition));
  ...
  public IBundleProvider searchConditions(
      ...
      @OptionalParam(
          ...
          ReferenceAndListParam subjectParam,
  ...
  private Condition convertToR3Condition(org.hl7.fhir.r4.model.Condition condition) {
    ...
    if (FhirUtils.getOpenmrsConditionType(condition)
        .filter(type -> type == FhirUtils.OpenmrsConditionType.DIAGNOSIS)
        .isPresent()) {
