...
@Component
public class FhirPatientServiceImpl extends BaseFhirService<Patient, org.openmrs.Patient>
    implements FhirPatientService {
  ...
  public IBundleProvider searchForPatients(PatientSearchParams patientSearchParams) {
    return searchQuery.getQueryResults(
        patientSearchParams.toSearchParameterMap(), dao, translator, searchQueryInclude);
  }
