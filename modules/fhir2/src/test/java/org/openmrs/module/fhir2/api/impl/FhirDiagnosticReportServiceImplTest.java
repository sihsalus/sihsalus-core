...
public class FhirDiagnosticReportServiceImplTest {
  ...
  @Mock private FhirDiagnosticReportDao dao;

  @Mock private DiagnosticReportTranslator translator;
  ...
  @Mock private SearchQueryInclude<DiagnosticReport> searchQueryInclude;
  ...
  public void setUp() {
    service =
        new FhirDiagnosticReportServiceImpl() {
  ...
  public void updateDiagnosticReport_shouldUpdateExistingDiagnosticReport() {
    ...
    when(translator.toOpenmrsType(fhirDiagnosticReport, diagnosticReport))
        .thenReturn(updatedFhirDiagnosticReport);
  ...
  public void searchForDiagnosticReports_shouldReturnCollectionOfDiagnosticReportsByParameters() {
    ...
    IBundleProvider results =
        service.searchForDiagnosticReports(
    ...
    IBundleProvider results =
        service.searchForDiagnosticReports(
            new DiagnosticReportSearchParams(
                null, null, null, null, null, null, null, null, includes));
