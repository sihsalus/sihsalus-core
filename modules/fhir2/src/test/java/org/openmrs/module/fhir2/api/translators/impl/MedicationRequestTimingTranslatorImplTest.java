...
public class MedicationRequestTimingTranslatorImplTest {
  ...
  @Mock private DurationUnitTranslator durationUnitTranslator;
  ...
  public void setup() {
    ...
    when(orderService.getOrderFrequencyByConcept(oncePerDayConcept))
        .thenReturn(oncePerDayFrequency);
    when(orderService.getOrderFrequencyByUuid("once-per-day-frequency-uuid"))
        .thenReturn(oncePerDayFrequency);
  }
