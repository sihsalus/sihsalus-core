...
public class ConditionVerificationStatusTranslatorImplTest {
  ...
  public void shouldTranslateConfirmedVerificationStatusToFhirType() {
    CodeableConcept codeableConcept =
        verificationStatusTranslator.toFhirResource(ConditionVerificationStatus.CONFIRMED);
  ...
  public void shouldTranslateProvisionalVerificationStatusToFhirType() {
    CodeableConcept codeableConcept =
        verificationStatusTranslator.toFhirResource(ConditionVerificationStatus.PROVISIONAL);
  ...
  public void shouldTranslateProvisionalVerificationStatusToOpenMrsType() {
    ...
    codeableConcept.addCoding(
        new Coding()
            .setCode(FHIR_CONFIRMED)
            .setSystem(FhirConstants.CONDITION_VERIFICATION_STATUS_SYSTEM_URI));

    assertThat(
        verificationStatusTranslator.toOpenmrsType(codeableConcept),
