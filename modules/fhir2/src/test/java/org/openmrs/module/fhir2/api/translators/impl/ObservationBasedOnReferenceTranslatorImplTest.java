...
public class ObservationBasedOnReferenceTranslatorImplTest {
  ...
  @Mock private FhirServiceRequestDao<TestOrder> orderDao;

  @Mock private FhirMedicationRequestDao medicationRequestDao;
  ...
  public void toOpenmrsType_shouldConvertServiceRequestReferenceToOrder() {
    Reference orderReference =
        new Reference()
            .setReference(FhirConstants.SERVICE_REQUEST + "/" + ORDER_UUID)
  ...
  public void toOpenmrsType_shouldConvertMedicationRequestReferenceToOrder() {
    Reference orderReference =
        new Reference()
            .setReference(FhirConstants.MEDICATION_REQUEST + "/" + ORDER_UUID)
