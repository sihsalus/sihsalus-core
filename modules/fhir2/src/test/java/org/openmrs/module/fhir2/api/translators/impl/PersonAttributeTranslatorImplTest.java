...
public class PersonAttributeTranslatorImplTest {
  ...
  private static final String LOCATION_ATTRIBUTE_UUID_VALUE =
      "ae919697-60a2-4f72-834c-e7d9df3ecf62";

  private static final String LOCATION_NAME = "Test Location";

  @Mock private FhirLocationService locationService;
  ...
  @InjectMocks private PersonAttributeTranslatorImpl personAttributeTranslator;
  ...
  public void setup() {
    ...
    when(personService.getPersonAttributeTypeByName(ATTRIBUTE_TYPE_NAME))
  ...
  public void shouldTranslatePersonAttributeToFhirExtension() {
    ...
    assertThat(
        result.getExtensionByUrl(FhirConstants.OPENMRS_FHIR_EXT_PERSON_ATTRIBUTE_TYPE),
        notNullValue());
    assertThat(
        result.getExtensionByUrl(FhirConstants.OPENMRS_FHIR_EXT_PERSON_ATTRIBUTE_VALUE),
        notNullValue());
    assertThat(
        result
  ...
  public void shouldTranslateStringPersonAttributeToFhirExtension() {
    ...
    assertThat(
        ((StringType) valueExtension.getValue()).getValue(), equalTo(STRING_ATTRIBUTE_VALUE));
  }
  ...
  public void shouldNotTranslateExtensionWithoutPersonAttributeTypeInSystemToPersonAttribute() {
    ...
    when(personService.getPersonAttributeTypeByName(NOT_IN_SYSTEM_ATTRIBUTE_TYPE_NAME))
        .thenReturn(null);
