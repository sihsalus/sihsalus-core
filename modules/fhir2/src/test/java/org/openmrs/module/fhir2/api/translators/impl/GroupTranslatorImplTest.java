...
public class GroupTranslatorImplTest {
  ...
  @Mock private GroupMemberTranslator groupMemberTranslator;
  ...
  public void shouldTranslateCohortMembersToFHIRGroupMembers() {
    ...
    // when(groupMemberTranslator.toFhirResource(anyInt())).thenReturn(new
    // GroupMember(groupMemberComponent.getEntity()));
