...
public class FhirAllergyIntoleranceServiceImplTest {
  ...
  @Mock private FhirAllergyIntoleranceDao allergyIntoleranceDao;

  @Mock private AllergyIntoleranceTranslator translator;

  @Mock private FhirGlobalPropertyService globalPropertyService;

  @Mock private SearchQueryInclude<AllergyIntolerance> searchQueryInclude;
  ...
  public void setup() {
    service =
        new FhirAllergyIntoleranceServiceImpl() {
  ...
  public void searchForAllergies_shouldSearchForAllergiesByIdentifier() {
    ...
    IBundleProvider results =
        service.searchForAllergies(
            new FhirAllergyIntoleranceSearchParams(
                patientParam, null, null, null, null, null, null, null, null, null));
  ...
  public void searchForAllergies_shouldSearchForAllergiesByCategory() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(FhirConstants.CATEGORY_SEARCH_HANDLER, category);
  ...
  public void searchForAllergies_shouldSearchForAllergiesByAllergen() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(FhirConstants.ALLERGEN_SEARCH_HANDLER, allergen);
    ...
    IBundleProvider results =
        service.searchForAllergies(
            new FhirAllergyIntoleranceSearchParams(
                null, null, allergen, null, null, null, null, null, null, null));
  ...
  public void searchForAllergies_shouldSearchForAllergiesBySeverity() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(FhirConstants.SEVERITY_SEARCH_HANDLER, severity);
    ...
    IBundleProvider results =
        service.searchForAllergies(
            new FhirAllergyIntoleranceSearchParams(
                null, null, null, severity, null, null, null, null, null, null));
  ...
  public void searchForAllergies_shouldSearchForAllergiesByManifestation() {
    ...
    manifestation.addAnd(
        new TokenOrListParam().addOr(new TokenParam().setValue(CODED_REACTION_UUID)));

    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(FhirConstants.CODED_SEARCH_HANDLER, manifestation);
    ...
    IBundleProvider results =
        service.searchForAllergies(
            new FhirAllergyIntoleranceSearchParams(
                null, null, null, null, manifestation, null, null, null, null, null));
  ...
  public void searchForAllergies_shouldSearchForAllergiesByClinicalStatus() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(FhirConstants.BOOLEAN_SEARCH_HANDLER, status);
  ...
  public void searchForAllergies_shouldSearchForAllergiesByUUID() {
    ...
    when(allergyIntoleranceDao.getSearchResults(any()))
    ...
    IBundleProvider results =
        service.searchForAllergies(
            new FhirAllergyIntoleranceSearchParams(
                null, null, null, null, null, null, uuid, null, null, null));
  ...
  public void searchForAllergies_shouldAddPatientsToReturnedResultsWhenIncluded() {
    ...
    IBundleProvider results =
        service.searchForAllergies(
            new FhirAllergyIntoleranceSearchParams(
                null, null, null, null, null, null, null, null, null, includes));
