...
public class EncounterLocationTranslatorImplTest {
  ...
  public void shouldTranslateEncounterLocationToFhirType() {
    Encounter.EncounterLocationComponent result =
        encounterLocationTranslator.toFhirResource(location);
  ...
  public void shouldTranslateEncounterLocationToOpenMrsType() {
    ...
    assertThat(
        encounterLocationTranslator.toOpenmrsType(encounterLocationComponent), notNullValue());
  }
