...
public class FhirPractitionerServiceImplTest {
  ...
  @Mock private PractitionerTranslator<Provider> practitionerTranslator;

  @Mock private FhirPractitionerDao practitionerDao;

  @Mock private FhirGlobalPropertyService globalPropertyService;

  @Mock private SearchQueryInclude<Practitioner> searchQueryInclude;
  ...
  private SearchQuery<
          ...
          Practitioner,
          FhirPractitionerDao,
          PractitionerTranslator<Provider>,
          SearchQueryInclude<Practitioner>>
      searchQuery;

  @Mock private FhirUserService userService;
  ...
  public void setUp() {
    ...
    practitioner2.setIdentifier(
        Collections.singletonList(new Identifier().setValue(USER_SYSTEM_ID)));
  ...
  public void shouldSearchForPractitionersByNameWhoIsProvider() {
    StringAndListParam name =
        new StringAndListParam().addAnd(new StringOrListParam().add(new StringParam(NAME)));

    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(NAME_SEARCH_HANDLER, NAME_PROPERTY, name);

    when(practitionerDao.getSearchResults(any())).thenReturn(singletonList(provider));
    when(searchQuery.getQueryResults(any(), any(), any(), any()))
        .thenReturn(
            new SearchQueryBundleProvider<>(
                theParams,
                practitionerDao,
                practitionerTranslator,
    ...
    IBundleProvider results =
        practitionerService.searchForPractitioners(
            new PractitionerSearchParams(
  ...
  public void shouldSearchForPractitionersByNameWhoIsUser() {
    StringAndListParam name =
        new StringAndListParam().addAnd(new StringOrListParam().add(new StringParam(USER_NAME)));
    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(NAME_SEARCH_HANDLER, NAME_PROPERTY, name);
  ...
  public void shouldSearchForPractitionersByNameWhoIsUserAndProvider() {
    ...
    when(practitionerDao.getSearchResults(any())).thenReturn(Collections.singletonList(provider));
    when(practitionerDao.getSearchResultsCount(any())).thenReturn(1);
    when(searchQuery.getQueryResults(any(), any(), any(), any()))
        .thenReturn(
            new SearchQueryBundleProvider<>(
                theParams,
  ...
  public void shouldReturnEmptyCollectionByWrongName() {
    StringAndListParam name =
        new StringAndListParam().addAnd(new StringOrListParam().add(new StringParam(WRONG_NAME)));
    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(NAME_SEARCH_HANDLER, NAME_PROPERTY, name);
  ...
  public void shouldSearchForPractitionersByIdentifier() {
    TokenAndListParam identifier =
        new TokenAndListParam().addAnd(new TokenOrListParam().add(IDENTIFIER));
    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(FhirConstants.IDENTIFIER_SEARCH_HANDLER, identifier);
    ...
    IBundleProvider results =
        practitionerService.searchForPractitioners(
            new PractitionerSearchParams(
                identifier, null, null, null, null, null, null, null, null, null, null));
  ...
  public void shouldReturnEmptyCollectionByWrongIdentifier() {
    TokenAndListParam identifier =
        new TokenAndListParam().addAnd(new TokenOrListParam().add(WRONG_IDENTIFIER));
    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(FhirConstants.IDENTIFIER_SEARCH_HANDLER, identifier);
  ...
  public void shouldSearchForPractitionersByGivenNameWhoIsUserAndProvider() {
    StringAndListParam givenName =
        new StringAndListParam().addAnd(new StringParam(PRACTITIONER_GIVEN_NAME));
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(
                FhirConstants.NAME_SEARCH_HANDLER, FhirConstants.GIVEN_PROPERTY, givenName);
    ...
    IBundleProvider results =
        practitionerService.searchForPractitioners(
            new PractitionerSearchParams(
                null, null, givenName, null, null, null, null, null, null, null, null));
  ...
  public void shouldReturnEmptyCollectionByWrongGivenName() {
    StringAndListParam givenName =
        new StringAndListParam().addAnd(new StringParam(WRONG_GIVEN_NAME));
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(
                FhirConstants.NAME_SEARCH_HANDLER, FhirConstants.GIVEN_PROPERTY, givenName);

    when(practitionerDao.getSearchResults(any())).thenReturn(Collections.emptyList());
    when(searchQuery.getQueryResults(any(), any(), any(), any()))
        .thenReturn(
            new SearchQueryBundleProvider<>(
                theParams,
  ...
  public void shouldSearchForPractitionersByFamilyNameWhoIsProvider() {
    StringAndListParam familyName =
        new StringAndListParam().addAnd(new StringParam(PRACTITIONER_FAMILY_NAME));
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(
                FhirConstants.NAME_SEARCH_HANDLER, FhirConstants.FAMILY_PROPERTY, familyName);
    ...
    IBundleProvider results =
        practitionerService.searchForPractitioners(
            new PractitionerSearchParams(
                null, null, null, familyName, null, null, null, null, null, null, null));
  ...
  public void shouldSearchForPractitionersByFamilyNameWhoIsUser() {
    StringAndListParam familyName =
        new StringAndListParam().addAnd(new StringParam(PRACTITIONER_FAMILY_NAME));
    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(NAME_SEARCH_HANDLER, FAMILY_PROPERTY, familyName);
  ...
  public void shouldReturnEmptyCollectionByWrongFamilyName() {
    StringAndListParam familyName =
        new StringAndListParam().addAnd(new StringParam(WRONG_FAMILY_NAME));
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(
                FhirConstants.NAME_SEARCH_HANDLER, FhirConstants.FAMILY_PROPERTY, familyName);
  ...
  public void shouldSearchForPractitionersByAddressCity() {
    ...
    IBundleProvider results =
        practitionerService.searchForPractitioners(
            new PractitionerSearchParams(
                null, null, null, null, city, null, null, null, null, null, null));
  ...
  public void shouldSearchForPractitionersByAddressState() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(
                FhirConstants.ADDRESS_SEARCH_HANDLER, FhirConstants.STATE_PROPERTY, state);
    ...
    IBundleProvider results =
        practitionerService.searchForPractitioners(
            new PractitionerSearchParams(
                null, null, null, null, null, state, null, null, null, null, null));
  ...
  public void shouldSearchForPractitionersByAddressPostalCode() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(
                FhirConstants.ADDRESS_SEARCH_HANDLER,
    ...
    IBundleProvider results =
        practitionerService.searchForPractitioners(
            new PractitionerSearchParams(
                null, null, null, null, null, null, postalCode, null, null, null, null));
  ...
  public void shouldReturnEmptyCollectionByWrongAddressPostalCode() {
    StringAndListParam postalCode =
        new StringAndListParam().addAnd(new StringParam(WRONG_POSTAL_CODE));
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(
                FhirConstants.ADDRESS_SEARCH_HANDLER,
  ...
  public void shouldSearchForPractitionersByAddressCountry() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(
                FhirConstants.ADDRESS_SEARCH_HANDLER, FhirConstants.COUNTRY_PROPERTY, country);
    ...
    IBundleProvider results =
        practitionerService.searchForPractitioners(
            new PractitionerSearchParams(
                null, null, null, null, null, null, null, country, null, null, null));
  ...
  public void shouldSearchForPractitionersByUUID() {
    ...
    IBundleProvider results =
        practitionerService.searchForPractitioners(
            new PractitionerSearchParams(
                null, null, null, null, null, null, null, null, uuid, null, null));
  ...
  public void shouldSearchForPractitionersByLastUpdated() {
    ...
    IBundleProvider results =
        practitionerService.searchForPractitioners(
            new PractitionerSearchParams(
                null, null, null, null, null, null, null, null, null, lastUpdated, null));
  ...
  public void shouldReturnEmptyCollectionByWrongLastUpdated() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(
                FhirConstants.COMMON_SEARCH_HANDLER, FhirConstants.ID_PROPERTY, lastUpdated);
  ...
  public void shouldAddRelatedResourcesToReturnedResultsWhenReverseIncluded() {
    ...
    when(searchQueryInclude.getIncludedResources(any(), any()))
        .thenReturn(Collections.singleton(new Encounter()));
    when(searchQuery.getQueryResults(any(), any(), any(), any()))
        .thenReturn(
            new SearchQueryBundleProvider<>(
                theParams,
