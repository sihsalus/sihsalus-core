...
public class ReferenceHandlingTranslatorTest {
  ...
  private static final String NAME_DISPLAY =
      "Ricky Morty (" + TEST_IDENTIFIER_TYPE_NAME + ": 34ty5jsd-u)";
  ...
  private static final String TEST_ORDER_REFERENCE =
      FhirConstants.SERVICE_REQUEST + "/" + ORDER_UUID;

  private static final String DRUG_ORDER_REFERENCE =
      FhirConstants.MEDICATION_REQUEST + "/" + ORDER_UUID;
  ...
  public void shouldExtractIdFromReference() {
    assertThat(
        ReferenceHandlingTranslator.getReferenceId(new Reference().setReference(PATIENT_URI))
            .orElse(null),
  ...
  public void shouldReturnNullIdForNullReference() {
    assertThat(
        ReferenceHandlingTranslator.getReferenceId(new Reference()).orElse(null), nullValue());
  }

  @Test
  public void shouldNotExtractIdWhenIdMissingFromReference() {
    assertThat(
        ReferenceHandlingTranslator.getReferenceId(
                new Reference().setReference(FhirConstants.PATIENT + "/"))
            .orElse(null),
        nullValue());
  }
  ...
  public void shouldReturnNullIdWhenNoSlashFound() {
    assertThat(
        ReferenceHandlingTranslator.getReferenceId(new Reference().setReference(PATIENT_UUID))
            .orElse(null),
        nullValue());
  }
  ...
  public void shouldExtractReferenceTypeFromReference() {
    assertThat(
        ReferenceHandlingTranslator.getReferenceType(new Reference().setReference(PATIENT_URI))
            .orElse(null),
  ...
  public void shouldReturnNullTypeForNullReference() {
    assertThat(
        ReferenceHandlingTranslator.getReferenceType(new Reference()).orElse(null), nullValue());
  }

  @Test
  public void shouldReturnNullTypeWhenTypeMissing() {
    assertThat(
        ReferenceHandlingTranslator.getReferenceType(
                new Reference().setReference("/" + PATIENT_UUID))
            .orElse(null),
        nullValue());
  }
  ...
  public void shouldReturnNullTypeWhenNoSlashFound() {
    assertThat(
        ReferenceHandlingTranslator.getReferenceType(new Reference().setReference(PATIENT_UUID))
            .orElse(null),
        nullValue());
  }
  ...
  public void shouldUseExplicitType() {
    assertThat(
        ReferenceHandlingTranslator.getReferenceType(new Reference().setType(FhirConstants.PATIENT))
            .orElse(null),
        equalTo(FhirConstants.PATIENT));
  }
