...
public class AllergyIntoleranceCategoryTranslatorImplTest {
  ...
  public void toFhirResource_shouldTranslateDrugAllergenTypeToMedicationCategory() {
    assertThat(
        categoryTranslator.toFhirResource(AllergenType.DRUG),
  ...
  public void toFhirResource_shouldTranslateFoodAllergenTypeToFoodCategory() {
    assertThat(
        categoryTranslator.toFhirResource(AllergenType.FOOD),
  ...
  public void toFhirResource_shouldTranslateEnvironmentAllergenTypeToEnvironmentCategory() {
    assertThat(
        categoryTranslator.toFhirResource(AllergenType.ENVIRONMENT),
  ...
  public void toOpenmrsType_shouldTranslateMedicationCategoryToDrugAllergenType() {
    assertThat(
        categoryTranslator.toOpenmrsType(AllergyIntolerance.AllergyIntoleranceCategory.MEDICATION),
  ...
  public void toOpenmrsType_shouldTranslateFoodCategoryToFoodAllergenType() {
    assertThat(
        categoryTranslator.toOpenmrsType(AllergyIntolerance.AllergyIntoleranceCategory.FOOD),
  ...
  public void toOpenmrsType_shouldTranslateEnvironmentCategoryToEnvironmentAllergenType() {
    assertThat(
        categoryTranslator.toOpenmrsType(AllergyIntolerance.AllergyIntoleranceCategory.ENVIRONMENT),
  ...
  public void toOpenmrsType_shouldTranslateBiologicCategoryToNullAllergenType() {
    assertThat(
        categoryTranslator.toOpenmrsType(AllergyIntolerance.AllergyIntoleranceCategory.BIOLOGIC),
        nullValue());
  }
  ...
  public void toOpenmrsType_shouldTranslateNullCategoryToNullAllergenType() {
    assertThat(
        categoryTranslator.toOpenmrsType(AllergyIntolerance.AllergyIntoleranceCategory.NULL),
        nullValue());
  }
}
