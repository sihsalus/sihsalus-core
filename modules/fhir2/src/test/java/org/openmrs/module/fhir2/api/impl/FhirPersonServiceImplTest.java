...
public class FhirPersonServiceImplTest {
  ...
  @Mock private FhirPersonDao dao;

  @Mock private PersonTranslator personTranslator;

  @Mock private FhirGlobalPropertyService globalPropertyService;

  @Mock private SearchQueryInclude<Person> searchQueryInclude;
    ...
    when(searchQuery.getQueryResults(any(), any(), any(), any()))
        .thenReturn(
            new SearchQueryBundleProvider<>(
                theParams, dao, personTranslator, globalPropertyService, searchQueryInclude));
  ...
  @Test
  public void searchForPeople_shouldReturnCollectionOfPersonWhenPersonBirthDateMatched()
