...
public class MedicationDispenseTranslatorImplTest {
  ...
  @Mock private EncounterReferenceTranslator<Encounter> encounterReferenceTranslator;

  @Mock private MedicationRequestReferenceTranslator medicationRequestReferenceTranslator;

  @Mock private ConceptTranslator conceptTranslator;

  @Mock private LocationReferenceTranslator locationReferenceTranslator;

  @Mock private PractitionerReferenceTranslator<Provider> practitionerReferenceTranslator;

  @Mock private MedicationDispenseStatusTranslator medicationDispenseStatusTranslator;

  @Mock private MedicationRequestStatusTranslator statusTranslator;

  @Mock private MedicationReferenceTranslator medicationReferenceTranslator;

  @Mock private MedicationRequestPriorityTranslator medicationRequestPriorityTranslator;

  @Mock
  private MedicationRequestTimingRepeatComponentTranslator
      medicationRequestTimingRepeatComponentTranslator;

  @Mock private OrderIdentifierTranslator orderIdentifierTranslator;
  ...
  @Before
  public void setup() {
    MedicationQuantityCodingTranslatorImpl quantityCodingTranslator =
        new MedicationQuantityCodingTranslatorImpl();
    quantityCodingTranslator.setConceptTranslator(conceptTranslator);

    MedicationRequestDispenseRequestComponentTranslatorImpl dispenseRequestTranslator =
        new MedicationRequestDispenseRequestComponentTranslatorImpl();
    dispenseRequestTranslator.setQuantityCodingTranslator(quantityCodingTranslator);

    MedicationRequestTimingTranslatorImpl timingTranslator =
        new MedicationRequestTimingTranslatorImpl();
    timingTranslator.setTimingRepeatComponentTranslator(
        medicationRequestTimingRepeatComponentTranslator);
    ...
    MedicationRequestTranslatorImpl medicationRequestTranslator =
        new MedicationRequestTranslatorImpl();
  ...
  public void toFhirResource_shouldTranslateStatus() {
    ...
    org.hl7.fhir.r4.model.MedicationDispense.MedicationDispenseStatus fhirObject =
  ...
  public void toFhirResource_shouldTranslateDoseQuantityAndUnits() {
    ...
    org.hl7.fhir.r4.model.MedicationDispense dispense = translator.toFhirResource(openmrsDispense);
    Quantity quantity =
        dispense.getDosageInstructionFirstRep().getDoseAndRateFirstRep().getDoseQuantity();
  ...
  public void toFhirResource_shouldTranslateDoseAsNeeded() {
    ...
    assertThat(dispense, notNullValue());
    assertThat(
        dispense.getDosageInstructionFirstRep().getAsNeededBooleanType().getValue(), equalTo(true));
  }
  ...
  public void toFhirResource_shouldTranslateDosingInstructions() {
    ...
    assertThat(dispense, notNullValue());
    assertThat(
        dispense.getDosageInstructionFirstRep().getText(),
        equalTo(openmrsDispense.getDosingInstructions()));
  }
  ...
  public void toFhirResource_shouldTranslateRecordedExtension() {
    ...
    assertThat(
        ((DateTimeType)
                dispense.getExtensionByUrl(FhirConstants.OPENMRS_FHIR_EXT_RECORDED).getValue())
            .getValue(),
        equalTo(dateCreated));
  }
  ...
  public void toOpenmrsType_shouldTranslateStatus() {
    Concept openmrsObject = new Concept();
    org.hl7.fhir.r4.model.MedicationDispense.MedicationDispenseStatus fhirObject =
        org.hl7.fhir.r4.model.MedicationDispense.MedicationDispenseStatus.COMPLETED.COMPLETED;
  ...
  public void toOpenmrsType_shouldTranslateDoseQuantityAndUnits() {
    ...
    Dosage.DosageDoseAndRateComponent doseAndRateComponent =
  ...
  public void toOpenmrsType_shouldTranslateWasSubstituted() {
    fhirDispense.setSubstitution(
        new org.hl7.fhir.r4.model.MedicationDispense.MedicationDispenseSubstitutionComponent()
            .setWasSubstituted(true));
    MedicationDispense dispense = translator.toOpenmrsType(fhirDispense);
