...
public class TaskTranslatorImplTest {
  ...
  private static final FhirTask.TaskStatus OPENMRS_TASK_STATUS_CANCELLED =
      FhirTask.TaskStatus.CANCELLED;
  ...
  @Mock private ReferenceTranslatorImpl referenceTranslator;

  @Mock private TaskInputTranslatorImpl taskInputTranslator;

  @Mock private TaskOutputTranslatorImpl taskOutputTranslator;

  @Mock private ConceptTranslator conceptTranslator;
  ...
  public void toFhirResource_shouldTranslateStatus() {
    ...
    assertThat(
        taskTranslator.toFhirResource(task).getStatus(), equalTo(FHIR_TASK_STATUS_CANCELLED));
  }
  ...
  public void toOpenmrsType_shouldTranslateStatus() {
    ...
    assertThat(
        taskTranslator.toOpenmrsType(task).getStatus(), equalTo(OPENMRS_TASK_STATUS_CANCELLED));
  }
  ...
  public void toFhirResource_shouldTranslateBasedOn() {
    ...
    shouldTranslateReferenceListToFhir(
        task,
        FhirConstants.SERVICE_REQUEST,
        SERVICE_REQUEST_UUID,
        task::setBasedOnReferences,
        t -> new ArrayList<>(t.getBasedOn()));
  }
  ...
  public void toOpenmrsType_shouldTranslateBasedOn() {
    ...
    shouldTranslateReferenceListToOpenmrs(
        task,
        FhirConstants.SERVICE_REQUEST,
        SERVICE_REQUEST_UUID,
        task::setBasedOn,
  ...
  public void toOpenmrsType_shouldUpdateBasedOn() {
    ...
    shouldUpdateReferenceListInOpenmrs(
        task,
        FhirConstants.SERVICE_REQUEST,
        SERVICE_REQUEST_UUID,
        task::setBasedOn,
  ...
  public void toFhirResource_shouldTranslateEncounter() {
    ...
    shouldTranslateReferenceToFhir(
        task,
        FhirConstants.ENCOUNTER,
        ENCOUNTER_UUID,
        task::setEncounterReference,
        Task::getEncounter);
  }
  ...
  public void toOpenmrsType_shouldTranslateEncounter() {
    ...
    shouldTranslateReferenceToOpenmrs(
        task,
        FhirConstants.ENCOUNTER,
        ENCOUNTER_UUID,
        task::setEncounter,
  ...
  public void toOpenmrsType_shouldUpdateEncounter() {
    ...
    shouldUpdateReferenceInOpenmrs(
        task,
        FhirConstants.ENCOUNTER,
        ENCOUNTER_UUID,
        task::setEncounter,
  ...
  public void toFhirResource_shouldTranslateOwner() {
    ...
    shouldTranslateReferenceToFhir(
        task, FhirConstants.ORGANIZATION, OPENELIS_ID, task::setOwnerReference, Task::getOwner);
  }
  ...
  public void toOpenmrsType_shouldTranslateOwner() {
    ...
    shouldTranslateReferenceToOpenmrs(
        task, FhirConstants.ORGANIZATION, OPENELIS_ID, task::setOwner, FhirTask::getOwnerReference);
  }
  ...
  public void toFhirResource_shouldTranslateFor() {
    ...
    shouldTranslateReferenceToFhir(
        task, FhirConstants.PATIENT, PATIENT_UUID, task::setForReference, Task::getFor);
  }
  ...
  public void toOpenmrsType_shouldTranslateFor() {
    ...
    shouldTranslateReferenceToOpenmrs(
        task, FhirConstants.PATIENT, PATIENT_UUID, task::setFor, FhirTask::getForReference);
  }
  ...
  public void toFhirResource_shouldTranslateLocation() {
    ...
    shouldTranslateReferenceToFhir(
        task, FhirConstants.LOCATION, LOCATION_UUID, task::setLocationReference, Task::getLocation);
  }
  ...
  public void toFhirResource_shouldTranslateOutputReference() {
    ...
    Task result =
        shouldTranslateReferenceToFhir(
            ...
            output::setValueReference,
            t -> (Reference) t.getOutput().iterator().next().getValue());

    assertThat(result.getOutput(), hasSize(1));
    assertThat(
        result.getOutput().iterator().next().getType().getCoding().iterator().next().getCode(),
  ...
  public void toOpenmrsType_shouldTranslateOutputReference() {
    ...
    FhirTask result =
        shouldTranslateReferenceToOpenmrs(
            ...
            DIAGNOSTIC_REPORT_UUID,
            output::setValue,
            t -> t.getOutput().iterator().next().getValueReference());
  ...
  public void toFhirResource_shouldTranslateMultipleOutputValueTypes() {
    ...
    assertThat(
        ((Reference) result.getOutput().get(0).getValue()).getReference(),
        equalTo(DIAGNOSTIC_REPORT_UUID));

    assertTrue(result.getOutput().get(1).getValue() instanceof DateTimeType);
    assertThat(
        ((DateTimeType) result.getOutput().get(1).getValue()).getValue(),
        DateMatchers.sameDay(new Date()));

    assertTrue(result.getOutput().get(2).getValue() instanceof DecimalType);
    assertThat(
        ((DecimalType) result.getOutput().get(2).getValue()).getValueAsNumber().doubleValue(),
  ...
  public void toOpenmrsType_shouldTranslateMultipleOutputValueTypes() {
    ...
    assertThat(
        outputList.get(2).getValueReference().getReference(), equalTo(DIAGNOSTIC_REPORT_UUID));
  ...
  public void toFhirResource_shouldTranslateInputTextValue() {
    ...
    assertThat(
        result.getInput().iterator().next().getType().getCoding().iterator().next().getCode(),
        equalTo(CONCEPT_UUID));
  ...
  public void toOpenmrsType_shouldTranslateInputTextValue() {
    ...
    assertThat(
        result.getInput(),
        hasItem(hasProperty("type", hasProperty("uuid", equalTo(CONCEPT_UUID)))));
  ...
  public void toFhirResource_shouldTranslateMultipleInputValueTypes() {
    ...
    assertThat(
        ((Reference) result.getInput().get(0).getValue()).getReference(),
        equalTo(DIAGNOSTIC_REPORT_UUID));

    assertTrue(result.getInput().get(1).getValue() instanceof DateTimeType);
    assertThat(
        ((DateTimeType) result.getInput().get(1).getValue()).getValue(),
        DateMatchers.sameDay(new Date()));

    assertTrue(result.getInput().get(2).getValue() instanceof DecimalType);
    assertThat(
        ((DecimalType) result.getInput().get(2).getValue()).getValueAsNumber().doubleValue(),
        equalTo(numericValue));
  ...
  public void toOpenmrsType_shouldTranslateMultipleInputValueTypes() {
    ...
    assertThat(
        inputList.get(2).getValueReference().getReference(), equalTo(DIAGNOSTIC_REPORT_UUID));
  ...
  public void toOpenmrsType_shouldTranslatePartOf() {
    ...
    shouldTranslateReferenceListToOpenmrs(
        task, FhirConstants.TASK, PARENT_TASK_UUID, task::setPartOf, FhirTask::getPartOfReferences);
  }
  ...
  private Task shouldTranslateReferenceToFhir(
      FhirTask task,
      String refType,
      String refUuid,
      Consumer<FhirReference> setOpenmrsReference,
      Function<Task, Reference> getFhirReference) {
    FhirReference openmrsReference = new FhirReference();
  ...
  private FhirTask shouldTranslateReferenceToOpenmrs(
      Task task,
      String refType,
      String refUuid,
      Consumer<Reference> setFhirReference,
      Function<FhirTask, FhirReference> getOpenmrsReference) {
    Reference fhirReference = new Reference().setReference(refUuid).setType(refType);
  ...
  private FhirTask shouldUpdateReferenceInOpenmrs(
      Task task,
      String refType,
      String refUuid,
      Consumer<Reference> setFhirReference,
  ...
  private void shouldTranslateReferenceListToFhir(
      FhirTask task,
      String refType,
      String refUuid,
      Consumer<Set<FhirReference>> setOpenmrsReference,
      Function<Task, List<Reference>> getFhirReference) {
    FhirReference openmrsReference = new FhirReference();
    openmrsReference.setType(refType);
    openmrsReference.setReference(refUuid);
  ...
  private void shouldTranslateReferenceListToOpenmrs(
      Task task,
      String refType,
      String refUuid,
      Consumer<List<Reference>> setFhirReference,
      Function<FhirTask, Set<FhirReference>> getOpenmrsReference) {
  ...
  private void shouldUpdateReferenceListInOpenmrs(
      Task task,
      String refType,
      String refUuid,
      Consumer<List<Reference>> setFhirReference,
