...
public class FhirConceptSourceServiceImplTest {
  ...
  @Mock private FhirConceptSourceDao dao;
  ...
  public void getFhirConceptSources_shouldReturnFhirConceptSources() {
    Collection<FhirConceptSource> sources =
        Lists.newArrayList(new FhirConceptSource(), new FhirConceptSource());
  ...
  public void getFhirConceptSourceByUrl_shouldReturnConceptSourceForUrl() {
    ...
    Optional<FhirConceptSource> result =
        fhirConceptSourceService.getFhirConceptSourceByUrl("http://www.example.com");
  ...
  @Test
  public void
      getFhirConceptSourceByConceptSource_shouldReturnEmptyOptionalWhereNoFhirConceptSourceExists() {
    ConceptSource conceptSource = new ConceptSource();
    Optional<FhirConceptSource> result =
        fhirConceptSourceService.getFhirConceptSource(conceptSource);
    assertThat(result.isPresent(), is(false));
  }
  ...
  public void getFhirConceptSourceByHl7Code_shouldReturnNullForMissingSourceName() {
    Optional<ConceptSource> result =
        fhirConceptSourceService.getConceptSourceByHl7Code("SNOMED CT");
