...
public class MedicationTranslatorImplTest {
  ...
  public void toFhirResource_shouldTranslateDosageConceptToMedicationForm() {
    CodeableConcept code =
        new CodeableConcept().addCoding(new Coding("", DOSAGE_FORM_CONCEPT_UUID, ""));
    ...
    assertThat(
        medication.getForm().getCoding().get(0).getCode(), equalTo(DOSAGE_FORM_CONCEPT_UUID));
  }
  ...
  public void toFhirResource_shouldTranslateDrugIngredientToMedicationIngredient() {
    ...
    CodeableConcept codeableConcept =
        new CodeableConcept().addCoding(new Coding("", INGREDIENT_CONCEPT_UUID, ""));
    ...
    assertThat(
        medication.getIngredient().get(0).getItemCodeableConcept().getCoding().size(),
        greaterThanOrEqualTo(1));
    assertThat(
        medication.getIngredient().get(0).getItemCodeableConcept().getCoding().get(0).getCode(),
  ...
  public void toOpenmrsType_shouldTranslateFormToDrugDosageForm() {
    Medication medication = new Medication();
    medication.setForm(
        new CodeableConcept().addCoding(new Coding(null, DOSAGE_FORM_CONCEPT_UUID, "")));
  ...
  public void toOpenmrsType_shouldTranslateMedicationIngredientsToDrugIngredients() {
    ...
    assertThat(
        drug.getIngredients().iterator().next().getIngredient().getUuid(),
        equalTo(INGREDIENT_CONCEPT_UUID));
  }
  ...
  public void addMedicineExtension_shouldAddExtensionForMaximumDailyDose() {
    assertThat(
        medicationTranslator
            .toFhirResource(drug)
            .getExtensionByUrl(FhirConstants.OPENMRS_FHIR_EXT_MEDICINE)
  ...
  public void addMedicineComponent_shouldSetMaximumDailyDoseCorrectly() {
    medicationTranslator.addMedicineComponent(
        drug, FhirConstants.OPENMRS_FHIR_EXT_MEDICINE + "#maximumDailyDose", "3.5");
  ...
  public void addMedicineComponent_shouldSetMinimumDailyDoseCorrectly() {
    medicationTranslator.addMedicineComponent(
        drug, FhirConstants.OPENMRS_FHIR_EXT_MEDICINE + "#minimumDailyDose", "2.0");
  ...
  public void addMedicineComponent_shouldSetStrengthCorrectly() {
    medicationTranslator.addMedicineComponent(
        drug, FhirConstants.OPENMRS_FHIR_EXT_MEDICINE + "#strength", DOSE_STRENGTH);
  ...
  public void addMedicineComponent_shouldSetDrugNameCorrectly() {
    medicationTranslator.addMedicineComponent(
        drug, FhirConstants.OPENMRS_FHIR_EXT_MEDICINE + "#" + DRUG_NAME_EXTENSION, DRUG_NAME);
  ...
  public void addMedicineComponent_shouldReturnNullIfValueIsNull() {
    ...
    medicationTranslator.addMedicineComponent(
        drug, FhirConstants.OPENMRS_FHIR_EXT_MEDICINE + "#strength", null);
    assertThat(drug.getStrength(), nullValue());
    assertThat(drug.getMinimumDailyDose(), nullValue());
    assertThat(drug.getMaximumDailyDose(), nullValue());
  }
  ...
  public void addMedicineComponent_shouldReturnNullIUrlDontStartWithNumberSign() {
    ...
    medicationTranslator.addMedicineComponent(
        drug, FhirConstants.OPENMRS_FHIR_EXT_MEDICINE, DOSE_STRENGTH);
    assertThat(drug.getStrength(), nullValue());
    assertThat(drug.getMinimumDailyDose(), nullValue());
    assertThat(drug.getMaximumDailyDose(), nullValue());
  }
