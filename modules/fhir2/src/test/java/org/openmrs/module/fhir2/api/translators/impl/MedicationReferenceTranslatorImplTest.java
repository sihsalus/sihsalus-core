...
public class MedicationReferenceTranslatorImplTest {
  ...
  @Mock private FhirMedicationDao dao;
  ...
  public void toOpenmrsType_shouldConvertReferenceToDrug() {
    Reference medicationReference =
        new Reference()
            .setReference(FhirConstants.MEDICATION + "/" + MEDICATION_UUID)
  ...
  public void toOpenmrsType_shouldThrowExceptionIfReferenceIsntForMedication() {
    Reference reference =
        new Reference().setReference("Unknown" + "/" + MEDICATION_UUID).setType("Unknown");
