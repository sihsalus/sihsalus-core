...
public class FhirContactPointMapServiceImplTest {
  ...
  @Mock private FhirContactPointMapDao fhirContactPointMapDao;

  @Mock private FhirContactPointMapServiceImpl fhirContactPointMapService;
  ...
  public void getFhirContactPointMapByUuid_shouldFhirContactPointMapByUuid() {
    when(fhirContactPointMapDao.getFhirContactPointMapByUuid(
            "497daha3-5750-4yf6-8g11-518c49f73445"))
        .thenReturn(Optional.of(fhirContactPointMap));

    Optional<FhirContactPointMap> result =
        fhirContactPointMapService.getFhirContactPointMapByUuid(
            "497daha3-5750-4yf6-8g11-518c49f73445");
  ...
  public void getFhirContactPointMapByUuid_shouldReturnEmptyFhirContactPointMapWhenNoUuidIsFound() {
    ...
    Optional<FhirContactPointMap> result =
        fhirContactPointMapService.getFhirContactPointMapByUuid(null);
  ...
  @Test
  public void
      getFhirContactPointMapForPersonAttributeType_shouldReturnEmptyFhirContactPointMapWhenNoPersonAttributeTypeIsFound() {
    when(fhirContactPointMapDao.getFhirContactPointMapForPersonAttributeType(null))
        .thenReturn(Optional.empty());

    Optional<FhirContactPointMap> result =
        fhirContactPointMapService.getFhirContactPointMapForPersonAttributeType(null);
  ...
  @Test
  public void
      getFhirContactPointMapForPersonAttributeType_shouldReturnFhirContactPointMapWhenPersonAttributeTypeIsFound() {
  ...
  @Test
  public void
      getFhirContactPointMapForAttributeType_shouldReturnEmptyFhirContactPointMapWhenAttributeTypeIsNotFound() {
    when(fhirContactPointMapDao.getFhirContactPointMapForAttributeType(null))
        .thenReturn(Optional.empty());

    Optional<FhirContactPointMap> result =
        fhirContactPointMapService.getFhirContactPointMapForAttributeType(null);
  ...
  @Test
  public void
      getFhirContactPointMapForAttributeType_shouldReturnFhirContactPointMapWhenLocationAttributeTypeIsFound() {
    when(fhirContactPointMapDao.getFhirContactPointMapForAttributeType(locationAttributeType))
        .thenReturn(Optional.of(fhirContactPointMap));

    Optional<FhirContactPointMap> result =
        fhirContactPointMapService.getFhirContactPointMapForAttributeType(locationAttributeType);
  ...
  @Test
  public void
      getFhirContactPointMapForAttributeType_shouldReturnFhirContactPointMapWhenProviderAttributeTypeIsFound() {
    when(fhirContactPointMapDao.getFhirContactPointMapForAttributeType(providerAttributeType))
        .thenReturn(Optional.of(fhirContactPointMap));

    Optional<FhirContactPointMap> result =
        fhirContactPointMapService.getFhirContactPointMapForAttributeType(providerAttributeType);
  ...
  public void saveFhirContactPointMap_ShouldReturnFhirContactPointMap() {
    ...
    when(fhirContactPointMapDao.saveFhirContactPointMap(fhirContactPointMap))
        .thenReturn(fhirContactPointMap);

    FhirContactPointMap result =
  ...
  public void saveFhirContactPointMap_ShouldUpdateExistingFhirContactPointMap() {
    ...
    FhirContactPointMap result =
        fhirContactPointMapService.saveFhirContactPointMap(existingFhirContactPointMap);
