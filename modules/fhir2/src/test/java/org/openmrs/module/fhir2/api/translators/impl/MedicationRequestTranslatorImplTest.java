...
public class MedicationRequestTranslatorImplTest {
  ...
  private static final String PRIOR_MEDICATION_REQUEST_REFERENCE =
      FhirConstants.MEDICATION_REQUEST + "/" + DRUG_ORDER_UUID;
  ...
  @Mock private PractitionerReferenceTranslator<Provider> providerPractitionerReferenceTranslator;

  @Mock private MedicationRequestStatusTranslator medicationRequestStatusTranslator;
  ...
  @Mock private MedicationRequestTimingTranslator timingTranslator;

  private MedicationRequestDispenseRequestComponentTranslatorImpl
  ...
  public void setup() {
    ...
    medicationRequestTranslator.setPractitionerReferenceTranslator(
    ...
    medicationRequestTranslator.setMedicationRequestReferenceTranslator(
  ...
  public void toOpenMrsType_shouldTranslateToOpenType() {
    DrugOrder result =
        medicationRequestTranslator.toOpenmrsType(new DrugOrder(), medicationRequest);
  ...
  @Test
  public void
      toFhirResource_shouldTranslateToFhirResourceWithReplacesFieldGivenDiscontinuedOrder() {
    ...
    assertThat(
        result.getPriorPrescription().getReference(), equalTo(PRIOR_MEDICATION_REQUEST_REFERENCE));
    assertThat(
        result.getPriorPrescription().getIdentifier().getValue(), equalTo(DRUG_ORDER_NUMBER));
  }
  ...
  public void toFhirResource_shouldTranslateToFhirResourceWithBasedOnFieldGivenRenewOrder() {
    ...
    assertThat(result.getId(), equalTo(DISCONTINUED_DRUG_ORDER_UUID));
    assertThat(
        result.getBasedOn().get(0).getReference(), equalTo(PRIOR_MEDICATION_REQUEST_REFERENCE));
  ...
  public void toOpenMrsType_shouldTranslateRequesterToOpenMrsType() {
    ...
    when(providerPractitionerReferenceTranslator.toOpenmrsType(requesterReference))
        .thenReturn(provider);
  ...
  public void toFhirResource_shouldTranslateOrdererToFhirType() {
    ...
    when(providerPractitionerReferenceTranslator.toFhirResource(provider))
        .thenReturn(requesterReference);
  ...
  public void toOpenMrsType_shouldTranslatePriorityToOpenMrsType() {
    ...
    when(medicationRequestPriorityTranslator.toOpenmrsType(
            MedicationRequest.MedicationRequestPriority.ROUTINE))
  ...
  public void toFhirResource_shouldTranslateConceptToMedicationCodeableConceptWithDrugNonCoded() {
    ...
    assertThat(
        result.getMedicationCodeableConcept().getText(), equalTo("Non-Coded Drug Formulation"));
  }
  ...
  public void toFhirResource_shouldAddDosageInstructions() {
    ...
    assertThat(
        result.getDosageInstructionFirstRep().getAsNeededBooleanType().booleanValue(), is(true));
  ...
  public void toFhirResource_shouldTranslateOpenMrsDateChangedToLastUpdated() {
    ...
    org.hl7.fhir.r4.model.MedicationRequest medicationRequest =
        medicationRequestTranslator.toFhirResource(drugOrder);
