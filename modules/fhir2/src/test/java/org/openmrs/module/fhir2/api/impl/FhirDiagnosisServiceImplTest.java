...
public class FhirDiagnosisServiceImplTest {
  ...
  @Mock private FhirDiagnosisDao dao;

  @Mock private DiagnosisTranslator translator;

  @Mock private SearchQueryInclude<Condition> searchQueryInclude;
  ...
  public void searchDiagnoses_shouldDelegateToSearchQuery() {
    ...
    when(searchQuery.getQueryResults(expectedParams, dao, translator, searchQueryInclude))
        .thenReturn(provider);
