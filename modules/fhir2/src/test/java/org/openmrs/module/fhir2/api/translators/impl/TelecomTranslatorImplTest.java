...
public class TelecomTranslatorImplTest {
  ...
  private static final String FHIR_CONTACT_POINT_MAP_TYPE_UUID =
      "fe637eac-7698-4763-8de0-923437fd3132";
  ...
  @Mock private FhirContactPointMapService fhirContactPointMapService;
  ...
  public void toFhirResource_shouldTranslatePersonAttributeUseToFhirContactPointUse() {
    when(fhirContactPointMapService.getFhirContactPointMapForPersonAttributeType(any()))
        .thenReturn(
            Optional.of(
                new FhirContactPointMap(
                    null, "person", null, null, ContactPoint.ContactPointUse.WORK, null)));
  ...
  public void toFhirResource_shouldTranslatePersonAttributeSystemToFhirContactPointSystem() {
    when(fhirContactPointMapService.getFhirContactPointMapForPersonAttributeType(any()))
        .thenReturn(
            Optional.of(
                new FhirContactPointMap(
                    null, "person", null, ContactPoint.ContactPointSystem.EMAIL, null, null)));
  ...
  public void toFhirResource_shouldTranslateProviderAttributeUseToFhirContactPointUse() {
    ...
    when(fhirContactPointMapService.getFhirContactPointMapForAttributeType(any()))
        .thenReturn(
            Optional.of(
                new FhirContactPointMap(
                    null, "provider", null, null, ContactPoint.ContactPointUse.WORK, null)));
  ...
  public void toFhirResource_shouldTranslateProviderAttributeSystemToFhirContactPointSystem() {
    ...
    when(fhirContactPointMapService.getFhirContactPointMapForAttributeType(any()))
        .thenReturn(
            Optional.of(
                new FhirContactPointMap(
                    null, "provider", null, ContactPoint.ContactPointSystem.EMAIL, null, null)));
  ...
  public void toFhirResource_shouldTranslateLocationAttributeUseToFhirContactPointUse() {
    ...
    when(fhirContactPointMapService.getFhirContactPointMapForAttributeType(any()))
        .thenReturn(
            Optional.of(
                new FhirContactPointMap(
                    null, "location", null, null, ContactPoint.ContactPointUse.WORK, null)));
  ...
  public void toFhirResource_shouldTranslateLocationAttributeSystemToFhirContactPointSystem() {
    ...
    when(fhirContactPointMapService.getFhirContactPointMapForAttributeType(any()))
        .thenReturn(
            Optional.of(
                new FhirContactPointMap(
                    null, "location", null, ContactPoint.ContactPointSystem.EMAIL, null, null)));
  ...
  public void toOpenmrsType_shouldTranslateFhirContactPointIdToPersonAttributeUuid() {
    ...
    PersonAttribute result =
        (PersonAttribute) telecomTranslator.toOpenmrsType(new PersonAttribute(), contactPoint);
  ...
  public void toOpenmrsType_shouldUpdatePersonAttributeUuid() {
    ...
    PersonAttribute result =
        (PersonAttribute) telecomTranslator.toOpenmrsType(personAttribute, contactPoint);
    assertThat(result, notNullValue());
  ...
  public void toOpenmrsType_shouldUpdatePersonAttributeWithTheCorrectPersonAttributeTypeUuid() {
    ...
    when(personService.getPersonAttributeTypeByUuid(PERSON_ATTRIBUTE_TYPE_UUID))
  ...
  public void toOpenmrsType_shouldTranslateIdToUuid() {
    ...
    contactPoint.setValue(CONTACT_POINT_VALUE);
    locationAttribute =
        (LocationAttribute) telecomTranslator.toOpenmrsType(new LocationAttribute(), contactPoint);
  ...
  public void toOpenmrsType_shouldUpdateLocationAttributeUuid() {
    ...
    LocationAttribute attribute =
        (LocationAttribute) telecomTranslator.toOpenmrsType(locationAttribute, contactPoint);
  ...
  public void toOpenmrsType_shouldNotUpdateLocationAttributeIfContactPointIsNull() {
    ...
    LocationAttribute attribute =
        (LocationAttribute) telecomTranslator.toOpenmrsType(locationAttribute, null);
    assertThat(attribute.getUuid(), notNullValue());
  ...
  public void toOpenmrsType_shouldAddCorrectLocationAttributeType() {
    ...
    when(globalPropertyService.getGlobalProperty(
            FhirConstants.LOCATION_CONTACT_POINT_ATTRIBUTE_TYPE))
        .thenReturn(LOCATION_ATTRIBUTE_TYPE_UUID);
    when(locationService.getLocationAttributeTypeByUuid(LOCATION_ATTRIBUTE_TYPE_UUID))
  ...
  public void toOpenmrsType_shouldTranslateWithCorrectLocationAttributeTypeForStreetName() {
    ...
    assertThat(
        locationAttribute.getAttributeType().getUuid(), equalTo(LOCATION_ATTRIBUTE_TYPE_UUID));
  }
  ...
  public void toOpenmrsType_shouldTranslateFhirContactPointIdToProviderAttributeUuid() {
    ...
    ProviderAttribute result =
        (ProviderAttribute) telecomTranslator.toOpenmrsType(new ProviderAttribute(), contactPoint);
    assertThat(result, notNullValue());
    assertThat(result.getUuid(), equalTo(CONTACT_POINT_ID));
  }
  ...
  public void toOpenmrsType_shouldUpdateProviderAttributeUuid() {
    ...
    ProviderAttribute result =
        (ProviderAttribute) telecomTranslator.toOpenmrsType(providerAttribute, contactPoint);
    assertThat(result, notNullValue());
    assertThat(result.getUuid(), notNullValue());
  ...
  public void toOpenmrsType_shouldUpdateProviderAttributeWithTheCorrectPersonAttributeTypeUuid() {
    ...
    when(providerService.getProviderAttributeTypeByUuid(PROVIDER_ATTRIBUTE_TYPE_UUID))
        .thenReturn(attributeType);
