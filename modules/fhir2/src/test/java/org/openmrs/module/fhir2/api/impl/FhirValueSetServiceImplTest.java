...
public class FhirValueSetServiceImplTest {
  ...
  @Mock private FhirConceptDao dao;

  @Mock private ValueSetTranslator translator;

  @Mock private SearchQueryInclude<ValueSet> searchQueryInclude;
  ...
  public void shouldSearchForValueSetsByName() {
    StringAndListParam titleParam =
        new StringAndListParam()
            .addAnd(new StringOrListParam().add(new StringParam(ROOT_CONCEPT_NAME)));
    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(FhirConstants.TITLE_SEARCH_HANDLER, titleParam);
  ...
  public void shouldReturnEmptyCollectionByWrongName() {
    StringAndListParam titleParam =
        new StringAndListParam().addAnd(new StringOrListParam().add(new StringParam("wrong name")));
    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(FhirConstants.TITLE_SEARCH_HANDLER, titleParam);
