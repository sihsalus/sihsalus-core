...
public class AllergyIntoleranceReactionComponentTranslatorImplTest {
  ...
  private static final String GLOBAL_PROPERTY_MODERATE_VALUE =
      "302553AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
  ...
  public void toFhirResource_shouldTranslateReactionToManifestation() {
    ...
    AllergyIntolerance.AllergyIntoleranceReactionComponent reactionComponent =
        reactionComponentTranslator.toFhirResource(omrsAllergy);
    ...
    assertThat(
        reactionComponent.getManifestation().get(0).getCoding().get(0).getCode(),
  ...
  public void toFhirResource_shouldTranslateAllergenToAllergySubstance() {
    ...
    assertThat(reactionComponent, notNullValue());
    assertThat(
        reactionComponent.getSubstance().getCodingFirstRep().getCode(), equalTo(CONCEPT_UUID));
    assertThat(
        reactionComponent.getSubstance().getCodingFirstRep().getDisplay(), equalTo(CODED_ALLERGEN));
  ...
  public void toFhirResource_shouldTranslateNonCodedAllergenToAllergySubstance() {
    ...
    codeableConcept.addCoding(
        new Coding().setCode(GLOBAL_PROPERTY_OTHER_VALUE).setDisplay(OTHER_CONCEPT_NAME));
    ...
    assertThat(reactionComponent, notNullValue());
    assertThat(
        reactionComponent.getSubstance().getCodingFirstRep().getCode(),
        equalTo(GLOBAL_PROPERTY_OTHER_VALUE));
    assertThat(
        reactionComponent.getSubstance().getCodingFirstRep().getDisplay(),
        equalTo(OTHER_CONCEPT_NAME));
  ...
  public void toOpenmrsType_shouldTranslateSeverityMildCorrectly() {
    ...
    when(severityTranslator.toOpenmrsType(AllergyIntolerance.AllergyIntoleranceSeverity.MILD))
        .thenReturn(mildConcept);
  ...
  @Test
  @Ignore(
      "HAPI FHIR 6.x: AllergyIntoleranceReactionComponent.hasSeverity() returns false for the NULL "
          + "severity enum, so the (correctly guarded) translator does not set severity. "
  ...
  public void toOpenmrsType_shouldTranslateSeverityOtherCorrectly() {
    ...
    when(severityTranslator.toOpenmrsType(AllergyIntolerance.AllergyIntoleranceSeverity.NULL))
        .thenReturn(otherConcept);
  ...
  public void toOpenmrsType_shouldTranslateManifestationToReaction() {
    ...
    CodeableConcept manifestation =
        new CodeableConcept()
            .addCoding(
                new Coding(
                    FhirConstants.CLINICAL_FINDINGS_SYSTEM_URI, CONCEPT_UUID, CODED_REACTION));
