...
public class AllergyIntoleranceSeverityTranslatorImplTest {
  ...
  public void setupMocks() {
    ...
    severityConceptUUIDs.put(
        FhirConstants.GLOBAL_PROPERTY_MODERATE, GLOBAL_PROPERTY_MODERATE_VALUE);
    ...
    when(globalPropertyService.getGlobalProperties(
        ...
        .thenReturn(severityConceptUUIDs);
  }
  ...
  public void shouldTranslateAllergyReactionToSEVEREAllergyIntoleranceSeverity() {
    ...
    AllergyIntolerance.AllergyIntoleranceSeverity severity =
        severityTranslator.toFhirResource(severeConcept);
  ...
  public void shouldTranslateAllergyReactionToMODERATEAllergyIntoleranceSeverity() {
    ...
    AllergyIntolerance.AllergyIntoleranceSeverity severity =
        severityTranslator.toFhirResource(moderateConcept);
    assertThat(severity, notNullValue());
  ...
  public void shouldTranslateAllergyReactionToMILDAllergyIntoleranceSeverity() {
    ...
    AllergyIntolerance.AllergyIntoleranceSeverity severity =
        severityTranslator.toFhirResource(mildConcept);
    assertThat(severity, notNullValue());
  ...
  public void shouldTranslateAllergyReactionToNullAllergyIntoleranceSeverity() {
    ...
    AllergyIntolerance.AllergyIntoleranceSeverity severity =
        severityTranslator.toFhirResource(otherConcept);
  ...
  public void shouldTranslateSEVEREToOpenMrsTypeCorrectly() {
    ...
    Concept concept =
        severityTranslator.toOpenmrsType(AllergyIntolerance.AllergyIntoleranceSeverity.SEVERE);
  ...
  public void shouldTranslateMODERATEToOpenMrsTypeCorrectly() {
    ...
    Concept concept =
        severityTranslator.toOpenmrsType(AllergyIntolerance.AllergyIntoleranceSeverity.MODERATE);
    assertThat(concept, notNullValue());
  ...
  public void shouldTranslateMILDToOpenMrsTypeCorrectly() {
    ...
    Concept concept =
        severityTranslator.toOpenmrsType(AllergyIntolerance.AllergyIntoleranceSeverity.MILD);
    assertThat(concept, notNullValue());
  ...
  public void shouldTranslateNULLToOpenMrsTypeCorrectly() {
    ...
    Concept concept =
        severityTranslator.toOpenmrsType(AllergyIntolerance.AllergyIntoleranceSeverity.NULL);
    assertThat(concept, notNullValue());
