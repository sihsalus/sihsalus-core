...
public class VisitTranslatorImplTest {
  ...
  @Mock private VisitTypeTranslatorImpl visitTypeTranslator;

  @Mock private VisitPeriodTranslatorImpl visitPeriodTranslator;
  ...
  public void setup() {
    ...
    periodStart =
        new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss", java.util.Locale.ENGLISH)
            .parse("10-Jan-2019 10:11:00");
    periodEnd =
        new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss", java.util.Locale.ENGLISH)
            .parse("10-Jan-2019 11:00:00");
  }
  ...
  public void toFhirResource_shouldTranslateToEncounterClassFhirType() {
    ...
    assertThat(
        result.getClass_().getSystem(),
        CoreMatchers.is(FhirConstants.ENCOUNTER_CLASS_VALUE_SET_URI));
