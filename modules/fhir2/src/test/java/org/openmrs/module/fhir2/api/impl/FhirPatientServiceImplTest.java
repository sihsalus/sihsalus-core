...
public class FhirPatientServiceImplTest {
  ...
  @Mock private PatientTranslator patientTranslator;

  @Mock private FhirPatientDao dao;

  @Mock private FhirPatientIdentifierSystemDao systemDao;

  @Mock private FhirGlobalPropertyService globalPropertyService;

  @Mock private SearchQueryInclude<org.hl7.fhir.r4.model.Patient> searchQueryInclude;
  ...
  private SearchQuery<
          ...
          FhirPatientDao,
          PatientTranslator,
          SearchQueryInclude<org.hl7.fhir.r4.model.Patient>>
      searchQuery;
  ...
  public void getByIds_shouldRetrievePatientsByIds() {
    ...
    List<org.hl7.fhir.r4.model.Patient> patientList =
        patientService.getPatientsByIds(new HashSet<>(Arrays.asList(1, 2, 3)));
  ...
  public void searchForPatients_shouldSearchForPatientsByName() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(FhirConstants.NAME_SEARCH_HANDLER, stringAndListParam);
    ...
    when(searchQuery.getQueryResults(any(), any(), any(), any()))
        .thenReturn(
            new SearchQueryBundleProvider<>(
                theParams, dao, patientTranslator, globalPropertyService, searchQueryInclude));
  ...
  public void searchForPatients_shouldReturnCollectionOfPatientsForPartialMatchOnFamilyName() {
    ...
    patients.add(patient);
    StringAndListParam stringAndListParam =
        new StringAndListParam().addAnd(new StringParam(PATIENT_PARTIAL_FAMILY_NAME));
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(FhirConstants.NAME_SEARCH_HANDLER, stringAndListParam);
  ...
  public void searchForPatients_shouldReturnEmptyCollectionWhenPatientNameNotMatched() {
    StringAndListParam stringAndListParam =
        new StringAndListParam().addAnd(new StringParam(PATIENT_GIVEN_NAME_NOT_MATCHED));
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(FhirConstants.NAME_SEARCH_HANDLER, stringAndListParam);
  ...
  public void searchForPatients_shouldReturnEmptyCollectionWhenPatientFamilyNameNotMatched() {
    StringAndListParam stringAndListParam =
        new StringAndListParam().addAnd(new StringParam(PATIENT_FAMILY_NAME_NOT_MATCHED));
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(FhirConstants.NAME_SEARCH_HANDLER, stringAndListParam);
  ...
  public void searchForPatients_shouldReturnCollectionOfPatientWhenPatientGenderMatched() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(FhirConstants.NAME_SEARCH_HANDLER, tokenAndListParam);
  ...
  public void searchForPatients_shouldReturnEmptyCollectionWhenPatientGenderNotMatched() {
    TokenAndListParam tokenAndListParam =
        new TokenAndListParam().addAnd(new TokenParam(WRONG_GENDER));
    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(FhirConstants.NAME_SEARCH_HANDLER, tokenAndListParam);
  ...
  @Test
  public void searchForPatients_shouldReturnCollectionOfPatientWhenPatientBirthDateMatched()
    ...
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(FhirConstants.DATE_RANGE_SEARCH_HANDLER, dateRangeParam);
  ...
  public void searchForPatients_shouldReturnEmptyCollectionWhenPatientBirthDateNotMatched() {
    DateRangeParam dateRangeParam =
        new DateRangeParam().setLowerBound(UNKNOWN_DATE).setUpperBound(UNKNOWN_DATE);
    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(FhirConstants.NAME_SEARCH_HANDLER, dateRangeParam);
  ...
  @Test
  public void searchForPatients_shouldReturnCollectionOfPatientWhenPatientDeathDateMatched()
      throws ParseException {
  ...
  public void searchForPatients_shouldReturnCollectionOfPatientWhenPatientCityMatched() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(FhirConstants.NAME_SEARCH_HANDLER, "city", stringAndListParam);
  ...
  public void searchForPatients_shouldReturnEmptyCollectionWhenPatientCityNotMatched() {
    StringAndListParam stringAndListParam =
        new StringAndListParam().addAnd(new StringParam(UNKNOWN_ADDRESS));
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(FhirConstants.NAME_SEARCH_HANDLER, "city", stringAndListParam);
  ...
  public void searchForPatients_shouldReturnCollectionOfPatientWhenPatientStateMatched() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(FhirConstants.NAME_SEARCH_HANDLER, "state", stringAndListParam);
  ...
  public void searchForPatients_shouldReturnCollectionOfPatientWhenPatientPostalCodeMatched() {
    ...
    patients.add(patient);
    StringAndListParam stringAndListParam =
        new StringAndListParam().addAnd(new StringParam(POSTAL_CODE));
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(FhirConstants.NAME_SEARCH_HANDLER, "postalCode", stringAndListParam);
  ...
  public void searchForPatients_shouldReturnCollectionOfPatientWhenPatientCountryMatched() {
    ...
    patients.add(patient);
    StringAndListParam stringAndListParam =
        new StringAndListParam().addAnd(new StringParam(COUNTRY));
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(FhirConstants.NAME_SEARCH_HANDLER, "country", stringAndListParam);
  ...
  public void searchForPatients_shouldReturnCollectionOfPatientWhenUUIDMatched() {
    ...
    IBundleProvider results =
        patientService.searchForPatients(
            new PatientSearchParams(
                null, null, null, null, null, null, null, null, null, null, null, null, uuid, null,
                null, null, null));
  ...
  public void searchForPatients_shouldReturnCollectionOfPatientWhenLastUpdatedMatched() {
    DateRangeParam lastUpdated =
        new DateRangeParam().setUpperBound(LAST_UPDATED_DATE).setLowerBound(LAST_UPDATED_DATE);
  ...
  public void searchForPatients_shouldReturnEmptyCollectionWhenLastUpdatedNotMatched() {
    DateRangeParam lastUpdated =
        new DateRangeParam()
            .setUpperBound(WRONG_LAST_UPDATED_DATE)
  ...
  public void searchForPatients_shouldAddReverseIncludedResourcesToResultList() {
    ...
    when(searchQueryInclude.getIncludedResources(any(), any()))
        .thenReturn(Collections.singleton(new Observation()));
    when(patientTranslator.toFhirResource(patient)).thenReturn(fhirPatient);
    when(patientTranslator.toFhirResources(anyCollection())).thenCallRealMethod();
  ...
  public void searchForPatients_shouldSearchForPatientsByOpenmrsQuery() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(FhirConstants.QUERY_SEARCH_HANDLER, stringAndListParam);
    ...
    IBundleProvider results =
        patientService.searchForPatients(
            OpenmrsPatientSearchParams.builder().query(stringAndListParam).build());
  ...
  public void getPatientEverything_shouldReturnAllInformationAboutSpecifiedPatient() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap()
            ...
            .addParameter(
                FhirConstants.COMMON_SEARCH_HANDLER, FhirConstants.ID_PROPERTY, patientId);

    HashSet<Include> revIncludes = new HashSet<>();

    revIncludes.add(
        new Include(FhirConstants.OBSERVATION + ":" + FhirConstants.INCLUDE_PATIENT_PARAM));
    revIncludes.add(
        new Include(FhirConstants.ALLERGY_INTOLERANCE + ":" + FhirConstants.INCLUDE_PATIENT_PARAM));
    revIncludes.add(
        new Include(FhirConstants.DIAGNOSTIC_REPORT + ":" + FhirConstants.INCLUDE_PATIENT_PARAM));
    revIncludes.add(
        new Include(FhirConstants.ENCOUNTER + ":" + FhirConstants.INCLUDE_PATIENT_PARAM));
    revIncludes.add(
        new Include(FhirConstants.MEDICATION_REQUEST + ":" + FhirConstants.INCLUDE_PATIENT_PARAM));
    revIncludes.add(
        new Include(FhirConstants.SERVICE_REQUEST + ":" + FhirConstants.INCLUDE_PATIENT_PARAM));
    revIncludes.add(
        new Include(FhirConstants.PROCEDURE_REQUEST + ":" + FhirConstants.INCLUDE_PATIENT_PARAM));
  ...
  public void getPatientEverything_shouldReturnAllInformationAboutAllPatients() {
    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(FhirConstants.EVERYTHING_SEARCH_HANDLER, "");
  ...
  @Test
  public void
      getPatientIdentifierTypeByIdentifier_shouldReturnIdentifierTypeWithSystemWhenSystemIsPresent() {
    ...
    PatientIdentifierType result =
        patientService.getPatientIdentifierTypeByIdentifier(identifierWithSystem);
  ...
  @Test
  public void
      getPatientIdentifierTypeByIdentifier_shouldReturnNullWhenSystemAndIdentifierTypeNotPresent() {
    Identifier identifier = new Identifier();
