...
public class LocationFhirResourceProviderIntegrationTest extends BaseFhirR4IntegrationTest<LocationFhirResourceProvider, Location> {
	...
	public void shouldSearchForExistingLocationsAsJson() throws Exception {
		...
		assertThat(entries, everyItem(hasProperty("fullUrl", startsWith("http://localhost/ws/fhir2/R4/Location/"))));
