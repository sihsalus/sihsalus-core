...
public class PersonAddressTranslatorImplTest {
  ...
  public void shouldSetUseToHomeIfPreferred() {
    ...
    assertThat(
        addressTranslator.toFhirResource(address).getUse(), equalTo(Address.AddressUse.HOME));
  }
