...
public class ObservationTranslatorImplTest {
  ...
  @Mock private ObservationStatusTranslator observationStatusTranslator;

  @Mock private ObservationReferenceTranslator observationReferenceTranslator;

  @Mock private ObservationValueTranslator observationValueTranslator;

  @Mock private ConceptTranslator conceptTranslator;

  @Mock private ObservationCategoryTranslator categoryTranslator;
  ...
  @Mock private ObservationInterpretationTranslator interpretationTranslator;

  @Mock private ObservationReferenceRangeTranslator referenceRangeTranslator;

  @Mock private ObservationBasedOnReferenceTranslator basedOnReferenceTranslator;

  @Mock private ObservationEffectiveDatetimeTranslator datetimeTranslator;
  ...
  public void toFhirResource_shouldConvertStatus() {
    Obs observation = new Obs();
    when(observationStatusTranslator.toFhirResource(observation))
        .thenReturn(Observation.ObservationStatus.UNKNOWN);
  ...
  public void toFhirResource_shouldAddReferenceRange() {
    ...
    Observation.ObservationReferenceRangeComponent referenceRangeComponent =
    ...
    List<Observation.ObservationReferenceRangeComponent> referenceRangeComponentList =
        new ArrayList<>();
    referenceRangeComponentList.add(referenceRangeComponent);

    when(referenceRangeTranslator.toFhirResource(observation))
        .thenReturn(referenceRangeComponentList);
    ...
    assertThat(
        ...
        hasItem(
            hasProperty(
                "low", hasProperty("value", equalTo(BigDecimal.valueOf(LOW_NORMAL_VALUE))))));
    assertThat(
        result.getReferenceRange(),
        hasItem(
            hasProperty(
                "high", hasProperty("value", equalTo(BigDecimal.valueOf(HIGH_NORMAL_VALUE))))));
  }
  ...
  public void toFhirResource_shouldConvertObsGroupToHasMemberReferences() {
    ...
    assertThat(
        result.getHasMember(), hasItem(hasProperty("type", equalTo(FhirConstants.OBSERVATION))));
  }
  ...
  public void toFhirResource_shouldConvertOrderToReference() {
    ...
    when(basedOnReferenceTranslator.toFhirResource(observation.getOrder()))
        .thenReturn(orderReference);
  ...
  public void toFhirResource_shouldAddLoationExtensionToObsWithTextValue() {
    ...
    Extension extension =
        result.getExtensionByUrl(FhirConstants.OPENMRS_FHIR_EXT_OBS_LOCATION_VALUE);
    ...
    assertThat(
        ...
        equalTo(FhirConstants.LOCATION + "/" + LOCATION_UUID));
  }
  ...
  public void toOpenmrsType_shouldTranslateHasMemberReferencesToGroupObs() {
    ...
    reference
        ...
        .setReference(FhirConstants.OBSERVATION + "/" + OBS_UUID);
