...
public class FhirUserServiceImplTest {
  ...
  @Mock private PractitionerTranslator<User> translator;
  ...
  public void shouldSearchForUsersByName() {
    ...
    when(dao.getSearchResults(any())).thenReturn(singletonList(user));
  ...
  public void shouldsearchForUsersByIdentifier() {
    TokenAndListParam identifier =
        new TokenAndListParam().addAnd(new TokenOrListParam().add(USER_SYSTEM_ID));
    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(IDENTIFIER_SEARCH_HANDLER, identifier);
  ...
  public void shouldReturnEmptyCollectionByWrongIdentifier() {
    TokenAndListParam identifier =
        new TokenAndListParam().addAnd(new TokenOrListParam().add(WRONG_USER_SYSTEM_ID));
    SearchParameterMap theParams =
  ...
  public void shouldsearchForUsersByAddressCity() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(ADDRESS_SEARCH_HANDLER, CITY_PROPERTY, city);
  ...
  public void shouldsearchForUsersByAddressState() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(ADDRESS_SEARCH_HANDLER, STATE_PROPERTY, state);
  ...
  public void shouldsearchForUsersByAddressPostalCode() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(ADDRESS_SEARCH_HANDLER, POSTAL_CODE_PROPERTY, postalCode);
  ...
  public void shouldSearchForUsersByAddressCountry() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(ADDRESS_SEARCH_HANDLER, COUNTRY_PROPERTY, country);
  ...
  public void shouldSearchForUsersByUUID() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(COMMON_SEARCH_HANDLER, ID_PROPERTY, uuid);
  ...
  public void shouldsearchForUsersByLastUpdated() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(COMMON_SEARCH_HANDLER, LAST_UPDATED_PROPERTY, lastUpdated);
