...
public class AllergyIntoleranceCriticalityTranslatorImplTest {
  ...
  public void shouldTranslateSEVERESeverityToHIGHCriticality() {
    assertThat(
        criticalityTranslator.toFhirResource(AllergyIntolerance.AllergyIntoleranceSeverity.SEVERE),
  ...
  public void shouldTranslateMILDSeverityToLOWCriticality() {
    assertThat(
        criticalityTranslator.toFhirResource(AllergyIntolerance.AllergyIntoleranceSeverity.MILD),
  ...
  public void shouldTranslateMODERATESeverityToUNABLETOACCESSCriticality() {
    assertThat(
        criticalityTranslator.toFhirResource(
            AllergyIntolerance.AllergyIntoleranceSeverity.MODERATE),
  ...
  public void shouldTranslateNULLSeverityToUNABLETOACCESSCriticality() {
    assertThat(
        criticalityTranslator.toFhirResource(AllergyIntolerance.AllergyIntoleranceSeverity.NULL),
        equalTo(AllergyIntolerance.AllergyIntoleranceCriticality.UNABLETOASSESS));
  }
}
