...
public class FhirServiceRequestServiceImplTest {
  ...
  private static final ServiceRequest.ServiceRequestStatus STATUS =
      ServiceRequest.ServiceRequestStatus.ACTIVE;

  private static final ServiceRequest.ServiceRequestPriority PRIORITY =
  ...
  @Mock private ServiceRequestTranslator<TestOrder> translator;

  @Mock private FhirServiceRequestDao<TestOrder> dao;

  @Mock private FhirGlobalPropertyService globalPropertyService;

  @Mock private SearchQueryInclude<ServiceRequest> searchQueryInclude;

  @Mock
  private SearchQuery<
          TestOrder,
          ServiceRequest,
          FhirServiceRequestDao<TestOrder>,
          ServiceRequestTranslator<TestOrder>,
          SearchQueryInclude<ServiceRequest>>
      searchQuery;
  ...
  public void setUp() {
    serviceRequestService =
        new FhirServiceRequestServiceImpl() {
  ...
  public void searchForServiceRequest_shouldReturnCollectionOfServiceRequestByPatientParam() {
        ...
        new ReferenceAndListParam()
            .addAnd(
                new ReferenceOrListParam()
                    .add(new ReferenceParam().setValue(PATIENT_GIVEN_NAME).setChain(SP_GIVEN)));
    ...
    IBundleProvider results =
        serviceRequestService.searchForServiceRequests(
            patientReference, null, null, null, null, null, null, null);
  ...
  public void searchForServiceRequest_shouldReturnCollectionOfServiceRequestByCode() {
    ...
    IBundleProvider results =
        serviceRequestService.searchForServiceRequests(
            null, code, null, null, null, null, null, null);
  ...
  public void searchForServiceRequest_shouldReturnCollectionOfServiceRequestByEncounter() {
    ReferenceAndListParam encounterReference =
        new ReferenceAndListParam()
            .addAnd(
                new ReferenceOrListParam()
                    .add(new ReferenceParam().setValue(ENCOUNTER_UUID).setChain(null)));
    ...
    IBundleProvider results =
        serviceRequestService.searchForServiceRequests(
            null, null, encounterReference, null, null, null, null, null);
  ...
  public void searchForServiceRequest_shouldReturnCollectionOfServiceRequestByRequester() {
    ...
    IBundleProvider results =
        serviceRequestService.searchForServiceRequests(
            null, null, null, participantReference, null, null, null, null);
  ...
  public void searchForServiceRequest_shouldReturnCollectionOfServiceRequestByOccurrence() {
    DateRangeParam occurrence =
        new DateRangeParam().setLowerBound(OCCURRENCE).setUpperBound(OCCURRENCE);
    ...
    IBundleProvider results =
        serviceRequestService.searchForServiceRequests(
            null, null, null, null, occurrence, null, null, null);
  ...
  public void searchForServiceRequest_shouldReturnCollectionOfServiceRequestByUUID() {
    ...
    IBundleProvider results =
        serviceRequestService.searchForServiceRequests(
            null, null, null, null, null, uuid, null, null);
  ...
  public void searchForServiceRequest_shouldReturnCollectionOfServiceRequestByLastUpdated() {
    ...
    IBundleProvider results =
        serviceRequestService.searchForServiceRequests(
            null, null, null, null, null, null, lastUpdated, null);
  ...
  public void searchForPeople_shouldAddRelatedResourcesWhenIncluded() {
    ...
    IBundleProvider results =
        serviceRequestService.searchForServiceRequests(
            null, null, null, null, null, null, null, includes);
