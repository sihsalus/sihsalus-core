...
public class ConditionClinicalStatusTranslatorImplTest {
  ...
  public void shouldMapOpenMrsActiveToFHIRActive() {
    CodeableConcept codeableConcept =
        clinicalStatusTranslator.toFhirResource(ConditionClinicalStatus.ACTIVE);
  ...
  public void shouldMapOpenMrsInActiveToFHIRInActive() {
    CodeableConcept codeableConcept =
        clinicalStatusTranslator.toFhirResource(ConditionClinicalStatus.INACTIVE);
    assertThat(codeableConcept, notNullValue());
  ...
  public void shouldMapOpenMrsHistoryOfToFHIRInActive() {
    CodeableConcept codeableConcept =
        clinicalStatusTranslator.toFhirResource(ConditionClinicalStatus.HISTORY_OF);
    assertThat(codeableConcept, notNullValue());
    assertThat(codeableConcept.getCodingFirstRep().getCode(), equalTo(INACTIVE));
    assertThat(
        codeableConcept.getCodingFirstRep().getSystem(),
  ...
  public void shouldMapFHIRActiveToOpenMrsActiveClinicalCondition() {
    ...
    assertThat(
        clinicalStatusTranslator.toOpenmrsType(codeableConcept),
        is(ConditionClinicalStatus.ACTIVE));
  }
  ...
  public void shouldMapFHIRInActiveToOpenMrsInActive() {
    ...
    assertThat(
        clinicalStatusTranslator.toOpenmrsType(codeableConcept),
        is(ConditionClinicalStatus.INACTIVE));
  }
}
