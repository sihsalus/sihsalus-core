...
public class FhirRelatedPersonServiceImplTest {
  ...
  private static final Integer RELATED_PERSON_ID = 123;
  ...
  @Mock private FhirRelatedPersonDao dao;

  @Mock private RelatedPersonTranslator translator;

  @Mock private FhirGlobalPropertyService globalPropertyService;

  @Mock private SearchQueryInclude<RelatedPerson> searchQueryInclude;
  ...
  public void setup() {
    relatedPersonService =
        new FhirRelatedPersonServiceImpl() {
  ...
  public void shouldThrowResourceNotFoundWhenGetByWrongUuid() {
    assertThrows(
        ResourceNotFoundException.class, () -> relatedPersonService.get(WRONG_RELATED_PERSON_UUID));
  }
  ...
  public void searchForRelatedPeople_shouldReturnCollectionOfRelatedPersonForNameMatched() {
    StringAndListParam stringAndListParam =
        new StringAndListParam().addAnd(new StringOrListParam().add(new StringParam(GIVEN_NAME)));
    ...
    IBundleProvider results =
        relatedPersonService.searchForRelatedPeople(
            new RelatedPersonSearchParams(
                stringAndListParam, null, null, null, null, null, null, null, null, null, null));
  ...
  @Test
  public void
      searchForRelatedPeople_shouldReturnCollectionOfRelatedPersonWhenPersonGenderMatched() {
    TokenAndListParam tokenAndListParam =
        new TokenAndListParam().addAnd(new TokenOrListParam().add(GENDER));

    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(FhirConstants.GENDER_SEARCH_HANDLER, tokenAndListParam);
    ...
    IBundleProvider results =
        relatedPersonService.searchForRelatedPeople(
            new RelatedPersonSearchParams(
                null, tokenAndListParam, null, null, null, null, null, null, null, null, null));
  ...
  @Test
  public void
      searchForRelatedPeople_shouldReturnEmptyCollectionWhenRelatedPersonGenderNotMatched() {
    TokenAndListParam tokenAndListParam =
        new TokenAndListParam().addAnd(new TokenOrListParam().add(WRONG_GENDER));
  ...
  @Test
  public void
      searchForRelatedPeople_shouldReturnCollectionOfRelatedPersonWhenPersonBirthDateMatched()
          throws ParseException {
    Date birthDate = dateFormatter.parse(PERSON_BIRTH_DATE);
    person.setBirthdate(birthDate);

    DateRangeParam dateRangeParam =
        new DateRangeParam().setLowerBound(PERSON_BIRTH_DATE).setUpperBound(PERSON_BIRTH_DATE);
    ...
    IBundleProvider results =
        relatedPersonService.searchForRelatedPeople(
            new RelatedPersonSearchParams(
                null, null, dateRangeParam, null, null, null, null, null, null, null, null));
  ...
  @Test
  public void
      searchForRelatedPeople_shouldReturnEmptyCollectionWhenRelatedPersonBirthDateNotMatched() {
    DateRangeParam dateRangeParam =
        new DateRangeParam()
            .setLowerBound(NOT_FOUND_PERSON_BIRTH_DATE)
  ...
  public void searchForRelatedPeople_shouldReturnCollectionOfRelatedPersonWhenPersonCityMatched() {
    StringAndListParam stringAndListParam =
        new StringAndListParam().addAnd(new StringOrListParam().add(new StringParam(CITY)));

    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(
                FhirConstants.ADDRESS_SEARCH_HANDLER,
                FhirConstants.CITY_PROPERTY,
                stringAndListParam);
  ...
  public void searchForRelatedPeople_shouldReturnCollectionOfRelatedPersonWhenPersonStateMatched() {
    StringAndListParam stringAndListParam =
        new StringAndListParam().addAnd(new StringOrListParam().add(new StringParam(STATE)));

    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(
                FhirConstants.ADDRESS_SEARCH_HANDLER,
                FhirConstants.STATE_PROPERTY,
                stringAndListParam);
  ...
  @Test
  public void
      searchForRelatedPeople_shouldReturnCollectionOfRelatedPersonWhenPersonPostalCodeMatched() {
    StringAndListParam stringAndListParam =
        new StringAndListParam().addAnd(new StringOrListParam().add(new StringParam(POSTAL_CODE)));
  ...
  @Test
  public void
      searchForRelatedPeople_shouldReturnEmptyCollectionWhenRelatedPersonPostalCodeNotMatched() {
    StringAndListParam stringAndListParam =
        new StringAndListParam()
            .addAnd(new StringOrListParam().add(new StringParam(NOT_ADDRESS_FIELD)));
  ...
  public void searchForRelatedPeople_shouldReturnCollectionOfPersonWhenPersonCountryMatched() {
    StringAndListParam stringAndListParam =
        new StringAndListParam().addAnd(new StringOrListParam().add(new StringParam(COUNTRY)));

    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(
                FhirConstants.ADDRESS_SEARCH_HANDLER,
                FhirConstants.COUNTRY_PROPERTY,
                stringAndListParam);
  ...
  public void searchForPeople_shouldAddRelatedResourcesWhenIncluded() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(FhirConstants.INCLUDE_SEARCH_HANDLER, includes);
    ...
    when(searchQueryInclude.getIncludedResources(any(), any()))
        .thenReturn(Collections.singleton(new Patient()));

    IBundleProvider results =
        relatedPersonService.searchForRelatedPeople(
            new RelatedPersonSearchParams(
                null, null, null, null, null, null, null, null, null, null, includes));
