...
public class FhirTaskServiceImplTest {
  ...
  private static final org.hl7.fhir.r4.model.Task.TaskStatus FHIR_TASK_STATUS =
      org.hl7.fhir.r4.model.Task.TaskStatus.REQUESTED;

  private static final org.hl7.fhir.r4.model.Task.TaskStatus FHIR_NEW_TASK_STATUS =
      org.hl7.fhir.r4.model.Task.TaskStatus.ACCEPTED;
  ...
  private static final org.hl7.fhir.r4.model.Task.TaskIntent FHIR_TASK_INTENT =
      org.hl7.fhir.r4.model.Task.TaskIntent.ORDER;
  ...
  @Mock private FhirTaskDao dao;

  @Mock private TaskTranslator translator;

  @Mock private FhirGlobalPropertyService fhirGlobalPropertyService;

  @Mock private SearchQueryInclude<Task> searchQueryInclude;
  ...
  public void searchForTasks_shouldReturnTasksByParameters() {
    ...
    when(searchQuery.getQueryResults(any(), any(), any(), any()))
        .thenReturn(
            new SearchQueryBundleProvider<>(
                theParams, dao, translator, fhirGlobalPropertyService, searchQueryInclude));
    ...
    IBundleProvider results =
        fhirTaskService.searchForTasks(
            new TaskSearchParams(null, null, null, null, null, null, null, null, null));
