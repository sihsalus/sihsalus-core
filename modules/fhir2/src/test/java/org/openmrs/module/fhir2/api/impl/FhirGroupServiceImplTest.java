...
public class FhirGroupServiceImplTest {
  ...
  @Mock private FhirGroupDao dao;

  @Mock private GroupTranslator translator;

  @Mock private FhirGlobalPropertyService globalPropertyService;

  @Mock private SearchQueryInclude<Group> searchQueryInclude;
  ...
  private SearchQuery<
          ...
          FhirGroupDao,
          GroupTranslator,
          SearchQueryInclude<org.hl7.fhir.r4.model.Group>>
      searchQuery;
  ...
  public void searchForGroups_shouldReturnCollectionOfGroupByParticipant() {
    ...
    participant.addValue(
        new ReferenceOrListParam()
            .add(new ReferenceParam().setValue(COHORT_UUID).setChain(Practitioner.SP_RES_ID)));
