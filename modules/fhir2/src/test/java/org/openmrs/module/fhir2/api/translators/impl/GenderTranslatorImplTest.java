...
public class GenderTranslatorImplTest {
  ...
  public void shouldConvertUnknownValueToNullGender() {
    assertThat(
        genderTranslator.toFhirResource("DUMMY VALUE"), is(Enumerations.AdministrativeGender.NULL));
  }

  @Test
  public void shouldConvertMaleToM() {
    assertThat(
        genderTranslator.toOpenmrsType(Enumerations.AdministrativeGender.MALE), equalTo("M"));
  }

  @Test
  public void shouldConvertFemaleToF() {
    assertThat(
        genderTranslator.toOpenmrsType(Enumerations.AdministrativeGender.FEMALE), equalTo("F"));
  }

  @Test
  public void shouldConvertUnknownToU() {
    assertThat(
        genderTranslator.toOpenmrsType(Enumerations.AdministrativeGender.UNKNOWN), equalTo("U"));
  }

  @Test
  public void shouldConvertOtherToO() {
    assertThat(
        genderTranslator.toOpenmrsType(Enumerations.AdministrativeGender.OTHER), equalTo("O"));
  }
