...
public class ObservationValueTranslatorImplTest {
  ...
  @Mock private ObservationQuantityCodingTranslatorImpl quantityCodingTranslator;

  @Mock ConceptService conceptService;

  @Mock FhirConceptSourceService fhirConceptSourceService;
  ...
  public void setup() {
    ...
    obsValueTranslator =
        new ObservationValueTranslatorImpl() {
