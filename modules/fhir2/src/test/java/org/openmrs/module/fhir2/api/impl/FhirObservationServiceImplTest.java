...
public class FhirObservationServiceImplTest {
  ...
  @Mock private FhirObservationDao dao;

  @Mock private FhirGlobalPropertyService globalPropertyService;

  @Mock private SearchQueryInclude<Observation> searchQueryInclude;
  ...
  private SearchQuery<
          ...
          SearchQueryInclude<Observation>>
      searchQuery;

  @Mock private ObservationTranslator translator;
  ...
  public void setup() {
    fhirObservationService =
        new FhirObservationServiceImpl() {
  ...
  public void getLastnObservations_shouldReturnRecentNObservations() {
    ...
    TokenAndListParam categories =
        new TokenAndListParam().addAnd(new TokenParam().setValue("laboratory"));

    TokenAndListParam code =
        new TokenAndListParam()
            .addAnd(
                new TokenParam()
                    .setSystem(FhirTestConstants.LOINC_SYSTEM_URL)
                    .setValue(LOINC_SYSTOLIC_BP),
                new TokenParam()
                    .setSystem(FhirTestConstants.CIEL_SYSTEM_URN)
                    .setValue(CIEL_DIASTOLIC_BP));
  ...
  @Test
  public void
      getLastnObservations_shouldReturnRecentNObservationsForAllPatientsWhenNoPatientIsSpecified() {
    Obs obs = new Obs();
    obs.setUuid(OBS_UUID);
  ...
  public void getLastnEncountersObservations_shouldReturnRecentNEncountersObservations() {
    ...
    IBundleProvider results =
        fhirObservationService.getLastnEncountersObservations(max, searchParams);
  ...
  @Test
  public void
      getLastnEncountersObservations_shouldReturnFirstRecentEncountersObservationsWhenMaxIsMissing() {
    Obs obs = new Obs();
    obs.setUuid(OBS_UUID);
    ...
    searchParams.setCode(code);
    IBundleProvider results =
        fhirObservationService.getLastnEncountersObservations(null, searchParams);
  ...
  @Test
  public void
      getLastnEncountersObservations_shouldReturnRecentNEncountersObservationsForAllPatientsWhenNoPatientIsSpecified() {
    Obs obs = new Obs();
    obs.setUuid(OBS_UUID);
