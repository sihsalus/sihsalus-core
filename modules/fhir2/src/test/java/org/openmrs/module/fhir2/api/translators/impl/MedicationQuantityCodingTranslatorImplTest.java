...
public class MedicationQuantityCodingTranslatorImplTest {
  ...
  public void toFhirResource_shouldTranslateMedicationQuantityDefaultingToUuid() {
    ...
    notSameAs.setUuid(
        "5d4b9c92-ed26-45ca-8f6e-08c48b00648d"); // this is just a random uuid, so should *not* be a
    // match for SAME_AS_MAP_TYPE_UUID
    ...
    mg.addConceptMapping(
        new ConceptMap(
            new ConceptReferenceTerm(snomed, "snomed-ct-mg-code-not-same-as", "snomed"),
            notSameAs));
