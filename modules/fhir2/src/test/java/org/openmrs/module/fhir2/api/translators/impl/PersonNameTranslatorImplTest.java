...
public class PersonNameTranslatorImplTest {
  ...
  public void shouldOnlyCreateOneExtensionForExtensibleAttributes() {
    ...
    // note that this throws an IllegalArgumentException if more than extension with the same URL
    // occurs
    Extension extension =
        personNameTranslator
            .toFhirResource(name)
  ...
  public void shouldConvertOtherGivenNamesToMiddleName() {
    ...
    assertThat(
        personNameTranslator.toOpenmrsType(name).getMiddleName(),
  ...
  public void shouldConvertFhirFamilyNameToFamilyName() {
    ...
    assertThat(
        personNameTranslator.toOpenmrsType(name).getFamilyName(), equalTo(PERSON_FAMILY_NAME));
  }
  ...
  public void shouldConvertExtensionToPrefix() {
    ...
    nameExtension.addExtension(
        FhirConstants.OPENMRS_FHIR_EXT_NAME + "#prefix", new StringType(PERSON_MIDDLE_NAME));
  ...
  public void shouldConvertExtensionToFamilyNamePrefix() {
    ...
    nameExtension.setUrl(FhirConstants.OPENMRS_FHIR_EXT_NAME);
    nameExtension.addExtension(
        FhirConstants.OPENMRS_FHIR_EXT_NAME + "#familyNamePrefix",
        new StringType(PERSON_MIDDLE_NAME));

    assertThat(
        personNameTranslator.toOpenmrsType(name).getFamilyNamePrefix(),
        equalTo(PERSON_MIDDLE_NAME));
  }
  ...
  public void shouldConvertExtensionToFamilyName2() {
    ...
    nameExtension.setUrl(FhirConstants.OPENMRS_FHIR_EXT_NAME);
    nameExtension.addExtension(
        FhirConstants.OPENMRS_FHIR_EXT_NAME + "#familyName2", new StringType(PERSON_MIDDLE_NAME));

    assertThat(
        personNameTranslator.toOpenmrsType(name).getFamilyName2(), equalTo(PERSON_MIDDLE_NAME));
  }
  ...
  public void shouldConvertExtensionToFamilyNameSuffix() {
    ...
    nameExtension.setUrl(FhirConstants.OPENMRS_FHIR_EXT_NAME);
    nameExtension.addExtension(
        FhirConstants.OPENMRS_FHIR_EXT_NAME + "#familyNameSuffix",
        new StringType(PERSON_MIDDLE_NAME));

    assertThat(
        personNameTranslator.toOpenmrsType(name).getFamilyNameSuffix(),
        equalTo(PERSON_MIDDLE_NAME));
  }
  ...
  public void shouldConvertExtensionToDegree() {
    ...
    nameExtension.setUrl(FhirConstants.OPENMRS_FHIR_EXT_NAME);
    nameExtension.addExtension(
        FhirConstants.OPENMRS_FHIR_EXT_NAME + "#degree", new StringType(PERSON_MIDDLE_NAME));
