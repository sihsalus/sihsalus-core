...
public class FhirMedicationRequestServiceImplTest {
  ...
  @Mock private MedicationRequestTranslator medicationRequestTranslator;

  @Mock private FhirMedicationRequestDao dao;

  @Mock private FhirGlobalPropertyService globalPropertyService;

  @Mock private SearchQueryInclude<MedicationRequest> searchQueryInclude;
  ...
  public void setup() {
    medicationRequestService =
        new FhirMedicationRequestServiceImpl() {
  ...
  public void shouldThrowResourceNotFoundForBadMedicationRequestUuid() {
    assertThrows(
        ...
        () -> medicationRequestService.get(BAD_MEDICATION_REQUEST_UUID));
  }
  ...
  public void searchForMedicationRequest_shouldReturnCollectionOfMedicationRequestByParticipant() {
    ...
    IBundleProvider results =
        medicationRequestService.searchForMedicationRequests(
            new MedicationRequestSearchParams(
                null, null, null, participant, null, null, null, null, null, null, null));
  ...
  public void searchForEncounter_shouldReturnCollectionOfMedicationRequestBySubject() {
    ...
    subject.addValue(
        new ReferenceOrListParam()
            .add(new ReferenceParam().setValue("john").setChain(Patient.SP_FAMILY)));
  ...
  public void searchForEncounter_shouldReturnCollectionOfMedicationRequestByMedicationReference() {
    ...
    IBundleProvider results =
        medicationRequestService.searchForMedicationRequests(
            new MedicationRequestSearchParams(
                null, null, null, null, medication, null, null, null, null, null, null));
  ...
  @Test
  public void
      searchForMedicationRequest_shouldReturnCollectionOfMedicationRequestByMedicationCode() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(FhirConstants.CODED_SEARCH_HANDLER, code);
  ...
  public void searchForMedicationRequest_shouldReturnCollectionOfMedicationRequestByEncounter() {
    ...
    encounter.addValue(
        new ReferenceOrListParam()
            .add(
                new ReferenceParam()
                    .setValue("jdjdj-kdkdkkd-kddd")
                    .setChain(Encounter.SP_IDENTIFIER)));
    ...
    IBundleProvider results =
        medicationRequestService.searchForMedicationRequests(
            new MedicationRequestSearchParams(
                null, encounter, null, null, null, null, null, null, null, null, null));
  ...
  public void searchForMedicationRequest_shouldReturnCollectionOfMedicationRequestByUUID() {
    TokenAndListParam uuid =
        new TokenAndListParam().addAnd(new TokenParam(MEDICATION_REQUEST_UUID));
    ...
    IBundleProvider results =
        medicationRequestService.searchForMedicationRequests(
            new MedicationRequestSearchParams(
                null, null, null, null, null, uuid, null, null, null, null, null));
  ...
  public void searchForMedicationRequest_shouldReturnCollectionOfMedicationRequestsByStatus() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(FhirConstants.COMMON_SEARCH_HANDLER, MedicationRequest.SP_STATUS);
    ...
    IBundleProvider results =
        medicationRequestService.searchForMedicationRequests(
            new MedicationRequestSearchParams(
                null, null, null, null, null, null, status, null, null, null, null));
  ...
  public void searchForMedicationRequests_shouldAddRelatedResourcesWhenIncluded() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap()
            .addParameter(
                FhirConstants.COMMON_SEARCH_HANDLER, FhirConstants.LAST_UPDATED_PROPERTY, uuid)
    ...
    when(searchQueryInclude.getIncludedResources(any(), any()))
        .thenReturn(Collections.singleton(new Practitioner()));

    IBundleProvider results =
        medicationRequestService.searchForMedicationRequests(
            new MedicationRequestSearchParams(
                null, null, null, null, null, uuid, null, null, null, includes, null));
  ...
  public void searchForMedicationRequests_shouldAddRelatedResourcesWhenRevIncluded() {
    ...
    IBundleProvider results =
        medicationRequestService.searchForMedicationRequests(
            new MedicationRequestSearchParams(
                null, null, null, null, null, uuid, null, null, null, null, revIncludes));
