...
public class PatientIdentifierTranslatorImplTest {
  ...
  @Mock private FhirPatientIdentifierSystemServiceImpl patientIdentifierSystemService;

  @Mock private FhirPatientService patientService;
  ...
  public void shouldConvertPatientIdentifierToIdentifier() {
    ...
    when(patientIdentifierSystemService.getUrlByPatientIdentifierType(identifierType))
        .thenReturn(IDENTIFIER_URL);
  ...
  public void shouldSetUseToOfficialIfIdentifierIsPreferred() {
    ...
    assertThat(
        identifierTranslator.toFhirResource(patientIdentifier).getUse(),
        is(Identifier.IdentifierUse.OFFICIAL));
  }
  ...
  public void shouldSetUseToUsualIfIdentifierIsNotPreferred() {
    ...
    assertThat(
        identifierTranslator.toFhirResource(patientIdentifier).getUse(),
        is(Identifier.IdentifierUse.USUAL));
  }
  ...
  public void shouldConvertIdentifierToPatientIdentifier() {
    ...
    when(patientService.getPatientIdentifierTypeByIdentifier(argThat(equalTo(identifier))))
