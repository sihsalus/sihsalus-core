...
public class FhirConceptServiceImplTest {
  ...
  @Mock private FhirConceptDao conceptDao;
  ...
  public void getConceptWithSameAsMappingInSource_shouldGetConceptBySourceNameAndCode() {
    ...
    Concept concept = new Concept();
    concept.setUuid(CONCEPT_UUID);
    when(conceptDao.getConceptWithSameAsMappingInSource(loinc, "1000-1"))
        .thenReturn(Optional.of(concept));

    Optional<Concept> result =
        fhirConceptService.getConceptWithSameAsMappingInSource(loinc, "1000-1");
  ...
  public void getConceptWithSameAsMappingInSource_shouldReturnNullIfSourceIsNull() {
    Optional<Concept> result =
        fhirConceptService.getConceptWithSameAsMappingInSource(null, "1000-1");
  ...
  public void getConceptsWithAnyMappingInSource_shouldGetListOfConceptsBySourceNameAndCode() {
    ...
    when(conceptDao.getConceptsWithAnyMappingInSource(loinc, "1000-1"))
