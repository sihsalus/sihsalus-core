...
public class ObservationReferenceRangeTranslatorImplTest {
  ...
  public void toFhirType_shouldMapHighAndLowNormalObservationReferenceRangeToExpected() {
    ...
    List<Observation.ObservationReferenceRangeComponent> result =
        observationReferenceRangeTranslator.toFhirResource(getObs(conceptNumeric));
    ...
    assertThat(
        component.getType().getCodingFirstRep().getSystem(),
        equalTo(FhirConstants.OBSERVATION_REFERENCE_RANGE_SYSTEM_URI));
    assertThat(
        component.getType().getCodingFirstRep().getCode(),
        equalTo(FhirConstants.OBSERVATION_REFERENCE_NORMAL));
  ...
  public void toFhirType_shouldMapHighAndLowAbsoluteObservationReferenceRangeToExpected() {
    ...
    assertThat(
        component.getType().getCodingFirstRep().getCode(),
        equalTo(FhirConstants.OBSERVATION_REFERENCE_ABSOLUTE));
    assertThat(component.hasLow(), is(true));
  ...
  public void toFhirType_shouldMapHighAndLowAbsoluteToExpectedIfLowIsNull() {
    ...
    assertThat(
        result, hasItem(hasProperty("high", hasProperty("value", equalTo(HIGH_ABSOLUTE_VALUE)))));
  }
  ...
  public void toFhirType_shouldMapHighAndLowAbsoluteToExpectedIfHighIsNull() {
    ...
    assertThat(
        result, hasItem(hasProperty("low", hasProperty("value", equalTo(LOW_ABSOLUTE_VALUE)))));
  }
  ...
  public void toFhirType_shouldMapHighAndLowNormalToExpectedIfLowIsNull() {
    ...
    assertThat(result.get(0).hasLow(), equalTo(false));
    assertThat(
        result, hasItem(hasProperty("high", hasProperty("value", equalTo(HIGH_NORMAL_VALUE)))));
  }
  ...
  public void toFhirType_shouldMapHighAndLowNormalToExpectedIfHighIsNull() {
    ...
    assertThat(result.get(0).hasHigh(), equalTo(false));
    assertThat(
        result, hasItem(hasProperty("low", hasProperty("value", equalTo(LOW_NORMAL_VALUE)))));
  }
  ...
  public void toFhirType_shouldMapHighAndLowCriticalToExpectedIfLowIsNull() {
    ...
    assertThat(result.get(0).hasLow(), equalTo(false));
    assertThat(
        result, hasItem(hasProperty("high", hasProperty("value", equalTo(HIGH_CRITICAL_VALUE)))));
  }
  ...
  public void toFhirType_shouldMapHighAndLowCriticalToExpectedIHighIsNull() {
    ...
    assertThat(result.get(0).hasHigh(), equalTo(false));
    assertThat(
        result, hasItem(hasProperty("low", hasProperty("value", equalTo(LOW_CRITICAL_VALUE)))));
  }
  ...
  public void toFhirType_shouldUseObsReferenceRangeNormalValues() {
    ...
    List<Observation.ObservationReferenceRangeComponent> result =
        observationReferenceRangeTranslator.toFhirResource(obs);
