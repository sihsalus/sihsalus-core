...
public class FhirMedicationServiceImplTest {
  ...
  @Mock private MedicationTranslator medicationTranslator;

  @Mock private FhirMedicationDao medicationDao;

  @Mock private FhirGlobalPropertyService globalPropertyService;

  @Mock private SearchQueryInclude<Medication> searchQueryInclude;
  ...
  public void getMedicationByUuid_shouldThrowResourceNotFoundWhenCalledWithUnknownUuid() {
    assertThrows(
        ResourceNotFoundException.class, () -> fhirMedicationService.get(WRONG_MEDICATION_UUID));
  }
  ...
  public void searchForMedications_shouldSearchMedicationsByCode() {
    ...
    IBundleProvider result =
        fhirMedicationService.searchForMedications(
            new MedicationSearchParams(code, null, null, null, null, null));
  ...
  public void searchForMedications_shouldSearchMedicationsByDosageForm() {
    ...
    SearchParameterMap theParams =
        new SearchParameterMap().addParameter(FhirConstants.DOSAGE_FORM_SEARCH_HANDLER, dosageForm);
    ...
    IBundleProvider result =
        fhirMedicationService.searchForMedications(
            new MedicationSearchParams(null, dosageForm, null, null, null, null));
  ...
  public void searchForMedications_shouldSearchMedicationsByIngredientCode() {
    ...
    IBundleProvider result =
        fhirMedicationService.searchForMedications(
            new MedicationSearchParams(null, null, ingredientCode, null, null, null));
  ...
  public void searchForMedications_shouldSearchMedicationsByUUID() {
    ...
    IBundleProvider result =
        fhirMedicationService.searchForMedications(
            new MedicationSearchParams(null, null, null, uuid, null, null));
  ...
  public void searchForMedications_shouldSearchMedicationsByLastUpdated() {
    ...
    IBundleProvider result =
        fhirMedicationService.searchForMedications(
            new MedicationSearchParams(null, null, null, null, lastUpdated, null));
  ...
  @Test
  public void searchForMedications_shouldAddReverseIncludedResourcesToResultList() {
    ...
    IBundleProvider results =
        fhirMedicationService.searchForMedications(
            new MedicationSearchParams(null, null, null, null, null, revIncludes));
