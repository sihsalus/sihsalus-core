...
public class ObservationComponentTranslatorImplTest {
  ...
  public void toFhirResource_shouldConvertObsToObservationComponent() {
    ...
    Observation.ObservationComponentComponent result =
        observationComponentTranslator.toFhirResource(obs);
  ...
  public void toFhirResource_shouldReturnNullIfObsNull() {
    Observation.ObservationComponentComponent result =
        observationComponentTranslator.toFhirResource(null);
  ...
  public void toOpenmrsType_shouldSetObsValue() {
    ...
    when(observationValueTranslator.toOpenmrsType(any(Obs.class), same(value)))
        .thenAnswer(
            (i) -> {
              ((Obs) i.getArguments()[0])
                  .setValueNumeric(((Quantity) i.getArguments()[1]).getValue().doubleValue());
