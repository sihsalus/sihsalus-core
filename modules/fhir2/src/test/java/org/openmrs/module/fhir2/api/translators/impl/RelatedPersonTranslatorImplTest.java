...
public class RelatedPersonTranslatorImplTest {
  ...
  public void shouldTranslateOpenMrsRelationshipToFhirRelatedPerson() {
    org.hl7.fhir.r4.model.RelatedPerson result =
        relatedPersonTranslator.toFhirResource(relationship);
  ...
  public void shouldAddRelationshipIdentifier() {
    ...
    assertThat(
        result.getIdentifierFirstRep().getValue(),
        equalTo(FhirConstants.PERSON + "/" + PERSON_A_UUID));
