...
public class ConditionTranslatorImplTest {
  ...
  private static final String PRACTITIONER_REFERENCE =
  ...
  @Mock private ConditionClinicalStatusTranslator<ConditionClinicalStatus> clinicalStatusTranslator;

  @Mock
  private ConditionVerificationStatusTranslator<ConditionVerificationStatus>
      verificationStatusTranslator;

  @Mock private ConceptTranslator conceptTranslator;

  @Mock private PractitionerReferenceTranslator<User> creatorReferenceTranslator;
  ...
  public void shouldTranslateConditionClinicalStatusToOpenMrsType() {
    ...
    codeableConcept.addCoding(
        new Coding().setCode(ACTIVE).setSystem(FhirConstants.OPENMRS_FHIR_PREFIX));
    fhirCondition.setClinicalStatus(codeableConcept);
    when(clinicalStatusTranslator.toOpenmrsType(codeableConcept))
  ...
  public void shouldTranslateConditionClinicalStatusToFhirType() {
    ...
    when(clinicalStatusTranslator.toFhirResource(ConditionClinicalStatus.ACTIVE))
  ...
  public void shouldTranslateConditionVerificationStatusToFhirType() {
    CodeableConcept codeableConcept = new CodeableConcept();
    codeableConcept.addCoding(
        new Coding().setCode(CONFIRMED).setSystem(FhirConstants.OPENMRS_FHIR_PREFIX));
  ...
  public void shouldTranslateConditionVerificationStatusToOpenMrsType() {
    CodeableConcept codeableConcept = new CodeableConcept();
    codeableConcept.addCoding(
        new Coding().setCode(PROVISIONAL).setSystem(FhirConstants.OPENMRS_FHIR_PREFIX));
  ...
  public void shouldTranslateOpenMrsConditionOnsetDateToFhirType() {
    ...
    org.hl7.fhir.r4.model.Condition condition =
        conditionTranslator.toFhirResource(openmrsCondition);
  ...
  public void shouldTranslateOpenMrsConditionAdditionalDetailToFhirType() {
    ...
    assertThat(
        fhirCondition.getNote().get(0).getText(), is("Patient experiencing mild headaches."));
  }
  ...
  public void shouldTranslateConditionNonCodedToOpenMrsType() {
    ...
    fhirCondition.setCode(codeableConcept);
    fhirCondition.addExtension(
        FhirConstants.OPENMRS_FHIR_EXT_NON_CODED_CONDITION,
  ...
  public void shouldTranslateConditionNonCodedToFhirType() {
    ...
    assertThat(condition.getCode().getCoding(), not(Collections.emptyList()));
    assertThat(
        condition.getCode().getCoding().get(0).getCode(), equalTo(CONDITION_NON_CODED.toString()));
    assertThat(
        condition.getCode().getCoding().get(0).getDisplay(), equalTo(CONDITION_NON_CODED_VALUE));

    Extension extension =
        condition.getExtensionByUrl(FhirConstants.OPENMRS_FHIR_EXT_NON_CODED_CONDITION);
