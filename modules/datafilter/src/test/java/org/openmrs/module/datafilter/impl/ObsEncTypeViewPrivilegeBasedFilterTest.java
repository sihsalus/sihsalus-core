...
public class ObsEncTypeViewPrivilegeBasedFilterTest
  ...
  private List<Obs> getObservations() {
    ...
    return obsService.getObservations(
        persons, null, questions, null, null, null, null, null, null, null, null, false);
  }

  @Test
  public void
      getEncounters_shouldIncludeObsLinkedToEncountersThatRequireAPrivilegeAndTheUserHasIt() {
