...
public class EncounterEncTypeViewPrivilegeBasedFilterTest
    extends BaseEncTypeViewPrivilegeBasedFilterTest {
  ...
  public void getEncounters_shouldExcludeEncountersThatRequireAPrivilege() {
    ...
    assertEquals(
        expCount, encounterService.getEncounters(name, 0, Integer.MAX_VALUE, false).size());
  }
  ...
  public void getEncounters_shouldIncludeEncountersThatRequireAPrivilegeAndTheUserHasIt() {
    ...
    Collection<Encounter> encounters =
        encounterService.getEncounters(name, 0, Integer.MAX_VALUE, false);
  ...
  @Test
  public void
      getVisits_shouldIncludePrivilegedEncountersOfTheVisitIfTheUserHasTheRequiredPrivilege() {
    executeDataSet(TestConstants.ROOT_PACKAGE_DIR + "visitWithEncounters.xml");
    reloginAs("dBeckham", "test");
    DataFilterTestUtils.addPrivilege(PRIV_MANAGE_CHEMO_PATIENTS);
