...
public class PatientLocationBasedFilterTest extends BaseFilterTest {
  ...
  @Test
  public void getAllPatients_shouldReturnAllPatientsIfTheAuthenticatedUserIsASuperUser()
      throws Exception {
  ...
  @Test
  public void
      getPatients_shouldReturnAllPatientsByPersonAttributeTypeIfTheAuthenticatedUserIsASuperUser() {
    assertTrue(Context.getAuthenticatedUser().isSuperUser());
    Context.getAdministrationService()
        .setGlobalProperty(
            OpenmrsConstants.GLOBAL_PROPERTY_PERSON_ATTRIBUTE_SEARCH_MATCH_MODE,
