...
public class ProgramWorkflowServiceAdvice implements AfterReturningAdvice {
  ...
  public void afterReturning(Object returnValue, Method method, Object[] args, Object target)
    ...
    if ((methodName.equals("savePatientProgram")
        || methodName.equals("purgePatientProgram")
        || methodName.equals("voidPatientProgram")
        || methodName.equals("unvoidPatientProgram"))) {
      if (args[0] != null) {
