...
public class PatientFlagPriorityResource extends MetadataDelegatingCrudResource<Priority> {
  ...
  protected PageableResult doSearch(RequestContext context) {
    ...
    return new NeedsPaging<Priority>(
        priority == null ? Collections.emptyList() : Arrays.asList(priority), context);
  }

  @Override
  protected PageableResult doGetAll(RequestContext context) throws ResponseException {
    return new NeedsPaging<Priority>(
        Context.getService(FlagService.class).getAllPriorities(), context);
  }
}
