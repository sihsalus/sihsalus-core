...
@Resource(
    name =
        RestConstants.VERSION_1 + PatientFlagsRestController.PATIENT_FLAGS_REST_NAMESPACE + "/tag",
    supportedClass = Tag.class,
...
public class PatientFlagTagResource extends MetadataDelegatingCrudResource<Tag> {
  ...
  public Tag getByUniqueId(String tagId) {
    ...
    if (tag == null) tag = getService().getTagByName(tagId);
    return tag;
  }
  ...
  public Model getCREATEModel(Representation rep) {
    return new ModelImpl()
        ...
        .property(
            "displayPoints",
            new ArrayProperty(new RefProperty("#/definitions/PatientflagsDisplaypointCreate")));
  }
  ...
  public Model getGETModel(Representation rep) {
    ...
    return model
        .property("tagId", new IntegerProperty())
        .property("name", new StringProperty())
        .property("roles", new ArrayProperty(new RefProperty("#/definitions/RoleGet")))
        .property(
            "displayPoints",
            new ArrayProperty(new RefProperty("#/definitions/PatientflagsDisplaypointGet")))
