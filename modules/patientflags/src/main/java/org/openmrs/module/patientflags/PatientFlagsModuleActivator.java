...
public class PatientFlagsModuleActivator extends BaseModuleActivator implements DaemonTokenAware {
  ...
  public void started() {
    ...
    if ((Context.getAdministrationService()
            .getGlobalProperty("patientflags.patientOverviewDisplay"))
        == null) {
      Context.getAdministrationService()
          .saveGlobalProperty(
              new GlobalProperty(
    ...
    extensionPoints.put(
        "org.openmrs.admin.list", "org.openmrs.module.patientflags.extension.html.FlagAdminExt");
    ...
    if ((Context.getAdministrationService()
        ...
        .equals("true")) {
      extensionPoints.put(
          "org.openmrs.patientDashboard.overviewBox",
    ...
    // unfortunately it needs to be executed twice since extensions are added to module before
    // activator is executed
  ...
  public void shutdown() {
    ...
    // need to delete the configured extensions here to assure that they aren't double-loaded on
    // next startup
    Module thisModule = ModuleFactory.getModuleByPackage("org.openmrs.module.patientflags");
