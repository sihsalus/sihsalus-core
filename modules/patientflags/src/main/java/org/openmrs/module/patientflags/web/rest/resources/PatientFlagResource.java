...
@Resource(
    name =
        RestConstants.VERSION_1
            ...
            + "/patientflag",
    supportedClass = PatientFlag.class,
...
public class PatientFlagResource extends DataDelegatingCrudResource<PatientFlag> {
  ...
  protected PageableResult doSearch(RequestContext context) {
    ...
    if (StringUtils.isNotBlank(patientUuid)) {
      ...
      if (patient != null) {
        return new NeedsPaging<PatientFlag>(
            Context.getService(FlagService.class).getPatientFlags(patient), context);
      }
    }
  ...
  /**
   * @see
   *     org.openmrs.module.webservices.rest.web.resource.impl.BaseDelegatingResource#delete(java.lang.Object,
   *     java.lang.String, org.openmrs.module.webservices.rest.web.RequestContext)
   */
  @Override
  protected void delete(PatientFlag delegate, String reason, RequestContext context)
   ...
   */
  @Override
  protected PatientFlag undelete(PatientFlag delegate, RequestContext context)
      throws ResponseException {
    if (delegate.getVoided()) {
