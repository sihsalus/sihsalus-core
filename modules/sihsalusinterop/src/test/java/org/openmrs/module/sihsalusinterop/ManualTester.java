...
public class ManualTester {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.println(
          "   • Identificador System: " + fhirPatient.getIdentifier().get(0).getSystem());
      System.out.println(
          "   • Identificador Value: " + fhirPatient.getIdentifier().get(0).getValue());
      System.out.println();
      ...
      String jsonPatient =
          ctx.newJsonParser().setPrettyPrint(true).encodeResourceToString(fhirPatient);
