...
public class DyakuAllergyIntoleranceMapper {
  ...
  public static final String PROFILE_ALERGIA_PE =
  ...
  public static AllergyIntolerance toDyakuFhir(Allergy allergy, String patientReference) {
    ...
    log.info(
        "Convirtiendo Allergy ["
            + allergy.getAllergyId()
            + "] a AllergyIntolerance FHIR R4 (Perfil AlergiaPe)");
    ...
    if (allergy.getAllergen() != null) {
      ...
      } else if (allergenDisplay.contains("DRUG")
          || allergenDisplay.contains("MEDICATION")
