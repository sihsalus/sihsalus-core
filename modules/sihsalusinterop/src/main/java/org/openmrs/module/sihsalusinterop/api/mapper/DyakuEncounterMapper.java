...
public class DyakuEncounterMapper {
  ...
  public static org.hl7.fhir.r4.model.Encounter toDyakuFhir(
      Encounter encounter, String patientReference, String organizationReference) {
    if (encounter == null) {
    ...
    if (encounter.getLocation() != null) {
      org.hl7.fhir.r4.model.Encounter.EncounterLocationComponent location =
