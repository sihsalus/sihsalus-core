...
@Resource(
    name = RestConstants.VERSION_1 + "/bedTagMap",
    supportedClass = BedTagMap.class,
...
public class BedTagMapResource extends DataDelegatingCrudResource<BedTagMap> {
  ...
  @Override
  protected void delete(BedTagMap delegate, String reason, RequestContext context)
  ...
  public Model getCREATEModel(Representation rep) {
    return new ModelImpl()
        .property("bed", new StringProperty())
        .property("bedTag", new StringProperty());
  }
