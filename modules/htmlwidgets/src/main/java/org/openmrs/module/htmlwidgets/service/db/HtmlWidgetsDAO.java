...
/** HtmlWidgets Database Access Interface */
public interface HtmlWidgetsDAO {

  /**
   * @return all OpenmrsMetadata of the passed type
   */
  @Transactional(readOnly = true)
  public <T extends OpenmrsMetadata> List<T> getAllMetadataByType(
      Class<T> type, boolean includeRetired);
