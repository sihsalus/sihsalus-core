...
public class WidgetUtil {
  ...
  public static <T extends Object> T parseInput(String input, Class<? extends T> type) {
    try {
      ...
      throw new RuntimeException(
          "Unable to convert input <" + input + "> to type " + type.getSimpleName(), e);
    }
  }
  ...
  public static Object parseInput(
      Object input, Class<?> type, Class<? extends Collection> collectionType) {
    try {
   ...
   * @return the Object of the passed type, given the passed input
   */
  public static Object getFromRequest(
      HttpServletRequest request, String parameterName, Object object, String propertyName) {
  ...
  @SuppressWarnings("unchecked")
  public static Object getFromRequest(
      HttpServletRequest request, String parameterName, Field field) {
    ...
    if (collectionType != null) {
      ...
      if (paramVals != null) {
        Collection defaultValue =
            Set.class.isAssignableFrom(collectionType) ? new HashSet() : new ArrayList();
