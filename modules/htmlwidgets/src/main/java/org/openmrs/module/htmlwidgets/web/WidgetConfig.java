...
public class WidgetConfig {
  ...
  // ******* PROPERTIES *******
  private PageContext pageContext; // This represents the PageContext
  ...
  private Class<?>
      type; // The represents the class to edit. It is an alternative to object/property
  ...
  public WidgetConfig clone() {
    ...
    c.setFormat(format);
    c.setAttributes(new HashSet<Attribute>(cloneAttributes()));
    return c;
  }

  /**
   * @return the HttpServletRequest associated with the PageContext
   */
  ...
  public List<Attribute> cloneAttributes() {
    ...
    for (Attribute a : getAttributes()) {
      ret.add(
          new Attribute(
              a.getName(), a.getFixedValue(), a.getConfiguredValue(), a.getDefaultValue()));
    }
    return ret;
  }
}
