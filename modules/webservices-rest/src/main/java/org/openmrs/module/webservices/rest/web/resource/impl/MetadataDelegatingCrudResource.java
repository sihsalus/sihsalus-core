...
/**
 * Subclass of {@link DelegatingCrudResource} with helper methods specific to {@link
 * OpenmrsMetadata}
 *
 * @param <T>
 */
public abstract class MetadataDelegatingCrudResource<T extends OpenmrsMetadata>
    extends DelegatingCrudResource<T> {

  @Override
  public Model getGETModel(Representation rep) {
    ModelImpl model =
        ((ModelImpl) super.getGETModel(rep))
  ...
  /**
   * @see
   *     org.openmrs.module.webservices.rest.web.resource.impl.BaseDelegatingConverter#getRepresentationDescription(org.openmrs.module.webservices.rest.web.representation.Representation)
   */
  @Override
  ...
  /**
   * @see
   *     org.openmrs.module.webservices.rest.web.resource.impl.DelegatingCrudResource#delete(java.lang.String,
  ...
  /**
   * @see
   *     org.openmrs.module.webservices.rest.web.resource.impl.BaseDelegatingResource#undelete(java.lang.Object,
   *     org.openmrs.module.webservices.rest.web.RequestContext)
   */
  @Override
   ...
   * @return the display string. <strong>Should</strong> return a localized message if specified
   *     <strong>Should</strong> return the name property when no localized message is specified
   *     <strong>Should</strong> return the empty string when no localized message is specified and
