...
public abstract class BaseDelegatingSubclassHandler<Superclass, Subclass extends Superclass>
    implements DelegatingSubclassHandler<Superclass, Subclass> {
  ...
  /**
   * Uses introspection into the generic interface to determine the superclass plugged into by this
   * handler
   *
   * @see
   *     org.openmrs.module.webservices.rest.web.resource.impl.DelegatingSubclassHandler#getSuperclass()
   */
  @SuppressWarnings("unchecked")
  @Override
  public Class<Superclass> getSuperclass() {
    return ReflectionUtil.getParameterizedTypeFromInterface(
        getClass(), DelegatingSubclassHandler.class, 0);
  }
   ...
   *
   * @see
   *     org.openmrs.module.webservices.rest.web.resource.impl.DelegatingSubclassHandler#getSubclassHandled()
   */
  @SuppressWarnings("unchecked")
  @Override
  public Class<Subclass> getSubclassHandled() {
    return ReflectionUtil.getParameterizedTypeFromInterface(
        getClass(), DelegatingSubclassHandler.class, 1);
  }

  /**
   * @see
   *     org.openmrs.module.webservices.rest.web.resource.impl.DelegatingResourceHandler#getUpdatableProperties()
   */
  @Override
  ...
  /**
   * @see
   *     org.openmrs.module.webservices.rest.web.resource.impl.DelegatingResourceHandler#purge(java.lang.Object,
  ...
  public DelegatingCrudResource<Superclass> getResource() {
    ...
    Resource resource =
        Context.getService(RestService.class).getResourceBySupportedClass(getSuperclass());
