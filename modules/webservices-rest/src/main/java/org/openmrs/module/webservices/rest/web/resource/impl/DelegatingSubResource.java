 ...
 */
public abstract class DelegatingSubResource<T, P, PR extends DelegatingCrudResource<P>>
    extends BaseDelegatingResource<T> implements SubResource {
   ...
   */
  public abstract PageableResult doGetAll(P parent, RequestContext context)
      throws ResponseException;
  ...
  public String getUri(Object instance) {
    org.openmrs.module.webservices.rest.web.annotation.SubResource sub =
        getClass()
   ...
   */
  @Override
  public Object retrieve(String parentUniqueId, String uuid, RequestContext context)
      throws ResponseException {
  ...
  public Object update(
      String parentUniqueId, String uuid, SimpleObject propertiesToUpdate, RequestContext context)
      throws ResponseException {
    T delegate = getByUniqueId(uuid);
    if (delegate == null) throw new ObjectNotFoundException();
    testParent(delegate, parentUniqueId);
   ...
   */
  @Override
  public void delete(String parentUniqueId, String uuid, String reason, RequestContext context)
      throws ResponseException {
    T delegate = getByUniqueId(uuid);
    if (delegate == null) throw new ObjectNotFoundException();
    testParent(delegate, parentUniqueId);
  ...
  private PR getParentResource() {
    ...
    org.openmrs.module.webservices.rest.web.annotation.Resource resource =
        sub.parent()
  ...
  public SimpleObject asRef(T delegate) throws ConversionException {
    ...
    if (method != null) {
      try {
        if ((Boolean) method.invoke(delegate)) description.addProperty("voided");
      ...
      if (method != null) {
        try {
          if ((Boolean) method.invoke(delegate)) description.addProperty("retired");
        } catch (IllegalArgumentException e) {
