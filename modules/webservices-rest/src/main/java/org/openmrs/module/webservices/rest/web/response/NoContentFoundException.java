...
/**
 * This exception should be thrown for cases where returning an empty list would not be appropriate.
 * e.g where a patient's allergy status is Allergies.UNKNOWN
 */
