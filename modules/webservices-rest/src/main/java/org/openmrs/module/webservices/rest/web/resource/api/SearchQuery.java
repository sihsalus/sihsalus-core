 ...
 *   <li>Set the various search query properties through the respective methods of the static
 *       builder class ({@link Builder#withRequiredParameters(String...)}, {@link
 *       Builder#withOptionalParameters(String...)}.
 *   <li>Build the {@link SearchQuery} instance with the {@link Builder#build()} method.
 *   <li>Get the search query properties through the getter methods (such as {@link
 *       #getRequiredParameters()} or {@link #getOptionalParameters()}).
 * </ol>
 */
public class SearchQuery {
  ...
  public static class Builder {
     ...
     * @return this builder instance <strong>Should</strong> fail if required parameters are already
     *     set
     */
    ...
    public Builder withRequiredParameters(SearchParameter... requiredParameters) {
      ...
      searchQuery.requiredParameters =
          Collections.unmodifiableSet(
              new HashSet<SearchParameter>(Arrays.asList(requiredParameters)));
     ...
     * @return this builder instance <strong>Should</strong> fail if optional parameters are already
     *     set
     */
    ...
    public Builder withOptionalParameters(SearchParameter... optionalParameters) {
      ...
      searchQuery.optionalParameters =
          Collections.unmodifiableSet(
              new HashSet<SearchParameter>(Arrays.asList(optionalParameters)));
      return this;
    }
     ...
     *     <strong>Should</strong> return a search query instance with properties set through the
     *     builder <strong>Should</strong> assign an empty set to required parameters if not set by
     *     the builder <strong>Should</strong> assign an empty set to optional parameters if not set
     *     by the builder <strong>Should</strong> fail if the description is null
     *     <strong>Should</strong> fail if the description is empty <strong>Should</strong> fail if
     *     both required and optional parameters are empty
     */
    public SearchQuery build() {
      ...
      Validate.isTrue(
          !searchQuery.requiredParameters.isEmpty() || !searchQuery.optionalParameters.isEmpty(),
  ...
  /**
   * @see Object#hashCode()
   * @return the hash code <strong>Should</strong> return same hashcode for equal search configs
   */
  @Override
  public int hashCode() {
    final int prime = 31;
   ...
   * @return true if obj is equal to this otherwise false <strong>Should</strong> return true if
   *     given this <strong>Should</strong> return true if this optional parameters and required
   *     parameters are equal to given search query <strong>Should</strong> be symmetric
   *     <strong>Should</strong> be transitive <strong>Should</strong> return false if given null
   *     <strong>Should</strong> return false if given an object which is not an instanceof this
   *     class <strong>Should</strong> return false if this optional parameters is not equal to the
   *     given search queries optional parameters <strong>Should</strong> return false if this
   *     required parameters is not equal to the given search queries required parameters
   */
  @Override
