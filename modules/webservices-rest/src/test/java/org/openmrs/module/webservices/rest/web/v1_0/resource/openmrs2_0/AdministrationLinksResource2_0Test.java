...
public class AdministrationLinksResource2_0Test
  ...
  public AdministrationSectionLinks newObject() {
    ...
    links.put(
        "module/webservices/rest/settings.form", RestConstants.MODULE_ID + ".manage.settings");

    return new AdministrationSectionLinks(
        RestConstants.MODULE_ID, RestConstants.MODULE_ID + ".title", links);
  }
