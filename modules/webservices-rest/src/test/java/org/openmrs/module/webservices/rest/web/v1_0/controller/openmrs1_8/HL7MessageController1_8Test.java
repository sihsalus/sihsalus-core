...
public class HL7MessageController1_8Test extends MainResourceControllerTest {
  ...
  private static final String HL7_DATA =
      "MSH|^~\\&|NES|AMRS.ELD|TESTSYSTEM|TESTFACILITY|20010101000000||ADT^A04|REl7wt78q9Pzlqe9ecJB|P|2.5";

  private static final String HL7_INVALID_SOURCE_DATA =
      "MSH|^~\\&|NES|nonexistingsource|TESTSYSTEM|TESTFACILITY|20010101000000||ADT^A04|REl7wt78q9Pzlqe9ecJB|P|2.3";
  ...
  public void adt_a28_shouldCreatePatient() throws Exception {
    ...
    SimpleObject hl7Message = new SimpleObject();
    String hl7Data =
        "MSH|^~\\&|REST|LOCAL|HL7HANDLER|OPENMRS|20140331101300^0|HUP|ADT^A28^ADT_A05|ADD PERSON INFO|P|2.5|1|||AL||ASCII\r"
