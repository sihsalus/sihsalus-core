...
@Resource(
    name = RestConstants.VERSION_1 + "/genericChild",
...
public class GenericChildResource extends DelegatingCrudResource<GenericChild> {
  ...
  public Model getCREATEModel(Representation rep) {
    return new ModelImpl().property("value", new StringProperty());
  }
  ...
  @Override
  public void delete(GenericChild visit, String reason, RequestContext context)
