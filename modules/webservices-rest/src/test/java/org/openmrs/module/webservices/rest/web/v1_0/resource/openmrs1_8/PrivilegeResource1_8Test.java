...
public class PrivilegeResource1_8Test
    extends BaseDelegatingResourceTest<PrivilegeResource1_8, Privilege> {
  ...
  public Privilege newObject() {
    Privilege privilege =
        new Privilege("PrivilegeResourceTest Privilege", "This privilege is only for testing.");
    privilege.setUuid(
        UUID.randomUUID().toString()); // Uuid isn't assigned during creation until 1.8.1.
