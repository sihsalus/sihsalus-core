...
public class ConceptResourceShortNameTest extends BaseModuleWebContextSensitiveTest {
  ...
  public void shortName_shouldBePresentInFullRepresentation() throws Exception {
    ...
    assertThat(
        "shortName key should be present in full representation", fullRep, hasKey("shortName"));
  }
   ...
   */
  @Test
  public void shortName_shouldReturnCorrectValueInFullRepresentationWhenShortNameIsDefined()
      throws Exception {
    Concept concept =
        Context.getConceptService().getConceptByUuid(RestTestConstants1_8.CONCEPT_UUID);
  ...
  public void shortName_shouldBeResolvableViaCustomRepresentation() throws Exception {
    ...
    ConceptResource1_9 resource = getResource();
    SimpleObject customRep =
        resource.asRepresentation(concept, new CustomRepresentation("uuid,shortName"));

    assertTrue(customRep.containsKey("uuid"), "uuid should be present in custom representation");
    assertTrue(
        customRep.containsKey("shortName"),
        "shortName should be resolvable via custom representation");
  ...
  public void shortName_shouldNotBePresentInDefaultRepresentation() throws Exception {
    ...
    assertThat(
        "shortName should not be present in default representation",
        defaultRep,
        not(hasKey("shortName")));
  }
  ...
  public void shortName_shouldNotBePresentInRefRepresentation() throws Exception {
    ...
    assertThat(
        "shortName should not be present in ref representation", refRep, not(hasKey("shortName")));
  }
}
