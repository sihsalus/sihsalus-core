...
public class ValidateUtilTest extends BaseModuleWebContextSensitiveTest {
  ...
  // this is only enabled in OpenMRS 1.9 and 1.10, so we include it in the tests for these specific
  // versions
  ...
  @Test
  @Verifies(
      value = "should throw ValidationException if errors occur during validation",
