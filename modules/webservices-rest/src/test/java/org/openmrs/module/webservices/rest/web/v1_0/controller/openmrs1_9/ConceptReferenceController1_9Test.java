...
public class ConceptReferenceController1_9Test extends RestControllerTestUtils {
  ...
  public void shouldGetConceptByMapping() throws Exception {
    ...
    assertThat(
        ((Map<String, String>) result.get(CONCEPT_MAPPING)).get("uuid"), equalTo(CONCEPT_UUID));
  }
    ...
    SimpleObject result =
        deserialize(
            handle(
                newGetRequest(
                    getURI(),
                    new MainResourceControllerTest.Parameter(
                        "references", CONCEPT_UUID + "," + CONCEPT_MAPPING))));
        ...
        deserialize(
            handle(
                newGetRequest(
                    getURI(),
                    new MainResourceControllerTest.Parameter(
                        "references", "aef986bd-e993-4634-ac51-8efcc407e237"))));
  ...
  public void shouldSupportPostRequests() throws Exception {
    ...
    MockHttpServletRequest request =
        request(RequestMethod.POST, getURI(), MediaType.APPLICATION_FORM_URLENCODED_VALUE);
  ...
  public void shouldSupportPostRequestsWithJson() throws Exception {
    ...
    request.setContent(
        ("{\"references\": [\"" + CONCEPT_UUID + "\"]}").getBytes(StandardCharsets.UTF_8));
