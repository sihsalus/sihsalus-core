...
public class HL7MessageResource1_8Test
    extends BaseDelegatingResourceTest<HL7MessageResource1_8, IncomingHl7Message1_8> {
  ...
  public IncomingHl7Message1_8 newObject() {
    ...
    msg.setHL7Source(
        Context.getHL7Service().getHL7SourceByName(RestTestConstants1_8.HL7_SOURCE_NAME));
