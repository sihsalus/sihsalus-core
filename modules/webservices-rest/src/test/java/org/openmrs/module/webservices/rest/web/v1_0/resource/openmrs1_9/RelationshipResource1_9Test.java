...
/** Contains tests for the {@link RelationshipResource1_9} */
public class RelationshipResource1_9Test
    extends BaseDelegatingResourceTest<RelationshipResource1_9, Relationship> {
  ...
  public void createShouldIgnoreRelationshipTypeSpecificDisplayPropertiesWhenCreating() {
    // Ensuring that when the payload comes with displayAIsToB/displayBIsToA the resource should
    // create resource without any issue.
    final String RELATIONSHIP_NAME = "Sibling";
    final String DESCRIPTION =
        "Relationship between brother/sister, brother/brother, and sister/sister";
    ...
    SimpleObject relationshipTypeSimpleObject =
        new SimpleObject()
