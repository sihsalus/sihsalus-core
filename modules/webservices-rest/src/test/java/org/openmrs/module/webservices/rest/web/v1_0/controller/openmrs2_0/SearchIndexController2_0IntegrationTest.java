...
public class SearchIndexController2_0IntegrationTest extends RestControllerTestUtils {
  ...
  @Test
  public void updateSearchIndexForType_shouldUpdateTheSearchIndexForAllInstancesOfTheSpecifiedType()
      throws Exception {
  ...
  @Test
  public void updateSearchIndexForObject_shouldUpdateTheSearchIndexForTheSpecifiedObjectOnly()
      throws Exception {
    ...
    final String data =
        "{\"resource\": \"concept\", \"subResource\": \"name\", "
