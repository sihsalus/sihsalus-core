...
public class AlertRecipientResource2_0Test
    extends BaseDelegatingResourceTest<AlertRecipientResource2_0, AlertRecipient> {
  ...
  public String getDisplayProperty() {
    return Context.getUserService()
        .getUserByUuid(RestTestConstants1_8.USER_UUID)
        .getDisplayString();
  }
