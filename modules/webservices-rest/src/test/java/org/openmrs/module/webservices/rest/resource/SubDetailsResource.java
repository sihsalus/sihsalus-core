 ...
 */
@SubResource(
    parent = SystemSettingResource1_9.class,
    path = "subdetails",
    supportedClass = SubDetails.class,
    supportedOpenmrsVersions = {"2.0.* - 9.*"})
public class SubDetailsResource
    extends DelegatingSubResource<SubDetails, GlobalProperty, SystemSettingResource1_9> {
  ...
  @Override
  public PageableResult doGetAll(GlobalProperty parent, RequestContext context)
  ...
  @Override
  protected void delete(SubDetails delegate, String reason, RequestContext context)
      throws ResponseException {}
