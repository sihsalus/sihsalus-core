...
public class ConceptReferenceRangeResource2_7Test
    extends BaseDelegatingResourceTest<ConceptReferenceRangeResource2_7, ConceptReferenceRange> {
  ...
  public ConceptReferenceRange newObject() {
    ...
    referenceRange.setConceptNumeric(
        Context.getConceptService().getConceptNumericByUuid(RestConstants2_7.CONCEPT_NUMERIC_UUID));
