...
public class EncounterController1_9Test extends MainResourceControllerTest {
  ...
  public long getAllCount() {
    Map<Integer, List<Encounter>> allPatientEncounters =
        Context.getEncounterService().getAllEncounters(null);
  ...
  /**
   * @see
   *     org.openmrs.module.webservices.rest.web.v1_0.controller.EncounterController1_9Test#createEncounter_shouldCreateEncounterWithObsAttributesUnordered()
   */
  @Test
  @Disabled(
      "Fails with org.hibernate.TransientObjectException: object references an unsaved transient instance")
  public void createEncounter_shouldCreateEncounterWithObsAttributesUnordered() throws Exception {
    ...
    Assertions.assertNotNull(newEncounter);
    ...
    Assertions.assertTrue(obsDisplayValues.contains("CIVIL STATUS: MARRIED"));
    Assertions.assertTrue(obsDisplayValues.contains("WEIGHT (KG): 70.0"));
  }
  ...
  public void createEncounter_shouldCreateEncounterWithNestedObs() throws Exception {
    ...
    assertThat(encounterObs.size(), is(1));
    ...
    assertThat(parentGroupMembers.size(), is(1));
    ...
    assertThat(childGroupMembers.size(), is(1));

    Obs grandchildObs = childGroupMembers.iterator().next();
    assertThat(grandchildObs.getValueNumeric(), is(1.0));
  ...
  public void createEncounter_shouldCreateANewEncounterWithObs() throws Exception {
    ...
    Assertions.assertEquals(4, obs.size());
    Set<String> obsDisplayValues = new HashSet<String>();
    for (Map<String, String> o : obs) {
      obsDisplayValues.add(o.get("display"));
    }
    Assertions.assertTrue(obsDisplayValues.contains("CIVIL STATUS: MARRIED"));
    Assertions.assertTrue(obsDisplayValues.contains("FAVORITE FOOD, NON-CODED: fried chicken"));
    ...
    Assertions.assertTrue(obsDisplayValues.contains("DATE OF FOOD ASSISTANCE: " + format));
  }

  /**
   * @see
   *     org.openmrs.module.webservices.rest.web.v1_0.controller.EncounterController1_9Test#getEncounter_shouldGetAFullRepresentationOfAEncounterIncludingObsGroups()
   */
  @Test
  public void getEncounter_shouldGetAFullRepresentationOfAEncounterIncludingObsGroups()
      throws Exception {
    executeDataSet("encounterWithObsGroup1_9.xml");
    MockHttpServletRequest req =
        request(RequestMethod.GET, getURI() + "/62967e68-96bb-11e0-8d6b-9b9415a91465");
    req.addParameter(
    ...
    Assertions.assertEquals("62967e68-96bb-11e0-8d6b-9b9415a91465", result.get("uuid"));
    Assertions.assertNotNull(result.get("obs"));
    Assertions.assertEquals(
        "0f97e14e-cdc2-49ac-9255-b5126f8a5147", Util.getByPath(result, "obs[0]/concept/uuid"));
    Assertions.assertEquals(
        "96408258-000b-424e-af1a-403919332938",
        Util.getByPath(result, "obs[0]/groupMembers[0]/concept/uuid"));
    Assertions.assertEquals("Some text", Util.getByPath(result, "obs[0]/groupMembers[0]/value"));
    Assertions.assertEquals(
        "11716f9c-1434-4f8d-b9fc-9aa14c4d6126",
        Util.getByPath(result, "obs[0]/groupMembers[1]/concept/uuid"));
    Assertions.assertEquals(
        ConversionUtil.convertToRepresentation(ymd.parse("2011-06-12"), Representation.DEFAULT),
        Util.getByPath(result, "obs[0]/groupMembers[1]/value"));
    // make sure there's a group in the group
    Assertions.assertEquals(
        "0f97e14e-cdc2-49ac-9255-b5126f8a5147",
    ...
    Assertions.assertEquals(
        "Some text", Util.getByPath(result, "obs[0]/groupMembers[2]/groupMembers[0]/value"));
    Assertions.assertEquals(
        "11716f9c-1434-4f8d-b9fc-9aa14c4d6126",
  ...
  public void getEncounter_shouldExcludeVoidedOrders() throws Exception {
    ...
    MockHttpServletRequest req =
        request(RequestMethod.GET, getURI() + "/4e1a9d6e-0852-4d4b-9888-ecb680738dbe");
    req.addParameter(
        RestConstants.REQUEST_PROPERTY_FOR_REPRESENTATION, RestConstants.REPRESENTATION_FULL);
    MockHttpServletResponse response = handle(req);
    SimpleObject result = deserialize(response);
    ...
    Util.log("full", result);
    Assertions.assertNotNull(result);
    Assertions.assertNotNull(result.get("orders"));
    Assertions.assertEquals(0, ((List<?>) result.get("orders")).size());
  }

  /**
   * @see
   *     org.openmrs.module.webservices.rest.web.v1_0.controller.EncounterController1_9Test#shouldCreateAnEncounterWithObsAndOrdersOfDifferentTypes()
   */
  @Test
  @Disabled("Needs to be rewritten to use new order resource")
  public void shouldCreateAnEncounterWithObsAndOrdersOfDifferentTypes() throws Exception {
    ...
    orders.add(
        SimpleObject.parseJson(
            "{ \"type\": \"order\", \"concept\": \""
                + foodAssistanceUuid
                + "\", "
                + "\"orderer\": \"c2299800-cca9-11e0-9572-0800200c9a66\", \"orderType\": \""
                + lunchOrderUuid
                + "\", \"instructions\": \""
                + lunchInstructions
                + "\" }"));
    orders.add(
        SimpleObject.parseJson(
            "{ \"type\": \"drugorder\", \"concept\": \""
                + triomuneConceptUuid
                + "\", \"drug\": \""
                + triomuneDrugUuid
                + "\", \"route\": \"e10ffe54-5184-4efe-8960-cd565ec1cdf8\", "
    ...
    List<String> lookFor =
        new ArrayList<String>(Arrays.asList("FOOD ASSISTANCE", "Triomune-30: 1.0 tablet"));
  ...
  public void createEncounter_shouldCreateANewEncounterWithAVisitProperty() throws Exception {
    ...
    Assertions.assertNotNull(newEncounterObject);
    Encounter newEncounter =
        Context.getEncounterService()
            .getEncounterByUuid(((SimpleObject) newEncounterObject).get("uuid").toString());
    Assertions.assertEquals(before + 1, getAllCount());
    // the encounter should have been assigned to the visit
    Assertions.assertNotNull(newEncounter);
    Assertions.assertNotNull(newEncounter.getVisit());
    Assertions.assertEquals(visitUuid, newEncounter.getVisit().getUuid());
  }
  ...
  public void createEncounter_shouldEditVisitPropertyForAnExisitingEncounter() throws Exception {
    ...
    Visit newVisit =
        new Visit(
            ...
            vs.getVisitTypeByUuid(RestTestConstants1_9.VISIT_TYPE_UUID),
    ...
    Assertions.assertEquals(newVisit, update.getVisit());
  }
  ...
  public void createEncounter_shouldCreateEncounterWithProviders() throws Exception {
    ...
    // Post
    SimpleObject newEncounter =
        deserialize(handle(newPostRequest(getURI(), createEncounterWithProviders())));

    Assertions.assertNotNull(newEncounter);
    Assertions.assertEquals(encountersBefore + 1, getAllCount());
    ...
    Assertions.assertEquals(2, encounterProviderList.size());
  }
  ...
  private SimpleObject createEncounterWithObs() throws Exception {
    ...
    obs.add(
        SimpleObject.parseJson(
            "{ \"concept\": \"c607c80f-1ea9-4da3-bb88-6276ce8868dd\",\"value\": 70 }"));
    ...
    obs.add(
        SimpleObject.parseJson(
            "{ \"concept\": \"96408258-000b-424e-af1a-403919332938\", \"value\": \"fried chicken\" }"));
    ...
    return new SimpleObject()
        .add("location", "9356400c-a5a2-4532-8f2b-2361b3446eb8")
        .add("encounterType", "61ae96f4-6afe-4351-b6f8-cd4fc383cce1")
        .add("encounterDatetime", "2011-01-15")
        .add("patient", "da7f524f-27ce-4bb2-86d6-6d1d05312bd5")
        .add(
            "encounterProviders",
            Arrays.asList(
                new SimpleObject()
                    .add("provider", "c2299800-dgha-11e0-9572-0800200c9a66")
                    .add("encounterRole", "a0b03050-c99b-11e0-9572-0800200c9a66")))
        .add("obs", obs);
  }
  ...
  private SimpleObject createEncounterWithProviders() throws Exception {
    ...
    providers.add(
        SimpleObject.parseJson(
            "{\"provider\":\"c2299800-dgha-11e0-9572-0800200c9a66\","
    ...
    return new SimpleObject()
        .add("location", "9356400c-a5a2-4532-8f2b-2361b3446eb8")
        .add("encounterType", "61ae96f4-6afe-4351-b6f8-cd4fc383cce1")
        .add("encounterDatetime", "2015-06-17")
        .add("patient", "da7f524f-27ce-4bb2-86d6-6d1d05312bd5")
        .add("encounterProviders", providers);
  }
  ...
  public void getEncounter_shouldGetOnlyNonVoidedEncounterProviders() throws Exception {
    Encounter encounter =
        Context.getEncounterService()
            .getEncounterByUuid(RestTestConstants1_9.SECOND_ENCOUNTER_UUID);
    ...
    Assertions.assertNotNull(voidedEncounterProviderUuid);
    // the encounter has a voided encounter provider
    Assertions.assertEquals(
        RestTestConstants1_9.VOIDED_ENCOUNTER_PROVIDER, voidedEncounterProviderUuid);

    // retrieve the same encounter via the encounter web service
    MockHttpServletRequest req =
        request(RequestMethod.GET, getURI() + "/" + RestTestConstants1_9.SECOND_ENCOUNTER_UUID);
    MockHttpServletResponse response = handle(req);
    SimpleObject result = deserialize(response);

    voidedEncounterProviderUuid = null;
    List<Map<String, String>> encounterProviderList = result.get("encounterProviders");
    // we now check to make sure the encounter REST web service does not return voided encounter
    // provider
    if (encounterProviderList != null) {
      for (Map<String, String> wsEncounterProvider : encounterProviderList) {
        if (StringUtils.equals(
            RestTestConstants1_9.VOIDED_ENCOUNTER_PROVIDER, wsEncounterProvider.get("uuid"))) {
    ...
    Assertions.assertNull(voidedEncounterProviderUuid);
  }
  ...
  public void updateEncounter_shouldUpdateEncounterProviders() throws Exception {
    ...
    Assertions.assertNotNull(existing);
    Assertions.assertNotEquals(existing.getEncounterRole(), es.getEncounterRoleByUuid(newRoleUuid));
    ...
    SimpleObject newOne =
        SimpleObject.parseJson(
            "{"
                ...
                + "\","
                + "\"provider\": \""
                + existing.getProvider().getUuid()
                + "\","
                + "\"encounterRole\": \""
                + newRoleUuid
                + "\","
                + "\"encounter\": \""
                + existing.getEncounter().getUuid()
                + "\""
                + "}");
    ...
    SimpleObject encounterToModify =
        new SimpleObject()
            .add("encounterProviders", encounterProvidersToPost)
    ...
    EncounterProvider updateEncounterProvider =
        getEncounterProviderWthUuid(updatedEncounter.getEncounterProviders(), existing.getUuid());

    Assertions.assertEquals(initialCount, updatedEncounter.getEncounterProviders().size());
    Assertions.assertNotNull(updatedEncounter);
    Assertions.assertEquals(
        es.getEncounterRoleByUuid(newRoleUuid), updateEncounterProvider.getEncounterRole());
  }
  ...
  public void shouldUnVoidAnEncounter() throws Exception {
    ...
    Assertions.assertTrue(encounter.isVoided());

    String json = "{\"deleted\": \"false\"}";
    SimpleObject response =
        deserialize(
            handle(newPostRequest(getURI() + "/" + RestTestConstants1_9.ENCOUNTER_UUID, json)));

    encounter = es.getEncounterByUuid(RestTestConstants1_9.ENCOUNTER_UUID);
    Assertions.assertFalse(encounter.isVoided());
    Assertions.assertEquals("false", PropertyUtils.getProperty(response, "voided").toString());
  }

  @Test
  public void
      shouldFetchAllPatientEncounterIncludingVoidedPatientEncountersIfIncludeAllParamIsSetToTrue()
          throws Exception {
    Patient patient =
        Context.getPatientService()
            .getPatientByUuid(RestTestConstants1_9.PATIENT_WITH_ENCOUNTER_UUID);

    Encounter enc =
        Context.getEncounterService().getEncounterByUuid(RestTestConstants1_9.ENCOUNTER_UUID);
    ...
    Assertions.assertEquals(2, encs.size());
  ...
  @Test
  public void shouldFetchOnlyNonVoidedPatientEncountersIfIncludeAllParamIsSetToFalse()
      throws Exception {
    Patient patient =
        Context.getPatientService()
            .getPatientByUuid(RestTestConstants1_9.PATIENT_WITH_ENCOUNTER_UUID);
    ...
    SimpleObject result = deserialize(handle(req));
    List<Object> encounters = result.get("results");
    Assertions.assertEquals(encs.size(), encounters.size());
  }
