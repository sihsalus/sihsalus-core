...
public class DrugReferenceMapResource1_10Test
    extends BaseDelegatingResourceTest<DrugReferenceMapResource1_10, DrugReferenceMap> {
  ...
  public DrugReferenceMap newObject() {
    return Context.getService(RestHelperService.class)
        .getObjectByUuid(DrugReferenceMap.class, RestTestConstants1_10.DRUG_REFERENCE_MAP_UUID);
  }
