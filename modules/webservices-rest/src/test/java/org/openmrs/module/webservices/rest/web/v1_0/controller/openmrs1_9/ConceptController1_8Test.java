...
public class ConceptController1_8Test extends MainResourceControllerTest {
  ...
  public void shouldGetAConceptByUuid() throws Exception {
    MockHttpServletRequest req =
        request(RequestMethod.GET, getURI() + "/15f83cd6-64e9-4e06-a5f9-364d3b14a43d");
    SimpleObject result = deserialize(handle(req));
    Util.log("Concept fetched", result);
    Assertions.assertNotNull(result);
    Assertions.assertEquals(
        "15f83cd6-64e9-4e06-a5f9-364d3b14a43d", PropertyUtils.getProperty(result, "uuid"));
    Assertions.assertEquals(
        "ASPIRIN", PropertyUtils.getProperty(PropertyUtils.getProperty(result, "name"), "name"));
  }
  ...
  public void shouldGetSpecifiedRepresentationForGetAll() throws Exception {
    MockHttpServletRequest req = request(RequestMethod.GET, getURI());
    req.setParameter(
        RestConstants.REQUEST_PROPERTY_FOR_REPRESENTATION, RestConstants.REPRESENTATION_DEFAULT);
    SimpleObject result = deserialize(handle(req));
    Object aResult = Util.getResultsList(result).get(0);
  ...
  public void shouldCreateAConcept() throws Exception {
    ...
    String json =
        "{ \"names\": [{\"name\":\"test concept\", \"locale\":\"en\", \"conceptNameType\":\""
  ...
  public void shouldEditFullySpecifiedNameOfAConcept() throws Exception {
    ...
    MockHttpServletRequest req =
        request(RequestMethod.POST, getURI() + "/f923524a-b90c-4870-a948-4125638606fd");
    req.setContent(json.getBytes());
    handle(req);
    Concept updated = service.getConceptByUuid("f923524a-b90c-4870-a948-4125638606fd");
    Assertions.assertNotNull(updated);
    Assertions.assertEquals(
        changedName, updated.getFullySpecifiedName(Context.getLocale()).getName());
  }
  ...
  public void shouldReturnTheAuditInfoForTheFullRepresentation() throws Exception {
    MockHttpServletRequest req =
        request(RequestMethod.GET, getURI() + "/0dde1358-7fcf-4341-a330-f119241a46e8");
    req.addParameter(
  ...
  @Test
  @Disabled(
      "TRUNK-1956: H2 cannot execute the generated SQL because it requires all fetched columns to be included in the group by clause")
  public void shouldSearchAndReturnAListOfConceptsMatchingTheQueryString() throws Exception {
    ...
    Assertions.assertEquals(
        "0dde1358-7fcf-4341-a330-f119241a46e8", PropertyUtils.getProperty(hits.get(0), "uuid"));
    Assertions.assertEquals(
        "0f97e14e-cdc2-49ac-9255-b5126f8a5147", PropertyUtils.getProperty(hits.get(1), "uuid"));
  }
  ...
  public void doSearch_shouldReturnMembersOfConcept() throws Exception {
    ...
    Assertions.assertEquals(
        "f4d0b584-6ce5-40e2-9ce5-fa7ec07b32b4",
        PropertyUtils.getProperty(hits.get(0), "uuid")); // FAVORITE FOOD, NON-CODED
  }
  ...
  public void doSearch_shouldReturnAnswersToConcept() throws Exception {
    ...
    String answerToUuid =
        "95312123-e0c2-466d-b6b1-cb6e990d0d65"; // FOOD ASSISTANCE FOR ENTIRE FAMILY
    ...
    Assertions.assertEquals(1, hits.size());
    Assertions.assertEquals(
        "b98a6ed4-77e7-4cee-aae2-81957fcd7f48",
        PropertyUtils.getProperty(hits.get(0), "uuid")); // NO
  }
  ...
  public void shouldAddSetMembersToConcept() throws Exception {
    ...
    String json =
        "{ \"setMembers\": [\"0dde1358-7fcf-4341-a330-f119241a46e8\", \"54d2dce5-0357-4253-a91a-85ce519137f5\"] }";
  ...
  public void shouldAddAnswersToConcept() throws Exception {
    MockHttpServletRequest request = request(RequestMethod.POST, getURI() + "/" + getUuid());
    String json =
        "{ \"answers\": [\"0dde1358-7fcf-4341-a330-f119241a46e8\", \"54d2dce5-0357-4253-a91a-85ce519137f5\", \"05ec820a-d297-44e3-be6e-698531d9dd3f\"] }";
    request.setContent(json.getBytes());
  ...
  private boolean hasAnswer(Concept question, Concept answer) {
    for (ConceptAnswer conceptAnswerObject : question.getAnswers()) {
      if (conceptAnswerObject.getAnswerConcept().equals(answer)) return true;
    }
  ...
  private boolean hasAnswer(Concept question, Drug druganswer) {
    for (ConceptAnswer conceptAnswerObject : question.getAnswers()) {
      if (conceptAnswerObject.getAnswerDrug() != null
          && conceptAnswerObject.getAnswerDrug().equals(druganswer)) return true;
    }
    // answer was not found
    return false;
  }
  ...
  public void shouldRemoveAnswersFromConcept() throws Exception {
    ...
    MockHttpServletRequest request =
        request(RequestMethod.POST, getURI() + "/" + conceptWithAnswersUuid);
    String json = "{ \"answers\": [\"" + existingAnswerUuid + "\", \"" + newAnswerUuid + "\"] }";
    request.setContent(json.getBytes());

    handle(request);

    // get the object again so we have the new answers (will this bork hibernate because we fetched
    // it earlier?)
  ...
  private Matcher<ConceptMap> hasTerm(final ConceptReferenceTerm term) {
    return new FeatureMatcher<ConceptMap, ConceptReferenceTerm>(
        equalTo(term), "conceptReferenceTerm", "conceptReferenceTerm") {
    ...
    assertThat(
        ...
        contains(
            allOf(
                ...
                hasEntry(
                    "uri",
                    "http://localhost/ws/rest/v1/concept/95312123-e0c2-466d-b6b1-cb6e990d0d65")),
            allOf(
                hasEntry("rel", "default"),
                hasEntry(
                    "uri",
                    "http://localhost/ws/rest/v1/concept/95312123-e0c2-466d-b6b1-cb6e990d0d65?v=default"))));
  }
  ...
  public void shouldReturnCustomRepresentation() throws Exception {
    ...
    Assertions.assertEquals(
        "Question (eg, patient history, SF36 items)", conceptClass.get("description"));
    ...
    Assertions.assertNull(
        name.get("resourceVersion")); // resourceVersion is not included in ref representation
  }
  ...
  public void shouldIncludeAllUnretiredConceptAnswersForAQuestionConcept() throws Exception {
    ...
    Assertions.assertNotNull(result);
    Assertions.assertEquals(
        expectedAnswerCount, ((List<Object>) PropertyUtils.getProperty(result, "answers")).size());
  }
  ...
  public void shouldIncludeAllSetMembersForAConceptSet() throws Exception {
    ...
    Assertions.assertEquals(
        expectedMemberCount,
        ((List<Object>) PropertyUtils.getProperty(result, "setMembers")).size());
  }
        ...
        deserialize(
            handle(
                newGetRequest(
                    ...
                    new Parameter("code", "WGT234"))));
    List<Object> results = Util.getResultsList(response);

    assertThat(results.size(), is(1));
    Object next = results.iterator().next();
    assertThat(
        (String) PropertyUtils.getProperty(next, "uuid"),
        is("c607c80f-1ea9-4da3-bb88-6276ce8868dd"));
  }
  ...
  public void shouldFindConceptsBySource() throws Exception {
    SimpleObject response =
        deserialize(
            handle(
                newGetRequest(getURI(), new Parameter("source", "Some Standardized Terminology"))));
    List<Object> results = Util.getResultsList(response);
  ...
  public void shouldFindConceptsBySourceUuid() throws Exception {
    SimpleObject response =
        deserialize(
            handle(
                newGetRequest(
                    getURI(), new Parameter("source", "00001827-639f-4cb4-961f-1e025bf80000"))));
    List<Object> results = Util.getResultsList(response);
  ...
  public void shouldFindConceptsByName() throws Exception {
    SimpleObject response =
        deserialize(handle(newGetRequest(getURI(), new Parameter("name", "WEIGHT (KG)"))));
    List<Object> results = Util.getResultsList(response);
  ...
  @Test
  public void shouldFailToFetchAConceptByNameIfTheNameIsNeitherPreferredNorFullySpecified()
      throws Exception {
    assertThrows(
        APIException.class,
        () -> {
          SimpleObject response =
              deserialize(handle(newGetRequest(getURI(), new Parameter("name", "WT"))));
          List<Object> results = Util.getResultsList(response);
  ...
  public void shouldReturnFullSetMembersOnAllLevelsForFullChildren() throws Exception {
    ...
    SimpleObject level1 =
        deserialize(
            handle(
                newGetRequest(
                    getURI() + "/" + conceptLevel1.getUuid(), new Parameter("v", "fullchildren"))));
    ...
    level1 =
        deserialize(
            handle(
                newGetRequest(
                    getURI(),
                    new Parameter("v", "fullchildren"),
                    new Parameter("name", "level1"))));

    List<Object> results = Util.getResultsList(level1);
    assertThatLevelsIncluded(
    ...
    assertThrows(
        ...
        () -> {
          ...
          deserialize(
              handle(
                  newGetRequest(
                      getURI() + "/" + conceptLevel1.getUuid(),
                      new Parameter("v", "fullchildren"))));
        });
  }

  private void assertThatLevelsIncluded(
      Map<String, Object> level1,
      Concept conceptLevel2,
      Concept conceptLevel3,
      Concept conceptLevel4,
      Concept conceptLevel5) {
