...
public class ProviderAttributeController1_9Test extends MainResourceControllerTest {
  ...
  public long getAllCount() {
    return service
        .getProviderByUuid(RestTestConstants1_9.PROVIDER_UUID)
        .getActiveAttributes()
        .size();
  }
  ...
  @Test
  @Disabled(
      "null id in org.openmrs.ProviderAttribute entry (don't flush the Session after an exception occurs)")
  public void shouldAddAttributeToProvider() throws Exception {
    int before =
        service.getProviderByUuid(RestTestConstants1_9.PROVIDER_UUID).getAttributes().size();
    String json =
        "{\"attributeType\":\""
