...
public class ConceptSearchController1_9Test extends MainResourceControllerTest {
  ...
  public void shouldSearchAndReturnAListOfConceptsMatchingTheQueryString() throws Exception {
    ...
    assertThat(
        hits,
        containsInAnyOrder(
            isConceptWithUuid("92afda7c-78c9-47bd-a841-0de0817027d4"),
            isConceptWithUuid("f923524a-b90c-4870-a948-4125638606fd")));
  }

  @Test
  public void shouldSearchAndReturnAListOfConceptsMatchingTheQueryStringAndConceptClass()
      throws Exception {
    MockHttpServletRequest req = request(RequestMethod.GET, getURI());
    req.addParameter("q", "ma");
    ...
    Assertions.assertEquals(
        "f923524a-b90c-4870-a948-4125638606fd", Util.getByPath(hits.get(0), "concept/uuid"));
