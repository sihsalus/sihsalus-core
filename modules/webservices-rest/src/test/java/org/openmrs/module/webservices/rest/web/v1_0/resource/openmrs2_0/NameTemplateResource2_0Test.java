...
public class NameTemplateResource2_0Test
    extends BaseDelegatingResourceTest<NameTemplateResource2_0, NameTemplate> {

  @Override
  public NameTemplate newObject() {
    Context.getAdministrationService()
        .setGlobalProperty(GLOBAL_PROPERTY_LAYOUT_NAME_FORMAT, PERSON_NAME_FORMAT_SHORT);
