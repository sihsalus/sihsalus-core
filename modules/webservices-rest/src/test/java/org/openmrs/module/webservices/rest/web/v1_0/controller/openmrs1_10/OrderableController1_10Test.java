...
public class OrderableController1_10Test extends MainResourceControllerTest {
  ...
  public void shouldReturnOrderableConceptClasses() throws Exception {
    ...
    assertThat(
        results, containsInAnyOrder(isConceptWithUuid(RestTestConstants1_10.COUGH_SYRUP_UUID)));
  }
  ...
  public void shouldReturnOrdersWithDrugConceptOnly() throws Exception {
    ...
    for (int i = 0; i < Util.getResultsSize(result); i++) {
      ...
      assertThat(
          service.getConceptByUuid(uuid).getConceptClass().getUuid(),
          is("3d065ed4-b0b9-4710-9a17-6d8c4fd259b7"));
    }
    ...
    for (int i = 0; i < Util.getResultsSize(result); i++) {
      ...
      assertThat(
          service.getConceptByUuid(uuid).getConceptClass().getUuid(),
          is("97097dd9-b092-4b68-a2dc-e5e5be961d42"));
    }
  }
