...
public class DatabaseChangeResource2_0Test
    extends BaseDelegatingResourceTest<
        DatabaseChangeResource2_0, DatabaseUpdater.OpenMRSChangeSet> {

  @Override
  public DatabaseUpdater.OpenMRSChangeSet newObject() {
    DatabaseUpdater.OpenMRSChangeSet changeSet =
        Mockito.mock(DatabaseUpdater.OpenMRSChangeSet.class, Mockito.CALLS_REAL_METHODS);
    changeSet.setId("id");
