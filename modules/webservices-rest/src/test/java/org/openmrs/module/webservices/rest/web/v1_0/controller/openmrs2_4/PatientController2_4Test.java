...
public class PatientController2_4Test extends RestControllerTestUtils {
  ...
  @Autowired private PatientDAO hibernatePatientDao;

  @Autowired private PersonDAO hibernatePersonDAO;

  @Test
  @Disabled(
      "TRUNK-6010: The generated SQL contains syntax error in Core before version 2.5. This has been fixed on commit c3f63301. Once a submodule that depends on core version 2.5 is added, this test should be moved there and unignored.")
  public void shouldReturnDuplicatedPatientsByAllAttributesIncludingVoided() throws Exception {
    ...
    req.addParameter(
        ...
        "givenName,middleName,familyName,gender,identifier,birthdate,includeVoided");
