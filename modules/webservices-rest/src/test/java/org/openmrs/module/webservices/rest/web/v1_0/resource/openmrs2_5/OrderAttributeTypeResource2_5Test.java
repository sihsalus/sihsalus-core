...
public class OrderAttributeTypeResource2_5Test
    extends BaseDelegatingResourceTest<OrderAttributeTypeResource2_5, OrderAttributeType> {
  ...
  public void validateFullRepresentation() throws Exception {
    ...
    assertPropEquals("retired", getObject().getRetired());
    assertPropEquals("retireReason", getObject().getRetireReason());
