...
/**
 * Provides a simple concrete implementation of a {@link CalculationResult} that can be used out of
 * the box.
 */
public class SimpleResult implements CalculationResult {
  ...
  /**
   * Convenience constructor that takes in a value, a {@link Calculation} and {@link
   * CalculationContext} in which it was evaluated
   *
   * @param value the value to set
   * @param calculation the calculation to set
   ...
   */
  public SimpleResult(
      Object value, Calculation calculation, CalculationContext calculationContext) {
    this.value = value;
