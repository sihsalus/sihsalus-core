 ...
 * indicates that it represents a definition that can be evaluated in a {@link
 * PatientCalculationContext} It is highly recommended to extend {@link SimpleParameterDefinition}
 * rather implementing this interface.
 */
