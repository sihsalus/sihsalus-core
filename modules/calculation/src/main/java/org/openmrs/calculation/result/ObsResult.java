...
public class ObsResult extends SimpleResult implements DateBasedResult {
  ...
  /**
   * Convenience constructor that takes in an {@link Obs}, {@link PatientCalculation} and {@link
   ...
   */
  public ObsResult(
      Obs obs, PatientCalculation calculation, PatientCalculationContext calculationContext) {
  ...
  public Date getDateOfResult() {
    if (getValue() != null) return getValue().getObsDatetime();
    return null;
  }
}
