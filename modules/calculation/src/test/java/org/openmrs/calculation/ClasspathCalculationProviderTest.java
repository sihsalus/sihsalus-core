...
public class ClasspathCalculationProviderTest extends BaseModuleContextSensitiveTest {
  ...
  @Test
  public void
      getCalculation_shouldRetrieveAConfiguredConfigurableCalculationWithAValidConfigurationString()
          throws Exception {
   ...
   */
  @Test
  public void getCalculation_shouldRetrieveANonConfigurableCalculationWithANullConfigurationString()
      throws Exception {
    ClasspathCalculationProvider p = new ClasspathCalculationProvider();
  ...
  public void
      getCalculation_shouldThrowAnExceptionIfAConfigurableCalculationIsPassedAnIllegalConfiguration()
          throws Exception {
    ClasspathCalculationProvider p = new ClasspathCalculationProvider();
  ...
  @Test(expected = InvalidCalculationException.class)
  public void
      getCalculation_shouldThrowAnExceptionIfANonConfigurableCalculationIsPassedAConfigurationString()
          throws Exception {
    ClasspathCalculationProvider p = new ClasspathCalculationProvider();
  ...
  @Test
  @Verifies(
      value = "should always return a different instance of a calculation",
      method = "getCalculation(String,String)")
  public void getCalculation_shouldAlwaysReturnADifferentInstanceOfACalculation() throws Exception {
    ...
    Assert.assertTrue(
        p.getCalculation(calculationName, null) != p.getCalculation(calculationName, null));
  }
}
