...
public class ResultUtilTest {
   ...
   */
  @Test
  public void isFalse_shouldReturnTrueForACodedObsWhoseValueIsTheGlobalPropertyConceptfalse()
      throws Exception {
   ...
   */
  @Test
  public void isFalse_shouldReturnFalseForACodedObsWhoseValueIsNotTheGlobalPropertyConceptfalse()
      throws Exception {
    Obs obs = Mockito.mock(Obs.class);
  ...
  public void isFalse_shouldReturnTrueForAnEmptySimpleResult() throws Exception {
    // it's bad practice to have a SimpleResult whose value is null, but we should still handle the
    // case
  ...
  public void convert_shouldReturnTrueWhenConvertingAnArbitraryObjectToBoolean() throws Exception {
    Assert.assertTrue(
        ResultUtil.convert(new SimpleResult(new PatientProgram(), null), Boolean.class));
  }
