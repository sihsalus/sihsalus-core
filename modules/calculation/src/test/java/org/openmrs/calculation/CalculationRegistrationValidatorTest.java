...
public class CalculationRegistrationValidatorTest extends BaseModuleContextSensitiveTest {
  ...
  @Test
  @Verifies(
      value = "should fail if token registration calculation name is empty or whitespace",
      method = "validate(Object,Errors)")
  public void validate_shouldFailIfTokenRegistrationCalculationNameIsEmptyOrWhitespace()
      throws Exception {
  ...
  @Test
  @Verifies(
      value = "should fail if token registration name is empty or whitespace",
      method = "validate(Object,Errors)")
  ...
  @Test
  @Verifies(
      value = "should fail if token registration name is not unique amongst all tokens",
      method = "validate(Object,Errors)")
  public void validate_shouldFailIfTokenRegistrationNameIsNotUniqueAmongstAllTokens()
      throws Exception {
    CalculationRegistration calculationRegistration = new CalculationRegistration();
  ...
  @Test
  @Verifies(
      value = "should fail if token registration provider class name is empty or whitespace",
      method = "validate(Object,Errors)")
  public void validate_shouldFailIfTokenRegistrationProviderClassNameIsEmptyOrWhitespace()
      throws Exception {
    CalculationRegistration calculationRegistration = new CalculationRegistration();
    calculationRegistration.setToken("test");
  ...
  public void validate_shouldPassExistingTokenRegistration() throws Exception {
    CalculationRegistration calculationRegistration =
        calculationRegistrationService.getCalculationRegistration(1);
    Errors errors = new BindException(calculationRegistration, "calculationRegistration");
    new CalculationRegistrationValidator().validate(calculationRegistration, errors);
  ...
  @Test
  @Verifies(
      value = "should fail if token registration does not represent a valid calculation",
      method = "validate(Object,Errors)")
  public void validate_shouldFailIfTokenRegistrationDoesNotRepresentAValidCalculation()
      throws Exception {
    CalculationRegistration calculationRegistration = new CalculationRegistration();
    calculationRegistration.setToken("ageCalc");
    calculationRegistration.setProviderClassName(ClasspathCalculationProvider.class.getName());
