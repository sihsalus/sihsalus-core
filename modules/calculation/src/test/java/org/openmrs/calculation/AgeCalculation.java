...
public class AgeCalculation extends PatientAtATimeCalculation {
  ...
  public AgeCalculation() {
    addParameterDefinition(
        new SimpleParameterDefinition("units", "java.lang.String", "Units Of Age", false));
  }

  /**
   * @see org.openmrs.calculation.patient.PatientAtATimeCalculation#preprocess(java.util.Collection,
   *     java.util.Map, org.openmrs.calculation.patient.PatientCalculationContext)
   */
  @Override
  public EvaluationInstanceData preprocess(
    ...
    if (cohort != null && !cohort.isEmpty()) {
      ...
      List<List<Object>> queryData =
          Context.getAdministrationService().executeSQL(q.toString(), true);
  ...
  /**
   * @see
   *     org.openmrs.calculation.patient.PatientAtATimeCalculation#evaluateForPatient(EvaluationInstanceData,
   *     Integer, Map, PatientCalculationContext)
   */
  @Override
  public CalculationResult evaluateForPatient(
