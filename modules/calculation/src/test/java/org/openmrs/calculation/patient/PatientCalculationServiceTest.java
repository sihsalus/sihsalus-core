...
public class PatientCalculationServiceTest extends BaseModuleContextSensitiveTest {
  ...
  @Verifies(
      value = "should fail if any required parameter is not set",
      method = "evaluate(Cohort,Calculation,Map<String,Object>,CalculationContext)")
  public void evaluate_shouldFailIfAnyRequiredParameterIsNotSet() throws Exception {
    ...
    ParameterDefinition requiredDefinition =
        new SimpleParameterDefinition("testParam", "my data type", null, true);
  ...
  @Verifies(
      ...
      method = "evaluate(Cohort,Calculation,Map<String,Object>,CalculationContext)")
  public void evaluate_shouldFailForABlankValueForARequiredParameterIfDatatypeIsAPrimitiveWrapper()
      throws Exception {
    PatientCalculation ageCalculation = getAgeCalculation();
    ParameterDefinition requiredDefinition =
        new SimpleParameterDefinition("testParam", "java.lang.Integer", null, true);
    ageCalculation.getParameterDefinitionSet().add(requiredDefinition);
  ...
  @Test(expected = MissingParameterException.class)
  @Verifies(
      value = "should fail for a blank value for a required parameter if datatype is a String",
      method = "evaluate(Cohort,Calculation,Map<String,Object>,CalculationContext)")
  public void evaluate_shouldFailForABlankValueForARequiredParameterIfDatatypeIsAString()
      throws Exception {
    PatientCalculation ageCalculation = getAgeCalculation();
    ParameterDefinition requiredDefinition =
        new SimpleParameterDefinition("testParam", "java.lang.String", null, true);
    ageCalculation.getParameterDefinitionSet().add(requiredDefinition);
  ...
  @Verifies(
      value = "should fail if the a parameter value doesnt match the allowed datatype",
      method = "evaluate(Cohort,PatientCalculation,Map<String,Object>,PatientCalculationContext)")
  public void evaluate_shouldFailIfTheAParameterValueDoesntMatchTheAllowedDatatype()
      throws Exception {
    PatientCalculation ageCalculation = getAgeCalculation();
    ParameterDefinition param =
        new SimpleParameterDefinition("testParam", "java.lang.Integer", null, false);
  ...
  @Test
  @Verifies(
      value = "should pass if the passed in datatype cannot be loaded",
      method = "evaluate(Cohort,PatientCalculation,Map<String,Object>,PatientCalculationContext)")
  public void evaluate_shouldPassIfThePassedInDatatypeCannotBeLoaded() throws Exception {
    PatientCalculation ageCalculation = getAgeCalculation();
    ParameterDefinition conceptDefinition =
        new SimpleParameterDefinition("conceptParam", "numericConcepts", null, false);
  ...
  @Test
  @Verifies(
      value = "should return the expected result size for cohort with a large number of patient",
      method = "evaluate(Cohort,PatientCalculation,Map<String,Object>,PatientCalculationContext)")
  public void evaluate_shouldReturnTheExpectedResultSizeForCohortWithALargeNumberOfPatient()
      throws Exception {
