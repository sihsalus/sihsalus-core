...
public class CalculationRegistrationServiceTest extends BaseModuleContextSensitiveTest {
  ...
  @Test
  @Verifies(
      value = "should return a token with a matching id",
      method = "getCalculationRegistration(Integer)")
  ...
  @Test
  @Verifies(
      value = "should fetch a token with a matching uuid",
      method = "getCalculationRegistrationByUuid(Integer)")
  public void getCalculationRegistrationByUuid_shouldFetchATokenWithAMatchingUuid()
      throws Exception {
  ...
  @Test
  @Verifies(
      value = "should get all tokens in the database",
      method = "getAllCalculationRegistrations()")
  ...
  /**
   * @see {@link
   *     CalculationRegistrationService#saveCalculationRegistration(CalculationRegistration)}
   */
  @Test
  @Verifies(
      value = "should save the specified calculationRegistration to the database",
      method = "saveCalculationRegistration(CalculationRegistration)")
  public void
      saveCalculationRegistration_shouldSaveTheSpecifiedCalculationRegistrationToTheDatabase()
          throws Exception {
  ...
  /**
   * @see {@link
   *     CalculationRegistrationService#purgeCalculationRegistration(CalculationRegistration)}
   */
  @Test
  @Verifies(
      value = "should purge the specified calculationRegistration from the database",
      method = "purgeCalculationRegistration(CalculationRegistration)")
  public void
      purgeCalculationRegistration_shouldPurgeTheSpecifiedCalculationRegistrationFromTheDatabase()
          throws Exception {
  ...
  @Test
  @Verifies(
      value = "should update an existing token",
      method = "saveCalculationRegistration(CalculationRegistration)")
  ...
  @Verifies(
      ...
      method = "getCalculation(java.lang.String)")
  public void
      getCalculation_shouldReturnTheCalculationAssociatedToTheCalculationRegistrationWithTheGivenName()
          throws Exception {
    MostRecentObsCalculation calculation =
        service.getCalculation("mostRecentCD4", MostRecentObsCalculation.class);
  ...
  @Test
  @Verifies(
      value = "should get all calculationRegistrations with a matching name",
      method = "findCalculationRegistrations(String)")
  public void findCalculationRegistrations_shouldGetAllCalculationRegistrationsWithAMatchingName()
      throws Exception {
  ...
  @Test
  @Verifies(
      value = "should fetch a token with a matching name",
      method = "getCalculationRegistrationByToken(String)")
  public void getCalculationRegistrationByToken_shouldFetchATokenWithAMatchingName()
      throws Exception {
  ...
  @Verifies(
      value = "should update the cached token registration",
      method = "saveCalculationRegistration(CalculationRegistration)")
  public void saveCalculationRegistration_shouldUpdateTheCachedTokenRegistration()
      throws Exception {
    ...
    CalculationRegistration newTokenRegInstance =
        service.getCalculationRegistrationByToken(tokenName);
