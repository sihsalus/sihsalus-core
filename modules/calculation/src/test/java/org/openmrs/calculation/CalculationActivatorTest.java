...
public class CalculationActivatorTest extends BaseModuleContextSensitiveTest {
  ...
  @Autowired CalculationRegistrationService service;
  ...
  public void testRegisterCalculations() throws Exception {
    ...
    assertThat(
        registration.getProviderClassName(),
        is(ImplementationConfiguredCalculationProvider.class.getName()));
    assertThat(registration.getCalculationName(), is("weight"));
  }

  @Test
  public void testOverwritingRegistration() throws Exception {
    service.saveCalculationRegistration(
        new CalculationRegistration(
            "weight",
            ClasspathCalculationProvider.class.getName(),
            MostRecentObsCalculation.class.getName(),
            "5089"));
