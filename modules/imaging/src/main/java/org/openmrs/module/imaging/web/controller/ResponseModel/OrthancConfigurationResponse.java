...
public class OrthancConfigurationResponse {
  ...
  public static List<OrthancConfigurationResponse> configurationResponseList(
      List<OrthancConfiguration> configs) {
    return configs.stream()
        .map(OrthancConfigurationResponse::createResponse)
