...
public class DicomStudyController {
  ...
  private static final Set<String> ALLOWED_FETCH_OPTIONS =
      new HashSet<String>(Arrays.asList("all", "newest"));

  private static final Set<String> ALLOWED_DELETE_OPTIONS =
      new HashSet<String>(Arrays.asList("openmrs", "orthanc", "openmrsOrthanc"));

  private static final Set<Integer> ALLOWED_LINK_STATUSES =
      new HashSet<Integer>(Arrays.asList(-1, 0, 1, 2));
  ...
  @Transactional
  public ResponseEntity<Object> useStudiesByPatient(
   ...
   */
  @RequestMapping(
      value = "/studiesbyconfig",
      method = RequestMethod.GET,
      produces = MediaType.APPLICATION_JSON_VALUE)
  @Authorized(ImagingConstants.PRIVILEGE_VIEW_IMAGE_DATA)
  @Transactional
  public ResponseEntity<Object> useStudiesByConfig(
    ...
    OrthancConfiguration configuration =
        orthancConfigurationService.getOrthancConfiguration(configurationId);
    ...
    for (DicomStudy study : studies) {
      String dbName =
          ((patient.getGivenName() != null) ? patient.getGivenName().trim() : "")
              + " "
  ...
  @Authorized(ImagingConstants.PRIVILEGE_VIEW_IMAGE_DATA)
  @Transactional
  public ResponseEntity<Object> useStudySeries(
   ...
   */
  @RequestMapping(
      value = "/studyinstances",
      method = RequestMethod.GET,
      produces = MediaType.APPLICATION_JSON_VALUE)
  @Authorized(ImagingConstants.PRIVILEGE_VIEW_IMAGE_DATA)
  @Transactional
  public ResponseEntity<Object> useStudyInstances(
      @RequestParam(value = "studyId") int studyId,
    ...
    try {
      ...
      for (DicomInstance instance : instances) {
        DicomInstanceResponse dicomInstanceResponse =
            DicomInstanceResponse.createResponse(instance);
  ...
  @Transactional
  public ResponseEntity<Object> useOrthancConfigurations(
      HttpServletRequest request, HttpServletResponse response) {
    OrthancConfigurationService orthancConfigurationService =
        Context.getService(OrthancConfigurationService.class);
    List<OrthancConfiguration> configurations =
        orthancConfigurationService.getAllOrthancConfigurations();
    List<OrthancConfigurationResponse> orthancConfigurationResponseList =
        OrthancConfigurationResponse.configurationResponseList(configurations);
  ...
  @Transactional
  public ResponseEntity<Object> uploadStudies(
  ...
  @Transactional
  public ResponseEntity<Object> getLinkStudies(
      @RequestParam(value = "configurationId") int configurationId,
  ...
  @Authorized(ImagingConstants.PRIVILEGE_LINK_IMAGE_STUDIES)
  @Transactional
  public ResponseEntity<Object> assignStudy(
      @RequestParam(value = "studyId") int studyId,
      @RequestParam(value = "patient") String patientUuid,
  ...
  @Transactional
  public ResponseEntity<Object> deleteStudy(
      @RequestParam(value = "studyId") int studyId,
  ...
  @Authorized(ImagingConstants.PRIVILEGE_VIEW_IMAGE_DATA)
  @Transactional
  public ResponseEntity<?> previewInstance(
      @RequestParam(value = "orthancInstanceUID") String orthancInstanceUID,
      @RequestParam(value = "studyId") int studyId) {
    DicomStudyService dicomStudyService = Context.getService(DicomStudyService.class);
    DicomStudy study = dicomStudyService.getDicomStudy(studyId);
    if (study == null) {
    ...
    try {
      DicomStudyService.PreviewResult previewResult =
          dicomStudyService.fetchInstancePreview(orthancInstanceUID, study);
