...
public interface LegacyUIService extends OpenmrsService {
   ...
   *     because previously the patient's active orders would get discontinued in the process which
   ...
   *     PatientService#exitFromCare(Patient patient, Date dateExited, Concept reasonForExit) which
   *     was moved to exit from care module
