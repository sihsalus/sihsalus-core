...
/**
 * Unit Test class to ensure that none of the DWR services have deprecated methods. For reasoning
  ...
  public void checkThatNoDeprecatedMethodExistsInServiceClassesInDWRPackage() {
    try {
      ...
      if (candidates.size() > 0) {
        String message =
            "Found classes in DWR package which contain @Deprecated annotation. "
  ...
  private List<String> findDWRServiceClassesWhichContainDeprecatedAnnotation()
    ...
    String packageSearchPath =
        ResourcePatternResolver.CLASSPATH_ALL_URL_PREFIX
            + resolveBasePackage(OPENMRS_DWR_PACKAGE_NAME)
            + "/**/*Service.class";
