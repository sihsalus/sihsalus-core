...
public class EncounterTypeListControllerTest extends BaseModuleWebContextSensitiveTest {
  ...
  /**
   * @see
   *     EncounterTypeListController#onSubmit(HttpServletRequest,HttpServletResponse,Object,BindException)
   */
  @Test
  @Verifies(
      value = "should not fail if no encounter types are selected",
  ...
  public void onSubmit_shouldNotFailIfNoEncounterTypesAreSelected() throws Exception {
    ...
    SimpleFormController controller =
        (SimpleFormController) applicationContext.getBean("encounterTypeList");
