...
public class DWRProviderServiceTest extends BaseModuleWebContextSensitiveTest {
  ...
  private static final String PROVIDERS_INITIAL_XML =
      "org/openmrs/api/include/ProviderServiceTest-initial.xml";

  private static final String PROVIDER_ATTRIBUTE_TYPES_XML =
   ...
   */
  @Test
  public void findProvider_shouldReturnAMessageWithNoMatchesFoundWhenNoProvidersAreFound()
      throws Exception {
  ...
  public void findProvider_shouldReturnTheListOfProvidersMatchingTheSearchName() throws Exception {
    ...
    Assertions.assertTrue(
        providerNames.containsAll(Arrays.asList("Bruno Otterbourg", "Hippocrates of Cos")));
  }
  ...
  @Test
  @Disabled(
      "This test fails because we have the order by for person names mentioned in the person.hbm.xml for the names set. "
  ...
  public void
      findProviderCountAndProvider_shouldReturnTheCountOfAllProvidersMatchingTheSearchedNameAlongWithProviderList()
          throws Exception {
    Map<String, Object> countAndProviders =
        service.findProviderCountAndProvider("provider", true, 0, 2);
