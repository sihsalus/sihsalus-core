...
public class PortletTagTest {
  ...
  @Test
  @Verifies(
      value = "return the correct url for a core portlet",
      method = "generatePortletUrl(String, String)")
  ...
  @Test
  @Verifies(
      value = "return the correct url for a module portlet",
      method = "generatePortletUrl(String, String)")
  ...
  @Verifies(
      value =
          "replace period in a module id with a forward slash when building a module portlet url",
      method = "generatePortletUrl(String, String)")
  public void
      getModulePortletUrl_shouldReplacePeriodInAModuleIdWithAForwardSlashWhenBuildingAModulePortletUrl() {
    String portletUrl = "test.portlet";
  ...
  @Test
  @Verifies(
      value = "not update the moduleId field for a module portlet",
      method = "generatePortletUrl(String, String)")
  ...
  @Test
  @Verifies(
      value = "return a core portlet url when the specified module cannot be found",
      method = "generatePortletUrl(String, String)")
  ...
  @Test
  @Verifies(
      value = "append .portlet to the url if not specified",
      method = "generatePortletUrl(String, String)")
  ...
  @Test
  @Verifies(
      value = "treat both an empty and null module id as core portlets",
      method = "generatePortletUrl(String, String)")
