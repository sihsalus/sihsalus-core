...
public class ConceptFormControllerTest extends BaseModuleWebContextSensitiveTest {
  ...
  public void ConceptFormBackingObject_shouldCopyNumericAttributes() {
    ...
    ConceptFormController.ConceptFormBackingObject conceptFormBackingObject =
        controller.new ConceptFormBackingObject(concept);

    org.junit.jupiter.api.Assertions.assertEquals(
        Double.valueOf(5.2), conceptFormBackingObject.getHiAbsolute());
    org.junit.jupiter.api.Assertions.assertEquals(
        Double.valueOf(1.0), conceptFormBackingObject.getLowAbsolute());

    org.junit.jupiter.api.Assertions.assertEquals(
        Double.valueOf(4.1), conceptFormBackingObject.getHiCritical());
    org.junit.jupiter.api.Assertions.assertEquals(
        Double.valueOf(2.1), conceptFormBackingObject.getLowCritical());

    org.junit.jupiter.api.Assertions.assertEquals(
        Double.valueOf(3.1), conceptFormBackingObject.getLowNormal());
    org.junit.jupiter.api.Assertions.assertEquals(
        Double.valueOf(3.9), conceptFormBackingObject.getHiNormal());

    org.junit.jupiter.api.Assertions.assertEquals(
        Integer.valueOf(42), conceptFormBackingObject.getDisplayPrecision());
