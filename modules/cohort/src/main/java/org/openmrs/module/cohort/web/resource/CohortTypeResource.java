...
public class CohortTypeResource extends DataDelegatingCrudResource<CohortType> {
  ...
  @Override
  protected void delete(CohortType cohortType, String reason, RequestContext request)
  ...
  public CohortType getByUniqueId(String uuidOrName) {
    CohortType cohortType =
        Context.getService(CohortTypeService.class).getCohortTypeByUuid(uuidOrName);
  ...
  protected PageableResult doGetAll(RequestContext context) throws ResponseException {
    return new NeedsPaging<>(
        (List<CohortType>) Context.getService(CohortTypeService.class).findAllCohortTypes(),
        context);
  }
