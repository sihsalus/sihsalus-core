...
public class UtilsTest {
  ...
  public void version5Uuid_shouldGenerateExpectedUuid() {
    ...
    assertThat(
        version5Uuid("Write Code, Save Lives").toString(),
        equalTo("330fd6a6-43ad-5a84-b406-6006c0869809"));
    assertThat(
        version5Uuid("Medical Record System").toString(),
        equalTo("be709f07-95e0-5856-8408-684f82d6d894"));
  }
  ...
  public void normalizeConceptSourceName_shouldNotConsiderSpacesUnderscoresOrDashes() {
    ...
    assertThat(
        normalizeConceptSourceName("SNOMED CT"), equalTo(normalizeConceptSourceName("SNOMED-CT")));
    assertThat(
        normalizeConceptSourceName("snomed_ct"), equalTo(normalizeConceptSourceName("SNOMED-CT")));
    assertThat(
        normalizeConceptSourceName("KenyaEMR"),
        not(equalTo(normalizeConceptSourceName("KenyaEMR+"))));
  }
}
