...
public class Privileges {
  ...
  public static final String TASK_STOCKMANAGEMENT_STOCKOPERATIONS_MUTATE =
      "Task: stockmanagement.stockoperations.mutate";

  /** Task: stockmanagement.stockoperations.approve: Able to aprove stock operations */
  public static final String TASK_STOCKMANAGEMENT_STOCKOPERATIONS_APPROVE =
  ...
  public static final String TASK_STOCKMANAGEMENT_STOCKOPERATIONS_RECEIVEITEMS =
  ...
  public static final String TASK_STOCKMANAGEMENT_STOCKSOURCES_MUTATE =
      "Task: stockmanagement.stockSources.mutate";

  /** App: stockmanagement.stockOperationType: Able to view stock operation types */
  public static final String APP_STOCKMANAGEMENT_STOCKOPERATIONTYPE =
  ...
  public static final String TASK_STOCKMANAGEMENT_REPORTS_MUTATE =
      "Task: stockmanagement.reports.mutate";

  public static final List<String> ALL =
      Arrays.asList(
          APP_STOCKMANAGEMENT_DASHBOARD,
          APP_STOCKMANAGEMENT_STOCKITEMS,
          TASK_STOCKMANAGEMENT_STOCKITEMS_MUTATE,
          TASK_STOCKMANAGEMENT_STOCKITEMS_DISPENSE_QTY,
          TASK_STOCKMANAGEMENT_STOCKITEMS_DISPENSE,
          APP_STOCKMANAGEMENT_USERROLESCOPES,
          TASK_STOCKMANAGEMENT_USERROLESCOPES_MUTATE,
          ...
          APP_STOCKMANAGEMENT_STOCKSOURCES,
          TASK_STOCKMANAGEMENT_STOCKSOURCES_MUTATE,
          APP_STOCKMANAGEMENT_STOCKOPERATIONTYPE,
          TASK_STOCKMANAGEMENT_PARTY_READ,
