...
public class UserRoleScope extends org.openmrs.BaseChangeableOpenmrsData implements Serializable {
  ...
  public UserRoleScopeLocation addUserRoleScopeLocation(
      UserRoleScopeLocation userRoleScopeLocation) {
  ...
  public UserRoleScopeLocation removeUserRoleScopeLocation(
      UserRoleScopeLocation userRoleScopeLocation) {
  ...
  public void setUserRoleScopeOperationTypes(
      Set<UserRoleScopeOperationType> userRoleScopeOperationTypes) {
    this.userRoleScopeOperationTypes = userRoleScopeOperationTypes;
  }

  public UserRoleScopeOperationType addUserRoleScopeOperationType(
  ...
  public UserRoleScopeOperationType removeUserRoleScopeOperationType(
      UserRoleScopeOperationType userRoleScopeOperationType) {
