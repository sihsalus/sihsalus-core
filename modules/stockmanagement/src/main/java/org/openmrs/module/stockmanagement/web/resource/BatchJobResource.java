...
@Resource(
    name = RestConstants.VERSION_1 + "/" + ModuleConstants.MODULE_ID + "/batchjob",
    supportedClass = BatchJobDTO.class,
...
public class BatchJobResource extends ResourceBase<BatchJobDTO> {
  ...
  @Override
  protected void delete(BatchJobDTO delegate, String reason, RequestContext context)
  ...
  public Model getGETModel(Representation rep) {
    ...
    if (rep instanceof DefaultRepresentation || rep instanceof FullRepresentation) {
      modelImpl
          ...
          .property("startTime", new DateTimeProperty())
          .property("endTime", new DateTimeProperty())
          .property("expiration", new DateTimeProperty())
          .property("parameters", new StringProperty())
          .property("privilegeScope", new StringProperty())
          .property("locationScope", new StringProperty())
          .property("locationScopeUuid", new IntegerProperty())
          .property("executionState", new StringProperty())
