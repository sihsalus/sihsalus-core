...
public class StockItemDTOValidator implements Validator {
  ...
  public void validate(Object target, Errors errors) {
    ...
    if (object.getUuid() != null) {
      ...
      if (stockItem == null) {
        errors.rejectValue(
            "uuid", messageSourceService.getMessage("stockmanagement.stockitem.notexists"));
        return;
      }
    }

    if (stockItem == null) {
      if (StringUtils.isBlank(object.getDrugUuid())
          && StringUtils.isBlank(object.getConceptUuid())) {
        errors.rejectValue(
            "drugUuid",
      ...
      if (!StringUtils.isBlank(object.getDrugUuid())
          && !StringUtils.isBlank(object.getConceptUuid())) {
        errors.rejectValue(
            "drugUuid", messageSourceService.getMessage("stockmanagement.stockitem.drugorconcept"));
        return;
      }
    }
    ...
    if (!StringUtils.isBlank(object.getDrugUuid())
        && StringUtils.isBlank(object.getDispensingUnitUuid())) {
      errors.rejectValue(
          "dispensingUnitUuid",
    ...
    if (StringUtils.isBlank(object.getCommonName())) {
      ...
      errors.rejectValue(
          "commonName", messageSourceService.getMessage("stockmanagement.stockitem.commonName255"));
      return;
    }
    ...
    if (StringUtils.isBlank(object.getAcronym())) {
      ...
      errors.rejectValue(
          "acronym", messageSourceService.getMessage("stockmanagement.stockitem.acronym255"));
      return;
    }

    if ((!StringUtils.isBlank(object.getPurchasePriceUoMUuid())
            && object.getPurchasePrice() == null)
        || (StringUtils.isBlank(object.getPurchasePriceUoMUuid())
            && object.getPurchasePrice() != null)) {
      errors.rejectValue(
          "purchasePrice",
    ...
    if (object.getPurchasePrice() != null
        && object.getPurchasePrice().compareTo(BigDecimal.ZERO) < 0) {
      errors.rejectValue(
          "purchasePrice",
    ...
    if ((!StringUtils.isBlank(object.getReorderLevelUoMUuid()) && object.getReorderLevel() == null)
        || (StringUtils.isBlank(object.getReorderLevelUoMUuid())
            && object.getReorderLevel() != null)) {
      errors.rejectValue(
          "reorderlevel",
    ...
    if (object.getReorderLevel() != null
        && object.getReorderLevel().compareTo(BigDecimal.ZERO) < 0) {
      errors.rejectValue(
          "reorderlevel",
