...
public class StockOperationActionValidator implements Validator {
  ...
  public void validate(Object target, Errors errors) {
    ...
    if (object.getName() == null) {
      errors.rejectValue(
          "name",
          messageSourceService.getMessage("stockmanagement.stockoperation.action.namerequired"));
      return;
    }
    ...
    if (object.getName().equals(StockOperationAction.Action.REJECT)
      ...
      if (StringUtils.isBlank(object.getReason())) {
        errors.rejectValue(
            ...
            messageSourceService.getMessage(
                "stockmanagement.stockoperation.action.reasonrequired"));
        return;
      }
      ...
      if (object.getReason().length() > 500) {
        errors.rejectValue(
            "reason",
            messageSourceService.getMessage(
                "stockmanagement.stockoperation.action.reasonexceeds500"));
        return;
      }
    }
  }
