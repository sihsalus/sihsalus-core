...
public class CSVWriter extends AbstractCSVWriter {
  ...
  @Override
  protected void writeNext(String[] nextLine, boolean applyQuotesToAll, Appendable appendable)
      throws IOException {
    if (nextLine == null) {
      return;
    }
  ...
  /**
   * Checks whether the next character that is to be written out is a special character that must be
   * quoted. The quote character, escape charater, and separator are special characters.
   *
