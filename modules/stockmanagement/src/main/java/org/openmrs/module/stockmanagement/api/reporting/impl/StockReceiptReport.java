...
public class StockReceiptReport extends StockOperationLineItemReport {
  ...
  protected void setFilters(StockOperationLineItemFilter filter, Properties parameters) {
    StockOperationType stockOperationType =
        stockManagementService.getStockOperationTypeByType(StockOperationType.RECEIPT);
  ...
  protected void writeRow(CSVWriter csvWriter, StockOperationLineItem row) {
    writeLineToCsv(
        ...
        row.getPurchasePrice() == null ? "" : row.getPurchasePrice().toPlainString(),
