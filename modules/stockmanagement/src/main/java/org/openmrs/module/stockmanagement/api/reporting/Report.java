...
public class Report<T extends ReportGenerator> {
  ...
  public static List<Report<?>> getAllReports() {
    ...
    reports.add(
        new Report<>(
            "8df8c605-6b37-11ed-93a2-806d973f13a9",
            1,
            "Stock Status Report",
            "STOCK_STATUS_REPORT",
            new ReportParameter[] {
            ...
            StockStatusReport.class));
    reports.add(
        new Report<>(
            "8df8c605-6b37-11ed-93a2-816d973f13a9",
            1,
            ...
            StockConsumptionReport.class));
    reports.add(
        new Report<>(
            "8df8c605-6b37-11ed-93a2-826d973f13a9",
            1,
            "Stock Receipt Report",
            "STOCK_RECEIPT_REPORT",
            new ReportParameter[] {
              ReportParameter.StartDate,
              ReportParameter.EndDate,
              ReportParameter.StockItemCategory,
            ...
            StockReceiptReport.class));
    reports.add(
        new Report<>(
            "8df8c605-6b37-11ed-93a2-836d973f13a9",
            1,
            "Stock Issue Report",
            "STOCK_ISSUE_REPORT",
            new ReportParameter[] {
            ...
            StockIssueReport.class));
    reports.add(
        new Report<>(
            "8df8c605-6b37-11ed-93a2-846d973f13a9",
            1,
            "Dispensing Logs",
            "DISPENSING_LOGS",
            new ReportParameter[] {
            ...
            DispensingLogsReport.class));
    reports.add(
        new Report<>(
            "8df8c605-6b37-11ed-93a2-856d973f13a9",
            1,
            "Prescribed Drugs Report",
            "PRESCRIBED_DRUGS_REPORT",
            new ReportParameter[] {
              ReportParameter.StartDate,
              ReportParameter.EndDate,
              ReportParameter.StockItemCategory,
            ...
            PrescribedDrugsReport.class));
    reports.add(
        new Report<>(
            "8df8c605-6b37-11ed-93a2-866d973f13a9",
            1,
            "Fulfillment Prescriptions Report",
            "FULFILLMENT_PRESCRIPTIONS_REPORT",
            new ReportParameter[] {
              ReportParameter.StartDate,
              ReportParameter.EndDate,
              ReportParameter.StockItemCategory,
    ...
    reports.add(
        new Report<>(
            "8df8c605-6b37-11ed-93a2-876d973f13a9",
            1,
            ...
            StockForecastReport.class));
    reports.add(
        new Report<>(
            "8df8c605-6b37-11ed-93a2-886d973f13a9",
            1,
            "Stock Expiry Forecast Report",
            "STOCK_EXPIRY_FORECAST_REPORT",
            new ReportParameter[] {
              ReportParameter.StartDate,
              ReportParameter.EndDate,
              ReportParameter.StockItemCategory,
            ...
            StockExpiryForecastReport.class));
    reports.add(
        new Report<>(
            "8df8c605-6b37-11ed-93a2-906d973f13a9",
            1,
            "Stock-Out Report",
            "STOCK_OUT_REPORT",
            new ReportParameter[] {
    ...
    reports.add(
        new Report<>(
            "8df8c605-6b37-11ed-93a2-916d973f13a9",
            1,
            "Stock Expiry Report",
            "STOCK_EXPIRY_REPORT",
            new ReportParameter[] {
    ...
    reports.add(
        new Report<>(
            "8df8c605-6b37-11ed-93a2-926d973f13a9",
            1,
            ...
            StockTransferOutReport.class));
    reports.add(
        new Report<>(
            "8df8c605-6b37-11ed-93a2-936d973f13a9",
            1,
            ...
            StockTransferInReport.class));
    reports.add(
        new Report<>(
            "8df8c605-6b37-11ed-93a2-946d973f13a9",
            1,
            "Most Moving Items/Least Moving Items",
            "MOST_LEAST_MOVING_ITEMS",
            new ReportParameter[] {
              ReportParameter.StartDate,
              ReportParameter.EndDate,
              ReportParameter.StockItemCategory,
            ...
            MostLeastMovingItemsReport.class));
