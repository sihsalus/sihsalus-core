...
@Resource(
    name = RestConstants.VERSION_1 + "/" + ModuleConstants.MODULE_ID + "/orderitem",
    supportedClass = OrderItemDTO.class,
...
public class OrderItemResource extends ResourceBase<OrderItemDTO> {
  ...
  @Override
  protected void delete(OrderItemDTO delegate, String reason, RequestContext context)
  ...
  protected PageableResult doSearch(RequestContext context) {
    ...
    if (StringUtils.isNotBlank(param)) filter.setOrderNumber(param);
  ...
  public Model getGETModel(Representation rep) {
    ...
    if (rep instanceof DefaultRepresentation || rep instanceof FullRepresentation) {
      modelImpl
          ...
          .property("orderUuid", new StringProperty())
          .property("action", new StringProperty())
          .property("orderNumber", new StringProperty())
          .property("encounterUuid", new StringProperty())
          ...
          .property("conceptId", new IntegerProperty())
          ...
          .property("createdFromName", new StringProperty())
          .property("createdFrom", new IntegerProperty())
          ...
          .property("fulfilmentPartyUuid", new StringProperty())
          ...
          .property("patientGivenName", new StringProperty())
          .property("patientFamilyName", new StringProperty())
