...
public class AuthenticationUtil {
   ...
   * @return the Properties whose keys start with the given prefix, without the prefix if
   *     stripPrefix is true
   */
  public static Properties getPropertiesWithPrefix(
      Properties properties, String prefix, boolean stripPrefix) {
