            ...
            <fo:flow flow-name="xsl-region-body">
                ...
                <fo:block-container height="{$body-height}" display-align="before">
                    ...
                    <fo:block-container height="{$table-height}" display-align="before">
                        ...
                        <!-- Demographic fields in a table row (as shown in the example image) -->
                        <xsl:if test="fields/field[@label = $genderKey] or fields/field[@label = $dobKey] or fields/field[@label = $ageKey]">
                            <fo:block-container margin-bottom="{$field-vertical-gap}">
                                <fo:table table-layout="fixed" width="100%">
                                    ...
                                    <fo:table-header>
                                        <fo:table-row>
                                            <xsl:if test="fields/field[@label = $genderKey]">
                                                <fo:table-cell>
                                                    <fo:block font-size="{$label-font-size}pt" font-weight="normal" font-family="{$label-font-family}" color="#444444">
                                                        <xsl:value-of select="fields/field[@label = $genderKey]/@label"/>
                                                    </fo:block>
                                                </fo:table-cell>
                                            </xsl:if>
                                            <xsl:if test="fields/field[@label = $dobKey]">
                                                <fo:table-cell>
                                                    <fo:block font-size="{$label-font-size}pt" font-weight="normal" font-family="{$label-font-family}" color="#444444">
                                                        <xsl:value-of select="fields/field[@label = $dobKey]/@label"/>
                                                    </fo:block>
                                                </fo:table-cell>
                                            </xsl:if>
                                            <xsl:if test="fields/field[@label = $ageKey]">
                                                <fo:table-cell>
                                                    <fo:block font-size="{$label-font-size}pt" font-weight="normal" font-family="{$label-font-family}" color="#444444">
                                                        <xsl:value-of select="fields/field[@label = $ageKey]/@label"/>
                                                    </fo:block>
                                                </fo:table-cell>
                                            </xsl:if>
                                        </fo:table-row>
                                    ...
                                    <fo:table-body>
                                        <fo:table-row>
                                            <xsl:if test="fields/field[@label = $genderKey]">
                                                <fo:table-cell>
                                                    <fo:block font-size="{$title-font-size}pt" font-weight="bold" font-family="{$value-font-family}" >
                                                        <xsl:value-of select="fields/field[@label = $genderKey]"/>
                                                    </fo:block>
                                                </fo:table-cell>
                                            </xsl:if>
                                            <xsl:if test="fields/field[@label = $dobKey]">
                                                <fo:table-cell>
                                                    <fo:block font-size="{$title-font-size}pt" font-weight="bold" font-family="{$value-font-family}" >
                                                        <xsl:choose>
                                                            <xsl:when test="contains(fields/field[@label = $dobKey], ' 00:00:00.0')">
                                                                <xsl:value-of select="substring-before(fields/field[@label = $dobKey], ' 00:00:00.0')"/>
                                                            </xsl:when>
                                                            <xsl:otherwise>
                                                                <xsl:value-of select="fields/field[@label = $dobKey]"/>
                                                            </xsl:otherwise>
                                                        </xsl:choose>
                                                    </fo:block>
                                                </fo:table-cell>
                                            ...
                                            <xsl:if test="fields/field[@label = $ageKey]">
                                                <fo:table-cell>
                                                    <fo:block font-size="{$title-font-size}pt" font-weight="bold" font-family="{$value-font-family}" >
                                                        <xsl:value-of select="fields/field[@label = $ageKey]"/>
                                                    </fo:block>
                                                </fo:table-cell>
                                            </xsl:if>
                                        </fo:table-row>
