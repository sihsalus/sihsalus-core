...
public class ProgramWorkflowShortConverter extends BaseShortConverter {
  ...
  /**
   * This short converter can deal with both ProgramWorkflow and CGLib proxy for ProgramWorkflow.
   * <br>
   * Because, when "c" is a CGLib proxy of ProgramWorkflow,
   * ProgramWorkflow.class.isAssignableFrom(c) will also return true
   *
