...
/**
 * Short Converter for OrderType and its CGLib proxy. <br>
 ...
 */
public class OrderTypeShortConverter extends BaseShortConverter {

  public OrderTypeShortConverter(Mapper mapper, ConverterLookup converterLookup) {
    super(mapper, converterLookup);
  }

  /**
   * This short converter can deal with both OrderType and CGLib proxy for OrderType. <br>
   * Because, when "c" is a CGLib proxy of OrderType, OrderType.class.isAssignableFrom(c) will also
   * return true
   *
  ...
  public Object getByUUID(String uuid) {
    return Context.getOrderService().getOrderTypeByUuid(uuid);
  }
}
