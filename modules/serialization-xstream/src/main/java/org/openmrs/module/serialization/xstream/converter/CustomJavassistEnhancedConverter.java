 ...
 * default, xstream won't serialize the javassist proxy's properties in the serialized xml string,
 * but just puts a few information in serialized xml string which describe the interfaces, packages
 * and other information of current class, so we need this own-defined
 * "CustomJavassistEnhancedConverter" for javassist proxies.
 */
