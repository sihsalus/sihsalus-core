 ...
 */
public class ConceptShortConverter extends BaseShortConverter {

  public ConceptShortConverter(Mapper mapper, ConverterLookup converterLookup) {
    super(mapper, converterLookup);
  }

  /**
   * This short converter can deal with both Concept and CGLib proxy for Concept. <br>
   * Because, when "c" is a CGLib proxy of Concept, Concept.class.isAssignableFrom(c) will also
   * return true
   *
