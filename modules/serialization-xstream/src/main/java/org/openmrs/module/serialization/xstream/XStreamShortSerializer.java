...
public class XStreamShortSerializer extends XStreamSerializer {
  ...
  public XStreamShortSerializer(XStream customXstream) throws SerializationException {
    ...
    // here use the very high priority, so that this converter can replace UserConverter in long
    // serializer
    xstream.registerConverter(
        new UserShortConverter(mapper, conerterLookup), xstream.PRIORITY_VERY_HIGH);
