...
/**
 * Short Converter for Program and its CGLib proxy. <br>
 ...
 */
public class ProgramShortConverter extends BaseShortConverter {

  public ProgramShortConverter(Mapper mapper, ConverterLookup converterLookup) {
    super(mapper, converterLookup);
  }

  /**
   * This short converter can deal with both Program and CGLib proxy for Program. <br>
   * Because, when "c" is a CGLib proxy of Program, Program.class.isAssignableFrom(c) will also
   * return true
   *
