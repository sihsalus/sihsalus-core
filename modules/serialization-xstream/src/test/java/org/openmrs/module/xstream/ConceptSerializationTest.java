...
public class ConceptSerializationTest extends BaseModuleContextSensitiveTest {
	...
	public void shouldDeserializeConcept() throws Exception {
		...
		xmlBuilder.append("    <conceptName id=\"22\" uuid=\"b8159118-c97b-4d5a-a63e-d4aa4be0c4d3\" voided=\"false\">\n");
		...
		xmlBuilder.append("      <concept reference=\"1\"/>\n");
		xmlBuilder.append("      <conceptSource id=\"59\" uuid=\"14ea70c7-fe49-46ae-9957-8a678c82d1d8\">\n");
		...
		Concept concept = Context.getSerializationService().deserialize(xmlBuilder.toString(), Concept.class,
