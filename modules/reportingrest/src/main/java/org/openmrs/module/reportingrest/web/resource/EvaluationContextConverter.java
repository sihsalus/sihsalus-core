...
public class EvaluationContextConverter implements Converter<EvaluationContext> {
  ...
  @Override
  public SimpleObject asRepresentation(EvaluationContext instance, Representation rep)
  ...
  @Override
  public Object getProperty(EvaluationContext instance, String propertyName)
      throws ConversionException {
    try {
