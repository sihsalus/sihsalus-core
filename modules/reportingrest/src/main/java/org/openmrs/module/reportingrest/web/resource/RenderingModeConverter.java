...
public class RenderingModeConverter implements Converter<RenderingMode> {
   ...
   */
  @Override
  public SimpleObject asRepresentation(RenderingMode mode, Representation rep)
   ...
   */
  @Override
  public Object getProperty(RenderingMode renderer, String propertyName)
      throws ConversionException {
    try {
      return PropertyUtils.getProperty(renderer, propertyName);
    } catch (Exception e) {
      throw new ConversionException(
          "Unable to retrieve property " + propertyName + " from " + renderer, e);
    }
  }
   ...
   */
  @Override
  public void setProperty(Object renderer, String propertyName, Object value)
      throws ConversionException {
    // not used
  }
