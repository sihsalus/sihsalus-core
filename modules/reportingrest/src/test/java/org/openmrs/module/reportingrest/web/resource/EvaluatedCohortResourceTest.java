...
public class EvaluatedCohortResourceTest
    extends BaseEvaluatedResourceTest<EvaluatedCohortResource, EvaluatedCohort> {
  ...
  public void testEvaluateWithNoParameters() throws Exception {
    ...
    String[] expectedUuids =
        new String[] {
          "da7f524f-27ce-4bb2-86d6-6d1d05312bd5", "a7e04421-525f-442f-8138-05b619d16def"
        };
  ...
  public void testEvaluateBuiltInDefinitionWithNoParameters() throws Exception {
    Object evaluated =
        getResource()
            .retrieve(BuiltInCohortDefinitionLibrary.PREFIX + "males", buildRequestContext());
    String json = toJson(evaluated);

    assertThat((String) path(evaluated, "definition", "name"), is("Males"));
    assertThat(
        (String) path(evaluated, "definition", "uuid"),
        is("reporting.library.cohortDefinition.builtIn.males"));
  ...
  public void testEvaluateBuiltInDefinitionWithParametersUsingPost() throws Exception {
    SimpleObject postBody =
        new SimpleObject().add("effectiveDate", "1996-08-30").add("maxAge", "20");

    Object evaluated =
        getResource()
            .update(
                BuiltInCohortDefinitionLibrary.PREFIX + "upToAgeOnDate",
                postBody,
                buildRequestContext());
    String json = toJson(evaluated);
    ...
    assertThat(
        (String) path(evaluated, "definition", "uuid"),
        is("reporting.library.cohortDefinition.builtIn.upToAgeOnDate"));
  ...
  private void assertCohortMembers(Object evaluated, String json, String[] expectedUuids)
      throws Exception {
