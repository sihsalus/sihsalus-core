...
public class EvaluatedResourceTest extends BaseModuleWebContextSensitiveTest {
  ...
  public void setUp() throws Exception {
    resource =
        new EvaluatedResource<Evaluated<?>>() {
          @Override
  ...
  public void testGetEvaluationContextWithParameters_noParams() throws Exception {
    ...
    EvaluationContext evalContext =
        resource.getEvaluationContextWithParameters(definition, buildRequestContext(), null, null);
  ...
  public void testGetEvaluationContextWithParameters_paramFromRequest() throws Exception {
    ...
    EvaluationContext evalContext =
        resource.getEvaluationContextWithParameters(
            definition, buildRequestContext("timeQualifier", "FIRST"), null, null);
    assertThat(evalContext.getParameterValues().size(), is(1));
    assertThat(
        (TimeQualifier) evalContext.getParameterValue("timeQualifier"), is(TimeQualifier.FIRST));
  }
  ...
  public void testGetEvaluationContextWithParameters_paramFromBody() throws Exception {
    ...
    EvaluationContext evalContext =
        resource.getEvaluationContextWithParameters(
            definition, buildRequestContext(), null, postBody);
    assertThat(evalContext.getParameterValues().size(), is(1));
    assertThat(
        (TimeQualifier) evalContext.getParameterValue("timeQualifier"), is(TimeQualifier.FIRST));
  }
  ...
  public void testGetEvaluationContextWithParameters_collectionParamFromRequest() throws Exception {
    ...
    definition.addParameter(
        new Parameter(
            "encounterTypeList", "Encounter Types", EncounterType.class, List.class, null));
    EvaluationContext evalContext =
        resource.getEvaluationContextWithParameters(
            definition, buildRequestContext("encounterTypeList", etUuid), null, null);
    assertThat(evalContext.getParameterValues().size(), is(1));
    assertThat(
        (List<EncounterType>) evalContext.getParameterValue("encounterTypeList"),
        containsInAnyOrder(Context.getEncounterService().getEncounterTypeByUuid(etUuid)));
  }

  @Test
  public void testGetEvaluationContextWithParameters_emptyCollectionParamFromRequest()
      throws Exception {
    String etUuid = "61ae96f4-6afe-4351-b6f8-cd4fc383cce1";
    EncounterCohortDefinition definition = new EncounterCohortDefinition();
    definition.addParameter(
    ...
    EvaluationContext evalContext =
        resource.getEvaluationContextWithParameters(
            definition, buildRequestContext("encounterTypeList", null), null, null);
    assertThat(evalContext.getParameterValues().size(), is(1));
    assertThat(
        ((List<EncounterType>) evalContext.getParameterValue("encounterTypeList")).size(), is(0));
  }
  ...
  @Test
  public void testGetEvaluationContextWithParameters_emptyCollectionParamFromBody()
      throws Exception {
    String etUuid = "61ae96f4-6afe-4351-b6f8-cd4fc383cce1";
    EncounterCohortDefinition definition = new EncounterCohortDefinition();
    definition.addParameter(
  ...
  public void testGetEvaluationContextWithParameters_missingCollectionParam() throws Exception {
    ...
    EvaluationContext evalContext =
        resource.getEvaluationContextWithParameters(
            definition, buildRequestContext(null), null, null);
    assertThat(evalContext.getParameterValues().size(), is(1));
