...
@Resource(
    name =
        RestConstants.VERSION_1
            + OrderTemplatesRestController.ORDER_TEMPLATES_REST_NAMESPACE
            + "/orderTemplate",
    supportedClass = OrderTemplate.class,
...
public class OrderTemplatesResource extends DelegatingCrudResource<OrderTemplate> {
  ...
  protected void delete(
      OrderTemplate orderTemplate, String retireReason, RequestContext requestContext)
      throws ResponseException {
    getService()
        .retireOrderTemplate(
            getService().getOrderTemplateByUuid(orderTemplate.getUuid()), retireReason);
  }
  ...
  @Override
  public void purge(OrderTemplate orderTemplate, RequestContext requestContext)
      throws ResponseException {
  ...
  protected PageableResult doGetAll(RequestContext context) throws ResponseException {
    return new NeedsPaging<OrderTemplate>(
        getService().getAllOrderTemplates(context.getIncludeAll()), context);
  }
