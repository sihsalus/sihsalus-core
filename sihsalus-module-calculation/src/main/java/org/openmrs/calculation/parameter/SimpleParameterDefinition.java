...
public class SimpleParameterDefinition implements ParameterDefinition {
   ...
   * @param required whether this property should be marked as required or not for the evaluation of
   *     the associated calculation to occur
   * @param description the description to set
   */
  public SimpleParameterDefinition(
      String key, String datatype, String name, boolean required, String description) {
    this.key = key;
