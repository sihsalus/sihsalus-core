 ...
 * Calculation Registrations for a consumer to choose from, in order to facilitate the registration
 * process. These are not meant to provide the superset of all available Calculation Registration
 * options that are available, but rather as a convenience mechanism for registering a subset of all
