...
public class CalculationRegistrationServiceImpl extends BaseOpenmrsService
    implements CalculationRegistrationService {

  protected final Log log = LogFactory.getLog(this.getClass());

  private CalculationRegistrationDAO dao;

  private Map<String, CalculationRegistration> tokenCalculationRegistrationCache =
      new ConcurrentHashMap<String, CalculationRegistration>();
  ...
  /**
   * @see
   *     org.openmrs.calculation.api.CalculationRegistrationService#getCalculationRegistration(java.lang.Integer)
   */
  @Override
  ...
  /**
   * @see
   *     org.openmrs.calculation.api.CalculationRegistrationService#getCalculationRegistrationByUuid(String)
   */
  @Override
  ...
  /**
   * @see
   *     org.openmrs.calculation.api.CalculationRegistrationService#getCalculationRegistrationByToken(java.lang.String)
   */
  @Override
  ...
  /**
   * @see
   *     org.openmrs.calculation.api.CalculationRegistrationService#getAllCalculationRegistrations()
   */
  @Override
  ...
  /**
   * @see
   *     org.openmrs.calculation.api.CalculationRegistrationService#getCalculationRegistrationsByProviderClassname(String)
   */
  @Override
  ...
  /**
   * @see
   *     org.openmrs.calculation.api.CalculationRegistrationService#findCalculationRegistrations(java.lang.String)
   */
  @Override
  ...
  /**
   * @see
   *     org.openmrs.calculation.api.CalculationRegistrationService#saveCalculationRegistration(org.openmrs.calculation.CalculationRegistration)
   */
  @Override
  ...
  /**
   * @see
   *     org.openmrs.calculation.api.CalculationRegistrationService#purgeCalculationRegistration(CalculationRegistration)
   */
  @Override
  ...
  /**
   * @see
   *     org.openmrs.calculation.api.CalculationRegistrationService#getCalculation(java.lang.String)
   */
  ...
  public <T extends Calculation> T getCalculation(String tokenName, Class<T> clazz)
    ...
    CalculationRegistration calculationRegistration =
        tokenCalculationRegistrationCache.get(tokenName);
