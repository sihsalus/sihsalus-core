 ...
 * instances. If a configuration string is passed in that is not valid for a given {@link
 * CalculationProvider} then it should throw an {@link InvalidCalculationException} to indicate
 * this.
 */
