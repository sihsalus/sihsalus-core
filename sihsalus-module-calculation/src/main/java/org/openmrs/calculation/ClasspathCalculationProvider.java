...
public class ClasspathCalculationProvider implements CalculationProvider {
  ...
  /**
   * @see CalculationProvider#getCalculation(String, String) <strong>Should</strong> retrieve a
   *     configured configurable calculation with a valid configuration string
   *     <strong>Should</strong> retrieve a non configurable calculation with a null configuration
   *     string <strong>Should</strong> throw an exception if a configurable calculation is passed
   *     an illegal configuration <strong>Should</strong> throw an exception if a non configurable
   *     calculation is passed a configuration string <strong>Should</strong> always return a
   *     different instance of a calculation
   */
  public Calculation getCalculation(String calculationName, String configuration)
    ...
    // If this is not a ConfigurableCalculation, but a configuration was passed in, throw an
    // Exception
    else {
