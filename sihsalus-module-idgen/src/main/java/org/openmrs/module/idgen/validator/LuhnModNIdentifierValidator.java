...
/**
 * A IdentifierValidator based on the Luhn Mod-N Algorithm See
...
public abstract class LuhnModNIdentifierValidator implements IdentifierValidator {
  ...
  /**
   * This is the primary method for determining the Base for this implementation. For example, if
   * you want a Mod-30 implementation, excluding characters B, I, O, Q, S, Z then you would set this
   * to "0123456789ACDEFGHJKLMNPRTUVWXY";
   */
  public abstract String getBaseCharacters();

  /**
   * This method converts all identifiers to a standard format. This may include things like
   * converting to upper-case, adding hyphens, etc. By default, this converts to upper-case and
  ...
  /**
   * By default, this will return all characters returned from getBaseCharacters, in both upper- and
   * lower-case variants
   *
  ...
  public char computeCheckDigit(String undecoratedIdentifier) {
    ...
    // Starting from the right and working leftwards is easier since the initial "factor" will
    // always be "2"
