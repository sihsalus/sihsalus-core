...
public class LocationBasedPrefixProvider implements GlobalPropertyListener, PrefixProvider {
  ...
  public static final String PREFIX_LOCATION_ATTRIBUTE_TYPE_GP =
  ...
  public String getLocationPrefix(Location location) {
    if (location != null) {
      ...
      // This means we either reached the top of the location without a valid prefix found or there
  ...
  public static String getPrefixLocationAttributeType() {
    if (prefixLocationAttributeType == null) {
      prefixLocationAttributeType =
          Context.getAdministrationService().getGlobalProperty(PREFIX_LOCATION_ATTRIBUTE_TYPE_GP);
    }
