...
public class HibernateDataFilterDAO implements DataFilterDAO {
	...
	public EntityBasisMap getEntityBasisMap(String entityIdentifier, String entityType, String basisIdentifier,
		...
		cq.select(root).where(matchingMap(cb, root, entityIdentifier, entityType, basisIdentifier, basisType));
	...
	private Predicate matchingMap(CriteriaBuilder cb, Root<EntityBasisMap> root, String entityIdentifier,
			String entityType, String basisIdentifier, String basisType) {
		return cb.and(
				equalIgnoreCase(cb, root, "entityIdentifier", entityIdentifier),
				equalIgnoreCase(cb, root, "entityType", entityType),
