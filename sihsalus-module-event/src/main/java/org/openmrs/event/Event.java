...
public class Event {
  ...
  /**
   * Creates a subscription for the specified class and action, if action is null, the subscription
   * is created for all the actions
   *
   * @param clazz
   * @param action
  ...
  /**
   * Removes the subscription associated to the specified class and set of actions, if action is
   * null all subscriptions associated to the class are dropped
   *
   * @param clazz if null, all objects are unsubscribed
  ...
  public static void unsubscribe(
      Class<?> clazz, Collection<Event.Action> actions, EventListener listener) {
