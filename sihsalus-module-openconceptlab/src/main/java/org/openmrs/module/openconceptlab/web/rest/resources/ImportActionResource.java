/**
 * This Source Code Form is subject to the terms of the Mozilla Public v. 2.0. If a copy of the MPL
 * was not distributed with this file, You obtain one at http://mozilla.org/MPL/2.0/. OpenMRS is
 * also distributed the terms of the Healthcare Disclaimer located at http://openmrs.org/ Copyright
 * (C) OpenMRS Inc. OpenMRS is a registered trademark and the OpenMRS graphic logo is a trademark of
 * OpenMRS Inc.
 */
...
public class ImportActionResource extends DelegatingCrudResource<ImportAction> {
  ...
  @Override
  protected void delete(ImportAction importAction, String s, RequestContext requestContext)
  ...
  @Override
  public void purge(ImportAction importAction, RequestContext requestContext)
      throws ResponseException {
    throw new ResourceDoesNotSupportOperationException();
  }
  ...
  public Model getCREATEModel(Representation rep) {
    return new ModelImpl()
        .property("anImport", new RefProperty("#/definitions/OpenconceptlabImportCreate"))
        .property("ignoreAllErrors", new BooleanProperty());
  }
