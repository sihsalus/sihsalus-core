...
public class ObsDataSetDefinition extends RowPerObjectDataSetDefinition {
  ...
  @ConfigurationProperty private List<Mapped<? extends ObsQuery>> rowFilters;
  ...
  public void addColumn(
    ...
    if (dataDefinition instanceof ObsDataDefinition) {
      ...
      ObsDataDefinition odd =
          new EncounterToObsDataDefinition((EncounterDataDefinition) dataDefinition);
      ...
      ObsDataDefinition odd =
          new PatientToObsDataDefinition((PatientDataDefinition) dataDefinition);
      getColumnDefinitions().add(new RowPerObjectColumnDefinition(name, odd, mappings, converters));
  ...
  public void addRowFilter(ObsQuery filter, String mappings) {
    getRowFilters()
        .add(new Mapped<ObsQuery>(filter, ParameterizableUtil.createParameterMappings(mappings)));
  }
