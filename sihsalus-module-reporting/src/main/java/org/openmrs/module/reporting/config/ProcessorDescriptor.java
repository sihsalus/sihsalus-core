...
public class ProcessorDescriptor {
  ...
  @JsonProperty private Boolean runOnSuccess;

  @JsonProperty private Boolean runOnError;

  @JsonProperty private String processorMode;

  @JsonProperty private Map<String, String> configuration;
