...
public class EvaluationUtil {
  ...
  /**
   * This can be used to retrieve the parameter name that may be included within a parameter
   * expression If the expression has no expression-like syntax to remove, it simply returns the
   * expression For example ${startDate} and ${startDate+1d} would both return "startDate"
   *
   ...
   */
  public static Object evaluateParameterExpression(
      String expression, Map<String, Object> parameters) throws ParameterException {
