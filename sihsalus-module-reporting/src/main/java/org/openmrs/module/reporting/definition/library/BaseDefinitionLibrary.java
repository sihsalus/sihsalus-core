...
/**
 * Implementations of this class can conveniently implement on-the-fly-created reporting
 * definitions, with inline documentation on how they will behave.
 */
    ...
    public Replacements add(String key, Object replacement) {
      String asString =
          replacement instanceof OpenmrsObject
              ? ((OpenmrsObject) replacement).getId().toString()
