...
/**
 * Allows for configuring one or more "cohortsToCheck". If "presentInAtLeast" is set, it will
 * include those patients who are present in that number of cohortsToCheck or more If
 * "presentInAtMost is set, it will include those patients who are present in that number of
 * cohortsToCheck or fewer
 */
...
public class PresenceOrAbsenceCohortDefinition extends BaseCohortDefinition {
  ...
  @ConfigurationProperty private List<Mapped<? extends CohortDefinition>> cohortsToCheck;

  @ConfigurationProperty private Integer presentInAtLeast;

  @ConfigurationProperty private Integer presentInAtMost;
