...
public class PatientStateCohortDefinition extends BaseCohortDefinition {
  ...
  public String toString() {
    ...
    ret.append("Patients ");
    if (startedOnOrAfter != null) ret.append("who started on or after " + startedOnOrAfter + " ");
    if (startedOnOrBefore != null)
      ret.append("who started on or before " + startedOnOrBefore + " ");
    if (endedOnOrAfter != null) ret.append("who ended on or after " + endedOnOrAfter + " ");
    if (endedOnOrBefore != null) ret.append("who ended on or before " + endedOnOrBefore + " ");

    if (states != null && states.size() > 0) {
      ret.append(" in ");
      for (ProgramWorkflowState s : states) ret.append(s.getName() + " ");
    }
