...
public class ConditionalParameterEncounterQuery extends BaseQuery<Encounter>
    implements EncounterQuery {

  @ConfigurationProperty private Map<Object, Mapped<? extends EncounterQuery>> conditionalQueries;

  @ConfigurationProperty private Mapped<? extends EncounterQuery> defaultQuery;
