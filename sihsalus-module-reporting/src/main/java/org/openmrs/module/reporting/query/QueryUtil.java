...
public class QueryUtil {
  ...
  /**
   * @return an IdSet that contains only those members that exist in all passed sets if any of the
   *     passed sets are null, this returns null
   */
  ...
  /**
   * @return an IdSet that contains only those members that exist in all passed sets if any of the
   *     passed sets are null, they are ignored
   */
  ...
  /**
   * @return an IdSet that contains all members that exist in any of the passed sets if any of the
   *     passed sets are null, they are ignored
   */
