...
/**
 * Primary use case is to support base Cohorts for report definitions that take in optional
 * parameters For the configured parameter(s), if these parameters are non-null, evaluate the Cohort
 * Definition, but if these parameters are null, return "All Patients"
 */
...
public class ConditionalParameterCohortDefinition extends BaseCohortDefinition {
  ...
  @ConfigurationProperty private Mapped<? extends CohortDefinition> defaultCohortDefinition;

  @ConfigurationProperty private String parameterToCheck;
  ...
  public void setConditionalCohortDefinitions(
      Map<Object, Mapped<? extends CohortDefinition>> conditionalCohortDefinitions) {
    this.conditionalCohortDefinitions = conditionalCohortDefinitions;
  }

  public void addConditionalCohortDefinition(
      Object parameterValue, Mapped<? extends CohortDefinition> cohortDefinition) {
  ...
  public void setDefaultCohortDefinition(
      Mapped<? extends CohortDefinition> defaultCohortDefinition) {
