...
public class CompositionCohortDefinitionEvaluator
    extends CompositionQueryEvaluator<CohortDefinition, Patient>
  ...
  @Override
  protected IdSet<Patient> evaluateQuery(Mapped<CohortDefinition> query, EvaluationContext context)
