...
/**
 * This class contains the logic necessary to set-up and tear down a report defined as a
 * ReportManager
 */
public class ReportManagerUtil {
  ...
  /**
   * Convenience method that can be used to automatically set up all ReportManager classes that
   * extend the passed in interface and are registered spring beans. This enables a module author to
   * create an interface or base class for all of their module's reports, and annotate each of these
   * as a Component, and call this single method to set them all up in their Activator.
   */
  ...
  /**
   * Sets up a single report, overwriting the existing report if the version is greater Typical
   * usage would be for a module that defines one or more reports via ReportManagers to install
   * these in the started() method of their activator by calling this method on each ReportManager
   * in turn.
   */
  ...
  public static void setupReportDefinition(
   ...
   */
  public static ReportDesign createExcelTemplateDesign(
   ...
   */
  public static ReportDesign createJSONTemplateDesign(
      String reportDesignUuid, ReportDefinition reportDefinition, String resourcePath) {
   ...
   */
  public static ReportDesign createCsvReportDesign(
      String reportDesignUuid, ReportDefinition reportDefinition) {
    ReportDesign design = new ReportDesign();
    design.setUuid(reportDesignUuid);
    design.setName("CSV");
   ...
   * @return a new ReportDesign for a standard CSV output
   */
  public static ReportDesign createJSONReportDesign(
      String reportDesignUuid, ReportDefinition reportDefinition) {
    ReportDesign design = new ReportDesign();
    design.setUuid(reportDesignUuid);
    design.setName("JSON");
