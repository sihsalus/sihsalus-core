...
public class DataUtil {
  ...
  /**
   * @param data
   * @param results each element should be an Object[2] with the first being an Integer id, and the
  ...
  /**
   * @return the result of evaluating the given definition against the given person, cast to the
   *     given type
   */
  public static <T> T evaluateForPerson(
      PersonDataDefinition definition, Person person, Class<T> type) {
  ...
  /**
   * @return the result of evaluating the given definition against the given patient, cast to the
   *     given type
   */
  public static <T> T evaluateForPatient(
      PatientDataDefinition definition, Integer patientId, Class<T> type) {
