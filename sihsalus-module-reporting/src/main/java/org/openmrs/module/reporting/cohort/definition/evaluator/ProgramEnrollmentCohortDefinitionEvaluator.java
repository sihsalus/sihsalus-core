...
public class ProgramEnrollmentCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
   ...
   * @should return patients enrolled in the given programs on the given date if passed in time is
   *     at midnight
   * @should return patients that completed the given programs on the given date if passed in time
   *     is at midnight
