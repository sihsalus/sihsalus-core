...
public interface ReportDefinitionService extends DefinitionService<ReportDefinition> {
  ...
  /**
   * This method evaluates a ReportDefinition object for the given EvaluationContext and returns a
   * ReportData
   *
  ...
  public ReportData evaluate(
      Mapped<? extends ReportDefinition> reportDefinition, EvaluationContext context)
      throws EvaluationException;
