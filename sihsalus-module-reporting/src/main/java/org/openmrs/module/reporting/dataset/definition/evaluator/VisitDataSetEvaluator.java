...
/**
 * The logic that evaluates a {@link
 * org.openmrs.module.reporting.dataset.definition.EncounterDataSetDefinition} and produces an
 * {@link org.openmrs.module.reporting.dataset.DataSet}
 */
...
public class VisitDataSetEvaluator implements DataSetEvaluator {
  ...
  public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext context)
    ...
    for (RowPerObjectColumnDefinition cd : dsd.getColumnDefinitions()) {
      ...
      MappedData<? extends VisitDataDefinition> dataDef =
          (MappedData<? extends VisitDataDefinition>) cd.getDataDefinition();
