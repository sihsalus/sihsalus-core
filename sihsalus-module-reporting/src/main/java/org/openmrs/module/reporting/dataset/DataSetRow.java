...
public class DataSetRow implements Serializable {
  ...
  /**
   * @return a map from key to value. Normally you would use {@link #getColumnValues()} but this
   *     version is useful if you need to use the returned map in JSTL for example.
   */
