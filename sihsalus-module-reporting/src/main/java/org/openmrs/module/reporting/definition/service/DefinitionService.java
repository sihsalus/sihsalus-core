...
public interface DefinitionService<T extends Definition> extends OpenmrsService {
   ...
   * Definition with the passed uuid, or a new instance of the Definition represented by the passed
   * type. Throws an IllegalArgumentException if any of this is invalid.
   *
   * @param uuid
   * @param type
