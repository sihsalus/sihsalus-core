...
public abstract class AbstractWebReportRenderer implements WebReportRenderer {
  ...
  /**
   * @see
   *     org.openmrs.module.reporting.report.renderer.ReportRenderer#getRenderedContentType(org.openmrs.module.reporting.report.ReportRequest)
   */
  @Override
  ...
  /**
   * @see
   *     org.openmrs.module.reporting.report.renderer.ReportRenderer#getFilename(org.openmrs.module.reporting.report.ReportRequest)
   */
  @Override
