...
public class PeriodIndicatorReportUtil {
  ...
  public static void addDimension(
      PeriodIndicatorReportDefinition def,
      String key,
      Mapped<CohortDefinitionDimension> dimension) {
  ...
  public static void addColumn(
    ...
    ensureDataSetDefinition(def);
    def.getIndicatorDataSetDefinition()
        .addColumn(
            key,
            displayName,
  ...
  public static void saveDataSetDefinition(PeriodIndicatorReportDefinition def) {
    Map<String, CohortIndicatorAndDimensionColumn> sortedColumns =
        new TreeMap<String, CohortIndicatorAndDimensionColumn>(new DelimitedKeyComparator());
    ...
    Context.getService(DataSetDefinitionService.class)
        .saveDefinition(def.getIndicatorDataSetDefinition());
  }
}
