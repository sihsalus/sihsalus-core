...
public class NumericObsForEncounterQuery extends ObsForEncounterQuery implements EncounterQuery {
  ...
  @ConfigurationProperty private RangeComparator operator1;

  @ConfigurationProperty private Double value1;

  @ConfigurationProperty private RangeComparator operator2;

  @ConfigurationProperty private Double value2;
