...
public class ReportProcessorConfiguration extends BaseOpenmrsMetadata {
  ...
  /**
   * @return the ReportDesign NOTE: if null, this implies that this ReportProcessorConfiguration is
   *     global.
   */
  ...
  /**
   * Convenience method for asking this ReportProcessorConfiguration if it is global, or local to a
   * single ReportDesign
   *
