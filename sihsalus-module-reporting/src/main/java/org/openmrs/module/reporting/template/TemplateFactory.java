...
public class TemplateFactory {
  ...
  public TemplateFactory(
      @Qualifier("messageSourceService") MessageSourceService mss,
  ...
  public Template compileHandlebarsTemplate(String template) {
    try {
      ...
      throw new TemplateEvaluationException(
          "Error compiling handlebars template: " + template,
          e); // this is in another package. Use this or another exception?
    }
  }

  public String evaluateHandlebarsTemplate(String template, Object context)
