...
public class ConditionalParameterCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
  ...
  public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context)
    ...
    ConditionalParameterCohortDefinition cd =
        (ConditionalParameterCohortDefinition) cohortDefinition;
    Cohort ret = new Cohort();
    Object valueToCheck = context.getParameterValue(cd.getParameterToCheck());
    Mapped<? extends CohortDefinition> match =
        cd.getConditionalCohortDefinitions().get(valueToCheck);
    if (match == null) {
