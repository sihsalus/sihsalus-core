...
public class CohortDimensionEvaluator implements DimensionEvaluator {
  ...
  public CohortDimensionResult evaluate(Dimension dimension, EvaluationContext context)
    ...
    result.addOptionCohort(
        Dimension.UNCLASSIFIED, CohortUtil.subtract(baseCohort, totalDimensions));
   ...
   * @throws EvaluationException
   */
  public Cohort evaluateDimensionOption(
      CohortDimension dimension, String option, EvaluationContext context)
      throws EvaluationException {
    ...
    if (mappedDef == null) {
      throw new IllegalArgumentException(
          "No CohortDefinition dimension option found for option: " + option);
    }
