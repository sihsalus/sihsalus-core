...
public interface ReportDAO {
   ...
   * @see
   *     org.openmrs.module.reporting.report.service.ReportService#getReportRequests(ReportDefinition,
   *     Date, Date, Integer, Integer, Status...)
   */
   ...
   * @return all {@link ReportRequest} in the system that match the passed parameters
   * @see
   *     org.openmrs.module.reporting.report.service.ReportService#getReportRequestsCount(ReportDefinition,
   *     Date, Date, Status...)
   */
  ...
  /**
   * Retrieves the UUIDs of the report requests associated with the report definition with the given
   * UUID
   *
   * @param reportDefinitionUuid the uuid of the report definition
