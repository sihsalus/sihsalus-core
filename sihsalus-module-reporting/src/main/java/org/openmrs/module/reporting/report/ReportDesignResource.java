...
/**
 * Represents a resource which is used in the rendering of a report. Such a resource could be an xml
 * design file, and image, a File template, or any particular resource that a renderer requires.
 */
