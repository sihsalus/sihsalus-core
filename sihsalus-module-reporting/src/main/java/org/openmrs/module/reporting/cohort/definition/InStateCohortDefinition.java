...
/**
 * Query for whether the patient was in a state on a date or date range (Using onDate is equivalent
 * to setting onOrAfter==onOrBefore, but may be more efficient and readable
 */
