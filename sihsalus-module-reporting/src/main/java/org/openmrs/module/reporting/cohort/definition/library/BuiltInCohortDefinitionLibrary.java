...
public class BuiltInCohortDefinitionLibrary extends BaseDefinitionLibrary<CohortDefinition> {
  ...
  public AgeCohortDefinition getUpToAgeOnDate() {
    ...
    cd.addParameter(
        new Parameter("effectiveDate", "reporting.parameter.effectiveDate", Date.class));
  ...
  public CohortDefinition getAnyEncounterDuringPeriod() {
    ...
    return new MappedParametersCohortDefinition(
        cd, "onOrAfter", "startDate", "onOrBefore", "endDate");
  }
  ...
  public CohortDefinition getCodedObsSearchAdvanced() {
    ...
    cd.addParameter(
        new Parameter("values", "reporting.parameter.valueList", Concept.class, List.class, null));
    cd.addParameter(new Parameter("onOrAfter", "reporting.parameter.onOrAfter", Date.class));
    cd.addParameter(new Parameter("onOrBefore", "reporting.parameter.onOrBefore", Date.class));
  ...
  public CohortDefinition getNumericObsSearchAdvanced() {
    ...
    cd.addParameter(
        new Parameter(
            "timeModifier",
            "reporting.parameter.timeModifier",
            NumericObsCohortDefinition.TimeModifier.class));
    cd.addParameter(new Parameter("question", "reporting.parameter.question", Concept.class));
    cd.addParameter(
        new Parameter("operator1", "reporting.parameter.operator1", RangeComparator.class));
    cd.addParameter(new Parameter("value1", "reporting.parameter.value1", Double.class));
    cd.addParameter(
        new Parameter("operator2", "reporting.parameter.operator2", RangeComparator.class));
  ...
  public CohortDefinition getTextObsSearchAdvanced() {
    ...
    cd.addParameter(
        new Parameter(
            "timeModifier",
            "reporting.parameter.timeModifier",
            TextObsCohortDefinition.TimeModifier.class));
    cd.addParameter(new Parameter("question", "reporting.parameter.question", Concept.class));
    cd.addParameter(
        new Parameter("values", "reporting.parameter.valueList", Concept.class, List.class, null));
    cd.addParameter(new Parameter("onOrAfter", "reporting.parameter.onOrAfter", Date.class));
  ...
  public CohortDefinition getEncounterSearchAdvanced() {
    ...
    cd.addParameter(new Parameter("onOrBefore", "reporting.parameter.onOrBefore", Date.class));
    cd.addParameter(
        new Parameter("atLeastCount", "reporting.parameter.atLeastCount", Integer.class));
    cd.addParameter(new Parameter("atMostCount", "reporting.parameter.atMostCount", Integer.class));
    cd.addParameter(
        new Parameter(
            "encounterTypeList",
            "reporting.parameter.encounterTypeList",
            EncounterType.class,
            List.class,
            null));
    cd.addParameter(
        new Parameter("formList", "reporting.parameter.formList", Form.class, List.class, null));
    cd.addParameter(
        new Parameter(
            "locationList", "reporting.parameter.locationList", Location.class, List.class, null));
    cd.addParameter(
        new Parameter("timeQualifier", "reporting.parameter.timeQualifier", TimeQualifier.class));
    return cd;
  }
  ...
  public CohortDefinition getBornDuringPeriod() {
    ...
    return new MappedParametersCohortDefinition(
        cd, "bornOnOrAfter", "startDate", "bornOnOrBefore", "endDate");
  }
  ...
  public CohortDefinition getDiedDuringPeriod() {
    ...
    return new MappedParametersCohortDefinition(
        cd, "diedOnOrAfter", "startDate", "diedOnOrBefore", "endDate");
  }
  ...
  public CohortDefinition getPersonWithAttribute() {
    ...
    cd.addParameter(
        new Parameter(
            "attributeType", "reporting.parameter.attributeType", PersonAttributeType.class));
    cd.addParameter(
        new Parameter("values", "reporting.parameter.values", String.class, List.class, null));
    return cd;
  }
  ...
  public CohortDefinition getPatientsWithEnrollment() {
    ...
    cd.addParameter(
        new Parameter(
            "enrolledOnOrAfter",
            "reporting.parameter.enrolledOnOrAfter",
            Date.class,
            null,
            null,
            null,
    ...
    cd.addParameter(
        new Parameter(
            "enrolledOnOrBefore",
            "reporting.parameter.enrolledOnOrBefore",
            Date.class,
            null,
            null,
            null,
    ...
    cd.addParameter(
        new Parameter(
            "completedOnOrAfter",
            "reporting.parameter.completedOnOrAfter",
            Date.class,
            null,
            null,
            null,
    ...
    cd.addParameter(
        new Parameter(
            "completedOnOrBefore",
            "reporting.parameter.completedOnOrBefore",
            Date.class,
            null,
            null,
            null,
    ...
    cd.addParameter(
        new Parameter(
            "locationList",
            "reporting.parameter.locationList",
            Location.class,
            List.class,
            null,
            null,
  ...
  public CohortDefinition getPatientsInProgram() {
    ...
    cd.addParameter(
        new Parameter(
            "onOrAfter", "reporting.parameter.onOrAfter", Date.class, null, null, null, false));
    cd.addParameter(
        new Parameter(
            "onOrBefore", "reporting.parameter.onOrBefore", Date.class, null, null, null, false));
    cd.addParameter(
        new Parameter("onDate", "reporting.parameter.onDate", Date.class, null, null, null, false));
    cd.addParameter(
        new Parameter(
            "locations",
            "reporting.parameter.locationList",
  ...
  public CohortDefinition getPatientsWithState() {
    ...
    cd.addParameter(
        new Parameter(
            "states", "reporting.parameter.states", ProgramWorkflowState.class, List.class, null));
    cd.addParameter(
        new Parameter("startedOnOrAfter", "reporting.parameter.startedOnOrAfter", Date.class));
    cd.addParameter(
        new Parameter("startedOnOrBefore", "reporting.parameter.startedOnOrBefore", Date.class));
    cd.addParameter(
        new Parameter("endedOnOrAfter", "reporting.parameter.endedOnOrAfter", Date.class));
    cd.addParameter(
        new Parameter("endedOnOrBefore", "reporting.parameter.endedOnOrBefore", Date.class));
    return cd;
  }
  ...
  public CohortDefinition getConditonSearchAdvanced() {
    ...
    cd.addParameter(
        new Parameter("conditionCoded", "reporting.parameter.conditionCoded", Concept.class));
    cd.addParameter(
        new Parameter("conditionNonCoded", "reporting.parameter.conditionNonCoded", String.class));
    cd.addParameter(
        new Parameter(
            "onsetDateOnOrBefore", "reporting.parameter.onsetDateOnOrBefore", Date.class));
    cd.addParameter(
        new Parameter("onsetDateOnOrAfter", "reporting.parameter.onsetDateOnOrAfter", Date.class));
    cd.addParameter(
        new Parameter("endDateOnOrBefore", "reporting.parameter.endDateOnOrBefore", Date.class));
    cd.addParameter(
        new Parameter("endDateOnOrAfter", "reporting.parameter.endDateOnOrAfter", Date.class));
    cd.addParameter(
        new Parameter("createdOnOrBefore", "reporting.parameter.createdOnOrBefore", Date.class));
    cd.addParameter(
        new Parameter("createdOnOrAfter", "reporting.parameter.createdOnOrAfter", Date.class));
