...
/**
 * This class returns ObsQuerys that have been Serialized to the database This class is annotated as
 * a Handler that supports all ObsQuery classes Specifying no order on this indicates that this is
 * the default means of Persisting an ObsQuery. To override this behavior, any additional
 * ObsQueryPersister should specify the order field on the Handler annotation.
 */
