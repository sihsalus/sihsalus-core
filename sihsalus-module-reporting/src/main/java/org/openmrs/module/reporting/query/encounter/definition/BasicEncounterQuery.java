...
public class BasicEncounterQuery extends BaseQuery<Encounter> implements EncounterQuery {
  ...
  @ConfigurationProperty private Integer whichNumber;

  @ConfigurationProperty public List<EncounterType> encounterTypes;

  @ConfigurationProperty public List<Form> forms;

  @ConfigurationProperty public Date onOrAfter;

  @ConfigurationProperty public Date onOrBefore;
