...
/**
 * The logic that evaluates a {@link SimpleIndicatorDataSetDefinition} and produces an {@link
 * DataSet}
 *
...
public class SimpleIndicatorDataSetEvaluator implements DataSetEvaluator {
  ...
  public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext context)
    ...
    for (DataSetColumn c : dsd.getColumns()) {
      ...
      try {
        SimpleIndicatorResult result =
            (SimpleIndicatorResult) is.evaluate(col.getIndicator(), context);
