...
/**
 * Extends the patient-based EvaluationContext to add an additional Visit filter for use within
 * Visit specific queries and data extraction Note that this cache is cleared whenever any changes
 * are made to baseVisits
 */
