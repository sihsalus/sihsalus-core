...
/**
 * Any method in this class that returns a String (or CharSequence) will be exposed as a helper for
...
public class HandlebarsHelpers {
  ...
  /**
   * This will be exposed as a handlebars helper. Usage is like: {{ message location.uuid
   * prefix="ui.i18n.Location.name." }}
   *
   * @param key
   * @param options
  ...
  /**
   * This will be exposed as a handlebars helper. Usage is like: {{ conceptName "PIH:Lab only" }}
   *
   * @param sourceAndCode
  ...
  /**
   * This will be exposed as a handlebars helper. Usage is like: {{ formatDate
   * request.evaluateStartDatetime "yyyyMMdd" }}
   *
   * @param date
