...
/**
 * This interface exposes the functionality required to access the Data Access functionality for a
 * particular set of DataSetDefinition implementations
 */
public interface DataSetDefinitionPersister extends DefinitionPersister<DataSetDefinition> {
  ...
  /**
   * Returns a List of {@link DataSetDefinition} whose name contains the passed name. An empty list
   * will be returned if there are none found. Search is case insensitive.
   *
