...
/**
 * Represents a value that may be used to configure a CohortDefinition instance. Typically such a
 * property will be constructed through introspection of objects that contain the {@link
