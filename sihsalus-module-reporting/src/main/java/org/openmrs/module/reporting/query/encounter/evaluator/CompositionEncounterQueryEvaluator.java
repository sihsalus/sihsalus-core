...
public class CompositionEncounterQueryEvaluator
    extends CompositionQueryEvaluator<EncounterQuery, Encounter> {
  ...
  @Override
  protected IdSet<Encounter> evaluateQuery(Mapped<EncounterQuery> query, EvaluationContext context)
