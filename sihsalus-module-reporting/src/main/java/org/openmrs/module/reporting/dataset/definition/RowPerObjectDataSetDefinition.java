...
public abstract class RowPerObjectDataSetDefinition extends BaseDataSetDefinition {
  ...
  @ConfigurationProperty private List<RowPerObjectColumnDefinition> columnDefinitions;

  @ConfigurationProperty private SortCriteria sortCriteria;
  ...
  /**
   * Removes the RowPerObjectColumnDefinition defined with the passed name, returning true of the
   * removal was successful
   */
  public boolean removeColumnDefinition(String name) {
    for (Iterator<RowPerObjectColumnDefinition> i = getColumnDefinitions().iterator();
        i.hasNext(); ) {
