...
/**
 * This DataSetDefinition wraps a {@link CohortIndicatorDataSetDefinition} and allows you to run it
 * on a series of startDate/endDate/location triplet. The {@link DataSet} that this defines has the
 * same columns as the wrapped {@link DataSetDefinition}, prepended by columns for 'startDate',
 * 'endDate', and 'location' for each iteration. Each row of the DataSet is the result you'd get
 * from evaluating the wrapped DataSetDefinition on one startDate/endDate/location triplet,
 */
@Localized("reporting.MultiPeriodIndicatorDataSetDefinition")
public class MultiPeriodIndicatorDataSetDefinition extends BaseDataSetDefinition
    implements DataSetDefinition {

  // ***** PROPERTIES *****

  @ConfigurationProperty private CohortIndicatorDataSetDefinition baseDefinition;

  @ConfigurationProperty private List<Iteration> iterations;
