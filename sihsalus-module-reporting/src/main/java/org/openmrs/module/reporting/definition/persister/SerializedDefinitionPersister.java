...
/**
 * This class returns Definitions that have been Serialized to the database This class is abstract
 * as it is meant to be extended by any Persister that wishes to use Serialization as it's
 * Persistence mechanism
 */
public abstract class SerializedDefinitionPersister<T extends Definition>
    implements DefinitionPersister<T> {
