...
/**
 * Interprets the valueText of an Obs as the id of an OpenMRS object, and converts to that object;
 * currently only supports Locations
 *
 * @param <T>
 */
  ...
  public Object convert(Object original) {
    ...
    if (dataType != Location.class) {
      throw new IllegalArgumentException(
          "ObValueTextAsCodedConverter only currently supports Location.class");
    }
