...
/**
 * This subinterface defines the methods needed to allow an evaluator to be wrapped in a {@link
 * LazyPageableDataSet}, making it easy to implement the evaluator for many {@link
 * PageableDataSetDefinition}s.
 */
public interface LazyPageableDataSetEvaluator extends DataSetEvaluator {
  ...
  public PageableDataSet evaluate(
      DataSetDefinition dataSetDefinition, EvaluationContext evalContext) throws ReportingException;
}
