...
public class ReportDescriptor {
  ...
  @JsonProperty private List<ParameterDescriptor> parameters;

  @JsonProperty private List<DataSetDescriptor> datasets;

  @JsonProperty private List<DesignDescriptor> designs;

  @JsonProperty private Map<String, Object> config;

  // utility property for storing the path to this descriptor on the file system so we know where to
