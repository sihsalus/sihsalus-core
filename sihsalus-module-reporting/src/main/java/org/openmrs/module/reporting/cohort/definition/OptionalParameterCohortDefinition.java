...
public class OptionalParameterCohortDefinition extends BaseCohortDefinition {
  ...
  @ConfigurationProperty private CohortDefinition wrappedCohortDefinition;

  @ConfigurationProperty private List<String> parametersToCheck;

  public OptionalParameterCohortDefinition() {}

  public OptionalParameterCohortDefinition(
      CohortDefinition wrappedCohortDefinition, String... parametersToCheck) {
