...
public class BuiltInEncounterDataLibrary extends BaseDefinitionLibrary<EncounterDataDefinition> {
  ...
  @Autowired BuiltInPatientDataLibrary builtInPatientDataLibrary;
  ...
  public EncounterDataDefinition getEncounterVisit() {
    return new EncounterVisitDataDefinition();
  }

  @DocumentedDefinition("encounterType.name")
  public EncounterDataDefinition getEncounterTypeName() {
    return new ConvertedEncounterDataDefinition(
        new EncounterTypeDataDefinition(), new ObjectFormatter());
  }

  @DocumentedDefinition("location.name")
  public EncounterDataDefinition getLocationName() {
    return new ConvertedEncounterDataDefinition(
        new EncounterLocationDataDefinition(), new ObjectFormatter());
  }
