...
public class CompositionEncounterQuery extends CompositionQuery<EncounterQuery, Encounter>
    implements EncounterQuery {

  @ConfigurationProperty private Map<String, Mapped<EncounterQuery>> searches;
