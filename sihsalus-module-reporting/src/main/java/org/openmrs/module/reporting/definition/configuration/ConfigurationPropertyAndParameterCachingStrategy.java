 ...
 * {@link org.openmrs.module.reporting.evaluation.caching.Caching} annotation
 *
 * @see org.openmrs.module.reporting.evaluation.caching.Caching
 */
public class ConfigurationPropertyAndParameterCachingStrategy
    extends ConfigurationPropertyCachingStrategy {

  /**
   * Implementation that creates a cache key out of the instance class name and a sorted Map of
   * field name -> value for all fields annotated as {@link
   * org.openmrs.module.reporting.definition.configuration.ConfigurationProperty}
   *
   * @see
   *     org.openmrs.module.reporting.evaluation.caching.CachingStrategy#getCacheKey(org.openmrs.module.reporting.evaluation.Definition,
