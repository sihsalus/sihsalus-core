...
public class EncounterWithCodedObsCohortDefinition extends BaseCohortDefinition {
  ...
  @ConfigurationProperty private Concept concept;

  @ConfigurationProperty private List<Concept> includeCodedValues;

  @ConfigurationProperty private List<Concept> excludeCodedValues;

  @ConfigurationProperty private boolean includeNoObsValue = false;
