...
public class ConvertedPersonDataEvaluator implements PersonDataEvaluator {
  ...
  /**
   * @see
   *     org.openmrs.module.reporting.data.person.evaluator.PersonDataEvaluator#evaluate(org.openmrs.module.reporting.data.person.definition.PersonDataDefinition,
  ...
  public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
    ...
    EvaluatedPersonData unconvertedData =
        Context.getService(PersonDataService.class).evaluate(def.getDefinitionToConvert(), context);
