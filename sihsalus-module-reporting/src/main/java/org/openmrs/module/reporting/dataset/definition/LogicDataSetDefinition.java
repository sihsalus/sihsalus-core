...
public class LogicDataSetDefinition extends BaseDataSetDefinition
    implements PageableDataSetDefinition {

  public static final long serialVersionUID = 1L;

  @ConfigurationProperty private List<Column> columns = new ArrayList<Column>();
