...
public class EncounterQueryServiceImpl extends BaseDefinitionService<EncounterQuery>
    implements EncounterQueryService {
   ...
   */
  public EncounterQueryResult evaluate(EncounterQuery query, EvaluationContext context)
   ...
   */
  public EncounterQueryResult evaluate(
      Mapped<? extends EncounterQuery> mappedQuery, EvaluationContext context)
      throws EvaluationException {
