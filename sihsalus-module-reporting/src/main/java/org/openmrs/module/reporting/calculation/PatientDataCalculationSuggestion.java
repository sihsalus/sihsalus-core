    ...
    if (ret.isEmpty()) {
      ret.add(
          new CalculationRegistration(
              "gender", provider, GenderDataDefinition.class.getName(), null));
      ret.add(
          new CalculationRegistration("age", provider, AgeDataDefinition.class.getName(), null));
      ret.add(
          new CalculationRegistration(
              "villageName",
              provider,
              PreferredAddressDataDefinition.class.getName(),
              "{cityVillage}"));
    }
