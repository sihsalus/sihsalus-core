...
public class BuiltInPatientDataLibrary extends BaseDefinitionLibrary<PatientDataDefinition> {
  ...
  public PatientDataDefinition getAgeAtStart() {
    ...
    ageOnDate.setDefinitionToConvert(
        Mapped.<PatientDataDefinition>map(getAgeOnEffectiveDate(), "effectiveDate=${startDate}"));
    return ageOnDate;
  }
  ...
  public PatientDataDefinition getAgeAtEnd() {
    ...
    ageOnDate.setDefinitionToConvert(
        Mapped.<PatientDataDefinition>map(getAgeOnEffectiveDate(), "effectiveDate=${endDate}"));
    return ageOnDate;
  }
  ...
  public PatientDataDefinition getPreferredIdentifierLocation() {
    return getPreferredIdentifier(
        new PropertyConverter(PatientIdentifier.class, "location"), new ObjectFormatter());
  }
  ...
  protected PatientDataDefinition getAgeOnEffectiveDate(DataConverter... converters) {
    ...
    ageDataDefinition.addParameter(
  ...
  protected PatientDataDefinition getPreferredName(String property) {
    return convert(
        new PreferredNameDataDefinition(), new PropertyConverter(PersonName.class, property));
  }
}
