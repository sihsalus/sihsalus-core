...
public class CohortIndicatorAndDimensionResult implements IndicatorResult {
  ...
  /** Default constructor */
  public CohortIndicatorAndDimensionResult(
      CohortIndicatorResult cohortIndicatorResult, EvaluationContext context) {
  ...
  /**
   * @return the Cohort which results from intersecting the CohortIndicator cohort with the
   *     dimension Cohorts
   */
  ...
  /**
   * @return the Denominator which results from intersecting the CohortIndicator cohort with the
   *     dimension Cohorts
   */
  ...
  /**
   * @return the LogicResults which results from intersecting the CohortIndicator cohort with the
   *     dimension Cohorts
   */
