...
public class PatientDataSetDataDefinition extends DataSetDataDefinition
  ...
  public PatientDataSetDataDefinition(
      RowPerObjectDataSetDefinition definition, TimeQualifier whichValues, Integer numberOfValues) {
