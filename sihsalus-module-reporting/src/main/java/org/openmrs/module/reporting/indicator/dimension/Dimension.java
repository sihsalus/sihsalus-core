...
/**
 * A Dimension represents the ability to produce classifications that cover an entire spectrum of
 * values
 */
public interface Dimension extends Definition {
  ...
  /**
   * When evaluating an indicator for a given set of Dimensions, this is the separator character to
  ...
  /**
   * When evaluating an indicator for a given set of Dimensions, this is the separator character to
   * use to separate the name and value of a Dimension
   */
