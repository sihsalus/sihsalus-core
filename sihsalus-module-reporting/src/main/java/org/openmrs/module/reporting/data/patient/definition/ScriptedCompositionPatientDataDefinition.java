...
public class ScriptedCompositionPatientDataDefinition extends BaseDataDefinition
   ...
   */
  public void setContainedDataDefinitions(
      Map<String, Mapped<PatientDataDefinition>> containedDataDefinitions) {
   ...
   */
  public void addContainedDataDefinition(
      String key, Mapped<PatientDataDefinition> patientDataDefinitions) {
   ...
   */
  public void addContainedDataDefinition(
      String key, PatientDataDefinition patientDataDefintion, Map<String, Object> mappings) {
    addContainedDataDefinition(
        key, new Mapped<PatientDataDefinition>(patientDataDefintion, mappings));
  }
