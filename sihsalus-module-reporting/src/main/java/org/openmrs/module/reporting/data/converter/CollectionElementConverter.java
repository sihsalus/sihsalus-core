...
/**
 * Takes a collection of objects and returns valueIfPresent if the valueToCheck is in the
 * collection, valueIfNotPresent otherwise
 */
public class CollectionElementConverter implements DataConverter {
  ...
  public CollectionElementConverter(
      Object valueToCheck, Object valueIfPresent, Object valueIfNotPresent) {
