...
public class PreferredIdentifierDataEvaluator implements PatientDataEvaluator {
   ...
   * @should return the preferred identifier of the passed type for each patient in the passed
   *     context
  ...
  public EvaluatedPatientData evaluate(PatientDataDefinition definition, EvaluationContext context)
    ...
    Map<Integer, Object> m =
        Context.getService(EvaluationService.class)
            .evaluateToMap(q, Integer.class, Object.class, context);
    c.setData(m);
