...
public class XlsReportRenderer extends ReportTemplateRenderer {
  ...
  public static String INCLUDE_DATASET_NAME_AND_PARAMETERS_PROPERTY =
      "includeDataSetNameAndParameters";
  ...
  public boolean getIncludeDataSetNameAndParameters(ReportDesign design) {
    return "true"
        .equalsIgnoreCase(
            design.getPropertyValue(INCLUDE_DATASET_NAME_AND_PARAMETERS_PROPERTY, ""));
  }
