...
public class EncounterProviderDataDefinition extends BaseDataDefinition
    implements EncounterDataDefinition {

  public static final long serialVersionUID = 1L;

  @ConfigurationProperty private OpenmrsMetadata encounterRole;

  @ConfigurationProperty private boolean singleProvider = true;
