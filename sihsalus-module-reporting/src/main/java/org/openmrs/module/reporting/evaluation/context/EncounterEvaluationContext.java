...
/**
 * Extends the patient-based EvaluationContext to add an additional Encounter filter for use within
 * Encounter specific queries and data extraction Note that this cache is cleared whenever any
 * changes are made to baseEncounters
 */
public class EncounterEvaluationContext extends EvaluationContext {
  ...
  /**
   * Constructs a new EncounterEvaluationContext given the passed EvaluationContext and
   * EncounterIdSet
   */
