...
public class AuditEncounterQuery extends BaseQuery<Encounter> implements EncounterQuery {
  ...
  @ConfigurationProperty public Date createdOnOrAfter;

  @ConfigurationProperty public Date createdOnOrBefore;

  @ConfigurationProperty public Integer latestCreatedNumber;
