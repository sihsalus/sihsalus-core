...
| `GET` | `/api/admin/static-modules` | Static module inventory for operators. |
...
| Billing | `/rest/v1/billing/*`, `/rest/v1/billing/receipt`, `/rest/v1/billing/api/*`, `/rest/v2/billing/timesheet` |
| Cohort | `/rest/v1/cohortm/cohort`, `/rest/v1/cohortm/cohortmember`, `/rest/v1/cohortm/cohorttype`, `/rest/v1/cohortm/cohortattributetype`, `/rest/v1/cohortm/cohort-member-attribute-type` |
| O3 Forms | `/rest/v1/o3/forms/{formNameOrUuid}` |
| Open Concept Lab | `/rest/v1/openconceptlab/import`, `/rest/v1/openconceptlab/subscription`, import action subresources |
...
| Queue | `/rest/v1/queue`, `/rest/v1/queue-entry`, `/rest/v1/queue-room`, `/rest/v1/queue-room-provider`, `/rest/v1/visit-queue-entry`, `/rest/v1/queue-entry-metric`, `/rest/v1/queue-entry/transition`, `/rest/v1/queueutil/*` |
| Reporting REST | `/rest/v1/reportingrest/reportDefinition`, `/rest/v1/reportingrest/reportRequest`, `/rest/v1/reportingrest/reportDesign`, `/rest/v1/reportingrest/cohortDefinition`, `/rest/v1/reportingrest/dataSetDefinition`, `/rest/v1/reportingrest/adhocquery`, `/rest/v1/reportingrest/adhocdataset`, report run/download actions |
| SIH Salus Interop | `/rest/v1/interop/*`, `/module/sihsalusinterop/api/*` |
