...
public class EncounterPdfReportRenderer extends ReportDesignRenderer {
  ...
  public void render(ReportData results, String argument, OutputStream out)
    ...
    try {
      String encounterUuidsParam =
          (String) getReportParam(results, EncounterPdfReportManager.ENCOUNTER_UUIDS_PARAM);
      ...
      Locale reportLocale =
          (Locale) getReportParam(results, EncounterPdfReportManager.ENCOUNTER_LOCALE_PARAM);
      EncounterPrintingContext printingContext =
          new EncounterPrintingContext(encounters, reportLocale);
  ...
  private String getStylesheetName() {
    String stylesheetName =
        Context.getService(InitializerService.class)
            .getValueFromKey(PatientDocumentsConstants.ENCOUNTER_PRINTING_STYLESHEET_KEY);
