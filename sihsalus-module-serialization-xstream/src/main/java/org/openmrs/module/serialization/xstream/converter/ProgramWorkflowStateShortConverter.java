...
public class ProgramWorkflowStateShortConverter extends BaseShortConverter {
  ...
  /**
   * This short converter can deal with both ProgramWorkflowState and CGLib proxy for
   * ProgramWorkflowState. <br>
   * Because, when "c" is a CGLib proxy of ProgramWorkflowState,
   * ProgramWorkflowState.class.isAssignableFrom(c) will also return true
   *
