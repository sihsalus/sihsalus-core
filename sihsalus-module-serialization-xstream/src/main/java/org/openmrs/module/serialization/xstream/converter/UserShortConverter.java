...
/**
 * Short Converter for User and its CGLib proxy. <br>
 ...
 */
public class UserShortConverter extends BaseShortConverter {

  public UserShortConverter(Mapper mapper, ConverterLookup converterLookup) {
    super(mapper, converterLookup);
  }

  /**
   * This short converter can deal with both User and CGLib proxy for User. <br>
   * Because, when "c" is a CGLib proxy of User, User.class.isAssignableFrom(c) will also return
   * true
   *
