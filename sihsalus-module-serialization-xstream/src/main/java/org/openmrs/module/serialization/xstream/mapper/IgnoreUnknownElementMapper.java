...
/**
 * This mapper and CustomReflectionConverter together implement the function to let xstream ignore
 * those unknown elements while deserialize from a string
 *
...
public class IgnoreUnknownElementMapper extends MapperWrapper {
   ...
   * here just don't do anything for this exception, so that xstream can ignore those unknown
   * elements.
   */
