...
public class FileUploadWidget implements Widget {
  ...
  public void render(WidgetConfig config, Writer w) throws IOException {
    ...
    HtmlUtil.renderOpenTag(
        w,
        "span",
        "class=currentResourceSection"
            + (config.getDefaultValue() != null ? "" : "|style=display:none;"));
    if (uploadName != null) {
    ...
    HtmlUtil.renderSimpleTag(
        w,
        "input",
        "name=foo|type=button|value=Change|onclick=showResourceChange_" + id + "(this, 'show');");
    HtmlUtil.renderCloseTag(w, "span");

    HtmlUtil.renderOpenTag(
        w,
        "span",
        "class=resourceChangeSection"
            + (config.getDefaultValue() == null ? "" : "|style=display:none;"));
    ...
    if (config.getDefaultValue() != null
      ...
      HtmlUtil.renderSimpleTag(
          w,
          "input",
          "type=button|value=Cancel|onclick=hideResourceChange_" + id + "(this, 'hide');");
    }
    HtmlUtil.renderCloseTag(w, "span");
