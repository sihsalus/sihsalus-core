...
/**
 * Demonstration / test bean to encapsulate the properties that can be set using the Widget
 * Framework
 */
public class Demo {
   ...
   */
  public void setPatientIdentifierTypeObj(PatientIdentifierType patientIdentifierTypeObj) {
   ...
   */
  public void setProgramWorkflowStateObj(ProgramWorkflowState programWorkflowStateObj) {
