...
public class HtmlUtil  {
	...
	public static void renderResource(Writer w, HttpServletRequest request, String resource) throws IOException {
		...
		if (rewrites != null && rewrites.containsKey(resource))
			resource = rewrites.get(resource);
	...
	/**
	 * Since OpenMRS 1.7, certain resources are silently rewritten. This method tries to get
