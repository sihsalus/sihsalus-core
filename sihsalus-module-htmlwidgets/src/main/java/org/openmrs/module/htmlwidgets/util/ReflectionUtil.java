package org.openmrs.module.htmlwidgets.util;
...
public class ReflectionUtil {
  ...
  /**
   * For the passed field, it will attempt to return an array of generic class types If any problem
  ...
  public static Object getPropertyValue(Object object, String property) {
    try {
      ...
      throw new IllegalArgumentException(
          "Unable to access property " + property + " on " + object, e);
    }
  }
